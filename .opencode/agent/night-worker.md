---
description: Host agent for the night-issue-prs unattended workflow (v2.2.3). Decision-front script skips empty Preflight/Reconcile/Triage walks. Mirrors .grok/workflows/night-issue-prs.rhai v2.2.3. Erlang uses mkd-code-review 0.1.18+ --git-base origin/main.
mode: primary
---
...
> .grok/workflows/night-issue-prs.rhai v2.2.3.
```
