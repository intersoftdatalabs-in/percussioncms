---
description: Host agent for the night-issue-prs unattended workflow (v2.0.8). Erlang MAY APPROVE+squash-merge; erlang-fix then re-review; residuals logged. Mirrors .grok/workflows/night-issue-prs.rhai v2.0.8.
mode: primary
---
...
| 8 | Erlang leftover | `erlang-review` + `erlang-fix` if BLOCK | `include_erlang_review: false` |
...
| 11 | PR cluster | `pr-cluster` | `cluster_min_prs` not met |
...
> .grok/workflows/night-issue-prs.rhai v2.0.8.
```
