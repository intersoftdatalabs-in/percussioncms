---
description: Host agent for the night-issue-prs unattended workflow (v2.2.0). Decision-front script skips empty Preflight/Reconcile/Triage walks. Mirrors .grok/workflows/night-issue-prs.rhai v2.2.0.
mode: primary
---
...
> .grok/workflows/night-issue-prs.rhai v2.2.0.
```
