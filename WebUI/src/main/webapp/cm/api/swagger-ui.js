...
(function () {
  ...
  templates["content_type"] = template(function (
    Handlebars,
    depth0,
    helpers,
    partials,
...
(function () {
  var template = Handlebars.template,
    templates = (Handlebars.templates = Handlebars.templates || {});
  templates["operation"] = template(function (
    Handlebars,
    depth0,
    helpers,
    partials,
    ...
    buffer +=
      escapeExpression(stack1) + "_content' style='display:none'>\n        ";
...
(function () {
  var template = Handlebars.template,
    templates = (Handlebars.templates = Handlebars.templates || {});
  templates["param"] = template(function (
    Handlebars,
    depth0,
    helpers,
    partials,
    ...
    function program11(depth0, data) {
      ...
      buffer +=
        escapeExpression(stack1) + "' placeholder='' type='text' value='";
      if ((stack1 = helpers.defaultValue)) {
        stack1 = stack1.call(depth0, { hash: {}, data: data });
      } else {
        stack1 = depth0.defaultValue;
...
(function () {
  var template = Handlebars.template,
    templates = (Handlebars.templates = Handlebars.templates || {});
  templates["param_list"] = template(function (
    Handlebars,
    depth0,
    helpers,
    partials,
    ...
    function program8(depth0, data) {
      ...
      stack2 =
        ((stack1 = helpers.isArray || depth0.isArray),
        stack1
          ? stack1.call(depth0, depth0, options)
          : helperMissing.call(depth0, "isArray", depth0, options));
      if (stack2 || stack2 === 0) {
        buffer += stack2;
      }
      buffer += "\n      ";
...
(function () {
  var template = Handlebars.template,
    templates = (Handlebars.templates = Handlebars.templates || {});
  templates["param_readonly"] = template(function (
    Handlebars,
    depth0,
    helpers,
    partials,
...
(function () {
  var template = Handlebars.template,
    templates = (Handlebars.templates = Handlebars.templates || {});
  templates["param_required"] = template(function (
    Handlebars,
    depth0,
    helpers,
    partials,
...
(function () {
  var template = Handlebars.template,
    templates = (Handlebars.templates = Handlebars.templates || {});
  templates["resource"] = template(function (
    Handlebars,
    depth0,
    helpers,
    partials,
...
(function () {
  var template = Handlebars.template,
    templates = (Handlebars.templates = Handlebars.templates || {});
  templates["signature"] = template(function (
    Handlebars,
    depth0,
    helpers,
    partials,
...
(function () {
  var template = Handlebars.template,
    templates = (Handlebars.templates = Handlebars.templates || {});
  templates["status_code"] = template(function (
    Handlebars,
    depth0,
    helpers,
    partials,
...
(function () {
  ...
  OperationView = (function (_super) {
    ...
    OperationView.prototype.mouseEnter = function (e) {
      ...
      pos.left = x;
      elem.css(pos);
      return $(e.currentTarget.parentNode)
    ...
    OperationView.prototype.render = function () {
      ...
      if (
        ...
        $(".model-signature", $(this.el)).append(
          responseSignatureView.render().el
        );
      } else {
      ...
      $(".response-content-type", $(this.el)).append(
        responseContentTypeView.render().el
      );
    ...
    OperationView.prototype.addStatusCode = function (statusCode) {
      ...
      return $(".operation-status", $(this.el)).append(
        statusCodeView.render().el
      );
    };
    ...
    OperationView.prototype.handleFileUpload = function (map, form) {
      ...
      for (_j = 0, _len1 = _ref6.length; _j < _len1; _j++) {
        ...
        if (param.paramType === "form") {
          if (
            param.type.toLowerCase() !== "file" &&
            map[param.name] !== void 0
          ) {
      ...
      this.invocationUrl = this.model.supportHeaderParams()
        ? ((headerParams = this.model.getHeaderParams(map)),
          this.model.urlify(map, false))
    ...
    OperationView.prototype.toggleOperationContent = function () {
      ...
      elem = $(
        "#" +
          Docs.escapeResourceName(this.model.parentId) +
          "_" +
          this.model.nickname +
          "_content"
      );
      ...
      if (swaggerUi.api.models.hasOwnProperty(this.model.responseModel)) {
        responseModel = {
          sampleJSON: JSON.stringify(
            swaggerUi.api.models[this.model.responseModel].createJSONSample(),
            null,
            2
          ),
          isParam: false,
          signature:
            swaggerUi.api.models[this.model.responseModel].getMockSignature(),
        };
  ...
  ParameterView = (function (_super) {
    ...
    ParameterView.prototype.render = function () {
      ...
      if (isParam) {
        ...
        $(".parameter-content-type", $(this.el)).append(
          parameterContentTypeView.render().el
        );
      } else {
        responseContentTypeView = new ResponseContentTypeView({
          model: contentTypeModel,
  ...
  ResponseContentTypeView = (function (_super) {
    ...
    function ResponseContentTypeView() {
      _ref9 = ResponseContentTypeView.__super__.constructor.apply(
        this,
        arguments
      );
      return _ref9;
    ...
    ResponseContentTypeView.prototype.render = function () {
      ...
      template = this.template();
      $(this.el).html(template(this.model));
      $("label[for=responseContentType]", $(this.el)).text(
  ...
  ParameterContentTypeView = (function (_super) {
    ...
    function ParameterContentTypeView() {
      _ref10 = ParameterContentTypeView.__super__.constructor.apply(
        this,
        arguments
      );
      return _ref10;
    ...
    ParameterContentTypeView.prototype.render = function () {
      ...
      template = this.template();
      $(this.el).html(template(this.model));
      $("label[for=parameterContentType]", $(this.el)).text(
