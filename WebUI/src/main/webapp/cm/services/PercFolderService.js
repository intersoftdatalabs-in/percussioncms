...
(function ($) {
   ...
   */
  function getFoldersWithWorkflow(
    path,
    workflowName,
    callback,
  ...
  function startAssociatedFoldersJob(
    path,
    workflowName,
    callback,
    includeFoldersWithDifferentWorkflow,
  ...
  function getAssociatedFoldersJobStatus(jobId, callback) {
    var requestURL =
      $.perc_paths.FOLDERMGT_GET_ASSOCIATED_FOLDERS_JOB_STATUS + jobId;
    $.PercServiceUtils.makeJsonRequest(
      requestURL,
      $.PercServiceUtils.TYPE_GET,
      false,
  ...
  function cancelAssociatedFoldersJob(jobId, sync, callback) {
    var requestURL =
      $.perc_paths.FOLDERMGT_CANCEL_ASSOCIATED_FOLDERS_JOB + jobId;
    $.PercServiceUtils.makeJsonRequest(
      requestURL,
      $.PercServiceUtils.TYPE_GET,
      sync,
