...
(function ($, window) {
  ...
  $.deparam = jq_deparam = function (params, coerce) {
    ...
    $.each(params.replace(/\+/g, " ").split("&"), function (j, v) {
      ...
      if (param.length === 2) {
        ...
        obj[sanitizeKey(key)] = coerce ? undefined : "";
      }
    });
  ...
  function jq_deparam_sub(is_fragment, url_or_params, coerce) {
    if (url_or_params === undefined || typeof url_or_params === "boolean") {
      ...
      url_or_params =
        jq_param[sanitizeKey(is_fragment) ? str_fragment : str_querystring]();
    } else {
  ...
  $[sanitizeKey(str_elemUrlAttr)] ||
    ($[sanitizeKey(str_elemUrlAttr)] = function (obj) {
  ...
  jq_event_special[sanitizeKey(str_hashchange)] = $.extend(
    jq_event_special[sanitizeKey(str_hashchange)],
    {
