  ...
  (function (factory) {
    ...
    FancytreeNode.prototype = /** @lends FancytreeNode# */ {
      ...
      scrollIntoView: function (effects, options) {
        ...
        var opts = $.extend(
            {
              effects:
                effects === true ? { duration: 200, queue: false } : effects,
    ...
    Fancytree.prototype = /** @lends Fancytree# */ {
      ...
      findNextNode: function (match, startNode) {
        ...
        match =
          typeof match === "string" ? _makeNodeTitleStartMatcher(match) : match;
      ...
      generateFormElements: function (selected, active, opts) {
        ...
        var nodeList,
          ...
          activeName =
            typeof active === "string" ? active : "ft_" + this._id + "_active",
          id = "fancytree_result_" + this._id,
          $result = $("#" + id),
          stopOnParents =
            this.options.selectMode === 3 && opts.stopOnParents !== false;
      ...
      loadKeyPath: function (keyPathList, optsOrCallback) {
        ...
        setTimeout(function () {
          self
            ._loadKeyPathImpl(dfd, opts, parent, pathSegList)
            .done(function () {
              dfd.resolve();
            });
        }, 0);
    ...
    $.extend(
      ...
      /** @lends Fancytree_Hooks# */
      {
          ...
          ajaxDfd.then(
            function (data, textStatus, jqXHR) {
              ...
              if (ctx.options.postProcess) {
                ...
                data =
                  typeof data.d === "string" ? $.parseJSON(data.d) : data.d;
              }
        ...
        nodeRenderTitle: function (ctx, title) {
          ...
          if (opts.renderTitle) {
            nodeTitle =
              opts.renderTitle.call(tree, { type: "renderTitle" }, ctx) || "";
          }
          if (!nodeTitle) {
        ...
        nodeSetExpanded: function (ctx, flag, callOpts) {
          ...
          if ((node.expanded && flag) || (!node.expanded && !flag)) {
            ...
            !noEvents &&
            this._triggerNodeEvent("beforeExpand", node, ctx.originalEvent) ===
              false
          ) {
            // Callback returned false
            return _getRejectedPromise(node, ["rejected"]);
        ...
        nodeSetSelected: function (ctx, flag, callOpts) {
          ...
          if (
            !noEvents &&
            this._triggerNodeEvent("beforeSelect", node, ctx.originalEvent) ===
              false
          ) {
        ...
        fixPositionOptions: function (opts) {
          ...
          if (!$.ui.fancytree.jquerySupports.positionMyOfs) {
            var // parse 'left+3 center' into ['left+3 center', 'left', '+3', 'center', undefined]
              ...
              // convert to numbers
              dx =
                (myParts[2] ? +myParts[2] : 0) + (atParts[2] ? +atParts[2] : 0),
              dy =
                (myParts[4] ? +myParts[4] : 0) + (atParts[4] ? +atParts[4] : 0);
 ...
 */ (function (factory) {
    ...
    function autoScroll(tree, event) {
      ...
      if (sp !== document && sp.tagName !== "HTML") {
        ...
        if (spOfs.top + sp.offsetHeight - event.pageY < sensitivity) {
          delta =
            sp.scrollHeight - tree.$scrollParent.innerHeight() - scrollTop;
   ...
   */ (function (factory) {
    ...
    $.ui.fancytree._FancytreeNodeClass.prototype.editStart = function () {
      ...
      if (
        instOpts.beforeEdit.call(node, { type: "beforeEdit" }, eventData) ===
        false
      ) {
        return false;
      }
    ...
    $.ui.fancytree._FancytreeNodeClass.prototype.editEnd = function (
      ...
      if (
        instOpts.beforeClose.call(node, { type: "beforeClose" }, eventData) ===
        false
      ) {
        return false;
      }
    ...
    $.ui.fancytree.registerExtension({
      ...
      nodeKeydown: function (ctx) {
        switch (ctx.originalEvent.which) {
          ...
          case $.ui.keyCode.ENTER:
            if (
              $.inArray("mac+enter", ctx.options.edit.triggerStart) >= 0 &&
              isMac
            ) {
              ctx.node.editStart();
              return false;
      ...
      nodeRenderStatus: function (ctx) {
        ...
        if (span) {
          if (node.statusNodeType) {
            ...
            icon =
              node.expanded && node.hasChildren() ? "folderOpen" : "folder";
          } else {
