...
(function ($) {
        ...
        for (var i = 0, c = a_fn.length; i < c; i++) {
          ...
          try {
            if (isStr(fn))
              // 'name' of a function
              fn = eval(fn);
            if (typeof fn === "function") g(fn)(Instance);
          } catch (ex) {}
        }
  ...
  $.layout = {
    ...
    config: {
      ...
      resizers: {
        ...
        cssDemo: {
          // DEMO CSS - applied if: options.PANE.applyDemoStyles=true
          background: "#DDD",
          border: "none",
        },
      },
      ...
      content: {
        ...
        cssDemoPane: {
          // DEMO CSS - REMOVE scrolling from 'pane' when it has a content-div
          overflow: "hidden",
          padding: 0,
        },
      },
      panes: {
        // defaults for ALL panes - overridden by 'per-pane settings' below
        cssReq: {
          position: "absolute",
          margin: 0,
    ...
    plugins: {
      ...
      effects: {
        ...
        slide:
          $.effects &&
          ($.effects.slide || ($.effects.effect && $.effects.effect.slide)), // default effect
      },
    },
    ...
    disableTextSelection: function () {
      ...
      if ($.fn.disableSelection) {
        if (!$d.data(x))
          // document hasn't been initialized yet
    ...
    getElementDimensions: function ($E, inset) {
      var // dimensions hash - start with current data IF passed
        d = { css: {}, inset: {} },
        x = d.css, // CSS hash
    ...
    borderWidth: function (el, side) {
      ...
      return $.css(el, b + "Style", true) === "none"
        ? 0
  ...
  $.layout.optionsMap = {
    ...
    center: (
      ...
      "onresize,onresize_start,onresize_end,onsizecontent,onsizecontent_start,onsizecontent_end"
    ).split(","),
      ...
      function getBranch(path, create) {
        ...
        for (; i < c; i++) {
          ...
          if (D.branch[k] === undefined) {
            ...
            else D.branch = {}; // branch is undefined
  ...
  $.fn.layout = function (opts) {
    var // local aliases to global data
      ...
      state = {
        ...
        panesSliding: {},
        container: {
          // list all keys referenced in code to avoid compiler error msgs
          innerWidth: 0,
          innerHeight: 0,
          outerWidth: 0,
          outerHeight: 0,
      ...
      _runCallbacks = function (evtName, pane, skipBoundEvents) {
        var hasPane = pane && isStr(pane),
          ...
          $P = hasPane ? $Ps[pane] : 0;
        if (hasPane && !$P)
          // a pane is specified, but does not exist!
          return retVal;
        ...
        if (fn) {
          try {
            ...
            if (typeof fn === "function") {
              ...
              // must be a layout/container callback - pass suitable info
      ...
      setOuterWidth = function (el, outerWidth, autoHide) {
        ...
        if (w > 0) {
          if (autoHide && $E.data("autoHidden") && $E.innerHeight() > 0) {
            ...
            if (!browser.mozilla)
              // FireFox refreshes iframes - IE does not
      ...
      _parseSize = function (pane, size, dir) {
        ...
        var o = options,
          avail = 0;
        if (dir == "horz")
          // north or south or center.minHeight
          avail =
            sC.innerHeight -
            ($Ps.north ? o.north.spacing_open : 0) -
            ($Ps.south ? o.south.spacing_open : 0);
        else if (dir == "vert")
          // east or west or center.minWidth
          avail =
            sC.innerWidth -
            ($Ps.west ? o.west.spacing_open : 0) -
            ($Ps.east ? o.east.spacing_open : 0);
        ...
        var o = options[pane],
          ...
          altPaneSpacing =
            (!$altP || altS.isHidden
              ? 0
              : options[altPane][
                  altS.isClosed !== false ? "spacing_closed" : "spacing_open"
                ]) || 0,
          ...
          limitSize =
            ...
            (isSliding
              ? 0
              : _parseSize("center", minCenterSize, dir) +
                altPaneSize +
                altPaneSpacing),
      ...
      getHoverClasses = function (el, allStates) {
        var $El = $(el),
          ...
          classes =
            ...
            (root + _pane + _hover) +
            (root + _state + _hover) +
            (root + _pane + _state + _hover);
        if (allStates)
          // when 'removing' classes, also remove alternate-state classes
      ...
      createChildren = function (evt_or_pane, opts) {
        ...
        else if (!cos || !Array.isArray(cos)) return;
        ...
        $.each(cos, function (idx, co) {
          ...
          var $containers = co.containerSelector
            ? $P.find(co.containerSelector)
            : $C || $P;
        ...
        try {
          ...
          if (sC.isBody) {
            ...
            if ($N.is(":visible")) {
              ...
              if (sC.innerHeight < 1)
                // container has no 'height' - warn developer
          ...
          $.each(["_open", "_close", "_size"], function (i, n) {
            var sName = "fxName" + n,
              ...
              fxExists =
                $.effects &&
                ($.effects[fxName] ||
                  ($.effects.effect && $.effects.effect[fxName]));
      ...
      afterInitPane = function (pane) {
        ...
        if (s.isVisible) {
          // pane is OPEN
          if (state.initialized)
            // this pane was added AFTER layout was created
            resizeAll(); // will also sizeContent
          else sizeContent(pane);

          if (o.triggerEventsOnLoad) _runCallbacks("onresize_end", pane);
          // automatic if onresize called, otherwise call it specifically
          // resize child - IF inner-layout already exists (created before this layout)
          else resizeChildren(pane, true); // a previously existing childLayout
        }
      ...
      initHandles = function (panes) {
        ...
        $.each(panes, function (i, pane) {
          ...
          $R.attr("id", paneId ? paneId + "-resizer" : "") // if paneSelector is an ID, then create a matching ID for the resizer, eg: "#paneLeft" => "paneLeft-resizer"
            .data({
          ...
          if (o.resizerDblClickToggle)
            $R.on("dblclick." + sID, function (e) {
              toggle(e);
            });

          if ($T) {
            $T.attr("id", paneId ? paneId + "-toggler" : "") // if paneSelector is an ID, then create a matching ID for the resizer, eg: "#paneLeft" => "#paneLeft-toggler"
              .data({
                parentLayout: Instance,
                layoutPane: Instance[pane], // NEW pointer to pane-alias-object
                layoutEdge: pane,
      ...
      initResizable = function (panes) {
        ...
        $.each(panes, function (idx, pane) {
          ...
          var s = state[pane],
            ...
            r,
            live, // set in start because may change
          ...
          if (!s.isClosed)
            $R.attr("title", o.tips.Resize).css("cursor", o.resizerCursor); // n-resize, s-resize, etc
            ...
            drag: function (e, ui) {
              if (!helperClassesSet) {
                ...
                ui.helper
                  ...
                  .children()
                  .css("visibility", "hidden"); // hide toggler inside dragged resizer-bar
              ...
              if (
                live &&
                Math.abs(ui.position[side] - lastPos) >= o.liveResizingTolerance
              ) {
                lastPos = ui.position[side];
        ...
        var resizePanes = function (evt, ui, pane, resizingDone) {
          ...
          if (!resizingDone) {
            ...
            if (s.isSliding)
              // RE-SHOW 'object-masks' so objects won't show through sliding pane
              showMasks(pane, { resizing: true });
          }
        };
      },
      ...
      sizeMask = function () {
        ...
        if (s.tagName == "IFRAME" && s.isVisible)
          // no need to mask closed/hidden panes
          $M.css({
            top: s.offsetTop,
            left: s.offsetLeft,
            width: s.outerWidth,
      ...
      showMasks = function (pane, args) {
        ...
        $.each(panes, function (i, p) {
          ...
          if (
            s.isVisible &&
            (o.maskObjects || (!a.objectsOnly && o.maskContents))
          ) {
            getMasks(p).each(function () {
              sizeMask.call(this);
              this.style.zIndex = s.isSliding
                ? z.pane_sliding + 1
                : z.pane_normal + 1;
      ...
      destroy = function (evt_or_destroyChildren, destroyChildren) {
        ...
        // no event, so transfer 1st param to destroyChildren param
      ...
      removePane = function (evt_or_pane, remove, skipResize, destroyChild) {
        ...
        var o = options[pane],
          ...
          destroy =
            destroyChild !== undefined ? destroyChild : o.destroyChildren;
      ...
      close = function (evt_or_pane, force, noAnimation, skipCallback) {
        ...
        $N.queue(function (queueNext) {
          ...
          var abort =
            !s.isShowing && false === _runCallbacks("onclose_start", pane);
          ...
          if (s.isSliding)
            // pane is being closed, so UNBIND trigger events
            bindStopSlidingEvents(pane, false); // will set isSliding=false
          // resize panes adjacent to this one
          else sizeMidPanes(_c[pane].dir === "horz" ? "" : "center", false); // false = NOT skipCallback
      ...
      open = function (evt_or_pane, slide, noAnimation, noAlert) {
        ...
        $N.queue(function (queueNext) {
          ...
          if (s.autoResize && s.size != o.size)
            // resize pane to original size set in options
          ...
          if (slide)
            // START Sliding - will set isSliding=true
            bindStopSlidingEvents(pane, true);
          // BIND trigger events to close sliding-pane
          else if (s.isSliding)
            // PIN PANE (stop sliding) - open pane 'normally' instead
      ...
      slideClose = function (evt_or_pane) {
        ...
        if (s.isClosed || s.isResizing) {
          ...
          o.preventPrematureSlideClose &&
          evt &&
          $.layout.isMouseOverElem(evt, $Ps[pane])
        ) {
          // handle incorrect mouseleave trigger, like when over a SELECT-list in IE
        } else if (evt)
          // trigger = mouseleave - use a delay
        ...
        if (pane === "center") {
          ...
          if (s.noRoom) {
            ...
            if (s.wasOpen && o.closable) {
              if (o.autoReopen) open(pane, false, true, true);
              // true = noAnimation, true = noAlert
              // leave the pane closed, so just update state
              else s.noRoom = false;
          ...
          if (!s.noRoom) {
            ...
            // 'hide' pane if cannot just be closed
            else hide(pane, true); // true = noAnimation
          }
        }
      },
      /**
      ...
      sizePane = function (
        ...
        var pane = evtPane.call(this, evt_or_pane), // probably NEVER called from event?
          ...
          skipResizeWhileDragging =
            s.isResizing && !o.triggerEventsDuringLiveResize,
        ...
        $N.queue(function (queueNext) {
          ...
          if (doFX && $P.is(":visible")) {
            ...
            $P.css({ zIndex: z.pane_animate })
              .show()
              .animate(props, o.fxSpeed_size, easing, function () {
        ...
        $.each(panes, function (i, pane) {
          ...
          if (pane === "center") {
            ...
            if (!state.initialized && o.minWidth > newCenter.width) {
              var reqPx = o.minWidth - s.outerWidth,
      ...
      resizeAll = function (evt_or_refresh) {
        ...
        $.each(["south", "north", "east", "west"], function (i, pane) {
          ...
          if (
            ...
            o !== "undefined" &&
            o.responsive &&
            o.responsive.enabled
          ) {
            //if(s.size >= o.responsive.sizes.lg)
            if (windowWidth >= o.responsive.sizes.lg)
              if (
                o.responsive.when === "lg" ||
                o.responsive.when === "md" ||
                o.responsive.when === "sm" ||
                o.responsive.when === "xs"
              ) {
            ...
            if (
              windowWidth >= o.responsive.sizes.md &&
              windowWidth < o.responsive.sizes.lg
            )
              if (
                o.responsive.when === "md" ||
                o.responsive.when === "sm" ||
            ...
            if (
              windowWidth >= o.responsive.sizes.sm &&
              windowWidth < o.responsive.sizes.md
            )
            ...
            if (
              windowWidth >= o.responsive.sizes.xs &&
              windowWidth < o.responsive.sizes.sm
            )
        ...
        $.each(_c.allPanes, function (i, pane) {
          ...
          if (state[pane].isVisible)
            // undefined for non-existent panes
      ...
      sizeContent = function (evt_or_panes, remeasure) {
        ...
        $.each(panes, function (idx, pane) {
          ...
          if (
            (!s.isMoving && !s.isResizing) ||
            o.liveContentResizing ||
            remeasure ||
            m.top == undefined
          ) {
            _measure();
          ...
          function _measure() {
            var ignore = options[pane].contentIgnoreSelector,
              $Fs = $C
                .nextAll()
                .not(".ui-layout-mask")
                .not(ignore || ":lt(0)"), // not :lt(0) = ALL
            ...
            if ($F.length)
              ...
              m.spaceBelow =
                $F[0].offsetTop + $F.outerHeight() - m.bottom + _below($F);
            // no footer - check marginBottom on Content element itself
      ...
      sizeHandles = function (evt_or_panes) {
        ...
        $.each(panes, function (i, pane) {
          ...
          if (spacing === 0) {
            ...
            // skip if resizer was hidden for any reason
      ...
      swapPanes = function (evt_or_pane1, pane2) {
        ...
        if (
          false === _runCallbacks("onswap_start", pane1) ||
    ...
    function keyDown(evt) {
      ...
      if (CURSOR && options[PANE[code]].enableCursorHotkey)
        ...
        // check to see if this matches a custom-hotkey
        $.each(_c.borderPanes, function (i, p) {
          ...
          if (
            ...
            if (
              k &&
              code === (isNaN(k) || k <= 9 ? k.toUpperCase().charCodeAt(0) : k)
            ) {
              // Key matches
              pane = p;
              return false; // BREAK
    ...
    function allowOverflow(el) {
      ...
      var newCSS = { zIndex: options.zIndexes.resizer_normal + 1 },
        curCSS = {},
        of = $P.css("overflow"),
        ofX = $P.css("overflowX"),
        ofY = $P.css("overflowY");
    ...
    if (_create() === "cancel")
      // onload_start callback returned false to CANCEL layout creation
      return null;
    // true OR false -- if layout-elements did NOT init (hidden or do not exist), can auto-init later
    else return Instance; // return the Instance object
  };
})(jQuery);
...
(function ($) {
  ...
  $.ui.cookie = {
    ...
    write: function (name, val, cookieOpts) {
      ...
      document.cookie =
        name + "=" + (clear ? "" : encodeURIComponent(val)) + params; // write or clear cookie
    },
  ...
  $.layout.state = {
    ...
    _create: function (inst) {
      ...
      if ($.isPlainObject(sm.autoLoad)) {
        ...
        } // any other truthy value will trigger loadCookie
  ...
  $.layout.buttons = {
    ...
    init: function (inst) {
      ...
      $.each(
        ...
        function (i, action) {
          $.each(
            $.layout.buttons.config.borderPanes.split(","),
            function (ii, pane) {
    ...
    get: function (inst, selector, pane, action) {
      ...
      if ($E.length && $.layout.buttons.config.borderPanes.indexOf(pane) >= 0) {
        ...
        $E.addClass(btn + " " + btn + "-" + pane).data("layoutName", o.name); // add layout identifier - even if blank!
      }
      return $E;
    },
    ...
    addSlideToggle: function (inst, selector, pane, slide) {
      $.layout.buttons
        .get(inst, selector, pane, "slideToggle")
        .click(function (evt) {
      ...
      return this.queue(function () {
        ...
        if (show) {
          ...
          if (pos) {
            ...
            // dir === bottom
            else $el.css({ top: state.container.layoutHeight, bottom: "auto" });
          }
        ...
        $el.show().animate(animation, {
          ...
          complete: function () {
            ...
            if (show)
              // Restore left/right too
              $el.css($el.data(keyLR) || {}).removeData(keyLR);
            // Move the pane off-screen (left: -99999, right: 'auto')
            else $el.css(offscrn);
...
(function ($) {
  ...
  _.callbacks.resizeTabLayout = function (x, ui) {
    ...
    $P.filter(":visible")
      .find(".ui-layout-container:visible")
      .addBack()
      .each(function () {
