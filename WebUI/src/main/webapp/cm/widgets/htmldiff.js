  ...
  ((o = function (e) {
    ...
    (d = function (e, n, t, r, i, _, a, o) {
      ...
      return (
        null != (s = f(e, 0, t, r, i, _, a)) &&
          (r < s.start_in_before &&
            _ < s.start_in_after &&
            d(e, n, t, r, s.start_in_before, _, s.start_in_after, o),
          o.push(s),
          s.end_in_before <= i &&
            s.end_in_after <= a &&
            d(e, n, t, s.end_in_before + 1, i, s.end_in_after + 1, a, o)),
        o
      );
    }),
    (r = function (e) {
    ...
    ((c = {
      ...
      delete: function (e, n, t) {
        var r;
        return (
          (r = n.slice(e.start_in_before, +e.end_in_before + 1 || 9e9)),
          p("del", r)
        );
      },
