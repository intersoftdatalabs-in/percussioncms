...
(function ($) {
  ...
  $.fn.PercActionDataTable = function (config) {
    ...
    $.each(rows, function (index, row) {
      ...
      var rowMenu = Array.isArray(config.percMenus)
        ? config.percMenus[index]
        : config.percMenus;
  ...
  function getActionMenu(menu, rowData) {
    if (menu == undefined) menu = $.PercPageActions;
    ...
    if (rowData) menuDiv.data("data", rowData);
    return menuDiv;
  }
