...
(function ($) {
  $.perc_template_metadata_dialog = function (templateId) {
    ...
    function setMetaContent(templateId) {
      $.PercSiteTemplatesController(false).loadTemplateMetadata(
        templateId,
    ...
    function saveMetadata(templateId) {
      ...
      var metadataObj = {
        HtmlMetadata: {
          additionalHeadContent:
            additionalHeadContent[0].nextSibling.CodeMirror.getValue(),
          afterBodyStartContent:
            afterBodyStartContent[0].nextSibling.CodeMirror.getValue(),
          beforeBodyCloseContent:
            beforeBodyCloseContent[0].nextSibling.CodeMirror.getValue(),
          id: templateId,
      ...
      $.PercBlockUI();
      $.PercSiteTemplatesController(false).saveTemplateMetadata(
        metadataObj,
    ...
    function _addFieldGroups() {
      ...
      var fieldGroups = [
        {
          groupName: "perc-section-doctype-container",
          groupLabel: "DocType/HTML Tags",
          fieldNames: ["doctype"],
        },
        {
        ...
        {
          groupName: "perc-section-protected-container",
          groupLabel: "Protected Regions",
          fieldNames: ["protected_region", "protected_region_text"],
        },
      ];
      $.each(fieldGroups, function (index) {
        ...
        var groupHtml =
          "<div style='margin:0 -35px;padding: 15px 15px 15px 35px;cursor:pointer;' id = '" +
          this.groupName +
