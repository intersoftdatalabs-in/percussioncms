  ...
  $.widget("ui.perc_wizard", {
    ...
    _addButtons: function () {
      ...
      var buttons =
        ...
        "<button id='perc_wizard_finish' class='btn btn-primary' name='perc_wizard_finish' style='float:right;'>" +
        I18N.message("perc.ui.common.label@Finish") +
        "</button>" +
        "<button id='perc_wizard_next' class='btn btn-primary'  name='perc_wizard_next' style='float:right;'>" +
        I18N.message("perc.ui.common.label@Next") +
        "</button>" +
        "<button id='perc_wizard_cancel' class='btn btn-primary' name='perc_wizard_cancel' style='float:right;'>" +
        I18N.message("perc.ui.assign.workflow@Cancel") +
        "</button>" +
        "<button id='perc_wizard_back' class='btn btn-primary'  name='perc_wizard_back' style='float:right;'>" +
        I18N.message("perc.ui.common.label@Back") +
        "</button>" +
        "</div>";
  ...
  $.extend($.ui.perc_wizard, {
    ...
    defaults: {
      ...
      title:
        typeof I18N == "undefined"
          ? "Wizard"
          : I18N.message("perc.ui.common.label@Wizard"),
      onOk: function () {
