...
(function ($) {
  $.percFinderButtons = function () {
    ...
    function disableAllButtonsButSite() {
      $(".perc-finder-menu #perc-finder-preview")
        .addClass("ui-disabled")
        .removeClass("ui-enabled")
        .off("click"); //Disabled
      $(".perc-finder-menu #perc-finder-actions-button")
        .addClass("ui-disabled")
        .removeClass("ui-enabled")
        .off("click"); //Disabled
      $(".perc-finder-menu #perc-finder-delete")
        ...
        .addClass("ui-disabled")
        .off("click"); //Disabled
      $(".perc-finder-menu #perc-finder-new-folder")
        .addClass("ui-disabled")
        .removeClass("ui-enabled")
        .off("click"); //Disabled
      $(".perc-finder-menu #mcol-new-page")
        .addClass("ui-disabled")
        .removeClass("ui-enabled")
        .off("click"); //Disabled
      $(".perc-finder-menu #mcol-new-asset")
        .addClass("ui-disabled")
        .removeClass("ui-enabled")
        .off("click"); //Disabled
    }
    ...
    function createButtons(finder, contentViewer) {
      ...
      if (!isLibMode) {
        ns =
          '<a id="perc-finder-new-site" class="perc-form ui-state-default perc-font-icon icon-sitemap fas fa-sitemap" href="#" title="' +
          I18N.message("perc.ui.finder.buttons@Click New Site") +
          '"></a>';
