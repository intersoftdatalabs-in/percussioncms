 ...
 **/
  var MillerColumn = {
    _init: function () {
      ...
      this.element
        .addClass("ui-widget ui-widget-content mcol")
        .append($("<table></table>").append(thetr));
    ...
    removeQueued: function () {
      this._getData("tr")
        ...
        .children()
        .eq(0)
        .animate({ width: "0px" }, "fast", "linear", function () {
          $(this).find("tr.remover-row").empty();
          $(this).css("width", "auto");
        });
    },
