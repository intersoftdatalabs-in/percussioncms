...
(function ($) {
  ...
  $.perc_browser = function (options) {
    ...
    var leaf_selectable =
      settings.selectable_object == "leaf" ||
      settings.selectable_object == "all";
    var folder_selectable =
      settings.selectable_object == "folder" ||
      settings.selectable_object == "all";

    var top = window.parent.parent.jQuery(
      "<div>" +
    ...
    var path_select = top
      .find("#perc-saveas-dialog-location")
      .on("change", function () {
    ...
    if (settings.new_folder_opt) {
      top
        .parent()
        .find("#perc-saveas-dialog-new-folder")
        .on("click", function (e) {
          new_folder_callback();
        });
    } else {
