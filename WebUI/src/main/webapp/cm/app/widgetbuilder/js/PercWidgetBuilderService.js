...
(function ($) {
  ...
  function _getWidgetDefSummaries(callback) {
    _makeServiceCall(
      $.perc_paths.WIDGET_DEFS_SUMMARIES,
  ...
  function _deleteWidgetDef(widgetDefId, callback) {
    _makeServiceCall(
      $.perc_paths.WIDGET_DEF + widgetDefId,
  ...
  function _deployWidget(widgetDefId, callback) {
    _makeServiceCall(
      $.perc_paths.WIDGET_DEF_DEPLOY + widgetDefId,
  ...
  function _validate(widgetDefFull, callback) {
    _makeServiceCall(
      $.perc_paths.WIDGET_DEF_VALIDATE,
      $.PercServiceUtils.TYPE_POST,
      widgetDefFull,
      callback
    );
