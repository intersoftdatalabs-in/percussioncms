...
<div class="perc-main">
    ...
    <div class="ui-layout-north" style="padding: 0px 0px; overflow:visible">
        ...
        <div id="tabs" class = 'perc-template-tabs'>
            <ul>
                <li>
                    <a role="button" tabindex="0" title='<i18n:message key="perc.ui.web.mgt@Content"/>' id="perc-tab-content" href="#tabs-2" ><i18n:message key="perc.ui.web.mgt@Content"/></a>
                </li>
                <li><a role="button" tabindex="0" title='<i18n:message key = "perc.ui.web.mgt@Layout"/>' id="perc-tab-layout" href="#tabs-3" ><i18n:message key = "perc.ui.web.mgt@Layout"/></a></li>
                <li><a role="button" tabindex="0" title='<i18n:message key = "perc.ui.web.mgt@Style"/>' id="perc-tab-style" href="#tabs-4" ><i18n:message key = "perc.ui.web.mgt@Style"/></a></li>
