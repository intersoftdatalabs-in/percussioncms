    ...
    function puff() {
      ...
      function sortDepths(regionDepths, regionDepthsSorted) {
        for (id in regionDepths) {
          regionDepthsSorted.push({
            regionId: id,
            regionDepth: regionDepths[id],
          });
        }
        regionDepthsSorted.sort(function (regionx, regiony) {
          return regiony.regionDepth - regionx.regionDepth;
        });
      }
      ...
      function puffFromRegionToParent(regionDiv) {
        ...
        var direction = parent.hasClass("perc-vertical")
          ? "vertical"
          : "horizontal";
        if (direction == "vertical") {
          ...
          if (biggestWidth > parent.width()) parent.css("width", biggestWidth);
          if (totalHeight > parent.height()) parent.css("height", totalHeight);
        } else {
