...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $("#perc-servers-container").on("change", "#perc-driver", function () {
      ...
      $("#perc-editor-wrapper").load(
        "../app/includes/serverEditors/propEditor.jsp?editorName=" +
          driverValue,
        function () {
          if (driverValue == "FTP") {
            loadPrivateFileKey();
  ...
  function renderEditor(serverName, propertyObj, serverType) {
    ...
    $("#perc-editor-form").load(
      "../app/includes/serverEditors/serverEditor.jsp",
      function () {
  ...
  function setEditorProperties(propObj) {
    ...
    propContainer
      .find('input[percName="serverName"]')
    ...
    $.each(serverProperties, function (name, value) {
      ...
      if (propertyName == "ignoreUnModifiedAssets") {
        if (propertyValue == true)
          $("#perc-editor-prop-container")
            .find("span[percName=" + propertyName + "]")
            .text("Only modified assets will be published.");
        else
          $("#perc-editor-prop-container")
            .find("span[percName=" + propertyName + "]")
            .text("All assets will be published.");
