...
(function ($) {
  ...
  $.perc_load_template = function (template_id, div) {
    ...
    function set_widget_drops() {
      ...
      $.perc_pagemanager.get_widget_ctypes(
        template_id,
        false,
        set_drops,
        ut.show_error,
    ...
    function load_content() {
      ...
      $.perc_templatemanager.load_template(template_id, function (xml) {
        var root_region_id = $.xmlDOM(xml)
          .find("rootRegion>children>region>regionId")
          .text();
        $.perc_templatemanager.render_region(
          root_region_id,
          xml,
          function (data) {
    ...
    function after_load() {
      var actions = [
        {
          ...
          action: function (assetid, widgetid, widgetdefid, id) {
            clear_asset(assetid, widgetid, widgetdefid, id);
          },
        },
        {
          icon: function () {
      ...
      all_widgets().perc_decorate(true, actions, template_id).droppable({
        accept: "#nothing",
        scope: $.perc_iframe_scope,
        activeClass: "perc-widget-active",
        hoverClass: "perc-widget-hover",
      });
      set_widget_drops();
    }
  ...
  $.perc_content_viewer = function (options) {
    ...
    function _previewPage() {
      ...
      if (_isPageDirty()) {
        ...
        $.fn.jmodal({
          ...
          buttonText: {
            button1: I18N.message("perc.ui.content.viewer@Yes Button"),
            button2: I18N.message("perc.ui.content.viewer@No Button"),
            button3: "",
          },
          fixed: true,
    ...
    function _openPage(id, name) {
      ...
      $("#perc-pageEditor-show-hide")
        ...
        .on("click", function () {
          decorated = !decorated;
          var label = decorated
            ? I18N.message("perc.ui.webmgt.pageeditor.menu@Hide")
            : I18N.message("perc.ui.webmgt.pageeditor.menu@Show");
          $(this).html(label);
          redecorate();
        });
      ...
      var dummy = false;
      tabs.tabs("option", "active", function (event) {
        if (dummy) {
          dummy = false;
          return true;
        }
    ...
    function clear() {
      ...
      $("#perc-pageEditor-show-hide").off().addClass("ui-state-disabled");
      $("#perc-metadata-button").off().addClass("ui-meta-pre-disabled");
      $("#perc-preview-button").off().addClass("ui-meta-pre-disabled");
      ...
      actions = [
        {
          ...
          action: function (assetid, widgetid, widgetdefid, pageid) {
            _clearAssetFromPage(assetid, widgetid, widgetdefid, pageid);
          },
        },
        {
          icon: function () {
    ...
    function reload() {
      ...
      if ($.perc_use_iframe) {
        ...
        if ($.browser.mozilla) {
          ...
          $.perc_pagemanager.render_page(_getPageId(), function (page) {
            load_iframe(page);
            redecorate();
            set_widget_drops();
          });
    ...
    function redecorate() {
      decorateCallback();
      all_widgets().perc_decorate(decorated, actions, pageId).droppable({
        accept: "#nothing",
        scope: $.perc_iframe_scope,
        activeClass: "perc-widget-active",
        hoverClass: "perc-widget-hover",
      ...
      all_regions()
        ...
        .droppable({
          accept: ".perc-widget",
          scope: $.perc_iframe_scope,
          activeClass: "perc-region-active",
          hoverClass: "perc-region-hover",
    ...
    function _addWidgetAssociation(wdgName, region) {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          add_widget(wdgName, regionId, function () {
            reload();
          });
        },
        type: "GET",
    ...
    function add_widget(wdgName, regionId, k) {
      ...
      var region_assoc = $.grep(assocs, function (x) {
      ...
      region_assoc.widgetItems.push({
        definitionId: wdgName,
        _tagName: "widgetItem",
      });
      ...
      $.ajax({
        ...
        error: function (error) {
          alert(
            I18N.message("perc.ui.content.viewer@Add Widget Error") +
              wdgName +
