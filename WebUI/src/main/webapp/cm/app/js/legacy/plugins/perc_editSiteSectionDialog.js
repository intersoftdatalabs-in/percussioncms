    ...
    function openDialog(site, callback) {
      ...
      dialog = $(
        "<div>" +
          ...
          "<div style='background: #E6E6E9; padding-top: 5px; padding-right: 10px; text-align:right;'><label>" +
          I18N.message("perc.ui.general@Denotes Required Field") +
          "</label></div>" +
          '<div class="fieldGroup">' +
          "<div id='perc-site-general-container'>" +
          "<label for='perc-site-hostname' class='perc-required-field'>" +
          I18N.message("perc.ui.editSiteSectionDialog.label@Site hostname") +
          ":</label> <br/> " +
          ...
          '<label for="perc-canonical-url-dist-sections" id="perc-canonical-url-dist-sections-label">' +
          I18N.message("perc.ui.editSiteSectionDialog.label@Sections") +
          "</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
          ...
          '<label for="perc-canonical-url-dist-pages" id="perc-canonical-url-dist-pages-label">' +
          I18N.message("perc.ui.editSiteSectionDialog.label@Landing Pages") +
          "</label> <br/>" +
          "<label for='perc-arrow-key-message'(>" +
          I18N.message("perc.ui.users@ArrowKeys") +
          ")</label> <br/> " +
          ...
          "<label for='perc-site-gen-sitemap' id='perc-site-gen-sitemap-label'>" +
          I18N.message("perc.ui.editSiteSectionDialog.label@Generate sitemap") +
          "</label> <br/> " +
          ...
          "<label for='perc-site-gen-sitemap-exclude-image' id='perc-site-gen-sitemap-label-exclude-image'>" +
          "Exclude Image" +
          "</label> <br/> " +
          "<label id='perc-site-protocol-label' for='perc-site-protocol'>" +
          I18N.message("perc.ui.editSiteSectionDialog.label@Protocol") +
          ":</label> <br/> " +
          ...
          "</select> <br/> " +
          "<label for='perc-site-default-document' id='perc-site-default-document-label'>" +
          I18N.message("perc.ui.editSiteSectionDialog.label@Default document") +
          ":</label> <br/> " +
          ...
          "<label id='perc-site-folder-permission-label' for='perc-site-folder-permission'>" +
          I18N.message("perc.ui.folderPropsDialog.label@Permission") +
          ":</label> <br/> " +
          // refactored from radio buttons to drop downs
          "<select name='perc-site-folder-permission' tabindex='0' id='perc-site-folder-permission'>" +
          "     <option id='perc-folder-permission-option-read' value='" +
          $.PercFolderHelper().PERMISSION_READ +
          "'>" +
          I18N.message("perc.ui.folderPropsDialog.permissionValue@Read") +
          "</option>" +
          "     <option id='perc-folder-permission-option-write' value='" +
          $.PercFolderHelper().PERMISSION_WRITE +
          "'>" +
          I18N.message("perc.ui.folderPropsDialog.permissionValue@Write") +
          "</option>" +
          "</select>" +
        ...
        percButtons: {
          Save: {
            click: function () {
              ...
              if (
                secureSiteCheck.data("originalValue") &&
                !secureSiteCheck.is(":checked")
              ) {
                ...
                var options = {
                  ...
                  question:
                    ...
                    I18N.message("perc.ui.edit.site.section.dialog@Warning") +
                    "</span> <BR> " +
      ...
      function _addFieldGroups() {
        ...
        $.each(fieldGroups, function (index) {
          ...
          var minmaxClass =
            index === 0 ? "perc-items-minimizer" : "perc-items-maximizer";
          var groupHtml =
            "<div class='perc-section-header'>" +
            "<div class='perc-section-label' data-group='" +
            this.groupName +
            "'>" +
            "<span tabindex='" +
            tabindexArr.at(counter) +
            "' title='" +
            this.groupLabel +
            "' class='perc-min-max " +
            minmaxClass +
      ...
      function getSecureSectionFieldGroups() {
        ...
        fieldGroups =
          ...
          I18N.message("perc.ui.editSiteSectionDialog.label@Login page") +
          ":</label><br/>" +
      ...
      $("#perc-enable-canonical-url").on("click", function () {
        _handleCanonicalOption();
      });

      $("#perc-site-registration-confirmation-page-browse").on(
        "click",
        function () {
      ...
      $("#perc-site-login-page")
        ...
        .on("keypress keydown", function (evt) {
          ...
          if (evt.charCode === 0 || typeof evt.charCode == "undefined") return;
          evt.preventDefault();
        });
      ...
      $.PercSiteService.getSiteProperties(site, function (status, result) {
        if (status === $.PercServiceUtils.STATUS_SUCCESS) {
          ...
          else $("#perc-enable-canonical-url").prop("checked", false);
          // Enabling/disabling other "canonical" options depending on check/uncheck option
          _handleCanonicalOption();

          //Set the protocol.
          if (props.siteProtocol)
            $("#perc-site-protocol").val(props.siteProtocol);
          ...
          if (
            props.generateSiteMapOptions.generateSitemapExcludeImage == true
          ) {
          ...
          else $("#perc-replace-canonical-tags").prop("checked", false);
          ...
          if (
            props.folderPermission.accessLevel ===
            $.PercFolderHelper().PERMISSION_READ
          )
            $("#perc-folder-permission-option-read").prop("selected", true);
          else $("#perc-folder-permission-option-write").prop("selected", true);
          ...
          if (props.folderPermission.writePrincipals) {
            ...
            writePrincipals = Array.isArray(writePrincipals)
              ? writePrincipals
              : [writePrincipals];
          }
          ...
          if (props.isSecure) secureSiteCheck.prop("checked", true);
          else secureSiteCheck.prop("checked", false);
          ...
          $.PercUserService.getUsers(function (status, usersJson) {
            ...
            self.listEditor = $.PercListEditorWidget({
              ...
              toggleroff: [
                $.PercFolderHelper().PERMISSION_WRITE,
                $.PercFolderHelper().PERMISSION_ADMIN,
              ],
