...
(function ($) {
      ...
      $.ajax({
        ...
        success: function (data, textstatus) {
          ...
          if ($cssTheme.length === 0) {
            // There is no CSS override, make one.
   ...
   */
  function set_theme_for_template(
    templateID,
    themeName,
    k,
    err,
          ...
          $.ajax({
            ...
            error: function (data, textstatus) {
              $.perc_utils.alert_dialog({
                ...
                content: $.PercServiceUtils.extractDefaultErrorMessage(data),
              });
            },
          });
        }
