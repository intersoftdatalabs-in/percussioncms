...
(function ($) {
  ...
  $.PercRecentListService = {
    ...
    RECENT_TYPES: [
      this.RECENT_TYPE_ITEM,
      this.RECENT_TYPE_TEMPLATE,
      this.RECENT_TYPE_SITE_FOLDER,
      this.RECENT_TYPE_ASSET_FOLDER,
    ],
  };
  ...
  function getRecentList(type, site) {
    ...
    if (!$.inArray(type, $.PercRecentListService.RECENT_TYPES)) {
      ...
      if (
        type === $.PercRecentListService.RECENT_TYPE_TEMPLATE ||
