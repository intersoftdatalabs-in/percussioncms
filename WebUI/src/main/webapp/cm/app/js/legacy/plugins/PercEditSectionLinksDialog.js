    ...
    function openDialog(
      ...
      dialog = $(
        "<div>" +
          ...
          taborder +
          "' id='perc-external-link-text' name='perc-external-link-text' maxlength='100'/> <br/>" +
          ...
          taborder +
          "' id='perc-external-link-url' class='required url_name' name='perc-external-link-url' maxlength='512'/><br/> " +
          ...
          "<input type='text' tabindex='" +
          taborder +
          "' id='perc-external-link-navigation-cssclassnames' maxlength='255' name='perc-external-link-navigation-cssclassnames'/> <br/>" +
          "</fieldset>" +
          "</div>" +
