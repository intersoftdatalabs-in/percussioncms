...
(function ($) {
  ...
  function openUploadDialog(finder) {
    ...
    function createDialog() {
      ...
      var dialogContent =
        "<div id='perc-design-file-upload'>" +
        '<form id="perc-theme-file-upload-form" name="perc-theme-file-upload-form" enctype="multipart/form-data" method="post" action="' +
        actionUrl +
        '">' +
    ...
    function checkElementWithSameNameOrUpload() {
      ...
      $.PercWebResourcesService.validateFileUpload(
        path,
        fileName,
    ...
    function uploadFile() {
      ...
      dialog
        .find('input[name="upload-theme-file-path"]')
        .val("/" + encodedPath.slice(3).join("/") + "/" + fileName);
    ...
    function initializePath() {
      ...
      if (
        typeof selectedItemSpec !== "undefined" &&
