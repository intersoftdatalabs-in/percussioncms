...
(function ($) {
  $.PercListEditorWidget = function (options) {
    ...
    var html =
      '<div id="perc-ui-listedit-header">' +
      ...
      '        <input id="perc-ui-permission-usernamefield" tabindex="0" title="' +
      I18N.message("perc.ui.rolePropsDialog.title@Enter a role") +
      '" name="perc-ui-permission-usernamefield"/>' +
      '        <div id="perc-ui-permission-plusbutton" tabindex="0" role="button" title="' +
      I18N.message("perc.ui.rolePropsDialog.title@Add User") +
      '"></div>' +
      "    </div>" +
      "" +
