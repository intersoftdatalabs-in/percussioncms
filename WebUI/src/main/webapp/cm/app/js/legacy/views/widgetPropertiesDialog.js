...
(function ($, P) {
  P.widgetPropertiesDialog = function (
    setWidgetProperty,
    widgetProperties,
    widgetDefinitionId,
    postCallback,
    ...
    $.perc_widget_definition_client.restGetWidgetDefinition(
      ...
      function (widgetDef) {
        if (widgetProperties) {
          if (
            typeof widgetProperties.sys_perc_name !== "undefined" &&
            typeof widgetProperties.sys_perc_description !== "undefined"
          ) {
            widgetDef.userPrefDef.sys_perc_name = new $.perc_sys_pref(
              "perc_sys_name",
              "",
              "Name",
              "sys_perc_name",
        ...
        var dialogOptions = {
          ...
          percButtons: {
            ...
            Cancel: {
              ...
              id: "perc-widget-properties-cancel",
            },
          },
        ...
        var dlgHeight = "auto";
        if (numOfFields > 10) dlgHeight = "700";
        if (
          $("#perc_edit_widget_properties > #perc-section-system-container")
            .length === 0
        )
    ...
    function saveProperties() {
      ...
      if (requiredFieldsValid === true) {
        ...
        if (
          ...
          widgetName !== "" &&
          widgetName !== originalName &&
          getWidgetByName(widgetName) !== null
        ) {
    ...
    function _addFieldGroups() {
      ...
      if (dialog.find("#perc-section-system-container").length > 0)
        dialog
          .find(".ui-dialog-content.ui-widget-content")
          .addClass("group-style");
      ...
      $.each(fieldGroups, function (index) {
        ...
        var groupHtml =
          ...
          "<div class='perc-section-label' data-perc-group-name='" +
          this.groupName +
          "'>" +
  ...
  $.perc_widget_definition_model = function () {
    ...
    this.render = function () {
      ...
      for (let u in this.userPrefDef) {
        if (
          (this.userPrefDef[u].name === "sys_perc_name" ||
            this.userPrefDef[u].name === "sys_perc_description") &&
          (this.userPrefDef[u].datatype === "perc_sys_name" ||
            this.userPrefDef[u].datatype === "perc_sys_description")
        )
          sysProperties += "\t" + this.userPrefDef[u].render();
        else properties += "\t" + this.userPrefDef[u].render();
      }
      ...
      if (
        $(html).find("input,textarea,select").filter("[required]").length > 0
      ) {
        html.append(
          "<div><p>" +
  ...
  $.perc_sys_pref = function (
    ...
    this.render = function () {
      ...
      if (datatype === "perc_sys_name") {
        var value =
          typeof this.realValue != "undefined"
            ? this.realValue
            : this.default_value;
        buff = "<tr>\n";
        buff +=
          ...
          "</tr>\n";
        buff +=
          '   <td><input class="perc-widget-property" name="' +
          this.name +
          '" type="text" value="' +
          value +
          '" data-perc-original-value="' +
          value +
          '" maxlength="30"></td>\n' +
          "</tr>\n";
        buff += "</tr>\n";
      ...
      if (datatype === "perc_sys_description") {
        ...
        buff +=
          ...
          "</tr>\n";
        buff +=
          '   <td><textarea style="resize: none; border: 1px inset #F0F0F0; padding: 2px; height: 40px" class="perc-widget-property" name="' +
          this.name +
  ...
  $.perc_user_pref = function (
    ...
    this.render = function () {
      ...
      if (datatype2 === "string" || datatype2 === "number") {
        ...
        var checked =
          value2 === true || value2 === "true" || value2 === "on"
            ? "CHECKED "
            : "";
        buff +=
          '   <td class = "checkbox-size"><input class="perc-widget-property" name="' +
          this.name +
          '" type="checkbox" ' +
          checked +
          this.required_attr +
        ...
        buff += "   <td>\n";
        buff +=
          '   <select class="perc-widget-property" name="' +
          this.name +
          '" ' +
          this.required_attr +
          ">\n";
        ...
        buff +=
          ...
          "</tr>\n";
        buff +=
          '   <td><textarea class="perc-widget-property" name="' +
          this.name +
          '">\n';
        for (let v in values) {
          buff += values[v] + "\n";
