...
(function ($, P) {
  ...
  P.pageView = function () {
    ...
    if (
      $.PercNavigationManager.getView() === $.PercNavigationManager.VIEW_EDITOR
    ) {
    ...
    function openPage(pageId, pageName) {
      ...
      var pglabel =
        $.PercNavigationManager.getMode() === $.PercNavigationManager.MODE_EDIT
          ? I18N.message("perc.ui.page.label@Editing Page")
          : I18N.message("perc.ui.page.label@Viewing Page");
      var pgType =
        $.PercNavigationManager.getMode() === $.PercNavigationManager.MODE_EDIT
          ? "page-editing"
          : "page-viewing";
      ...
      if (
        ...
        pageModel = P.pageModel(
          ...
          function () {
            ...
            $tabs
              .data("disabled.tabs", [])
              .tabs("option", "active", defaultTabIndex);
            $("#perc-pageEditor-tabs")
              .find("li")
              .each(function (i) {
                // Don't enable Layout and Style tabs if template type is UNASSIGNED
                if (
                  pageModel.getTemplateModel().getTemplateType() !== unassigned
                ) {
            ...
            if (isAdmin || isDesigner) {
              actionsDropdown.PercDropdown({
                ...
                percDropdownOptionLabels: [
                  I18N.message("perc.ui.page.menu@Actions"),
                  I18N.message("perc.ui.page.menu@Edit Metadata"),
                  I18N.message("perc.ui.page.menu@Edit Template"),
                  I18N.message("perc.ui.page.menu@Change Template"),
                ],
                ...
                percDropdownCallbackData: [
                  I18N.message("perc.ui.page.menu@Action"),
                  I18N.message("perc.ui.page.menu@Edit Metadata"),
                  I18N.message("perc.ui.page.menu@Edit Template"),
                  I18N.message("perc.ui.page.menu@Change Template"),
                ],
      ...
      if (
        ...
        actionsDropdown.PercDropdown({
          ...
          percDropdownOptionLabels: [
            I18N.message("perc.ui.page.menu@Actions"),
            I18N.message("perc.ui.page.menu@View Metadata"),
          ],
          percDropdownCallbacks: [
            function () {},
            function () {
      ...
      function _addToMyPages(pageId) {
        $.PercPageService.addToMyPages(pageId, function (status, result) {
          if (status == $.PercServiceUtils.STATUS_ERROR) {
            ...
            $(".perc-my-pages-action")
              .removeClass("perc-add-to-my-pages")
              .addClass("perc-remove-from-my-pages")
              .attr(
                "title",
                I18N.message("perc.ui.page.mypages@Remove from My Pages"),
      ...
      function _removeFromMyPages(pageId) {
        $.PercPageService.removeFromMyPages(pageId, function (status, result) {
          if (status === $.PercServiceUtils.STATUS_ERROR) {
            ...
            $(".perc-my-pages-action")
              .removeClass("perc-remove-from-my-pages")
              .addClass("perc-add-to-my-pages")
              .attr(
                "title",
                I18N.message("perc.ui.page.mypages@Add to My Pages"),
      ...
      function addMoreMenus() {
        if (isAdmin || isDesigner) {
          ...
          layoutActionsDropdown.PercDropdown({
            ...
            percDropdownCallbackData: [
              I18N.message("perc.ui.page.menu@Action"),
              I18N.message("perc.ui.page.menu@Edit TemplateEdit Template"),
              I18N.message("perc.ui.page.menu@Change Template"),
            ],
            percDropdownDisabledFlag: [false, true, true],
          });
          ...
          layoutActionsDropdown.PercDropdown({
            ...
            percDropdownCallbacks: [function () {}, _changeTemplate],
            percDropdownCallbackData: [
              I18N.message("perc.ui.page.menu@Action"),
              I18N.message("perc.ui.page.menu@Change Template"),
            ],
        ...
        layoutViewDropdown.PercDropdown({
          ...
          percDropdownOptionLabels: [
            I18N.message("perc.ui.page.menu@View"),
            I18N.message("perc.ui.menu@JavaScript Off"),
            I18N.message("perc.ui.page.menu@Hide Guides"),
          ],
          percDropdownCallbacks: [
            function () {},
            function () {},
          ...
          function (status, result) {
            if (status) {
              ...
              if (pubActions.length > 0) {
                var actionNames = [
                  I18N.message("perc.ui.page.menu@Publishing"),
                ];
        ...
        if (
          ...
          var viewDropDownData = {
            ...
            percDropdownOptionLabels: [
              I18N.message("perc.ui.page.menu@View"),
              I18N.message("erc.ui.page.menu@Revisions"),
              I18N.message("perc.ui.page.menu@Comments"),
              I18N.message("perc.ui.page.menu@Preview"),
              I18N.message("perc.ui.page.menu@Publishing History"),
              I18N.message("perc.ui.menu@JavaScript Off"),
            ],
            percDropdownCallbacks: [
              $.noop,
    ...
    function populateOrphanAssets(status, unusedAssets) {
      ...
      if (unusedAssets.length > 0) {
        ...
        for (let i = 0; i < unusedAssets.length; i++) {
          ...
          var folderPaths = "";
          if (
            typeof asset.folderPaths != "undefined" &&
            asset.folderPaths.length > 0
          ) {
            hoverText =
              asset.folderPaths[0].replace("//Folders/$System$", "") +
              "/" +
              asset.name;
          ...
          orphanAssetsContainer.append(
            $("<a />")
              ...
              .append(
                $("<div />")
                  ...
                  .append(
                    $("<img />")
                      .attr("src", asset.icon)
                      .data("iconSrc", asset.icon)
                      .data("overIconSrc", asset.overIcon)
              ...
              .data("assetFolderPaths", folderPaths)
              .data("widgetId", asset.widgetId)
              .off("click")
    ...
    function initOrphanAssetsMenu() {
      ...
      $(".perc-ui-delete-asset")
        .attr("src", "/cm/images/icons/editor/deleteInactive.png")
        .off();
      $(".perc-ui-edit-asset")
        .attr("src", "/cm/images/icons/editor/editInactive.png")
        .off();
    }
    ...
    function deleteOrphanAsset(event) {
      ...
      var assetmsg =
        i < 2
          ? I18N.message("perc.ui.page.general@asset")
    ...
    function orphanAssetDeleted() {
      ...
      var remainingAssets = $("#perc_asset_library")
        .find(".perc-orphan-assets-list")
        .find("a");
    ...
    function selectOrphanAsset(e, obj) {
      ...
      if (selected.length > 0) {
        $(".perc-ui-delete-asset")
          .attr("src", "/cm/images/icons/editor/delete.png")
          .off("click")
          .on("click", function (evt) {
            deleteOrphanAsset(evt);
          });
        $(".perc-ui-edit-asset")
          .attr("src", "/cm/images/icons/editor/edit.png")
          .on("click", function (evt) {
            editOrphanAsset(evt);
          });
      } else {
    ...
    function clearSelection() {
      $(".perc-orphan-assets-list")
        .find("a")
        .removeClass("perc-orphan-assets-selected");
      $(".perc-ui-delete-asset")
        .attr("src", "/cm/images/icons/editor/deleteInactive.png")
        .off();
      $(".perc-ui-edit-asset")
          ...
          $.PercItemPublisherService.getScheduleDates(
            ...
            function (status, result) {
              ...
              if (
                ...
                pageStatus === I18N.message("perc.ui.page.general@Pending")
              ) {
    ...
    function _publishItem(callbackData) {
      ...
      if (siteName === undefined && itemType === "Page") {
        ...
        var currentItemPath =
          $.perc_finder().getPathItemById(itemId).folderPath;
        siteName = currentItemPath
          .replace("/" + $.perc_paths.SITES_ROOT, "")
          .split("/")[1];
      }
            ...
            doIfDefaultServerNotModified(
              ...
              function () {
                if (trName === I18N.message("perc.ui.page.menu@Publish")) {
                  ...
                  trName ===
                  I18N.message("perc.ui.page.menu@Remove from Staging")
                ) {
                  $.PercBlockUI();
    ...
    function _afterPublish(success, results) {
      if (!success) {
        ...
        if (
          ...
          publishStatus ===
          $.PercItemPublisherService.PUBLISHER_JOB_STATUS_BADCONFIG
        ) {
          $.unblockUI();
          $.perc_utils.alert_dialog({
            title: I18N.message(
    ...
    function doIfDefaultServerNotModified(siteName, callback) {
      $.PercNavigationManager.loadSiteProperties(
        siteName,
        function (siteProperties) {
          $.PercItemPublisherService.isDefaultServerModified(
            siteProperties.id,
            function (status, result) {
              if (status) {
                if (result) {
