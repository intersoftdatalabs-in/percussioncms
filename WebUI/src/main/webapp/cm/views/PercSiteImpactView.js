...
(function ($) {
  ...
  function renderSiteImpact(itemId, itemType, rootElement) {
    ...
    function _renderResults(status, result) {
      ...
      $("#perc-site-impact-pages-wrapper .perc-site-impact-item").on(
        "click",
        function () {
    ...
    function _createSiteImpactHtml(siteImpactData) {
      ...
      var config = {
        ...
        fnDrawCallback: function (oSettings) {
          rootElement.find("table").removeAttr("style");
        },
        bPaginate: false,
        percHeaders: [
          I18N.message("perc.ui.site.impact.view@Page Name"),
          I18N.message("perc.ui.site.impact.view@Site"),
          I18N.message("perc.ui.site.impact.view@Status"),
        ],
        aoColumns: [
          {
            sType: "string",
      ...
      var templateConfig = {
        ...
        percHeaders: [
          I18N.message("perc.ui.site.impact.view@Template Name"),
          I18N.message("perc.ui.site.impact.view@Site"),
        ],
        aoColumns: [
          {
      ...
      rootElement
        .find(".perc-site-impact-templates")
        .PercDataTable(templateConfig);
    }
