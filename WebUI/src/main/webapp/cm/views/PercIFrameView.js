...
(function ($) {
  ...
  function saveContent(isNew) {
    ...
    showMandatoryFieldAlertPopUp =
      $.perc_utils.checkMandatoryFieldsEmpty(frame);
  ...
  function addAssetToFolder(frame) {
    ...
    if (assetContentId === undefined || assetContentId === "") {
      $.perc_utils.alert_dialog({
        ...
        content: I18N.message("perc.ui.iframe.view@Unable To Create Asset"),
      });
      return;
    }
    ...
    $.PercAssetController.putAssetInFolder(
      assetContentId,
      path,
      function (status, res) {
