...
(function ($) {
  $.PercPublishLogsMinuetView = function () {
    ...
    function bindLogActions() {
      ...
      $("#percSitePublishingLogList .perc-sortable-header").on(
        "click keydown",
        function (event) {
    ...
    function bindLogDetailsEvents() {
      ...
      $(".perc-publish-item-details-button").on("click", function () {
        ...
        $("#percPublishItemLogDetailsTarget").animateCss(
          "fadeOut faster",
          function () {
            processTemplate(
              itemData,
      ...
      $("#percSitePublishingLogDetails .perc-sortable-header").on(
        "click keydown",
        function (event) {
          if (event.type == "click" || event.which == 13) {
            sortLogField(
    ...
    function sortLogField(
      ...
      $("#" + targetId + " .perc-sortable-header")
        .not($(eventObj))
        .removeClass("perc-active-sort")
        .addClass("perc-inactive-sort")
        .data("perc-ort-order", "desc");
      $(eventObj)
        .addClass("perc-active-sort")
        .removeClass("perc-inactive-sort");
