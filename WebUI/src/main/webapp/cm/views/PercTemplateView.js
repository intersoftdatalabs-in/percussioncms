...
(function ($, P) {
  ...
  P.templateView = function () {
    ...
    function loadTab(index) {
      if (index === TEMPLATE_CONTENT) {
        ...
        var actionNames = [
          ...
          I18N.message("perc.ui.template.design.view@Edit Meta Data"),
          I18N.message("perc.ui.template.design.view@Edit Page"),
        ];
        ...
        percTemplateView.PercDropdown({
          ...
          percDropdownCallbackData: [
            I18N.message(I18N.message("perc.ui.template.design.view@View")),
            I18N.message("perc.ui.menu@JavaScript Off"),
          ],
        ...
        $("#perc-metadata-button")
          .find("img")
          .attr("src", "/cm/images/icons/buttonMetadata.png")
      ...
      if (index === TEMPLATE_LAYOUT) {
        ...
        layoutViewDropdown.PercDropdown({
          ...
          percDropdownOptionLabels: [
            I18N.message("perc.ui.template.design.view@View"),
            I18N.message("perc.ui.menu@JavaScript Off"),
            I18N.message("perc.ui.template.design.view@Hide Guides"),
          ],
          percDropdownCallbacks: [
            function () {},
            function () {},
        ...
        $.PercTemplateService().checkImportLogExists(
          gSelectTemp,
        ...
        var actionNamesHelp = [
          I18N.message("perc.ui.template.design.view@Help"),
          I18N.message("perc.ui.template.design.view@Download Report Log"),
          I18N.message("perc.ui.template.design.view@Video Tutorials"),
          I18N.message("perc.ui.template.design.view@Import FAQs"),
          I18N.message("perc.ui.template.design.view@Percussion Community"),
          I18N.message("perc.ui.template.design.view@More Help"),
        ];
        var disableActionsHelp = [
          false,
          percTemplateHelpLayoutMenu,
          true,
          true,
          true,
          true,
        ...
        percTemplateHelpLayout.PercDropdown({
          ...
          percDropdownCallbacks: [
            ...
            function () {
              openUrl("MoreHelp", "https://percussioncmshelp.intsof.com");
            },
          ],
          percDropdownCallbackData: [
            I18N.message("perc.ui.template.design.view@Help"),
    ...
    function showVideoIframe() {
      $("#perc_video_tutorial_dialog")
        .find("#perc_iframe_video")
        .attr("height", "400px");
    }

    function handleUnreachableURL() {
      $("#perc_video_tutorial_dialog")
        .find("#perc_notfound_image")
        .attr("height", "400px");
    }
      ...
      $.PercPathService.getPathItemById(
        ...
        function (status, data) {
          if (status === $.PercServiceUtils.STATUS_SUCCESS) {
            ...
            data.PathItem.path =
              folderPath.replace("//", "/") + "/" + data.PathItem.name;
    ...
    function _updateLabelAndName(model) {
      ...
      if (model.isResponsiveBaseTemplate()) {
        ...
        $(".perc-template-name-label")
          .html("")
          .text(I18N.message("perc.ui.edit.template@Editing Template"));
