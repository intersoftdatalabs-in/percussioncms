...
(function ($) {
  ...
  $.Perc_Template_Summary = function (sourceId, templateId, templateName) {
     ...
     */
    this.getBaseTemplateName = function () {
     ...
     */
    this.getTemplateNameLowerCase = function () {
      return this.templateNameLowerCase;
    };
    ...
    this.assignToSite = function (siteId) {
      if (!this.containsSite(siteId)) this.siteIds.push(siteId);
    };
    ...
    this.containsSite = function (siteId) {
      for (s in this.siteIds) {
        if (siteId == this.siteIds[s]) return true;
      }
      return false;
    };
     ...
     */
    this.setPersisted = function (isPersisted) {
     ...
     */
    this.setDeleteFlag = function (del) {
      this.deleteFlag(del);
    };

    this.setBaseTemplate = function (isBase) {
      this.isBase = isBase;
    };
