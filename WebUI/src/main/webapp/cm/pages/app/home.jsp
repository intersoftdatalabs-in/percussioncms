...
<link rel="stylesheet" type="text/css" href="/cm/pages/cui/components/perc-css/perc.css"/>
...
<%} else { %>
<iframe id="cui-frame" title="<i18n:message key='perc.ui.navMenu.home@Home' />" src="/cm/pages/cui/index.html"
