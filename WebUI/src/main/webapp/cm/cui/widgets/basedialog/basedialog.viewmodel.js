  ...
  return function BaseDialogViewModel(options) {
    ...
    self.constants = {
      ...
      UNKNOWN_SERVER_ERROR:
        ".No message body writer found for response class : PSErrors.",
      UNKNOWN_SERVER_ERROR_RESPONSE:
        "Unknown Server Error. Please try again later.",
    };

    self.isLoading = ko.observable();
    self.windowTitle = ko.observable(self.constants.DEFAUL_TITLE);
    self.secondaryButton = ko.observable(
      self.constants.DEFAULT_SECONDARY_BUTTON
    );
    ...
    function setupConfirmationDialog(data) {
      ...
      var secButton = data.secondaryButton
        ...
        buttons: [
          {
            ...
            click: function () {
              ...
              if ($.isFunction(secButton.callback)) secButton.callback();
            },
            class: "secondary-button",
          },
          {
