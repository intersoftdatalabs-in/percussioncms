  ...
  function openDialogIfEmptyEmail() {
    ...
    function createDialogHTML(baseUrl) {
      return (
        ...
        '            <label for="newEmail">' +
        "                <span>" +
        I18N.message("perc.ui.change.email@New Email") +
        "</span>" +
        '                <input type="email" id="newEmail" name="newEmail" placeholder= "' +
        I18N.message("perc.ui.change.email@Enter New Email") +
        '" autofocus autocomplete="off" />' +
        "            </label>" +
        '            <label for="confirmEmail">' +
        "                <span>" +
        I18N.message("perc.ui.change.email@Confirm New Email") +
        "</span>" +
        '                <input type="email" id="confirmEmail" name="confirmEmail" placeholder= "' +
        I18N.message("perc.ui.change.email@Confirm New Email") +
        '" autocomplete="off" />' +
        "            </label>" +
        '                <button class="pw-submit" type="submit">' +
        I18N.message("perc.ui.change.email@Change Email") +
        "</button>" +
        '                <span class="pw-message" style="display:none">' +
        I18N.message("perc.ui.change.email@Working on it") +
        "</span>" +
        "        </p>" +
        "    </form>" +
        "</div>"
