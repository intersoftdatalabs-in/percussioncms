...
(function ($) {
  ...
  $.perc_paths = {
    ...
    PATH_ITEM_SUMMARY_BY_WORKFLOW_STATE:
      SERVICES.PATHMGT + "/path/item/wfState",
    PATH_ITEM_MOVE: SERVICES.PATHMGT + "/path/moveItem",
    PATH_ITEM_PROPERTIES: SERVICES.PATHMGT + "/path/itemProperties",
    PATH_VALIDATE_DELETE_FOLDER:
      SERVICES.PATHMGT + "/path/validateFolderDelete",
    ...
    PATH_SAVE_FOLDER_PROPERTIES:
      SERVICES.PATHMGT + "/path/saveFolderProperties",
    ...
    TEMPLATE_CREATE_FROM_URL_ASYNC:
      SERVICES.SITEMGT + "/sitetemplates/createFromUrlAsync",
    TEMPLATE_CREATE_FROM_URL_RESULT:
      SERVICES.SITEMGT + "/sitetemplates/getImportedTemplate",
    TEMPLATE_CREATE_FROM_PAGE:
      SERVICES.SITEMGT + "/sitetemplates/createFromPage",
    TEMPLATE_RENDER: SERVICES.PAGEMGT + "/render/template",
    TEMPLATE_RENDER_SCRIPTSOFF:
      SERVICES.PAGEMGT + "/render/template/scriptsoff",
    ...
    CLEAR_MIGRATION_EMPTY_FLAG:
      SERVICES.PAGEMGT + "/page/clearMigrationEmptyFlag",
    ...
    SECTION_CREATE_SECTION_LINK:
      SERVICES.SITEMGT + "/section/createSectionLink",
    SECTION_DELETE_SECTION_LINK:
      SERVICES.SITEMGT + "/section/deleteSectionLink",
    SECTION_CREATE_EXTERNAL_LINK:
      SERVICES.SITEMGT + "/section/createExternalLinkSection",
    SECTION_SECTION_FROM_FOLDER:
      SERVICES.SITEMGT + "/section/createSectionFromFolder",
    ...
    SECTION_REPLACE_LANDING_PAGE:
      SERVICES.SITEMGT + "/section/replaceLandingPage",
    SECTION_UPDATE: SERVICES.SITEMGT + "/section/update",
    SECTION_LINK_UPDATE: SERVICES.SITEMGT + "/section/updateSectionLink",
    SECTION_EXTERNAL_LINK_UPDATE:
      SERVICES.SITEMGT + "/section/updateExternalLink",
    ...
    REGION_CSS_PREPARE_FOR_EDIT:
      SERVICES.PAGEMGT + "/theme/regioncss/prepareForEdit",
    ...
    ASSET_WIDGET_REL:
      SERVICES.ASSETMGT + "/asset/createAssetWidgetRelationship",
    ...
    ASSET_WIDGET_REL_UPDATE:
      SERVICES.ASSETMGT + "/asset/updateAssetWidgetRelationship",
    ASSET_ADD_TO_FOLDER: SERVICES.ASSETMGT + "/asset/addAssetToFolder",
    ASSET_WIDGET_DROP_CRITERIA:
      SERVICES.ASSETMGT + "/asset/assetWidgetDropCriteria/",
    ASSET_WIDGET_REL_DEL:
      SERVICES.ASSETMGT + "/asset/clearAssetWidgetRelationship",
    ASSET_ORPHAN_WIDGET_REL_DEL:
      SERVICES.ASSETMGT + "/asset/clearOrphanAssetsWidgetRelationship",
    ...
    UPDATE_INSPECTED_ELEMENT:
      SERVICES.ASSETMGT + "/asset/updateInspectedElements",
    ...
    INCREMENTAL_RELATED_LIST:
      SERVICES.SITEMGT + "/publish/incremental/relatedcontent/",
    ...
    SITE_UPDATE_PUBLISH_PROPERTIES:
      SERVICES.SITEMGT + "/site/updatePublishProperties",
    ...
    METADATA_SAVE_GLOBAL_VARIABLES:
      SERVICES.METADATAMGT + "/metadata/globalvariables",
    ...
    WORKFLOW_TRANSITION_COMMENT:
      SERVICES.ITEMMGT + "/workflow/transitionWithComments",
    WORKFLOW_TRANSITIONS: SERVICES.ITEMMGT + "/workflow/getTransitions",
    WORKFLOW_CHECKED_OUT_TO_USER:
      SERVICES.ITEMMGT + "/workflow/isCheckedOutToCurrentUser",
    WORKFLOW_IS_APPROVE_ALLOWED:
      SERVICES.ITEMMGT + "/workflow/isApproveAvailableToCurrentUser",
    ...
    // Comments
    COMMENTS_DEFAULT_MODERATION:
      SERVICES.DELIVERY + "/comment/defaultModerationState",
    ...
    WEBRESOURCESMGT_VALIDATE_FILE_UPLOAD:
      SERVICES.DESIGN + "/webresources/validateFileUpload",
    ...
    FOLDERMGT_START_ASSOCIATED_FOLDERS_JOB:
      SERVICES.FOLDERMGT + "/folders/GetAssociatedFoldersJob/start/",
    FOLDERMGT_GET_ASSOCIATED_FOLDERS_JOB_STATUS:
      SERVICES.FOLDERMGT + "/folders/GetAssociatedFoldersJob/status/",
    FOLDERMGT_CANCEL_ASSOCIATED_FOLDERS_JOB:
      SERVICES.FOLDERMGT + "/folders/GetAssociatedFoldersJob/cancel/",
    FOLDERMGT_FOLDERS_WITH_WORKFLOW_ASSIGN:
      SERVICES.FOLDERMGT + "/folders/workflowassignment",
    FOLDERMGT_IS_WORKFLOW_ASSIGN_PROGRESS:
      SERVICES.FOLDERMGT + "/folders/workflowassignment/isInProgress",
    ...
    MEMBERSHIP_ACT_BLK_DEL_ACCOUNT:
      SERVICES.DELIVERY + "/membership/admin/account",
    MEMBERSHIP_ACT_SAVE_GROUP:
      SERVICES.DELIVERY + "/membership/admin/user/group",

    // License
    LICENSE_ACTIVATE: SERVICES.LICENSE + "/license/activate",
    LICENSE_GET_INFORMATION: SERVICES.LICENSE + "/license/status",
    LICENSE_GET_NETSUITE_METHOD:
      SERVICES.LICENSE + "/license/methodWithCheckUrl",
    ...
    DEFAULT_SERVER_MODIFIED:
      SERVICES.PUBMGT + "/servers/isDefaultServerModified/",
    ...
    TEMPLATE_MIGRATE_CONTENT:
      SERVICES.MIGRATIONMGT + "/contentmigration/migrate",
