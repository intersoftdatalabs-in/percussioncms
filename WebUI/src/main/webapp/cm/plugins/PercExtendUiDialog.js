...
(function ($) {
  ...
  $.ui.dialog.prototype._createButtons = function (buttons) {
    ...
    if (
      typeof this.options.percButtons != "undefined" &&
      this.options.percButtons != null
    )
  ...
  $.ui.dialog.prototype._setData = function (key, value) {
    var self = this;
    if (key === "perc-buttons") self._createPercButtons(value);
  ...
  $.ui.dialog.prototype._createPercButtons = function (percButtons) {
    ...
    typeof percButtons == "object" &&
      percButtons !== null &&
      $.each(percButtons, function () {
