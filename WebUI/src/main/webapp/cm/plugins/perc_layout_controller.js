...
(function ($) {
  $.perc_layout_controller = function () {
    ...
    this.editWidgetStart = function (widget, callback) {
      ...
      this.currentWidgetDefinition =
        this.widgetDefinitions[widget.getWidgetDefinitionId()];
    ...
    this.editWidgetOk = function (callback) {
      ...
      for (var d in userPrefs) {
        ...
        if (userPrefs[d].datatype === "list") {
          ...
          value = new Array();
          for (var v in values) value.push(values[v]);
...
(function ($) {
  ...
  $.perc_widget_library_model = function (widgetLibraryXml) {
    ...
    this.html = function () {
      var buff =
        '<div class="perc-header" style="float:none;"> ' +
        I18N.message("perc.ui.layout.controller@Drag and Drop Widgets") +
        " </div>\n";
  ...
  $.perc_widget_summary_model = function ($widgetSummaryXml) {
    ...
    this.html = function () {
      var buff = "";
      buff +=
        "<div class='perc-toolbar-item' id='" +
        this.id +
        "' name='" +
        this.name +
        "'>\n";
...
(function ($) {
  $.perc_user_pref = function (
    ...
    this.render = function () {
      ...
      var value =
        this.realValue == null || this.realValue === ""
          ? this.default_value
          : this.realValue;
