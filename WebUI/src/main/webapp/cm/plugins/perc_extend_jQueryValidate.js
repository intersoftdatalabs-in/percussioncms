...
(function ($) {
  ...
  $.validator.addMethod("noBinary", function (value, element) {
    ...
    if (typeof match[0] != "undefined") var splitMatch = match[0].split("."); // matches 0 since it's the first group
    ...
    return (
      ...
      $.inArray(extension.toLowerCase(), binaryExtArray) === -1
    );
  });

  $.validator.addMethod("perc_remote", function (value, element, param) {
            ...
            success: function (response) {
              ...
              if (valid) {
                ...
                errors[element.name] = previous.message =
                  response || validator.defaultMessage(element, "perc_remote");
