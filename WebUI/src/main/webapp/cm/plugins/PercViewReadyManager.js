  ...
  $.PercViewReadyManager = {
    ...
    setWrapper: function (wrappertoset) {
      ...
      $("#perc-ui-view-indicator")
        .removeClass("perc-ui-view-ready")
    ...
    handleWrapperComplete: function (wrapperName) {
      ...
      if (this.wrappers.length === 0) {
        $("#perc-ui-view-indicator")
          .removeClass("perc-ui-view-processing")
          .addClass("perc-ui-view-ready");
    ...
    return {
      ...
      isComponentInWrapper: function (componentName, processedFlag) {
        return processedFlag
          ? $.inArray(componentName, this.components) !== -1 &&
              $.inArray(componentName, this.processedComponents) === -1
          : $.inArray(componentName, this.components) !== -1;
      },
      handleComponentProgress: function (compName, progress) {
        if ($.inArray(compName, this.components) === -1) {
          $.PercViewReadyManager.logMessage(
            "The component '" +
              compName +
        ...
        if (progress === "complete") {
          ...
          component
            .addClass("perc-ui-component-ready")
            .removeClass("perc-ui-component-processing");
      ...
      init: function () {
        $(this.components).each(function () {
          ...
          component
            .addClass("perc-ui-component-processing")
            .removeClass("perc-ui-component-ready");
          var compPos = component.position();
          var compWrapper = $(
