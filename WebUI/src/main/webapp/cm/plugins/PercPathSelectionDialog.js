...
(function ($) {
  ...
  function _open(options) {
    ...
    var buttonSaveOk = {
      ...
      click: function () {
        if (
          settings.selectedItemValidator &&
          typeof settings.selectedItemValidator === "function"
        ) {
    ...
    function createDialog() {
      ...
      if (
        ...
        container
          ...
          .append(
            '<a class="perc-font perc-font-button" href="#"><i class="' +
      ...
      finderTree = $(
        ...
        onClick: function (pathItem) {
          ...
          if ($.inArray(pathItem.category, settings.selectableTypes) !== -1)
            dialogHTML
              .find("label[for='perc-select-blog-location-tree']")
              .hide();
        },
      });
