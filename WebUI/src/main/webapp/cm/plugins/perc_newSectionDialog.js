    ...
    function openDialog(site, parentId, callback) {
      ...
      dialog = $(
        "<div>" +
          ...
          "<span style='position: relative; float: right; margin-top: -44px; margin-right: -2px;'><label>" +
          I18N.message("perc.ui.general@Denotes Required Field") +
          "</label></span>" +
          "<form action='' method='GET'> " +
          "<label class='perc-required-field' for='perc-section-type'>" +
          I18N.message("perc.ui.newSectionDialog.label@Type") +
          ":</label> <br>" +
          ...
          I18N.message("perc.ui.newSectionDialog.label@Section link") +
          "</option>" +
          "<option value='externallink'>" +
          I18N.message("perc.ui.newSectionDialog.label@External link") +
          "</option>" +
          "<option value='convertfolder'>" +
          I18N.message("perc.ui.newSectionDialog.label@Convert folder") +
          "</option>" +
          "</select> <br>" +
          "<div id='perc-section-container'>" +
          "<label for='perc-select-template'>" +
          I18N.message("perc.ui.newSectionDialog.label@Select a template") +
          ": </label><br/>" +
          ...
          "<fieldset>" +
          "<label for='perc-external-link-text' class='perc-required-field'>" +
          I18N.message("perc.ui.newSectionDialog.label@External link text") +
          ":</label> <br/> " +
          "<input type='text' class='required' tabindex='0' id='perc-external-link-text' name='perc-external-link-text' maxlength='100'/> <br/>" +
          "<label class='perc-required-field' for='perc-external-link-url'>" +
          I18N.message("perc.ui.newSectionDialog.label@External link URL") +
          ":</label> <br/> " +
          ...
          "<fieldset>" +
          "<label for='perc-section-link-target' class='perc-required-field'>" +
          I18N.message("perc.ui.newSectionDialog.label@Target section") +
          ":</label> <br/> " +
          ...
          "<fieldset>" +
          "<label for='perc-convert-folder-path' class='perc-required-field'>" +
          I18N.message("perc.ui.newSectionDialog.label@Target folder") +
          ":</label> <br/> " +
          ...
          "<label class='perc-required-field' for='perc-landing-page'>" +
          I18N.message("perc.ui.newSectionDialog.label@Select landing page") +
          ":</label> <br>" +
      ...
      var selectLocalStyle =
        "height: 160px; width: 410px; overflow-x: scroll; overflow-y: hidden;";
