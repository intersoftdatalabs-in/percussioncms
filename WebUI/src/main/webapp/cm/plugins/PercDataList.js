...
(function ($) {
  ...
  function init(container, config) {
    ...
    var head = $('<div class="perc-item-list-label" />').html(options.title);
  ...
  function activateMoreLessLink(container) {
    $(container)
      .find(".perc-moreLink, .perc-lessLink")
      .on("click", function () {
        $(container)
          .find(".perc-more-list, .perc-moreLink, .perc-lessLink")
          .toggle()
          .toggleClass("perc-visible perc-hidden");
      });
  }
  ...
  function selectItem(container, itemname) {
    ...
    var id = container
      .find(".perc-itemname[title='" + itemname + "']")
      .attr("data-id");
  ...
  function enableAddButton(container) {
    ...
    if (options.enableAdd) {
      container
        ...
        .off("click")
        .on("click", function () {
          if (typeof options.createItem == "function") options.createItem();
        })
        .on("keydown", function (eventHandler) {
          if (eventHandler.code == "Enter" || eventHandler.code == "Space") {
            document.activeElement.click();
