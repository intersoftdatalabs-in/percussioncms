...
(function ($) {
   ...
   * Author: Luis Mendez
   */
  var _setDateFromFieldOrg = $.datepicker._setDateFromField;
   ...
   */
  var _connectDateOrg = $.datepicker._connectDatepicker;
  $.datepicker._connectDatepicker = function (target, inst) {
    ...
    if (showOn == "button" || showOn == "both") {
      ...
      adiv.on("click", function (evt) {
        ...
        // This override is all about the "null"
   ...
   */
  var _showDatepickerOrg = $.datepicker._showDatepicker;
  $.datepicker._showDatepicker = function (input) {
    // Call the original method which will show the datepicker
    _showDatepickerOrg.apply(this, [input]);
  ...
  var _checkExternalClickOrg = $.datepicker._checkExternalClick;
   ...
   */
  var _hideDatepickerOrg = $.datepicker._hideDatepicker;
  ...
  $.datepicker._selectDate = function (id, dateStr) {
    ...
    else if (inst.input && !showTime) inst.input.trigger("change"); // fire the change event
    if (inst.inline) this._updateDatepicker(inst);
      ...
      if (showTime) {
        ...
        if (typeof inst.input[0] != "object") inst.input[0].trigger("focus"); // restore focus
   ...
   */
  var _updateDatepickerOrg = $.datepicker._updateDatepicker;
  $.datepicker._updateDatepicker = function (inst) {
    _updateDatepickerOrg.apply(this, [inst]);
    $.timepicker.resize();
  };
  ...
  Timepicker.prototype = {
    ...
    show: function (input) {
      ...
      var stepMinutes =
        parseInt($.datepicker._get(inst, "stepMinutes"), 10) || 1;
    ...
    _generateHtml: function () {
      ...
      html +=
        '<span class="fragHours">08</span><span class="delim">:</span><span class="fragMinutes">45</span> <span class="fragAmpm"></span></div></div><table>';
      html += "<tr><th>Hour</th><th>Minute</th></tr>";
      html +=
        '<tr><td><div id="hourSlider" class="slider"></div></td><td><div id="minuteSlider" class="slider"></div></td></tr>';
      html += "</table>";
