...
public class GadgetRequestCacheFilter implements Filter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
    ...
    // cm/gadgets/ifr passes in param "url" for gadget that needs to be validated to be not
    // malformed.
    ...
    if (gadgetUrl != null && !gadgetUrl.isEmpty()) {
      try {
        ...
        log.warn(
            "Invalid URL detected. URL: {} Error: {}. NOTE: These warnings may be generated by an active application security scan.",
            gadgetUrl,
    ...
    try (InputStreamReader is = new InputStreamReader(request.getInputStream(), encoding)) {
