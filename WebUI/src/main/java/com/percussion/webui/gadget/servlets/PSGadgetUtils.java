...
public class PSGadgetUtils {
  ...
  /**
   * Given an input url will validate against the uri in the gadget registry if the uri is not
   * valid, it will return false. This is intended to block malicious calls to the gadget servlets.
   *
