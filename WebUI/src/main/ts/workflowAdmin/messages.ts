...
export const WF_ADMIN_MSG = {
  ...
  // Users - US4
  USERS_TITLE: "perc.ui.users@Users",
  CREATE_USER: "perc.ui.users@Create User",
  EDIT_USER: "perc.ui.users@Edit User",
  USER_NAME: "perc.ui.users@Username",
  EMAIL: "perc.ui.users@Email Address",
  PASSWORD: "perc.ui.users@Password",
  CONFIRM_PASSWORD: "perc.ui.users@Confirm Password",
  USER_ROLES: "perc.ui.users@Assigned Roles",
  PROVIDER_TYPE: "perc.ui.users@Account Type",
  LDAP_IMPORT: "perc.ui.users@Import from Directory",
  LDAP_STATUS_DISABLED: "perc.ui.users@Directory Service is not configured or disabled.",
  LDAP_SEARCH_PLACEHOLDER: "perc.ui.users@Search directory users...",
  LDAP_SEARCH_BTN: "perc.ui.users@Search",
  CONFIRM_DELETE_USER: "perc.ui.users@Are you sure you want to delete user \"{0}\"?",
  PASSWORDS_DONOT_MATCH: "perc.ui.users@Passwords do not match.",
