...
export const EDITOR_MSG = {
  ...
  RELATED_PICK: "perc.ui.editor@Pick from folder",
  RELATED_PICK_TITLE: "perc.ui.editor@Choose a page or asset",
  RELATED_PICK_PATH: "perc.ui.editor@Folder path",
  RELATED_PICK_LIST: "perc.ui.editor@List folder",
  RELATED_PICK_USE: "perc.ui.editor@Use this item",
  RELATED_PICK_EMPTY: "perc.ui.editor@No pages or assets in this folder.",
  RELATED_PICK_LOADING: "perc.ui.editor@Loading folder…",
  RELATED_PICK_FAILED: "perc.ui.editor@Could not list that folder.",
  RELATED_PICK_FORBIDDEN: "perc.ui.editor@You are not allowed to list that folder.",
