...
export const DEV_MSG_KEYS = {
  ...
  LOC_HINT:
    "perc.ui.developer@Create, save, or delete CMS locales (language string and label required). Language cannot be renamed after create. Format-profile and auto-translation editors are not in this chrome.",
