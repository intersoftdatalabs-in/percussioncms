...
export const DEV_MSG_KEYS = {
  ...
  PIPE_HINT:
    "perc.ui.developer@Server applications (classic XML Applications). Open a row for read-only detail, data sets, and pipe IR (resources, tanks, mapper). Graph edit, IR write, and start/stop are later slices.",
