...
export const DEV_MSG = {
  ...
  COMM_HINT:
    "Select a community to view associated roles. Role membership and ACL edit are not available yet.",
  ...
  COMM_META_ID: "Id",
  COMM_META_GUID: "GUID",
  COMM_ROLES: "Associated roles",
  COMM_NO_ROLES: "No roles associated with this community.",
  COMM_COL_ROLE_NAME: "Role name",
  COMM_COL_ROLE_ID: "Role id",
  COMM_COL_ROLE_GUID: "Role GUID",
  COMM_GAPS: "Known gaps",
  COMM_GAP_ROLES_EDIT: "Add/remove role membership is not supported via this API yet",
