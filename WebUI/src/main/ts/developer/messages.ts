...
export const DEV_MSG_KEYS = {
  ...
  AM_HINT:
    "perc.ui.developer@Create or delete Content Explorer action menus (name required, no spaces). On a user cascading MENU, add, remove, or reorder child menus and save. System menus cannot be changed.",
  ...
  AM_CHILDREN_COL_ACTIONS: "perc.ui.developer@Actions",
