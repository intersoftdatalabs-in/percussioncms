...
export const DEV_MSG_KEYS = {
  ...
  CT_HINT: "perc.ui.developer@Create a type, import design XML, or select one to view fields and edit label, description, enabled, type-level search indexing, local field add/delete, field flags, include system or shared fields, workflows, templates, item-level exits, control property values, and field-rule expressions. Export downloads design XML. Import creates a new type from that XML (unique name; no overwrite). Delete requires a held lock.",
  ...
  CT_FIELDS_HINT:
    "perc.ui.developer@Lock to add or delete a local field (POST/DELETE .../fields). Origin is always local. Toggle searchable / required for local fields, then save. Include an existing system or shared field from the picker (origin stays system/shared).",
