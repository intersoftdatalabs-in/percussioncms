...
export const DEV_MSG_KEYS = {
  ...
  DF_HINT:
    "perc.ui.developer@Content Explorer display formats (columns, folder/view/search usage). Open a user format to add, remove, or reorder columns. Packaged/system formats are read-only. Create/delete is a later slice.",
