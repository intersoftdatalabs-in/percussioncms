...
export const DEV_MSG_KEYS = {
  ...
  PIPE_HINT:
    "perc.ui.developer@Server applications (classic XML Applications). Open a row for detail, data sets, and pipe IR (resources, tanks, mapper). Admins can Start or Stop a running application. Graph edit and IR write remain later slices.",
  ...
  PIPE_DATASETS_HINT:
    "perc.ui.developer@Request pages and content editors listed on the classic application catalog. Pipe IR structure (stages, tanks, mapper) is shown below when available.",
