...
export const DEV_MSG_KEYS = {
  ...
  SLOT_HINT:
    "perc.ui.developer@Create or delete assembly slots (Admin). Name is unique and cannot contain spaces. Finder and relationship editors are not in this chrome.",
