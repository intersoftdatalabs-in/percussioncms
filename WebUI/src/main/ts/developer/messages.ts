...
export const DEV_MSG_KEYS = {
  ...
  CT_HINT: "perc.ui.developer@Select a content type to view fields and edit label, description, enabled, icon strategy, field flags, workflows, templates, item-level exits, control property values, and field-rule expressions.",
