...
export const DEV_MSG_KEYS = {
  ...
  CT_HINT: "perc.ui.developer@Select a content type to view fields and edit label, description, enabled, field flags, workflows, templates, item-level exits, control property values, and field-rule expressions. Export downloads design XML. Import creates a new type from that XML (unique name; no overwrite).",
