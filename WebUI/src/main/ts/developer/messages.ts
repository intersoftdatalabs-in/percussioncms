...
export const DEV_MSG_KEYS = {
  ...
  DF_HINT:
    "perc.ui.developer@Create or delete Content Explorer display formats (name required, no spaces). Open a user format to add, remove, or reorder columns. Packaged/system formats are read-only.",
  ...
  DF_COLUMNS_HINT:
    "perc.ui.developer@Column definitions for this display format. On a user format, add, remove, or reorder columns and save.",
  DF_COLUMNS_READONLY:
    "perc.ui.developer@This packaged/system format is read-only. Column add, remove, and reorder are available on user formats only.",
  ...
  DF_GAP_COLUMNS_EDIT: "perc.ui.developer@Sort-order designer completeness is a later slice.",
