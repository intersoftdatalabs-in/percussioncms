...
export const DEV_MSG_KEYS = {
  ...
  DF_HINT:
    "perc.ui.developer@Create or delete Content Explorer display formats (name required, no spaces). Column and sort editing stay read-only in this chrome.",
  ...
  DF_GAP_WRITE:
    "perc.ui.developer@Column picker completeness is a later slice. Create and delete persist via REST.",
