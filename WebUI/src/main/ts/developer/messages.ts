...
export const DEV_MSG_KEYS = {
  ...
  SR_HINT:
    "perc.ui.developer@Create or delete Content Explorer searches (name required, no spaces). Field criteria stay read-only in this chrome. Views are a separate catalog.",
