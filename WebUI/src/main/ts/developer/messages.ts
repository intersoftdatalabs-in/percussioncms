...
export const DEV_MSG_KEYS = {
  ...
  TAB_FILE_EXPLORER: "perc.ui.developer@File Explorer",
  TAB_DATABASE_EXPLORER: "perc.ui.developer@Database Explorer",
  TAB_PROBLEMS: "perc.ui.developer@Problems",
  TAB_OBJECT_SORTER: "perc.ui.developer@Object Sorter",
  ...
  CT_COPY: "perc.ui.developer@Copy",
  CT_COPY_TITLE: "perc.ui.developer@Copy content type",
  CT_COPY_NAME: "perc.ui.developer@New name",
  CT_COPY_SUBMIT: "perc.ui.developer@Copy content type",
  CT_COPYING: "perc.ui.developer@Copying...",
  CT_COPY_ERROR: "perc.ui.developer@Could not copy content type.",
  CT_COPY_HINT:
    "perc.ui.developer@Creates a distinct content type with the same fields. Folder and navigation system types cannot be copied.",
  ...
  TPL_HINT: "perc.ui.developer@Select a template to lock, edit label, description, source, bindings, contained slots, and content-type associations, then save while the lock is held. Export XML from detail. Import XML creates a new unique template (no overwrite).",
  ...
  TPL_CT_ASSOC: "perc.ui.developer@Content types",
  TPL_CT_ASSOC_HINT:
    "perc.ui.developer@Content types associated with this template (name and GUID). Lock, then add or remove, then save (full replace). Empty list clears associations.",
  TPL_CT_ADD: "perc.ui.developer@Add content type",
  TPL_CT_REMOVE: "perc.ui.developer@Remove",
  TPL_CT_NAME_PLACEHOLDER: "perc.ui.developer@Content type name or GUID",
  TPL_CT_DUP: "perc.ui.developer@That content type is already associated.",
  TPL_CT_NAME_INVALID: "perc.ui.developer@Enter a content type name or a GUID (for example 0-6-311).",
  TPL_CT_EMPTY: "perc.ui.developer@No content types associated.",
  TPL_CT_COL_GUID: "perc.ui.developer@GUID",
  ...
  TPL_SNIPPET_OPEN: "perc.ui.developer@Insert snippet",
  TPL_SNIPPET_TITLE: "perc.ui.developer@Snippet library",
  TPL_SNIPPET_HINT:
    "perc.ui.developer@Choose a built-in Velocity macro and insert it into the template source at the caret.",
  TPL_SNIPPET_FILTER: "perc.ui.developer@Filter",
  TPL_SNIPPET_FILTER_PLACEHOLDER: "perc.ui.developer@Search title, id, or text",
  TPL_SNIPPET_CATEGORY: "perc.ui.developer@Category",
  TPL_SNIPPET_CAT_ALL: "perc.ui.developer@All",
  TPL_SNIPPET_CAT_FIELD: "perc.ui.developer@Field",
  TPL_SNIPPET_CAT_SLOT: "perc.ui.developer@Slot",
  TPL_SNIPPET_CAT_MISC: "perc.ui.developer@Misc",
  TPL_SNIPPET_LOADING: "perc.ui.developer@Loading snippets...",
  TPL_SNIPPET_EMPTY: "perc.ui.developer@No snippets match the filter.",
  TPL_SNIPPET_LOAD_ERROR: "perc.ui.developer@Could not load snippet library.",
  TPL_SNIPPET_COL_TITLE: "perc.ui.developer@Title",
  TPL_SNIPPET_COL_CATEGORY: "perc.ui.developer@Category",
  TPL_SNIPPET_COL_ID: "perc.ui.developer@Id",
  TPL_SNIPPET_CANCEL: "perc.ui.developer@Cancel",
  TPL_SNIPPET_INSERT: "perc.ui.developer@Insert",
  TPL_SNIPPET_INSERTED: "perc.ui.developer@Snippet inserted.",
  TPL_FORM_LABEL: "perc.ui.developer@Label",
  TPL_FORM_DESCRIPTION: "perc.ui.developer@Description",
  TPL_LOCK: "perc.ui.developer@Lock",
  TPL_UNLOCK: "perc.ui.developer@Unlock",
  TPL_LOCK_TOOLBAR: "perc.ui.developer@Template design session",
  TPL_LOCKED: "perc.ui.developer@Locked by you",
  TPL_UNLOCKED: "perc.ui.developer@Not locked",
  TPL_LOCK_HINT:
    "perc.ui.developer@Lock to edit, save while the lock is held, then unlock. Save does not release the lock.",
  TPL_LOCK_ERROR: "perc.ui.developer@Could not lock template.",
  TPL_UNLOCK_ERROR: "perc.ui.developer@Could not unlock template.",
  TPL_UNLOCKED_NOTICE: "perc.ui.developer@Template unlocked.",
  TPL_LOCK_REQUIRED: "perc.ui.developer@Lock this template before saving.",
  ...
  SLOT_LOCK_HINT:
    "perc.ui.developer@Lock to edit finder, relationship, finder arguments, and content-type/template associations. Save does not release the lock. Properties-only saves omit unchanged finder and association fields.",
  ...
  SLOT_LOCK_REQUIRED:
    "perc.ui.developer@Lock this slot before saving finder, relationship, finder arguments, or associations.",
  ...
  SLOT_ASSOCIATIONS_HINT:
    "perc.ui.developer@Lock, then add or remove content-type <-> template pairs by name or GUID. Save applies a full replace.",
  SLOT_ASSOC_ADD: "perc.ui.developer@Add association",
  SLOT_ASSOC_REMOVE: "perc.ui.developer@Remove",
  SLOT_ASSOC_CT_PLACEHOLDER: "perc.ui.developer@Content type name or GUID",
  SLOT_ASSOC_TPL_PLACEHOLDER: "perc.ui.developer@Template name or GUID",
  SLOT_ASSOC_UNKNOWN: "perc.ui.developer@Unknown content type or template.",
  SLOT_GAPS: "perc.ui.developer@Known limitations of this endpoint",
  SLOT_NONE: "perc.ui.developer@None",
  SLOT_COL_CT: "perc.ui.developer@Content type",
  SLOT_COL_TPL: "perc.ui.developer@Template",
  ...
  PIPE_DATASETS_HINT:
    "perc.ui.developer@Request pages and content editors listed on the classic application catalog. Pipe IR structure (stages, tanks, mapper) is shown below when available. Use a data-set name as the Test invoke resource when the app has native pipe IR.",
  ...
  PIPE_IR_SOURCE: "perc.ui.developer@IR source",
  PIPE_IR_VERSION: "perc.ui.developer@IR version",
  PIPE_IR_RESOURCES: "perc.ui.developer@IR resources",
  PIPE_IR_COL_PIPE: "perc.ui.developer@Pipe",
  PIPE_IR_COL_STAGES: "perc.ui.developer@Stages present",
  PIPE_IR_COL_TX: "perc.ui.developer@Transaction",
  PIPE_IR_TANKS: "perc.ui.developer@Backend tanks",
  PIPE_IR_COL_ALIAS: "perc.ui.developer@Alias",
  PIPE_IR_COL_TABLE: "perc.ui.developer@Table",
  PIPE_IR_COL_DS: "perc.ui.developer@Datasource",
  PIPE_IR_JOINS: "perc.ui.developer@Joins",
  PIPE_IR_MAPPER: "perc.ui.developer@Mapper mappings",
  PIPE_IR_COL_DOC: "perc.ui.developer@Document field",
  PIPE_IR_COL_BACKEND: "perc.ui.developer@Backend",
  PIPE_IR_COL_BACKEND_KIND: "perc.ui.developer@Backend kind",
  PIPE_IR_SELECTOR: "perc.ui.developer@Selector",
  ...
  PIPE_INVOKE_RESOURCE: "perc.ui.developer@Resource",
  PIPE_INVOKE_BODY: "perc.ui.developer@Request JSON",
  PIPE_INVOKE_RUN: "perc.ui.developer@Invoke",
  PIPE_INVOKE_RUNNING: "perc.ui.developer@Invoking…",
  PIPE_INVOKE_RESULT: "perc.ui.developer@Execute result",
  ...
  PIPE_RESULT_PAGE_HINT:
    "perc.ui.developer@Associate a local XSL stylesheet with this resource. Test HTML applies the stylesheet merge. Use raw structured output to omit presentation so Test invoke returns JSON or XML without XSL. JSON (.json / Accept: application/json) never applies XSL even when a result page remains. Cloud URLs, credentials, and path traversal are rejected.",
  ...
  PIPE_RESULT_PAGE_CLEAR: "perc.ui.developer@Use raw structured output",
  PIPE_RESULT_PAGE_CLEARING: "perc.ui.developer@Clearing…",
  PIPE_RESULT_PAGE_CLEARED: "perc.ui.developer@Presentation cleared. Test invoke returns raw JSON or XML.",
  ...
  PIPE_INVOKE_JSON: "perc.ui.developer@Test JSON",
  PIPE_INVOKE_JSON_RUNNING: "perc.ui.developer@Testing JSON…",
  PIPE_INVOKE_XML: "perc.ui.developer@Test XML",
  PIPE_INVOKE_XML_RUNNING: "perc.ui.developer@Testing XML…",
  PIPE_INVOKE_XML_RESULT: "perc.ui.developer@XML result",
  ...
  PIPE_PROBLEMS_LOADING: "perc.ui.developer@Loading validation problems…",
  PIPE_PROBLEMS_EMPTY: "perc.ui.developer@No validation problems.",
  PIPE_PROBLEMS_UNAVAILABLE:
    "perc.ui.developer@Validation / problems REST is not available on this server yet (deferred until wave 3 validation ships).",
  PIPE_PROBLEMS_ERROR: "perc.ui.developer@Could not load validation problems.",
  PIPE_PROBLEMS_FORBIDDEN:
    "perc.ui.developer@Admin role is required to load pipeline validation problems.",
  PIPE_COL_PROB_SEVERITY: "perc.ui.developer@Severity",
  PIPE_COL_PROB_CODE: "perc.ui.developer@Code",
  PIPE_COL_PROB_MESSAGE: "perc.ui.developer@Message",
  PIPE_COL_PROB_RESOURCE: "perc.ui.developer@Resource",
  PIPE_COL_PROB_PATH: "perc.ui.developer@Path",
  ...
  SF_HINT:
    "perc.ui.developer@Create, save, or delete shared field groups (name required, no spaces). On detail, add or delete nested fields and save control properties and choices.",
  ...
  SF_FIELDS_HINT:
    "perc.ui.developer@Add a nested field (name, data type, occurrence) or delete one after confirm. Select a field below to edit control property values and choices.",
  ...
  SF_COL_ACTIONS: "perc.ui.developer@Actions",
  SF_ADD: "perc.ui.developer@Add field",
  SF_FIELD_DELETE: "perc.ui.developer@Delete",
  SF_NEW_NAME: "perc.ui.developer@New field name",
  SF_NEW_DATATYPE: "perc.ui.developer@Data type",
  SF_NEW_OCCURRENCE: "perc.ui.developer@Occurrence",
  SF_ADDED: "perc.ui.developer@Shared field added.",
  SF_FIELD_DELETED: "perc.ui.developer@Shared field deleted.",
  SF_ADD_ERROR: "perc.ui.developer@Could not add shared field.",
  SF_FIELD_DELETE_ERROR: "perc.ui.developer@Could not delete shared field.",
  SF_FIELD_DUPLICATE: "perc.ui.developer@A shared field with that name already exists.",
  SF_LOCK:
    "perc.ui.developer@Could not save the shared field group; it is locked by another user.",
  SF_INVALID_FIELD_NAME:
    "perc.ui.developer@Field name is invalid. Use a letter followed by letters, digits, or underscore (no spaces).",
  SF_FIELD_DELETE_CONFIRM: "perc.ui.developer@Delete this shared field?",
  SF_CONTROL_PROPS: "perc.ui.developer@Control property values",
  SF_CONTROL_PROPS_HINT:
    "perc.ui.developer@View and save control parameter name/value pairs and optional choices for the selected shared field. Omit choices on save to leave the catalog unchanged; set type none to clear. The request lock is acquired and released on save.",
  SF_CONTROL_PROPS_FIELD: "perc.ui.developer@Field",
  SF_CONTROL_PROPS_NAME: "perc.ui.developer@Property name",
  SF_CONTROL_PROPS_VALUE: "perc.ui.developer@Value",
  SF_CONTROL_PROPS_EMPTY: "perc.ui.developer@No control property values for this field.",
  SF_CONTROL_PROPS_LOADING: "perc.ui.developer@Loading control property values...",
  SF_CONTROL_PROPS_CONTROL: "perc.ui.developer@Control",
  SF_CONTROL_PROPS_NO_FIELD: "perc.ui.developer@Select a field to view control property values.",
  SF_CONTROL_PROPS_ERROR: "perc.ui.developer@Could not load control property values.",
  SF_CONTROL_PROPS_NAME_PLACEHOLDER: "perc.ui.developer@Parameter name",
  SF_CONTROL_PROPS_VALUE_PLACEHOLDER: "perc.ui.developer@Parameter value",
  SF_CONTROL_PROPS_SAVE: "perc.ui.developer@Save control properties",
  SF_CONTROL_PROPS_SAVED: "perc.ui.developer@Shared field control properties saved.",
  SF_CONTROL_PROPS_SAVE_ERROR: "perc.ui.developer@Could not save control properties.",
  SF_CONTROL_PROPS_ADD: "perc.ui.developer@Add property",
  SF_CONTROL_PROPS_REMOVE: "perc.ui.developer@Remove",
  ...
  SYS_HINT:
    "perc.ui.developer@Global system fields from the content-editor system definition. Admins can save field properties, add or delete fields, edit control properties, persist command-handler stylesheet associations, and persist application-flow redirects.",
  ...
  SYS_FIELDS_HINT:
    "perc.ui.developer@Fields available to all content types as system fields. Change searchable or occurrence, then Save fields. Select a field below to edit control property values.",
  ...
  SYS_CONTROL_PROPS_HINT:
    "perc.ui.developer@View and save control parameter name/value pairs for the selected system field. The request lock is acquired and released on save. Choice catalogs stay out of this chrome.",
  ...
  SYS_AF: "perc.ui.developer@Application flow",
  SYS_AF_HINT:
    "perc.ui.developer@Command-handler default application-flow redirects (Workbench System Def application flow). Save acquires and releases the system-definition lock. Remove drops that handler. At least one handler is required. Empty href keeps an empty default path. Conditional redirects are shown read-only.",
  SYS_AF_COL_HANDLER: "perc.ui.developer@Command handler",
  SYS_AF_COL_HREF: "perc.ui.developer@Redirect href",
  SYS_AF_COL_CONDITIONALS: "perc.ui.developer@Conditionals",
  SYS_AF_COL_ACTIONS: "perc.ui.developer@Actions",
  SYS_AF_SAVE: "perc.ui.developer@Save application flow",
  SYS_AF_SAVED: "perc.ui.developer@System-def application flow saved.",
  SYS_AF_SAVE_ERROR: "perc.ui.developer@Could not save system-def application flow.",
  SYS_AF_LOADING: "perc.ui.developer@Loading application flow...",
  SYS_AF_ERROR: "perc.ui.developer@Could not load system-def application flow.",
  SYS_AF_EMPTY: "perc.ui.developer@No application-flow redirects returned.",
  SYS_AF_ADD: "perc.ui.developer@Add handler",
  SYS_AF_REMOVE: "perc.ui.developer@Remove",
  SYS_AF_NEW_HANDLER: "perc.ui.developer@Command handler name",
  SYS_AF_NEW_HREF: "perc.ui.developer@Redirect href",
  SYS_AF_HREF_PLACEHOLDER: "perc.ui.developer@../sys_cx/mainpage.html",
  SYS_AF_INVALID:
    "perc.ui.developer@Use a letter-start handler name and a ../sys_* or ../rx_* path ending in .html, .xml, or .jsp (or leave href empty).",
  SYS_AF_LAST:
    "perc.ui.developer@At least one command handler redirect is required.",
  ...
  SYS_CONTROL_PROPS_EMPTY: "perc.ui.developer@No control property values for this field.",
  SYS_CONTROL_PROPS_LOADING: "perc.ui.developer@Loading control property values...",
  SYS_CONTROL_PROPS_CONTROL: "perc.ui.developer@Control",
  SYS_CONTROL_PROPS_NO_FIELD: "perc.ui.developer@Select a field to view control property values.",
  SYS_CONTROL_PROPS_ERROR: "perc.ui.developer@Could not load control property values.",
  SYS_CONTROL_PROPS_NAME_PLACEHOLDER: "perc.ui.developer@Parameter name",
  SYS_CONTROL_PROPS_VALUE_PLACEHOLDER: "perc.ui.developer@Parameter value",
  SYS_CONTROL_PROPS_SAVE: "perc.ui.developer@Save control properties",
  SYS_CONTROL_PROPS_SAVED: "perc.ui.developer@System field control properties saved.",
  SYS_CONTROL_PROPS_SAVE_ERROR: "perc.ui.developer@Could not save control properties.",
  SYS_CONTROL_PROPS_ADD: "perc.ui.developer@Add property",
  SYS_CONTROL_PROPS_REMOVE: "perc.ui.developer@Remove",
  ...
  IF_HINT:
    "perc.ui.developer@Create, save, or delete assembly item filters (name required, no spaces). Add, edit, or clear rule rows (name + params) on detail, then Save.",
  ...
  IF_RULES_HINT:
    "perc.ui.developer@Add, edit, or remove filter rule definitions and parameters. Save writes rules[] on the Admin item-filter PUT. Clear all rules and Save sends rules: []. Extension names are typically Java/global/percussion/itemfilter/…",
  IF_NONE: "perc.ui.developer@None",
  IF_COL_RULE: "perc.ui.developer@Rule",
  IF_COL_PARAMS: "perc.ui.developer@Parameters",
  IF_COL_ACTIONS: "perc.ui.developer@Actions",
  IF_RULE_ADD: "perc.ui.developer@Add rule",
  IF_RULE_REMOVE: "perc.ui.developer@Remove rule",
  IF_RULES_CLEAR: "perc.ui.developer@Clear all rules",
  IF_PARAM_ADD: "perc.ui.developer@Add parameter",
  IF_PARAM_REMOVE: "perc.ui.developer@Remove",
  IF_PARAM_NAME: "perc.ui.developer@Param name",
  IF_PARAM_VALUE: "perc.ui.developer@Param value",
  ...
  VW_EXECUTE: "perc.ui.developer@Execute",
  VW_EXECUTING: "perc.ui.developer@Executing…",
  VW_EXECUTE_RESULTS: "perc.ui.developer@Execute results",
  VW_EXECUTE_EMPTY: "perc.ui.developer@No rows returned.",
  VW_EXECUTE_ERROR: "perc.ui.developer@Could not execute view.",
  VW_EXECUTE_INVALID_URL:
    "perc.ui.developer@Custom view URL is invalid. Use a classic relative path without schemes or traversal.",
  VW_EXECUTE_FORBIDDEN: "perc.ui.developer@Admin role required to execute this custom URL view.",
  VW_EXECUTE_NOT_FOUND: "perc.ui.developer@View not found.",
  VW_EXECUTE_UNAVAILABLE:
    "perc.ui.developer@Custom view resource is not available. Check the URL application and page.",
  VW_COL_RESULT_TITLE: "perc.ui.developer@Title",
  VW_COL_RESULT_TYPE: "perc.ui.developer@Type",
  VW_COL_RESULT_PATH: "perc.ui.developer@Path",
  ...
  VW_COL_WRITE: "perc.ui.developer@Write",
  VW_WRITE_PROTECTED: "perc.ui.developer@Protected",
  VW_WRITE_USER: "perc.ui.developer@Writable",
  ...
  WF_DETAIL_SET_DEFAULT: "perc.ui.developer@Set as default",
  WF_DETAIL_SET_DEFAULT_BUSY: "perc.ui.developer@Setting default...",
  WF_DETAIL_SET_DEFAULT_DONE: "perc.ui.developer@This workflow is the system default.",
  WF_DETAIL_SET_DEFAULT_SAVED: "perc.ui.developer@Default workflow updated.",
  WF_DETAIL_SET_DEFAULT_ERROR: "perc.ui.developer@Could not set the default workflow.",
  ...
  WF_GRAPH_DELETED: "perc.ui.developer@Transition deleted.",
  WF_GRAPH_DELETE_ERROR: "perc.ui.developer@Could not delete workflow transition.",
  WF_GRAPH_DELETE_FORBIDDEN:
    "perc.ui.developer@Packaged or default workflows cannot be edited from this surface.",
  WF_GRAPH_DELETE_BAD:
  ...
  APPFILE_FILES_HINT:
    "perc.ui.developer@Relative files under the application root. Open a file to edit and save (Admin). Admins can create, delete, and rename/move folders and files.",
  ...
  APPFILE_NEW_FOLDER_LABEL: "perc.ui.developer@New folder path",
  APPFILE_FOLDER_CREATED: "perc.ui.developer@Folder created.",
  APPFILE_FOLDER_CREATE_ERROR: "perc.ui.developer@Could not create folder.",
  APPFILE_RENAME: "perc.ui.developer@Rename / move",
  APPFILE_RENAME_SAVE: "perc.ui.developer@Move",
  APPFILE_RENAME_CANCEL: "perc.ui.developer@Cancel",
  APPFILE_RENAME_LABEL: "perc.ui.developer@New relative path",
  APPFILE_RENAMED: "perc.ui.developer@Path renamed.",
  APPFILE_RENAME_ERROR: "perc.ui.developer@Could not rename or move this path.",
  APPFILE_DELETE: "perc.ui.developer@Delete",
  APPFILE_DELETED: "perc.ui.developer@Path deleted.",
  ...
  FE_ERROR: "perc.ui.developer@Could not load File Explorer roots.",
  FE_HINT:
    "perc.ui.developer@Allow-listed server folders (Workbench File Explorer). Open a root to list children. Not Server Configs and not XML application CMS files. Write and upload are not available here.",
  FE_BROWSE_HINT:
    "perc.ui.developer@Read-only listing. Directories open; files are listed only. Drag into CMS and upload are not supported on this surface.",
  FE_COL_DISPLAY: "perc.ui.developer@Name",
  FE_COL_ID: "perc.ui.developer@Id",
  FE_COL_EXISTS: "perc.ui.developer@On server",
  FE_COL_NAME: "perc.ui.developer@Name",
  FE_COL_TYPE: "perc.ui.developer@Type",
  FE_COL_SIZE: "perc.ui.developer@Size (bytes)",
  FE_PRESENT: "perc.ui.developer@Present",
  FE_MISSING: "perc.ui.developer@Missing",
  FE_TYPE_DIR: "perc.ui.developer@Directory",
  FE_TYPE_FILE: "perc.ui.developer@File",
  FE_OPEN_ROOT: "perc.ui.developer@Open root",
  FE_OPEN_DIR: "perc.ui.developer@Open folder",
  FE_BACK_ROOTS: "perc.ui.developer@Back to roots",
  FE_UP: "perc.ui.developer@Up one folder",
  FE_BREADCRUMB: "perc.ui.developer@File Explorer path",
  FE_CHILDREN_LOADING: "perc.ui.developer@Loading folder...",
  FE_CHILDREN_EMPTY: "perc.ui.developer@This folder is empty.",
  FE_CHILDREN_ERROR: "perc.ui.developer@Could not list this folder.",
  DBX_LOADING: "perc.ui.developer@Loading Database Explorer datasources...",
  DBX_EMPTY: "perc.ui.developer@No Database Explorer datasources are configured.",
  DBX_ERROR: "perc.ui.developer@Could not load Database Explorer datasources.",
  DBX_HINT:
    "perc.ui.developer@Allow-listed JDBC catalogs (Workbench Database Explorer). Open a datasource to list tables and views. Read-only — not a DBA tool and not File Explorer.",
  DBX_BROWSE_HINT:
    "perc.ui.developer@Read-only listing of tables and views. SQL, DDL, and write are not supported on this surface.",
  DBX_COL_DISPLAY: "perc.ui.developer@Name",
  DBX_COL_ID: "perc.ui.developer@Id",
  DBX_COL_KIND: "perc.ui.developer@Kind",
  DBX_COL_AVAILABLE: "perc.ui.developer@Available",
  DBX_COL_NAME: "perc.ui.developer@Name",
  DBX_COL_TYPE: "perc.ui.developer@Type",
  DBX_COL_SCHEMA: "perc.ui.developer@Schema",
  DBX_REPOSITORY: "perc.ui.developer@Repository",
  DBX_OTHER: "perc.ui.developer@Datasource",
  DBX_PRESENT: "perc.ui.developer@Yes",
  DBX_MISSING: "perc.ui.developer@No",
  DBX_TYPE_TABLE: "perc.ui.developer@Table",
  DBX_TYPE_VIEW: "perc.ui.developer@View",
  DBX_OPEN_DS: "perc.ui.developer@Open datasource",
  DBX_BACK_DS: "perc.ui.developer@Back to datasources",
  DBX_TABLES_LOADING: "perc.ui.developer@Loading tables...",
  DBX_TABLES_EMPTY: "perc.ui.developer@No tables or views in this catalog.",
  DBX_TABLES_ERROR: "perc.ui.developer@Could not list tables for this datasource.",
  PROB_LOADING: "perc.ui.developer@Loading Problems...",
  PROB_EMPTY: "perc.ui.developer@No design problems for this session.",
  PROB_ERROR: "perc.ui.developer@Could not load Problems.",
  PROB_HINT:
    "perc.ui.developer@Validation and design problems for the open editor and session (Workbench Problems). Read-only. Open Source when a peer editor exists.",
  PROB_COL_SEVERITY: "perc.ui.developer@Severity",
  PROB_COL_SOURCE: "perc.ui.developer@Source",
  PROB_COL_MESSAGE: "perc.ui.developer@Message",
  PROB_COL_LOCATION: "perc.ui.developer@Location",
  PROB_NAVIGATE: "perc.ui.developer@Open source",
  PROB_SEV_ERROR: "perc.ui.developer@Error",
  PROB_SEV_WARNING: "perc.ui.developer@Warning",
  OS_LOADING: "perc.ui.developer@Loading Object Sorter...",
  OS_EMPTY: "perc.ui.developer@No design objects in the current catalog.",
  OS_ERROR: "perc.ui.developer@Could not load the current object list.",
  OS_HINT:
    "perc.ui.developer@Organize the current Developer object list (Content Types). Choose a sort or move rows in custom order. This is an auxiliary aid — it does not rename or delete objects.",
  OS_SESSION_ONLY:
    "perc.ui.developer@Sort order is kept for this browser session only. It is not saved as a CMS user preference (no preference REST peer for this list).",
  OS_SORT_LABEL: "perc.ui.developer@Sort",
  OS_MODE_LABEL_ASC: "perc.ui.developer@Label A to Z",
  OS_MODE_LABEL_DESC: "perc.ui.developer@Label Z to A",
  OS_MODE_NAME_ASC: "perc.ui.developer@Name A to Z",
  OS_MODE_NAME_DESC: "perc.ui.developer@Name Z to A",
  OS_MODE_CUSTOM: "perc.ui.developer@Custom order",
  OS_COL_NAME: "perc.ui.developer@Name",
  OS_COL_LABEL: "perc.ui.developer@Label",
  OS_COL_ORDER: "perc.ui.developer@Order",
  OS_MOVE_UP: "perc.ui.developer@Move up",
  OS_MOVE_DOWN: "perc.ui.developer@Move down",
  ...
  SITE_VIRT_JSON_SCHEMA_HINT:
    "perc.ui.developer@JSON Schema uses the root path only (no Git remote). Point at a local JSON Schema fixture directory (schema.json or _config.yaml jsonschema.file). Save sourceKind=json-schema, then Build Virtual Site, then Preview assembled site. Publish Virtual Site copies assembled files to the Site filesystem target after a local JSON Schema Build. Missing build stays unavailable. Live HTTP schema fetch, jsonschema.url, remote $ref/$id HTTP, remote URLs, and credentials are never sent on the REST envelope.",
  ...
  SITE_VIRT_PREVIEW_HINT:
    "perc.ui.developer@Opens the last assembled home in a new tab after Build (Git filesystem, CSV filesystem, SQL database, HTTP JSON, Object storage, RSS / Atom, iCalendar, Sitemap XML, Robots.txt, llms.txt, OpenAPI YAML, AsyncAPI YAML, GraphQL SDL, or JSON Schema). Same-origin preview of the build output. Requires Admin.",
  ...
  SITE_VIRT_PUBLISH_HINT:
    "perc.ui.developer@Builds this Virtual Site using saved source properties, then copies assembled files to the Site filesystem publish location (Git filesystem, CSV filesystem, SQL database, HTTP JSON, Object storage, RSS / Atom, iCalendar, Sitemap XML, Robots.txt, llms.txt, OpenAPI YAML, AsyncAPI YAML, GraphQL SDL, or JSON Schema). Requires Admin. Traditional repository Sites do not show this control.",
