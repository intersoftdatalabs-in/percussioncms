...
export const DEV_MSG_KEYS = {
  ...
  CT_HINT: "perc.ui.developer@Select a content type to view fields and edit label, description, enabled, local field add/delete, field flags, workflows, templates, item-level exits, control property values, and field-rule expressions.",
  ...
  CT_FIELDS_HINT:
    "perc.ui.developer@Lock to add or delete a local field (POST/DELETE .../fields). Origin is always local. Toggle searchable / required for local fields, then save. Include of system/shared fields is a later slice.",
