...
export const DEV_MSG_KEYS = {
  ...
  CT_CONTROL_PROPS_HINT:
    "perc.ui.developer@Lock to edit display-control parameter values for the selected field, then save. Save replaces property values and does not unlock. Choice catalogs stay read-only.",
  ...
  CT_CONTROL_PROPS_CHOICES: "perc.ui.developer@Choice catalog (read-only)",
