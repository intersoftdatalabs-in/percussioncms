...
export const DEV_MSG_KEYS = {
  ...
  TPL_HINT: "perc.ui.developer@Select a template to lock, edit label, description, source, bindings, and contained slots, then save while the lock is held. Export XML from detail. Import XML creates a new unique template (no overwrite).",
