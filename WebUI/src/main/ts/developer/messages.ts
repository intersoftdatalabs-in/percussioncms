...
export const DEV_MSG_KEYS = {
  ...
  PIPE_HINT:
    "perc.ui.developer@Server applications (classic XML Applications). Open a row for detail, data sets, Admin Start/Stop, Test invoke, and Problems when available. Pipe IR editor and enable/disable remain later slices.",
  ...
  PIPE_DATASETS_HINT:
    "perc.ui.developer@Request pages and content editors defined in this application. Use a data-set name as the Test invoke resource when the app has native pipe IR.",
