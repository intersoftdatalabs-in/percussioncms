...
describe("VirtualSiteSourcePanel", () => {
  ...
  it("loads http-json values with root path and Build/Publish chrome (no Preview)", async () => {
    getVirtual.mockResolvedValue({
  ...
  it("shows Build chrome for http-json and success result with Publish (no Preview)", async () => {
    getVirtual.mockResolvedValue({
      sourceKind: "http-json",
      rootPath: "C:/http-json-docs",
      virtual: true,
