...
describe("VirtualSiteSourcePanel", () => {
  ...
  it("loads icalendar values with root path and Build/Preview/Publish chrome", async () => {
    ...
    expect(screen.getByTestId("developer-site-virtual-icalendar-hint")).toBeTruthy();
    expect(screen.getByTestId("developer-site-virtual-icalendar-hint").textContent).toBe(
  ...
  it("saves icalendar configuration without Git remote fields or CalDAV credentials", async () => {
    getVirtual
      .mockResolvedValueOnce({ sourceKind: null, virtual: false })
      .mockResolvedValueOnce({
        sourceKind: "icalendar",
  ...
  it("switching icalendar back to repository hides virtual fields", async () => {
    getVirtual.mockResolvedValue({
      sourceKind: "icalendar",
      rootPath: "C:/icalendar-docs",
      virtual: true,
    ...
    expect(screen.queryByTestId("developer-site-virtual-icalendar-hint")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-build-section")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-build")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-preview")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-publish")).toBeNull();
  ...
  it("loads sitemap-xml values with root path and shows Build/Preview/Publish chrome", async () => {
    ...
    expect(
      (screen.getByTestId("developer-site-virtual-root-path") as HTMLInputElement).value,
    ).toBe("C:/sitemap-xml-docs");
    expect(screen.getByTestId("developer-site-virtual-sitemap-xml-hint")).toBeTruthy();
    expect(screen.getByTestId("developer-site-virtual-sitemap-xml-hint").textContent).toBe(
  ...
  it("saves sitemap-xml configuration without Git remote fields or crawl credentials", async () => {
    getVirtual
      .mockResolvedValueOnce({ sourceKind: null, virtual: false })
      .mockResolvedValueOnce({
        sourceKind: "sitemap-xml",
    ...
    expect(updateVirtual).not.toHaveBeenCalled();
    fireEvent.change(screen.getByTestId("developer-site-virtual-root-path"), {
      target: { value: "C:/sitemap-xml-docs" },
    });
    fireEvent.click(screen.getByTestId("developer-site-virtual-save"));
    await waitFor(() => {
      expect(screen.getByTestId("developer-site-virtual-saved")).toBeTruthy();
  ...
  it("switching sitemap-xml back to repository hides virtual fields", async () => {
    getVirtual.mockResolvedValue({
      sourceKind: "sitemap-xml",
      rootPath: "C:/sitemap-xml-docs",
      virtual: true,
    ...
    expect(screen.queryByTestId("developer-site-virtual-sitemap-xml-hint")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-build-section")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-build")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-preview")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-publish")).toBeNull();
  ...
  it("loads robots-txt values with root path and shows Build/Preview/Publish chrome", async () => {
    getVirtual.mockResolvedValue({
    ...
    expect(screen.getByTestId("developer-site-virtual-robots-txt-hint")).toBeTruthy();
    expect(screen.getByTestId("developer-site-virtual-robots-txt-hint").textContent).toBe(
  ...
  it("saves robots-txt configuration without Git remote fields or crawl credentials", async () => {
    getVirtual
      .mockResolvedValueOnce({ sourceKind: null, virtual: false })
      .mockResolvedValueOnce({
        sourceKind: "robots-txt",
    ...
    expect(updateVirtual).not.toHaveBeenCalled();
    fireEvent.change(screen.getByTestId("developer-site-virtual-root-path"), {
      target: { value: "C:/robots-txt-docs" },
    });
    fireEvent.click(screen.getByTestId("developer-site-virtual-save"));
    await waitFor(() => {
      expect(screen.getByTestId("developer-site-virtual-saved")).toBeTruthy();
  ...
  it("switching robots-txt back to repository hides virtual fields", async () => {
    getVirtual.mockResolvedValue({
      sourceKind: "robots-txt",
      rootPath: "C:/robots-txt-docs",
      virtual: true,
  ...
  it("loads openapi-yaml values with root path and shows Build/Preview/Publish chrome", async () => {
    ...
    expect(screen.getByTestId("developer-site-virtual-openapi-yaml-hint")).toBeTruthy();
    expect(screen.getByTestId("developer-site-virtual-openapi-yaml-hint").textContent).toBe(
  ...
  it("saves openapi-yaml configuration without Git remote fields or spec-fetch credentials", async () => {
    getVirtual
      .mockResolvedValueOnce({ sourceKind: null, virtual: false })
      .mockResolvedValueOnce({
        sourceKind: "openapi-yaml",
  ...
  it("switching openapi-yaml back to repository hides virtual fields", async () => {
    getVirtual.mockResolvedValue({
      sourceKind: "openapi-yaml",
      rootPath: "C:/openapi-docs",
      virtual: true,
    ...
    expect(screen.queryByTestId("developer-site-virtual-openapi-yaml-hint")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-build-section")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-build")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-preview")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-publish")).toBeNull();
  ...
  it("loads asyncapi-yaml values with root path and shows Build/Preview/Publish chrome", async () => {
    ...
    expect(
      (screen.getByTestId("developer-site-virtual-root-path") as HTMLInputElement).value,
    ).toBe("C:/asyncapi-docs");
    expect(screen.getByTestId("developer-site-virtual-asyncapi-yaml-hint")).toBeTruthy();
    expect(screen.getByTestId("developer-site-virtual-asyncapi-yaml-hint").textContent).toBe(
  ...
  it("saves asyncapi-yaml configuration without Git remote fields or spec-fetch credentials", async () => {
    getVirtual
      .mockResolvedValueOnce({ sourceKind: null, virtual: false })
      .mockResolvedValueOnce({
        sourceKind: "asyncapi-yaml",
  ...
  it("switching asyncapi-yaml back to repository hides virtual fields", async () => {
    getVirtual.mockResolvedValue({
      sourceKind: "asyncapi-yaml",
      rootPath: "C:/asyncapi-docs",
      virtual: true,
    ...
    expect(screen.queryByTestId("developer-site-virtual-asyncapi-yaml-hint")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-build-section")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-build")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-preview")).toBeNull();
    expect(screen.queryByTestId("developer-site-virtual-publish")).toBeNull();
  ...
  it("loads graphql-sdl values with root path and shows Build/Preview/Publish chrome", async () => {
    ...
    expect(screen.getByTestId("developer-site-virtual-graphql-sdl-hint")).toBeTruthy();
    expect(screen.getByTestId("developer-site-virtual-graphql-sdl-hint").textContent).toBe(
  ...
  it("saves graphql-sdl configuration without Git remote fields or graphql.url", async () => {
    getVirtual
      .mockResolvedValueOnce({ sourceKind: null, virtual: false })
      .mockResolvedValueOnce({
        sourceKind: "graphql-sdl",
    ...
    expect(savedBody).not.toHaveProperty("password");
    expect(JSON.stringify(savedBody)).not.toMatch(
      /authorization|api[_-]?key|crawl|credential|token|graphql\.url/i,
    );
    expect(getVirtual).toHaveBeenCalledTimes(2);
    expect(
      (screen.getByTestId("developer-site-virtual-root-path") as HTMLInputElement).value,
  ...
  it("switching graphql-sdl back to repository hides virtual fields", async () => {
    getVirtual.mockResolvedValue({
      sourceKind: "graphql-sdl",
      rootPath: "C:/graphql-docs",
      virtual: true,
  ...
  it("shows Build chrome for rss-atom and success result with Preview and Publish", async () => {
    ...
    buildVirtual.mockResolvedValue({
      siteName: "Help",
      siteKey: "rss-atom-docs",
      outputPath: "C:/tmp/virtual-sites/rss-atom-docs",
      pagesWritten: 1,
      linkProblemCount: 0,
      hasLinkProblems: false,
      linkProblems: [],
  ...
  it("shows Preview chrome for rss-atom and opens last-build home", async () => {
    const open = vi.fn();
    window.open = open;
    getVirtual.mockResolvedValue({
      sourceKind: "rss-atom",
    ...
    expect(previewStatus).toHaveBeenCalledWith("RssHelp");
    expect(String(open.mock.calls[0][0])).toContain("8.2/index.html");
    expect(open.mock.calls[0][1]).toBe("_blank");
  });

  it("shows Preview chrome for sitemap-xml and opens last-build home", async () => {
    const open = vi.fn();
    window.open = open;
    getVirtual.mockResolvedValue({
      sourceKind: "sitemap-xml",
  ...
  it("shows Preview chrome for robots-txt and opens last-build home (Publish shown)", async () => {
    const open = vi.fn();
    window.open = open;
    getVirtual.mockResolvedValue({
      sourceKind: "robots-txt",
  ...
  it("shows Preview chrome for asyncapi-yaml and opens last-build home", async () => {
    ...
    previewStatus.mockResolvedValue({
      available: true,
      homePath: "8.2/onLightMeasured-1.html",
    });
    ...
    expect(previewStatus).toHaveBeenCalledWith("AsyncApiHelp");
    expect(String(open.mock.calls[0][0])).toContain("8.2/onLightMeasured-1.html");
    expect(open.mock.calls[0][1]).toBe("_blank");
  });
  ...
  it("shows Preview chrome for json-schema and opens last-build home (Publish hidden)", async () => {
    ...
    expect(previewStatus).toHaveBeenCalledWith("JsonSchemaHelp");
    expect(String(open.mock.calls[0][0])).toContain("8.2/sku-1.html");
    expect(open.mock.calls[0][1]).toBe("_blank");
  });

  it("shows empty preview state for sitemap-xml when no assembled site exists", async () => {
    window.open = vi.fn();
    getVirtual.mockResolvedValue({
      sourceKind: "sitemap-xml",
      rootPath: "C:/sitemap-xml-docs",
  ...
  it("shows Publish chrome for robots-txt and success dest path", async () => {
    getVirtual.mockResolvedValue({
      sourceKind: "robots-txt",
      rootPath: "C:/robots-txt-docs",
      virtual: true,
    ...
    const savedBodyHint = screen.getByTestId("developer-site-virtual-robots-txt-hint").textContent;
    expect(savedBodyHint).not.toMatch(/authorization|api[_-]?key|crawl credential|password/i);
    fireEvent.click(screen.getByTestId("developer-site-virtual-publish"));
    await waitFor(() => {
      expect(screen.getByTestId("developer-site-virtual-publish-result")).toBeTruthy();
    });
    expect(publishVirtual).toHaveBeenCalledWith("RobotsHelp");
    expect(screen.getByTestId("developer-site-virtual-publish-success").textContent).toContain(
      DEV_MSG.SITE_VIRT_PUBLISH_SUCCESS,
    );
    expect(screen.getByTestId("developer-site-virtual-publish-files").textContent).toBe("3");
