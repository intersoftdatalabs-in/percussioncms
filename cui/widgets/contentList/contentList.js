...
[
  "pages/cm1adaptor",
  "text!widgets/contentList/contentList.html",
  "widgets/contentList/contentList.ViewModel",
  "widgel-base",
], function (cm1Adaptor, defaultView, defaultViewModel) {
  // module:
  var widgetName = "cui.contentList";
  ...
  $.widGEL.baseWidget.injectCssFile(
    "widgets.contentList",
    requirejs.toUrl("widgets/contentList/contentList.css")
  );
