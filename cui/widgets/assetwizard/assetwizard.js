...
define (
    ...
    [
		'pages/cm1adaptor',
        'text!widgets/assetwizard/assetwizard.html',
        'widgets/assetwizard/assetwizard.viewmodel',
        'widgel-base'
    ],
    // module:
    function (cm1Adaptor, defaultView, defaultViewModel) {
        var widgetName = 'cui.assetwizard';
        ...
        $.widGEL.baseWidget.injectCssFile('widgets.assetwizard', requirejs.toUrl('widgets/assetwizard/assetwizard.css'));
		...
		$.widGEL.baseWidget.injectCssFile('fancytree.css', requirejs.toUrl('fancytree-css'));
