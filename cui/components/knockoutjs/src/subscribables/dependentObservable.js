ko.computed = ko.dependentObservable = function (
  ...
  function addSubscriptionToDependency(subscribable, id) {
    if (!_subscriptionsToDependencies[id]) {
      _subscriptionsToDependencies[id] = subscribable.subscribe(
  ...
  function evaluateImmediate() {
    ...
    try {
      ...
      try {
        var newValue = evaluatorFunctionTarget
    ...
    if (disposeWhenNodeIsRemoved.nodeType) {
      disposeWhen = function () {
        return (
          ...
          (disposeWhenOption && disposeWhenOption())
        );
      };
    }
  }
  ...
  if (
    disposeWhenNodeIsRemoved &&
    isActive() &&
    disposeWhenNodeIsRemoved.nodeType
  ) {
    dispose = function () {
