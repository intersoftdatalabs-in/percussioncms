(function () {
    ...
    if (targetNodeOrNodeArray) {
      ...
      return ko.dependentObservable(
        ...
        function () {
          ...
          var templateName = ko.isObservable(template)
            ? template()
            : typeof template == "function"
            ? template(bindingContext["$data"], bindingContext)
            : template;
  ...
  ko.renderTemplateForEach = function (
    ...
    var executeTemplateForArrayItem = function (arrayValue, index) {
      ...
      var templateName =
        typeof template == "function"
          ? template(arrayValue, arrayItemContext)
          : template;
    ...
    init: function (element, valueAccessor) {
      ...
      if (typeof bindingValue == "string" || bindingValue["name"]) {
        ...
        var templateNodes = ko.virtualElements.childNodes(element),
          container =
            ko.utils.moveCleanedNodesToContainerElement(templateNodes); // This also removes the nodes from their current parent
