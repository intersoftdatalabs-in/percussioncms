...
public interface IPSCommentRestService extends IPSRestService {
   ...
   *     each allowed criteria field. Cannot be <code>null</code>.
   ...
   *
   * @param callback the callback name to be used for jsonp wrapping, defaults to <code>fn</code>.
   * @param pagepath the page path not including site. This is a querystring param and is not
   *     required and may be <code>null</code> or empty.
   * @param site See {@link PSCommentCriteria#getSite()}.
   *     <p>This is a querystring param and is not required and may be <code>null</code> or empty.
   * @param username This is a querystring param and is not required and may be <code>null</code> or
   *     empty.
   * @param state This is a querystring param and is not required and may be <code>null</code> or
   *     empty.
   * @param maxResults This is a querystring param and is not required and may be <code>null</code>
   *     or empty.
   * @param startIndex This is a querystring param and is not required and may be <code>null</code>
   *     or empty.
   * @param tag This is a querystring param and is not required and may be <code>null</code> or
   *     empty.
   * @param sortby This is a querystring param and is not required and may be <code>null</code> or
   *     empty.
   * @param ascending This is a querystring param and is not required and may be <code>null</code>
   *     or empty.
   * @param moderated This is a querystring param and is not required and may be <code>null</code>
   *     or empty.
   * @param viewed This is a querystring param and is not required and may be <code>null</code> or
   *     empty.
   * @return wrapped comments object, never <code>null</code> or empty. But the wrapper object may
   *     contain no comment data.
   */
  @POST
  @Path("/jsonp")
  @Produces(MediaType.APPLICATION_JSON)
  ...
  /**
   * Retrieves list of page summaries for the specified site. Page summaries include the pagepath,
   * total count, and approved count.
   *
   * @param site the sitename of the site to find pages with comments for.
   * @param maxResults the max results that should be returned, may be <code>null</code> or empty.
   *     Used for paging.
   * @param startIndex the stating index of the page result to send back, may be <code>null</code>
   ...
   *
   * @param params the multivaluedmap of all parameters passed in by the form. Never <code>null
   *     </code>, may be empty.
   * @param headers the multivaluedmap of request header parameters. Never <code>null</code>, may be
   *     empty.
   */
  @POST
  @Path("/addcomment")
   ...
   *
   * @param commentIds An object which represent a list of comment IDs to be deleted.
   */
  @PUT
  @RolesAllowed("deliverymanager")
  ...
  public abstract String getDefaultModerationState(@PathParam("site") String site);
