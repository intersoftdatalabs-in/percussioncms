...
public class PSProfanityFilter {
  ...
  /**
   * * Initializes the Profanity filter from a file. Will first try to load it from conf/perc. If it
   * is not found, will load it from the old webapps location. If that is not found, will load it
   * from the class path resource.
   */
