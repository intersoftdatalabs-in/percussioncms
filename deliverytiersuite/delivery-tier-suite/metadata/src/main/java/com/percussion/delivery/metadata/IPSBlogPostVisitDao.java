...
public interface IPSBlogPostVisitDao {
   ...
   *
   * @param pagepaths collection of page path strings whose visits needs to be deleted. Cannot be
   ...
   *
   * @param pagepath The page path of the page visit entry that should be deleted. Cannot be <code>
   *     null</code> nor empty.
   ...
   *
   * @param visits collection of entries to be saved, cannot be <code>null</code>, may be empty.
   */
   ...
   *
   * @param visit A {@link IPSBlogPostVisit} instance to store in the database. Cannot be <code>null
   *     </code>.
   */
  public void save(IPSBlogPostVisit visit);

  /**
   * Returns list of most visited pages within the supplied number of days, limits to the supplied
   * limit amount.
   *
   ...
   *
   * @param pagepath The pagepath of the page visit entry to return. Cannot be <code>null</code> nor
   *     empty.
   * @return The page visit entry with the pagepath specified. If no entry is found, null is
   *     returned.
   */
