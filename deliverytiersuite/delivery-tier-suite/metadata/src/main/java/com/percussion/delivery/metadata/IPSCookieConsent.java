...
public interface IPSCookieConsent {
   ...
   *
   * @param serviceName the name of service cookies.
   */
  ...
  /**
   * Sets whether the user opted in for cookie consent. Should always be true as if they did not, no
  ...
  /**
   * Returns whether the user opted in to use cookies. Should always be true if there is a record
   * present.
   *
