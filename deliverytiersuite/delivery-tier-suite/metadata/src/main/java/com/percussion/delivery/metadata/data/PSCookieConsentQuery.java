 ...
 * variable 'services' which is needed to map all cookies approved by the client to unique DB
 * entries per approved cookie.
 *
 * @author chriswright
 */
...
public final class PSCookieConsentQuery extends PSCookieConsent {
  ...
  public String toString() {
    return String.format(
        "Site name: %s - IP: %s - Consent Date: %s - Services: %s",
