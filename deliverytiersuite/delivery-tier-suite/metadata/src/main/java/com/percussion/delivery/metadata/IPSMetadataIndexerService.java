...
/**
 * This interface defines the behavior of an indexer of metadata information from pages. It provides
 * the methods to save/update/delete metadata entries along with its properties.
 *
 * @author davidpardini
 */
public interface IPSMetadataIndexerService {
   ...
   *
   * @return A set of string with the indexed directories and subdirectories. For example:
   *     "/testdir1", "/testdir1/subdir".
   */
   ...
   *
   * @param pagepaths collection of page path strings that identifies the index entries. Cannot be
   ...
   *
   * @param entryToDelete The pagepath of the metadata entry that should be deleted. Cannot be
