...
/**
 * This class holds property to datatype mappings used to figure out which datatype to store the
 * property value as. It is intended to be instantiated and injected via Spring. The mappings are
 * defined in the beans.xml file.
 *
 * @author erikserating
 */
  ...
  public VALUETYPE getDatatype(String key) {
    if (datatypeMappings == null)
      throw new IllegalStateException(
          "datatypeMappings is null, this class must be instantiated via Spring for data to be"
              + " filled in.");
    ...
    if (stringProp == null) return prop;
