  ...
  public void testParsingValidCriteria() throws Exception {
    ...
    el =
        new PSCriteriaElement(
            "perc:category IN ('/Categories/Cursos Cortos/Hoteleria, Turismo y Gastronomia/Espania', '/Categories/Cursos Cortos/Hoteleria, Turismo y Gastronomia/Francia', '/Categories/Cursos Cortos/Hoteleria, Turismo y Gastronomia/Peru')");
    assertEquals(el.getName(), "perc:category");
    assertEquals(el.getOperation(), "IN");
    assertEquals(
        el.getValue(),
        "'/Categories/Cursos Cortos/Hoteleria, Turismo y Gastronomia/Espania', '/Categories/Cursos Cortos/Hoteleria, Turismo y Gastronomia/Francia', '/Categories/Cursos Cortos/Hoteleria, Turismo y Gastronomia/Peru'");
