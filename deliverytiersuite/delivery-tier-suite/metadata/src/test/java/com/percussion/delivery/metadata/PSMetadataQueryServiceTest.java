...
public class PSMetadataQueryServiceTest extends TestCase {
  ...
  public void testQuery() throws Exception {
    ...
    for (IPSMetadataEntry entry : results) {
      ...
      assertEquals(
          "dcterms:title value type", VALUETYPE.STRING, props.get("dcterms:title").getValuetype());
      assertTrue(
          "dcterms:title value",
  ...
  public void testOrderBy_Title_SimpleOrdering() throws Exception {
    ...
    assertEquals(
        "First title from the list", "c page 2", props.get("dcterms:title").getStringvalue());

    props = toPropsMap(results.get(1).getProperties());
    assertEquals(
        "First title from the list", "d page", props.get("dcterms:title").getStringvalue());
  }
  ...
  public void testOrderBy_Title_MixingUpperAndLowerCasedChars_Asc() throws Exception {
    ...
    props = toPropsMap(results.get(0).getProperties());
    assertEquals(
        "First title from the list", "E page", props.get("dcterms:title").getStringvalue());
  ...
  public void testOrderBy_Title_MixingUpperAndLowerCasedChars_Desc() throws Exception {
    ...
    props = toPropsMap(results.get(0).getProperties());
    assertEquals(
        "First title from the list", "b page", props.get("dcterms:title").getStringvalue());

    props = toPropsMap(results.get(1).getProperties());
    assertEquals(
        "First title from the list", "A page", props.get("dcterms:title").getStringvalue());
  }
