...
public class PSMetadataQueryServiceTest {
  ...
  public void testTagsProcess_withOrderCount() throws Exception {
    ...
    List<PSPair<String, Integer>> tags =
        psMetadataTagsHelper.processTags(results, PSMetadataTagsHelper.COUNT_SORT);
  ...
  private List<IPSMetadataEntry> initiazeTagsProcessTest() {
    ...
    PSDbMetadataProperty propNotFound1 =
        new PSDbMetadataProperty("NOT ref", VALUETYPE.STRING, "no tags");
    PSDbMetadataProperty propNotFound2 =
        new PSDbMetadataProperty("NOT ref", VALUETYPE.STRING, "no tags");
    PSDbMetadataProperty propFound31 =
        new PSDbMetadataProperty(PSMetadataTagsHelper.REFERENCES, VALUETYPE.STRING, " PEpe");
    PSDbMetadataProperty propFound32 =
        new PSDbMetadataProperty(PSMetadataTagsHelper.REFERENCES, VALUETYPE.STRING, "       bar");
    PSDbMetadataProperty propFound33 =
        new PSDbMetadataProperty(PSMetadataTagsHelper.REFERENCES, VALUETYPE.STRING, "   foo");
    PSDbMetadataProperty propFound34 =
        new PSDbMetadataProperty(PSMetadataTagsHelper.REFERENCES, VALUETYPE.STRING, " LEO");
    PSDbMetadataProperty propFound35 =
        new PSDbMetadataProperty(
            PSMetadataTagsHelper.REFERENCES, VALUETYPE.STRING, "david          ");
    PSDbMetadataProperty propFound36 =
        new PSDbMetadataProperty(PSMetadataTagsHelper.REFERENCES, VALUETYPE.STRING, "jb");

    PSDbMetadataProperty propFound4 =
        new PSDbMetadataProperty(PSMetadataTagsHelper.REFERENCES, VALUETYPE.STRING, "jb");
    PSDbMetadataProperty propFound51 =
        new PSDbMetadataProperty(PSMetadataTagsHelper.REFERENCES, VALUETYPE.STRING, "PEPE");
    PSDbMetadataProperty propFound52 =
        new PSDbMetadataProperty(PSMetadataTagsHelper.REFERENCES, VALUETYPE.STRING, "LEO");
    PSDbMetadataProperty propFound53 =
        new PSDbMetadataProperty(PSMetadataTagsHelper.REFERENCES, VALUETYPE.STRING, "jb");
    // page1
  ...
  public void testProcessCategories() throws Exception {
    ...
    List<PSMetadataRestCategory> categoriesPage1 =
        psMetadataCategoriesHelper.processCategories(resultsPage1);
    List<PSMetadataRestCategory> categoriesPage2 =
        psMetadataCategoriesHelper.processCategories(resultsPage2);
  ...
  private List<IPSMetadataEntry> initializeNullCategoriesProcessTest() {
    ...
    PSDbMetadataProperty propNotFound1 =
        new PSDbMetadataProperty("NOT ref", VALUETYPE.STRING, "no categories");
  ...
  private List<IPSMetadataEntry> initializeCategoriesProcessTest() {
    ...
    PSDbMetadataProperty propFound1 =
        new PSDbMetadataProperty(
            PSMetadataCategoriesHelper.REFERENCES,
            VALUETYPE.STRING,
            "/Categories/CategoryB/CategoryB2");
    PSDbMetadataProperty propFound2 =
        new PSDbMetadataProperty(
            PSMetadataCategoriesHelper.REFERENCES,
            VALUETYPE.STRING,
            "/Categories/CategoryB/CategoryB1");
    PSDbMetadataProperty propFound3 =
        new PSDbMetadataProperty(
            PSMetadataCategoriesHelper.REFERENCES,
            VALUETYPE.STRING,
            "/Categories/CategoryA/CategoryA2");
    PSDbMetadataProperty propFound4 =
        new PSDbMetadataProperty(
            PSMetadataCategoriesHelper.REFERENCES,
            VALUETYPE.STRING,
  ...
  public void testQuery() throws Exception {
    ...
    for (IPSMetadataEntry entry : results) {
      ...
      assertEquals(
          VALUETYPE.STRING, props.get("dcterms:title").getValuetype(), "dcterms:title value type");
      assertTrue(
          props.get("dcterms:title").getStringvalue().startsWith("ABC Title"),
          "dcterms:title value");
  ...
  private PSDbMetadataEntry createCategoryEntry() {
    ...
    entry.addProperty(
        new PSDbMetadataProperty("perc:category", "/Categories/Jardineria/Arboles/Perennes"));
  ...
  public void testCriteria_Single_EntryField_Pagepath() throws Exception {
    runEntryTest(
        "pagepath = '/testsite/folderA/events/page7.html'",
        1,
        new PropertyValueChecker<IPSMetadataEntry>() {
          public boolean valueIsCorrect(IPSMetadataEntry currentValue) {
  ...
  public void testCriteria_Single_Property_String_InOperator() throws Exception {
    runPropertyTest(
        "dcterms:source IN ('otherTemplate', 'template2')",
        ENTRY_COUNT * 2,
        "dcterms:source",
        VALUETYPE.STRING,
        new PropertyValueChecker<Object>() {
  ...
  public void testCriteria_Single_Property_Date_LessThanOperator() throws Exception {
    runPropertyTest(
        "dcterms:created < '2010-12-15T00:00:00'",
        ENTRY_COUNT,
        "dcterms:created",
        VALUETYPE.DATE,
        new PropertyValueChecker<Object>() {
  ...
  public void testCriteria_Single_Property_Date_DifferentDateFormatSpecified() throws Exception {
    runPropertyTest(
        "dcterms:created <= '2010-12-15 16:17:18'",
        ENTRY_COUNT * 2,
        "dcterms:created",
        VALUETYPE.DATE,
        new PropertyValueChecker<Object>() {
  ...
  public void testOrderBy_Title_SimpleOrdering() throws Exception {
    ...
    String[] orderedTitles =
        new String[] {"a page", "b page", "b page 2", "c page", "c page 2", "d page"};
    ...
    assertEquals(
        "c page 2", props.get("dcterms:title").getStringvalue(), "First title from the list");

    props = toPropsMap(results.get(1).getProperties());
    assertEquals(
        "d page", props.get("dcterms:title").getStringvalue(), "First title from the list");
  }
  ...
  public void testOrderBy_Title_MixingUpperAndLowerCasedChars_Asc() throws Exception {
    ...
    List<IPSMetadataEntry> entries = new ArrayList<IPSMetadataEntry>();
    String[] orderedTitles =
        new String[] {"A page", "b page", "c page", "D page", "E page", "f page"};
    ...
    props = toPropsMap(results.get(0).getProperties());
    assertEquals(
        "E page", props.get("dcterms:title").getStringvalue(), "First title from the list");
  ...
  public void testOrderBy_Title_MixingUpperAndLowerCasedChars_Desc() throws Exception {
    ...
    List<IPSMetadataEntry> entries = new ArrayList<IPSMetadataEntry>();
    String[] orderedTitles =
        new String[] {"f page", "E page", "D page", "c page", "b page", "A page"};
    ...
    props = toPropsMap(results.get(0).getProperties());
    assertEquals(
        "b page", props.get("dcterms:title").getStringvalue(), "First title from the list");

    props = toPropsMap(results.get(1).getProperties());
    assertEquals(
        "A page", props.get("dcterms:title").getStringvalue(), "First title from the list");
  }
  ...
  public void testOrderBy_PagePath() throws Exception {
    ...
    for (int i = 0; i < orderedFileNames.length; i++) {
      ...
      PSDbMetadataEntry entry =
          new PSDbMetadataEntry(fileName, "folder", path + fileName, "TestType", "customSite");
  ...
  public void testOrderBy_Folder() throws Exception {
    ...
    String[] folderNames =
        new String[] {
          ...
          "/latestfolder/child1/",
          "/oldfolder/child1/",
          "/testingfolder/child1/",
        };
    for (int i = 0; i < ENTRY_COUNT; i++) {
      String folderName = folderNames[i];
      String pagepath = "/testsite" + folderName + "foo.html" + i;
      PSDbMetadataEntry entry =
          new PSDbMetadataEntry("foo.html" + i, folderName, pagepath, "TestType", "customSite");
      entries.add(entry);
    }
    indexer.save(entries);
  ...
  public void testOrderBy_Name() throws Exception {
    ...
    List<IPSMetadataEntry> entries = new ArrayList<IPSMetadataEntry>();
    Integer totalCount = 0;
    String[] pageNames = new String[] {"blog", "demo", "index", "post", "testing"};
    for (int i = 0; i < pageNames.length; i++) {
      String pageName = pageNames[i];
      String pagepath = "/testsite/folder1/child1/foo.html" + i;
      PSDbMetadataEntry entry =
          new PSDbMetadataEntry(pageName, "/folder1/child1/", pagepath, "TestType", "customSite");
    ...
    for (int i = 0; i < ENTRY_COUNT; i++) {
      ...
      PSDbMetadataEntry entry =
          new PSDbMetadataEntry(
              "foo.html" + i, "/folder1/child1/", pagepath, "TestType", "customSite");
      entry.clearProperties();
  ...
  private void runEntryTest(
      ...
      PropertyValueChecker<IPSMetadataEntry> propertyValueChecker)
      throws Exception {
    PSMetadataQuery query = new PSMetadataQuery();
    List<String> criteria = new ArrayList<String>();
  ...
  private void runPropertyTest(
      String criteriaString,
      int entryCountExpected,
      String propertyName,
      VALUETYPE propertyValuetypeExpected,
      PropertyValueChecker<Object> propertyValueChecker)
      throws Exception {
    PSMetadataQuery query = new PSMetadataQuery();
    List<String> criteria = new ArrayList<String>();
    ...
    for (IPSMetadataEntry entry : results) {
      ...
      assertEquals(
          propertyValuetypeExpected,
          props.get(propertyName).getValuetype(),
          "entry " + propertyName + " prop valuetype");

      assertTrue(
          propertyValueChecker.valueIsCorrect(props.get(propertyName).getValue()),
          "entry " + propertyName + " prop value");
    }
  }
  ...
  private PSDbMetadataEntry createEntry(
      ...
      int idx) {
    return createEntry(
        testsite, "ABC Title " + idx, folder, linktext, date, abstr, template, type, idx);
  }
  ...
  /**
   * Customer query that failed to sort {"criteria":["type = 'page'","dcterms:created >=
   * '2020-06-01T00:00:00'","site = 'portal'","folder LIKE
   * '/noticias/destacadas/noticias-destacadas-2021/%'","dcterms:source =
   * 'Noticias-Noticia-Single'"],"maxResults":3,"totalMaxResults":500,"isEditMode":"false","orderBy":"dcterms:created
   * desc, linktext_lower asc","returnTotalEntries":true,"startIndex":0}
   */
  @Test
  public void testSortByCreatedDateDesc() {
    ...
    try {
      query =
          mapper.readValue(
              "{\"criteria\":[\"type = 'page'\",\"site = 'portal'\",\"folder LIKE"
                  + " '/noticias/destacadas/noticias-destacadas-2021/%'\",\"dcterms:source ="
                  + " 'Noticias-Noticia-Single'\"],\"maxResults\":5,\"totalMaxResults\":500,\"isEditMode\":\"false\",\"orderBy\":\"dcterms:created"
                  + " desc, linktext_lower asc\",\"returnTotalEntries\":true,\"startIndex\":0}",
      ...
      query =
          mapper.readValue(
              "{\"criteria\":[\"type = 'page'\",\"site = 'portal'\",\"folder LIKE"
                  + " '/noticias/destacadas/noticias-destacadas-2021/%'\",\"dcterms:source ="
                  + " 'Noticias-Noticia-Single'\"],\"maxResults\":5,\"totalMaxResults\":500,\"isEditMode\":\"false\",\"orderBy\":\"dcterms:created"
                  + " asc, linktext_lower desc\",\"returnTotalEntries\":true,\"startIndex\":0}",
              PSMetadataQuery.class);
    ...
    try {
      query =
          mapper.readValue(
              "{\"criteria\":[\"type = 'page'\",\"site = 'portal'\",\"folder LIKE"
                  + " '/noticias/destacadas/noticias-destacadas-2021/%'\",\"dcterms:source ="
                  + " 'Noticias-Noticia-Single'\"],\"maxResults\":5,\"totalMaxResults\":500,\"isEditMode\":\"false\",\"orderBy\":\"linktext_lower"
                  + " asc\",\"returnTotalEntries\":true,\"startIndex\":0}",
              PSMetadataQuery.class);
      ...
      query =
          mapper.readValue(
              "{\"criteria\":[\"type = 'page'\",\"site = 'portal'\",\"folder LIKE"
                  + " '/noticias/destacadas/noticias-destacadas-2021/%'\",\"dcterms:source ="
                  + " 'Noticias-Noticia-Single'\"],\"maxResults\":5,\"totalMaxResults\":500,\"isEditMode\":\"false\",\"orderBy\":\"linktext_lower"
                  + " desc\",\"returnTotalEntries\":true,\"startIndex\":0}",
              PSMetadataQuery.class);
