...
public class PSFormDataJoinerTest {
   ...
   *
   * @param data An array consisting of form names and their values for each field. Odd positions
   *     have the form name, and even ones have a String array with values.
  ...
  public void testGenerateCsv_NoForms() throws Exception {
    ...
    assertEquals(StringUtils.EMPTY, formDataJoiner.generateCsv(new ArrayList<IPSFormData>()));
  }
  ...
  public void testGenerateCsv_SingleForm() throws Exception {
    ...
    // be compared
    List<IPSFormData> data =
        generateSampleData(new Object[] {"testform1", new String[] {"field1", "value1"}});

    Date created = data.get(0).getCreateDate();
    assertEquals(
        join("Form name,Create date,field1", "testform1," + created.toString() + ",value1"),
  ...
  public void testGenerateCsv_SingleForm_FieldValueWithComma() throws Exception {
    List<IPSFormData> formData =
        generateSampleData(
            new Object[] {"testform1", new String[] {"field1", "value1, with comma"}});
    assertEquals(
        join(
            "Form name,Create date,field1",
