...
public class PSFeedDaoTest {
  @Autowired private IPSFeedDao dao;
  ...
  public void testSaveLoadDescriptors() throws Exception {
    IPSFeedDescriptor desc1 =
        new TestDescriptor(
            "test1", "site1", "test description", "http://www.testme.com", "Test 1", "{}", "RSS2");
    IPSFeedDescriptor desc2 =
        new TestDescriptor(
            "test2",
            "site1",
            "test description2",
            "http://www.testme2.com",
            "Test 2",
            "{}",
            "RSS1");
    IPSFeedDescriptor desc3 =
        new TestDescriptor(
            "test3",
            "site2",
            "test description3",
            "http://www.testme3.com",
            "Test 3",
            "{}",
            "ATOM");
    ...
    IPSFeedDescriptor desc1_a =
        new TestDescriptor(
            "test4",
            "site1",
            "test description4",
            "http://www.testme4.com",
            "Test 4",
            "{}",
            "RSS2");
    IPSFeedDescriptor desc2_a =
        new TestDescriptor(
            "test2",
            "site1",
            "test description5",
            "http://www.testme5.com",
            "Test 5",
            "{}",
            "RSS1");
    updates.add(desc1_a);
