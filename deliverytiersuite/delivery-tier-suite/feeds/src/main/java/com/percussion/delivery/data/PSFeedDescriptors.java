...
public class PSFeedDescriptors
{
   ...
   private List<com.percussion.delivery.feeds.data.IPSFeedDescriptor> descriptors = new ArrayList<>();
 ...
 */
public List<com.percussion.delivery.feeds.data.IPSFeedDescriptor> getDescriptors()
{
    return descriptors;
}
