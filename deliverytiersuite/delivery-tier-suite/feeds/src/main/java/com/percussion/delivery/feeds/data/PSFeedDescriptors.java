...
public class PSFeedDescriptors {
    ...
    public PSFeedDescriptors(List<IPSFeedDescriptor> descriptors, String serviceUrl, String serviceUser, String servicePass, boolean servicePassEncrypted, String site) {
    ...
    public String toString() {
        return String.format("PSFeedDescriptors[descriptors=%s, serviceUrl=%s, serviceUser=%s, servicePassEncrypted=%s, site=%s]", descriptors, serviceUrl, serviceUser, servicePassEncrypted, site);
    }
}
