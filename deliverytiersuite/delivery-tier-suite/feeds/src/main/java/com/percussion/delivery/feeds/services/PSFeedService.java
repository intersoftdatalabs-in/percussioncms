...
public class PSFeedService extends PSAbstractRestService implements IPSFeedsRestService {
  ...
  private String generateFeed(
      IPSFeedDescriptor desc, String hostName, HttpServletRequest httpRequest)
    ...
    try {
      ...
      String host =
          StringUtils.isBlank(hostName) ? PSFeedGenerator.getHost(desc.getLink()) : hostName;
