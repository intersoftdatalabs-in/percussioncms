...
(function () {
  ...
  var HttpPostDataLayout = function (
    loggerKey,
    timeStampKey,
    levelKey,
    messageKey,
  ...
  var AjaxAppender = function (
    ...
    function preparePostData(batchedLoggingEvents) {
      ...
      while ((currentLoggingEvent = batchedLoggingEvents.shift())) {
        var currentFormattedMessage = appender
          .getLayout()
          .format(currentLoggingEvent);
      ...
      if (inPage) {
        ...
        init = function () {
          var initErrorMessage =
            "InPageAppender.init: unable to create console iframe";
          function finalInit() {
            try {
              getConsoleWindow().setNewestAtTop(newestMessageAtTop);
              getConsoleWindow().setScrollToLatest(scrollToLatestMessage);
