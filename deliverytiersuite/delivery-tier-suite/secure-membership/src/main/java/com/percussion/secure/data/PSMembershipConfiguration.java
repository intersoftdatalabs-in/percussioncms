...
public class PSMembershipConfiguration {
   ...
   *
   * @param membershipServiceProtocol The protocol (http or https), may not be <code>null</code> or
   *     empty
   */
   ...
   *
   * @param membershipServicePort The port, may not be <code>null</code> or empty, should be valid
   ...
   *
   * @return the value provided by user in the perc-secured-sections.properties file for
   *     perc.use.ldap
   */
