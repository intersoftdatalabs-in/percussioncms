...
@XmlType(
    name = "",
    propOrder = {"getRoomsAvailable3Result"})
@XmlRootElement(name = "GetRoomsAvailable3Response")
public class GetRoomsAvailable3Response {

  @XmlElement(name = "GetRoomsAvailable3Result")
