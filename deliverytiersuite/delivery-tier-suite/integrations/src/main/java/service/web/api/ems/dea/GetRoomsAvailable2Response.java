...
@XmlType(
    name = "",
    propOrder = {"getRoomsAvailable2Result"})
@XmlRootElement(name = "GetRoomsAvailable2Response")
public class GetRoomsAvailable2Response {

  @XmlElement(name = "GetRoomsAvailable2Result")
