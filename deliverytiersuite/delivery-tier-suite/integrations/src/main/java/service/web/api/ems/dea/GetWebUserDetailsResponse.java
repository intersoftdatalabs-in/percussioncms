...
@XmlType(
    name = "",
    propOrder = {"getWebUserDetailsResult"})
@XmlRootElement(name = "GetWebUserDetailsResponse")
public class GetWebUserDetailsResponse {

  @XmlElement(name = "GetWebUserDetailsResult")
