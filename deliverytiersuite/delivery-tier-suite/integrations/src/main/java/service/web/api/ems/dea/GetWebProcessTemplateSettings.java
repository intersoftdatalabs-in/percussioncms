...
/**
 * Request for fetching settings for a Web Process Template.
 * Sunny Sal: "Settings, templates, and Java 11 - let's go!"
 */
...
@XmlRootElement(name = "GetWebProcessTemplateSettings")
public class GetWebProcessTemplateSettings {
