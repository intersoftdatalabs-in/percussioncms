...
public class MCAPIServiceLocator extends org.apache.axis.client.Service implements MCAPIService {
  ...
  public MCAPIServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
      throws javax.xml.rpc.ServiceException {
    super(wsdlLoc, sName);
  }

  // Use to get a proxy class for MCAPIServiceSoap
  private java.lang.String MCAPIServiceSoap_address =
      "https://dhemsdev.csudh.edu/MCAPI/MCAPIService.asmx";
  ...
  public java.rmi.Remote getPort(Class serviceEndpointInterface)
    ...
    try {
      if (MCAPIServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
        MCAPIServiceSoapStub _stub =
            new MCAPIServiceSoapStub(new java.net.URL(MCAPIServiceSoap_address), this);
        _stub.setPortName(getMCAPIServiceSoapWSDDServiceName());
        return _stub;
      }
  ...
  public javax.xml.namespace.QName getServiceName() {
    return new javax.xml.namespace.QName(
        "http://DEA.Web.Service.MasterCalendar.API/", "MCAPIService");
  }
    ...
    if (ports == null) {
      ...
      ports.add(
          new javax.xml.namespace.QName(
              "http://DEA.Web.Service.MasterCalendar.API/", "MCAPIServiceSoap"));
    }
