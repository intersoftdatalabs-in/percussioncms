...
@XmlType(
    name = "",
    propOrder = {"getComboRoomComponentsResult"})
@XmlRootElement(name = "GetComboRoomComponentsResponse")
public class GetComboRoomComponentsResponse {

  @XmlElement(name = "GetComboRoomComponentsResult")
