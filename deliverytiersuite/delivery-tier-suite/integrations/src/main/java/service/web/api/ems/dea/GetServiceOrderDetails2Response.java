 ...
 *       &lt;sequence&gt;
 *         &lt;element name="GetServiceOrderDetails2Result" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(
    name = "",
    propOrder = {"getServiceOrderDetails2Result"})
...
public class GetServiceOrderDetails2Response {
  ...
  /**
   * Gets the value of the getServiceOrderDetails2Result property.
   *
  ...
  /**
   * Sets the value of the getServiceOrderDetails2Result property.
   *
   * @param value allowed object is {@link String }
   */
  public void setGetServiceOrderDetails2Result(String value) {
    this.getServiceOrderDetails2Result = value;
  }
}
