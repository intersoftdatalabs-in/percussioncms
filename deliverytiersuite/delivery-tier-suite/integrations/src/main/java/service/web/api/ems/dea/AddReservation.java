...
/**
 * Java 11+ refactored SOAP request for AddReservation.
...
public final class AddReservation {
    ...
    private AddReservation(Builder builder) {
    ...
    public static class Builder {
        ...
        public AddReservation build() { return new AddReservation(this); }
    }
    ...
    public boolean equals(Object o) {
        ...
        AddReservation that = (AddReservation) o;
    ...
    @Override
    public int hashCode() {
        return java.util.Objects.hash(userName, password, groupID, roomID, bookingDate, startTime, endTime, eventName, statusID);
    }
    @Override
