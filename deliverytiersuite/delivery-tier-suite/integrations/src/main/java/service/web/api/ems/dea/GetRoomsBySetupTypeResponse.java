 ...
 *       &lt;sequence&gt;
 *         &lt;element name="GetRoomsBySetupTypeResult" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(
    name = "",
    propOrder = {"getRoomsBySetupTypeResult"})
...
public class GetRoomsBySetupTypeResponse {
  ...
  /**
   * Gets the value of the getRoomsBySetupTypeResult property.
   *
  ...
  /**
   * Sets the value of the getRoomsBySetupTypeResult property.
   *
   * @param value allowed object is {@link String }
   */
  public void setGetRoomsBySetupTypeResult(String value) {
    this.getRoomsBySetupTypeResult = value;
  }
}
