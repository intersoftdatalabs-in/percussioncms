...
/**
 * * <Data> <Description>Z (old) Loker Student Union</Description> <BuildingCode>(old)
 * LSU</BuildingCode> <ID>1</ID> <TimeZoneDescription>Pacific Time (US &amp; Canada);
 * Tijuana</TimeZoneDescription> <TimeZoneAbbreviation>PT</TimeZoneAbbreviation>
 * <CurrentLocalTime>2018-05-14T12:51:08.493</CurrentLocalTime> </Data>
 *
 * @author natechadwick
 */
  ...
  public void setCurrentLocalTime(String currentLocalTime) {
    try {
      this.currentLocalTime =
          FastDateFormat.getInstance(IPSEMSEventService.DATETIME_FORMAT_STRING)
              .parse(currentLocalTime.replace("T", " "));
    } catch (ParseException e) {
      log.error(
          "Error setting CurrentLocalTime with value {} and format: {}, Error: {}",
          currentLocalTime,
          IPSEMSEventService.DATETIME_FORMAT_STRING,
          e.getMessage());
