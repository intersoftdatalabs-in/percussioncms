...
/**
 * <Data> <CategoryID>2147483647</CategoryID> <CategoryDescription>Room Charge</CategoryDescription>
 * <UseCutOff>false</UseCutOff> <CutOffTime>1900-01-01T00:00:00</CutOffTime>
 * <CutOffDays>0</CutOffDays> <CutOffHours>0</CutOffHours>
 * <PONumberRequired>false</PONumberRequired>
 * <BillingReferenceRequired>false</BillingReferenceRequired> <CurrencySymbol>US
 * Dollars</CurrencySymbol> <UseStates>false</UseStates> <DefaultStateID>0</DefaultStateID> </Data>
 *
 * @author natechadwick
 */
@XmlRootElement
    ...
    try {
      this.custoffTime =
          FastDateFormat.getInstance(IPSEMSEventService.TIME_FORMAT_STRING)
              .parse(custoffTime.replace("T", " "));
    } catch (ParseException e) {
      log.error(
          "Error setting CustoffTime with value {} and format: {}, Error: {}",
          custoffTime,
