...
public class PSMultiAppVersionRedirectorValveTest {
  ...
  /**
   * * Make sure the sample properties File Loads and Parses OK and that the version is rewritten to
   * the sample context.
   *
   * @throws IOException
   * @throws ServletException
  ...
  public void testWithPropertiesFile()
      throws IOException, ServletException, URISyntaxException, LifecycleException {
    PSMultiAppVersionRedirectorValve valve = new PSMultiAppVersionRedirectorValve();
    Request req = getTestRequest();
    ...
    try {
      ...
      /*this is expected due to no connector.*/
    }
    validateTestRequest(req);
  }
  ...
  @Ignore
  @Test
  public void testWithBadPropertiesFile()
      throws IOException, URISyntaxException, ServletException, LifecycleException {
