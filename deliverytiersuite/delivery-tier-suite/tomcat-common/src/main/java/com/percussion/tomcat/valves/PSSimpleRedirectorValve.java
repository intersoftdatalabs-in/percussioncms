...
public class PSSimpleRedirectorValve extends ValveBase implements Lifecycle {
  ...
  public void invoke(Request request, Response response) throws IOException, ServletException {
    ...
    if (!matched) getNext().invoke(request, response);
  }
  ...
  public void setTargetHost(String targetHost) {
    if (targetHost != null && targetHost.trim().length() > 0) this.targetHost = targetHost;
  }
  ...
  public void setServiceNames(String serviceNames) {
    if (serviceNames != null && serviceNames.trim().length() > 0) this.serviceNames = serviceNames;
  }
  ...
  public void startInternal() throws LifecycleException {
    ...
    started = true;
    if (getContainer() != null) setState(LifecycleState.STARTING);
  }

  @Override
  public void stopInternal() throws LifecycleException {
    started = false;
    if (getContainer() != null) setState(LifecycleState.STOPPING);
  }
}
