...
public class MainDTSPreInstall {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            var javabin = System.getProperty("file.separator").equals("/") 
                ? javaHome + "/bin/java" 
    ...
    public static int execJar(Path jar, Path execPath, Path installDir, String isProduction) throws IOException,
        ...
        var builder = new ProcessBuilder(
                javabin, "-Dinstall.prod.dts=" + isProduction, "-Dfile.encoding=UTF8", "-Dsun.jnu.encoding=UTF8", 
                "-Dinstall.dir=" + dir, "-Drxdeploydir=" + dir, "-jar", jar.toAbsolutePath().toString(), 
                "-f", ANT_INSTALL).directory(execPath.toFile());
