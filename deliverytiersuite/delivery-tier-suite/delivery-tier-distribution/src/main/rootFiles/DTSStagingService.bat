...
set SERVICE_NAME=PercussionStagingDTS
set PR_DISPLAYNAME=PercussionStagingDTS
...
if %1 == delete goto doRemove
echo Unknown parameter "%1"
:displayUsage
echo.
echo Usage: service.bat install/delete [service_name]
goto end
