...
public class PSMembership implements IPSMembership {
  ...
  @Basic private Date lastAccessed;
  ...
  public void setPwdResetKey(String pwdResetKey) {
    if (pwdResetKey != null) Validate.notEmpty(pwdResetKey, "The pwdResetKey may not be empty");
  ...
  public PSMemberStatus getStatus() {
    if (status != null) return this.status;
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof IPSMembership)) return false;
    ...
    if (this.createdDate == null || other.getCreatedDate() == null)
      ...
      bldr.append(
          DateUtils.truncate(this.createdDate, Calendar.SECOND),
          DateUtils.truncate(other.getCreatedDate(), Calendar.SECOND));

    if (this.lastAccessed == null || other.getLastAccessed() == null)
      bldr.append(this.lastAccessed, other.getLastAccessed());
    else
      bldr.append(
          DateUtils.truncate(this.lastAccessed, Calendar.SECOND),
          DateUtils.truncate(other.getLastAccessed(), Calendar.SECOND));
