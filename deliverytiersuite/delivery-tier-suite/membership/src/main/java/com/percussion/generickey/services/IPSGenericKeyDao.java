...
public interface IPSGenericKeyDao {
  /**
   * Create an instance of a generic key. The generic key is not yet persisted. This method is used
   * to work as a factory and switch easily between mongo and rdbms.
   *
