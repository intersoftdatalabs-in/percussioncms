...
/**
 * Pre-authenticated processing filter for Percussion Membership Services.
 * Handles authentication based on headers or servlet principal using Java 11 features.
 *
...
public class PSPreAuthenticatedProcessingFilter extends AbstractPreAuthenticatedProcessingFilter {
    ...
    /**
     * Authentication details source that builds pre-authenticated tokens with roles.
     * Uses Java 11 features for cleaner, more maintainable code.
     */
    public static class PSAuthenticationDetailsSource implements
        ...
        /**
         * Extract granted authorities from roles header or apply default roles.
         * Uses Stream API for functional programming approach.
         */
        ...
        private List<GrantedAuthority> getDefaultRoles(String userName) {
            var defaultRole = PS_MANAGER_USER.equalsIgnoreCase(userName) 
