...
/**
 * JAX-RS Application configuration for Percussion Membership Services.
 * Configures Jersey with Spring integration and REST services using Java 11 features.
 *
...
public class PSMembershipApplication extends ResourceConfig {
    ...
    /**
     * Initialize the JAX-RS application with required components.
     * Sets up Spring integration, REST services, and exception handling using modern Java patterns.
     */
    ...
    private void registerRestServices() {
        var restServices = List.of(
            PSMembershipRestService.class,
            PSGenericKeyRestService.class
        );
