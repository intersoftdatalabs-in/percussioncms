...
public class PSMembershipService implements IPSMembershipService {
  ...
  public PSUserSummary validatePwdResetKey(String resetKey) throws PSResetPwdException, Exception {
    ...
    if (!isValid) {
      throw new PSResetPwdException(
          "The reset password token you have provided has timed out. You can request for a new"
              + " token on the login page.");
    }
  ...
  public String confirmAccount(String confirmKey)
    ...
    if ((!isValid)) {
      ...
      if (member.getStatus().equals(PSMemberStatus.Active)) {
        ...
        throw new PSResetPwdException(
            "The confirmation token you have provided has timed out. You can request for a new"
                + " token on the register page.");
      }
    }
  ...
  private String getResetEmailBodyMessage(String userEmail, String redirectLink) {
    ...
    sb.append("\r\n");
    sb.append(
        "To reset the password, click the link below or copy and paste the link into your"
            + " browser:");
    sb.append("\r\n");
  ...
  private String getConfirmationEmailBodyMessage(
    ...
    sb.append("\r\n\n");
    sb.append(
        "To complete the registration process and activate your account, simply visit the link"
            + " below:");
    sb.append("\r\n");
    sb.append(redirectLink);
    sb.append("\r\n");
    sb.append(
        "If clicking the link does not work, just copy and paste the entire link into your"
            + " browser.");
    sb.append("\r\n\n");
