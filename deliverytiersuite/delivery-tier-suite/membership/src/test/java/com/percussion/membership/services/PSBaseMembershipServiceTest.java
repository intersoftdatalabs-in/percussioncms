...
public abstract class PSBaseMembershipServiceTest {
   ...
   * @param userId
   * @param password
   * @param notValid <code>true</code> if the supplied params are not expected to be valid, <code>
   *     false</code> if valid.
   * @return The resulting session id, or <code>null</code> if <code>shouldThrow</code> is <code>
   *     true</code> and and exception was thrown.
