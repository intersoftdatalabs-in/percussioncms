...
/**
 * Custom dialect for Hibernate using MSSQL Server 2008 and above.
 * Redefines native types for compatibility.
...
public class PSUnicodeSQLServerDialect extends SQLServer2012Dialect {
     ...
     * as those described in PSJdbcDataTypeMaps.xml.
     */
    public PSUnicodeSQLServerDialect() {
        super();
        // Register native data types for Hibernate
