...
public class PSDefaultRangedPage implements IPSRangedPage {
  ...
  public void setPageFields(Map<String, Object> fields) {
    if (fields == null) throw new IllegalArgumentException("Field list may not be null");
    else this.pageFields = (ConcurrentHashMap<String, Object>) fields;
  }
  ...
  public void setPageSize(int size) {
    if (size <= 0) this.pageSize = DEFAULT_PAGE_SIZE;
