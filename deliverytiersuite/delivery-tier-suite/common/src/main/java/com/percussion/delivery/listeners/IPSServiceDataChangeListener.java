...
public interface IPSServiceDataChangeListener {
  /**
   * Called when data is changed as a result of an update or delete and is committed to the
   * repository. An insert will not fire this method.
   *
   * @param site the site whose data was changed. Never blank.
   * @param services affected by the data change. Never <code>null</code> or empty.
   */
