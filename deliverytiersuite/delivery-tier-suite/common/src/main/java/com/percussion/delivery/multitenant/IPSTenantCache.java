...
public interface IPSTenantCache {
  ...
  /**
   * * Tha maximum time to live that a tenants info can be cached before it must be re-authorized
   *
   * @param minutes
   */
  ...
  /**
   * * When set to true, the service will attempt to autorize expiring urls using the provider set
