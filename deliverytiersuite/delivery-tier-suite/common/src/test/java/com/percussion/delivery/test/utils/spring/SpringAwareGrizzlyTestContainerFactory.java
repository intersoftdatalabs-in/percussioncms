...
public class SpringAwareGrizzlyTestContainerFactory implements TestContainerFactory {
  ...
  private static class SpringAwareGrizzlyWebTestContainer implements TestContainer {
    ...
    private static final Logger log =
        LogManager.getLogger(SpringAwareGrizzlyWebTestContainer.class.getName());
    private URI baseUri;
    private HttpServer webServer;
    private Object springTarget;
    private Servlet servletInstance;

    private SpringAwareGrizzlyWebTestContainer(
        URI baseUri, DeploymentContext context, Object springTarget) {
      ...
      this.webServer =
          GrizzlyHttpServerFactory.createHttpServer(
              this.baseUri, context.getResourceConfig(), false);
    }
    ...
    //        private void instantiateGrizzlyWebServer(DeploymentContext deploymentContext, Object
    // springTarget) {
  ...
  //        }
  //
  //        private void populateFilterDescriptors(ServletAdapter sa, List<FilterDescriptor>
  // filters) {
  //            if (filters != null) {
  //                for (WebAppDescriptor.FilterDescriptor d : filters) {
  //                    sa.addFilter(instantiate(d.getFilterClass()), d.getFilterName(),
  // d.getInitParams());
  //                }
  //            }
  //
  //        }
  //
  //        private void populateEventListeners(ServletAdapter sa, List<Class<? extends
