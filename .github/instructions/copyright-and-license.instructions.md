...
applyTo: "**/*.java"
description: "Guidance for adding the standard Percussion CMS license header to Java source files"
---
...
Ensure copyright years are updated to the current year, 2026 in the example below.
