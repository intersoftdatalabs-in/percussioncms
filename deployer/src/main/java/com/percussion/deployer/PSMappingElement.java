...
public class PSMappingElement implements Comparable<PSMappingElement> {
     ...
     * methods to fit its needs, otherwise using the base-class methods results
     * in {@code java.lang.NullPointerException}s.
     */
     ...
     *
     * @return {@code true} if it has parent (if {@link #setParent(String, String, String)} is called), otherwise {@code false}
     */
    ...
    /**
     * Compare's this object {@code toString()} representation
