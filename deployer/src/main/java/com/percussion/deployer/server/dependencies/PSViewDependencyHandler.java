...
public class PSViewDependencyHandler extends PSElementDependencyHandler {
   ...
   */
  public PSViewDependencyHandler(PSDependencyDef def, PSDependencyMap dependencyMap)
  ...
  protected PSDependencyHandler getChildHandler() {
    if (m_childHandler == null)
      m_childHandler = getDependencyHandler(PSViewDefDependencyHandler.DEPENDENCY_TYPE);
