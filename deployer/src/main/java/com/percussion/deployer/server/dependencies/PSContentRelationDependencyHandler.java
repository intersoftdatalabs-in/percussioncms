...
public class PSContentRelationDependencyHandler extends PSIdTypeDependencyHandler
  ...
  public Iterator getChildDependencies(PSSecurityToken tok, PSDependency dep)
    ...
    com.percussion.deployer.server.dependencies.PSDependencyHandler ctHandler =
        getDependencyHandler(PSContentDefDependencyHandler.DEPENDENCY_TYPE);
    ...
    while (relationships.hasNext()) {
      ...
      if (child != null) childDeps.add(child);
      ...
      while (props.hasNext()) {
        ...
        if (type != null && value != null && value.trim().length() > 0) {
          com.percussion.deployer.server.dependencies.PSDependencyHandler handler =
              getDependencyHandler(type);
    ...
    PSDependencyHandler relHandler =
        getDependencyHandler(
            com.percussion.deployer.server.dependencies.PSRelationshipDependencyHandler
                .DEPENDENCY_TYPE);
