...
/**
 * Class to handle packaging and installing folder dependencies. A folder is represented by a top
 * level folder, and all folders including that top level folder are included as shared (optional)
 * dependencies. Content items are included as local dependencies, so that deploying a folder will
 * automatically deploy its content items.
 */
public class PSFolderDependencyHandler extends PSFolderObjectDependencyHandler {
  /**
   ...
   */
  public PSFolderDependencyHandler(PSDependencyDef def, PSDependencyMap dependencyMap)
  ...
  public Iterator<PSDependency> getChildDependencies(PSSecurityToken tok, PSDependency dep)
    ...
    if (dep != null) childDeps.add(childDep);
