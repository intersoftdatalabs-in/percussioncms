...
public class PSLogHandler {
   ...
   */
  public Iterator<PSArchiveSummary> getArchiveSummaries(String tgtServer) throws PSDeployException {
  ...
  public Iterator<PSArchiveSummary> getArchiveSummaries(String tgtServer, String archiveRef)
    ...
    var tData = m_dbmsHandle.catalogTableData(m_archiveLogSummarySchema, null, filter);
