...
/** Class to handle packaging and deploying a search. */
public class PSSearchDependencyHandler extends PSElementDependencyHandler {
  /**
   ...
   */
  public PSSearchDependencyHandler(PSDependencyDef def, PSDependencyMap dependencyMap)
  ...
  static final String DEPENDENCY_TYPE = "Search";
