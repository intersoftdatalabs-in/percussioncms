...
/**
 * Class to handle packaging and installing folder tree dependencies. A folder tree consists of a
 * top level folder and all of its child folders (recursively) as local dependencies. No content
 * items are included.
 */
public class PSFolderTreeDependencyHandler extends PSFolderObjectDependencyHandler {
  /**
   ...
   */
  public PSFolderTreeDependencyHandler(PSDependencyDef def, PSDependencyMap dependencyMap)
  ...
  public Iterator<PSDependency> getChildDependencies(PSSecurityToken tok, PSDependency dep)
    ...
    PSDependencyHandler handler =
        getDependencyHandler(PSFolderTreeDefDependencyHandler.DEPENDENCY_TYPE);
  ...
  public PSDependency getDependency(PSSecurityToken tok, String id) throws PSDeployException {
    ...
    if (!pathSpecifiesParent(id)) {
      ...
      if (sum != null) dep = createDeployableElement(m_def, id, sum.getName());
    }
  ...
  static final String DEPENDENCY_TYPE = "FolderTree";
