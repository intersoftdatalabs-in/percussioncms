...
public class PSAppTransformer {
   ...
   */
  public static void checkItemData(List mappings, PSItemData itemData, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");

    if (itemData == null) throw new IllegalArgumentException("itemData may not be null");
  ...
  private static void checkFieldSetData(
      List mappings, PSFieldSet fieldSet, PSItemData itemData, PSApplicationIdContext ctx) {
    if (fieldSet.getType() == PSFieldSet.TYPE_COMPLEX_CHILD) {
      PSAppNamedItemIdContext fieldCtx =
    ...
    while (fields.hasNext()) {
      ...
      if (o instanceof PSField) {
        checkFieldData(mappings, (PSField) o, itemData, fieldSet.getType(), ctx);
      } else {
        // fieldset, check it
  ...
  private static void checkFieldData(
    ...
    if (!field.getBooleanProperty(PSField.MAY_CONTAIN_IDS_PROPERTY)) return;
    ...
    while (rows.hasNext()) {
      ...
      if (fieldSetType == PSFieldSet.TYPE_COMPLEX_CHILD) {
        PSJdbcColumnData sysIdCol = row.getColumn(IPSConstants.CHILD_ITEM_PKEY, true);
        if (sysIdCol == null) break;

        PSAppNamedItemIdContext childCtx =
      ...
      if (fieldSetType == PSFieldSet.TYPE_SIMPLE_CHILD) {
        PSAppNamedItemIdContext simpleCtx =
            new PSAppNamedItemIdContext(PSAppNamedItemIdContext.TYPE_SIMPLE_CHILD_VALUE, val);
      ...
      if (isNumeric(val)) {
        ...
        if (!vals.contains(val)) {
          // add mapping
          PSApplicationIDTypeMapping mapping = new PSApplicationIDTypeMapping(curCtx, val);
  ...
  public static void transformItemData(
      PSItemData itemData, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
  ...
  private static void transformFieldSetData(
      PSFieldSet fieldSet, PSItemData itemData, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    PSApplicationIdContext ctx = mapping.getContext();
    ...
    if (!isChild && fieldCtx.getType() == PSAppNamedItemIdContext.TYPE_ITEM_FIELD) {
      fieldName = fieldCtx.getName();
    } else if (isChild && fieldCtx.getType() == PSAppNamedItemIdContext.TYPE_CHILD_ITEM) {
      ...
      if (nextCtx instanceof PSAppNamedItemIdContext) {
        PSAppNamedItemIdContext childFieldCtx = (PSAppNamedItemIdContext) nextCtx;
  ...
  private static void transformFieldData(
      PSField field, PSItemData itemData, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    PSApplicationIdContext ctx = mapping.getContext();
    PSApplicationIdContext root = ctx.getCurrentRootCtx();
    if (!(root instanceof PSAppNamedItemIdContext))
    ...
    try {
      ...
      while (srcRows.hasNext()) {
        ...
        if (srcCol == null || tgtCol == null)
          throw new IllegalArgumentException("column to transform not found");

        // if a complex child, ensure it's the right row
        if (isChild) {
          PSJdbcColumnData sysIdCol = tgtRow.getColumn(IPSConstants.CHILD_ITEM_PKEY, true);
          if (sysIdCol == null) throw new IllegalArgumentException("child row id column not found");
          if (!childItemCtx.getName().equals(sysIdCol.getValue())) continue;
        }
        ...
        if (!isUrl && srcVal != null && srcVal.equals(mappedSrcVal)) {
          ...
          newTgtVal =
              PSUrlUtils.createUrl(
                  base.toString(), PSDeployComponentUtils.convertToEntries(paramMap), null);
        }

        if (newTgtVal != null) {
          tgtCol.setValue(newTgtVal);
          // update simple child context value if we have one
          if (simpleCtx != null) simpleCtx.updateCtxValue(newTgtVal);
        }
      }

    } finally {
      // push simple ctx back to root if we got one
      if (simpleCtx != null) ctx.resetCurrentRootCtx();

      // push field ctx back to root
      ctx.resetCurrentRootCtx();

      // push complex child ctx back to root if we got one
      if (childItemCtx != null) ctx.resetCurrentRootCtx();
    }
  }
   ...
   * @param ctx The current context, may be <code>null</code>.
   */
  public static void checkFieldSet(List mappings, PSFieldSet fs, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");

    if (fs == null) throw new IllegalArgumentException("fs may not be null");
    ...
    while (fields.hasNext()) {
      ...
      if (o instanceof PSField) {
        ...
        PSAppNamedItemIdContext fieldCtx =
            new PSAppNamedItemIdContext(
                PSAppNamedItemIdContext.TYPE_CE_FIELD, field.getSubmitName());
        fieldCtx.setParentCtx(fsCtx);
        if (field.getLocator() != null) checkDataLocator(mappings, field.getLocator(), fieldCtx);

        // check field default value
        IPSReplacementValue defVal = field.getDefault();
        if (defVal != null) {
          PSAppCEItemIdContext defCtx =
              new PSAppCEItemIdContext(PSAppCEItemIdContext.TYPE_DEFAULT_VALUE);
        ...
        if (fTrans != null) {
          ...
          if (!callSet.isEmpty()) {
            PSAppCEItemIdContext iTransCtx =
                new PSAppCEItemIdContext(PSAppCEItemIdContext.TYPE_INPUT_TRANSLATION);
        ...
        if (valRules != null) {
          PSAppCEItemIdContext valRuleCtx =
              new PSAppCEItemIdContext(PSAppCEItemIdContext.TYPE_VALIDATION_RULE);
          ...
          if (applyWhen != null) checkApplyWhen(mappings, applyWhen, valRuleCtx);
        }
        ...
        if (visRules != null) {
          PSAppCEItemIdContext visRuleCtx =
              new PSAppCEItemIdContext(PSAppCEItemIdContext.TYPE_VISIBILITY_RULE);
        ...
        if (choices != null) checkChoices(mappings, choices, fieldCtx);
  ...
  public static void transformFieldSet(
      PSFieldSet fieldSet, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    if (fieldSet == null) throw new IllegalArgumentException("fieldSet may not be null");
    ...
    if (childCtx.getType() == PSAppNamedItemIdContext.TYPE_FIELD_SET) {
      ...
      if (child instanceof PSFieldSet) transformFieldSet((PSFieldSet) child, mapping, idMap);
            ...
            case PSAppCEItemIdContext.TYPE_VALIDATION_RULE:
              ...
              if (valRules != null) {
                ...
                if (nextRoot instanceof PSAppIndexedItemIdContext)
                  ...
                  transformApplyWhen(valRules.getApplyWhen(), mapping, idMap);
                else throw new IllegalArgumentException("invalid validation rule ctx");
              }
              break;
    ...
    } else throw new IllegalArgumentException("invalid child of field set ctx");
   ...
   * @param ctx The current context, may be <code>null</code>.
   */
  public static void checkUIDef(List mappings, PSUIDefinition uiDef, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
  ...
  public static void transformUIDef(
      PSUIDefinition uiDef, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    if (uiDef == null) throw new IllegalArgumentException("uiDef may not be null");
    ...
    if (root instanceof PSAppCEItemIdContext) {
      ...
      if (ctx.getNextRootCtx() instanceof PSAppUISetIdContext && uiSets.hasNext()) {
        ...
        if (setName == null)
          throw new IllegalArgumentException("invalid ui set ctx in default ui ctx");
   ...
   * @param ctx The current context, may be <code>null</code>.
   */
  public static void checkDisplayMapper(
      List mappings, PSDisplayMapper mapper, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (dispMappings.hasNext()) {
      ...
      PSAppNamedItemIdContext mappingCtx =
          new PSAppNamedItemIdContext(
              PSAppNamedItemIdContext.TYPE_DISPLAY_MAPPING, mapping.getFieldRef());
      ...
      if (childMapper != null) checkDisplayMapper(mappings, childMapper, mappingCtx);
    }
  }
  ...
  public static void transformDisplayMapper(
      PSDisplayMapper mapper, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    if (mapper == null) throw new IllegalArgumentException("mapper may not be null");
    ...
    while (dispMappings.hasNext()) {
      ...
      if (ctx.getNextRootCtx() instanceof PSAppUISetIdContext) {
        ...
        if (childMapper != null) transformDisplayMapper(childMapper, mapping, idMap);
      }
      break;
    }
   ...
   * @param ctx The current context, may be <code>null</code>.
   */
  public static void checkAppFlow(
      List mappings, PSApplicationFlow appFlow, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (names.hasNext()) {
      ...
      PSAppNamedItemIdContext flowCtx =
          new PSAppNamedItemIdContext(PSAppNamedItemIdContext.TYPE_APP_FLOW, name);
      ...
      while (redirects.hasNext()) {
        ...
        if (redirects.hasNext()) checkRules(mappings, req.getConditions(), reqCtx);
  ...
  public static void transformAppFlow(
      PSApplicationFlow appFlow, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    if (appFlow == null) throw new IllegalArgumentException("appFloww may not be null");
    ...
    if (reqCtx.getType() != PSAppIndexedItemIdContext.TYPE_CONDITIONAL_REQUEST) {
      throw new IllegalArgumentException("invalid conditional request ctx");
    }
    ...
    while (redirects.hasNext()) {
      ...
      if (index++ == reqCtx.getIndex()) {
        ...
        else transformUrlRequest(req, mapping, idMap);
        break;
      }
    }
   ...
   * @param ctx The current context, may be <code>null</code>.
   */
  public static void checkDataMapper(
      List mappings, PSDataMapper mapper, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (dataMappings.hasNext()) {
      ...
      if (mapping.getBackEndMapping() instanceof IPSReplacementValue) {
        PSAppDataMappingIdContext mappingCtx =
            new PSAppDataMappingIdContext(mapping, PSAppDataMappingIdContext.TYPE_BACK_END);
        mappingCtx.setParentCtx(ctx);
        checkReplacementValue(
            mappings, (IPSReplacementValue) mapping.getBackEndMapping(), mappingCtx);
      }

      if (mapping.getDocumentMapping() instanceof IPSReplacementValue) {
        PSAppDataMappingIdContext mappingCtx =
            new PSAppDataMappingIdContext(mapping, PSAppDataMappingIdContext.TYPE_XML);
        mappingCtx.setParentCtx(ctx);
        checkReplacementValue(
            mappings, (IPSReplacementValue) mapping.getDocumentMapping(), mappingCtx);
      }

      PSCollection conds = mapping.getConditionals();
      if (conds != null) {
        PSAppDataMappingIdContext mappingCtx =
            new PSAppDataMappingIdContext(mapping, PSAppDataMappingIdContext.TYPE_COND);
        mappingCtx.setParentCtx(ctx);
  ...
  public static void transformDataMapper(
      PSDataMapper mapper, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    if (mapper == null) throw new IllegalArgumentException("mapper may not be null");
      ...
      if (mappingCtx.isSameMapping(dataMapping, true)) {
        if (mappingCtx.getType() == PSAppDataMappingIdContext.TYPE_BACK_END) {
          transformReplacementValue(
              (IPSReplacementValue) dataMapping.getBackEndMapping(), mapping, idMap);
          mappingCtx.updateCtxValue((IPSReplacementValue) dataMapping.getBackEndMapping());
        } else if (mappingCtx.getType() == PSAppDataMappingIdContext.TYPE_XML) {
          transformReplacementValue(
              (IPSReplacementValue) dataMapping.getDocumentMapping(), mapping, idMap);
          mappingCtx.updateCtxValue((IPSReplacementValue) dataMapping.getDocumentMapping());
        } else if (mappingCtx.getType() == PSAppDataMappingIdContext.TYPE_COND) {
          PSCollection conds = dataMapping.getConditionals();
          if (conds != null) transformConditionals(conds.iterator(), mapping, idMap);
        }
      }
    }
    ctx.resetCurrentRootCtx();
  ...
  public static void checkConditionalExits(
      List mappings, Iterator exits, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (exits.hasNext()) {
      ...
      PSAppIndexedItemIdContext exitCtx =
          new PSAppIndexedItemIdContext(PSAppIndexedItemIdContext.TYPE_CONDITIONAL_EXIT, index++);
      exitCtx.setParentCtx(ctx);
      PSApplyWhen applyWhen = exit.getCondition();
      if (applyWhen != null) checkApplyWhen(mappings, applyWhen, exitCtx);
    ...
    while (exits.hasNext()) {
      ...
      if (index++ == exitCtx.getIndex()) {
        if (ctx.getNextRootCtx() instanceof PSAppCEItemIdContext) {
          PSApplyWhen applyWhen = exit.getCondition();
          if (applyWhen != null) transformApplyWhen(applyWhen, mapping, idMap);
        } else {
          transformExtensionCalls(exit.getRules().iterator(), mapping, idMap);
        }
      }
    }
  ...
  public static void checkConditionalEffects(
      List mappings, Iterator effects, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (effects.hasNext()) {
      ...
      PSAppIndexedItemIdContext effectCtx =
          new PSAppIndexedItemIdContext(PSAppIndexedItemIdContext.TYPE_CONDITIONAL_EFFECT, index++);
      effectCtx.setParentCtx(ctx);
      checkRules(mappings, effect.getConditions(), effectCtx);

      PSExtensionCall call = effect.getEffect();
      PSAppExtensionCallIdContext callCtx = new PSAppExtensionCallIdContext(call);
  ...
  public static void transformConditionalEffects(
    ...
    if (effectCtx.getType() != PSAppIndexedItemIdContext.TYPE_CONDITIONAL_EFFECT) {
      throw new IllegalArgumentException("invalid conditional exit ctx");
    }
    ...
    while (effects.hasNext()) {
      ...
      if (index++ == effectCtx.getIndex()) {
        if (ctx.getNextRootCtx() instanceof PSAppExtensionCallIdContext) {
          ...
          transformCallParams(effect.getEffect().getParameters().iterator(), mapping, idMap);
          ctx.resetCurrentRootCtx();
        } else {
  ...
  public static void checkConditionalExtensions(
      List mappings, Iterator extensions, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (extensions.hasNext()) {
      PSConditionalExtension extension = (PSConditionalExtension) extensions.next();
      PSAppIndexedItemIdContext extesnionCtx =
          new PSAppIndexedItemIdContext(
  ...
  public static void transformConditionalExtensions(
    ...
    PSApplicationIdContext root = ctx.getCurrentRootCtx();
    if (!(root instanceof PSAppIndexedItemIdContext))
      throw new IllegalArgumentException("invalid conditional extension ctx");
    PSAppIndexedItemIdContext extensionCtx = (PSAppIndexedItemIdContext) root;
    if (extensionCtx.getType() != PSAppIndexedItemIdContext.TYPE_CONDITIONAL_EXTENSION) {
      throw new IllegalArgumentException("invalid conditional extension ctx");
    }
    ...
    while (extensions.hasNext()) {
      ...
      if (index++ == extensionCtx.getIndex()) {
        if (ctx.getNextRootCtx() instanceof PSAppExtensionCallIdContext) {
          ctx.getCurrentRootCtx();
          transformCallParams(extension.getExtension().getParameters().iterator(), mapping, idMap);
          ctx.resetCurrentRootCtx();
        } else {
  ...
  public static void checkCustomActionGroups(
      List mappings, Iterator groups, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (groups.hasNext()) {
      ...
      if (custGroup != null) {
        ...
        if (formAction != null) {
          PSAppIndexedItemIdContext grpCtx =
              new PSAppIndexedItemIdContext(
  ...
  public static void transformCustomActionGroups(
    ...
    if (groupCtx.getType() != PSAppIndexedItemIdContext.TYPE_CUSTOM_ACTION_GROUP) {
      throw new IllegalArgumentException("invalid group ctx");
    }
   ...
   * @param ctx The current context, may be <code>null</code>.
   */
  public static void checkStylesheetSet(
      List mappings, PSCommandHandlerStylesheets sheets, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (names.hasNext()) {
      ...
      while (styleSheets.hasNext()) {
        ...
        if (styleSheets.hasNext()) checkRules(mappings, sheet.getConditions(), sheetCtx);
  ...
  public static void transformStylesheetSet(
      PSCommandHandlerStylesheets sheets, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    if (sheets == null) throw new IllegalArgumentException("sheets may not be null");
    ...
    while (names.hasNext()) {
      ...
      while (styleSheets.hasNext()) {
        ...
        if (index++ == sheetCtx.getIndex()) {
          ...
          else transformUrlRequest(sheet.getRequest(), mapping, idMap);
          break;
        }
      }
    }
   ...
   * @param ctx The current context, may be <code>null</code>.
   */
  public static void checkResultPage(List mappings, PSResultPage page, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");

    if (page == null) throw new IllegalArgumentException("page may not be null");
    ...
    if (page.getStyleSheet() != null) {
      ...
      PSAppNamedItemIdContext pageCtx =
          new PSAppNamedItemIdContext(PSAppNamedItemIdContext.TYPE_RESULT_PAGE, name);
  ...
  public static void transformResultPage(
      PSResultPage page, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    if (page == null) throw new IllegalArgumentException("page may not be null");
   ...
   * @param ctx The current context, may be <code>null</code>.
   */
  public static void checkUISet(List mappings, PSUISet uiSet, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    if (choices != null) checkChoices(mappings, choices, uiSetCtx);
  ...
  public static void transformUISet(
      PSUISet uiSet, PSApplicationIDTypeMapping mapping, PSIdMap idMap) throws PSDeployException {
    if (uiSet == null) throw new IllegalArgumentException("uiSet may not be null");
    ...
    if (next instanceof PSAppCEItemIdContext) {
      ...
      if (itemCtx.getType() == PSAppCEItemIdContext.TYPE_CHOICES && choices != null) {
        transformChoices(choices, mapping, idMap);
      } else {
        PSAppCEItemIdContext rulesCtx = (PSAppCEItemIdContext) ctx.getCurrentRootCtx();
      ...
      PSAppNamedItemIdContext ctlCtx = (PSAppNamedItemIdContext) ctx.getCurrentRootCtx();
   ...
   */
  public static void checkChoices(List mappings, PSChoices choices, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    if (filter != null) {
      ...
      PSAppCEItemIdContext filterCtx =
          new PSAppCEItemIdContext(PSAppCEItemIdContext.TYPE_CHOICE_FILTER);
  ...
  public static void transformChoices(
      PSChoices choices, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    if (choices == null) throw new IllegalArgumentException("choices may not be null");
    ...
    if (ctx.getNextRootCtx() instanceof PSAppEntryIdContext) {
    ...
    } else if (ctx.getNextRootCtx() instanceof PSAppUrlRequestIdContext) {
      // check the url request of the choice
      PSUrlRequest urlRequest = choices.getLookup();
      if (urlRequest != null) {
      ...
      PSChoiceFilter filter = choices.getChoiceFilter();
      if (filter != null) {
        PSAppCEItemIdContext filterCtx = (PSAppCEItemIdContext) ctx.getCurrentRootCtx();
        if (filterCtx.getType() != PSAppCEItemIdContext.TYPE_CHOICE_FILTER) {
          throw new IllegalArgumentException("invalid choices ctx");
        }
   ...
   * @param ctx The current context, may not be <code>null</code>.
   */
  public static void checkApplyWhen(
      List mappings, PSApplyWhen applyWhen, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");

    if (applyWhen == null) throw new IllegalArgumentException("applyWhen may not be null");

    PSAppCEItemIdContext itemCtx = new PSAppCEItemIdContext(PSAppCEItemIdContext.TYPE_APPLY_WHEN);
  ...
  public static void transformApplyWhen(
      PSApplyWhen applyWhen, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    if (applyWhen == null) throw new IllegalArgumentException("applyWhen may not be null");
   ...
   * @param ctx The current context, may be <code>null</code>.
   */
  public static void checkRules(List mappings, Iterator rules, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
  ...
  public static void checkProcessChecks(
      List mappings, Iterator procChecks, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (procChecks.hasNext()) {
      ...
      PSAppNamedItemIdContext procCheckCtx =
  ...
  public static void transformRules(
    ...
    while (rules.hasNext()) {
      ...
      if (index++ == ruleCtx.getIndex()) {
        ...
        PSExtensionCallSet callSet = rule.getExtensionRules();
        if (ctx.getNextRootCtx() instanceof PSAppExtensionCallIdContext && callSet != null) {
  ...
  public static void checkCloneFieldOverrides(
      List mappings, PSCloneOverrideFieldList overrideList, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (overrides.hasNext()) {
      ...
      checkReplacementValue(mappings, override.getReplacementValue(), overrideCtx);
  ...
  public static void transformCloneFieldOverrides(
      PSCloneOverrideFieldList overrideList, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    if (overrideList == null) throw new IllegalArgumentException("overrideList may not be null");
    ...
    if (overrideCtx.getType() != PSAppIndexedItemIdContext.TYPE_CLONE_FIELD_OVERRIDE) {
      throw new IllegalArgumentException("invalid clone field override ctx");
    }
    ...
    while (overrides.hasNext()) {
      ...
      if (index++ == overrideCtx.getIndex()) {
        ...
        if (nextCtx instanceof PSAppExtensionCallIdContext) {
          transformReplacementValue(override.getReplacementValue(), mapping, idMap);
        } else {
   ...
   * @param ctx The current context, may be <code>null</code>.
   */
  public static void checkEntry(List mappings, PSEntry entry, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    if (isNumeric(value)) {
      PSApplicationIDTypeMapping mapping = new PSApplicationIDTypeMapping(entryCtx, value);
      mappings.add(mapping);
    }
  }
  ...
  public static void transformEntry(
      PSEntry entry, PSApplicationIDTypeMapping mapping, PSIdMap idMap) throws PSDeployException {
    if (entry == null) throw new IllegalArgumentException("entry may not be null");
   ...
   * @param ctx The current context, may be <code>null</code>.
   */
  public static void checkUrlRequest(
      List mappings, PSUrlRequest urlRequest, PSApplicationIdContext ctx) {
    if (urlRequest == null) throw new IllegalArgumentException("urlRequest may not be null");
    ...
    if (converter != null) {
      PSAppExtensionCallIdContext callCtx = new PSAppExtensionCallIdContext(converter);
      callCtx.setParentCtx(urlCtx);
      checkCallParams(mappings, converter.getParameters().iterator(), callCtx);
    }
  }
  ...
  public static void transformUrlRequest(
      PSUrlRequest urlRequest, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    if (urlRequest == null) throw new IllegalArgumentException("urlRequest may not be null");
    ...
    if (reqCtx.isSameRequest(urlRequest)) {
      ...
      if (ctx.getNextRootCtx() instanceof PSAppExtensionCallIdContext) {
        if (converter != null) {
          ctx.getCurrentRootCtx();
          transformCallParams(urlRequest.getConverter().getParameters().iterator(), mapping, idMap);
          ctx.resetCurrentRootCtx();
        }
      } else {
        Iterator params = urlRequest.getQueryParameters();
   ...
   * @param ctx The current context, may be <code>null</code>.
   */
  public static void checkParam(List mappings, PSParam param, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");

    if (param == null) throw new IllegalArgumentException("param may not be null");

    PSAppNamedItemIdContext paramCtx =
        new PSAppNamedItemIdContext(PSAppNamedItemIdContext.TYPE_PARAM, param.getName());
  ...
  public static void checkJexlBinding(
    ...
    if (bindings == null) throw new IllegalArgumentException("bindings may not be null");
    ...
    while (entries.hasNext()) {
      ...
      List<String> ids = PSDeployJexlUtils.getIdsFromBinding(entry.getExpression());
      ...
      if (ids.size() > 1) {
        ...
        while (it.hasNext()) {
          ...
          paramList.add(new PSParam(tmpName, new PSTextLiteral(it.next())));
        }
      } else if (ids.size() == 1) {
        paramList.add(new PSParam(bindingName, new PSTextLiteral(ids.get(0))));
      }

      Iterator<PSParam> params = paramList.iterator();
      PSBindingIdContext bCtx =
          new PSBindingIdContext(bindingIx, bindingName, entry.getExpression());

      int paramIx = 0;
      while (params.hasNext()) {
        PSParam p = params.next();
        String val = p.getValue().getValueText();
        if (!occurenceMap.containsKey(val)) occurenceMap.put(val, 0);
        else {
          Integer i = occurenceMap.get(val);
          i++;
          occurenceMap.put(val, i);
        }
        PSAppTransformer.checkJexlBindingParam(mappings, p, paramIx++, occurenceMap.get(val), bCtx);
  ...
  public static void checkJexlBindingParam(
    ...
    if (value == null) throw new IllegalStateException("value may not be null");

    if (!(value instanceof PSLiteral))
      throw new IllegalStateException("value must be PSLiteral type");

    if (bCtx == null) throw new IllegalArgumentException("binding context may not be null");

    // create a binding parameter context with index, occurence and value
    PSBindingParamIdContext paramCtx =
        new PSBindingParamIdContext(paramIx, occur, (PSTextLiteral) param.getValue());
    ...
    if (!StringUtils.isBlank(valueText) && isNumeric(valueText)) {
      PSApplicationIDTypeMapping mapping =
          new PSApplicationIDTypeMapping(paramCtx, value.getValueText());
      mappings.add(mapping);
    }
  }
  ...
  public static void transformParam(
      PSParam param, PSApplicationIDTypeMapping mapping, PSIdMap idMap) throws PSDeployException {
    if (param == null) throw new IllegalArgumentException("param may not be null");
  ...
  public static void transformJexlBinding(
    ...
    PSBindingParamIdContext paramCtx = (PSBindingParamIdContext) mapping.getContext();

    if (paramCtx == null)
      throw new IllegalStateException("mapping exists without a parameter " + "context");
    PSBindingIdContext bindingCtx = (PSBindingIdContext) paramCtx.getParentCtx();
    if (bindingCtx == null)
      throw new IllegalStateException(
          "parameter context exists without a" + "parent binding context");
    ...
    if (StringUtils.isNotBlank(bindKey)) b = bindings.getByName(bindKey);
    else {
      ...
      if (pb != null) b = bindings.getByIndex(pb.getIndex());
    }
    // if the binding exists ...
    if (b != null) PSAppTransformer.transformJexlBindingParam(b, mapping, idMap, je);
  }
  ...
  public static void transformJexlBindingParam(
      ...
      PSApplicationIDTypeMapping mapping,
      PSIdMap idMap,
      PSJexlExpressionHelper je)
      throws PSDeployException {
    if (binding == null) throw new IllegalArgumentException("bindings may not be null");

    if (mapping == null) throw new IllegalArgumentException("mapping may not be null");

    if (idMap == null) throw new IllegalArgumentException("idMap may not be null");

    if (je == null) throw new IllegalArgumentException("jexl expression helper may not be null");
    ...
    if (paramCtx.getOccurence() == 0) {
      ...
      for (int i = 0; i < paramCtx.getOccurence(); i++) {
        String nVal = je.getJexlBindingParamOccurenceValue(oldVal, paramCtx, i);
        if (nVal != null) index = bVal.indexOf(nVal, index);
      }
   ...
   * @param ctx The current context, may be <code>null</code>.
   */
  public static void checkProperties(List mappings, Iterator props, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (props.hasNext()) {
      ...
      PSAppNamedItemIdContext propCtx =
  ...
  public static void checkExtensionCalls(
      List mappings, Iterator calls, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (calls.hasNext()) {
      ...
      PSAppExtensionCallIdContext callCtx = new PSAppExtensionCallIdContext(call, index++);
  ...
  public static void transformExtensionCalls(
    ...
    while (calls.hasNext()) {
      PSExtensionCall call = (PSExtensionCall) calls.next();
      if (index++ == callCtx.getIndex()
          && callCtx.getExtensionRef().equals(call.getExtensionRef().getFQN())) {
        transformCallParams(call.getParameters().iterator(), mapping, idMap);
        break;
      }
    }
  ...
  public static void checkDataLocator(
      List mappings, IPSReplacementValue locator, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");

    if (locator == null) throw new IllegalArgumentException("locator may not be null");

    PSAppCEItemIdContext locatorCtx =
        new PSAppCEItemIdContext(PSAppCEItemIdContext.TYPE_DATA_LOCATOR);
  ...
  public static void transformDataLocator(
      IPSReplacementValue locator, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    if (locator == null) throw new IllegalArgumentException("locator may not be null");
   ...
   * @param ctx The current context, may not be <code>null</code>.
   */
  public static void checkConditionals(List mappings, Iterator conds, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (conds.hasNext()) {
      ...
      if (cond.getValue() == null
          || (cond.getValue() instanceof PSLiteral && cond.getVariable() instanceof PSLiteral)) {
        continue;
      }

      // skip if the operator is a unary operator
      if (cond.isUnary()) continue;

      PSAppConditionalIdContext condCtx;
      condCtx = new PSAppConditionalIdContext(cond, PSAppConditionalIdContext.TYPE_VALUE);
      condCtx.setParentCtx(ctx);
      checkReplacementValue(mappings, cond.getValue(), condCtx);

      condCtx = new PSAppConditionalIdContext(cond, PSAppConditionalIdContext.TYPE_VARIABLE);
      condCtx.setParentCtx(ctx);
   ...
   * @param ctx The current context, may not be <code>null</code>.
   */
  public static void checkCallParams(List mappings, Iterator params, PSApplicationIdContext ctx) {
    if (mappings == null) throw new IllegalArgumentException("mappings may not be null");
    ...
    while (params.hasNext()) {
      ...
      PSAppExtensionParamIdContext paramCtx = new PSAppExtensionParamIdContext(index++, val);
      paramCtx.setParentCtx(ctx);
  ...
  public static void transformCallParams(
    ...
    PSAppExtensionParamIdContext paramCtx = (PSAppExtensionParamIdContext) root;
    int index = 0;
    while (params.hasNext()) {
      PSAbstractParamValue val = (PSAbstractParamValue) params.next();
  ...
  public static void checkReplacementValue(
    ...
    if (value instanceof PSLiteral && !(value instanceof PSDateLiteral)) {
      String valueText = value.getValueText();
      if (valueText != null && valueText.trim().length() > 0 && isNumeric(valueText)) {
        PSApplicationIDTypeMapping mapping =
            new PSApplicationIDTypeMapping(ctx, value.getValueText());
        mappings.add(mapping);
      }
      ...
      PSAppNamedItemIdContext callCtx =
          new PSAppNamedItemIdContext(PSAppNamedItemIdContext.TYPE_FUNCTION_CALL, call.getName());
      callCtx.setParentCtx(ctx);
      checkCallParams(mappings, call.getParameters().iterator(), callCtx);
    }
  }
  ...
  public static void transformReplacementValue(
      IPSReplacementValue value, PSApplicationIDTypeMapping mapping, PSIdMap idMap)
      throws PSDeployException {
    if (value == null) throw new IllegalArgumentException("value may not be null");
    ...
    if (value instanceof PSExtensionCall) {
      ...
      transformCallParams(((PSExtensionCall) value).getParameters().iterator(), mapping, idMap);
      ctx.resetCurrentRootCtx();
    } else if (value instanceof PSFunctionCall) {
      PSApplicationIdContext ctx = mapping.getContext();
      PSApplicationIdContext root = ctx.getCurrentRootCtx();
      ...
      if (callCtx.getType() != PSAppNamedItemIdContext.TYPE_FUNCTION_CALL)
        throw new IllegalArgumentException("invalid function call ctx");
      transformCallParams(((PSFunctionCall) value).getParameters().iterator(), mapping, idMap);
      ctx.resetCurrentRootCtx();
    } else {
  ...
  private static int getNewId(PSApplicationIDTypeMapping mapping, PSIdMap idMap)
    ...
    if (mapping.hasNewValue()) {
      ...
      if (mapping.getParentId() != null) {
        String newParentId = idMap.getNewId(mapping.getParentId(), mapping.getParentType());
