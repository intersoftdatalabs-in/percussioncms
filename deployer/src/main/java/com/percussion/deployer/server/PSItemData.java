...
/**
 * Encapsulates an item definition and Jdbc table data for a single table that is
 * part of a content item's full data for use in making modifications to the
 * table data based on information in the item definition.
 */
public class PSItemData {
    ...
    * referencing tables in the item definition.
    *
    * @return The table alias, never <code>null</code> or empty after
    * construction.
    */
   public String getTableAlias() {
      if (m_tableAlias == null) {
         ...
         if (pipe != null) {
            ...
            tableSets.forEachRemaining(tableSet -> {
               var tableRefs = ((PSTableSet) tableSet).getTableRefs();
               tableRefs.forEachRemaining(tableRef -> {
