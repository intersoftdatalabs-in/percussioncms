...
public abstract class PSCmsObjectDependencyHandler extends PSIdTypeDependencyHandler {
   ...
   */
  public PSCmsObjectDependencyHandler(PSDependencyDef def, PSDependencyMap dependencyMap)
   ...
   */
  protected String getIdFromKey(IPSDbComponent comp, String name) throws PSDeployException {
    if (comp == null) throw new IllegalArgumentException("comp may not be null");
    ...
    if (key.isAssigned() && key.getPartCount() > 0) id = key.getPart(key.getDefinition()[0]);
  ...
  protected void reserveNewId(PSDependency dep, PSIdMap idMap, IPSDbComponent comp)
    ...
    if (mapping.isNewObject() && (mapping.getTargetId() == null)) {
      ...
      if (dep.supportsParentId()) {
        ...
        mapping.setTarget(
            id, dep.getDisplayName(), parentMapping.getTargetId(), parentMapping.getTargetName());
      } else mapping.setTarget(id, dep.getDisplayName());
    }
  }
   ...
   * @throws PSDeployException if any other error occurs.
   */
  protected Element getElementFromFile(
      PSArchiveHandler archive, PSDependency dep, PSDependencyFile file) throws PSDeployException {
    if (archive == null) throw new IllegalArgumentException("archive may not be null");
    if (dep == null) throw new IllegalArgumentException("dep may not be null");
   ...
   * @throws PSDeployException If there are any other errors.
   */
  protected List<PSDependency> getDepsFromMultiValuedProperty(
      PSSecurityToken tok, PSMultiValuedProperty prop, PSDependencyHandler handler)
      throws PSDeployException, PSNotFoundException {
    if (tok == null) throw new IllegalArgumentException("tok may not be null");
   ...
   * @throws PSDeployException If there are any other errors.
   */
  protected void transformMultiValuedProperty(
      PSMultiValuedProperty prop, PSImportCtx ctx, String type) throws PSDeployException {
    if (prop == null) throw new IllegalArgumentException("prop may not be null");
   ...
   */
  protected void addTransactionLogEntry(
      PSDependency dep, PSImportCtx ctx, IPSDbComponent comp, int action) throws PSDeployException {
    if (dep == null) throw new IllegalArgumentException("dep may not be null");
    if (ctx == null) throw new IllegalArgumentException("ctx may not be null");
    if (comp == null) throw new IllegalArgumentException("comp may not be null");

    addTransactionLogEntry(
        dep, ctx, comp.getComponentType(), PSTransactionSummary.TYPE_CMS_OBJECT, action);
  }
   ...
   */
  protected PSComponentProcessorProxy getComponentProcessor() throws PSDeployException {
