...
public class PSStylesheetDependencyHandler extends PSSupportFileDependencyHandler {
  ...
  public Iterator getChildTypes() {
    ...
    while (types.hasNext()) childTypes.add(types.next().toString());
  ...
  public Iterator getChildDependencies(PSSecurityToken tok, PSDependency dep)
    ...
    if (fileDep != null) {
      ...
      while (fileDeps.hasNext()) childDeps.add(fileDeps.next());
      ...
      while (sheetDeps.hasNext()) childDeps.add(sheetDeps.next());
    }
