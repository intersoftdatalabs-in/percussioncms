...
public class PSDbFunctionDefDependencyHandler extends PSDependencyHandler {
  ...
  public Iterator getDependencies(PSSecurityToken tok) throws PSDeployException {
    ...
    while (funcs.hasNext()) deps.add(createDependency((PSDatabaseFunction) funcs.next()));
  ...
  public PSDependency getDependency(PSSecurityToken tok, String id) throws PSDeployException {
    ...
    if (func != null) dep = createDependency(func);
  ...
  private PSDependency createDependency(PSDatabaseFunction func) {
    PSDependency dep = createDependency(m_def, func.getName(), func.getName());
    if (func.getType() == PSDatabaseFunctionManager.FUNCTION_TYPE_SYSTEM)
      dep.setDependencyType(PSDependency.TYPE_SYSTEM);
    else dep.setDependencyType(PSDependency.TYPE_SERVER);
