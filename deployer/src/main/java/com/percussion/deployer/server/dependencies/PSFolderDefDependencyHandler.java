...
public class PSFolderDefDependencyHandler extends PSFolderObjectDependencyHandler {
   ...
   */
  public PSFolderDefDependencyHandler(PSDependencyDef def, PSDependencyMap dependencyMap)
  ...
  public Iterator getChildDependencies(PSSecurityToken tok, PSDependency dep)
    ...
    childDeps.addAll(getChildDependencies(tok, dep.getDependencyId(), dep.getDependencyType()));

    // get folder contents
    com.percussion.deployer.server.dependencies.PSDependencyHandler contentsHandler =
        getDependencyHandler(
            com.percussion.deployer.server.dependencies.PSFolderContentsDependencyHandler
                .DEPENDENCY_TYPE);
    PSDependency ctDep = contentsHandler.getDependency(tok, dep.getDependencyId());
  ...
  static {
    ...
    ms_optChildTypes.add(PSFolderTranslationsDependencyHandler.DEPENDENCY_TYPE);
