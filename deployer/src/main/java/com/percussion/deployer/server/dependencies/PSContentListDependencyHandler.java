 ...
 *
 */
public class PSContentListDependencyHandler
      extends
         PSElementDependencyHandler
{
    ...
    */
   public PSContentListDependencyHandler(PSDependencyDef def,
    ...
    */
   public final static String DEPENDENCY_TYPE = "ContentList";
   ...
   static
   {
      ms_childTypes.add(PSContentListDefDependencyHandler.DEPENDENCY_TYPE);
   }
}
