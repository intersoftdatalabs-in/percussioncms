...
public class PSDeploymentHandler implements IPSDeploymentHandler, IPSLoadableRequestHandler {
   ...
   public Document connect(PSRequest req)
      ...
      var doc = Optional.ofNullable(req.getInputDocument())
      ...
      var licensed = new PSServerBrand().isComponentLicensed(IPSBrandCodeConstants.MULTI_SERVER_MANANGER) ? "yes" : "no";
      ...
      try {
         ...
         throw new PSAuthenticationFailedException(IPSSecurityErrors.GENERIC_AUTHENTICATION_FAILED, null);
      }
      ...
      root.setAttribute("deployVersion", String.valueOf(PSDeploymentServerConnection.DEPLOYMENT_INTERFACE_VERSION));
