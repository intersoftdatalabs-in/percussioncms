...
/**
 * Interface for the uninstall results. Package name and type are required and rest of the data is
 * filled based on the stage at which the failure occurred.
 *
 * @author bjoginipally
 */
public interface IPSUninstallResult {
  /**
   * Returns the package guid, may be <code>null</code>, if the supplied package name does have a
   * corresponding guid.
   *
