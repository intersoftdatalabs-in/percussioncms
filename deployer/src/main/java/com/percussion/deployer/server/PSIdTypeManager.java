...
public class PSIdTypeManager {
   ...
   * @throws PSDeployException if there are any errors.
   */
  public static Iterator<PSApplicationIDTypes> loadIdTypes(
      PSSecurityToken tok, Iterator<PSDependency> deps)
  ...
  public static PSApplicationIDTypes loadIdTypes(
      ...
      Map<String, List<String>> filterCache,
   ...
   *     incomplete.
   */
  public static Iterator<PSApplicationIDTypeMapping> getIdTypeDependencies(
  ...
  private static void fixupMappings(PSApplicationIDTypes curTypes, PSApplicationIDTypes newTypes) {
    ...
    while (resources.hasNext()) {
      ...
      while (elements.hasNext()) {
        String element = elements.next();
        Iterator<PSApplicationIDTypeMapping> mappings =
            newTypes.getIdTypeMappings(resource, element, false);
  ...
  private static void addChoiceFilters(
      PSSecurityToken tok, PSApplicationIDTypes idTypes, Map<String, List<String>> filterCache)
      throws PSDeployException, PSNotFoundException {
    ...
    while (ids.hasNext()) {
      ...
      if (filterCache != null) typeList = filterCache.get(id);
      if (typeList == null) {
   ...
   */
  private static void addExtensionParamNames(
