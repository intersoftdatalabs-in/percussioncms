...
public class PSDependencyDef {
  ...
  public PSDependencyDef(
      ...
      boolean isDeployableElement,
      boolean canBeAncestor,
  ...
  public PSDependencyDef(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    m_objectTypeName =
        PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_OBJECT_TYPE_NAME);
    m_handlerClass =
        PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_HANDLER_CLASS);
    m_isDeployableElement =
        XML_ATTR_TRUE.equals(sourceNode.getAttribute(XML_ATTR_IS_DEPLOYABLE_ELEMENT));
    m_supportsIdTypes = XML_ATTR_TRUE.equals(sourceNode.getAttribute(XML_ATTR_SUPPORTS_ID_TYPES));
    m_supportsIdMapping =
        XML_ATTR_TRUE.equals(sourceNode.getAttribute(XML_ATTR_SUPPORTS_ID_MAPPING));
    m_supportsUserDependencies =
        XML_ATTR_TRUE.equals(sourceNode.getAttribute(XML_ATTR_SUPPORTS_USER_DEPENDENCIES));
    ...
    if (!StringUtils.isBlank(guidType)) m_guidType = guidType;
  }
  ...
  private static final String XML_ATTR_SUPPORTS_ID_MAPPING = "supportsIdMapping";
  private static final String XML_ATTR_SUPPORTS_USER_DEPENDENCIES = "supportsUserDependencies";
  private static final String XML_ATTR_IS_DEPLOYABLE_ELEMENT = "isDeployableElement";
  private static final String XML_ATTR_CAN_BE_ANCESTOR = "canBeAncestor";
  private static final String XML_ATTR_SUPPORTS_PARENT_ID = "supportsParentId";
