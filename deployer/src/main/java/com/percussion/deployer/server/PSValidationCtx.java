...
public class PSValidationCtx {
  ...
  public boolean alreadyValidated(PSDependency dep) {
    Objects.requireNonNull(dep, "dep may not be null");
    // If shared, check for results first. If none, then only counts if already validated as a
  ...
  // Flag to indicate if ancestors should be validated. Initially false, modified by
  // setValidateAncestors.
  ...
  // String, value is the corresponding PSImportPackage.
  ...
  // String, value is the PSDependency object.
  ...
  // were added as a String, value is a List of PSDependency objects.
