...
public class PSSupportFileDependencyHandler extends PSAppObjectDependencyHandler {
  ...
  public PSDependency getDependency(PSSecurityToken tok, String id)
    ...
    if (appName != null) {
      ...
      treatAsApp =
          treatAsApp
              && !(appName.equals(SYS_CONTROL_APP)
      ...
      if (!treatAsApp) {
        ...
        if (file != null) {
          ...
          if (isSystemFile(appName)) dep.setDependencyType(PSDependency.TYPE_SYSTEM);
        }
      }
    }
   ...
   */
  protected Iterator getDependencyFiles(PSSecurityToken tok, String id) throws PSDeployException {
    if (tok == null) throw new IllegalArgumentException("tok may not be null");
    ...
    if (appName != null && appfile != null) {
      ...
      PSDependencyFile depFile =
          new PSDependencyFile(PSDependencyFile.TYPE_SUPPORT_FILE, tmpFile, appfile);
      files.add(depFile);
    }
   ...
   * @throws PSDeployException If there are any errors.
   */
  protected void installFileDependencyFiles(
      PSSecurityToken tok, PSArchiveHandler archive, PSDependency dep, PSImportCtx ctx)
      throws PSDeployException {
    if (tok == null) throw new IllegalArgumentException("tok may not be null");
    ...
    if (files.hasNext()) {
      ...
      if (file.getType() == PSDependencyFile.TYPE_SUPPORT_FILE) depFile = file;
    }
