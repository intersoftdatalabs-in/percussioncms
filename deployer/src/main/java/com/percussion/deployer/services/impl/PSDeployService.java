 ...
 * Handles deserialization, transformation, and persistence of deployment objects.
 */
...
public class PSDeployService implements IPSDeployService {
    ...
    /**
     * A helper method for installing dependency files within a transaction boundary.
     * Handles deserialization, applying transforms, persisting/updating via HibernateTransactionManager.
     */
    @Override
    ...
    public void deserializeAndSaveVariant(PSSecurityToken tok,
        ...
        try {
            ...
            var th = (PSTemplateDefDependencyHandler) PSDependencyManager
