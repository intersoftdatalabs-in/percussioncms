...
public interface IPSDeployConstants {
  ...
  /**
   * Directory below the deployment root containing all server files, relative to the Rhythmyx root.
   */
  public static final String SERVER_DIR = DEPLOYMENT_ROOT + "/server";

  /**
   * Directory below the deployment root containing all client files, relative to the Rhythmyx root.
   */
  ...
  public static final String ID_TYPE_ELEMENT_REQUEST_PROPERTIES = "RequestProperties";
  ...
  public static final String ID_TYPE_ELEMENT_CE_CUSTOM_ACTIONS = "CECustomActionGroup";

  /** Constant for the Content Editor input translations type element. */
  public static final String ID_TYPE_ELEMENT_CE_INPUT_TRANSLATIONS = "CEInputTranslations";

  /** Constant for the Content Editor output translations type element. */
  public static final String ID_TYPE_ELEMENT_CE_OUTPUT_TRANSLATIONS = "CEOutputTranslations";

  /** Constant for the Content Editor section link list type element. */
  public static final String ID_TYPE_ELEMENT_CE_SECTION_LINK_LIST = "CESectionLinkList";
  ...
  public static final String ID_TYPE_ELEMENT_CE_VALIDATION_RULES = "CEValidationRules";

  /** Constant for the pre-exit type element. */
  public static final String ID_TYPE_ELEMENT_INPUT_DATA_EXITS = "InputDataExits";

  /** Constant for the post-exit type element. */
  public static final String ID_TYPE_ELEMENT_RESULT_DATA_EXITS = "ResultDataExits";
  ...
  /** Constant for url parameters type element. Represents parameters hardcoded in a url string. */
  public static final String ID_TYPE_ELEMENT_URL_PARAMS = "UrlParams";

  /** Constant for clone field overrides type element. */
  public static final String ID_TYPE_ELEMENT_CLONE_FIELD_OVERRIDES = "CloneFieldOverrides";

  /** Constant for item data field values. Represents literal ids within content item data */
  public static final String ID_TYPE_ELEMENT_ITEM_DATA = "ItemData";

  /**
   * Constant for Finder parameters type element. Represents parameters hardcoded in a map in
   * tables.
   */
  ...
  /** Shadow for the above CONTENT_TYPE, no different. todo merge into content_type */
  ...
  /**
   * Constant for the System def element dependency object type. These elements may be overridden in
   * the shared def.
   */
  public static final String DEP_OBJECT_TYPE_SYSTEM_DEF_ELEMENT = "SystemDefElement";
  ...
  public static final String DEP_OBJECT_TYPE_LOADABLE_HANDLER = "LoadableHandler";

  /** Constant for Translation settings */
  public static final String DEP_OBJECT_TYPE_TRANSLATIONSETTINGS_DEF = "TranslationSettingsDef";

  /** Constant for sys_eWebEditPro control name */
  public static final String CONTROL_NAME_SYS_EWEB_EDIT_PRO = "sys_eWebEditPro";
  ...
  public static final String CONTROL_PARAM_NAME_WORD_TEMPLATE_URL = "WordTemplateURL";
  ...
  /**
   * The system property to allow cross-build deployment. Does not require a value, just must be
   * set, allows deployment across different builds, but not different versions.
   */
  public static final String PROP_ALLOW_BUILD_MISMATCH =
      "com.percussion.deployer.allowBuildMismatch";

  /**
   * The system property to allow missing package dependencies. Does not require a value, just must
   * be set, allows deployment of a package that has package dependencies that have not been meet.
   */
  public static final String PROP_ALLOW_MISSING_PACKAGE_DEP =
      "com.percussion.deployer.allowMissingPackageDep";

  /**
   * The system property for max child dependencies override. If set to a valid number, determines
   * the maximum number of child dependencies or ancestors that can be returned without an error. If
   * it does not specify a valid number, or is not specified, the default value {@link #MAX_DEPS} is
   * used.
   */
  public static final String PROP_MAX_DEPS = "com.percussion.deployer.maxDeps";

  /**
   * The system property for the Rhythmyx root override. Set this to specify the server request root
   * when it is not using the standard "/Rhythmyx" value. Can be specified with or without the
   * leading forward slash.
   */
  public static final String PROP_RX_ROOT = "com.percussion.deployer.rxRoot";

  /**
   * The system property to allow creation of packages containing Rhythmyx sample applications. Does
   * not require a value, just must be set. All the archives created when running in this mode will
   * have archiveType (attribute of PSXExportDescriptor element) set to <code>
   * PSExportDescriptor.ARCHIVE_TYPE_SAMPLE</code>
   */
  ...
  public static final String ID_TYPE_ELEMENT_REQUEST_VALIDATIONS = "RequestParamValidations";
