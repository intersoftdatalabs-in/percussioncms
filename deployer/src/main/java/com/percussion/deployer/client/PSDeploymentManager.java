...
public class PSDeploymentManager {
  ...
  public void loadDependencies(PSDependency dependency) throws PSDeployException {
    ...
    try {
      ...
      Element root = PSXmlDocumentBuilder.createRoot(reqDoc, "PSXDeployLoadDependenciesRequest");
      root.appendChild(dependency.toXml(reqDoc));

      String maxCount = getMaxDepCount();
      if (maxCount != null) root.setAttribute("maxCount", maxCount);
  ...
  public void loadAncestors(PSDependency dependency) throws PSDeployException {
    ...
    try {
      Document reqDoc = PSXmlDocumentBuilder.createXmlDocument();
      Element root = PSXmlDocumentBuilder.createRoot(reqDoc, "PSXDeployLoadAncestorsRequest");
      root.appendChild(dependency.toXml(reqDoc));
  ...
  public Iterator getDeployableElements(String type) throws PSDeployException {
    ...
    try {
      ...
      Document reqDoc = PSXmlDocumentBuilder.createXmlDocument();
      Element root =
          PSXmlDocumentBuilder.createRoot(reqDoc, "PSXDeployGetDeployableElementsRequest");
      root.setAttribute("type", type);
      Document respDoc = m_conn.execute(reqType, reqDoc);
      PSXmlTreeWalker tree = new PSXmlTreeWalker(respDoc);
      Element depEl =
          tree.getNextElement(
              PSDeployableElement.XML_NODE_NAME, PSXmlTreeWalker.GET_NEXT_ALLOW_CHILDREN);
      ...
      while (depEl != null) {
        try {
          ...
          depEl =
              tree.getNextElement(
                  PSDeployableElement.XML_NODE_NAME, PSXmlTreeWalker.GET_NEXT_ALLOW_SIBLINGS);
        } catch (PSUnknownNodeTypeException e) {
          Object[] args = {reqType, PSDeployableElement.XML_NODE_NAME, e.getMessage()};
  ...
  public Iterator<Map<String, String>> getDependencyToPackageNameIndex() throws PSDeployException {
    ...
    try {
      ...
      NodeList nl = root.getElementsByTagName("PSXDependencyToPackageNameEntry");
  ...
  public Map getParentTypes() throws PSDeployException {
    ...
    try {
      ...
      Document respDoc = m_conn.execute(reqType, reqDoc);
      PSXmlTreeWalker tree = new PSXmlTreeWalker(respDoc);
      Element entryEl = tree.getNextElement(searchEl, PSXmlTreeWalker.GET_NEXT_ALLOW_CHILDREN);

      while (entryEl != null) {
        String childType = PSDeployComponentUtils.getRequiredAttribute(entryEl, "childType");
        String parentType = PSDeployComponentUtils.getRequiredAttribute(entryEl, "parentType");
        types.put(childType, parentType);

        entryEl = tree.getNextElement(searchEl, PSXmlTreeWalker.GET_NEXT_ALLOW_SIBLINGS);
      }
  ...
  public PSIdMap getIdMap(String source) throws PSDeployException {
    ...
    PSIdMap map =
        (PSIdMap)
            getDeployComponent(
                "getIdMap",
                "PSXDeployGetIdMapRequest",
                "sourceServer",
                source,
                PSIdMap.class,
                PSIdMap.XML_NODE_NAME);
  ...
  private IPSDeployComponent getDeployComponent(
    ...
    try {
      ...
      if (attrName != null) root.setAttribute(attrName, attrValue);
      Document respDoc = m_conn.execute(reqType, reqDoc);
      PSXmlTreeWalker tree = new PSXmlTreeWalker(respDoc);
  ...
  public PSDbmsMap getDbmsMap(String source) throws PSDeployException {
    ...
    PSDbmsMap map =
        (PSDbmsMap)
            getDeployComponent(
                "getDbmsMap",
                "PSXDeployGetDbmsMapRequest",
                "server",
                source,
                PSDbmsMap.class,
                PSDbmsMap.XML_NODE_NAME);
  ...
  public PSExportDescriptor getExportDescriptor(String name) throws PSDeployException {
    ...
    PSExportDescriptor desc =
        (PSExportDescriptor)
            getDeployComponent(
                "getExportDescriptor",
                "PSXDeployGetExportDescriptorRequest",
                "descName",
                name,
                PSExportDescriptor.class,
  ...
  public void deleteExportDescriptor(String name) throws PSDeployException {
    ...
    sendSimpleRequst(
        "deleteExportDescriptor", "PSXDeployDeleteExportDescriptorRequest", "descName", name);
  }
  ...
  private Document sendSimpleRequst(
      String reqTypeSuffix, String reqNodeName, String attrName, String attrValue)
      throws PSDeployException {
  ...
  public void saveExportDescriptor(PSExportDescriptor descriptor) throws PSDeployException {
    ...
    saveDeployComponent(descriptor, "saveExportDescriptor", "PSXDeploySaveExportDescriptorRequest");
  }
  ...
  public void saveUserDependency(PSUserDependency dep) throws PSDeployException {
    ...
    try {
      Document reqDoc = PSXmlDocumentBuilder.createXmlDocument();
      Element root = PSXmlDocumentBuilder.createRoot(reqDoc, "PSXDeploySaveUserDependencyRequest");
      root.appendChild(dep.toXml(reqDoc));
  ...
  public void deleteUserDependency(PSUserDependency dep) throws PSDeployException {
    ...
    try {
      Document reqDoc = PSXmlDocumentBuilder.createXmlDocument();
      Element root =
          PSXmlDocumentBuilder.createRoot(reqDoc, "PSXDeployDeleteUserDependencyRequest");
      root.appendChild(dep.toXml(reqDoc));
  ...
  private void saveDeployComponent(
      IPSDeployComponent component, String reqTypeName, String reqRootName)
      throws PSDeployException {
    String reqType = getDeployReqType(reqTypeName);
  ...
  public List<String> validateLocalConfigFile(File localConfig) throws PSDeployException {
    ...
    try {
      String xmlContent = com.percussion.util.IOTools.getFileContent(localConfig);
      Document reqDoc = PSXmlDocumentBuilder.createXmlDocument();
      Element root = PSXmlDocumentBuilder.createRoot(reqDoc, "PSXValidateLocalConfigRequest");
  ...
  public PSMultiValueHashMap<String, String> validateArchive(
      PSArchiveInfo archiveInfo, boolean checkArchiveRef) throws PSDeployException {
    ...
    try {
      Document reqDoc = PSXmlDocumentBuilder.createXmlDocument();
      Element root = PSXmlDocumentBuilder.createRoot(reqDoc, "PSXDeployValidateArchiveRequest");
      root.setAttribute("checkArchiveRef", checkArchiveRef ? "yes" : "no");
      root.appendChild(archiveInfo.toXml(reqDoc));

      String allowBuildMismatch = System.getProperty(IPSDeployConstants.PROP_ALLOW_BUILD_MISMATCH);
      ...
      String allowMissingPackageDep =
          System.getProperty(IPSDeployConstants.PROP_ALLOW_MISSING_PACKAGE_DEP);
      // property defined is all that matters
      ...
      PSXmlTreeWalker valTree = new PSXmlTreeWalker(respDoc.getDocumentElement());

      Element valElement = valTree.getNextElement(PSDeploymentHandler.XML_AV_EL_NAME);
      ...
      while (valElement != null) {
        ...
        valElement = valTree.getNextElement(PSDeploymentHandler.XML_AV_EL_NAME);
      }
  ...
  public PSArchiveSummary getArchiveSummary(int archiveLogId) throws PSDeployException {
    PSArchiveSummary archiveSummary =
        (PSArchiveSummary)
            getDeployComponent(
                "getArchiveSummary",
                "PSXDeployGetArchiveSummaryRequest",
                "archiveLogId",
  ...
  public void deleteArchive(String archiveRef) throws PSDeployException {
    ...
    sendSimpleRequst("deleteArchive", "PSXDeployDeleteArchiveRequest", "archiveRef", archiveRef);
  }
  ...
  public PSArchiveInfo getArchiveInfo(int archiveLogId) throws PSDeployException {
    PSArchiveInfo archiveInfo =
        (PSArchiveInfo)
            getDeployComponent(
                "getArchiveInfo",
                "PSXDeployGetArchiveInfoRequest",
                "archiveLogId",
                Integer.toString(archiveLogId),
                PSArchiveInfo.class,
  ...
  public PSAppPolicySettings getAppPolicySettings() throws PSDeployException {
    PSAppPolicySettings settings =
        (PSAppPolicySettings)
            getDeployComponent(
                "getAppPolicySettings",
                "PSXDeployGetAppPolicySettingsRequest",
                null,
                null,
                PSAppPolicySettings.class,
  ...
  public void saveAppPolicySettings(PSAppPolicySettings settings) throws PSDeployException {
    ...
    saveDeployComponent(settings, "saveAppPolicySettings", "PSXDeploySaveAppPolicySettingsRequest");
  }
  ...
  public IPSDeployJobControl copyArchiveToServer(String archiveRef, final File archiveFile)
    ...
    if (archiveFile == null || !archiveFile.exists())
      throw new IllegalArgumentException("archiveFile may not be null and must exist");
  ...
  public IPSDeployJobControl copyConfigToServer(String configRef, final File configFile)
    ...
    if (configFile == null || !configFile.exists())
      throw new IllegalArgumentException("configFile may not be null and must exist");
  ...
  public IPSDeployJobControl createConfigDef(String descName, final File targetFile)
    ...
    if (targetFile == null) throw new IllegalArgumentException("targetFile may not be null");
    ...
    try {
      ...
      Element root = PSXmlDocumentBuilder.createRoot(reqDoc, "PSXDeployCreateConfigDefRequest");
  ...
  public IPSDeployJobControl createDefaultConfig(
    ...
    try {
      final Document reqDoc = PSXmlDocumentBuilder.createXmlDocument();
      Element root = PSXmlDocumentBuilder.createRoot(reqDoc, "PSXDeployCreateDefaultConfigRequest");
  ...
  public IPSDeployJobControl createDescriptorSummary(String descName, final File targetFile)
    ...
    try {
      final Document reqDoc = PSXmlDocumentBuilder.createXmlDocument();
      Element root =
          PSXmlDocumentBuilder.createRoot(reqDoc, "PSXDeployCreateDescriptorSummaryRequest");
      root.setAttribute("descName", descName);
  ...
  public IPSDeployJobControl copyArchiveFromServer(String descName, File targetFile)
    ...
    try {
      final Document reqDoc = PSXmlDocumentBuilder.createXmlDocument();
      Element root = PSXmlDocumentBuilder.createRoot(reqDoc, "PSXDeployGetArchiveFileRequest");
      root.setAttribute("descName", descName);
  ...
  public IPSDeployJobControl runExportJob(PSExportDescriptor desc) throws PSDeployException {
    if (desc == null) throw new IllegalArgumentException("desc may not be null");
  ...
  public PSFeatureSet getFeatureSet() throws PSDeployException {
    ...
    try {
      Document reqDoc = PSXmlDocumentBuilder.createXmlDocument();
      PSXmlDocumentBuilder.createRoot(reqDoc, "PSXDeployGetFeatureSetRequest");
      Document respDoc = m_conn.execute(reqType, reqDoc);
  ...
  public void loadValidationResults(PSImportDescriptor desc) throws PSDeployException {
    ...
    PSImportDescriptor resultDesc =
        (PSImportDescriptor)
            getDeployComponent(
                "getValidationResults",
                "PSXDeployGetValidationResultsRequest",
                "archiveRef",
                desc.getArchiveInfo().getArchiveRef(),
                PSImportDescriptor.class,
  ...
  int getJobStatus(int jobId, StringBuilder messageBuffer) throws PSDeployException {
    if (messageBuffer == null) throw new IllegalArgumentException("messageBuffer may not be null");

    String reqType = getJobReqType("getJobStatus");

    try {
      Document reqDoc = PSXmlDocumentBuilder.createXmlDocument();
      Element reqRoot = PSXmlDocumentBuilder.createRoot(reqDoc, "PSXJobGetStatus");
      ...
      if (message != null) messageBuffer.append(message);
  ...
  int cancelJob(int jobId) throws PSDeployException {
    ...
    try {
      Document reqDoc = PSXmlDocumentBuilder.createXmlDocument();
      Element reqRoot = PSXmlDocumentBuilder.createRoot(reqDoc, "PSXJobCancel");
      reqRoot.setAttribute("id", String.valueOf(jobId));
  ...
  private PSDependency getDependencyFromElement(String reqType, Element depEl)
    ...
    try {
      ...
      else if (PSDeployableObject.XML_NODE_NAME.equals(elName)) dep = new PSDeployableObject(depEl);
  ...
  private IPSDeployJobControl runServerJob(PSDescriptor desc, String jobType)
    ...
    try {
      ...
      if ("import".equals(jobType)) {
        String applyToComms = System.getProperty(IPSDeployConstants.APPLY_TO_ALL_COMMS);
