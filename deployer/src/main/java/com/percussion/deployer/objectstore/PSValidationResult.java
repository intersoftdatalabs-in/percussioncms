...
public class PSValidationResult implements IPSDeployComponent {
  ...
  public PSValidationResult(
      PSDependency dep, boolean isError, String message, boolean isAllowSkip) {
  ...
  public void skipInstall(boolean skipInstall) {
    if ((!m_isAllowSkip) && skipInstall)
      throw new IllegalArgumentException("skipInstall cannot be true, due to allowSkip() is false");
  ...
  public Element toXml(Document doc) {
    ...
    root.setAttribute(XML_ATTR_MSG, m_message == null ? "" : m_message);
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    if (depEl.getNodeName().equals(PSDeployableObject.XML_NODE_NAME))
      ...
      Object[] args = {
        "(PSXDeployableElement | PSXDeployableObject | PSXUserDependency)", depEl.getNodeName()
      };
      throw new PSUnknownNodeTypeException(IPSObjectStoreErrors.XML_ELEMENT_WRONG_TYPE, args);
    }
  }
  ...
  private boolean getRequiredBoolAttr(Element srcNode, String attrName)
    ...
    String sAttrValue = PSDeployComponentUtils.getRequiredAttribute(srcNode, attrName);
