...
public class PSAppEnabledPolicySetting extends PSAppPolicySetting {
  /**
   * Default constructor. Default to disable the log policy, {@link #isAppEnabled()} return <code>
   * false</code>.
   */
   ...
   *
   * @param enabled <code>true</code> if set to enable the app policy; <code>false</code> otherwise.
   */
