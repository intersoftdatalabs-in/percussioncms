...
public class PSAppPolicySettings implements IPSDeployComponent {
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    Element childEl =
        PSDeployComponentUtils.getNextRequiredElement(
            tree, PSXmlTreeWalker.GET_NEXT_ALLOW_CHILDREN, PSAppEnabledPolicySetting.XML_NODE_NAME);
    m_appEnabledPolicy = new PSAppEnabledPolicySetting(childEl);

    childEl =
        PSDeployComponentUtils.getNextRequiredElement(
            tree, PSXmlTreeWalker.GET_NEXT_ALLOW_SIBLINGS, PSTracePolicySetting.XML_NODE_NAME);
    m_tracePolicy = new PSTracePolicySetting(childEl);

    childEl =
        PSDeployComponentUtils.getNextRequiredElement(
            tree, PSXmlTreeWalker.GET_NEXT_ALLOW_SIBLINGS, PSLogPolicySetting.XML_NODE_NAME);
  ...
  // See IPSDeployComponent interface
  public int hashCode() {
    return m_appEnabledPolicy.hashCode() + m_tracePolicy.hashCode() + m_logPolicy.hashCode();
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof PSAppPolicySettings) {
      PSAppPolicySettings other = (PSAppPolicySettings) obj;
      result =
          other.m_appEnabledPolicy.equals(m_appEnabledPolicy)
