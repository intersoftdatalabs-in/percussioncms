...
public final class PSArchivePackage implements IPSDeployComponent {
  ...
  public PSArchivePackage(String pkgName, String pkgType, int status, int logId) {
    ...
    if (!validateStatus(status)) throw new IllegalArgumentException("status value is not a valid");
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    m_status =
        Integer.parseInt(PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_STATUS));
    m_logId =
