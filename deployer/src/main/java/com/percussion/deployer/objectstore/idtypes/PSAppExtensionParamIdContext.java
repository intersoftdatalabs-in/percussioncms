...
public final class PSAppExtensionParamIdContext extends PSApplicationIdContext {
  ...
  public Element toXml(Document doc) {
    ...
    Optional.ofNullable(m_paramName).ifPresent(name -> root.setAttribute(XML_ATTR_NAME, name));
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    m_param =
        paramEl.getNodeName().equals(PSFunctionParamValue.NODE_NAME)
            ? new PSFunctionParamValue(paramEl, null, null)
