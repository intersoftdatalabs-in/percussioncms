...
public class PSIdMapping implements IPSDeployComponent {
  ...
  public PSIdMapping(
    ...
    if (parentType != null) {
      ...
      throw new IllegalArgumentException("parentId must be null if parentType is null");
    ...
    if (parentType != null) {
      ...
      throw new IllegalArgumentException("parentName must be null if parentType is null");
  ...
  public void setTarget(
      String targetId, String targetName, String targetParentId, String targetParentName) {
    ...
    if (targetParentId != null) {
      ...
      throw new IllegalArgumentException("targetParentId may not be null if source parent is set");
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    m_sourceName = PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_SRC_NAME);
    m_objectType = PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_OBJ_TYPE);
    ...
    if (sTemp != null && sTemp.trim().length() > 0) {
      ...
      m_sourceParentId =
          PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_SRC_PARENT_ID);
      m_sourceParentName =
          PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_SRC_PARENT_NAME);
    }

    String sIsNewObject =
        PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_IS_NEW_OBJECT);
    ...
    if (!m_isNewObject) {
      ...
      if (tgtEl == null) {
        ...
        m_targetId = PSDeployComponentUtils.getRequiredAttribute(tgtEl, XML_ATTR_TGT_ID);
        m_targetName = PSDeployComponentUtils.getRequiredAttribute(tgtEl, XML_ATTR_TGT_NAME);
        if (m_parentType != null) {
          m_targetParentId =
              PSDeployComponentUtils.getRequiredAttribute(tgtEl, XML_ATTR_TGT_PARENT_ID);
          m_targetParentName =
              PSDeployComponentUtils.getRequiredAttribute(tgtEl, XML_ATTR_TGT_PARENT_NAME);
        }
      }
    }
  }
  ...
  public void copyFrom(IPSDeployComponent obj) {
    ...
    if (!(obj instanceof PSIdMapping))
      throw new IllegalArgumentException("obj wrong type, expecting PSIdMapping");
  ...
  // See IPSDeployComponent interface
  public int hashCode() {
    return m_sourceId.hashCode()
        + m_sourceName.hashCode()
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PSIdMapping)) result = false;
    else {
      PSIdMapping obj2 = (PSIdMapping) obj;

      if (!m_sourceId.equals(obj2.m_sourceId)) result = false;
      else if (!m_sourceName.equals(obj2.m_sourceName)) result = false;
      else if (!m_objectType.equals(obj2.m_objectType)) result = false;
      else if (m_isNewObject != obj2.m_isNewObject) result = false;
      else if (m_isNewMapping != obj2.m_isNewMapping) result = false;
      else if ((m_targetId == null) ^ (obj2.m_targetId == null)) result = false;
      else if (m_targetId != null && !m_targetId.equals(obj2.m_targetId)) result = false;
      else if ((m_targetName == null) ^ (obj2.m_targetName == null)) result = false;
      else if (m_targetName != null && !m_targetName.equals(obj2.m_targetName)) {
        result = false;
      } else if (m_parentType == null ^ obj2.m_parentType == null) result = false;
      else if (m_parentType != null && !m_parentType.equals(obj2.m_parentType)) {
        result = false;
      } else if (m_sourceParentId == null ^ obj2.m_sourceParentId == null) result = false;
      else if (m_sourceParentId != null && !m_sourceParentId.equals(obj2.m_sourceParentId)) {
        result = false;
      } else if (m_sourceParentName == null ^ obj2.m_sourceParentName == null) result = false;
      else if (m_sourceParentName != null && !m_sourceParentName.equals(obj2.m_sourceParentName)) {
        result = false;
      } else if (m_targetParentId == null ^ obj2.m_targetParentId == null) result = false;
      else if (m_targetParentId != null && !m_targetParentId.equals(obj2.m_targetParentId)) {
        result = false;
      } else if (m_targetParentName == null ^ obj2.m_targetParentName == null) result = false;
      else if (m_targetParentName != null && !m_targetParentName.equals(obj2.m_targetParentName)) {
        result = false;
      }
    }
