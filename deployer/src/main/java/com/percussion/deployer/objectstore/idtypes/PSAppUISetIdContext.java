...
public class PSAppUISetIdContext extends PSApplicationIdContext {
  ...
  public PSAppUISetIdContext(PSUISet uiSet) {
    ...
    if (name != null && name.trim().length() > 0) m_name = name;
    else m_name = null;
  }
  ...
  public String getDisplayText() {
    ...
    if (m_name == null) {
      ...
      text = MessageFormat.format(getBundle().getString("appIdUISetName"), new Object[] {m_name});
    }
  ...
  public Element toXml(Document doc) {
    ...
    if (m_name != null) root.setAttribute(XML_ATTR_NAME, m_name);
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    if (m_name != null && m_name.trim().length() == 0) m_name = null;
  ...
  public void copyFrom(IPSDeployComponent obj) {
    ...
    if (!(obj instanceof PSAppUISetIdContext)) throw new IllegalArgumentException("obj wrong type");
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PSAppUISetIdContext)) isEqual = false;
    else {
      PSAppUISetIdContext other = (PSAppUISetIdContext) obj;
