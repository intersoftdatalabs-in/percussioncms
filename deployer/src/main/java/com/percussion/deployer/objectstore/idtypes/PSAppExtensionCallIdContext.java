...
public class PSAppExtensionCallIdContext extends PSApplicationIdContext {
    ...
    if (validateIndex(m_index)) {
      text =
          MessageFormat.format(
              getBundle().getString("appIdCtxOrdinalExtensionCall"),
              new Object[] {m_extensionRef, String.valueOf(m_index)});
    } else {
      text =
          MessageFormat.format(
              getBundle().getString("appIdCtxExtensionCall"), new Object[] {m_extensionRef});
    }
  ...
  public Element toXml(Document doc) {
    ...
    if (validateIndex(m_index)) root.setAttribute(XML_ATTR_INDEX, String.valueOf(m_index));
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PSAppExtensionCallIdContext)) isEqual = false;
    else {
      PSAppExtensionCallIdContext other = (PSAppExtensionCallIdContext) obj;
      if (!m_extensionRef.equals(other.m_extensionRef)) isEqual = false;
      else if (m_index != other.m_index) isEqual = false;
