...
public class PSAppDataMappingIdContext extends PSApplicationIdContext {
  ...
  public boolean isSameMapping(PSDataMapping mapping, boolean compareOriginal) {
    ...
    if (m_type == TYPE_BACK_END && compareOriginal) beMapping = m_origMapping;
    else if (m_type == TYPE_XML && compareOriginal) docMapping = m_origMapping;
  ...
  public String getDisplayText() {
    ...
    String text =
        MessageFormat.format(
            getBundle().getString(key), new Object[] {side, m_beMapping, m_docMapping});
  ...
  public void updateCtxValue(Object value) {
    ...
    if (m_type == TYPE_BACK_END) m_beMapping = value.toString();
    else if (m_type == TYPE_XML) m_docMapping = value.toString();
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    Element ctxEl = tree.getNextElement(PSXmlTreeWalker.GET_NEXT_ALLOW_CHILDREN);
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PSAppDataMappingIdContext)) isEqual = false;
    else {
      PSAppDataMappingIdContext other = (PSAppDataMappingIdContext) obj;
      if (!m_beMapping.equals(other.m_beMapping)) isEqual = false;
      else if (!m_docMapping.equals(other.m_docMapping)) isEqual = false;
      else if (m_type != other.m_type) isEqual = false;
  ...
  public int hashCode() {
    return m_beMapping.hashCode() + m_docMapping.hashCode() + m_type + super.hashCode();
  }
  ...
  protected boolean hasSameData(PSApplicationIdContext ctx) {
    ...
    if (ctx instanceof PSAppDataMappingIdContext) {
      ...
      if (m_beMapping.equals(other.m_beMapping) && m_docMapping.equals(other.m_docMapping)) {
        hasSame = true;
      }
    }
