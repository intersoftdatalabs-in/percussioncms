...
public class PSDeployableElement extends PSDependency {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PSDeployableElement)) isEqual = false;
    else {
      PSDeployableElement other = (PSDeployableElement) obj;
      if (!super.equals(other)) isEqual = false;
      else if (m_description == null ^ other.m_description == null) isEqual = false;
      else if (m_description != null && !m_description.equals(other.m_description)) {
        isEqual = false;
      }
    }
  ...
  public void copyFrom(IPSDeployComponent obj) {
    ...
    if (!(obj instanceof PSDeployableElement)) throw new IllegalArgumentException("obj wrong type");
  ...
  /**
   * The description for this object, initialized to an empty string. Modified by calls to {@link
