...
public class PSAppDisplayMapperIdContext extends PSApplicationIdContext {
  ...
  public String getDisplayText() {
    String text =
        MessageFormat.format(
            getBundle().getString("appIdDisplayMapper"),
            new Object[] {String.valueOf(m_id), m_fieldSetRef});
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    m_fieldSetRef = PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_FIELD_SET_REF);
    String strId = PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_ID);
    try {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PSAppDisplayMapperIdContext)) isEqual = false;
    else {
      PSAppDisplayMapperIdContext other = (PSAppDisplayMapperIdContext) obj;
      if (!m_fieldSetRef.equals(other.m_fieldSetRef)) isEqual = false;
      else if (m_id != other.m_id) isEqual = false;
