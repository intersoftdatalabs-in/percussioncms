...
public class PSBindingIdContext extends PSApplicationIdContext {
  ...
  public Element toXml(Document doc) {
    ...
    if (validateIndex(getIndex())) root.setAttribute(XML_ATTR_INDEX, String.valueOf(getIndex()));
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    setValue(PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_BVALUE));
    setIndex(-1);
