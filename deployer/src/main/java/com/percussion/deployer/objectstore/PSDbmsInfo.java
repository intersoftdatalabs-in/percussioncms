...
public class PSDbmsInfo implements IPSDeployComponent {
  ...
  public Element toXml(Document doc) {
    ...
    Optional.ofNullable(getConnectionInfo())
        .ifPresent(
            info ->
                PSXmlDocumentBuilder.addElement(
                    doc, root, DATASOURCE_XML_ELEMENT, info.getDataSource()));
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException, PSDeployException {
    ...
    passwordEncrypted =
        Optional.ofNullable(tree.getElementData(PASSWORD_ENCRYPTED_XML_ELEMENT))
