...
public class PSLogDetail implements IPSDeployComponent {
   ...
   */
  public PSLogDetail(
      PSValidationResults validationResults,
      PSIdMap idMap,
      PSDbmsMap dbmsMap,
      PSTransactionLogSummary txnLog) {
    if (validationResults == null)
      throw new IllegalArgumentException("validationResults parameter should not be null");
    if (txnLog == null) throw new IllegalArgumentException("txnLog parameter should not be null");
  ...
  public Element toXml(Document doc) {
    ...
    if (m_idMap != null) root.appendChild(m_idMap.toXml(doc));
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    childEl = tree.getNextElement(PSXmlTreeWalker.GET_NEXT_ALLOW_SIBLINGS);
    if (childEl != null) m_idMap = new PSIdMap(childEl);
  }
  ...
  public void copyFrom(IPSDeployComponent obj) {
    ...
    if (!(obj instanceof PSLogDetail))
      throw new IllegalArgumentException("obj wrong type, expecting PSLogDetail");
