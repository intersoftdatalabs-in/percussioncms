...
public class PSIdMap implements IPSDeployComponent {
  ...
  public PSIdMapping getMapping(PSDependency dep) {
    ...
    else return getMapping(dep.getDependencyId(), dep.getObjectType(), null, null);
  }
  ...
  public PSIdMapping getMapping(
      String sourceId, String objectType, String parentId, String parentType) {
    if (sourceId == null || sourceId.trim().length() == 0)
      throw new IllegalArgumentException("sourceId may not be null or empty");
    if (objectType == null || objectType.trim().length() == 0)
      throw new IllegalArgumentException("objectType may not be null or empty");
    ...
    while (mappings.hasNext() && result == null) {
      ...
      if (sourceId.equals(mapping.getSourceId()) && objectType.equals(mapping.getObjectType())) {
        if (parentId != null) {
  ...
  public PSIdMapping getTargetMapping(
    ...
    if (targetParentId != null && (parentType == null || parentType.trim().length() == 0)) {
      throw new IllegalArgumentException("parentType may not be null or empty");
    }
  ...
  public void removeMapping(PSIdMapping mapping) {
    ...
    if (mapping != null) m_mappingList.remove(mapping);
  }
  ...
  public boolean isMapped(String sourceId, String objectType, String parentId, String parentType) {
    ...
    if (parentId != null) {
      ...
      throw new IllegalArgumentException("parentType must be null if parentId is null");
    }

    PSIdMapping mapping = getMapping(sourceId, objectType, parentId, parentType);
    if (mapping != null && mapping.isMapped()) return true;
   ...
   * @throws PSDeployException if the id cannot be obtained.
   */
  public String getNewId(String id, String type, String parentId, String parentType)
   ...
   * @throws PSDeployException if the id cannot be obtained.
   */
  public int getNewIdInt(String id, String type, String parentId, String parentType)
      throws PSDeployException {
    if (id == null || id.trim().length() == 0)
      throw new IllegalArgumentException("id may not be null or empty");
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    Element mappingEl = tree.getNextElement(PSIdMapping.XML_NODE_NAME, FIRST_FLAGS);
  ...
  public boolean equals(Object obj) {
    ...
    if ((obj instanceof PSIdMap)) {
      PSIdMap obj2 = (PSIdMap) obj;
      result =
          m_sourceServer.equals(obj2.m_sourceServer) && m_mappingList.equals(obj2.m_mappingList);
    }
    return result;
  }
