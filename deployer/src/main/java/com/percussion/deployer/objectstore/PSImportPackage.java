...
public final class PSImportPackage implements IPSDeployComponent {
  ...
  public Element toXml(Document doc) {
    ...
    Optional.ofNullable(m_validationResults)
        .ifPresent(results -> root.appendChild(results.toXml(doc)));
    return root;
  }
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    var valEl =
        tree.getNextElement(
            PSValidationResults.XML_NODE_NAME, PSXmlTreeWalker.GET_NEXT_ALLOW_SIBLINGS);
