...
public class PSDependencyData implements IPSDeployComponent {
  ...
  public PSDependencyData(PSJdbcTableSchema schema, PSJdbcTableData data) {
    if (schema == null) throw new IllegalArgumentException("schema may not be null or empty");
    if (data == null) throw new IllegalArgumentException("data may not be null or empty");
  ...
  public void fromXml(Element sourceNode, PSJdbcDataTypeMap typeMap)
    ...
    Element schemaEl =
        PSDeployComponentUtils.getNextRequiredElement(
            tree, PSXmlTreeWalker.GET_NEXT_ALLOW_CHILDREN, PSJdbcTableSchema.NODE_NAME);

    Element dataEl =
        PSDeployComponentUtils.getNextRequiredElement(
            tree, PSXmlTreeWalker.GET_NEXT_ALLOW_SIBLINGS, PSJdbcTableData.NODE_NAME);
    ...
    try {
      ...
      Object[] args;
      if (m_schema == null) args = new Object[] {XML_NODE_NAME, schemaEl.getNodeName()};
      else args = new Object[] {XML_NODE_NAME, dataEl.getNodeName()};
  ...
  public void copyFrom(IPSDeployComponent obj) {
    ...
    if (!(obj instanceof PSDependencyData))
      throw new IllegalArgumentException("obj wrong type, expecting PSDependencyData");
  ...
  public boolean equals(Object obj) {
    ...
    if ((obj instanceof PSDependencyData)) {
      PSDependencyData obj2 = (PSDependencyData) obj;
      result = m_schema.equals(obj2.m_schema) && m_data.equals(obj2.m_data);
    }
