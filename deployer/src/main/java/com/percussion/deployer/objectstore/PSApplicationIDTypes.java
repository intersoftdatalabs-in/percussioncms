...
public final class PSApplicationIDTypes implements IPSDeployComponent {
  ...
  public Iterator<String> getResourceList(boolean incompleteOnly) {
    ...
    if (incompleteOnly) {
      m_resourceMap.keySet().stream().filter(resName -> !isComplete(resName)).forEach(resList::add);
    } else {
  ...
  public Iterator<String> getElementList(String resourceName, boolean incompleteOnly) {
    ...
    var resElements =
        Optional.ofNullable(m_resourceMap.get(resourceName))
   ...
   * @throws IllegalArgumentException If any param is invalid.
   */
  public Iterator<PSApplicationIDTypeMapping> getIdTypeMappings(
