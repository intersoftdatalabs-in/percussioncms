...
public class PSArchiveSummary implements IPSDeployComponent {
  ...
  public PSArchiveSummary(PSArchiveInfo archiveInfo, Date installDate, Iterator packageList) {
    ...
    if (installDate == null) throw new IllegalArgumentException("installDate may not be null");
    if (packageList == null || (!packageList.hasNext()))
      throw new IllegalArgumentException("packageList may not be null or empty");
  ...
  public Element toXml(Document doc) {
    ...
    root.setAttribute(XML_ATTR_INSTALL_DATE, dateFormat.format(m_installDate));
    ...
    if (m_archiveManifest != null) root.appendChild(m_archiveManifest.toXml(doc));
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException, PSDeployException {
    ...
    String sDate = PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_INSTALL_DATE);
    PSDateFormatISO8601 dateFormat = new PSDateFormatISO8601();
  ...
  public void copyFrom(IPSDeployComponent obj) {
    ...
    if (!(obj instanceof PSArchiveSummary))
      throw new IllegalArgumentException("obj wrong type, expecting PSArchiveSummary");
  ...
  // see IPSDeployComponent interface
  public int hashCode() {
    return ((m_id > 0) ? m_id : 0)
        + m_installDate.hashCode()
        + m_archiveInfo.hashCode()
        + m_packageList.hashCode()
