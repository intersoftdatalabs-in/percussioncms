...
public class PSAppNamedItemIdContext extends PSApplicationIdContext {
  ...
  public String getDisplayText() {
    ...
    String text = MessageFormat.format(getBundle().getString(key), new Object[] {m_name});
  ...
  public String getIdentifier() {
    ...
    return (m_type == TYPE_PARAM || m_type == TYPE_PSPROPERTY) ? m_name : null;
  }
  ...
  public void updateCtxValue(Object value) {
    ...
    if (m_type == TYPE_SIMPLE_CHILD_VALUE) m_name = (String) value;
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PSAppNamedItemIdContext)) isEqual = false;
    else {
      PSAppNamedItemIdContext other = (PSAppNamedItemIdContext) obj;
  ...
  private static final String[] TYPE_ENUM = {
    ...
    "Param",
    "AppFlow",
    "CommandHandlerStylesheets",
    "ResultPage",
    "SysDefInputDataExitCmd",
    "SysDefResultDataExitCmd",
    "SysDefInitParamCmd",
    "PSProperty",
    "PSFunctionCall",
    "PSProcessCheck",
