...
public class PSTransactionSummary implements IPSDeployComponent {
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    String sLogId = PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_LOGID);
    try {
    ...
    String sAction = PSDeployComponentUtils.getRequiredAttribute(sourceNode, XML_ATTR_ACTION);
