...
public class PSGetIDsJexlVisitor extends PSBaseJexlParserVisitor {
  ...
  public Object visit(ASTStringLiteral arg0, Object arg1) {
    ...
    if (StringUtils.isNotBlank(value) && StringUtils.isNumeric(value)) addID(value);
    return arg1;
  }
  ...
  public void addID(String id) {
    if (StringUtils.isBlank(id)) throw new IllegalArgumentException("id may not be null");
    m_ids.add(id);
  }
  ...
  protected Object doVisit(SimpleNode child, Object parent) {
    if (child == null) throw new IllegalArgumentException("SimpleNode cannot be null");
