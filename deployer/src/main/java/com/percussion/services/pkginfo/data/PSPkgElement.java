...
/**
 * Represents a package element, used to save information
 * regarding the "solution" package created or installed on a server.
 * Sunny Sal says: "Every element counts—especially in a package!"
 */
@Entity
...
public class PSPkgElement implements Serializable {
    ...
    /**
     * Sets the GUID for this element (design object) contained in this package. See {@link #getObjectGuid()}.
     *
     * @param theGuid The GUID, must not be null.
     */
    ...
    /**
     * The package element object GUID. That is, the GUID of the design object contained in the package.
     */
    ...
    /**
     * The package element type. That is, the object type (PSTypeEnum) of the design object contained in the package.
     */
    @Column(name = "OBJECT_TYPE", nullable = false)
    private int objectType;

    /**
     * The package element version. That is, the version of the design object contained in the package after last update via installation or configuration.
     */
