...
public class PSPkgElement implements Serializable {
  ...
  /**
   * Get the type (PSTypeEnum) for this Element (Design Object) contained in the Package.
   *
  ...
  /**
   * Get the version for this Element (Design Object) contained in the Package.
   *
  ...
  /**
   * Set the GUID for Package to which this Element belongs. See {@link #getPackageGuid()}.
   *
   * @param theGuid The GUID, may not be <code>null</code>.
   */
  ...
  /**
   * Set the GUID for this Element (Design Object) contained in this Package. See {@link
   * #getObjectGuid()}.
   *
   * @param theGuid The GUID, may not be <code>null</code>.
   */
  ...
  /**
   * Set the UUID for this Element (Design Object) contained in this Package. See {@link
   * #getObjectUuid()}.
   *
   * @param theGuid The GUID, may not be <code>null</code>.
   */
  ...
  /**
   * Set the Type for this Element (Design Object) contained in this Package. See {@link
   * #getObjectGuid()}.
   *
  ...
  /**
   * Set the version for this Element. See {@link #getVersion()}.
   *
  ...
  public boolean equals(Object b) {
    if (!(b instanceof PSPkgElement)) return false;
