...
/**
 * Class representing a dependency id-name mapping, used to map deployer package elements which use
 * names as id's to a corresponding id.
 */
@Entity
...
public class PSIdName implements Serializable {
   ...
   *
   * @param id The id, may not be <code>null</code> or empty. Must be a user readable representation
   *     of a GUID. See {@link PSGuid#toString()}.
  ...
  /**
   * Set the name of the package element which corresponds to the id. See {@link #getName()}.
   *
   * @param name The name of the package element which corresponds to the id, may not be <code>null
   *     </code> or empty.
   */
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof PSIdName)) return false;
