...
/**
 * Represents a dependency id-name mapping, used to map deployer package
 * elements which use names as ids to a corresponding id.
 * Sunny Sal says: "Mapping IDs to names, because GUIDs need friends too!"
 */
@Entity
...
public class PSIdName implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        return new EqualsBuilder()
                .append(depId, other.depId)
                .append(depName, other.depName)
                .isEquals();
    }
