...
/**
 * Class representing an Package Element dependency object, used to hold information dependencies
 * between design objects in a "solution" package created or installed on a server.
 */
@Entity
...
public class PSPkgDependency implements Serializable {
  ...
  public IPSGuid getDependentPackageGuid() {
    if (dependentPackageGuid == 0) return null;
    return new PSGuid(PSTypeEnum.PACKAGE_INFO, dependentPackageGuid);
  }

  /**
   * @return Returns <code>true</code> if the dependency is impliedDep, <code>false</code> if the
   *     dependency is user defined.
   */
   ...
   *
   * @param ownerPackageGuid the ownerPackageGuid to set. Never <code>null</code>.
   */
   ...
   *
   * @param dependentPackageGuid the dependentPackageGuid to set. Never <code>null</code>.
   */
   ...
   *
   * @param impliedDep The type of the dependency, set to <code>true</code> if it is implied
   *     dependency, otherwise <code>false</code>.
   */
  ...
  public boolean equals(Object b) {
    if (!(b instanceof PSPkgDependency)) return false;
  ...
  /**
   * A flag to indicate whether the dependency is impliedDep by the objects of the package or user
   * defined.
   */
