...
/**
 * Represents a package element dependency object,
 * used to hold information about dependencies between design objects in
 * a "solution" package created or installed on a server.
 * Sunny Sal says: "Element dependencies—because no design object is an island!"
 */
@Entity
...
public class PSPkgElementDependency implements Serializable {
    ...
    public String toString() {
        return "PSPkgElementDependency{" +
                ...
                ", ownerElementGuid='" + ownerElementGuid + '\'' +
                ", dependentElementGuid='" + dependentElementGuid + '\'' +
                '}';
    }
