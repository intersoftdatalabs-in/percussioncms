...
public class PSPkgElementDependency implements Serializable {
   ...
   * Set the GUID to the Element (Design Object) that has the dependency
   *
   * @param ownerGuid the ownerElementGuid to set. Never <code>null</code>.
   */
  public void setOwnerElementGuid(IPSGuid ownerGuid) {
    if (ownerGuid == null) throw new IllegalArgumentException("Owner GUID may not be null");
   ...
   * Set the GUID to the Element (Design Object) to which there is a dependency
   *
   * @param dependentGuid the dependentElementGuid to set. Never <code>null</code>.
   */
  public void setDependentElementGuid(IPSGuid dependentGuid) {
    if (dependentGuid == null) throw new IllegalArgumentException("Dependent GUID may not be null");
  ...
  public boolean equals(Object b) {
    if (!(b instanceof PSPkgElementDependency)) return false;
