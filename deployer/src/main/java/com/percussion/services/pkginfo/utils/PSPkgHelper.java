...
public class PSPkgHelper {
    ...
    public static void updatePkgElementVersions(String pkgName) throws PSNotFoundException {
        ...
        if (pkgInfo == null) {
            throw new RuntimeException(MessageFormat.format(
                "Failed to get the package info for {0}", pkgName));
        }
     ...
     */
    private static void updatePkgElementVersion(IPSGuid id, boolean forceUpdate) throws PSNotFoundException {
        ...
        try {
            ...
            throw new RuntimeException(MessageFormat.format(
                "Failed to get the design object version for package element with guid {0}", id), e);
        }
     ...
     */
    public static List<String> validatePkgElement(PSPkgElement pkgElem, Collection<String> comms) throws PSNotFoundException {
        if (pkgElem == null) {
        ...
        final String objName = PSIdNameHelper.isSupported(objType)
        ...
        try {
            ...
            throw new RuntimeException(MessageFormat.format(
                "Failed to get the design object version for package element guid {0}", pkgElem.getGuid()), e);
        }
     ...
     */
    private static String validateCommunityVisibility(IPSGuid id, String name, String type, Collection<String> commsVisibility) {
