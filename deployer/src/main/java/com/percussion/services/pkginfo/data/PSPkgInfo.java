...
/**
 * Class representing an Package Information object, used to save information regarding the
 * "solution" package created or installed on a server.
 */
@Entity
...
public class PSPkgInfo implements Serializable {
  ...
  /**
   * Convenience method that performs the following check: {@link #getType()} equals {@link
   * PackageType#DESCRIPTOR}.
   *
   * @return <code>true</code> if the associate package is of the <code>CREATED</code> type,
   ...
   *
   * @return <code>true</code> if the associate package is editable, otherwise, <code>false</code>.
   */
  ...
  /**
   * Convenience method that performs the following check: {@link #getCategory()} equals {@link
   * PackageCategory#SYSTEM}.
   *
   * @return <code>true</code> if the associated package is of the <code>SYSTEM</code> category,
   *     otherwise, <code>false</code>.
   */
  ...
  /**
   * A convenience method that looks at the type, the last action and the status of that action and
   * calculates a status.
   *
   * @returns <code>true</code> if this pkg type is {@link PackageType#PACKAGE} and the last action
   *     is {@link PackageAction#INSTALL} and the last action status is {@link
   *     PackageActionStatus#SUCCESS}, otherwise <code>false</code>.
   */
   ...
   *
   * @returns The Type of the Package. Either {@link PackageType#DESCRIPTOR} or {@link
   *     PackageType#PACKAGE}
   */
   ...
   *
   * @returns The Category of the Package. Either {@link PackageCategory#SYSTEM} or {@link
   *     PackageCategory#USER}
   */
  ...
  public void setGuid(IPSGuid theGuid) {
    if (theGuid == null) throw new IllegalArgumentException("Guid may not be null");

    guid = theGuid.longValue();
  }

  /**
   * Set the Package Descriptor Name of the Package. This is base name without the extension. See
   * {@link #getPackageDescriptorName()}.
   *
   * @param thePackageDescriptorName The name of the Package Descriptor, may not be <code>null
   *     </code>.
   */
  ...
  public void setPackageDescriptorGuid(IPSGuid guid) {
    if (guid == null) throw new IllegalArgumentException("Descriptor Guid may not be null");
   ...
   *
   * @param thePublisherName The name of the Package's Publisher, may not be <code>null</code>.
   */
   ...
   *
   * @param thePublisherUrl The URL of the Package Publisher, may not be <code>null</code>.
   */
  ...
  /**
   * Set the Configuration Definition to be shipped with the Package. See {@link
  ...
  /**
   * Set the Date the when the action was done . See {@link #getInstallationDate()}.
   *
   * @param theInstallationDate The Installation Date of the Package, may not be <code>null</code>.
   */
  ...
  /**
   * Set the Original Configuration Date the Package. See {@link #getOriginalConfigDate()}.
   *
   * @param theOriginalConfigurationDate The Original Configuration Date of the Package, may not be
   *     <code>null</code>.
   */
  ...
  /**
   * Set the name of the user that performed the last action on this package. See {@link
   * #getInstaller()}.
   *
   * @param theInstaller The Installer of the Package, may not be <code>null</code>.
   */
  public void setLastActionByUser(String user) {
    if (user == null) throw new IllegalArgumentException("The Installer may not be null");
   ...
   *
   * @param thePackageType The type of the Package, may not be <code>null</code>. Must be either
   *     "descriptor" or "package".
   */
   ...
   *
   * @param thePackageCat The category of the Package, may not be <code>null</code>. Must be either
   *     "system" or "user".
   */
  ...
  /**
   * Set the Content Management Version Minimum of the Package. See {@link #getCmVersionMinimum()}.
   *
   * @param theCmVersionMinimum The Content Management Version Minimum of the Package, may not be
   *     <code>null</code>.
   */
  ...
  /**
   * Set the Content Management Version Maximum of the Package. See {@link #getCmVersionMaximum()}.
   *
   * @param theCmVersionMaximum The Content Management Version Maximum of the Package, may not be
   *     <code>null</code>.
   */
  ...
  public boolean equals(Object b) {
    if (!(b instanceof PSPkgInfo)) return false;
