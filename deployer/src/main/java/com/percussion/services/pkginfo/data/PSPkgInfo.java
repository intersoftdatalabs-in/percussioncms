...
/**
 * Represents a package information object, used to save information
 * regarding the "solution" package created or installed on a server.
 * Sunny Sal says: "Package info—because every package has a story!"
 */
@Entity
...
public class PSPkgInfo implements Serializable {
    ...
    /**
     * Returns true if this package type is PACKAGE and the last action is INSTALL_CREATE and the last action status is SUCCESS.
     *
    ...
    /**
     * Sets the package descriptor name of the package. This is base name without the extension.
    ...
    /**
     * Sets the configuration definition to be shipped with the package. See {@link #getShippedConfigDefinition()}.
     *
     * @param theShippedConfigDefinition The configuration definition to be shipped with the package, must not be null.
     */
     ...
     *
     * @param theOriginalConfigurationDate The original configuration date of the package, must not be null.
     */
    ...
    /**
     * Sets the name of the user that performed the last action on this package. See {@link #getLastActionByUser()}.
     *
     ...
     *
     * @param theCmVersionMinimum The content management version minimum of the package, must not be null.
     */
     ...
     *
     * @param theCmVersionMaximum The content management version maximum of the package, must not be null.
     */
    ...
    public String toString() {
        return "PSPkgInfo{" +
                ...
                ", shippedConfigDefinition='" + shippedConfigDefinition + '\'' +
                ", lastActionDate=" + lastActionDate +
                ", origConfigDate=" + origConfigDate +
                ", lastActionByUser='" + lastActionByUser + '\'' +
                ", lastAction='" + lastAction + '\'' +
                ", lastActionStatus='" + lastActionStatus + '\'' +
                ", type='" + type + '\'' +
                ", category='" + category + '\'' +
                ", cmVersionMinimum='" + cmVersionMinimum + '\'' +
                ", cmVersionMaximum='" + cmVersionMaximum + '\'' +
                '}';
    }
