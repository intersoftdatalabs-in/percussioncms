...
public class PSPkgInfoService implements IPSPkgInfoService {
   ...
   *
   * @param id the ID of the deleted package info, assumed not <code>null</code>.
   */
  ...
  public void deletePkgInfo(String name) {
    ...
    if (null != info) deletePkgInfo(info.getGuid());
  }
  ...
  public PSPkgInfo loadPkgInfoModifiable(IPSGuid id) throws PSNotFoundException {
    ...
    PSPkgInfo pkgInfo = getSession().get(PSPkgInfo.class, id.longValue());

    if (pkgInfo == null) throw new PSNotFoundException(id);
  ...
  public List<PSPkgElement> loadPkgElements(List<IPSGuid> ids) throws PSNotFoundException {
    ...
    if (ids.isEmpty()) throw new IllegalArgumentException("ids may not be empty");
  ...
  public PSPkgElement loadPkgElementModifiable(IPSGuid id) throws PSNotFoundException {
    ...
    if (pkgElement == null) throw new PSNotFoundException(id);
  ...
  public List<PSPkgDependency> loadPkgDependencies(IPSGuid guid, boolean depType) {
    ...
    if (guid == null) throw new IllegalArgumentException("ownerGuid may not be null");
  ...
  public void savePkgDependency(PSPkgDependency pkgDependency) {
    if (pkgDependency == null) throw new IllegalArgumentException("pkgDependency may not be null");
  ...
  public void deletePkgInfoChildren(String name) {
    ...
    PSPkgInfo info = findPkgInfo(name);
    if (null != info) deletePkgInfoChildren(info.getGuid());
  }
}
