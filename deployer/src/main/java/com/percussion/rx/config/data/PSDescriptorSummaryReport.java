...
public class PSDescriptorSummaryReport {
    ...
    private void createInfo(StringBuilder sb, PSExportDescriptor desc) {
        ...
        sb.append("Publisher: ").append(StringUtils.defaultString(desc.getPublisherName())).append(NEWLINE);
    ...
    private void createPackagesSections(StringBuilder sb, PSExportDescriptor desc) {
        ...
        for (var entry : desc.getPkgDepList()) {
            ...
            var version = entry.get(PSDescriptor.XML_PKG_DEP_NAME); // Possible bug: Should this be XML_PKG_DEP_VERSION?
     ...
     */
    private void createSectionFromMultiMap(String title, PSMultiValueHashMap<String, String> map, StringBuilder sb) {
