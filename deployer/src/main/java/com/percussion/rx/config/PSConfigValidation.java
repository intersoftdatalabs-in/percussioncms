 ...
 * the configuration files in one package against another package.
 *
 * @author YuBingChen
 */
public class PSConfigValidation {
   ...
   *
   * @param name the name of the validated object, never <code>null</code> or empty.
   * @param propName the name of the property, it may be <code>null</code> or empty.
   * @param isError <code>true</code> if it is an error; otherwise it is a warning.
   * @param message the message of the validation. It may not be <code>null</code> or empty.
   */
   ...
   *
   * @param e the exception caught during validation process, not <code>null</code>.
   */
  ...
  public String getValidationMsg() {
    if (m_exception != null) {
      String expMsg =
          StringUtils.isBlank(m_exception.getLocalizedMessage())
              ? m_exception.toString()
              : m_exception.getLocalizedMessage();
      return "While verifying package \"" + m_pkgName + "\", an error occurred: " + expMsg;
    }
  ...
  /**
   * Sets the package name that was used to validate against with the current package.
   *
  ...
  public boolean equals(Object b) {
    if (!(b instanceof PSConfigValidation)) return false;
  ...
  /** The name of the design object, never <code>null</code> after the constructor. */
  private String m_objName;

  /** The type of the design object, never <code>null</code> after the constructor. */
  private PSTypeEnum m_objType;

  /**
   * Determines if the object is an error or warning. It is <code>true</code> for an error, <code>
   * false</code> if it is a warning.
   */
