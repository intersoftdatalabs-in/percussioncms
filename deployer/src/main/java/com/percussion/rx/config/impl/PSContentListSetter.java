...
public class PSContentListSetter extends PSSimplePropertySetter {
  ...
  private void setDeliveryType(IPSContentList cList, Object value) throws PSNotFoundException {
    ...
    String url = cList.getUrl();
    url =
        PSUrlUtils.replaceUrlParameterValue(url, IPSHtmlParameters.SYS_DELIVERYTYPE, deliveryName);
    cList.setUrl(url);
  }
   ...
   *
   * @param cList the Content List, assumed not <code>null</code>.
   * @param value the value of the new property, assumed not <code>null</code>, it must be a Map
   *     object.
   */
   ...
   *
   * @param cList the Content List, assumed not <code>null</code>.
   * @param value the item filter name, assumed not <code>null</code>, it must be an existing filter
   *     name.
   */
  ...
  /**
   * The property name of the expander parameters. The value of the property type is expected to be
   * a {@link Map}
   */
  public static final String EXPANDER_PARAMS = "expanderParams";

  /**
   * The property name of the generator parameters. The value of the property type is expected to be
   * a {@link Map}
   */
  public static final String GEN_PARAMS = "generatorParams";

  /**
   * The property name of a delivery type (name). The value of the property type is expected to be a
   * {@link String}
   */
  public static final String DELIVERY_TYPE = "deliveryType";

  /**
   * The property name of an item filter (name). The value of the property type is expected to be a
   * {@link String}
   */
