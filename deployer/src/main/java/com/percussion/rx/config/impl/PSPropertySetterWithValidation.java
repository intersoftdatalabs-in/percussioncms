...
/**
 * Provides convenience methods for setters implementing property validation.
 * The derived class must override {@link #validate(String, ObjectState, String, Object, Object)}.
 *
 * @author YuBingChen
 */
public class PSPropertySetterWithValidation extends PSSimplePropertySetter {
    ...
    @Override
    public List<PSConfigValidation> validate(String objName, ObjectState state, IPSPropertySetter setter) {
        ...
        try {
            ...
            for (var prop : properties.entrySet()) {
                var subResult = validate(objName, state, prop.getKey(), prop.getValue(), otherProps.get(prop.getKey()));
