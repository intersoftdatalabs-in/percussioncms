...
/**
 * This class provides convenience methods for setters that implementing property validation. The
 * derived class must override {@link #validate(String, ObjectState, String, Object, Object)}
 *
 * @author YuBingChen
 */
public class PSPropertySetterWithValidation extends PSSimplePropertySetter {
  ...
  public List<PSConfigValidation> validate(
    ...
    try {
      ...
      String errorMsg = "Failed to validate the name \"" + objName + "\"";
   ...
   * @param propValue the property value of the current setter, it may be <code>null</code>.
   * @param otherValue the property value of the other setter, it may be <code>null</code>.
   * @return a list of validation result, never <code>null</code>, may be <code>null</code> if there
