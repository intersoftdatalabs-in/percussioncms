...
public class PSSiteSetter extends PSPropertySetterWithValidation {
    ...
    for (Map<String, Object> var : myVars) {
      ...
      for (Map<String, Object> other : otherVars) {
        ...
        if (myVarName.equalsIgnoreCase(pair.getFirst())) {
          String msg = " the Site Variable \"" + myVarName + "\" is already configured.";
  ...
  /**
   * The name of the property contains a collection of Site variables. The expected value is a
   * {@link Map Map&lt;String, Map&lt;String, Object>>}.
   */
  public static final String VARIABLES = "variables";

  /** This maps the logic property name to an actual property name defined in {@link IPSSite}. */
