...
/**
 * The parser to parse <code>&lt;psx:list></code> elements (assume <code>psx</code> is the prefix)
...
public class PSListBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {
  ...
  @Override
  protected Class getBeanClass(@SuppressWarnings("unused") Element element) {
  ...
  protected void doParse(Element element, BeanDefinitionBuilder bean) {
    ...
    PSPair<Object, Boolean> result =
        PSConfigMapper.resolveSimplePlaceholder(lookupKey, pMgr.getProperties());
    List list = null;
    if (result.getSecond()) {
      ...
      if (result.getFirst() == null) {
        ...
        ms_log.warn(
            "The \"List\" type is expected for the replaced value of \""
                + lookupKey
