...
public class PropertySet {
   ...
   * there is not a <CODE>set</CODE> method for the propertySetOrProperty property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Property } {@link
   * PropertySet }
   */
