...
public class PSLocationSchemeConfigHandler extends PSObjectConfigHandler {
    ...
    public int hashCode() {
        return super.hashCode()
                + new org.apache.commons.lang.builder.HashCodeBuilder().append(m_extraProperties).toHashCode();
    }
    ...
    public List<PSConfigValidation> validate(IPSConfigHandler other) {
        ...
        for (var pair : commonNames) {
            var msg = " Context / Location Scheme pair \"" + pair.getFirst() + "\" is already configured.";
