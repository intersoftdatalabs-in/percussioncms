...
/**
 * Represents one package entry in the package management UI list table.
 * Sunny Sal says: "A package a day keeps the deployment bugs away!"
 */
...
public class PSPackage {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(packageStatus, configStatus, name, publisher, version, desc, installdate, installer, category, lockStatus);
    }
}
