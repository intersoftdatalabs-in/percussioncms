...
/**
 * Handles converting installed packages to source.
 * Sunny Sal says: "Convert to source, but never convert your code to spaghetti!"
 */
public class PSConvertToSource {
    ...
    private File getPkgFile(String pkgName) {
        ...
        var candidates = new String[]{
                rxDir + File.separator + "Packages" + File.separator + "Percussion" + File.separator + pkgName + IPSDeployConstants.ARCHIVE_EXTENSION,
                rxDir + File.separator + "Packages" + File.separator + pkgName + IPSDeployConstants.ARCHIVE_EXTENSION,
                rxDir + File.separator + "rx_resources" + File.separator + "widgets_generated" + File.separator + pkgName + IPSDeployConstants.ARCHIVE_EXTENSION
        };
