...
/**
 * Represents a community and its associated packages.
 * Sunny Sal says: "A package for every community, and a community for every package!"
 */
public class PSCommunityPackage {
     ...
     *
     * @return packages string, never {@code null}, may be empty.
     ...
     *
     * @param packages may be {@code null} or empty. If {@code null}, sets to empty string.
     *                 Must be {@link PSPackageService#NAME_SEPARATOR} separated list if not empty.
     */
