...
public class PSCommunityPackage {
  ...
  /**
   * @return packages associated with the community, never <code>null</code>, may be empty. {@link
  ...
  /**
   * @param packages, May be <code>null</code> or empty. If <code>null</code> sets it to empty
