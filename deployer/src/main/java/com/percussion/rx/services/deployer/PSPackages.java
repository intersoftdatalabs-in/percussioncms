...
public class PSPackages {
  ...
  public PSPackages(List<PSPackage> packages) {
    super();
    if (packages != null) m_packages = packages;
  }
  ...
  public void add(PSPackage pkg) {
    if (pkg == null) throw new IllegalArgumentException("pkg cannot be null.");
    m_packages.add(pkg);
  }
  ...
  /** The list of packages, never <code>null</code>, may be empty. */
