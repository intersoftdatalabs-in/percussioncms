...
public class PSPackageCommunities {
  ...
  public PSPackageCommunities(List<PSPackageCommunity> packages) {
    super();
    if (packages != null) m_packageCommunities = packages;
  }
  ...
  public void add(PSPackageCommunity pkgComm) {
    if (pkgComm == null) throw new IllegalArgumentException("pkg cannot be null.");
   ...
   *
   * @param pkgComm the package community object to be removed. May be <code>null</code>.
   */
  ...
  /** The list of package community objects, never <code>null</code>, may be empty. */
  private List<PSPackageCommunity> m_packageCommunities = new ArrayList<>();
}
