...
public class PSImplConfigLoaderTest {
  ...
  /**
   * Tests loading an implementation config file that contains simple property setter.
   *
   * @param expectedHandlers number of expected handlers in the file.
   * @throws Exception if an error occurs.
   */
  private void SimpleImplConfigTest(String filePath, int expectedHandlers, int propCount)
      throws Exception {
  ...
  public static final String UNIT_TEST_DIR = "/com/percussion/rx/config/test/";
