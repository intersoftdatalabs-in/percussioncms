...
public class PSConfigNormalizerTest {
  ...
  public Map<String, Object> loadLocalConfigFile(boolean resolveFQName) throws Exception {
  ...
  private void dumpNormalizedMap(Map<String, Object> nMap) {
    ...
    for (Map.Entry<String, Object> mapEntry : sortedSet) {
      ...
      if (mapEntry.getValue() instanceof Map) {
        ...
        System.out.println("List Size: " + ((Collection) mapEntry.getValue()).size());
      }
      System.out.println("----------");
    }
  }
  ...
  private void validateEmptyProperties(Map<String, Object> props, int count) {
    ...
    if (count == 5) {
      Object sub_childObj = props.get("com.percussion.Smog.parent.emptySet2");
