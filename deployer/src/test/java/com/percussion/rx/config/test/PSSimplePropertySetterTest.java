...
public class PSSimplePropertySetterTest extends TestCase {
  ...
  public void testAddPropertyDefs() throws Exception {
    ...
    for (String k : defs.keySet()) {
      ...
      assertTrue("Expect value = \"FIXME\"", myvalue.equals(PSSimplePropertySetter.FIX_ME));
    }
    ...
    pmap.put(
        "innerObject.innerObject2.stringValue",
        "${myPrefix.stringVal} abc ${myPrefix.stringVal_2}");
    sSetter.setProperties(pmap);
  ...
  public void testSimpleProperties() throws Exception {
    ...
    assertTrue(dObj.getInnerObject().getStringValue().equals(STR_IINER_VALUE));
    assertTrue(dObj.getInnerObject().getInnerObject2().getStringValue().equals(STR_IINER_VALUE2));
  }
