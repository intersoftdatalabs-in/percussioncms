...
public class PSIdNameTest {
  ...
  public void testEquals() throws Exception {
    PSIdName idName1 = new PSIdName((new PSGuid(PSTypeEnum.INTERNAL, 301)).toString(), "foo");
    PSIdName idName2 = new PSIdName((new PSGuid(PSTypeEnum.INTERNAL, 301)).toString(), "foo");
