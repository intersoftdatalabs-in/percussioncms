...
public class PSIdMappingTest {
  ...
  public void testEquals() throws Exception {
    ...
    PSIdMapping mapping2 = new PSIdMapping("sourceId_1", "sourceName_1", "type1");
    assertEquals(mapping1, mapping2);

    PSIdMapping mapping3 = new PSIdMapping("sourceId_3", "sourceName_3", "type1");
    ...
    mapping1 = new PSIdMapping("sourceId_1", "sourceName_1", "type1", true);
    mapping2 = new PSIdMapping("sourceId_1", "sourceName_1", "type1", true);
    assertEquals(mapping1, mapping2);

    mapping3 = new PSIdMapping("sourceId_3", "sourceName_3", "type1", true);
    assertTrue(!mapping1.equals(mapping3));
    ...
    mapping1 =
        new PSIdMapping(
            "sourceId_1", "sourceName_1", "type1", "parent1", "parentName", "parentType", false);
    assertEquals(mapping1, new PSIdMapping(mapping1));
  }

  /**
   * Tests all Xml functions, and uses <code>equals()</code> and <code>isNewObject()</code> as well.
   *
   * @throws Exception if there are any errors.
   */
  public void testXml() throws Exception {
    ...
    //
    PSIdMapping src = new PSIdMapping("sourceId_1", "sourceName_1", "type_1");
    ...
    //
    PSIdMapping src_2 = new PSIdMapping("sourceId_2", "sourceName_2", "type_1", false);
    ...
    //
    PSIdMapping src_new = new PSIdMapping("sourceId_new", "sourceName_new", "type_new");
  ...
  /**
   * Constructs a <code>PSIdMapping</code> object using the supplied params and catches any
   * exception. For params, see {@link PSIdMapping(String, String, String} for more info.
   *
   * @return <code>true</code> if no exceptions were caught, <code>false</code> otherwise.
   */
  private boolean testCtorValid(String sourceId, String sourceName, String type) {
    try {
