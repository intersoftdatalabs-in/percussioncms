...
public class PSDescriptorTest {
  ...
  public void testPkgDepList() throws Exception {
    ...
    ArrayList<Map<String, String>> pkgDepList2 = new ArrayList<Map<String, String>>();
    ...
    ArrayList<Map<String, String>> pkgDepList = new ArrayList<Map<String, String>>();
  ...
  public void testImport() throws Exception {
    ...
    if (info.getArchiveDetail().getExportDescriptor().getPackages().hasNext()) {
      Iterator packages = info.getArchiveDetail().getExportDescriptor().getPackages();
   ...
   *
   * @param full <code>true</code> to include modified and missing package lists, <code>false</code>
   *     otherwise.
