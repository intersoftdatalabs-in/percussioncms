...
public class PSArchiveManifestTest extends TestCase {
  ...
  public void testAll() throws Exception {
    ...
    PSDependencyFile depFile1 = new PSDependencyFile(PSDependencyFile.TYPE_APPLICATION_FILE, f1);
    depFile1.setArchiveLocation(loc1);
    PSDependencyFile depFile2 = new PSDependencyFile(PSDependencyFile.TYPE_APPLICATION_XML, f2);
    depFile2.setArchiveLocation(loc2);
    PSDependencyFile depFile3 = new PSDependencyFile(PSDependencyFile.TYPE_DBMS_SCHEMA, f3);
    depFile3.setArchiveLocation(loc3);
    PSDependencyFile depFile4 = new PSDependencyFile(PSDependencyFile.TYPE_DBMS_SCHEMA, f4);
    ...
    assertTrue(doesFileListTheSame(archman.getFiles(de3), (new ArrayList()).iterator()));
