...
public class PSIdMapTest {
  ...
  public void testConstructor() throws Exception {
    ...
    // should be a problem
    assertFalse(testCtorValid(null));
    assertFalse(testCtorValid(""));
  }
  ...
  public void testEquals() throws Exception {
    ...
    assertFalse(map1_3.equals(map2));
  }

  /**
   * Tests all Xml functions, and uses <code>equals()</code> and <code>isNewMappping()</code> and
  ...
  public void testXml() throws Exception {
    ...
    PSIdMapping mapping = new PSIdMapping("sourceId_1", "sourceName_1", "type_1");
    PSIdMapping mapping2 = new PSIdMapping("sourceId_2", "sourceName_2", "type_1");
    PSIdMapping mapping3 = new PSIdMapping("sourceId_3", "sourceName_3", "type_1");
