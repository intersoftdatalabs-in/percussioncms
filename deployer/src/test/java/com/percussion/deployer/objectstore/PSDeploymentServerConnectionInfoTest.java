...
public class PSDeploymentServerConnectionInfoTest {
  ...
  public void testEquals() throws Exception {
    ...
    different = new PSDeploymentServerConnectionInfo("host", 2, "user", "pass", false);
  ...
  /**
   * Helper method for constructing <code>PSDeploymentServerConnectionInfo</code> and catching any
   ...
   * @return <code>true</code> if the object constructed without error; <code>false</code> if the
   *     constructor threw an IllegalArgumentException
   */
  private boolean isCtorValid(
      String host, int port, String user, String pass, boolean isEncrypted) {
    boolean valid = true;
    try {
      new PSDeploymentServerConnectionInfo(host, port, user, pass, isEncrypted);
