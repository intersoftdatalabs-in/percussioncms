...
public class PSApplicationIdContextTest extends TestCase {
  ...
  public void testXml() throws Exception {
    ...
    PSAppExtensionParamIdContext extParamCtx = new PSAppExtensionParamIdContext(0, params[0]);
    assertTrue(extParamCtx.equals(testXml(extParamCtx)));
    PSAppExtensionParamIdContext extParamCtx2 = new PSAppExtensionParamIdContext(0, params[0]);
    ...
    dispMap.setId(2);
    PSAppDisplayMapperIdContext ceDispMapCtx = new PSAppDisplayMapperIdContext(dispMap);
    ...
    PSDataMapping dataMapping =
        new PSDataMapping(new PSXmlField("testXml"), new PSTextLiteral("testLit"));
    PSAppDataMappingIdContext dataMappingCtx =
        new PSAppDataMappingIdContext(dataMapping, PSAppDataMappingIdContext.TYPE_BACK_END);
    assertTrue(dataMappingCtx.equals(testXml(dataMappingCtx)));
    PSAppDataMappingIdContext dataMappingCtx2 =
        new PSAppDataMappingIdContext(dataMapping, PSAppDataMappingIdContext.TYPE_XML);
    assertTrue(dataMappingCtx2.equals(testXml(dataMappingCtx2)));
    PSAppDataMappingIdContext dataMappingCtx3 =
        new PSAppDataMappingIdContext(dataMapping, PSAppDataMappingIdContext.TYPE_COND);
   ...
   * @throws Exception if there are any errors.
   */
  private PSApplicationIdContext testXml(PSApplicationIdContext ctx) throws Exception {
