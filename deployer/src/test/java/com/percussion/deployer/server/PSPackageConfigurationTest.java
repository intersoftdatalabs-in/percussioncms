...
/**
 * Unit test for the PSPackageConfiguration, which include PSDependencyMap and PSDependencyDef
 * classes
 */
...
public class PSPackageConfigurationTest {
  ...
  private static final String UNIT_TEST_DIR = "/com/percussion/config/";

  private static final String RESOURCE_D0C = UNIT_TEST_DIR + "sys_PackageConfiguration.xml";
  ...
  /**
   * File contains less non-deployable elements in the order definition. The parent element is
   * "Custom"
   */
  private static final String MissNonDeployEl = UNIT_TEST_DIR + "sys_PkgConfig_MissNonDeployEl.xml";

  /**
   * File contains less deployable elements in the order definition. The parent of non-deployable
   * elements is not "Custom"
   */
  private static final String InvalidNonDeployElParent =
      UNIT_TEST_DIR + "sys_PkgConfig_InvalidNonDeployElParent.xml";
}
