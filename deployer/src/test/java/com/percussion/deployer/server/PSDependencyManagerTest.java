...
public class PSDependencyManagerTest {
  ...
  private PSDeployableElement createElement(String type) {
    ...
    if (type.equals(MENU_TYPE)) {
      return new PSDeployableElement(
          PSDependency.TYPE_LOCAL, "101", MENU_TYPE, "Action Menu", "Edit", false, false, false);
    }

    if (type.equals(CE_TYPE)) {
      return new PSDeployableElement(
          PSDependency.TYPE_LOCAL, "101", CE_TYPE, "Content Type", "Folder", false, false, false);
    }
    ...
    if (type.equals(EXIT_TYPE)) {
      return new PSDeployableElement(
          PSDependency.TYPE_LOCAL,
          EXIT_TYPE + "-Java/global/percussion/system/asmhelper",
          CUSTOM_TYPE,
          CUSTOM_TYPE,
          "asmhelper",
          false,
