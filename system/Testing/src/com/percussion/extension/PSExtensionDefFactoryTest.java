...
public class PSExtensionDefFactoryTest extends TestCase {
   ...
   public void testFull() throws Exception {
      ...
      javaInitParams.setProperty(IPSExtensionHandler.INIT_PARAM_CONFIG_FILENAME,
      ...
      PSExtensionDef def = new PSExtensionDef(ref, ifaces.iterator(), urls.iterator(),
            javaInitParams, runtimeParams.iterator());
      ...
      for (int i = 0; i < methodCount; i++) {
         ...
         for (int j = 0; j < paramCount; j++) {
            PSExtensionMethodParam param = new PSExtensionMethodParam("name_" + i + "." + j,
                  String.class.getName(), "description_" + i + "." + j);
