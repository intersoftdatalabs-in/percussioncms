...
public class HTTPClientTest extends PSClientTestCase {
   ...
   public HTTPConnection getConnection() {
      ...
      HTTPConnection con = new HTTPConnection(props.getProperty(PROP_HOST_NAME),
      ...
      authInfo = new AuthorizationInfo(props.getProperty(PROP_HOST_NAME),
            Integer.parseInt(props.getProperty(PROP_PORT)), props.getProperty(PROP_SCHEME), "",
            Codecs.base64Encode(
      ...
      NVPair[] defaultHeaders = {new NVPair("User-Agent", "Rhythmyx Remote Requestor"),
