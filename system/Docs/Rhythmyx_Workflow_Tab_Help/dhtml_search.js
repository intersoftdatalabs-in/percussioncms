...
Page[3] = new Array(
  ...
  "A new workflow does not include States, Roles, or Notifications. &nbsp;Therefore, when Rhythmyx displays this page as the New Workflow page, the lists of States, Roles and Notifications are not included.",
  ...
  "Administrator &nbsp;Optional. &nbsp;The Workflow Role defined as the Administrator of this workflow. For more about the Workflow Administrator, see &nbsp;About Workflow Administrator.",
...
Page[4] = new Array(
  ...
  "To access the Copy Workflow page, on the Workflow Editor, click Copy Workflow.",
  "Field Descriptions",
...
Page[6] = new Array(
  ...
  "Click New Workflow.",
  "Rhythmyx displays the New Workflow page, which is a blank version of the Edit Workflow page.",
  "Enter the Name of the new workflow and the Workflow Administrator Role. &nbsp;You can also enter a free-form Description of the workflow. &nbsp;",
  "Click [Save].",
...
Page[7] = new Array(
  ...
  "To copy a Workflow:",
  "On the Workflow Editor, click the Copy Workflow link.",
  "Rhythmyx displays the Copy Workflow page.",
  "In the Source Workflow drop list, choose the Workflow you want to copy.",
  "In the New Workflow field, enter a name in the New Workflow field.",
...
Page[8] = new Array(
  ...
  "Rhythmyx displays the Edit Workflow page.",
...
Page[9] = new Array(
  ...
  "Access the Workflow Editor.",
  "Click the Delete button @&nbsp;in the row of the workflow you want to delete.",
...
Page[13] = new Array(
  ...
  "On the Edit Workflow page click Role in the New box.",
  "Rhythmyx displays the New Role for Workflow page, which is a blank version of the Edit Role page.",
  "Enter the Name of the Role and optional Description. &nbsp;",
  "Click [Save].",
...
Page[15] = new Array(
  ...
  "To edit a Role:",
  "Access the Edit Workflow page of the workflow whose Role you want to edit.",
  "Click the name of the Role you want to edit.",
  " Rhythmyx displays the Edit Role page.",
  "Make your changes.  You can change the Name or Description of the Role.",
  "Click [Save].",
...
Page[16] = new Array(
  ...
  "To delete a Role:",
  "Access the Edit Workflow page.",
  "Click the Delete button @&nbsp;in the row of the Role you want to delete.",
...
Page[20] = new Array(
  ...
  "Groups - The members added are groups (collections of users managed within the security provider rather than Rhythmyx).",
...
Page[21] = new Array(
  ...
  "Type - Radio buttons. Indicates whether the new Member is a Group (collection of members managed in the security provider and outside of Rhythmyx) or an individual User.",
...
Page[23] = new Array(
  ...
  "Role or Subject Property ",
  "Property Name",
  "Function",
  "Role",
  "sys_defaultCommunity",
  "Stores the name of the role's default Community. Required <br />when you are using the default Community feature.",
  "Role",
  "sys_defaulthomepageurl",
  "Stores the fully qualified or relative URL of the first Rhythmyx<br />page that appears after login for users who log in under this role. <br />Required when you are using the default home page feature. ",
  "Subject",
  "sys_email",
...
Page[24] = new Array(
  "To add a New Role: &nbsp;",
  "In the Rhythmyx Server Administrator, click the Security tab along the top, then the Roles tab along the bottom.",
  "Click [Add role].",
  "Rhythmyx displays the Add Role dialog.",
  "Enter the Name of the new Role.",
  "Add any Properties to the new Role. &nbsp;To add a property:",
  "Click in an empty row under Name.",
  "Rhythmyx displays a drop list of available properties.",
  "Select the property you want to assign to the Role.",
  "To add a value to the property, click in the same row under Value.",
...
Page[25] = new Array(
  ...
  "To edit a Role:",
  "In the Rhythmyx Server Administrator, click the Security tab along the top, then the Roles tab along the bottom.",
  "Select the Role whose properties you want to edit.",
  "Click the [Edit] button.",
  "Rhythmyx displays the Edit Role dialog.",
  "To add a property:",
  "Click in an empty row under Name.",
  "Rhythmyx displays a drop list of available properties.",
  "Select the property you want to assign to the Role.",
  ...
  "If values are pre-defined (see Maintaining Role and Member Property Names and Values), Rhythmyx will display the available properties in a drop list. &nbsp;Select the value you want to assign to the property.",
  "If values are free-form, Rhythmyx will move your cursor to the Edit Value field, where you can enter the values. Enter each unique value on a separate line.",
  "To delete a property, right click on the property and select Clear from the popup menu.",
  "To change the value of an existing property, click in the same row under Value.",
...
Page[26] = new Array(
  ...
  "To delete a Role:",
  "In the Rhythmyx Server Administrator, click the Security tab along the top, then the Roles tab along the bottom.",
  "In the View field, select Members by Role.",
  "Select the Role you want to delete. &nbsp;You can select multiple Roles.",
...
Page[27] = new Array(
  ...
  "In the Rhythmyx Server Administrator, click the Security tab along the top, then the Roles tab along the bottom.",
  "Select the Role to which you want to add Members.",
  "Click [Add Member(s)].",
  "Rhythmyx displays the Modify Member List for &lt;Role&gt; dialog.",
  "Select the security Provider from which you want to select Members.",
  "Choose the Type of Member you want to add. &nbsp;Options are Users (add individual Members), Groups (add groups of Members managed within the security provider) or Both (add both individual Members and groups of Members). &nbsp;NOTE: &nbsp;Not all security providers support Groups. &nbsp;If the security provider you select does not support Groups, these options are not editable.",
  "Enter an optional Filter. &nbsp;Use SQL syntax to define the values. &nbsp;Two wildcard characters are available: &nbsp;% matches 0 or more characters, while &quot;_&quot; matches any single character. &nbsp;(For example, to catalog the name admin1, you would enter admin1.  This entry would return only admin1.  If you wanted to catalog all names that begin admin, you would enter admin%.  This entry would return admin1, admin2, etc.  If you wanted to return all names that begin with &quot;ad&quot;, you would enter ad%.  This entry would return Adams, Adkins, admin1, admin2, etc.   Similarly, if you entered ols_n, Rhythmyx would return Olsen, Olson, and Olsun.",
  ...
  "Enter values. &nbsp;Each value should be entered on a separate line.",
  "Click [OK] on the Catalog Filter Editor dialog.",
  "Click the [Catalog] button.",
  "Rhythmyx displays a list of Members that matches the parameters you defined. &nbsp;You can define a filter for this list in the Display Filter field. &nbsp;The same options are available for this field as for the catalog filter. &nbsp;Click the @&nbsp;button to activate the display filter.",
...
Page[28] = new Array(
  ...
  "Click [Add member(s)].",
  "Rhythmyx displays the Modify Member List for &lt;Role&gt; dialog.",
  "On the Modify Member List for Role dialog, click the [New] button.",
  "Rhythmyx displays the New Member dialog.",
  "Enter the Member Name of the new Member.",
  "Choose the Type of new Member. &nbsp;Options are Users (individual Member) or Group (group of Members managed in the security provider but not managed in Rhythmyx).",
  "Select the Properties you want to define. &nbsp;Options are Global (properties not associated with a specific Role) and Role (properties for a specific Role). &nbsp;If you select Role, you must select the Role for which you want to define properties. &nbsp;Options for the Role field are all Roles associated with the Member. &nbsp;Note that any Global property will override a property of the same name from the security provider.",
  "To select a property, click in an empty row under Name and select a property from the drop list.",
  "To add a value to a property, click in the same row under Value. &nbsp;",
  "If values are pre-defined, Rhythmyx will display the available properties in a drop list. &nbsp;Select the value you want to assign to the property.",
  "If values are free-form, Rhythmyx will move your cursor to the Edit Value field, where you can enter the values. &nbsp;Enter each unique value on a separate line.",
...
Page[29] = new Array(
  ...
  "In the Rhythmyx Server Administrator, click the Security tab along the top, then the Roles tab along the bottom.",
  "Select the Member whose record you want to edit.",
  "Click the [Edit] button.",
  "Rhythmyx displays the Edit Member Properties dialog (same as New Member dialog).",
  "Select the Properties you want to View. &nbsp;Options are Global (view all properties) and Role (view properties associated with a specific Role). &nbsp;Note that any Global property will override a property of the same name from the security provider.",
  "To delete a property, right click on the property and select Clear from the popup menu.",
  "To change the value of an existing property, click in the same row under Value.",
  "If values are pre-defined, Rhythmyx will display the available properties in a drop list. &nbsp;Select the value you want to assign to the property.",
...
Page[30] = new Array(
  ...
  "In the Rhythmyx Server Administrator, click the Security tab along the top, then the Roles tab along the bottom.",
  "You have two options to delete a Member from a single Role:",
  ...
  "To delete a Member from all Roles, in the View field, select Roles by Member, then select the Member you want to delete.",
  "Click the [Delete] button.",
  "Rhythmyx displays a confirmation message. &nbsp;Click [Yes] to confirm the delete action or [No] to abort the delete action.",
...
Page[32] = new Array(
  ...
  "Processing",
  "Unpublish",
  "Default.  Content in this State is not published, or will be unpublished the next time the Publisher runs.",
  "Publish",
  "Content in this State is published when the Publisher runs.",
  "Ignore",
...
Page[34] = new Array(
  "To edit a State:",
  "Access the Edit State page for the State you want to edit.",
  "You can modify any of the three fields in the State.",
  "Click [Save].",
...
Page[35] = new Array(
  ...
  "Access the Edit Workflow page for the workflow from which you want to delete a State.",
  "Click the Delete button @ the row of the State you want to delete. &nbsp;",
  "Rhythmyx displays a confirmation message.",
  "To confirm the delete action, click [OK]. &nbsp;To abort the delete action, click [Cancel].",
  "Deleting a State",
...
Page[38] = new Array(
  ...
  "Access the New Transition page.",
  "Enter the Label (name) of the Transition (this field is mandatory) and Description of the Transition. &nbsp;",
  "Enter a Trigger for the Transition. &nbsp;A Trigger is a string Rhythmyx uses to start processing the Transition and is mandatory.",
  "Select the State the document will move to in the Transition To State field.",
  "Choose the Approval Type.  Options are Specified Number (specific number of approvals required for the Transition; approvals may come from any Role assigned to the current State of the content; if you choose this option, you must specify the number of Approvals Required) and Each Role (specific Roles must approve content before it can make this Transition; you must specify the Roles the must approve the content).",
  "If you chose Specified Number  in the Approval Type field, enter the number of Approvals Required for the Transition.",
  "Select an option for Comment Required. &nbsp;Choices are Optional (Rhythmyx displays the comment popup, but the user can choose not to make a comment), Required (user must enter a comment when making the Transition), and Do Not Show (Rhythmyx does not display the comment popup).",
  "If Workflow Actions are available, select the action you want to associate with the Transition. &nbsp;",
  ...
  "If you chose Each Role in the Approval Type field and Specified Roles in the Transition Roles field, you must add Transition Roles.   ",
...
Page[39] = new Array(
  ...
  "Access the Edit Transition page for the Transition you want to edit.",
...
Page[40] = new Array(
  ...
  "Access the Edit Workflow page of the workflow from which you want to delete the Transition.",
  "Click the Delete button @of the row of the Transition you want to delete.",
  "Rhythmyx displays a confirmation message. ",
  "To confirm the delete action, click [OK]. &nbsp;To abort the delete action, click [Cancel].",
...
Page[41] = new Array(
  ...
  "Click Add Transition Role.",
  "Rhythmyx displays the Add Transition Role page.",
  "Choose the Role you want to add.  Options are all Roles in the Workflow not currently assigned as Transition Roles to this Transition.",
  "Click [Save].",
...
Page[45] = new Array(
  ...
  "In some cases, you may need to define more than one Transition to make your Aging scenario function.  For more information, see &quot;Aging Scenarios (on page 49)&quot;.",
  "To define an Aging Transition: ",
  "In the Rhythmyx Content Explorer, click the Workflow tab. Rhythmyx displays the Workflow Editor. ",
  "Click on the name of the Workflow to which you want to add an Aging Transition. Rhythmyx displays the Edit Workflow page.",
  "Click on the name of the State to which you want to add a Transition. Rhythmyx displays the Edit State page.",
  "Click New Aging Transition. Rhythmyx displays the New Aging Transition page. ",
  "Enter the Label (name for the Transition; this field is mandatory) and Description of the Transition. ",
  "Enter a Trigger for the Transition.  A Trigger is a string Rhythmyx uses to start processing the Transition and is mandatory. ",
  "Select the State the document will move to in the Transition To State field. The To State may be the current State or it may be another State in the Workflow. ",
  "Select the Aging Type. Options are: ",
...
Page[46] = new Array(
  ...
  "Automatically transition a Content Item when a System Date (Start Date, End Date, Reminder Date) occurs (System Field Transition)",
...
Page[52] = new Array(
  ...
  "On the Edit Workflow page, click New Notification;",
...
Page[55] = new Array(
  ...
  "On the Edit Workflow page, click the delete button @of the Notification you want to delete.",
  "Rhythmyx displays a confirmation message.",
  "To confirm the delete action, click [OK]. &nbsp;To abort the delete action, click [Cancel].",
...
Page[57] = new Array(
  ...
  "${fieldname}",
  "You can use any system field and any shared or local field in the item.  For example:",
...
Page[61] = new Array(
  ...
  "Access the Edit State page.",
  "Click New Assigned Role.",
  "Rhythmyx will display the New Assigned Role page.",
  "Select the Role you want to assign to the State. &nbsp;Options include all Roles defined for the workflow. (Note that the Workflow administrator Role must be assigned to all States).",
  "Select an Assignment.  Options are None (State is not assigned to anyone), Reader (Role has read-only access to content items in the State), and Assignee (Role has full access to content items in the State). The Workflow administrator Role should have Assignee access to all States.",
  "Select an option for  Ad-hoc assignment.  Options are Disabled (default; ad hoc assignment is not permitted to the State), Enabled (ad hoc assignment is allowed to the State), and Anonymous (only Anonymous ACL access is permitted to the State.",
  "Select a Notify option. &nbsp;Options are Y (default; Notification is allowed) and N (Notification is not allowed).",
...
Page[62] = new Array(
  ...
  "Access the Edit State page for the State whose Role assignment you want to edit.",
  "Click the name of the Role whose assignment you want to edit.",
  "Rhythmyx displays the Role Assignment page.",
  "You can change the data in all fields. ",
...
Page[63] = new Array(
  ...
  "Access Edit State page of the State from which you want to delete the Role.",
  "Click the Delete button @&nbsp;in the row of the Role you want to delete.",
  "Rhythmyx displays a confirmation message. ",
  "To confirm the delete action, click [OK]. &nbsp;To abort the delete action, click [Cancel].",
...
Page[65] = new Array(
  ...
  "In Rhythmyx Content Explorer, click the Workflow tab.",
  "Rhythmyx displays the Workflow tab.",
  "Click the Preview icon for the Workflow to which you want to add the Transition.",
  "Rhythmyx displays the Preview of that Workflow.",
  "Click the Transition to which you want to add a Notification.",
  "Rhythmyx displays the Edit Transition page for the Transition you selected.",
  "Click New Transition Notification.",
  "Rhythmyx displays Transition Notification page.",
  "Select the Notification you want to assign to the Transition. &nbsp;Notifications are identified by Subject and unique identifier.",
  "Select the State Role Recipients Type. &nbsp;Options include:",
  ...
  "Enter the e-mail address of any additional recipients of the Notifications in the Additional Recipient List field or CC field. &nbsp;Separate the addresses with comma.",
...
Page[66] = new Array(
  ...
  "In the Rhythmyx Content Explorer, click the Workflow tab.",
  "Rhythmyx displays the Workflow Editor.",
  "Click the Preview icon for the Workflow to which you want to add the Transition.",
  "Rhythmyx displays the Preview of that Workflow.",
  "Click the Transition whose Notification you want to edit.",
  "Rhythmyx displays the Edit Transition page for the Transition you selected.",
  "Click the name of the Notification Assignment you want to edit.",
  "Rhythmyx displays the Transition Notification page.",
  "You can change the Notification assigned to the Transition, change the State Role Recipients Type, or add e-mail addresses to the Additional Recipient List or CC List, or delete e-mail addresses from those lists. ",
  "Click [Save] to save your changes.",
...
Page[68] = new Array(
  ...
  "The Workflow must include a Quick Edit State.  ",
  ...
  "Define a Quick Edit Transition from the Public State to the Quick Edit State.",
  ...
  "Define a Transition from the Quick Edit State back to the Public State.  This Transition should have the sys_TouchParentItems in the Workflow Actions field of the Edit Transition Page to ensure that all related content items are updated with the changes made during Quick Edit.",
  "The following graphic shows a portion of a State diagram of a Workflow in which Quick Edit has been implemented.  Note the Quick Edit State, the Quick Edit Transition to the State, and the Publish Transition back to Public.",
  "If a Content Item is in a Quick Edit State:",
  "Previewing should display the most recent Version of the Content Item.",
