...
Page[2] = new Array(
  ...
  "The Runtime Edition dialog always displays the Publishing Logs for the Edition.  When an Edition is running, the dialog displays status data, as in the screenshot below.",
...
Page[3] = new Array(
  ...
  "You can sort the logs based on the data in the following columns:",
  "Job ID (default)",
  "Start Type",
  "Elapsed Time",
  ...
  "Full Description",
  "Completed",
  "All Content Lists were processed successfully and all Content Items were published successfully.",
  "Completed with failures",
  "Publishing of one or more Content Items may have failed.  Check the log for the run to identify the Content Items for which publishing failed to determine the causes of the failures.",
  "Publishing of one or more Content Lists may have failed.  Check the console log (&lt;Rhythmyxroot&gt;/console.log) to determine which Content Lists failed and why.",
  "Cancelled",
  "The Content Items were assembled and prepared for delivery but the Edition was cancelled by the user before the Content Items were delivered.",
  "Aborted",
...
Page[4] = new Array(
  ...
  "You can sort the logs based on the data in the following columns:",
  "Content ID",
  "Location (sorts based only on output location)",
  "Elapsed Time",
  "Operation",
  "Status",
  "Delivery Type",
...
Page[6] = new Array(
  ...
  "Double-click on the Edition you want to run.",
  "The View and edit pane displays the Runtime Edition dialog.",
  "In the Menu bar, click Start.",
...
Page[7] = new Array(
  ...
  "To stop an Edition:",
  "In the Navigation pane, double-click on Publishing Status.",
  "The View and Edit pane displays the Publishing Status dialog.",
  "Select the Edition you want to cancel.",
...
Page[10] = new Array(
  ...
  "You can access details of each log.  When you click on the log entry, Rhythmyx displays the Log View in the View and Edit pane.",
...
Page[11] = new Array(
  ...
  "You can manually purge or archive logs as well.",
...
Page[14] = new Array(
  ...
  "To clear a Site record:",
  "Expand the Sites node. Expand the Site whose record you want to clear. Click on the Publishing Logs link.",
