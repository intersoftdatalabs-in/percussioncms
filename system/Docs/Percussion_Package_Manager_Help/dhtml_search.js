...
Page = new Array();
Page[0] = new Array(
  "Use the Package Management web application to",
...
Page[1] = new Array(
  ...
  "reapply package configuration settings",
...
Page[2] = new Array(
  ...
  "The table on the tab consists of the following columns:",
  "Package Status",
  "Indicates the condition of the package. Packages can be in one of the following states:",
  "State ",
  "Icon ",
  "Description",
  "Installed ",
  ...
  "Installation Error ",
  "Error occurred during package installation; package was not installed successfully and cannot be configured.",
  "Uninstalled ",
  "Package was removed from the system.",
  "Configuration Status",
  "Indicates the configuration condition of the package. Package configuration can be in one of the following states:",
  "State ",
  "Icon ",
  "Description",
  "Configured ",
  "Package was configured successfully.",
  "Configuration Error",
  "An error occurred in package configuration; configurations were not updated.",
  "Unconfigured ",
  "(no icon)",
  "That package was not configured; possible reasons the package was not configured include: the package did not allow configuration, the package has been uninstalled.",
  "Name",
  "Name of the package. The package name takes the format Publisher_Prefix.Solution_Name; for example, perc.Example is one of the example packages shipped to support Percussion's Packaging suite.",
  "Description",
  "Description of the package from the package vendor.",
  "Publisher",
  "Name of the organization that supplies or distributes the package.",
  "Version",
  "The latest version of the package that has been installed.",
  "By Whom",
  "Username of the Percussion CM System user that installed the package.",
  "Last Modified Date",
...
Page[4] = new Array(
  ...
  "whether the package was modified outside of standard configuration (for example in the Percussion Workbench); or",
  "whether a package dependency is missing ",
...
Page[6] = new Array(
  ...
  "Note that if a package includes design objects that are in use, those design objects will not be deleted when you uninstall the package (other design objects will be deleted normally). The system will display a warning message informing you which design objects will not be deleted.",
...
Page[8] = new Array(
  ...
  "Select the package whose associations you want to change.",
  "Click the [Edit Assocations] button",
  "Package Manager displays the Edit Community Associations dialog.",
  "In the Available list, choose the Communities you want to associate with the package. Standard multi-select options are available.",
  "Click the (arrow graphic) to move the Communities to the Selected list. You can also use drag and drop to move Communities.",
  "To remove Community associations, move them from the Selected list to the Available list.",
  "Click the [OK] button.",
...
Page[9] = new Array(
  ...
  "Select the Community whose associations you want to change.",
  "Click the [Edit Associations] button.",
  "Package Manager displays the Edit Package Associations dialog.",
  "In the Available list, choose the packages you want to associate with the Community. Standard multi-select options are available.",
  "Click the (arrow graphic) to move the packages to the Selected list. You can also use drag and drop to move packages.",
  "To remove package associations, move them from the Selected list to the Available list.",
  "Click the [OK] button.",
  "The system saves your changes. ",
...
function search(SearchWord) {
  ...
  Result +=
    '<script language="javascript" charset="ISO-8859-1" src="dhtml_search.js"></script>\n';
