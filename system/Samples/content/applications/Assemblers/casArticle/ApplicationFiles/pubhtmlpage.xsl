...
<xsl:stylesheet version="1.1"
	...
	<xsl:template
		match="rxslot[@template=&apos;Related Image&apos;]" mode="rxslot">
		<xsl:if test="linkurl">
			...
			<tr>
				<td>
					...
					<xsl:variable name="rxslot-2">
						<rxslot psxeditslot="yes" slotname="Related Image"
							template="Related Image">
							<xsl:copy-of
								select="$related/linkurl[@slotname=&apos;Related Image&apos;]" />
						</rxslot>
	...
	<xsl:template
		match="rxslot[@template=&apos;Hot Articles&apos;]" mode="rxslot">
		<xsl:if test="linkurl">
			<table bodercolor="green" border="1" cellspacing="0"
				width="100%">
				<tr>
					<td height="30" />
				</tr>
			...
			<tr valign="top">
				...
				<td>
					...
					<xsl:variable name="rxslot-6">
						<rxslot psxeditslot="yes" slotname="Hot Articles"
							template="Hot Articles">
							<xsl:copy-of
								select="$related/linkurl[@slotname=&apos;Hot Articles&apos;]" />
						</rxslot>
