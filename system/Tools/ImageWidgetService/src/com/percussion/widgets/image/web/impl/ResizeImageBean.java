...
/**
 * Data transfer object for image resize operations.
 * Contains parameters for resizing, cropping, and rotating images.
 * This bean is used for Spring MVC form binding and validation.
 *
 * @since Java 11
 */
public class ResizeImageBean {
     ...
     */
    public ResizeImageBean(String imageKey, int width, int height,
     ...
     *
     * @param other the bean to copy, must not be {@code null}
     * @throws IllegalArgumentException if other is {@code null}
     */
    public ResizeImageBean(ResizeImageBean other) {
        Objects.requireNonNull(other, "ResizeImageBean to copy must not be null");
    ...
    /**
     * Checks if this bean has valid resize dimensions.
     *
    ...
    /**
     * Checks if this bean has crop parameters.
     *
    ...
    /**
     * Checks if this bean has a valid crop box (all coordinates positive).
     *
    ...
    /**
     * Checks if this bean has rotation.
     *
     ...
     *
     * @return new ResizeImageBean with copied values
     */
    public ResizeImageBean copy() {
        return new ResizeImageBean(this);
    }
    ...
    public String toString() {
        return String.format("ResizeImageBean{imageKey='%s', size=%dx%d, crop=(%d,%d,%d,%d), rotate=%d}",
