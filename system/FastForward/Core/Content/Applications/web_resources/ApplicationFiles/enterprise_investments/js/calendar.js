...
function moveToNewDay(for_day) {
  ...
  if (for_day > 1) {
    ...
    the_back_html =
      "<b><a href='#' class='normal_lnk' onClick='displayEvents(" +
      back_one_day +
      ");'>&lt;&lt;</a></b>";
  }
  ...
  var the_html =
    "<table width='100%' border='' cellspacing='0' cellpadding='0'><tr><td height='3px'></td></tr>";
  the_html +=
    "<tr><td class='normal_lnks' align='center' nowrap width='100%'>" +
    the_back_html;
  the_html +=
    "&nbsp; &nbsp; <b>" +
    month_name +
...
function displayEvents(for_day) {
  ...
  the_new_html =
    "<table width='90%' border='0' cellspacing='0' cellpadding='0' id='monthevents' style='display:block'>";
  ...
  for (var i = 0; i < events.length; i++) {
    if (events[i].day == for_day) {
      ...
      the_new_html +=
        "<td width='50' align='center' class='months_news' height='20'>" +
        events[i].time +
        "</td>";
      the_new_html +=
        "<td class='months_news' height='20'><a href='" +
        events[i].url +
        "' class='months_newslnks'>" +
        events[i].title +
        "</a></td>";
      the_new_html += "</tr>";
      the_new_html += "<tr>";
  ...
  if (counter > 0) {
    ...
    document.getElementById("event_area").innerHTML =
      the_new_html +
      "<tr valign='top'><td width='20' height='20'>&nbsp;</td><td class='months_news' colspan=2>No events for today.&nbsp;</td></tr></table>";
  }
