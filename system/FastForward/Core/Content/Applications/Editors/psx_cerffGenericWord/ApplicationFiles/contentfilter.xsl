...
<xsl:stylesheet version="1.1"
	...
	<xsl:template
		match="html:p[@class='PageDisplayTitle'] | p[@class='PageDisplayTitle']"
		mode="contentfilter" />

	<xsl:template
		match="html:p[@class='PageDescription'] | p[@class='PageDescription']"
		mode="contentfilter" />

	<xsl:template
		match="html:p[@class='PageAuthor'] | p[@class='PageAuthor']"
		mode="contentfilter" />
