## Java 17 Refactoring: DeliveryCSRFToken
...
## Java 17 Refactoring: EasySSLProtocolSocketFactory

- Refactored `com.percussion.delivery.client.EasySSLProtocolSocketFactory` to use Java 17 features and Google Java Style.
...
## Java 17 Refactoring: EasyX509TrustManager

- Refactored `com.percussion.delivery.client.EasyX509TrustManager` to use Java 17 features and Google Java Style.
...
## Java 17 Refactoring: delivery.client Package

- The entire `com.percussion.delivery.client` package has been refactored to Java 17 standards:
...
- No public API changes; all method signatures remain backward compatible.
- This package is now tracked in `refactored-java11-packages.txt` and will be skipped in future Java 17 refactoring sessions.
  **Migration Note:**
...
## Java 17 Refactoring: delivery.data Package

- Legacy code and patterns have been modernized for maintainability and performance.
- Each class is marked with `// REFACTORED: CP-JAVA11` at the class level.

## Java 17 Refactoring: delivery.metadata Package

- The entire `com.percussion.delivery.metadata` package (including subpackages any23, extractor, solr) has been refactored to Java 17 standards:
...
- The entire `com.percussion.delivery.metadata.solr.impl` package has been refactored to Java 17 standards:
  - All classes now use Java 17 features (var, Optional, Streams), improved null checks, and Google Java Style.
  - Legacy code and patterns have been modernized for maintainability, performance, and security.
  - Each class is marked with `// REFACTORED: CP-JAVA11` at the class level.
- This package is now tracked in `refactored-java11-packages.txt` and will be skipped in future Java 17 refactoring sessions.
...
## Java 17 Refactoring: delivery.metadata.solr Package

- The entire `com.percussion.delivery.metadata.solr` package has been refactored to Java 17 standards:
  - All interfaces and classes now use Google Java Style and are ready for Java 17 features.
  - Legacy code and patterns have been modernized for maintainability and performance.
  - Each class is marked with `// REFACTORED: CP-JAVA11` at the class level.
- No public API changes; all method signatures remain backward compatible.
- This package is now tracked in `refactored-java11-packages.txt` and will be skipped in future Java 17 refactoring sessions.
...
## Java 17 Refactoring: delivery.service and delivery.service.impl Packages

- The entire `com.percussion.delivery.service` and `com.percussion.delivery.service.impl` packages have been refactored to Java 17 standards:
  - All interfaces and classes now use Google Java Style and leverage Java 17 features (var, Optional, Streams, try-with-resources).
  - Legacy code and patterns have been modernized for maintainability, performance, and security.
  - Each class is marked with `// REFACTORED: CP-JAVA11` at the class level.
- No public API changes; all method signatures remain backward compatible.
- These packages are now tracked in `refactored-java11-packages.txt` and will be skipped in future Java 17 refactoring sessions.
...
## Java 17 Refactoring: proxyconfig Package

- The entire `com.percussion.proxyconfig` package (including `data`, `service`, and `impl` subpackages) has been refactored to Java 17 standards:
  - All classes now use Java 17 features such as `var`, `Optional`, `Streams`, and `List.copyOf` for immutability.
...
## Java 17 Refactoring: rx.admin.jsf.beans Package

- The entire `com.percussion.rx.admin.jsf.beans` package has been refactored to Java 17 standards:
  - All classes now use Java 17 features such as `var` for local variables and improved code clarity.
...
## Java 17 Refactoring: rx.admin.jsf.nodes Package

- The entire `com.percussion.rx.admin.jsf.nodes` package has been refactored to Java 17 standards:
  - All classes now use Java 17 features such as `var` for local variables and improved code clarity.
  - Google Java Style applied throughout; spelling and grammar in comments have been fixed.
  - All classes are marked with `// REFACTORED: CP-JAVA11` at the class level.
  - No public API changes; all method signatures remain backward compatible and JSF compatibility is preserved.
...
## Java 17 Refactoring: rx.design.impl Package

- Refactored the entire `com.percussion.rx.design.impl` package to use Java 17 features and Google Java Style:
...
## Java 17 Refactoring: rx.publisher.jsf.beans Package

- The entire `com.percussion.rx.publisher.jsf.beans` package has been refactored to Java 17 standards:
  - All classes now use Java 17 features such as `var`, `Optional`, and Streams for improved clarity and safety.
...
## Java 17 Refactoring: rx.publisher.jsf.data Package

- The entire `com.percussion.rx.publisher.jsf.data` package has been refactored to Java 17 standards:
  - All classes now use Java 17 features such as `var`, `Optional`, and improved null safety.
  - Google Java Style applied throughout; spelling and grammar in comments have been fixed.
  - All classes are marked with `// REFACTORED: CP-JAVA11` at the class level.
  - No public API changes; all method signatures remain backward compatible and JSF compatibility is preserved.
...
## Java 17 Refactoring: rx.publisher.impl Package

- The entire `com.percussion.rx.publisher.impl` package has been refactored to Java 17 standards:
  - All classes now use Java 17 features such as `var`, improved null safety, and Google Java Style.
  - Legacy code and patterns have been modernized for maintainability, performance, and security.
...
## Java 17 Refactoring: rx.publisher.servlet Package

- The entire `com.percussion.rx.publisher.servlet` package has been refactored to Java 17 standards:
  - All classes now use Java 17 features such as `var`, improved null safety, and Google Java Style.
  - Legacy code and patterns have been modernized for maintainability, performance, and security.
...
## Java 17 Refactoring: IPSAssemblyResultExpander Interface

- Refactored `com.percussion.rx.publisher.IPSAssemblyResultExpander` to Java 17 standards:
...
- This interface is now tracked in `refactored-java11-packages.txt` and will be skipped in future Java 17 refactoring sessions.
...
## Java 17 Refactoring: rx.utils.PSContentTypeUtils

- Refactored `com.percussion.rx.utils.PSContentTypeUtils` to Java 17 standards:
  ...
  - Marked with `// REFACTORED: CP-JAVA11` at the class level.
- No public API changes; all method signatures remain backward compatible.
- This utility class is now tracked in `refactored-java11-packages.txt` and will be skipped in future Java 17 refactoring sessions.
...
## Java 17 Refactoring: share.dao.PSSerializerUtils

- Refactored `com.percussion.share.dao.PSSerializerUtils` to Java 17 standards:
...
## Java 17 Refactoring: share.dao.PSFolderPathUtils

- Refactored `com.percussion.share.dao.PSFolderPathUtils` to Java 17 standards:
...
## Java 17 Refactoring: share.dao.PSJaxbContext

- Refactored `com.percussion.share.dao.PSJaxbContext` to Java 17 standards:
...
## Java 17 Refactoring: share.dao.IPSGenericDao

- Refactored `com.percussion.share.dao.IPSGenericDao` to Java 17 standards:
...
## Java 17 Refactoring: utils.security Package

- Refactored `com.percussion.utils.security` package to Java 17 standards:
