	...
	<xsl:template match="/">
		<html>
			...
			<body onload="javascript:self.focus();"
				onUnload="javascript:onClickCancel()">
				...
				<td valign="top" class="headercell">
					<table width="100%" border="0" cellspacing="1"
						...
						<tr class="headercell2">
							<td class="headercell2font" align="center">Content&nbsp;Title&nbsp;(ID)&nbsp;&nbsp;&nbsp;
							</td>
							<td class="headercell2font" align="center">Content&nbsp;Type&nbsp;&nbsp;&nbsp;
							</td>
						...
						<xsl:if test="not(string-length(variantid))">
							<tr class="datacell1">
								<td class="datacellnoentriesfound" colspan="4" align="center">No
									entries found.&nbsp;
								</td>
							</tr>
						</xsl:if>
			...
			<td align="left" class="datacell1font">
				<a>
					...
					<xsl:attribute name="onclick">javascript:onClickUpdate(&quot;<xsl:value-of
						select="previewurl" />&quot;)</xsl:attribute>
