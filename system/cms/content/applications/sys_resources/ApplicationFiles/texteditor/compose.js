...
function createInlineLink(type) {
  ...
  while (urlString == "searchagain") {
    ...
    params = window.showModalDialog(
      "/Rhythmyx/sys_ceInlineSearch/contentsearch.html?inlineslotid=" +
        inlineslotid +
        "&inlinetext=" +
        inlinetext +
        "&inlinetype=" +
    ...
    urlString = window.showModalDialog(
      "/Rhythmyx/sys_ceInlineSearch/resultpage.html?inlineslotid=" +
        inlineslotid +
        "&inlinetext=" +
        inlinetext +
        "&inlinetype=" +
    ...
    urlString = window.showModalDialog(
      "/Rhythmyx/sys_ceInlineSearch/returnvariant.html?inlineslotid=" +
        inlineslotid +
        "&inlinetext=" +
        inlinetext +
        "&inlinetype=" +
