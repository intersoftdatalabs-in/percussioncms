...
ps.io.Actions = function () {
  ...
  this.getActionLabels = function (actionNames) {
    ...
    var params = new dojo.collections.Dictionary();
    params.add("names", o.names);
    return this._makeRequest(action, this.MIMETYPE_JSON, null, params);
  };
  ...
  this.getSnippetContent = function (objectId, isAAMode, selectedtext) {
    ...
    if (
      ...
      if (params == null) params = new dojo.collections.Dictionary();
  ...
  this.removeSnippet = function (relationshipIds) {
    ...
    return this._makeRequest(action, this.MIMETYPE_PLAIN, null, params);
  };
  ...
  this.addOptionalParam = function (params, key, value) {
    if (value != null && !dojo.lang.isUndefined(value)) params.add(key, value);
  };
  ...
  this.getServerProperties = function () {
    ...
    return this._makeRequest(action, this.MIMETYPE_JSON, null, null);
  };
  ...
  this.getFolderChildren = function (
    ...
    if (isSiteFolder) params.add("sys_slotid", slotid);
    params.add("category", isSiteFolder ? "sites" : "folders");
    return this._makeRequest(action, this.MIMETYPE_JSON, null, params);
  };
  ...
  this.getMaxTimeout = function () {
    ...
    return this._makeRequest(action, this.MIMETYPE_PLAIN, null, null);
  };
  ...
  this.getLocaleCount = function () {
    ...
    var response = this._makeRequest(action, this.MIMETYPE_PLAIN, null, null);
