...
ps.workflow.WorkflowActions = function () {
  ...
  this.executeWorkflowAction = function () {
    ...
    if (
      ...
      response = ps.io.Actions.transitionCheckOutItem(
        this.contentId,
      ...
      response = ps.io.Actions.transitionItem(
        this.contentId,
        this.actionId.getWfAction(),
        this._getComment(),
        this._getAdhocUsers(),
    ...
    this.wfDlg.hide();
    if (this.wfAdhocPane) location.reload();
  };
  ...
  this.handleObjectIdModifications = function (checkOutStatus) {
    ...
    for (var i = 0; i < results.count; i++) {
      ...
      newIds[i] = newId;
      if (result.isSlotNode()) slotIds.push(newId);
    }
    ...
    if (checkOutStatus == 1) {
      ...
      if (slotIds.length > 0) ps.aa.controller.updateTreeWidget();
    }
  };
...
ps.workflow.ActionId = function (idString) {
  ...
  this.equals = function (other) {
    ...
    else return this.idString == other.idString;
  };
