...
ps.content.CreateItem = function () {
  ...
  ((this.init = function (url) {
    ...
    (this._onOK = function () {
      ...
      var tempid =
        this.contentTypeImageData[ctid].templateIds[
      ...
      var newData = {
        sys_contenttypeid: ctid,
        sys_templateid: tempid,
        folderPath: fpath,
        itemPath: null,
        itemTitle: ititle,
      };
  ...
  ((this._initContentType = function () {
    ...
    (this._initTemplateImages = function (ctid) {
      ...
      if (
        ...
        this.contentTypeImageData[ctid]
      ) {
    ...
    (this.open = function (
      ...
      var newUrl = this.url;
      if (slotId != null) newUrl += "?objectId=" + escape(slotId.serialize());
      this.contentTypeImageData = null;
