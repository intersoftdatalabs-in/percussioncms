...
ps.declare(
  ...
  },
  {
      ...
      if (
        ...
        if (response1.isSuccess()) {
          ...
          if (
            ...
            ps.aa.controller.repositionSnippet(
              slotId,
              refRelId,
              newRelId,
              position,
    ...
    _handleTemplateCancel: function () {
      if (!this.isSelectTemplateMode) return true;
      this._maybeRestoreButtonState("okButton");
      this.cancelButton.setCaption(this.CLOSE_LABEL);
      this.setSelectTemplateMode(false);
      return false;
    ...
    _defineRootContentActions: function () {
      var actions = {};
      actions[ps.util.BROWSETAB_SITES_PANEL_PREF] = function () {
        return ps.io.Actions.getSites();
      };
      actions[ps.util.BROWSETAB_FOLDERS_PANEL_PREF] = function () {
    ...
    _setNameImages: function (rows) {
      ...
      var folderImg =
        imgPref +
        this.parent.rxroot +
        '/sys_resources/images/folder.gif"/>&nbsp;';
      var itemImg =
        imgPref +
        this.parent.rxroot +
    ...
    _maybeCreateTemplatesPanel: function () {
      ...
      this.templatesPanel = ps.widget.createWidget("ContentPane", params, div);
    ...
    _setSplitPaneChildVisible: function (splitpane, child, isVisible) {
      ...
      if (isVisible) {
        ...
        if (!alreadyHasChild) splitpane.addChild(child);
      } else {
