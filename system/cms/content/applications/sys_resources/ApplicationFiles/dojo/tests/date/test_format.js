...
function test_date_format() {
  ...
  jum.assertEquals(
    "format_test10",
    "12:55:12",
    dojo.date.format(date, { timePattern: "h:m:s", selector: "timeOnly" })
  );
  jum.assertEquals(
    "format_test11",
    "12:55:12.35",
    dojo.date.format(date, { timePattern: "h:m:s.SS", selector: "timeOnly" })
  );
  jum.assertEquals(
    "format_test12",
    "24:55:12.35",
    dojo.date.format(date, { timePattern: "k:m:s.SS", selector: "timeOnly" })
  );
  jum.assertEquals(
    "format_test13",
    "0:55:12.35",
  ...
  jum.assertEquals(
    "format_test15",
    "11082006",
    dojo.date.format(date, { datePattern: "ddMMyyyy", selector: "dateOnly" })
  );
...
function test_date_strftime() {
  ...
  jum.assertEquals(
    "strftime_test0",
    "06/08/11",
    dojo.date.strftime(date, "%y/%m/%d")
  );
  jum.assertEquals(
    "strftime_test0depr",
    "06/08/11",
    dojo.date.format(date, "%y/%m/%d")
  );
  ...
  jum.assertEquals(
    "strftime_test5",
    res,
    dojo.date.strftime(dt, fmt).substring(0, res.length)
  );
  ...
  jum.assertEquals(
    "strftime_test26",
    res,
    dojo.date.strftime(dt, fmt, "en").substring(0, res.length)
  );
...
function test_date_parse() {
  ...
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("08/11/06", { formatLength: "short", locale: "en" })
  );
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("8/11/06", { formatLength: "short", locale: "en" })
  );
  // Tolerate yyyy input in yy part...
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("8/11/2006", { formatLength: "short", locale: "en" })
  );
  // ...but not in strict mode
  jum.assertEquals(
    name(),
    null,
    dojo.date.parse("8/11/2006", {
      formatLength: "short",
      locale: "en",
      strict: true,
    })
  ...
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("Aug 11, 2006", { formatLength: "medium", locale: "en" })
  );
  jum.assertEquals(
    name(),
    aug_11_2006,
  ...
  jum.assertEquals(
    name(),
    aug_11_06CE,
    dojo.date.parse("Aug 11, 06", { formatLength: "medium", locale: "en" })
  );
  //en: 'long' fmt: MMMM d, yyyy
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("August 11, 2006", { formatLength: "long", locale: "en" })
  );
  ...
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("Friday, August 11, 2006", {
      formatLength: "full",
      locale: "en",
    })
  );
  ...
  jum.assertEquals(
    name(),
    null,
    dojo.date.parse("15/1/2005", { formatLength: "short", locale: "en" })
  );
  //day of month typo rolls over to the next month
  jum.assertEquals(
    name(),
    null,
    dojo.date.parse("Aug 32, 2006", { formatLength: "medium", locale: "en" })
  );
  ...
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("11/08/06", { formatLength: "short", locale: "es" })
  );
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("11/8/06", { formatLength: "short", locale: "es" })
  );
  // Tolerate yyyy input in yy part...
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("11/8/2006", { formatLength: "short", locale: "es" })
  );
  // ...but not in strict mode
  jum.assertEquals(
    name(),
    null,
    dojo.date.parse("11/8/2006", {
      formatLength: "short",
      locale: "es",
      strict: true,
    })
  ...
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("11-ago-06", { formatLength: "medium", locale: "es" })
  );
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("11-ago-2006", { formatLength: "medium", locale: "es" })
  );
  // Tolerate abbreviating period in month part...
  jum.assertEquals(
    name(),
  ...
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("11 de agosto de 2006", {
      formatLength: "long",
      locale: "es",
    })
  );
  ...
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("viernes 11 de agosto de 2006", {
      formatLength: "full",
      locale: "es",
    })
  );
  ...
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("06/08/11", { formatLength: "short", locale: "ja" })
  );
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("06/8/11", { formatLength: "short", locale: "ja" })
  );
  // Tolerate yyyy input in yy part...
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("2006/8/11", { formatLength: "short", locale: "ja" })
  );
  // ...but not in strict mode
  jum.assertEquals(
    name(),
    null,
    dojo.date.parse("2006/8/11", {
      formatLength: "short",
      locale: "ja",
      strict: true,
    })
  ...
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("2006/08/11", { formatLength: "medium", locale: "ja" })
  );
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("2006/8/11", { formatLength: "medium", locale: "ja" })
  );
  //ja: 'long' fmt: yyyy'\u5e74'\u6708'd'\u65e5'
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("2006\u5e748\u670811\u65e5", {
      formatLength: "long",
      locale: "ja",
    })
  );
  ...
  jum.assertEquals(
    name(),
    aug_11_2006,
    dojo.date.parse("2006\u5e74 8\u670811\u65e5 \u91d1\u66dc\u65e5", {
      formatLength: "full",
      locale: "ja",
    })
  );
  ...
  jum.assertEquals(
    ...
    dojo.date.parse("08/11/06 12:30 PM", {
      formatLength: "short",
      selector: "dateTime",
      locale: "en",
    })
  ...
  jum.assertEquals(
    ...
    dojo.date.parse("08/11/06 12:30 AM", {
      formatLength: "short",
      selector: "dateTime",
      locale: "en",
    })
...
function test_time_parse() {
  ...
  jum.assertEquals(
    time.getHours(),
    dojo.date.parse("12:30 PM", tformat).getHours()
  );
  jum.assertEquals(
    time.getMinutes(),
    dojo.date.parse("12:30 PM", tformat).getMinutes()
  );
}
...
function test_date_sql() {
  jum.assertEquals(
    "date.fromSql test",
    new Date("5/1/2006").valueOf(),
    dojo.date.fromSql("2006-05-01 00:00:00").valueOf()
  );
}
