...
function test_date_setDayOfYear() {
  jum.assertEquals(
    "getDayOfYear_test1",
    23,
    dojo.date.setDayOfYear(new Date(2006, 0, 1), 23).getDate()
  );
}
...
function test_date_getDayOfYear() {
  ...
  jum.assertEquals(
    "getDayOfYear_test2",
    32,
    dojo.date.getDayOfYear(new Date(2006, 1, 1))
  );
}
...
function test_date_getDaysInMonth() {
  ...
  jum.assertEquals(
    "getDaysInMonth_test1",
    31,
    dojo.date.getDaysInMonth(new Date(2006, 0, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test2",
    31,
    dojo.date.getDaysInMonth(new Date(2006, 2, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test3",
    30,
    dojo.date.getDaysInMonth(new Date(2006, 3, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test4",
    31,
    dojo.date.getDaysInMonth(new Date(2006, 4, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test5",
    30,
    dojo.date.getDaysInMonth(new Date(2006, 5, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test6",
    31,
    dojo.date.getDaysInMonth(new Date(2006, 6, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test7",
    31,
    dojo.date.getDaysInMonth(new Date(2006, 7, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test8",
    30,
    dojo.date.getDaysInMonth(new Date(2006, 8, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test9",
    31,
    dojo.date.getDaysInMonth(new Date(2006, 9, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test10",
    30,
    dojo.date.getDaysInMonth(new Date(2006, 10, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test11",
    31,
    dojo.date.getDaysInMonth(new Date(2006, 11, 1))
  );

  // Februarys
  jum.assertEquals(
    "getDaysInMonth_test12",
    28,
    dojo.date.getDaysInMonth(new Date(2006, 1, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test13",
    29,
    dojo.date.getDaysInMonth(new Date(2004, 1, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test14",
    29,
    dojo.date.getDaysInMonth(new Date(2000, 1, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test15",
    28,
    dojo.date.getDaysInMonth(new Date(1900, 1, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test16",
    28,
    dojo.date.getDaysInMonth(new Date(1800, 1, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test17",
    28,
    dojo.date.getDaysInMonth(new Date(1700, 1, 1))
  );
  jum.assertEquals(
    "getDaysInMonth_test18",
    29,
    dojo.date.getDaysInMonth(new Date(1600, 1, 1))
  );
}
...
function test_date_isLeapYear() {
  jum.assertFalse(
    "isLeapYear_test1",
    dojo.date.isLeapYear(new Date(2006, 0, 1))
  );
  jum.assertTrue(
    "isLeapYear_test2",
    dojo.date.isLeapYear(new Date(2004, 0, 1))
  );
  jum.assertTrue(
    "isLeapYear_test3",
    dojo.date.isLeapYear(new Date(2000, 0, 1))
  );
  jum.assertFalse(
    "isLeapYear_test4",
    dojo.date.isLeapYear(new Date(1900, 0, 1))
  );
  jum.assertFalse(
    "isLeapYear_test5",
    dojo.date.isLeapYear(new Date(1800, 0, 1))
  );
  jum.assertFalse(
    "isLeapYear_test6",
    dojo.date.isLeapYear(new Date(1700, 0, 1))
  );
  jum.assertTrue(
    "isLeapYear_test7",
    dojo.date.isLeapYear(new Date(1600, 0, 1))
  );
}
...
function test_date_getTimezoneName() {
  ...
  jum.assertEquals(
    "getTimezoneName_test1",
    "CDT",
    dojo.date.getTimezoneName(dt)
  );
...
function test_date_getOrdinal() {
  jum.assertEquals(
    "getOrdinal_test1",
    "st",
    dojo.date.getOrdinal(new Date(2006, 0, 1))
  );
  jum.assertEquals(
    "getOrdinal_test2",
    "nd",
    dojo.date.getOrdinal(new Date(2006, 0, 2))
  );
  jum.assertEquals(
    "getOrdinal_test3",
    "rd",
    dojo.date.getOrdinal(new Date(2006, 0, 3))
  );
  jum.assertEquals(
    "getOrdinal_test4",
    "th",
    dojo.date.getOrdinal(new Date(2006, 0, 4))
  );
  jum.assertEquals(
    "getOrdinal_test5",
    "th",
    dojo.date.getOrdinal(new Date(2006, 0, 11))
  );
  jum.assertEquals(
    "getOrdinal_test6",
    "th",
    dojo.date.getOrdinal(new Date(2006, 0, 12))
  );
  jum.assertEquals(
    "getOrdinal_test7",
    "th",
    dojo.date.getOrdinal(new Date(2006, 0, 13))
  );
  jum.assertEquals(
    "getOrdinal_test8",
    "th",
    dojo.date.getOrdinal(new Date(2006, 0, 14))
  );
  jum.assertEquals(
    "getOrdinal_test9",
    "st",
    dojo.date.getOrdinal(new Date(2006, 0, 21))
  );
  jum.assertEquals(
    "getOrdinal_test10",
    "nd",
    dojo.date.getOrdinal(new Date(2006, 0, 22))
  );
  jum.assertEquals(
    "getOrdinal_test11",
    "rd",
    dojo.date.getOrdinal(new Date(2006, 0, 23))
  );
  jum.assertEquals(
    "getOrdinal_test12",
    "th",
    dojo.date.getOrdinal(new Date(2006, 0, 24))
  );
}
...
function test_date_compare() {
  ...
  jum.assertEquals(
    "compare_test2",
    1,
    dojo.date.compare(d1, d2, dojo.date.compareTypes.DATE)
  );
  jum.assertEquals(
    "compare_test3",
    -1,
    dojo.date.compare(d2, d1, dojo.date.compareTypes.DATE)
  );
  jum.assertEquals(
    "compare_test4",
    -1,
    dojo.date.compare(d1, d2, dojo.date.compareTypes.TIME)
  );
  jum.assertEquals(
    "compare_test5",
    1,
