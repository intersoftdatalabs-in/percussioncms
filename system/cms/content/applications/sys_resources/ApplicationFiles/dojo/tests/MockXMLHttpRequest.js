...
tests.MockXMLHttpRequest = function (
  responseText,
  ...
  this._finish = function () {
    ...
    this.status = 200;
    this.statusText = "OK";
    if (this._responseFunc) this.responseText = this._responseFunc(this);
...
tests.MockXMLHttpRequest.set = function (
  responseTextOrFunc,
  /* milliseconds */ responseTime,
  responseXml
) {
  ...
  dojo.hostenv.getXmlhttpObject = function () {
    return new tests.MockXMLHttpRequest(
      responseTextOrFunc,
      responseTime,
      responseXml
    );
...
tests.MockXMLHttpRequest.wrap = function (
  scope,
  func,
  responseTextOrFunc,
  responseTime,
  ...
  var aroundFunc = function (invocation) {
    ...
    try {
      ...
      if (!disconnectHack) tests.MockXMLHttpRequest.restore();
      disconnectHack = true;
    }
    return result;
  };
