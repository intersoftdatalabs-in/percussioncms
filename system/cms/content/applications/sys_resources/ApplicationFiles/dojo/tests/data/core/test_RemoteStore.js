...
function _test_data_core_newStore() {
  return new dojo.data.core.RemoteStore({
    queryUrl: "http://ignored/?query=",
    saveUrl: "http://ignored/save",
  });
}
...
function _test_data_core_load_movies(remoteStore, sync, kwArgs) {
  var dataString =
    '{ "data" : { "1" :{ "Title": ["City of God"],	 "Year" : [2002], "Producer" : ["Katia Lund"] }, "2" :{ "Title" : ["Rain"], "Year" : [2001],	"Producer" : ["Christine Jeffs"] } } }';
