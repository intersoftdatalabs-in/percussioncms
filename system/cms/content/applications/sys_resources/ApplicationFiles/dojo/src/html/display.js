...
dojo.html.hide = function (/* HTMLElement */ node) {
  ...
  if (typeof node["dojoDisplayCache"] == "undefined") {
    // it could == '', so we cannot say !node.dojoDisplayCount
...
dojo.html.setDisplay = function (/* HTMLElement */ node, /* string */ display) {
  ...
  dojo.html.setStyle(
    node,
    "display",
    display instanceof String || typeof display == "string"
      ? display
      : display
...
dojo.html.setVisibility = function (
  /* HTMLElement */ node,
  /* string */ visibility
) {
  //	summary
  ...
  dojo.html.setStyle(
    node,
    "visibility",
    visibility instanceof String || typeof visibility == "string"
      ? visibility
      : visibility
      ? "visible"
      : "hidden"
...
dojo.html.setOpacity = function (
  /* HTMLElement */ node,
  /* float */ opacity,
  /* boolean? */ dontFixOpacity
) {
  //	summary
