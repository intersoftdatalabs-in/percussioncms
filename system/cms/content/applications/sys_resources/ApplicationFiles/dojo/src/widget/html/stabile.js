...
dojo.widget.html.stabile.commit = function (state) {
  ...
  dojo.widget.html.stabile._getStorage().value =
    dojo.widget.html.stabile.description(state);
};
...
dojo.widget.html.stabile.description = function (v, showAll) {
  ...
  try {
    ...
    if (v instanceof Array || v.push) {
      ...
      if (depth >= dojo.widget.html.stabile.depthLimit) return "[ ... ]";
