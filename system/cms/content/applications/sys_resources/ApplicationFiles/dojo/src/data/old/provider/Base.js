...
dojo.data.old.provider.Base.prototype.newItem = function (
  /* string */ itemName
) {
  /**
   * Creates a new item.
...
dojo.data.old.provider.Base.prototype.newAttribute = function (
  /* string */ attributeId
) {
  /**
...
dojo.data.old.provider.Base.prototype.getAttribute = function (
  /* string */ attributeId
) {
...
dojo.data.old.provider.Base.prototype.noteChange = function (
  /* dojo.data.old.Item */ item,
  /* string or dojo.data.old.Attribute */ attribute,
  /* anything */ value
) {
...
dojo.data.old.provider.Base.prototype.addItemObserver = function (
  /* dojo.data.old.Item */ item,
  /* object */ observer
) {
  /**
...
dojo.data.old.provider.Base.prototype.removeItemObserver = function (
  /* dojo.data.old.Item */ item,
  /* object */ observer
) {
  /**
...
dojo.data.old.provider.Base.prototype._newAttribute = function (
  /* String */ attributeId
) {
...
dojo.data.old.provider.Base.prototype._notifyObserversOfChanges = function (
  /* Array */ arrayOfChanges
) {
