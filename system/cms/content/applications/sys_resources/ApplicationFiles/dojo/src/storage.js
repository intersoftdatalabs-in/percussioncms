...
dojo.declare("dojo.storage", null, {
  ...
  isValidKey: function (/*string*/ keyName) {
    /*Boolean*/
    // summary:
...
dojo.storage.manager = new (function () {
  ...
  this.autodetect = function () {
    ...
    for (var i = 0; i < this._providers.length; i++) {
      ...
      if (
        dojo.lang.isUndefined(djConfig["forceStorageProvider"]) == false &&
        ...
        dojo.lang.isUndefined(djConfig["forceStorageProvider"]) == true &&
        providerToUse.isAvailable()
      ) {
        break;
      }
  ...
  this.supportsProvider = function (/*string*/ storageClass) {
    ...
    try {
      ...
      if (results == null || typeof results == "undefined") return false;
      return results;
    } catch (exception) {
      return false;
    }
