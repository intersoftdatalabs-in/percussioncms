...
dojo.regexp.host = function (/*Object?*/ flags) {
  ...
  var domainNameRE =
    ...
    dojo.regexp.tld(flags);

  // port number RE
  var portRE = flags.allowPort
...
dojo.regexp.currency = function (/*Object?*/ flags) {
  ...
  if (
    typeof flags.fractional == "undefined" &&
    typeof flags.cents != "undefined"
  ) {
    dojo.deprecated(
...
dojo.regexp.buildGroupRE = function (
  /*value or Array of values*/ a,
  /*Function(x) returns a regular expression as a String*/ re
) {
