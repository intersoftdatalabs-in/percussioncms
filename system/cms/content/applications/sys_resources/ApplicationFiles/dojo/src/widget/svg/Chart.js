...
dojo.widget.defineWidget(
  ...
  },
  {
    ...
    drawPlotArea: function () {
      ...
      rect.setAttribute(
        ...
        this.properties.width -
          this.properties.padding.left -
          this.properties.padding.right
      );
      rect.setAttribute(
        "height",
        this.properties.height -
          this.properties.padding.top -
          this.properties.padding.bottom
      );
    ...
    drawDataGroup: function () {
      ...
      this.dataGroup.setAttribute(
        "style",
        "clip-path:url(#plotClip" + this.widgetId + ");"
      );
    ...
    drawAxes: function () {
      ...
      var y = dojo.widget.svg.Chart.Plotter.getY(
        this.properties.axes.x.plotAt,
        this
      );
      ...
      line.setAttribute(
        "x2",
        this.properties.width - this.properties.padding.right
      );
      ...
      text.setAttribute(
        "y",
        this.properties.height - this.properties.padding.bottom + textSize + 2
      );
      text.setAttribute(
        "style",
        "text-anchor:middle;font-size:" + textSize + "px;fill:#000;"
      );
      text.appendChild(
        document.createTextNode(
          dojo.math.round(parseFloat(this.properties.axes.x.range.min), 2)
        )
      );
      ...
      text.setAttribute(
        "x",
        this.properties.width - this.properties.padding.right - textSize / 2
      );
      text.setAttribute(
        "y",
        this.properties.height - this.properties.padding.bottom + textSize + 2
      ...
      text.appendChild(
        document.createTextNode(
          dojo.math.round(parseFloat(this.properties.axes.x.range.max), 2)
        )
      );
      this.axisGroup.appendChild(text);
      ...
      //	y axis
      var line = document.createElementNS(dojo.svg.xmlns.svg, "line");
      var x = dojo.widget.svg.Chart.Plotter.getX(
        this.properties.axes.y.plotAt,
        this
      );
      ...
      line.setAttribute(
        "y2",
        this.properties.height - this.properties.padding.bottom
      );
      line.setAttribute("style", "stroke:#000;stroke-width:" + stroke + ";");
      this.axisGroup.appendChild(line);
      ...
      text.setAttribute(
        "style",
        "text-anchor:end;font-size:" + textSize + "px;fill:#000;"
      );
      text.appendChild(
        document.createTextNode(
          dojo.math.round(parseFloat(this.properties.axes.y.range.min), 2)
        )
      );
      this.axisGroup.appendChild(text);
      ...
      text.appendChild(
        document.createTextNode(
          dojo.math.round(parseFloat(this.properties.axes.y.range.max), 2)
        )
      );
      this.axisGroup.appendChild(text);
      dojo.svg.g.resume();
    ...
    init: function () {
      ...
      if (!this.properties.width || !this.properties.height) {
        ...
        if (!this.properties.width) {
          this.properties.width =
            box.width < 32 ? this.properties.defaultWidth : box.width;
        }
        if (!this.properties.height) {
          this.properties.height =
            box.height < 32 ? this.properties.defaultHeight : box.height;
        }
      }
    ...
    postCreate: function () {
      ...
      if (table) {
        ...
        if (!bRangeX) {
          this.properties.axes.x.range = {
            min: axisValues.x.min,
            max: axisValues.x.max,
          };
        }
        if (!bRangeY) {
          this.properties.axes.y.range = {
            min: axisValues.y.min,
...
dojo.widget.svg.Chart.Plotter = new (function () {
  ...
  this.plot = function (
    /* dojo.widget.Chart.DataSeries */ series,
    /* dojo.widget.Chart */ chart
  ) {
    //	summary
  ...
  (plotters["area"] = function (
    ...
    (plotters["scatter"] = function (
      ...
      for (var i = 0; i < series.values.length; i++) {
        ...
        point.setAttribute(
          "title",
          series.label + ": " + series.values[i].value
        );
        point.setAttribute(
          "d",
          "M " +
  ...
  plotters["bubble"] = function (
    ...
    for (var i = 0; i < series.values.length; i++) {
      ...
      point.setAttribute(
        "title",
        series.label + ": " + series.values[i].value + " (" + size + ")"
      );
      chart.dataGroup.appendChild(point);
    }
  };
