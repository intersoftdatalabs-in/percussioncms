...
dojo.svg.getNumericStyle = function (
  /* SVGElement */ node,
  /* string */ cssSelector
) {
  //	summary
...
dojo.svg.translate = function (
  ...
  if (
    ...
    node.ownerSVGElement.createSVGTransform
  ) {
...
dojo.svg.getGroup = function (/* SVGElement */ node) {
  ...
  for (var i = 0; i < a.length; i++) {
    if (
      a[i].nodeType == this.ELEMENT_NODE &&
