...
dojo.widget.defineWidget(
  ...
  },
  {
    ...
    splitAndFixPaths: function (s, url) {
      ...
      if (s) {
        // make sure we dont run regexes on empty content
        ...
        while ((match = regex.exec(s))) {
          ...
          s =
            ...
            s.substr(match.index + match[0].length);
        }
        ...
        while ((match = regex.exec(s))) {
          ...
          s =
            s.substr(0, match.index) + s.substr(match.index + match[0].length);
        }
