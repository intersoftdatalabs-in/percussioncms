...
dojo.gfx.color.rgb2hsv = function (
  /* int || Array */ r,
  /* int */ g,
  /* int */ b,
  /* Object? */ options
  ...
  var opt = {
    ...
    outputRange:
      options && options.outputRange ? options.outputRange : [255, 255, 255],
  };
...
dojo.gfx.color.hsv2rgb = function (
  /* int || Array */ h,
  /* int */ s,
  /* int */ v,
  /* Object? */ options
  ...
  var opt = {
    inputRange:
      options && options.inputRange ? options.inputRange : [255, 255, 255],
