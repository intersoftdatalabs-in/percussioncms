...
dojo.lang.extend(dojo.io.Request, {
  ...
  load: function (
    /*String*/ type,
    /*Object*/ data,
    /*Object*/ transportImplementation,
    /*Object*/ kwArgs
  ) {
    // summary:
  ...
  fromKwArgs: function (/*Object*/ kwArgs) {
    ...
    kwArgs.sendTransport = dojo.lang.firstValued(
  ...
  if (request["transport"]) {
    ...
    if (!this[tsName]) {
      dojo.io.sendBindError(
        request,
        "No dojo.io.bind() transport with name '" + request["transport"] + "'."
      );
