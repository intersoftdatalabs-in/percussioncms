...
dojo.data.old.format.Json = new (function () {
  ...
  // Public functions
  // -------------------------------------------------------------------
  this.loadDataProviderFromFileContents = function (
    /* dojo.data.old.provider.Base */ dataProvider,
  ...
  this.loadDataProviderFromArrayOfJsonData = function (
    /* dojo.data.old.provider.Base */ dataProvider,
    /* Array */ arrayOfJsonData
  ) {
  ...
  this.getJsonStringFromResultSet = function (
    /* dojo.data.old.ResultSet */ resultSet
  ) {
  ...
  // Private functions
  // -------------------------------------------------------------------
  function _loadDataProviderFromArrayOfArrays(
    /* dojo.data.old.provider.Base */ dataProvider,
    /* Array */ arrayOfJsonData
  ) {
    /**
  ...
  function _loadDataProviderFromArrayOfObjects(
    /* dojo.data.old.provider.Base */ dataProvider,
    /* Array */ arrayOfJsonData
  ) {
    /**
