...
dojo.widget.SvgButton = function () {
  ...
  this.setLabel = function (x, y, textSize, label, shape) {
    ...
    var coords = dojo.widget.SvgButton.prototype.coordinates(
      x,
      y,
      textSize,
      label,
...
// FIXME
dojo.widget.SvgButton.prototype.shapeString = function (
  x,
  y,
  textSize,
  label,
...
dojo.widget.SvgButton.prototype.coordinates = function (
  x,
  y,
  textSize,
  label,
...
dojo.widget.SvgButton.prototype.labelString = function (
  x,
  y,
  textSize,
  label,
...
dojo.widget.SvgButton.prototype.templateString = function (
  x,
  y,
  textSize,
  label,
  ...
  return (
    "<g class='dojoButton' dojoAttachEvent='onClick; onMouseMove: onFoo;' dojoAttachPoint='labelNode'>" +
    dojo.widgets.SVGButton.prototype.shapeString(x, y, textSize, label, shape) +
    dojo.widget.SVGButton.prototype.labelString(x, y, textSize, label, shape) +
    "</g>"
  );
};
