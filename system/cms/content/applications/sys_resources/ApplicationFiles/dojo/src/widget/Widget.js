...
dojo.declare(
  ...
  },
  {
    ...
    mixInProperties: function (args, /*Object*/ frag) {
      ...
      for (var x in args) {
        if (!this[x]) {
          // check the cache for properties
        ...
        if (typeof this[x] != typeof undef) {
          if (typeof args[x] != "string") {
            ...
            } else if (dojo.lang.isArray(this[x])) {
              // typeof [] == "object"
              this[x] = args[x].split(";");
              ...
              if (this[x] instanceof dojo.uri.Uri) {
                ...
                for (var y = 0; y < pairs.length; y++) {
                  ...
                  if (si != -1 && pairs[y].length > si) {
                    this[x][pairs[y].substr(0, si).replace(/^\s+|\s+$/g, "")] =
                      pairs[y].substr(si + 1);
                  }
                }
              }
...
dojo.widget.tags["dojo:propertyset"] = function (
  fragment,
  widgetParser,
  parentComp
) {
...
dojo.widget.tags["dojo:connect"] = function (
  fragment,
  widgetParser,
  parentComp
) {
...
dojo.widget.buildWidgetFromParseTree = function (
  ...
  var localProperties =
    localProps || parser.parseProperties(frag[frag["ns"] + ":" + stype]);
  var twidget = dojo.widget.manager.getImplementation(
    stype,
    null,
    null,
    frag["ns"]
...
dojo.widget.defineWidget = function (
  widgetClass,
  renderer,
  superclasses,
  init,
...
dojo.widget._defineWidget = function (
  widgetClass /*string*/,
  renderer /*string*/,
  superclasses /*function||array*/,
  init /*function*/,
  props /*object*/
) {
