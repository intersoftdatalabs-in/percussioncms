...
dojo.date.setIso8601Date = function (
  /*String*/ dateObject,
  /*String*/ formattedString
) {
...
dojo.date.setIso8601Time = function (
  /*Date*/ dateObject,
  /*String*/ formattedString
) {
  ...
  if (d) {
    ...
    formattedString = formattedString.substr(
      0,
      formattedString.length - d[0].length
    );
  }
...
dojo.date.toRfc3339 = function (/*Date?*/ dateObject, /*String?*/ selector) {
  ...
  if (selector != "timeOnly") {
    var date = [
      _(dateObject.getFullYear(), 4),
      _(dateObject.getMonth() + 1, 2),
      _(dateObject.getDate(), 2),
    ].join("-");
    formattedDate.push(date);
  }
  if (selector != "dateOnly") {
    var time = [
      _(dateObject.getHours(), 2),
      _(dateObject.getMinutes(), 2),
      _(dateObject.getSeconds(), 2),
    ].join(":");
