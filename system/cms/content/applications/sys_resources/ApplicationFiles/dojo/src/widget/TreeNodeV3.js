  ...
  },
  {
    ...
    setFolder: function () {
      ...
      if (!this.containerNode) {
        // maybe this node was unfolderized and still has container
        ...
        while ((elem = stack.pop())) {
          for (var i = 0; i < elem.childNodes.length; i++) {
            ...
            dojo.html.setClass(
              ...
              dojo.html
                .getClass(childNode)
                .replace(reg, "$1" + newTree.classPrefix)
            );
    ...
    addedTo: function (parent, index, dontPublishEvent) {
      ...
      if (siblingsCount > 1) {
        ...
        if (
          ...
          parent.children[siblingsCount - 2] instanceof dojo.widget.Widget
        ) {
    ...
    createSimple: function (args, parent) {
      ...
      treeNode.toggleObj =
        dojo.lfx.toggle[treeNode.toggle.toLowerCase()] || dojo.lfx.toggle.plain;
	...
	*/
    ...
    viewSetExpand: function () {
      ...
      dojo.html.setClass(
        this.domNode,
        dojo.html.getClass(this.domNode).replace(reg, "") + " " + expand
      );
    ...
    viewSetHasChildren: function () {
      ...
      dojo.html.setClass(
        this.domNode,
        dojo.html.getClass(this.domNode).replace(reg, "") + " " + clazz
      );
    ...
    doDetach: function () {
      ...
      if (siblingsCount > 0) {
        if (index == 0) {
          // deleted first node => update new first
