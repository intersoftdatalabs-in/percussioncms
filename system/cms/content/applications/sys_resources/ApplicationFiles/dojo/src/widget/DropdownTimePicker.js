...
dojo.widget.defineWidget(
  ...
  dojo.widget.DropdownContainer,
  {
    ...
    postMixInProperties: function () {
      ...
      dojo.widget.DropdownTimePicker.superclass.postMixInProperties.apply(
        this,
        arguments
      );
      var messages = dojo.i18n.getLocalization(
        "dojo.widget",
        "DropdownTimePicker",
        this.lang
      );
      ...
      if (this.value && isNaN(this.value)) {
        ...
        if (!this.value) {
          var d = dojo.date.format(new Date(), {
            selector: "dateOnly",
          ...
          dojo.deprecated(
            "dojo.widget.DropdownTimePicker",
            "time attributes must be passed in Rfc3339 format",
            "0.5"
          );
        }
      }
    ...
    fillInTemplate: function () {
      ...
      dojo.widget.DropdownTimePicker.superclass.fillInTemplate.apply(
        this,
        arguments
      );
      ...
      this.timePicker = dojo.widget.createWidget(
        "TimePicker",
        tpArgs,
        this.containerNode,
        "child"
    ...
    _updateText: function () {
      ...
      if (this.timePicker.selectedTime.anyTime) {
        ...
        dojo.deprecated(
          "dojo.widget.DropdownTimePicker",
          "Must use displayFormat attribute instead of timeFormat.  See dojo.date.format for specification.",
          "0.5"
        );
