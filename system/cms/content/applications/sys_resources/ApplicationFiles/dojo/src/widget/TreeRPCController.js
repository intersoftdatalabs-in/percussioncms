...
dojo.widget.defineWidget(
  ...
  dojo.widget.TreeLoadingController,
  {
    ...
    doMove: function (child, newParent, index) {
      ...
      this.runRPC({
        ...
        load: function (response) {
          success = this.doMoveProcessResponse(
            response,
            child,
            newParent,
            index
    ...
    doMoveProcessResponse: function (response, child, newParent, index) {
      ...
      return dojo.widget.TreeLoadingController.prototype.doMove.apply(
        this,
        args
      );
    },
    ...
    doRemoveNodeProcessResponse: function (response, node, callObj, callFunc) {
      ...
      if (response == true) {
        ...
        dojo.widget.TreeLoadingController.prototype.doRemoveNode.apply(
          this,
          args
        );
    ...
    doCreateChild: function (parent, index, output, callObj, callFunc) {
      ...
      this.runRPC({
        ...
        load: function (response) {
          ...
          this.doCreateChildProcessResponse(
            response,
            parent,
            index,
            callObj,
    ...
    doCreateChildProcessResponse: function (
      response,
      parent,
      index,
      callObj,
      ...
      dojo.widget.TreeLoadingController.prototype.doCreateChild.apply(
        this,
        args
      );
    },
