...
dojo.xml.XslTransform = function (/*String*/ xsltUri) {
  ...
  dojo.debug(
    "XslTransform is supported by Internet Explorer and Mozilla, with limited support in Opera 9 (no document function support)."
  );
  ...
  this.transformToContentPane = function (
    /*XMLDocument*/ xmlDoc,
    /*2 Dimensional Array*/ params,
  ...
  this.transformToRegion = function (
    /*XMLDocument*/ xmlDoc,
    /*2 Dimensional Array*/ params,
    /*HTMLElement*/ region,
    /*HTMLDocument*/ parentDoc
  ...
  this.transformToWindow = function (
    /*XMLDocument*/ xmlDoc,
    /*2 Dimensional Array*/ params,
