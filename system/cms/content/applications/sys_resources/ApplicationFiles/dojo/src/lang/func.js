...
dojo.lang.hitch = function (
  ...
  var fcn =
    (dojo.lang.isString(method) ? thisObject[method] : method) ||
    function () {};
  return function () {
...
dojo.lang.nameAnonFunc = function (
  /*Function*/ anonFuncPtr,
  /*Object*/ thisObj,
  /*Boolean*/ searchForNames
) {
  // summary:
...
dojo.lang.curry = function (thisObj, func /* args ... */) {
  ...
  function gather(nextArgs, innerArgs, expected) {
    ...
    if (expected <= 0) {
      ...
      return function () {
        return gather(
          arguments, // check to see if we've been run
          // with enough args
          totalArgs, // a copy
          expected
        ); // how many more do we need to run?;
      };
    }
  }
...
dojo.lang.curryArguments = function (
  /*Object*/ thisObj,
  /*Function*/ func,
  /*Array*/ args,
