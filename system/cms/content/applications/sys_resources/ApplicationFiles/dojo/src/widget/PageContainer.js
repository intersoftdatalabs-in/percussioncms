...
dojo.widget.defineWidget("dojo.widget.PageController", dojo.widget.HtmlWidget, {
  ...
  onKey: function (/*Event*/ evt) {
    ...
    if (
      evt.keyCode == evt.KEY_RIGHT_ARROW ||
      ...
      if (evt.keyCode == evt.KEY_RIGHT_ARROW) {
        ...
        next =
          this.children[
            (current + (this.children.length - 1)) % this.children.length
          ];
      }
...
dojo.widget.defineWidget("dojo.widget.PageButton", dojo.widget.HtmlWidget, {
  ...
  focus: function () {
    ...
    if (this.titleNode.focus) {
      // mozilla 1.7 doesn't have focus() func
