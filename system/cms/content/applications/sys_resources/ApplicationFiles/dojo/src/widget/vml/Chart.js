...
dojo.widget.defineWidget(
  ...
  },
  {
    ...
    drawPlotArea: function () {
      ...
      this.plotArea.style.clip =
        "rect(0 " + plotWidth + " " + plotHeight + " 0)";
    ...
    drawAxes: function () {
      ...
      var y = dojo.widget.vml.Chart.Plotter.getY(
      ...
      //	y axis
      var line = document.createElement("v:line");
      var x = dojo.widget.vml.Chart.Plotter.getX(
      ...
      t.style.top =
        this.properties.height - this.properties.padding.bottom + "px";
      t.style.left = this.properties.padding.left + "px";
      t.style.fontFamily = "sans-serif";
      t.style.fontSize = size + "px";
      t.innerHTML = dojo.math.round(
        parseFloat(this.properties.axes.x.range.min),
        2
      );
      ...
      t.style.top =
        this.properties.height - this.properties.padding.bottom + "px";
      t.style.left =
        this.properties.width - this.properties.padding.right - size + "px";
      t.style.fontFamily = "sans-serif";
      t.style.fontSize = size + "px";
      t.innerHTML = dojo.math.round(
        parseFloat(this.properties.axes.x.range.max),
        2
      );
      this.vectorNode.appendChild(t);
      ...
      t.style.fontSize = size + "px";
      t.innerHTML = dojo.math.round(
        parseFloat(this.properties.axes.y.range.max),
        2
      );
      this.vectorNode.appendChild(t);
      ...
      t.style.position = "absolute";
      t.style.top =
        this.properties.height - this.properties.padding.bottom - size + "px";
      t.style.left = "0px";
      t.style.width = this.properties.padding.left + "px";
      t.style.textAlign = "right";
      t.style.paddingRight = "4px";
      ...
      t.style.fontSize = size + "px";
      t.innerHTML = dojo.math.round(
        parseFloat(this.properties.axes.y.range.min),
        2
      );
      this.vectorNode.appendChild(t);
    },
...
dojo.widget.vml.Chart.Plotter = new (function () {
  ...
  this.getX = function (
    ...
    var xmin = 0;
    var xmax =
      chart.properties.width -
      chart.properties.padding.left -
      chart.properties.padding.right;
  ...
  this.getY = function (
    ...
    var ymin =
      chart.properties.height -
      chart.properties.padding.top -
  ...
  plotters["bar"] = function (
    ...
    for (var i = 0; i < series.values.length; i++) {
      ...
      bar.setAttribute(
        "title",
        series.label + " (" + i + "): " + series.values[i].value
      );
  ...
  plotters["line"] = function (
    ...
    line.setAttribute(
      "coordsize",
      chart.properties.width + "," + chart.properties.height
    );
    line.style.position = "absolute";
    line.style.top = "0px";
    line.style.left = "0px";
