 ...
 **/
dojo.i18n.currency.format = function (
  value,
  iso,
  flags /*optional*/,
  locale /*optional*/
  ...
  var formatData = dojo.i18n.currency._mapToLocalizedFormatData(
  ...
  if (value < 0) {
    if (formatData.signPlacement == "around") {
      ...
      !formatData.signPlacement ||
      formatData.signPlacement == "begin"
    ) {
      result = "-" + result;
    }
  }
...
dojo.i18n.currency.parse = function (value, iso, locale, flags /*optional*/) {
  ...
  if (
    flags.validate &&
    !dojo.i18n.number.isCurrency(value, iso, locale, flags)
  ) {
    return Number.NaN;
  }
...
*/
dojo.i18n.currency.isCurrency = function (
  value,
  iso,
  locale /*optional*/,
  flags
  ...
  var numberFormatData = dojo.i18n.number._mapToLocalizedFormatData(
...
dojo.i18n.currency._mapToLocalizedFormatData = function (
  table,
  iso,
  locale /*optional*/
) {
...
(function () {
  ...
  dojo.i18n.currency.FORMAT_TABLE = {
    ...
    ATS: {
      ...
      signPlacement: "after",
      htmlSymbol: "&euro;",
    }, //Austria using "EUR" // neg should read euro + sign + space + number
    AUD: { symbol: "$" },
    BOB: { symbol: "$b" },
