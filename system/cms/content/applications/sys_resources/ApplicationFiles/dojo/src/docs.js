...
dojo.lang.mixin(dojo.docs, {
  ...
  getFunctionMeta: function (/*Object*/ input) {
    ...
    if (package) {
      return this.require(
        package + "/meta/functions/" + name + "/" + id + "/meta"
      );
    } else {
  ...
  getFunctionDocumentation: function (/*Object*/ input) {
    ...
    if (package) {
      return this.require(
        package + "/meta/functions/" + name + "/" + id + "/documentation"
      );
    }
  },
  ...
  _onDocSelectFunction: function (/*Object*/ input) {
    ...
    var doc = this.getFunctionDocumentation({
      package: package,
      name: name,
      id: id,
    });
  ...
  savePackage: function (
    ...
    dojo.docs._rpc
      .callRemote("saveForm", props)
      .addCallbacks(dojo.docs._pkgRpc, dojo.docs._pkgRpc);
  },
...
dojo.event.topic.registerPublisher(
  ...
  dojo.docs,
  "_printFunctionResults"
);
dojo.event.topic.registerPublisher(
  "/docs/function/detail",
  dojo.docs,
  "_printFunctionDetail"
);
dojo.event.topic.registerPublisher(
  "/docs/package/detail",
  dojo.docs,
