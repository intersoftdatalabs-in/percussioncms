...
dojo.widget.defineWidget(
  ...
  dojo.widget.HtmlWidget,
  {
    ...
    postCreate: function () {
      ...
      this.demoContainer = dojo.widget.createWidget(
        "DemoContainer",
    ...
    returnToDemos: function () {
      ...
      dojo.lang.forEach(
        ...
        dojo.lang.hitch(this, function (child) {
          child.checkSize();
        })
      );
    ...
    processRegistry: function (type, registry, e) {
      ...
      dojo.lang.forEach(
        ...
        dojo.lang.hitch(this, this.addCategory)
      );
    },
    ...
    onSelectCategory: function (e) {
      ...
      dojo.lang.forEach(
        this.registry.categories[catName].demos,
        dojo.lang.hitch(this, function (demoName) {
    ...
    onSelectDemo: function (e) {
      ...
      this.demoContainer.setSummary(
        this.registry.definitions[e.target.name].description
      );
    },
  },
  "",
