...
dojo.widget.defineWidget(
  ...
  dojo.widget.ValidationTextbox,
  {
    ...
    mixInProperties: function (/*Object*/ localProperties) {
      ...
      dojo.widget.IpAddressTextbox.superclass.mixInProperties.apply(
        this,
        arguments
      );
      ...
      if (localProperties.allowdotteddecimal) {
        this.flags.allowDottedDecimal =
          localProperties.allowdotteddecimal == "true";
      }
      ...
      if (localProperties.allowdottedoctal) {
        this.flags.allowDottedOctal =
          localProperties.allowdottedoctal == "true";
      }
...
dojo.widget.defineWidget("dojo.widget.EmailTextbox", dojo.widget.UrlTextbox, {
  // summary:
...
dojo.widget.defineWidget(
  ...
  dojo.widget.EmailTextbox,
  {
    ...
    mixInProperties: function (/*Object*/ localProperties) {
      ...
      // First initialize properties in super-class.
      dojo.widget.EmailListTextbox.superclass.mixInProperties.apply(
        this,
        arguments
      );
