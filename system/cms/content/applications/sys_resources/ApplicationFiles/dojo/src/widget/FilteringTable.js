    ...
    parseMetadata: function (/* HTMLTableHead */ head) {
      ...
      for (var i = 0; i < cells.length; i++) {
        ...
        if (dojo.html.hasAttribute(cells[i], "dataType")) {
          ...
          if (
            sortType.toLowerCase() == "html" ||
            sortType.toLowerCase() == "markup"
          ) {
    ...
    fillCell: function (
      ...
      if (meta.sortType == "__markup__") {
        ...
        if (meta.getType() == Date) {
          ...
          "Number number int Integer float Float".indexOf(meta.sortType) > -1
        ) {
