...
dojo.widget.defineWidget(
  ...
  dojo.widget.PageContainer,
  {
    ...
    postMixInProperties: function () {
      if (this.selectedTab) {
        dojo.deprecated(
          "selectedTab deprecated, use selectedChild instead, will be removed in",
          "0.5"
        );
      ...
      if (this.closeButton != "none") {
        dojo.deprecated(
          "closeButton deprecated, use closable='true' on each child instead, will be removed in",
          "0.5"
        );
      }
      dojo.widget.TabContainer.superclass.postMixInProperties.apply(
        this,
        arguments
      );
    },
    ...
    fillInTemplate: function () {
      ...
      this.tablist = dojo.widget.createWidget(
        "TabController",
        {
    ...
    onResized: function () {
      ...
      if (this.selectedChildWidget) {
        ...
        this.selectedChildWidget.resizeTo(
          containerSize.width,
    ...
    selectTab: function (tab, callingWidget) {
      dojo.deprecated(
        "use selectChild() rather than selectTab(), selectTab() will be removed in",
        "0.5"
      );
    ...
    onKey: function (e) {
      ...
      if (e.keyCode == e.KEY_UP_ARROW && e.ctrlKey) {
        ...
        var button =
          this.correspondingTabButton || this.selectedTabWidget.tabButton;
        button.focus();
    ...
    postMixInProperties: function () {
      if (!this["class"]) {
        this["class"] =
          "dojoTabLabels-" +
          this.labelPosition +
          (this.doLayout ? "" : " dojoTabNoLayout");
      }
      dojo.widget.TabController.superclass.postMixInProperties.apply(
        this,
        arguments
      );
    },
...
dojo.widget.defineWidget("dojo.widget.TabButton", dojo.widget.PageButton, {
  ...
  templateString:
    "<div class='dojoTab' dojoAttachEvent='onClick'>" +
...
dojo.widget.defineWidget("dojo.widget.a11y.TabButton", dojo.widget.TabButton, {
  ...
  templateString:
    "<div class='dojoTab' dojoAttachEvent='onClick;onKey'>" +
    "<div dojoAttachPoint='innerDiv'>" +
    "<span dojoAttachPoint='titleNode' tabIndex='-1' waiRole='tab'>${this.label}</span>" +
