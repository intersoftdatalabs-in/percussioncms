...
dojo.html.getViewport = function () {
  ...
  if (dojo.render.html.mozilla) {
    ...
    dojo.exists(_document, "documentElement.clientWidth")
  ) {
    // IE6 Strict
...
dojo.html.getParentByType = function (
  /* HTMLElement */ node,
  /* string */ type
) {
  //	summary
...
if (dojo.render.html.ie && !dojo.render.html.ie70) {
  ...
  //is enough
  dojo.html.createExternalElement = function (
    /* HTMLDocument */ doc,
    /* string */ tag
  ) {
    //	summary
