...
dojo.widget.defineWidget(
  ...
  dojo.widget.IntegerTextbox,
  {
    ...
    mixInProperties: function (localProperties, frag) {
      ...
      if (
        localProperties.exponent == "true" ||
        localProperties.exponent == "always"
      ) {
        this.flags.exponent = true;
      } else if (
        localProperties.exponent == "false" ||
        localProperties.exponent == "never"
      ) {
      ...
      if (
        localProperties.esigned == "true" ||
        localProperties.esigned == "always"
      ) {
        this.flags.eSigned = true;
      } else if (
        localProperties.esigned == "false" ||
        localProperties.esigned == "never"
      ) {
