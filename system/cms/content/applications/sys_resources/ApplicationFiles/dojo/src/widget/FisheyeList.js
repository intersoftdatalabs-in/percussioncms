  ...
  },
  {
    ...
    _paint: function () {
      ...
      var sim = this.isHorizontal
        ? (1.0 - this.timerScale) * this.itemWidth +
          this.timerScale * this.itemMaxWidth
        : (1.0 - this.timerScale) * this.itemHeight +
...
dojo.widget.defineWidget(
  ...
  dojo.widget.HtmlWidget,
  {
    ...
    _blankImgPath: dojo.uri.moduleUri(
      "dojo.widget",
      ...
      elm.setSize = function (w, h) {
        ...
        for (var i = 0; i < this.svgDoc.childNodes.length; i++) {
          if (this.svgDoc.childNodes[i].setAttribute) {
            this.svgDoc.childNodes[i].setAttribute(
              "transform",
