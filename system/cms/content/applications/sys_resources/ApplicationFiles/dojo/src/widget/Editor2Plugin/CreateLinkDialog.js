...
dojo.widget.defineWidget(
  ...
  dojo.widget.Editor2DialogContent,
  {
    templatePath: dojo.uri.moduleUri(
      "dojo.widget",
      "templates/Editor2/Dialog/createlink.html"
    ),
    ...
    loadContent: function () {
      ...
      for (var i = 0; i < this.editableAttributes.length; ++i) {
        ...
        this["link_" + name].value =
          linkAttributes[name] == undefined ? "" : linkAttributes[name];
      }
      return true;
    },
    ok: function () {
      ...
      if (!this.linkNode) {
        ...
        dojo.withGlobal(curInst.window, "selectElement", dojo.html.selection, [
          this.linkNode,
        ]);
      }
      ...
      curInst.execCommand(
        "inserthtml",
        "<a " + attstr + this.extraAttribText + ">" + html + "</a>"
      );
