...
dojo.declare(
  ...
  },
  {
    ...
    _findValidItem: function (dir, curItem) {
      if (curItem) {
        curItem =
          dir > 0 ? curItem.getNextSibling() : curItem.getPreviousSibling();
      }
...
dojo.widget.defineWidget(
  ...
  },
  {
    ...
    _openAsSubmenu: function (
      /*Widget|DomNode*/ parent,
      /*Object*/ explodeSrc,
      /*String?*/ orient
    ) {
      // summary:
...
dojo.widget.defineWidget(
  ...
  },
  {
    ...
    _startSubmenuTimer: function () {
      ...
      this.hover_timer = dojo.lang.setTimeout(
        closure,
        this.parent.submenuDelay
      );
    },
...
dojo.widget.Menu2.OperaAndKonqFixer = new (function () {
  ...
  if (dojo.doc().createEvent) {
    // moz, safari has contextmenu event, need to do livecheck on this env.
    try {
