...
// -------------------------------------------------------------------
dojo.data.old.Item.compare = function (
  /* dojo.data.old.Item */ itemOne,
  /* dojo.data.old.Item */ itemTwo
) {
  /**
   * summary:
...
dojo.data.old.Item.prototype.compare = function (
  /* dojo.data.old.Item */ otherItem
) {
  /**
...
dojo.data.old.Item.prototype.isEqual = function (
  /* dojo.data.old.Item */ otherItem
) {
  /**
...
dojo.data.old.Item.prototype.get = function (
  /* string or dojo.data.old.Attribute */ attributeId
) {
  /**
...
dojo.data.old.Item.prototype.getValue = function (
  /* string or dojo.data.old.Attribute */ attributeId
) {
  /**
...
dojo.data.old.Item.prototype.getValues = function (
  /* string or dojo.data.old.Attribute */ attributeId
) {
  /**
...
dojo.data.old.Item.prototype.load = function (
  /* string or dojo.data.old.Attribute */ attributeId,
  /* anything */ value
) {
  /**
...
dojo.data.old.Item.prototype.set = function (
  /* string or dojo.data.old.Attribute */ attributeId,
  /* anything */ value
) {
  /**
...
dojo.data.old.Item.prototype.setValue = function (
  /* string or dojo.data.old.Attribute */ attributeId,
  /* dojo.data.old.Value */ value
) {
  this.set(attributeId, value);
};

dojo.data.old.Item.prototype.addValue = function (
  /* string or dojo.data.old.Attribute */ attributeId,
  /* anything */ value
) {
  /**
...
dojo.data.old.Item.prototype.setValues = function (
  /* string or dojo.data.old.Attribute */ attributeId,
  /* Array */ arrayOfValues
) {
  /**
...
dojo.data.old.Item.prototype.hasAttribute = function (
  /* string or dojo.data.old.Attribute */ attributeId
) {
  /**
...
dojo.data.old.Item.prototype.hasAttributeValue = function (
  /* string or dojo.data.old.Attribute */ attributeId,
  /* anything */ value
) {
  /**
