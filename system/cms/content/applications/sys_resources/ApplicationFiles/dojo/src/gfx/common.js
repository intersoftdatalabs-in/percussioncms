...
dojo.lang.mixin(dojo.gfx, {
  ...
  normalizeColor: function (/*Color*/ color) {
    ...
    return color instanceof dojo.gfx.color.Color
      ? color
      : new dojo.gfx.color.Color(color); // dojo.gfx.color.Color
  },
  ...
  makeParameters: function (defaults, update) {
    ...
    for (var i in defaults) {
      if (!(i in result)) {
        result[i] = dojo.lang.shallowCopy(
          i in update ? update[i] : defaults[i],
          true
        );
      }
    }
