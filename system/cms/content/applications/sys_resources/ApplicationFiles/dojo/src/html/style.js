...
dojo.html.prependClass = function (
  /* HTMLElement */ node,
  /* string */ classStr
) {
  //	summary
...
dojo.html.addClass = function (/* HTMLElement */ node, /* string */ classStr) {
  ...
  classStr = (dojo.html.getClass(node) + " " + classStr).replace(
    /^\s+|\s+$/g,
    ""
  );
  return dojo.html.setClass(node, classStr); //	boolean
...
dojo.html.removeClass = function (
  /* HTMLElement */ node,
  /* string */ classStr,
  ...
  try {
    if (!allowPartialMatches) {
      var newcs = dojo.html
        .getClass(node)
        .replace(new RegExp("(^|\\s+)" + classStr + "(\\s+|$)"), "$1$2");
    } else {
...
dojo.html.replaceClass = function (
  /* HTMLElement */ node,
  /* string */ newClass,
  /* string */ oldClass
) {
...
dojo.html.getElementsByClass = function (
  ...
  if (!useNonXpath && _document.evaluate) {
    ...
    var xpathResult = _document.evaluate(
      xpath,
      parent,
      null,
    ...
    var node,
      i = 0;
    outer: while ((node = candidateNodes[i++])) {
      ...
      if (matches == classes.length) {
        if (
          classMatchType == dojo.html.classMatchType.IsOnly &&
...
dojo.html.getStyleProperty = function (
  /* HTMLElement */ node,
  /* string */ cssSelector
) {
  //	summary
  ...
  return node && node.style
    ? node.style[dojo.html.toCamelCase(cssSelector)]
    : undefined; //	string
};

dojo.html.getStyle = function (
  /* HTMLElement */ node,
  /* string */ cssSelector
) {
  //	summary
...
dojo.html.setStyleText = function (
  /* HTMLElement */ target,
  /* string */ text
) {
  //	summary
...
dojo.html.getUnitValue = function (
  /* HTMLElement */ node,
  /* string */ cssSelector,
  /* boolean? */ autoIsZero
) {
...
if (dojo.render.html.ie) {
  // IE branch
  dojo.html.toPixelValue = function (
    /* HTMLElement */ element,
    /* String */ styleValue
  ) {
    // summary
  ...
  dojo.html.toPixelValue = function (
    ...
    //  If a value cannot be extracted, zero is returned.
    return styleValue && styleValue.slice(-2) == "px"
...
dojo.html.getPixelValue = function (
  ...
  //
  return dojo.html.toPixelValue(
    node,
    dojo.html.getComputedStyle(node, styleProperty)
  );
};

dojo.html.setPositivePixelValue = function (
  /* HTMLElement */ node,
  /* string */ selector,
  /* integer */ value
) {
...
dojo.html.insertCssRule = function (
  /* string */ selector,
  /* string */ declaration,
  /* integer? */ index
) {
  ...
  if (arguments.length < 3) {
    ...
    } else if (dojo.html.styleSheet.rules) {
      // IE
  ...
  } else if (dojo.html.styleSheet.addRule) {
    // IE
...
dojo.html.insertCssFile = function (
  ...
  dojo.html._insertedCssFiles.push({
    doc: doc,
    cssText: cssStr,
    nodeRef: style,
  });
...
dojo.html.fixPathsInCssText = function (/* string */ cssStr, /* string */ URI) {
  ...
  if (dojo.render.html.ie55 || dojo.render.html.ie60) {
    ...
    while ((match = regexIe.exec(cssStr))) {
      ...
      str +=
        cssStr.substring(0, match.index) +
        "AlphaImageLoader(" +
        match[1] +
        "src='" +
        url +
