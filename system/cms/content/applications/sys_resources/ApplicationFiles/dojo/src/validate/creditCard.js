...
dojo.validate.isValidCreditCard = function (
  /*String|Int*/ value,
  /*String*/ ccType
) {
  //Summary:
  ...
  if (
    value &&
    ccType &&
    (ccType.toLowerCase() == "er" || dojo.validate.isValidLuhn(value)) &&
    dojo.validate.isValidCreditCardNumber(value, ccType.toLowerCase())
  ) {
    return true; //Boolean
  }
  return false; //Boolean
};
dojo.validate.isValidCreditCardNumber = function (
  /*String|Int*/ value,
  /*String?*/ ccType
) {
  //Summary:
...
dojo.validate.isValidCvv = function (/*String|Int*/ value, /*String*/ ccType) {
  ...
  if (
    ...
    dojo.validate.isNumberFormat(value, flags)
  ) {
    return true; //Boolean
  }
  return false; //Boolean
