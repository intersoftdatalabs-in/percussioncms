...
dojo.widget.Parse = function (/*Object*/ fragment) {
  ...
  this.createSubComponents = function (
    ...
    for (var item in fragment) {
      ...
      if (
        ...
        // needed in IE when we have event.connected to the domNode
  ...
  this.createComponentFromScript = function (
    /*Node*/ nodeRef,
    ...
    return [
      dojo.widget.buildWidgetFromParseTree(
        ltn,
        properties,
        this,
        null,
...
dojo.widget.createWidget = function (
  /*String*/ name,
  /*String*/ props,
  /*Node*/ refNode,
  /*String*/ position
  ...
  function fromScript(placeKeeperNode, name, props, ns) {
    ...
    return dojo.widget
      .getParser()
      .createComponentFromScript(placeKeeperNode, name, props, ns);
  }
  ...
  if (!refNode) {
    ...
    // otherwise don't replace, but build in-place
    tn = refNode;
  }
