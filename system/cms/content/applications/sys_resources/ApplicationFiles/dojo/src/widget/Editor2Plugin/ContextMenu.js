...
dojo.widget.Editor2Plugin.ContextMenuManager = {
  ...
  registerGroup: function (name, handler) {
    if (this._registeredGroups[name]) {
      alert(
        "dojo.widget.Editor2Plugin.ContextMenuManager.registerGroup: menu group " +
          name +
  ...
  getGroup: function (name, contextmenuplugin) {
    ...
    switch (name) {
      ...
      case "Link":
      case "Image":
        return new dojo.widget.Editor2Plugin[name + "ContextMenuGroup"](
          contextmenuplugin
        );
      //TODO
      case "Anchor":
...
dojo.declare(
  ...
  },
  {
    ...
    setup: function (gs) {
      for (var i in gs) {
        var g = dojo.widget.Editor2Plugin.ContextMenuManager.getGroup(
          gs[i],
          this
        );
        if (g) {
...
dojo.declare(
  "dojo.widget.Editor2Plugin.GenericContextMenuGroup",
  dojo.widget.Editor2Plugin.SimpleContextMenuGroup,
  {
    createItems: function () {
      this.items.push(
...
dojo.declare(
  "dojo.widget.Editor2Plugin.LinkContextMenuGroup",
  dojo.widget.Editor2Plugin.SimpleContextMenuGroup,
  {
    createItems: function () {
      this.items.push(
...
dojo.declare(
  "dojo.widget.Editor2Plugin.ImageContextMenuGroup",
  dojo.widget.Editor2Plugin.SimpleContextMenuGroup,
  {
    createItems: function () {
      this.items.push(
