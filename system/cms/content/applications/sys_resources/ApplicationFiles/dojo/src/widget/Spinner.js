...
dojo.declare("dojo.widget.Spinner", null, {
  ...
  incrementSrc: dojo.uri.moduleUri(
    "dojo.widget",
    "templates/images/spinnerIncrement.gif"
  ),

  // decrementSrc: String
  //      down arrow graphic URL
  decrementSrc: dojo.uri.moduleUri(
    "dojo.widget",
    "templates/images/spinnerDecrement.gif"
  ),
  ...
  _spinnerPostMixInProperties: function (/*Object*/ args, /*Object*/ frag) {
    ...
    this.buttonSize = {
      width: inputSize.height / 2 - 1,
      height: inputSize.height / 2 - 1,
    };
  },
...
dojo.widget.defineWidget(
  ...
  [dojo.widget.IntegerTextbox, dojo.widget.Spinner],
  {
    ...
    postMixInProperties: function (/*Object*/ args, /*Object*/ frag) {
      dojo.widget.IntegerSpinner.superclass.postMixInProperties.apply(
        this,
        arguments
      );
    ...
    adjustValue: function (/*Number*/ direction, /*Number*/ x) {
      ...
      var num = Math.min(
        Math.max(
          parseInt(val) + parseInt(this.delta) * direction,
          this.flags.min ? this.flags.min : -Infinity
        ),
        this.flags.max ? this.flags.max : +Infinity
      );
      val = num.toString();
...
dojo.widget.defineWidget(
  ...
  },
  {
    ...
    postMixInProperties: function (/*Object*/ args, /*Object*/ frag) {
      dojo.widget.RealNumberSpinner.superclass.postMixInProperties.apply(
        this,
        arguments
      );
      this._spinnerPostMixInProperties(args, frag);
    ...
    postCreate: function (/*Object*/ args, /*Object*/ frag) {
      dojo.widget.RealNumberSpinner.superclass.postCreate.apply(
        this,
        arguments
      );
      this._spinnerPostCreate(args, frag);
    ...
    adjustValue: function (/*Number*/ direction, /*Number*/ x) {
      ...
      if (this.flags.separator.length > 0) {
        ...
        for (; i > 1; i -= 3) {
          val[0] =
            val[0].substr(0, i) + this.flags.separator + val[0].substr(i);
        }
        if (val[0].substr(0, 1) == " ") {
...
dojo.widget.defineWidget(
  ...
  {
    postMixInProperties: function (/*Object*/ args, /*Object*/ frag) {
      dojo.widget.TimeSpinner.superclass.postMixInProperties.apply(
        this,
        arguments
      );
      this._spinnerPostMixInProperties(args, frag);
    ...
    adjustValue: function (/*Number*/ direction, /*Number*/ x) {
      ...
      var format =
        this.flags.format && this.flags.format.search(/[Hhmst]/) >= 0
          ? this.flags.format
          : "hh:mm:ss t";
