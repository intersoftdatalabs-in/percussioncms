...
dojo.widget.defineWidget(
  "my.widget.demoEngine.DemoContainer",
  dojo.widget.HtmlWidget,
  {
    templatePath: dojo.uri.moduleUri(
      "dojo.widget",
      "demoEngine/templates/DemoContainer.html"
    ),
    templateCssPath: dojo.uri.moduleUri(
      "dojo.widget",
      "demoEngine/templates/DemoContainer.css"
    ),
    postCreate: function () {
      ...
      this.tabContainer = dojo.widget.createWidget(
        "TabContainer",
        {},
        this.tabNode
      );
