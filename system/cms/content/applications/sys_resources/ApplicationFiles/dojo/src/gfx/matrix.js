...
dojo.extend(dojo.gfx.matrix.Matrix2D, {
  xx: 1,
  xy: 0,
  yx: 0,
  yy: 1,
...
dojo.mixin(dojo.gfx.matrix, {
  ...
  normalize: function (matrix) {
    ...
    return matrix instanceof dojo.gfx.matrix.Matrix2D
      ? matrix
      : new dojo.gfx.matrix.Matrix2D(matrix); // dojo.gfx.matrix.Matrix2D
  },
  ...
  _sandwich: function (m, x, y) {
    ...
    return dojo.gfx.matrix.multiply(
      dojo.gfx.matrix.translate(x, y),
      m,
      dojo.gfx.matrix.translate(-x, -y)
    ); // dojo.gfx.matrix.Matrix2D
  },
