...
dojo.widget.defineWidget("dojo.widget.SlideShow", dojo.widget.HtmlWidget, {
  /*
		summary
  ...
  fillInTemplate: function () {
    ...
    if (this.imgUrls.length > 1) {
      this.img2.src =
        this.imgUrlBase + this.imgUrls[this._urlsIdx++] + this._getUrlSuffix();
      this._endTransition();
    } else {
      this.img1.src =
        this.imgUrlBase + this.imgUrls[this._urlsIdx++] + this._getUrlSuffix();
  ...
  _backgroundImageLoaded: function () {
    ...
    this.fadeAnim = dojo.lfx.fadeOut(
      this[this._foreground],
  ...
  _loadNextImage: function () {
    ...
    this[this._background].src =
      this.imgUrlBase + this.imgUrls[this._urlsIdx++];
