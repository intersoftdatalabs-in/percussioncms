...
dojo.html.sumAncestorProperties = function (
  /* HTMLElement */ node,
  /* string */ prop
) {
  //	summary
...
dojo.html.setStyleAttributes = function (
  /* HTMLElement */ node,
  /* string */ attributes
) {
  //	summary
...
dojo.html.getAbsolutePosition = dojo.html.abs = function (
  /* HTMLElement */ node,
...
dojo.html._sumPixelValues = function (
  /* HTMLElement */ node,
  selectors,
  autoIsZero
) {
...
dojo.html.getBorderExtent = function (
  /* HTMLElement */ node,
  /* string */ side
) {
  //	summary
  ...
  return dojo.html.getStyle(node, "border-" + side + "-style") == "none"
    ? 0
    : dojo.html.getPixelValue(node, "border-" + side + "-width"); // integer
};

dojo.html.getMarginExtent = function (
  /* HTMLElement */ node,
  /* string */ side
) {
  //	summary
...
dojo.html.getPaddingExtent = function (
  /* HTMLElement */ node,
  /* string */ side
) {
  //	summary
...
dojo.html.getPadBorder = function (/* HTMLElement */ node) {
  ...
  return {
    width: pad.width + border.width,
    height: pad.height + border.height,
  }; //	object
};
...
dojo.html.getMarginBox = function (/* HTMLElement */ node) {
  ...
  return {
    width: borderbox.width + margin.width,
    height: borderbox.height + margin.height,
  }; //	object
};
...
dojo.html.toCoordinateObject = dojo.html.toCoordinateArray = function (
  ...
  if (coords instanceof Array || typeof coords == "array") {
    ...
    !coords.nodeType &&
    !(coords instanceof String || typeof coords == "string") &&
    ("width" in coords ||
      "height" in coords ||
      "left" in coords ||
      "x" in coords ||
