  ...
  dojo.widget.LayoutContainer,
  {
    ...
    _checkButtons: function () {
      ...
      this.previousButton.disabled =
        !this.hasPreviousPanel() || !this.selected.canGoBack;
    ...
    _setButtonClass: function (button) {
      if (!this.hideDisabledButtons) {
        ...
        dojo.html.setClass(
          button,
          button.disabled ? "WizardButtonDisabled" : "WizardButton"
        );
      } else {
    ...
    registerChild: function (panel, insertionIndex) {
      dojo.widget.WizardContainer.superclass.registerChild.call(
        this,
        panel,
        insertionIndex
      );
...
dojo.widget.defineWidget("dojo.widget.WizardPane", dojo.widget.ContentPane, {
  // summary
  ...
  postMixInProperties: function (args, frag) {
    ...
    dojo.widget.WizardPane.superclass.postMixInProperties.apply(
      this,
      arguments
    );
  },
