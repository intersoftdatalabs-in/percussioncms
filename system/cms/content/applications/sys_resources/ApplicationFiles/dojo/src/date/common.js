...
dojo.date.getDayOfYear = function (/*Date*/ dateObject) {
  ...
  return Math.floor(
    (dateObject.getTime() - lastDayOfPrevYear.getTime()) / 86400000
  ); // Number
};

dojo.date.setWeekOfYear = function (
  /*Date*/ dateObject,
  /*Number*/ week,
  /*Number*/ firstDay
) {
...
dojo.date.getWeekOfYear = function (/*Date*/ dateObject, /*Number*/ firstDay) {
  ...
  firstDayOfYear.setDate(
    firstDayOfYear.getDate() - day + firstDay - (day > firstDay ? 7 : 0)
  );

  return Math.floor(
    (dateObject.getTime() - firstDayOfYear.getTime()) / 604800000
  );
};

dojo.date.setIsoWeekOfYear = function (
  /*Date*/ dateObject,
  /*Number*/ week,
  /*Number*/ firstDay
) {
...
dojo.date.getIsoWeekOfYear = function (
  /*Date*/ dateObject,
  /*Number*/ firstDay
) {
  // summary: unimplemented
...
dojo.date.compare = function (
  /* Date */ dateA,
  /* Date */ dateB,
  /* dojo.date.compareTypes */ options
) {
  //	summary
...
dojo.date.add = function (
  /* Date */ dt,
  /* dojo.date.dateParts */ interv,
  /* int */ incr
) {
  //	summary:
