  ...
  getCommand: function (/*dojo.widget.Editor2*/ editor, /*String*/ name) {
    ...
    switch (name) {
      ...
      default:
        ...
        if (
          (curtInst && curtInst.queryCommandAvailable(name)) ||
          (!curtInst &&
            dojo.widget.Editor2.prototype.queryCommandAvailable(name))
        ) {
          oCommand = new dojo.widget.Editor2BrowserCommand(editor, name);
        } else {
          dojo.debug(
            "dojo.widget.Editor2Manager.getCommand: Unknown command " + name
          );
          return;
        }
    }
...
dojo.lang.declare(
  ...
  },
  {
    ...
    getState: function () {
      if (
        this._editor._lastStateTimestamp > this._updateTime ||
...
dojo.widget.defineWidget(
  ...
  ],
  {
    ...
    templatePath: dojo.uri.moduleUri(
      "dojo.widget",
      "templates/Editor2/EditorDialog.html"
    ),
    ...
    fillInTemplate: function (args, frag) {
      ...
      dojo.widget.Editor2Dialog.superclass.fillInTemplate.call(
        this,
        args,
        frag
      );
...
dojo.lang.declare(
  "dojo.widget.Editor2DialogCommand",
  dojo.widget.Editor2BrowserCommand,
  ...
  },
  {
    execute: function () {
      if (!this.dialog) {
        if (!this.dialogParas.contentFile || !this.dialogParas.contentClass) {
          alert(
            "contentFile and contentClass should be set for dojo.widget.Editor2DialogCommand.dialogParas!"
          );
          return;
        }
    ...
    getText: function () {
      return (
        this.dialogParas.title ||
        dojo.widget.Editor2DialogCommand.superclass.getText.call(this)
      );
    },
  }
);
...
dojo.widget.defineWidget(
  ...
  },
  {
    ...
    toolbarTemplatePath: dojo.uri.cache.allow(
      dojo.uri.moduleUri("dojo.widget", "templates/EditorToolbarOneline.html")
    ),
    ...
    editorOnLoad: function () {
      ...
      if (this.toolbarWidget) {
        ...
        dojo.html.insertBefore(
          this.toolbarWidget.domNode,
          this.domNode.firstChild
        );
      } else {
        if (this.shareToolbar) {
          dojo.deprecated(
            "Editor2:shareToolbar is deprecated in favor of toolbarGroup",
            "0.5"
          );
        ...
        if (this.toolbarGroup) {
          if (dojo.widget.Editor2ToolbarGroups[this.toolbarGroup]) {
            this.toolbarWidget =
              dojo.widget.Editor2ToolbarGroups[this.toolbarGroup];
          }
        }
        if (!this.toolbarWidget) {
          ...
          if (this.toolbarTemplateCssPath) {
            ...
            tbOpts.templateCssString = dojo.uri.cache.get(
              this.toolbarTemplateCssPath
            );
          }
          if (this.toolbarPlaceHolder) {
            this.toolbarWidget = dojo.widget.createWidget(
              "Editor2Toolbar",
              tbOpts,
              dojo.byId(this.toolbarPlaceHolder),
              "after"
            );
          } else {
            this.toolbarWidget = dojo.widget.createWidget(
    ...
    unregisterLoadedPlugin: function (/*Object*/ obj) {
      ...
      dojo.debug(
        "dojo.widget.Editor2.unregisterLoadedPlugin: unknow plugin object: " +
          obj
      );
    },
    ...
    queryCommandEnabled: function (/*String*/ command, argument) {
      switch (command.toLowerCase()) {
        ...
        default:
          ...
          return dojo.widget.Editor2.superclass.queryCommandEnabled.apply(
            this,
            arguments
          );
      }
    ...
    queryCommandState: function (/*String*/ command, argument) {
      switch (command.toLowerCase()) {
        ...
        default:
          return dojo.widget.Editor2.superclass.queryCommandState.apply(
            this,
            arguments
          );
      }
    ...
    toggleHtmlEditing: function () {
      ...
      if (this === dojo.widget.Editor2Manager.getCurrentInstance()) {
        if (!this._inSourceMode) {
          ...
          this._htmlEditNode.style.height =
            dojo.html.getBorderBox(this.editNode).height + "px";
    ...
    restoreSelection: function () {
      ...
      if (this._bookmark) {
        ...
        dojo.withGlobal(this.window, "moveToBookmark", dojo.html.selection, [
          this._bookmark,
        ]);
        this._bookmark = null;
      } else {
    ...
    onLoad: function () {
      try {
        ...
        // FIXME: debug why this is throwing errors in IE!
        dojo.debug(e);
      }
      this.editorOnLoad();
    },
    ...
    replaceEditorContent: function (html) {
      ...
      dojo.widget.Editor2.superclass.replaceEditorContent.apply(
        this,
        arguments
      );
    },
    ...
    setupDefaultShortcuts: function () {
      ...
      dojo.lang.forEach(this.shortcuts, function (item) {
        ...
        if (cmd) {
          self.addKeyHandler(
            item[1] ? item[1] : item[0].charAt(0),
            item[2] == undefined ? self.KEY_CTRL : item[2],
            exec(cmd)
          );
        }
      });
