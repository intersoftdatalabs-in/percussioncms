  ...
  },
  {
    ...
    open: function (
      ...
      while (parent) {
        if (
          parent !== this &&
          parent.setOpenedSubpopup != undefined &&
          parent.applyPopupBasicStyle != undefined
        ) {
          parentPopup = parent;
    ...
    move: function (
      ...
      if (around) {
        ...
        padding = y;
        if (!aroundOrient) {
          //By default, attempt to open above the aroundNode, or below
...
dojo.widget.PopupManager = new (function () {
  ...
  this.registerAllWindows = function (/*Window*/ targetWindow) {
    ...
    if (!targetWindow) {
      //see comment below
      targetWindow = dojo.html.getDocumentWindow(
    ...
    for (var i = 0; i < targetWindow.frames.length; i++) {
      try {
        ...
        /* squelch error for cross domain iframes */
      }
    }
  };
