  ...
  if (input) {
    if (dojo.lang.isString(input)) {
      ...
      if (dojo.lang.isObject(input) && input.generate) {
        ...
        dojo.lang.assert(
          false,
          "The dojo.uuid.Uuid() constructor must be initializated with a UUID string."
        );
      }
    }
  } else {
...
dojo.uuid.Uuid.compare = function (
  /* dojo.uuid.Uuid */ uuidOne,
  /* dojo.uuid.Uuid */ uuidTwo
) {
  // summary:
...
dojo.uuid.Uuid.setGenerator = function (/* generator? */ generator) {
  ...
  dojo.lang.assert(
    !generator || (dojo.lang.isObject(generator) && generator.generate)
  );
  ...
  if (format) {
    switch (format) {
      ...
      default:
        ...
        dojo.lang.assert(
          false,
          "The toString() method of dojo.uuid.Uuid was passed a bogus format."
        );
    }
  } else {
...
dojo.uuid.Uuid.prototype.getVersion = function () {
  ...
  if (!this._versionNumber) {
    var errorMessage =
      "Called getVersion() on a dojo.uuid.Uuid that was not a DCE Variant UUID.";
    dojo.lang.assert(
      this.getVariant() == dojo.uuid.Uuid.Variant.DCE,
      errorMessage
    );
...
dojo.uuid.Uuid.prototype.getNode = function () {
  ...
  if (!this._nodeString) {
    var errorMessage =
      "Called getNode() on a dojo.uuid.Uuid that was not a TIME_BASED UUID.";
    dojo.lang.assert(
      this.getVersion() == dojo.uuid.Uuid.Version.TIME_BASED,
      errorMessage
    );
...
dojo.uuid.Uuid.prototype.getTimestamp = function (/* misc. */ returnType) {
  ...
  //   Throws an Error if this is not a version 1 UUID.
  var errorMessage =
    "Called getTimestamp() on a dojo.uuid.Uuid that was not a TIME_BASED UUID.";
  dojo.lang.assert(
    this.getVersion() == dojo.uuid.Uuid.Version.TIME_BASED,
    errorMessage
  );
  ...
  switch (returnType) {
    ...
    case Date:
      ...
      if (!this._timestampAsDate) {
        ...
        var secondsBetween1582and1970 =
          hoursBetween1582and1970 * secondsPerHour;
        var millisecondsBetween1582and1970 = secondsBetween1582and1970 * 1000;
        var millisecondsSince1970 =
          millisecondsSince1582 - millisecondsBetween1582and1970;
    ...
    default:
      ...
      dojo.lang.assert(
        false,
        "The getTimestamp() method dojo.uuid.Uuid was passed a bogus returnType: " +
          returnType
      );
      break;
  }
