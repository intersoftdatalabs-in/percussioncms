...
dojo.deprecated(
  "dojo.animation.Animation is slated for removal in 0.5; use dojo.lfx.* instead.",
  "0.5"
);
...
dojo.lang.extend(dojo.animation.Animation, {
  ...
  play: function (/*Boolean?*/ gotoStart) {
    ...
    var e = new dojo.animation.AnimationEvent(
      this,
      null,
