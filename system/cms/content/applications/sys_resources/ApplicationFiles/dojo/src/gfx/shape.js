...
dojo.declare("dojo.gfx.Shape", null, {
  ...
  setTransform: function (matrix) {
    ...
    this.matrix = dojo.gfx.matrix.clone(
      matrix ? dojo.gfx.matrix.normalize(matrix) : dojo.gfx.identity,
      true
    );
  ...
  _getRealMatrix: function () {
    ...
    return this.parentMatrix
      ? new dojo.gfx.matrix.Matrix2D([this.parentMatrix, this.matrix])
      : this.matrix; // dojo.gfx.matrix.Matrix
  },
});
