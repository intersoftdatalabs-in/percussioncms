...
dojo.widget.defineWidget(
  ...
  dojo.widget.HtmlWidget,
  {
    ...
    _addChild: function (/*Widget*/ widget) {
      ...
      if (widget.open) {
        dojo.deprecated(
          "open parameter deprecated, use 'selected=true' instead will be removed in ",
          "0.5"
        );
    ...
    _setSizes: function () {
      ...
      dojo.lang.forEach(this.children, function (child, idx) {
        ...
        child.resizeTo(
          mySize.width,
          mySize.height - totalCollapsedHeight + childCollapsedHeight
        );
        ...
        y +=
          idx == openIdx
            ? dojo.html.getBorderBox(child.domNode).height
            : childCollapsedHeight;
      });
    },
...
dojo.widget.defineWidget("dojo.widget.AccordionPane", dojo.widget.HtmlWidget, {
  // summary
  ...
  templatePath: dojo.uri.moduleUri(
    "dojo.widget",
    "templates/AccordionPane.html"
  ),
  templateCssPath: dojo.uri.moduleUri(
    "dojo.widget",
    "templates/AccordionPane.css"
  ),
  ...
  setSelected: function (/*Boolean*/ isSelected) {
    ...
    (isSelected ? dojo.html.addClass : dojo.html.removeClass)(
      this.domNode,
      this["class"] + "-selected"
    );
