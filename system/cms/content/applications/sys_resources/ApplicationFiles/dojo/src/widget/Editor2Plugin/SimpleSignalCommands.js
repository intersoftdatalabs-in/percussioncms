...
if (dojo.widget.Editor2Plugin["SimpleSignalCommands"]) {
  dojo.widget.Editor2Plugin["_SimpleSignalCommands"] =
...
dojo.widget.Editor2ToolbarItemManager.registerHandler(
  dojo.widget.Editor2Plugin.SimpleSignalCommands.Handler
);
