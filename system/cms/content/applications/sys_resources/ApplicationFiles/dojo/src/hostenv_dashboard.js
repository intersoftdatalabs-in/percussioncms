...
dojo.hostenv.getXmlhttpObject = function (/*Object*/ kwArgs) {
  ...
  if (widget.system && kwArgs) {
    if (
      (kwArgs.contentType && kwArgs.contentType.indexOf("text/") != 0) ||
      (kwArgs.headers &&
        kwArgs.headers["content-type"] &&
        kwArgs.headers["content-type"].indexOf("text/") != 0)
    ) {
...
dojo.hostenv.CurlRequest.prototype.open = function (
  /*String*/ method,
  /*URL*/ url,
  /*Boolean?*/ async,
  /*String?*/ username,
...
dojo.hostenv.CurlRequest.prototype.setRequestHeader = function (
  /*String*/ label,
  /*String*/ value
) {
  switch (label) {
...
dojo.hostenv.CurlRequest.prototype.getResponseHeader = function (
  /*String*/ headerLabel
) {
...
dojo.hostenv.CurlRequest.prototype.send = function (/*String*/ content) {
  ...
  var system = widget.system(
    dojo.hostenv.CurlRequest._formatCall(query, this._url),
    null
  );
  this.readyState = 2;
  if (this.onreadystatechange) {
