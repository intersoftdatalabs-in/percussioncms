...
dojo.widget.manager = new (function () {
    ...
    do {
      widgetId =
        ...
        (widgetTypeCtr[widgetType] != undefined
          ? ++widgetTypeCtr[widgetType]
          : (widgetTypeCtr[widgetType] = 0));
  ...
  var findImplementation = function (lowerCaseWidgetName, moduleName) {
    ...
    return module
      ? findImplementationInModule(lowerCaseWidgetName, module)
      : null;
  };
  ...
  this.getImplementationName = function (widgetName, ns) {
    ...
    var imps =
      knownWidgetImplementations[ns] || (knownWidgetImplementations[ns] = {});
