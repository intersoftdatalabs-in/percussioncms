...
dojo.declare(
  ...
  },
  {
    ...
    startSearch: function (/*String*/ searchStr, /*Function*/ callback) {
      ...
      var realUrl = dojo.string.substituteParams(this.searchUrl, {
        searchString: tss,
      });
      var _this = this;
...
dojo.declare(
  ...
  function (/*Object*/ options, /*DomNode*/ node) {
    ...
    if (
      !dj_undef("dataUrl", options) &&
      !dojo.string.isBlank(options.dataUrl)
    ) {
...
dojo.widget.defineWidget("dojo.widget.ComboBox", dojo.widget.HtmlWidget, {
  ...
  buttonSrc: dojo.uri.moduleUri(
    "dojo.widget",
    "templates/images/combo_box_arrow.png"
  ),
  ...
  setValue: function (/*String*/ value) {
    ...
    if (this.textInputNode.value != value) {
      // prevent mucking up of selection
  ...
  _handleBlurTimer: function (/*Boolean*/ clear, /*Number*/ millisec) {
    ...
    if (millisec) {
      // we ignore that zero is false and never sets as that never happens in this widget
    ...
    if (childs.length) {
      ...
      with (this.optionsListNode.style) {
        ...
        if (visibleCount == childs.length) {
          ...
          height =
            visibleCount * dojo.html.getMarginBox(childs[0]).height + "px";
        }
