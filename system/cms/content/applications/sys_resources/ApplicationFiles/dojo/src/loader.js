...
dojo.hostenv.loadModule = function (
  ...
  if (last == "*") {
    ...
    if (!ok && !omitModuleCheck) {
      dojo.raise(
        "Could not load '" + moduleName + "'; last tried '" + relpath + "'"
      );
    }
  }
...
dojo.kwCompoundRequire = function (/*Object containing Arrays*/ modMap) {
  ...
  var result = modMap[dojo.hostenv.name_]
...
dojo.setModulePrefix = function (/*String*/ module, /*String*/ prefix) {
  // summary: maps a module name to a path
  dojo.deprecated(
    'dojo.setModulePrefix("' + module + '", "' + prefix + '")',
...
dojo.hostenv.searchLocalePath = function (
  /*String*/ locale,
  /*Boolean*/ down,
  /*Function*/ searchFunc
) {
