...
dojo.lfx.html.propertyAnimation = function (
  /*DOMNode[]*/ nodes,
  /*Object[]*/ propertyMap,
  /*int*/ duration,
  /*function*/ easing,
...
dojo.lfx.html.fadeOut = function (
  /*DOMNode[]*/ nodes,
  /*int?*/ duration,
  /*Function?*/ easing,
  /*Function?*/ callback
...
dojo.lfx.html.fadeShow = function (
  /*DOMNode[]*/ nodes,
  /*int?*/ duration,
  /*Function?*/ easing,
  /*Function?*/ callback
...
dojo.lfx.html.fadeHide = function (
  /*DOMNode[]*/ nodes,
  /*int?*/ duration,
  /*Function?*/ easing,
  /*Function?*/ callback
...
dojo.lfx.html.wipeOut = function (
  /*DOMNode[]*/ nodes,
  /*int?*/ duration,
  /*Function?*/ easing,
  /*Function?*/ callback
...
dojo.lfx.html.slideTo = function (
  /*DOMNode*/ nodes,
  /*Object*/ coords,
  /*int?*/ duration,
  /*Function?*/ easing,
    ...
    var init = (function () {
      ...
      return function () {
        ...
        top =
          pos == "absolute"
            ? node.offsetTop
            : parseInt(compute(node, "top")) || 0;
        left =
          pos == "absolute"
            ? node.offsetLeft
            : parseInt(compute(node, "left")) || 0;
...
dojo.lfx.html.slideBy = function (
  /*DOMNode*/ nodes,
  /*Object*/ coords,
  /*int?*/ duration,
  /*Function?*/ easing,
...
dojo.lfx.html.explode = function (
  /*DOMNode*/ start,
  /*DOMNode*/ endNode,
  /*int?*/ duration,
  /*Function?*/ easing,
  ...
  var anim = new dojo.lfx.propertyAnimation(outline, props, duration, easing, {
    beforeBegin: function () {
...
dojo.lfx.html.implode = function (
  /*DOMNode*/ startNode,
  /*DOMNode*/ end,
  /*int?*/ duration,
  /*Function?*/ easing,
...
dojo.lfx.html.highlight = function (
  /*DOMNode[]*/ nodes,
...
dojo.lfx.html.unhighlight = function (
  /*DOMNode[]*/ nodes,
