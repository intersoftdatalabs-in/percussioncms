...
dojo.widget.fillFromTemplateCache = function (
  obj,
  templatePath,
  templateString,
  avoidCache
  ...
  if (!tpath && !obj["widgetType"]) {
    // don't have a real template here
    do {
      var dummyName =
        "__dummyTemplate__" + dojo.widget._templateCache.dummyCount++;
...
dojo.widget.attachTemplateNodes = function (
  rootNode,
  /*Widget*/ targetObj,
  events
) {
...
dojo.declare(
  ...
  },
  {
    ...
    addChild: function (
      ...
      if (!this.isContainer) {
        // we aren't allowed to contain other widgets, it seems
        dojo.debug(
    ...
    postInitialize: function (
      ...
      if (parentComp && (parentComp.snarfChildDomOutput || !sourceNodeRef)) {
        ...
        parentComp.addWidgetAsDirectChild(
          this,
          "",
          "insertAtIndex",
          "",
        ...
        if (this.domNode && this.domNode !== sourceNodeRef) {
          this._sourceNodeRef = dojo.dom.replaceNode(
            sourceNodeRef,
            this.domNode
          );
        }
      ...
      if (this.widgetsInTemplate) {
        ...
        for (var i = 0; i < subnodes.length; i++) {
          if (
            subnodes[i].getAttribute("dojoAttachPoint") == "subContainerWidget"
          ) {
        ...
        while ((w = stack.pop())) {
          for (var i = 0; i < w.children.length; i++) {
            ...
            if (
              cwidget._processedSubWidgets ||
              !cwidget.extraArgs["issubwidget"]
            ) {
              continue;
            }
    ...
    buildFromTemplate: function (/*Object*/ args, /*Object*/ frag) {
      ...
      dojo.widget.fillFromTemplateCache(
        this,
        args["templatePath"],
        null,
        avoidCache
