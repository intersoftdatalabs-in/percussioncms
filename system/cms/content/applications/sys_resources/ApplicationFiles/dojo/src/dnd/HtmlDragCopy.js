...
dojo.declare(
  ...
  },
  {
    onDragStart: function () {
      var dragObj = new dojo.dnd.HtmlDragCopyObject(
        this.dragObject,
        this.type,
        this
      );
    ...
    onSelected: function () {
      for (var i = 0; i < this.dragObjects.length; i++) {
        dojo.dnd.dragManager.selectedSources.push(
          new dojo.dnd.HtmlDragCopySource(this.dragObjects[i])
        );
      }
    },
  }
...
dojo.declare(
  ...
  },
  {
    ...
    onDragEnd: function (e) {
      ...
      new dojo.dnd.HtmlDragCopySource(
        this.sourceNode,
        this.type,
        this.copySource.copyOnce
      );
