...
dojo.lang.extend(dojo.dnd.TreeDragSource, {
  onDragStart: function () {
    ...
    dragObject.onDragStart = dojo.lang.hitch(dragObject, function (e) {
      ...
      var result = dojo.dnd.HtmlDragObject.prototype.onDragStart.apply(
        this,
        arguments
      );
...
dojo.lang.extend(dojo.dnd.TreeDropTarget, {
  ...
  onDragOver: function (e) {
    ...
    var accepts = dojo.dnd.HtmlDropTarget.prototype.onDragOver.apply(
      this,
      arguments
    );
  ...
  accepts: function (dragObjects) {
    var accepts = dojo.dnd.HtmlDropTarget.prototype.accepts.apply(
      this,
      arguments
    );
    ...
    if (
      dojo.lang.isUndefined(sourceTreeNode) ||
      !sourceTreeNode ||
      !sourceTreeNode.isTreeNode
    ) {
  ...
  setAutoExpandTimer: function () {
    ...
    this.autoExpandTimer = dojo.lang.setTimeout(
      autoExpand,
      _this.autoExpandDelay
    );
  },
  ...
  getAcceptPosition: function (e, sourceTreeNode) {
    ...
    if (
      ...
      !(
        !this.treeNode.actionIsDisabled(
          dojo.widget.TreeNode.prototype.actions.ADDCHILD
  ...
  isAdjacentNode: function (sourceNode, position) {
    ...
    if (sourceNode.getNextSibling() === this.treeNode && position == "before")
      return true;
    if (
      sourceNode.getPreviousSibling() === this.treeNode &&
      position == "after"
    )
      return true;
  ...
  getTargetParentIndex: function (sourceTreeNode, position) {
    ...
    if (
      this.treeNode.parent === sourceTreeNode.parent &&
...
dojo.lang.extend(dojo.dnd.TreeDNDController, {
  ...
  registerDNDNode: function (node) {
    ...
    if (!node.actionIsDisabled(node.actions.MOVE)) {
      ...
      var source = new dojo.dnd.TreeDragSource(
        node.labelNode,
        this,
        node.tree.widgetId,
        node
    ...
    var target = new dojo.dnd.TreeDropTarget(
      node.labelNode,
      this.treeController,
