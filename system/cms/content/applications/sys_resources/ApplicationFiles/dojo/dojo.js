...
if (typeof dojo === "undefined") {
  ...
  dojo.hostenv.callLoaded = function () {
    if (
      ...
      (djConfig["useXDomain"] && dojo.render.html.opera)
    ) {
  ...
  dojo.hostenv.loadModule = function (_47, _48, _49) {
    ...
    if (!_49 && !this["isXDomain"]) {
      ...
      if (!_4a) {
        dojo.raise(
          "symbol '" + _47 + "' is not defined after loading '" + _4b + "'"
        );
      }
    }
    return _4a;
  ...
  dojo.kwCompoundRequire = function (_5a) {
    var _5b = _5a["common"] || [];
    var _5c = _5a[dojo.hostenv.name_]
      ? _5b.concat(_5a[dojo.hostenv.name_] || [])
      : _5b.concat(_5a["default"] || []);
...
if (typeof window != "undefined") {
  ...
  dojo.hostenv.println = function (_c8) {
    if (!dojo.hostenv._println_safe) {
      ...
      try {
        var _c9 = document.getElementById(
  ...
  if (document.addEventListener) {
    if (
      ...
      (dojo.render.html.moz && djConfig["enableMozDomContentLoaded"] === true)
    ) {
...
dojo.requireIf(
  djConfig["debugAtAllCosts"] && !window.widget && !djConfig["useXDomain"],
  "dojo.browser_debug"
);
dojo.requireIf(
  djConfig["debugAtAllCosts"] && !window.widget && djConfig["useXDomain"],
  "dojo.browser_debug_xd"
);
...
dojo.dom.firstElement = dojo.dom.getFirstChildElement = function (_13e, _13f) {
  ...
  if (
    ...
    node &&
    node.tagName &&
    node.tagName.toLowerCase() != _13f.toLowerCase()
  ) {
...
dojo.dom.lastElement = dojo.dom.getLastChildElement = function (_141, _142) {
  ...
  if (
    ...
    node &&
    node.tagName &&
    node.tagName.toLowerCase() != _142.toLowerCase()
  ) {
...
dojo.dom.moveChildren = function (_148, _149, trim) {
  ...
  if (trim) {
    while (
      _148.hasChildNodes() &&
      _148.firstChild.nodeType == dojo.dom.TEXT_NODE
    ) {
      _148.removeChild(_148.firstChild);
    }
    while (
      _148.hasChildNodes() &&
      _148.lastChild.nodeType == dojo.dom.TEXT_NODE
    ) {
...
dojo.lang._mixin = function (obj, _197) {
  ...
  if (
    dojo.render.html.ie &&
    typeof _197["toString"] == "function" &&
    _197["toString"] != obj["toString"] &&
    _197["toString"] != tobj["toString"]
  ) {
...
dojo.event.MethodJoinPoint.getForMethod = function (obj, _253) {
  ...
  if (!ofn) {
    ...
    if (
      typeof ofn != "function" &&
      !dojo.lang.isFunction(ofn) &&
      !dojo.lang.isAlien(ofn)
    ) {
      return null;
    }
  }
...
dojo.lang.extend(dojo.event.MethodJoinPoint, {
  ...
  run: function () {
    ...
    var _261 = function (marr) {
      ...
      var _26c =
        !isNaN(_26b) && marr[4] !== null && typeof marr[4] != "undefined";
      if (marr[5]) {
...
dojo.lang.extend(dojo.AdapterRegistry, {
  register: function (name, _322, wrap, _324, _325) {
...
dojo.json = {
  ...
  register: function (name, _32d, wrap, _32f) {
...
dojo.html.getViewport = function () {
  ...
  if (dojo.render.html.mozilla) {
    ...
    if (!dojo.render.html.opera && _33c.innerWidth) {
      ...
      if (
        !dojo.render.html.opera &&
        dojo.exists(_33d, "documentElement.clientWidth")
      ) {
...
dojo.html.getScroll = function () {
  ...
  var top =
    _341.pageYOffset ||
    _342.documentElement.scrollTop ||
    dojo.body().scrollTop ||
    0;
  var left =
    _341.pageXOffset ||
    _342.documentElement.scrollLeft ||
        ...
        if (_368.scheme == null) {
          ...
          if (_368.authority == null) {
            ...
            if (_368.path.charAt(0) != "/") {
              var path =
                _369.path.substring(0, _369.path.lastIndexOf("/") + 1) +
                _368.path;
              var segs = path.split("/");
...
dojo.html.hasClass = function (node, _374) {
  return new RegExp("(^|\\s+)" + _374 + "(\\s+|$)").test(
...
dojo.html.removeClass = function (node, _37d, _37e) {
  try {
    if (!_37e) {
      var _37f = dojo.html
        .getClass(node)
        .replace(new RegExp("(^|\\s+)" + _37d + "(\\s+|$)"), "$1$2");
    } else {
...
dojo.html.getElementsByClass = function (_383, _384, _385, _386, _387) {
  ...
  if (!_387 && _388.evaluate) {
    ...
    if (_386 != dojo.html.classMatchType.ContainsAny) {
      _38e +=
        "concat(' ',@class,' '), ' " +
        _389.join(" ') and contains(concat(' ',@class,' '), ' ") +
        " ')";
      if (_386 == 2) {
      ...
      _38e +=
        "concat(' ',@class,' '), ' " +
        _389.join(" ') or contains(concat(' ',@class,' '), ' ") +
        " ')]";
    }
...
dojo.html.getStyleProperty = function (node, _3a5) {
  ...
  return node && node.style
    ? node.style[dojo.html.toCamelCase(_3a5)]
    : undefined;
};
...
dojo.html.setDisplay = function (node, _3fe) {
  dojo.html.setStyle(
    node,
    "display",
    _3fe instanceof String || typeof _3fe == "string"
      ? _3fe
      : _3fe
...
dojo.html.setVisibility = function (node, _402) {
  dojo.html.setStyle(
    node,
    "visibility",
    _402 instanceof String || typeof _402 == "string"
      ? _402
      : _402
      ? "visible"
      : "hidden"
...
dojo.html.getContentBox = function (node) {
  ...
  return {
    width: node.offsetWidth - _44b.width,
    height: node.offsetHeight - _44b.height,
  };
};
...
dojo.html.toCoordinateObject = dojo.html.toCoordinateArray = function (
  ...
  if (_461 instanceof Array || typeof _461 == "array") {
    ...
    if (
      !_461.nodeType &&
      !(_461 instanceof String || typeof _461 == "string") &&
      ("width" in _461 ||
        "height" in _461 ||
        "left" in _461 ||
        "x" in _461 ||
      ...
      var ret = {
        left: _461.left || _461.x || 0,
        top: _461.top || _461.y || 0,
        width: _461.width || 0,
        height: _461.height || 0,
      };
    } else {
...
dojo.lang.isNumeric = function (_484) {
  return (
    ...
    isFinite(_484) &&
    _484 != null &&
    !dojo.lang.isBoolean(_484) &&
    !dojo.lang.isArray(_484) &&
    !/^\s*$/.test(_484)
  );
};
dojo.lang.isBuiltIn = function (_485) {
  return (
    dojo.lang.isArray(_485) ||
    dojo.lang.isFunction(_485) ||
    dojo.lang.isString(_485) ||
    dojo.lang.isNumber(_485) ||
    dojo.lang.isBoolean(_485) ||
    _485 == null ||
    _485 instanceof Error ||
    typeof _485 == "error"
  );
};
...
dojo.lang.isOfType = function (_487, type, _489) {
  ...
  if (dojo.lang.isArray(type)) {
    ...
    switch (type) {
      ...
      case "optional":
        dojo.deprecated(
          'dojo.lang.isOfType(value, [type, "optional"])',
          "use dojo.lang.isOfType(value, type, {optional: true} ) instead",
          "0.5"
        );
...
dojo.lang.assertType = function (_499, type, _49b) {
  if (dojo.lang.isString(_49b)) {
    dojo.deprecated(
      'dojo.lang.assertType(value, type, "message")',
      "use dojo.lang.assertType(value, type) instead",
      "0.5"
    );
  }
  if (!dojo.lang.isOfType(_499, type, _49b)) {
    if (!dojo.lang.assertType._errorMessage) {
      dojo.lang.assertType._errorMessage =
...
dojo.lang.assertValidKeywords = function (_49c, _49d, _49e) {
  ...
  if (!_49e) {
    if (!dojo.lang.assertValidKeywords._errorMessage) {
      dojo.lang.assertValidKeywords._errorMessage =
        "In dojo.lang.assertValidKeywords(), found invalid keyword:";
    }
      ...
      switch (tcn.nodeType) {
        case dojo.dom.ELEMENT_NODE:
          ...
          if (
            ...
            _4d5[ctn][_4d5[ctn].length - 1].value =
  ...
  this.parseAttributes = function (node) {
    ...
    while ((_4e0 = atts[i++])) {
      if (isIE) {
        ...
        if (
          (typeof _4e0 == "object" && typeof _4e0.nodeValue == "undefined") ||
          _4e0.nodeValue == null ||
          _4e0.nodeValue == ""
        ) {
          continue;
...
dojo.ns = {
  ...
  loading: {},
  loaded: {},
  register: function (name, _4e4, _4e5, _4e6) {
  ...
  this.getUniqueId = function (_501) {
    ...
    do {
      _502 =
        _501 +
        "_" +
        (_4ff[_501] != undefined ? ++_4ff[_501] : (_4ff[_501] = 0));
...
dojo.widget.buildWidgetFromParseTree = function (
  ...
  var _58a = dojo.widget.manager.getImplementation(
    _588,
    null,
    null,
    frag["ns"]
...
dojo.widget.Parse = function (_59e) {
  ...
  this.createComponentFromScript = function (_5c8, _5c9, _5ca, ns) {
    ...
    return [
      dojo.widget.buildWidgetFromParseTree(ltn, _5ca, this, null, null, _5ca),
    ];
  };
};
...
dojo.widget.createWidget = function (name, _5cf, _5d0, _5d1) {
  ...
  function fromScript(_5da, name, _5dc, ns) {
    ...
    return dojo.widget
      .getParser()
      .createComponentFromScript(_5da, name, _5dc, ns);
  }
  _5cf = _5cf || {};
  var _5de = false;
  var tn = null;
...
dojo.widget.wai = {
  ...
  setAttr: function (node, ns, attr, _5f0) {
    if (dojo.render.html.ie) {
...
dojo.declare(
  ...
  },
  {
    ...
    addChild: function (_61f, _620, pos, ref, _623) {
      if (!this.isContainer) {
        dojo.debug(
...
dojo.html.overElement = function (_664, e) {
  ...
  var _668 = dojo.html.getAbsolutePosition(
    _664,
    true,
...
dojo.html.placeOnScreen = function (node, _67c, _67d, _67e, _67f, _680, _681) {
  ...
  for (var _68c = 0; _68c < _680.length; ++_68c) {
    ...
    var tryX =
      _67c -
      (_68d.charAt(1) == "L" ? 0 : w) +
      _67e[0] * (_68d.charAt(1) == "L" ? 1 : -1);
    var tryY =
      _67d -
      (_68d.charAt(0) == "T" ? 0 : h) +
      _67e[1] * (_68d.charAt(0) == "T" ? 1 : -1);
    if (_67f) {
      tryX -= _682.x;
      tryY -= _682.y;
    }
    ...
    if (_68e) {
      ...
      var dist =
        Math.pow(x - tryX - _682.x, 2) + Math.pow(y - tryY - _682.y, 2);
      if (_68a > dist) {
        _68a = dist;
        _688 = x;
        _689 = y;
...
dojo.html.placeOnScreenPoint = function (node, _695, _696, _697, _698) {
  ...
  return dojo.html.placeOnScreen(node, _695, _696, _697, _698, [
    "TL",
    "TR",
    "BL",
    "BR",
...
dojo.gfx.color.hex2rgb = function (hex) {
  ...
  for (var i = 0; i < rgb.length; i++) {
    rgb[i] =
      _6c7.indexOf(rgb[i].charAt(0)) * 16 + _6c7.indexOf(rgb[i].charAt(1));
  }
  return rgb;
};
...
dojo.lang.extend(dojo.lfx.IAnimation, {
  ...
  pause: null,
  stop: null,
  connect: function (evt, _6e0, _6e1) {
    if (!_6e1) {
      _6e1 = _6e0;
      _6e0 = this;
    }
...
dojo.lfx.Combine = function (_6fb) {
  ...
  if (
    _6fc.length == 1 &&
    (dojo.lang.isArray(_6fc[0]) || dojo.lang.isArrayLike(_6fc[0]))
  ) {
    _6fc = _6fc[0];
  }
  dojo.lang.forEach(
...
dojo.lfx.Chain = function (_706) {
  ...
  if (
    _707.length == 1 &&
    (dojo.lang.isArray(_707[0]) || dojo.lang.isArrayLike(_707[0]))
  ) {
    _707 = _707[0];
  }
  var _708 = this;
...
dojo.lfx.html.propertyAnimation = function (_71a, _71b, _71c, _71d, _71e) {
  ...
  var _71f = {
    ...
    nodes: _71a,
    duration: _71c,
    easing: _71d || dojo.lfx.easeDefault,
  };
  ...
  dojo.lang.forEach(_76d, function (node) {
    ...
    var init = (function () {
      ...
      return function () {
        ...
        top =
          pos == "absolute" ? node.offsetTop : parseInt(_773(node, "top")) || 0;
        left =
          pos == "absolute"
            ? node.offsetLeft
            : parseInt(_773(node, "left")) || 0;
    ...
    var anim = dojo.lfx.propertyAnimation(
      node,
      {
        top: { start: top, end: _76e.top || 0 },
        left: { start: left, end: _76e.left || 0 },
      },
      _76f,
      _770,
      { beforeBegin: init }
  ...
  dojo.lang.forEach(_77c, function (node) {
    ...
    var init = (function () {
      ...
      return function () {
        ...
        top =
          pos == "absolute" ? node.offsetTop : parseInt(_782(node, "top")) || 0;
        left =
          pos == "absolute"
            ? node.offsetLeft
            : parseInt(_782(node, "left")) || 0;
        if (!dojo.lang.inArray(["absolute", "relative"], pos)) {
    ...
    var anim = dojo.lfx
      .propertyAnimation(
        node,
        {
          top: { start: top, end: top + (_77d.top || 0) },
          left: { start: left, end: left + (_77d.left || 0) },
        },
        _77e,
        _77f
      )
...
dojo.lfx.html.explode = function (_78b, _78c, _78d, _78e, _78f) {
  ...
  var anim = new dojo.lfx.propertyAnimation(_792, _795, _78d, _78e, {
    beforeBegin: function () {
...
dojo.lfx.html.implode = function (_798, end, _79a, _79b, _79c) {
  ...
  var anim = new dojo.lfx.propertyAnimation(_7a0, _7a1, _79a, _79b, {
    beforeBegin: function () {
      dojo.html.hide(_798);
      dojo.html.show(_7a0);
    },
...
dojo.lfx.html.highlight = function (_7a4, _7a5, _7a6, _7a7, _7a8) {
  ...
  dojo.lang.forEach(_7a4, function (node) {
    ...
    var anim = dojo.lfx.propertyAnimation(
      node,
      { "background-color": { start: rgb, end: _7b0 } },
      _7a6,
      _7a7,
      {
        beforeBegin: function () {
...
dojo.lfx.html.unhighlight = function (_7b2, _7b3, _7b4, _7b5, _7b6) {
  ...
  dojo.lang.forEach(_7b2, function (node) {
    ...
    var anim = dojo.lfx.propertyAnimation(
      node,
      { "background-color": { start: _7b9, end: rgb } },
      _7b4,
      _7b5,
      {
        beforeBegin: function () {
...
dojo.lfx.toggle.plain = {
  show: function (node, _7be, _7bf, _7c0) {
    dojo.html.show(node);
...
dojo.lfx.toggle.fade = {
  show: function (node, _7c6, _7c7, _7c8) {
...
dojo.lfx.toggle.wipe = {
  show: function (node, _7ce, _7cf, _7d0) {
...
dojo.lfx.toggle.explode = {
  show: function (node, _7d6, _7d7, _7d8, _7d9) {
    dojo.lfx
      .explode(
        _7d9 || { x: 0, y: 0, width: 0, height: 0 },
        node,
        _7d6,
        _7d7,
        _7d8
...
dojo.lang.extend(dojo.io.Request, {
  ...
  useCache: false,
  preventCache: false,
  jsonFilter: function (_7f2) {
    if (
      this.mimetype == "text/json-comment-filtered" ||
    ...
    dojo.debug(
      "please consider using a mimetype of text/json-comment-filtered to avoid potential security issues with JSON endpoints"
    );
    return _7f2;
  },
  ...
  fromKwArgs: function (_805) {
    ...
    _805.encoding = dojo.lang.firstValued(
      _805["encoding"],
      djConfig["bindEncoding"],
      ""
    );
    _805.sendTransport = dojo.lang.firstValued(
      _805["sendTransport"],
  ...
  if (_80d["transport"]) {
    ...
    if (!this[_80e]) {
      dojo.io.sendBindError(
        _80d,
        "No dojo.io.bind() transport with name '" + _80d["transport"] + "'."
      );
      return _80d;
    }
...
dojo.io.sendBindError = function (_811, _812) {
  if (
    (typeof _811.error == "function" || typeof _811.handle == "function") &&
    (typeof setTimeout == "function" || typeof setTimeout == "object")
  ) {
    var _813 = new dojo.io.Error(_812);
    setTimeout(function () {
      _811[typeof _811.error == "function" ? "error" : "handle"](
        "error",
        _813,
        null,
        _811
  ...
  addToHistory: function (args) {
    ...
    if (!this.historyIframe) {
      if (djConfig["useXDomain"] && !djConfig["dojoIframeHistoryUrl"]) {
        dojo.debug(
          "dojo.undo.browser: When using cross-domain Dojo builds," +
...
if (!dj_undef("window")) {
  ...
  dojo.io.XMLHTTPTransport = new (function () {
      ...
      if (
        ...
        if (_878.method.toLowerCase() == "head") {
          ...
          if (_878.mimetype == "text/javascript") {
            ...
            if (
              _878.mimetype.substr(0, 9) == "text/json" ||
              _878.mimetype.substr(0, 16) == "application/json"
            ) {
              try {
              ...
              if (
                _878.mimetype == "application/xml" ||
                _878.mimetype == "text/xml"
              ) {
        ...
        _878[typeof _878.load == "function" ? "load" : "handle"](
          "load",
          ret,
          http,
          _878
        ...
        var _882 = new dojo.io.Error(
          "XMLHttpTransport Error: " + http.status + " " + http.statusText
        );
        _878[typeof _878.error == "function" ? "error" : "handle"](
          "error",
          _882,
          http,
          _878
    ...
    this.canHandle = function (_88b) {
      ...
      return (
        ...
        (dojo.lang.inArray(
          ...
          mlc.substr(0, 9) == "text/json" ||
          mlc.substr(0, 16) == "application/json") &&
        !(_88b["formNode"] && dojo.io.formHasFile(_88b["formNode"]))
      );
    };
    ...
    this.bind = function (_88d) {
      ...
      var _899 =
        _88d["preventCache"] ||
        (this.preventCache == true && _88d["preventCache"] != false);
      var _89a =
        _88d["useCache"] == true ||
        (this.useCache == true && _88d["useCache"] != false);
      if (!_899 && _89a) {
      ...
      var _89d = false;
      if (_898) {
        var _89e = this.inFlight.push({
          req: _88d,
          http: http,
          url: url,
          query: _88f,
          useCache: _89a,
          startTime: _88d.timeoutSeconds ? new Date().getTime() : 0,
        });
      ...
      if (_88d.method.toLowerCase() == "post") {
        ...
        http.setRequestHeader(
          ...
          _88d.multipart
            ...
            : _88d.contentType || "application/x-www-form-urlencoded"
        );
        try {
          http.send(_88f);
        } catch (e) {
...
dojo.io.cookie.getObjectCookie = function (name) {
  var _8b9 = null,
    _8ba = dojo.io.cookie.getCookie(name);
  if (_8ba) {
    _8b9 = {};
    var _8bb = _8ba.split("&");
...
dojo.io.cookie.isSupported = function () {
  if (typeof navigator.cookieEnabled != "boolean") {
    ...
    var _8bf = dojo.io.cookie.getCookie(
      "__TestingYourBrowserForCookieSupport__"
    );
...
dojo.widget.defineWidget(
  ...
  },
  {
    ...
    isLoaded: false,
    postCreate: function (args, frag, _8c2) {
      if (this.handler !== "") {
    ...
    splitAndFixPaths: function (s, url) {
      ...
      if (s) {
        ...
        while ((_8ed = _8f7.exec(s))) {
          _8ea.push(_8ed[1]);
          s =
            s.substring(0, _8ed.index) + s.substr(_8ed.index + _8ed[0].length);
        }
        if (this.adjustPaths) {
          var _8f8 =
    ...
    setHandler: function (_90a) {
      ...
      if (!dojo.lang.isFunction(fcn)) {
        this._handleDefaults(
          "Unable to set handler, '" + _90a + "' not a function.",
          "onExecError",
          true
        );
        return;
...
dojo.html.iframeContentWindow = function (_919) {
  var win =
    dojo.html.getDocumentWindow(dojo.html.iframeContentDocument(_919)) ||
    dojo.html.iframeContentDocument(_919).__parent__ ||
    (_919.name && document.frames[_919.name]) ||
    null;
  return win;
};
dojo.html.iframeContentDocument = function (_91b) {
  var doc =
    _91b.contentDocument ||
    (_91b.contentWindow && _91b.contentWindow.document) ||
    (_91b.name &&
      document.frames[_91b.name] &&
      document.frames[_91b.name].document) ||
    null;
  return doc;
};
...
dojo.lang.extend(dojo.html.BackgroundIframe, {
  ...
  size: function (node) {
    ...
    var _921 = dojo.html.toCoordinateObject(
      node,
      true,
      dojo.html.boxSizing.BORDER_BOX
    );
  ...
  getType: function () {
    if (dojo.doc()["selection"]) {
      ...
      if (oSel && oSel.rangeCount == 1) {
        ...
        if (
          _946.startContainer == _946.endContainer &&
          _946.endOffset - _946.startOffset == 1 &&
          _946.startContainer.nodeType != dojo.dom.TEXT_NODE
        ) {
...
dojo.widget.html.layout = function (_980, _981, _982) {
  ...
  var f = {
    top: dojo.html.getPixelValue(_980, "padding-top", true),
    left: dojo.html.getPixelValue(_980, "padding-left", true),
  };
...
dojo.declare("dojo.dnd.DragManager", null, {
  ...
  dragObjects: [],
  dragSources: [],
  registerDragSource: function (_9a0) {},
  dropTargets: [],
  registerDropTarget: function (_9a1) {},
  lastDragTarget: null,
...
dojo.declare("dojo.dnd.HtmlDragManager", dojo.dnd.DragManager, {
  ...
  onMouseDown: function (e) {
    ...
    if (
      dojo.html.isTag(_9b1, "button", "textarea", "input", "select", "option")
    ) {
      return;
    }
  ...
  dojo.dnd.DragObject,
  {
    ...
    getConstraints: function () {
      ...
      return {
        minX: x,
        minY: y,
        maxX: x + _9ef - mb.width,
        maxY: y + _9f0 - mb.height,
      };
    },
...
dojo.declare(
  ...
  dojo.dnd.DropTarget,
  {
    ...
    onDragOver: function (e) {
      ...
      for (var i = 0, _a08; i < this.domNode.childNodes.length; i++) {
        ...
        this.childBoxes.push({
          top: pos.y,
          bottom: pos.y + _a0a.height,
          left: pos.x,
          right: pos.x + _a0a.width,
          height: _a0a.height,
          width: _a0a.width,
          node: _a08,
        });
    ...
    placeIndicator: function (e, _a17, _a18, _a19) {
      ...
      if (_a1b) {
        this.dropIndicator.style[_a1a] =
          (_a19 ? _a1b[_a1a] : _a1b[this.vertical ? "right" : "bottom"]) + "px";
        if (this.vertical) {
...
dojo.declare("dojo.widget.FloatingPaneBase", null, {
  ...
  templatePath: dojo.uri.moduleUri(
    "dojo.widget",
    "templates/FloatingPane.html"
  ),
  templateCssPath: dojo.uri.moduleUri(
    "dojo.widget",
    "templates/FloatingPane.css"
  ),
  ...
  },
  {
    ...
    open: function (x, y, _a59, _a5a, _a5b, _a5c) {
      ...
      while (_a59) {
        if (
          _a59 !== this &&
          _a59.setOpenedSubpopup != undefined &&
          _a59.applyPopupBasicStyle != undefined
        ) {
          _a60 = _a59;
...
dojo.widget.defineWidget(
  ...
  [dojo.widget.HtmlWidget, dojo.widget.PopupContainerBase],
  {
    ...
    fillInTemplate: function () {
      ...
      dojo.widget.PopupContainer.superclass.fillInTemplate.apply(
        this,
        arguments
      );
    },
...
dojo.widget.PopupManager = new (function () {
  ...
  this.registerAllWindows = function (_a70) {
    if (!_a70) {
      _a70 = dojo.html.getDocumentWindow(
  ...
  },
  {
    ...
    _highlightOption: function (dir) {
      ...
      if (item) {
        ...
        try {
          var node = dojo.html.getElementsByClass(
            "dojoMenuItem2Label",
            item.domNode
          )[0];
          node.focus();
  ...
  },
  {
    ...
    bindDomNode: function (node) {
      ...
      if (
        ...
        win.document.designMode.toLowerCase() == "on"
      ) {
        dojo.event.browser.addListener(
          node,
          "contextmenu",
          dojo.lang.hitch(this, "onOpen")
        );
      }
...
dojo.widget.defineWidget(
  ...
  },
  {
    ...
    postMixInProperties: function () {
      ...
      dojo.widget.MenuItem2.superclass.postMixInProperties.apply(
        this,
        arguments
      );
    },
...
dojo.widget.defineWidget("dojo.widget.MenuSeparator2", dojo.widget.HtmlWidget, {
  templateString:
    '<tr class="dojoMenuSeparator2"><td colspan=4>' +
...
dojo.widget.defineWidget(
  ...
  [dojo.widget.HtmlWidget, dojo.widget.MenuBase],
  {
    menuOverlap: 2,
    templateString:
      '<div class="dojoMenuBar2" dojoAttachPoint="containerNode" tabIndex="0"></div>',
    close: function (_aad) {
      if (this._highlighted_option) {
        this._highlighted_option.onUnhover();
      }
    ...
    processKey: function (evt) {
      ...
      switch (evt.key) {
        ...
        case evt.KEY_LEFT_ARROW:
          ...
          break;
        default:
          rval = dojo.widget.MenuBar2.superclass.processKey.apply(
            this,
            arguments
          );
          break;
...
dojo.widget.defineWidget("dojo.widget.MenuBarItem2", dojo.widget.MenuItem2, {
  templateString:
      ...
      if (_adb <= _adc) {
        ...
        for (var i = 0; i < this.children.length; i++) {
          this.children[i].sizeActual = Math.round(
            _adc * (this.children[i].sizeMin / _adb)
          );
        }
      }
    },
...
dojo.declare("dojo.widget.TreeWithNode", null, function () {}, {
  ...
  addChild: function (_b17, _b18, _b19) {
    ...
    if (!_b17.isTreeNode) {
      dojo.raise(
        "You can only add TreeNode widgets to a " + this.widgetType + " widget!"
      );
      return;
    }
  ...
  },
  {
      ...
      if (_b2a.classPrefix != _b29.classPrefix) {
        ...
        while ((elem = _b2c.pop())) {
          for (var i = 0; i < elem.childNodes.length; i++) {
            ...
            dojo.html.setClass(
              _b30,
              dojo.html.getClass(_b30).replace(reg, "$1" + _b29.classPrefix)
            );
            _b2c.push(_b30);
          }
        }
    ...
    addedTo: function (_b32, _b33, _b34) {
      ...
      if (_b35 > 1) {
        ...
        if (
          _b33 == _b35 - 1 &&
          _b32.children[_b35 - 2] instanceof dojo.widget.Widget
        ) {
    ...
    createSimple: function (args, _b38) {
      ...
      _b3a.toggleObj =
        dojo.lfx.toggle[_b3a.toggle.toLowerCase()] || dojo.lfx.toggle.plain;
    ...
    viewSetExpand: function () {
      ...
      dojo.html.setClass(
        this.domNode,
        dojo.html.getClass(this.domNode).replace(reg, "") + " " + _b3c
      );
    ...
    viewSetHasChildren: function () {
      ...
      dojo.html.setClass(
        this.domNode,
        dojo.html.getClass(this.domNode).replace(reg, "") + " " + _b3e
      );
      this.viewSetHasChildrenAndExpand();
    },
    viewSetHasChildrenAndExpand: function () {
      ...
      dojo.html.setClass(
        this.domNode,
        dojo.html.getClass(this.domNode).replace(reg, "") + " " + _b40
      );
    },
      ...
      while (true) {
        ...
        if (_b78 && _b78.length) {
          do {
            ...
            this.currentIndex++ < _b78.length &&
            !(_b76 = this.filterFunc.call(this.filterObj, next))
          );
          if (_b76) {
  ...
  },
  {
    ...
    onAfterTreeCreate: function (_b9a) {
      ...
      dojo.event.browser.addListener(
        tree.domNode,
        "onmousedown",
        dojo.lang.hitch(this, this.onTreeMouseDown)
      );
      dojo.event.browser.addListener(
        tree.domNode,
        "onclick",
      ...
      dojo.event.browser.addListener(
        tree.domNode,
        "onfocus",
        dojo.lang.hitch(this, this.onFocusTree)
      );
    ...
    collapseAll: function (_ba4) {
      ...
      var _ba6 = function (elem) {
        return (
          elem instanceof dojo.widget.Widget && elem.isFolder && elem.isExpanded
        );
      };
      if (_ba4.isTreeNode) {
    ...
    doEditLabelFinish: function (save, _bc0) {
      ...
      if (save) {
        ...
        if (node.isPhantom) {
          ...
          node.destroy();
          dojo.widget.TreeBasicControllerV3.prototype.doCreateChild.call(
            this,
            _bc4,
            _bc5,
            data
    ...
    makeDefaultNode: function (_bc7, _bc8) {
      ...
      return dojo.widget.TreeBasicControllerV3.prototype.doCreateChild.call(
        this,
        _bc7,
        _bc8,
        data
...
dojo.lang.extend(dojo.widget.TreeBasicControllerV3, {
  createAndEdit: function (_bd1, _bd2) {
...
dojo.lang.extend(dojo.widget.TreeBasicControllerV3, {
  canClone: function (_bd5, _bd6, _bd7, deep) {
    return true;
  },
...
dojo.lang.extend(dojo.widget.TreeBasicControllerV3, {
  ...
  destroyChild: function (node) {
    return this.runStages(
      this.canDestroyChild,
      this.prepareDestroyChild,
      this.doDestroyChild,
      this.finalizeDestroyChild,
      this.exposeDestroyChild,
      arguments
    );
  },
...
dojo.lang.extend(dojo.widget.TreeBasicControllerV3, {
  canMoveNotANode: function (_bec, _bed) {
    if (_bec.treeCanMove) {
  ...
  canMove: function (_bee, _bef) {
    ...
    if (
      _bee.parent !== _bef &&
      _bef.actionIsDisabledNow(_bef.actions.ADDCHILD)
    ) {
      return false;
    }
    var node = _bef;
...
dojo.lang.extend(dojo.widget.TreeBasicControllerV3, {
  canCreateChild: function (_bf9, _bfa, data) {
  ...
  createChild: function (_bfc, _bfd, data) {
    ...
    return this.runStages(
      this.canCreateChild,
      this.prepareCreateChild,
      this.doCreateChild,
      this.finalizeCreateChild,
      this.exposeCreateChild,
      [_bfc, _bfd, data]
    );
  },
...
dojo.widget.defineWidget(
  ...
  },
  {
    ...
    onAfterTreeCreate: function (_c05) {
...
dojo.widget.defineWidget(
  ...
  dojo.widget.HtmlWidget,
  {
    ...
    initialize: function () {
      ...
      dojo.event.topic.subscribe(
        this.selector.eventNames.deselect,
        this,
        "onDeselect"
      );
    },
...
dojo.lang.extend(dojo.dnd.TreeDropTargetV3, {
  ...
  showIndicator: function (_c4d) {
    ...
    node.contentNode.style.width =
      dojo.html.getBorderBox(node.labelNode).width + "px";
    if (_c4d == "onto") {
  ...
  onDragOver: function (e) {
    var _c50 = dojo.dnd.HtmlDropTarget.prototype.onDragOver.apply(
      this,
      arguments
    );
  ...
  getAcceptPosition: function (e, _c58) {
    ...
    for (var i = 0; i < _c58.length; i++) {
      ...
      if (
        !this.controller.canMove(
          _c5c.treeNode ? _c5c.treeNode : _c5c,
  ...
  getPosition: function (e, _c66) {
    ...
    var _c6a = "";
    if (
      _c66 & dojo.widget.TreeV3.prototype.DndModes.ONTO &&
      _c66 & dojo.widget.TreeV3.prototype.DndModes.BETWEEN
    ) {
      if (p <= 0.33) {
        _c6a = "before";
      } else {
        if (
          p <= 0.66 ||
          (this.treeNode.isExpanded &&
            this.treeNode.children.length &&
            !this.treeNode.isLastChild())
        ) {
          _c6a = "onto";
        } else {
          _c6a = "after";
  ...
  getTargetParentIndex: function (_c6b, _c6c) {
    var _c6d =
      _c6c == "before"
        ? this.treeNode.getParentIndex()
        : this.treeNode.getParentIndex() + 1;
    if (
      _c6b.treeNode &&
      this.treeNode.parent === _c6b.treeNode.parent &&
      this.treeNode.getParentIndex() > _c6b.treeNode.getParentIndex()
    ) {
      _c6d--;
    }
    return _c6d;
...
ps.aa.ObjectId = function (_c90) {
  ...
  this.belongsToTheSameItem = function (_c92) {
    ...
    return this.getRelationshipId() || _c92.getRelationshipId()
      ? this.getRelationshipId() === _c92.getRelationshipId()
      : this.getContentId() === _c92.getContentId();
  };
  ...
  this.getImagePath = function (path) {
    ...
    return (
      path +
      ps.aa.ObjectId.ImageNames[_c9c] +
      "_" +
      this.idobj[ps.aa.ObjectId.CHECKOUT_STATUS] +
      ".gif"
    );
  };
...
ps.aa.dnd = new (function () {
  ...
  this._fillDropTargetChildBoxesGaps = function (_cc2) {
    dojo.lang.forEach(_cc2, function (box) {
      ...
      dojo.lang.forEach(_cc2, function (box2) {
        ...
        if (
          Math.max(box.top, box2.top) < Math.min(box.bottom, box2.bottom) &&
        ...
        if (
          Math.max(box.left, box2.left) < Math.min(box.right, box2.right) &&
  ...
  this._assertValidPosition = function (_ce5) {
    dojo.lang.assert(
      _ce5 === this.POS_BEFORE ||
        _ce5 === this.POS_AFTER ||
        _ce5 === this.POS_APPEND,
      "Unrecognized position: " + _ce5
    );
  };
  this._getDropTargetChildBox = function (_ce6) {
    ...
    return {
      top: pos.y,
      bottom: pos.y + _ce8.height,
      left: pos.x,
      right: pos.x + _ce8.width,
      height: _ce8.height,
      width: _ce8.width,
      node: _ce6,
    };
...
ps.io.Actions = new (function () {
  ...
  this._normalizeNames = function (_d05) {
    if (
      typeof _d05 == "undefined" ||
      _d05 == null ||
      (typeof _d05 == "array" && empty(_d05))
    ) {
...
ps.aa.Menu = new (function () {
  ...
  this.actionVisibilityChecker = {
    ...
    isVisible: function (_dba) {
      ...
      if (_dbb == null) {
        var _dbc = ps.io.Actions.getActionVisibility(
          this.getNames(),
          this.m_currentId
        );
        if (!_dbc.isSuccess()) {
  ...
  this._updateIconMenuItem = function (_dc6) {
    this.menubarIcon.setImage(
      _dc6.getImagePath(ps.aa.controller.IMAGE_ROOT_PATH)
    );
    var _dc7 = "";
    if (_dc6.isFieldNode()) {
  ...
  this._addViewMenu = function (_dd5) {
    ...
    function createSubmenu() {
      var _dd7 = dojo.widget.createWidget(ps.aa.Menu.POPUPMENU, {
  ...
  this._addToolsMenu = function (_dd8) {
    var _dd9 = this;
    function createSubmenu() {
      var _dda = dojo.widget.createWidget(ps.aa.Menu.POPUPMENU, {
        id: "ps.aa.ToolSubMenu",
      });
      var _ddb = "View_Compare";
      _dd9.compare = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: _dd9.actionVisibilityChecker.getLabel(_ddb),
        onClick: function () {
      ...
      _dd9.showRelationships = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: _dd9.actionVisibilityChecker.getLabel(_ddb),
        onClick: function () {
      ...
      _dda.addChild(_ddc);
      _dd9.viewContent = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
      ...
      _dd9.viewProperties = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Properties",
        onClick: function () {
      ...
      _dd9.viewRevisions = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Revisions",
        onClick: function () {
      ...
      _dd9.viewAuditTrail = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Audit Trail",
        onClick: function () {
      ...
      if (ps.io.Actions.getLocaleCount() > 1) {
        _ddb = "Translate";
        _dd9.translate = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
          caption: _dd9.actionVisibilityChecker.getLabel(_ddb),
          onClick: function () {
      ...
      _dd9.createVersion = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: _dd9.actionVisibilityChecker.getLabel(_ddb),
        onClick: function () {
      ...
      _dd9.showUrl = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
      ...
      _ddb = "Publish_Now";
      _dd9.pubNow = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: _dd9.actionVisibilityChecker.getLabel(_ddb),
        onClick: function () {
  ...
  this._addContentMenu = function (_ddd) {
    var _dde = this;
    function createSubmenu() {
      var _ddf = dojo.widget.createWidget(ps.aa.Menu.POPUPMENU, {
        id: "ps.aa.ContentSubMenu",
      });
      _dde.contentNewElem = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Copy",
        onClick: function () {
      ...
      _dde.contentNewItemElem = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "New",
        onClick: function () {
  ...
  this._addAccountMenu = function (_de0) {
    var _de1 = this;
    function createSubmenu() {
      var _de2 = dojo.widget.createWidget(ps.aa.Menu.POPUPMENU, {
        id: "ps.aa.AccountSubMenu",
      });
      _de1.accountUserInfoElem = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "User Info",
        onClick: function () {
      ...
      _de1.accountLogoutElem = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Logout",
        onClick: function () {
  ...
  this._addEditMenu = function (_de3) {
    var _de4 = this;
    function createSubmenu() {
      var _de5 = dojo.widget.createWidget(ps.aa.Menu.POPUPMENU, {
        id: "ps.aa.EditSubMenu",
      });
      _de4.editAllElem = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
      ...
      _de4.editFieldElem = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Field",
        onClick: function () {
      ...
      _de4.removeElem = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Remove",
        onClick: function () {
  ...
  this._addHelpMenu = function (_de6) {
    var _de7 = this;
    function createSubmenu() {
      var _de8 = dojo.widget.createWidget(ps.aa.Menu.POPUPMENU, {
    ...
    var _de9 = dojo.widget.createWidget(ps.aa.Menu.MENUBARITEMDROPDOWN, {
      caption: "Help",
  ...
  this._addPreviewMenu = function (_dea) {
    var _deb = this;
    function createSubmenu() {
      var _dec = dojo.widget.createWidget(ps.aa.Menu.POPUPMENU, {
  ...
  this._addNavigationMenu = function (_ded) {
    var _dee = this;
    function createSubmenu() {
      var _def = dojo.widget.createWidget(ps.aa.Menu.POPUPMENU, {
    ...
    this.nav = dojo.widget.createWidget(ps.aa.Menu.MENUBARITEMDROPDOWN, {
      caption: "Navigation",
      submenuId: "ps.aa.NavigationSubMenu",
    });
  ...
  (this._initContextMenu = function (ids) {
    ...
    _df2.createMenuItems = function () {
      _df1.ctxNewSnippet = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "New Snippet...",
        onClick: function () {
      ...
      _df1.ctxAddSnippet = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Insert Snippet...",
        onClick: function () {
          ps.aa.controller.addSnippet(ps.aa.Menu.INSERT_FROM_SLOT);
        },
      ...
      _df1.ctxRemoveSnippet = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
    ...
    _df3.createMenuItems = function () {
      _df1.ctxChangeTemplate = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Template...",
        onClick: function () {
          ps.aa.controller.changeTemplate();
        },
      ...
      _df1.ctxUp = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Up",
        onClick: function () {
          ps.aa.controller.moveSnippetUp();
        },
      ...
      _df1.ctxDown = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Down",
        onClick: function () {
          ps.aa.controller.moveSnippetDown();
        },
      ...
      _df1.ctxRemove = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Remove",
        onClick: function () {
          ps.aa.controller.removeSnippet();
        },
      ...
      _df1.ctxItemSeparator1 = dojo.widget.createWidget(
        ps.aa.Menu.MENUSEPARATOR
      );
      _df3.addChild(_df1.ctxItemSeparator1);
      _df1.ctxNewFromSnippet = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "New...",
        onClick: function () {
      ...
      _df1.ctxInsertFromSnippet = dojo.widget.createWidget(
        ps.aa.Menu.MENUITEM,
        {
          caption: "Insert...",
          onClick: function () {
      ...
      _df1.ctxReplaceFromSnippet = dojo.widget.createWidget(
        ps.aa.Menu.MENUITEM,
        {
          caption: "Replace...",
          onClick: function () {
      ...
      _df1.ctxItemSeparator2 = dojo.widget.createWidget(
        ps.aa.Menu.MENUSEPARATOR
      );
      _df3.addChild(_df1.ctxItemSeparator2);
      _df1.ctxOpenFromSnippet = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Open",
        onClick: function () {
      ...
      _df1.ctxWorkflow = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Workflow...",
        onClick: function () {
          ps.aa.controller.workflowItem();
        },
      ...
      _df1.ctxEditField = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
        caption: "Edit Field",
        onClick: function () {
          ps.aa.controller.editField();
        },
      ...
      _df1.ctxEditAll = dojo.widget.createWidget(ps.aa.Menu.MENUITEM, {
...
ps.UserInfo = new (function () {
  ...
  this._getUserInfoDialog = function () {
    this._userInfoDlg = ps.createDialog(
      { id: "ps.UserInfoDlg", title: "User Info" },
      "420px",
      "150px"
    );
...
ps.aa.Tree = function () {
  ...
  this._sort = function (_e24) {
    if (_e24 != null && !_e24.isLeafNode()) {
      _e24.childNodes.sort(function (o1, o2) {
        ...
        if (
          (o1.objId.isFieldNode() && o2.objId.isFieldNode()) ||
  ...
  this._getParentPageSnippet = function (_e3e, _e3f) {
    ...
    while (_e40) {
      if (
        (_e40.isPageNode() || _e40.isSnippetNode()) &&
        _e40.objId.getContentId() == _e3e.objId.getContentId()
      ) {
        return _e40;
      } else {
  ...
  this._getParentSlot = function (_e45, _e46) {
    ...
    while (_e47) {
      if (
        _e47.isSlotNode() &&
        _e47.objId.getSlotId() == _e45.objId.getSlotId() &&
        _e47.objId.getContentId() == _e45.objId.getParentId()
      ) {
        return _e47;
      } else {
  ...
  this._getFieldIdsByContentIdName = function (_e62, _e63, _e64, _e65) {
    ...
    for (var i = 0; i < _e64.childNodes.count; i++) {
      ...
      if (
        node.isFieldNode() &&
        node.objId.getContentId() == _e62 &&
        node.objId.getFieldName() == _e63
      ) {
        _e65.add(node.objId);
      } else {
        if (!node.isLeafNode()) {
      ...
      if (this.parentNode == null) {
        ...
        if (this.childNodes == null) {
          return (
            ...
            "\n" +
            "parent = " +
            this.parentNode.objId.serialize()
          );
        } else {
          return (
            "id = " +
...
ps.widget.ContentPaneProgress = function (_e94) {
  dojo.lang.assert(
    _e94 && _e94.onDownloadStart && _e94.onDownloadEnd,
...
ps.util.CreatePromptDialog = function (_ef3) {
  ...
  dojo.event.connect(this.wgtDlg, "onLoad", function () {
    ...
    _ef4.wgtButtonOk.onClick = function () {
      if (
        _ef4.textRequired &&
        ps.util.trim(_ef4.wgtPromptText.value).length < 1
      ) {
  ...
  var _ef6 =
    ...
    "</div>" +
    "<div>" +
    "<input id='ps.util.promptInput' type='text' size='60' value='" +
    this.promptText +
    "' /></div>" +
    "<br />" +
    "<div class='PsAaButtonBox'>" +
    "<button dojoType='ps:PSButton' id='ps.util.promptButtonCancel'>" +
    this.cancelBtnText +
    "</button>" +
    "<button dojoType='ps:PSButton' id='ps.util.promptButtonSelect'>" +
    this.okBtnText +
    "</button>" +
    "</div>";
  ...
  for (var i = 0; i < _efe.length; i++) {
    ...
    if (_f00.length > 0) {
      for (var j = 0; j < _f00.length; j++) {
        ...
        if (
          _f00[j].selectorText &&
          ps.util.trim(_f00[j].selectorText).toLowerCase() == _efa
        ) {
...
dojo.declare(
  ...
  },
  {
    ...
    _handleTemplateOk: function () {
      ...
      var _f27 = ps.io.Actions.resolveSiteFolders(
        this._getUISiteName(),
      ...
      if (
        this.parent.mode == ps.util.BROWSE_MODE_ACTIVE_ASSEMBLY ||
        this.parent.mode == ps.util.BROWSE_MODE_ACTIVE_ASSEMBLY_TABLE_EDITOR
      ) {
        var _f27 = ps.io.Actions.addSnippet(
          _f26,
          _f29,
          this._getUIFolderPath(),
          this._getUISiteName()
    ...
    _filterContentTable: function () {
      var _f39 = this;
      this.contentTable.setFilter(
        psxGetLocalMessage("javascript.ps.content.browse@Name"),
        function (_f3a) {
          var str = _f3a.toLowerCase();
          var _f3c = _f39.filterText.value.toLowerCase();
          return (
            dojo.string.isBlank(_f3c) ||
            _f39._getCellText(str).indexOf(_f3c) !== -1
          );
        }
      );
    },
    ...
    _setNameImages: function (rows) {
      ...
      var _f6f =
        _f6e + this.parent.rxroot + '/sys_resources/images/folder.gif"/>&nbsp;';
      var _f70 =
        _f6e + this.parent.rxroot + '/sys_resources/images/item.gif"/>&nbsp;';
      var _f71 = this;
    ...
    _loadTemplatesPanel: function (_f86) {
      ...
      if (!this.isFolderTab()) {
        ...
        var _f87 =
          __rxroot +
          "/ui/content/sitefolderparam.jsp" +
          "?idPrefix=" +
      ...
      var _f87 =
        __rxroot +
        "/ui/content/selecttemplate.jsp" +
        "?noButtons=false&objectId=" +
        escape(_f86.serialize());
    ...
    _onTemplatesSiteFolderParamLoaded: function () {
      var _f8f = ps.util.getServerProperty(
        "slotContentIncludeSiteDefaultValue",
        ""
      );
      var _f90 = ps.util.getServerProperty(
...
dojo.declare(
  ...
  },
  {
    ...
    loadSearchForm: function () {
      ...
      if (
        this.searchformPanel.slotId &&
        this.searchformPanel.slotId.serialize() === _fb9.serialize()
      ) {
        return;
      }
    ...
    _parseFilterPanelControls: function () {
      ...
      this.filterText = this._getElemById("filterText");
      dojo.event.connect(this.filterText, "onkeyup", this, "_onFilterTyped");
      var _fbf = ps.util.getServerProperty(
        "slotContentIncludeSiteDefaultValue",
        ""
      );
      var _fc0 = ps.util.getServerProperty(
        "slotContentIncludeFolderDefaultValue",
        ""
      );
      if (_fbf == "true") {
...
ps.widget.ScrollableNodes = function () {
  ...
  this._overElement = function (_fde, e) {
    ...
    return (
      e.clientX >= _fe0.left &&
      e.clientX <= _fe0.right &&
      e.clientY >= _fe0.top &&
      e.clientY <= _fe0.bottom
    );
  };
};
...
ps.widget.Autoscroller = function () {
  ...
  this._doScroll = function () {
    ...
    var _fee =
      _fec !== this.element.scrollLeft || _fed !== this.element.scrollTop;
    if (_fee) {
...
dojo.widget.defineWidget("dojo.widget.Button", dojo.widget.HtmlWidget, {
  isContainer: true,
  caption: "",
  templatePath: dojo.uri.moduleUri(
    "dojo.widget",
...
dojo.widget.defineWidget("dojo.widget.DropDownButton", dojo.widget.Button, {
  menuId: "",
  ...
  _sizeMyselfHelper: function () {
    this.arrow.src = dojo.uri.moduleUri(
      "dojo.widget",
      this.disabled ? this.disabledDownArrow : this.downArrow
    );
...
dojo.widget.defineWidget("dojo.widget.ComboButton", dojo.widget.Button, {
  menuId: "",
  templatePath: dojo.uri.moduleUri(
    "dojo.widget",
    "templates/ComboButtonTemplate.html"
  ),
  splitWidth: 2,
  arrowWidth: 5,
  _sizeMyselfHelper: function (e) {
    var mb = dojo.html.getMarginBox(this.containerNode);
    this.height = mb.height;
    this.containerWidth = mb.width;
    ...
    this.leftImage.height =
      this.rightImage.height =
      this.centerImage.height =
      this.arrowBackgroundImage.height =
        this.height;
    ...
    this.domNode.style.height = this.height + "px";
    var _1013 =
      this.containerWidth + this.splitWidth + this.arrowWidth + 2 * _1012;
  ...
  _setImageR: function (_101a) {
    this.arrowBackgroundImage.src = dojo.uri.moduleUri(
      "dojo.widget",
      _101a + "c.gif"
    );
...
ps.aa.controller = new (function () {
  ...
  this.toggleTreePane = function (_1032) {
    ...
    if (!_1032) {
      ...
      if (wg.sizeShare < 1) {
        wg.sizeShare =
          this.lastShowingTreePaneWidth > this.MIN_TREE_WIDTH
            ? this.lastShowingTreePaneWidth
            : 290;
      }
    }
  ...
  this.addSnippet = function (_1055) {
    ...
    switch (_1055) {
      case ps.aa.Menu.INSERT_FROM_SLOT:
        var _1057 = dojo.html.getElementsByClass(
          "PsAaSnippet",
  ...
  this.openRemoveSnippetsDlg = function () {
    var _1065 = dojo.html.getElementsByClass(
      "PsAaSnippet",
      document.getElementById(this.activeId.toString()),
      "div",
      dojo.html.classMatchType.IsOnly,
  ...
  this.createItem = function (_1069) {
    ...
    if (parent.newItemWindow && !parent.newItemWindow.closed) {
      ...
      if (
        this.fieldEdit.psCeFieldWindow &&
        !this.fieldEdit.psCeFieldWindow.closed
      ) {
    ...
    switch (_1069) {
      case ps.aa.Menu.NEW_FROM_SLOT:
        var _106d = dojo.html.getElementsByClass(
          "PsAaSnippet",
          document.getElementById(this.activeId.toString()),
          "div",
          dojo.html.classMatchType.IsOnly,
        ...
        if (_106d.length < 1) {
          ...
          this.snippetPickerDlg.open(
            function (_106e, relId, _1070) {
              _this._openNewItemDlg(
                _106e,
                _this._getSnippetIdFromRelId(_106e, relId),
                _1070
              );
            },
            function () {},
      ...
      case ps.aa.Menu.NEW_FROM_SNIPPET:
        ...
        this.snippetPickerDlg.open(
          function (_1074, relId, _1076) {
            _this._openNewItemDlg(
              _1074,
              _this._getSnippetIdFromRelId(_1074, relId),
              _1076
            );
          },
          function () {},
      ...
      case ps.aa.Menu.COPY_FROM_CONTENT:
        ...
        var _107d = {
          sys_contenttypeid: _1071.getContentTypeId(),
          sys_templateid: _1071.getTemplateId(),
          folderPath: fpath,
          itemPath: ipath,
          itemTitle: "",
        };
  ...
  this._handleCopyItem = function (_107e, _107f) {
    ...
    var _1085 = {
      ...
      promptTitle: "Title",
      promptText: _107f.itemTitle,
      textRequired: true,
      okBtnText: "Create",
      cancelBtnText: "Cancel",
      okBtnCallBack: _1081,
      cancelBtnCallBack: _1084,
    };
  ...
  this._getSnippetIdFromRelId = function (_1086, relId) {
    ...
    var _1088 = null;
    if (relId != null) {
      var _1089 = dojo.html.getElementsByClass(
        "PsAaSnippet",
        document.getElementById(_1086.toString()),
        "div",
        dojo.html.classMatchType.IsOnly,
        false
      );
  ...
  this._openNewItemDlg = function (_108c, _108d, _108e) {
    ...
    this.createItemDlg.open(
      function (_1090, _1091, _1092, _1093) {
  ...
  this.handleCreateItem = function (_1094, _1095, _1096, _1097) {
    var _1098 = ps.io.Actions.createItem(
      _1097.sys_contenttypeid,
      _1097.folderPath,
      _1097.itemPath,
      _1097.itemTitle
    );
    ...
    if (dojo.lang.has(obj, "validationError")) {
      ...
      var _109a = ps.io.Actions.getCreateItemUrl(
        _1097.folderPath,
        _1097.sys_contenttypeid,
        false
      );
  ...
  this.previewWithCurrentRevisions = function () {
    ...
    this.openWindow(
      "PREVIEW_PAGE",
      this.PREVIEW_WINDOW_STYLE,
      this._previewObjIdFromParamMap(_10b7),
  ...
  this.previewWithEditRevisions = function () {
    ...
    this.openWindow(
      "PREVIEW_MYPAGE",
      this.PREVIEW_WINDOW_STYLE,
      this._previewObjIdFromParamMap(_10b8),
      this.PREVIEW_WINDOW_NAME,
      _10b9
    );
  };
  ...
  this.editAll = function (_10f6) {
    ...
    if (
      ...
      if (this.psCeWindow && !this.psCeWindow.closed) {
        if (
          this.activeId.getContentId() == this.editObjectId.getContentId() ||
          !confirm(ps.aa.controller.EDITOROPEN_MSG)
        ) {
  ...
  this.moveToSlot = function (move) {
    ...
    var _1128 = ps.io.Actions.moveToSlot(
      move.getSnippetId(),
  ...
  this._handleMoveToSlotResponse = function (_112a, move) {
    ...
    if (_112a.isSuccess()) {
      ...
      if (_112a.getValue() === ps.io.Actions.NEEDS_TEMPLATE_ID) {
        if (
          move.getSnippetId().getTemplateId() !==
          move.getTargetSnippetId().getTemplateId()
        ) {
          ps.error("Template was already changed!");
          return false;
        }
        var _112a = ps.io.Actions.getAllowedSnippetTemplates(
  ...
  this.maybeRefreshMovedSnippetNode = function (move, moved) {
    ...
    if (moved) {
      if (move.getDontUpdatePage()) {
        ...
        if (
          move.getSlotId().getSlotId() !== move.getTargetSlotId().getSlotId()
        ) {
  ...
  this.reorderSnippetInSlot = function (_1139, _113a) {
    ...
    dojo.lang.assert(
      dojo.lang.isNumeric(_113a),
      "Can't be interpreted as number: \"" + _113a + '"'
    );
  ...
  this._toggleMenuBarBackGround = function (_1161) {
    if (this.menuBarStyle) {
      if (_1161) {
        this.menuBarStyle.background =
          "#85aeec url(../sys_resources/images/aa/soriaBarBg.gif) repeat-x top left";
      } else {
        this.menuBarStyle.background =
          "#85aeec url(../sys_resources/images/aa/soriaBarBgDisabled.gif) repeat-x top left";
      }
    }
  };
  this.openHelpWindow = function (_1162) {
    dojo.lang.assert(
      _1162 === ps.aa.Menu.AAHELP ||
        _1162 === ps.aa.Menu.AATUTORIAL ||
        _1162 === ps.aa.Menu.AAABOUT,
      "Unexpected windowName " + _1162
    );
  ...
  this.CHECKOUT_MSG =
    "The item is not checked out to you, please check out the item to edit the field.";
  this.EDITOROPEN_MSG =
    "A window is already open for editing another field. Do you want to abort the changes to the open field and activate the field you have selected?";
  this.SNIPPETOPEN_MSG =
    "A window is already open for editing another " +
    "snippet. Do you want to replace it with current snippet?";
  this.snippetOpenWindow = null;
  this.INPLACE_EDITOROPEN_MSG =
    "A field is already open for editing. Do you want to abort the changes to the open field and activate the field you have selected?";
  this._SELECT_TEMPLATE_DLG_ID = "selectTemplateDialog";
  this.CE_WINDOW_NAME = "Ce_Window";
  this.BASIC_WINDOW_STYLE =
    "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1";
  this.PREVIEW_WINDOW_NAME = "Preview_Window";
  this.PREVIEW_WINDOW_STYLE =
    "toolbar=0,location=0,directories=0,status=1,menubar=0,scrollbars=1,resizable=1,width=800,height=700";
...
ps.workflow.WorkflowActions = function () {
  ...
  this.workflowActionsUrl =
    "/Rhythmyx/ui/activeassembly/workflow/workflowactions.jsp";
  this.adhocSearchUrl = "/Rhythmyx/ui/activeassembly/workflow/adhocsearch.jsp";
  this.adhocResultsUrl =
    "/Rhythmyx/ui/activeassembly/workflow/adhocresults.jsp";
  this.init = function () {};
  this.maybeCreateWorkflowDialog = function () {
    ...
    this.wfDlg = ps.createDialog(
      { id: "ps.workflow.WorkflowActionsDlg", title: "Workflow Actions" },
      "420px",
      "250px"
    );
    var _this = this;
  ...
  this.openAdhocSearchDialog = function () {
    ...
    dojo.event.connect(this.adhocSearchPane, "onLoad", function () {
      ...
      if (
        !dojo.html.hasClass(_this.wgtButtonAdd.domNode, "dojoButtonDisabled")
      ) {
  ...
  this._maybeCreateAdhocSearchDialog = function () {
    ...
    this.wfAdhocPane = dojo.widget.createWidget(
      "ContentPane",
      { titleBarDisplay: false, executeScripts: true },
      div
    );
  ...
  this.executeWorkflowAction = function () {
    ...
    if (
      atype == ps.workflow.ActionId.ACTION_TYPE_CHECKIN ||
      atype == ps.workflow.ActionId.ACTION_TYPE_FORCE_CHECKIN
    ) {
      ...
      if (atype == ps.workflow.ActionId.ACTION_TYPE_CHECKOUT) {
        ...
        if (atype == ps.workflow.ActionId.ACTION_TYPE_TRANSITION_CHECKOUT) {
          _1174 = ps.io.Actions.transitionCheckOutItem(
            this.contentId,
          ...
          _1174 = ps.io.Actions.transitionItem(
            this.contentId,
            this.actionId.getWfAction(),
            this._getComment(),
            this._getAdhocUsers()
          ...
          if (
            ...
            ps.aa.controller.activeId.isCheckoutByMe()
          ) {
            _1175 = true;
            _1176 = "0";
          }
...
ps.aa.Field = function () {
  ...
  this.maybeCreateFieldModalDlg = function () {
    ...
    this.fieldModalDlg = ps.createDialog(
      { id: "ps.Field.FieldEditingDlg", title: "Edit Field" },
      "200px",
      "100px"
    );
    var _this = this;
  ...
  (this.editField = function (_11a0, e) {
    ...
    var dlgh = value.dlg_height
      ? value.dlg_height
      : this.DEFAULT_CONTROL_HEIGHT;
    this.renderer = value.aarenderer
      ? value.aarenderer
      : this.DEFAULT_FIELD_RENDERER;
    ...
    if (this.renderer == this.FIELD_RENDERER_MODAL) {
      ...
      if (dojo.lang.has(value, "cmsError")) {
        ...
        if (dojo.lang.has(value, "validationError")) {
          ...
          this.initialCheckSum = ps_getAllFieldChecksums(
            document.EditForm,
            true
          );
        }
      ...
      if (this.renderer == this.FIELD_RENDERER_INPLACE_TEXT) {
        var _11b1 = ps.io.Actions.setContentEditorFieldValue(
          this.objectId,
  ...
  this.FORM_CHANGE_WARNING_FOR_CLOSING =
    "Changes have been made.\nDo you want to save before closing?";
  this.FORM_CHANGE_WARNING_FOR_FULLEDITOR =
    "Changes have been made.\nDo you want to save before opening full editor?";
  this.FIELD_RENDERER_NONE_MESSAGE =
    "The source of the data comes from a hidden field.\nIt can probably be modified by editing another field in the content item.\n\nClick OK to open the full editor.";
};
dojo.kwCompoundRequire({
  common: [
    "ps.aa.controller",
...
dojo.widget.defineWidget("ps.widget.PopupMenu", dojo.widget.PopupMenu2, {
  bindTargetNodes: function (_11b7) {
...
dojo.widget.defineWidget("ps.widget.Tree", dojo.widget.TreeV3, {
  ...
  createWidgetFromModelNode: function (_11c1) {
    dojo.lang.assertType(_11c1, ps.aa.TreeNode);
    var title = _11c1.getLabel();
    var _11c3 = _11c1.objId.getTreeNodeWidgetId();
    var _11c4 = dojo.widget.createWidget("TreeNodeV3", {
      title: title,
      tree: this.widgetId,
      id: _11c3,
      modelId: _11c1.objId,
      tryLazyInit: true,
      isFolder: !_11c1.isLeafNode(),
    });
    var _this = this;
  ...
  _bindContextMenu: function (_11ce) {
    ...
    if (objId.isSlotNode()) {
      if (ps.aa.Menu.slotCtxMenu) {
        ...
        dojo.lang.assert(
          !this.indexOfSupported ||
            this.delayedInitSlotNodes.indexOf(_11ce.domNode) === -1,
          "Slot node is registered more than once: " + _11ce.domNode
        );
      ...
      if (ps.aa.Menu.itemCtxMenu) {
        ...
        dojo.lang.assert(
          !this.indexOfSupported ||
            this.delayedInitItemNodes.indexOf(_11ce.domNode) === -1,
          "Snippet node is registered more than once: " + _11ce.domNode
        );
  ...
  dndInit: function () {
    ...
    var _11d8 = dojo.widget.createWidget("ps:TreeDndController", {
...
dojo.experimental(
  "Tree drag'n'drop' has lots of problems/bugs, it requires dojo drag'n'drop overhaul to work, probably in 0.5"
);
dojo.widget.defineWidget(
  ...
  },
  {
    ...
    initialize: function (args) {
      this.treeController = dojo.lang.isString(args.controller)
        ? dojo.widget.byId(args.controller)
        : args.controller;
    ...
    makeDragSource: function (node) {
      return new dojo.dnd.TreeDragSourceV3(
        node.contentNode,
        this,
        node.tree.widgetId,
        node
    ...
    makeDropTarget: function (node) {
      return new dojo.dnd.TreeDropTargetV3(
        node.contentNode,
        this.treeController,
        node.tree.DndAcceptTypes,
        node
      );
    },
    unlistenNode: function (node) {
      if (this.dragSources[node.widgetId]) {
        dojo.dnd.dragManager.unregisterDragSource(
          this.dragSources[node.widgetId]
        );
        delete this.dragSources[node.widgetId];
      }
      if (this.dropTargets[node.widgetId]) {
        dojo.dnd.dragManager.unregisterDropTarget(
          this.dropTargets[node.widgetId]
        );
...
dojo.io.ScriptSrcTransport = new (function () {
  ...
  this.startWatchingInFlight = function () {
    if (!this.inFlightTimer) {
      this.inFlightTimer = setInterval(
        "dojo.io.ScriptSrcTransport.watchInFlight();",
        100
      );
    }
  };
      ...
      if (_122d.isDone) {
        ...
        if (!_122d.isFinishing) {
          ...
          try {
            if (
              _122d.checkString &&
              eval("typeof(" + _122d.checkString + ") != 'undefined'")
            ) {
              ...
              if (_122e.timeoutSeconds && _122e.timeout) {
                if (
                  _122d.startTime + _122e.timeoutSeconds * 1000 <
                  new Date().getTime()
                ) {
                  _122d.isFinishing = true;
            ...
            _122d.isFinishing = true;
            this._finish(_122d, "error", {
              status: this.DsrStatusCodes.Error,
              response: e,
            });
          }
        }
  ...
  this.canHandle = function (_122f) {
    return (
      dojo.lang.inArray(
        ["text/javascript", "text/json", "application/json"],
        _122f["mimetype"].toLowerCase()
      ) &&
      _122f["method"].toLowerCase() == "get" &&
      !(_122f["formNode"] && dojo.io.formHasFile(_122f["formNode"])) &&
      (!_122f["sync"] || _122f["sync"] == false) &&
      !_122f["file"] &&
      !_122f["multipart"]
    );
  };
  ...
  this.bind = function (_1234) {
    ...
    if (_1234.postContent) {
      ...
      if (_123b) {
        query +=
          (query ? "&" : "") +
          dojo.io.argsFromMap(_123b, _1234.encoding, _123c);
      }
    }
    if (_1234["apiId"]) {
    ...
    state.constantParams =
      _1234["constantParams"] == null ? "" : _1234["constantParams"];
    if (
      _1234["preventCache"] ||
      (this.preventCache == true && _1234["preventCache"] != false)
    ) {
    ...
    var _123f =
      state.url.length +
      state.query.length +
      state.constantParams.length +
      state.nocacheParam.length +
      this._extraPaddingLength;
    ...
    if (
      ...
      _1234["useRequestId"] &&
      !state["jsonp"] &&
      !_1234["forceSingleRequest"] &&
      _123f > this.maxUrlLength
    ) {
      if (url > this.maxUrlLength) {
        this._finish(state, "error", {
          status: this.DsrStatusCodes.Error,
          statusText: "url.tooBig",
        });
        return;
      } else {
  ...
  this._multiAttach = function (state, part) {
    ...
    if (_124d) {
      ...
      if (_124f > eqEnd || eqEnd == _124c - 1) {
        ...
        state.query =
          _1251 + "=" + state.query.substring(_124c, state.query.length);
      }
    }
    var _1252 = [
      _124e,
    ...
    if (_1255 != "partOk" && !state.kwArgs[_1255] && !state.kwArgs["handle"]) {
      ...
      switch (_1255) {
        case "load":
          ...
          state.kwArgs[
            typeof state.kwArgs.load == "function" ? "load" : "handle"
          ]("load", _1257, event, state.kwArgs);
          state.isDone = true;
          break;
        case "partOk":
        ...
        case "error":
          state.kwArgs[
            typeof state.kwArgs.error == "function" ? "error" : "handle"
          ]("error", event.response, event, state.kwArgs);
          state.isDone = true;
          break;
        default:
          state.kwArgs[
            typeof state.kwArgs[_1255] == "function" ? _1255 : "handle"
          ](_1255, event, event, state.kwArgs);
          state.isDone = true;
      }
    }
  };
  ...
  if (_125b._state[event.id]) {
    ...
    if (state == null) {
      ...
      for (var i = 0; _125e && i < _125e.length; i++) {
        var _1260 = _125e[i];
        if (
          _1260.getAttribute("class") == "ScriptSrcTransport" &&
          _1260.src == event.id
        ) {
...
dojo.declare("sos.widget.ImageGallery", dojo.widget.HtmlWidget, {
  ns: "sos",
  ...
  templateString:
    "<div dojoAttachPoint='outerNode' class='image-gallery-wrapper'>" +
  ...
  init: function () {
    ...
    if (!this.thumbCells) {
      ...
      for (var i = 0; i < this.numberThumbs + 2; i++) {
        ...
        cell.innerHTML =
          "<img src='" + this.tempImgPath + "' class='image-gallery-thumb'/>";
  ...
  loadNextThumbnail: function () {
    ...
    dojo.event.browser.addListener(img, "onload", function () {
      ...
      if (
        pos >= _1282.thumbIndex &&
        pos < _1282.thumbIndex + _1282.numberThumbs
      ) {
        _1282.showThumbs();
      }
  ...
  loadNextImage: function () {
    while (
      this.images.length >= this.imageCounter &&
      this.images[this.imageCounter]
    ) {
      this.imageCounter++;
    }
  ...
  showImage: function (index, _1295) {
    ...
    if (_1297 && _1297.length > 0) {
      dojo.lfx.html
        .fadeOut(_1297[0], 300, null, function () {
...
dojo.declare("sos.widget.FlickrImageGallery", sos.widget.ImageGallery, {
  ...
  generatePagingLinks: function () {
    ...
    var html = [
      "<ul id='" + this.widgetId + "_pageLinks'>",
      "<li>Pages: </li>",
    ];
    var _129e =
      "<li><a href='#' onclick='dojo.widget.byId(\"" +
      this.widgetId +
      '").setPage(';
    var _129f = "</a></li>";
    if (first > 1) {
  ...
  initSetMenus: function (data) {
    if (arguments.length == 0) {
      url =
        "http://www.flickr.com/services/rest/?method=flickr.photosets.getList&format=json&api_key=" +
        this.flickrApiKey +
        "&user_id=" +
        this.flickrUserId;
      var _12bc = this;
...
dojo.widget.defineWidget("ps.widget.PSImageGallery", sos.widget.ImageGallery, {
  templateString:
    "<div dojoAttachPoint='outerNode' class='image-gallery-wrapper'>" +
    "<div dojoAttachPoint='largeNode' class='image-gallery-image-wrapper'></div>" +
    "<div dojoAttachPoint='thumbsNode' class='image-gallery-thumbs-wrapper'>" +
