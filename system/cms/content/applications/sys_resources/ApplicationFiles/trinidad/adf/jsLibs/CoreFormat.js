function TrIntegerConverter(a0, a1, a2, a3, a4) {
  this._message = a0;
...
TrIntegerConverter.prototype.getAsString = function (a5, a6) {
  return "" + a5;
};
TrIntegerConverter.prototype.getAsObject = function (a7, a8) {
  return _decimalParse(
    a7,
    this._message,
...
function TrLongConverter(a0, a1, a2, a3, a4) {
  this._message = a0;
  this._maxPrecision = a1;
  this._maxScale = a2;
  this._maxValue = a3;
...
TrLongConverter.prototype.getAsString = function (a5, a6) {
  return "" + a5;
};
TrLongConverter.prototype.getAsObject = function (a7, a8) {
  return _decimalParse(
    a7,
    this._message,
...
function TrShortConverter(a0, a1, a2, a3, a4) {
  this._message = a0;
  this._maxPrecision = a1;
  this._maxScale = a2;
  this._maxValue = a3;
...
TrShortConverter.prototype.getAsString = function (a5, a6) {
  return "" + a5;
};
TrShortConverter.prototype.getAsObject = function (a7, a8) {
  return _decimalParse(
    a7,
    this._message,
...
function TrByteConverter(a0, a1, a2, a3, a4) {
  this._message = a0;
  this._maxPrecision = a1;
  this._maxScale = a2;
  this._maxValue = a3;
...
TrByteConverter.prototype.getAsString = function (a5, a6) {
  return "" + a5;
};
TrByteConverter.prototype.getAsObject = function (a7, a8) {
  return _decimalParse(
    a7,
    this._message,
...
function TrDoubleConverter(a0, a1, a2, a3, a4) {
  this._message = a0;
  this._maxPrecision = a1;
  this._maxScale = a2;
  this._maxValue = a3;
...
TrDoubleConverter.prototype.getAsString = function (a5, a6) {
  return "" + a5;
};
TrDoubleConverter.prototype.getAsObject = function (a7, a8) {
  return _decimalParse(
    a7,
    this._message,
...
function TrFloatConverter(a0, a1, a2, a3, a4) {
  this._message = a0;
  this._maxPrecision = a1;
  this._maxScale = a2;
  this._maxValue = a3;
...
TrFloatConverter.prototype.getAsString = function (a5, a6) {
  return "" + a5;
};
TrFloatConverter.prototype.getAsObject = function (a7, a8) {
  return _decimalParse(
    a7,
    this._message,
...
function TrRangeValidator(a0, a1, a2) {
  this._maxValue = a0;
  this._minValue = a1;
  this._messages = a2;
...
TrRangeValidator.prototype.getHints = function (a3) {
...
TrRangeValidator.prototype.validate = function (a4, a5, a6) {
  string = "" + a4;
    ...
    if (this._minValue != null) {
      if (numberValue >= this._minValue) {
        ...
        if (this._messages && this._messages["min"]) {
          ...
          a7 = _createFacesMessage(a8, a5, string, "" + this._minValue);
        }
      }
    } else {
      if (this._maxValue == null || numberValue <= this._maxValue) {
        ...
        if (this._messages && this._messages["max"]) {
          ...
          a7 = _createFacesMessage(a8, a5, string, "" + this._maxValue);
        }
      }
    }
  }
...
function TrLengthValidator(a0, a1, a2) {
  this._maxValue = a0;
  this._minValue = a1;
  this._messages = a2;
...
TrLengthValidator.prototype.getHints = function (a3) {
  return _returnRangeHints(
    this._messages,
    this._maxValue,
    this._minValue,
...
TrLengthValidator.prototype.validate = function (a4, a5, a6) {
  var a7 = "" + a4;
  var a8 = a7.length;
  if (
    a8 >= this._minValue &&
    ...
    if (this._minValue > 0 && this._maxValue != null) {
      ...
      if (this._messages && this._messages["min"]) {
        ...
        a11 = _createFacesMessage(a10, a5, a7, "" + this._minValue);
      }
      throw new TrConverterException(a11);
    } else {
      ...
      if (this._messages && this._messages["max"]) {
        ...
        a11 = _createFacesMessage(a10, a5, a7, "" + this._maxValue);
      }
      throw new TrConverterException(a11);
    }
  }
};
function TrDateTimeRangeValidator(a0, a1, a2) {
  this._maxValue = a0;
  this._minValue = a1;
  this._messages = a2;
...
TrDateTimeRangeValidator.prototype.getHints = function (a3) {
  var a4 = null;
  var a5 = null;
  if (this._maxValue) a4 = a3.getAsString(new Date(this._maxValue));
  if (this._minValue) a5 = a3.getAsString(new Date(this._minValue));
  return _returnRangeHints(
    this._messages,
    a4,
    a5,
...
TrDateTimeRangeValidator.prototype.validate = function (a6, a7, a8) {
  dateTime = a6.getTime();
  var a9;
  if (this._minValue && this._maxValue) {
...
function TrDateRestrictionValidator(a0, a1, a2) {
...
TrDateRestrictionValidator.prototype.getHints = function (a3) {
  ...
  return _returnHints(
    ...
    !this._weekdaysValue
      ...
      : this._translate(
          a4,
          this._translatedWeekdaysMap,
          a3.getLocaleSymbols().getWeekdays()
        ),
    !this._monthValue
      ? this._monthValue
      : this._translate(
...
function _decimalParse(a0, a1, a2, a3, a4, a5, a6, a7, a8) {
  ...
  if (a10) {
    ...
    if (a0.indexOf(a11) == 0 || a0.lastIndexOf(a11) == a0.length - 1) {
      a9 = _createFacesMessage(a2 + ".CONVERT", a7, a0);
      throw new TrConverterException(a9);
    }
    if (a11 == "\xa0") {
  ...
  if (
    ...
    if (!a16 && !isNaN(a15)) {
      ...
      if (a5 != null && a15 > a5) {
        a20 = a2 + ".MAXIMUM";
      } else if (a6 != null && a15 < a6) {
        a20 = a2 + ".MINIMUM";
      }
      if (a20 != null) {
        var a21 = a21;
        if (a21 == null || a21[a20] == null)
          throw new TrConverterException(
            null,
            null,
            "Conversion failed, but no appropriate message found"
          );
        else {
          a9 = _createFacesMessage(a20, a7, a0);
          throw new TrConverterException(a9);
        }
      }
      return a15;
  ...
  if (a2.indexOf("NumberConverter") == -1) {
    ...
    if (a1 && a1["number"]) {
      a9 = _createCustomFacesMessage(
        TrMessageFactory.getSummaryString(a22),
        a1["number"],
        a7,
        a0
      );
  ...
  if (!a23) {
    a9 = _createFacesMessage(a22, a7, a0);
  }
  throw new TrConverterException(a9);
}
function TrRegExpValidator(a0, a1) {
  this._pattern = a0;
  this._messages = a1;
  this._class = "TrRegExpValidator";
}
TrRegExpValidator.prototype = new TrValidator();
TrRegExpValidator.prototype.getHints = function (a2) {
  var a3 = null;
...
TrRegExpValidator.prototype.validate = function (a4, a5, a6) {
  a4 = a4 + "";
  ...
  if (a7 != void 0 && a7[0] == a4) {
    ...
    if (this._messages && this._messages["detail"]) {
      ...
      a9 = _createFacesMessage(a8, a5, a4, this._pattern);
    }
    throw new TrValidatorException(a9);
  }
};
function _returnRangeHints(a0, a1, a2, a3, a4, a5, a6, a7, a8) {
  if (a1 && a2) {
    var a9 = new Array();
    if (a0 && a0[a8]) {
      a9.push(TrMessageFactory.createCustomMessage(a0[a8], "" + a2, "" + a1));
    } else {
      a9.push(TrMessageFactory.createMessage(a5, "" + a2, "" + a1));
    }
    return a9;
  }
  return _returnHints(a0, a1, a2, a3, a4, a6, a7);
}
function _returnHints(a0, a1, a2, a3, a4, a5, a6) {
  var a7;
  if (a1) {
    a7 = new Array();
    if (a0 && a0[a5]) {
      a7.push(TrMessageFactory.createCustomMessage(a0[a5], "" + a1));
    } else {
      a7.push(TrMessageFactory.createMessage(a3, "" + a1));
    }
  }
  if (a2) {
    if (!a7) {
    ...
    if (a0 && a0[a6]) {
      a7.push(TrMessageFactory.createCustomMessage(a0[a6], "" + a2));
    } else {
      a7.push(TrMessageFactory.createMessage(a4, "" + a2));
    }
  }
  return a7;
}
