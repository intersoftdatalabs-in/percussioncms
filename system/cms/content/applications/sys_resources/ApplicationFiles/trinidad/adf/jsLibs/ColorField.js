  ...
  if (a4 != null) {
    ...
    if (a3 != null) {
      if (a3.alpha == 0) {
        ...
        a4.style.backgroundColor = new TrColorConverter("#RRGGBB").getAsString(
          a3
        );
...
function _lcp(a0, a1, a2) {
  ...
  if (a3.value != "") {
    ...
    try {
      ...
      if (a11 != null) {
        a2 += "&value=";
        if (a11.alpha == 0) a2 += escape(_cfTrans);
        else a2 += escape(new TrColorConverter(a9).getAsString(a11));
      }
    } catch (e) {}
  }
  var a12 = _cfts[a1];
