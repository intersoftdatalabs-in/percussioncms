function TrXMLRequestEvent(a0, a1) {
  this._status = a0;
  this._request = a1;
}
...
TrXMLRequestEvent.prototype._isResponseValidXML = function () {
  ...
  var a4 = a3.nodeName;
  if (!a4) a4 = a3.tagName;
  if (a4 == "parsererror") return false;
  return true;
};
...
TrXMLRequestEvent.prototype.getResponseHeader = function (a5) {
  var a6 = this._request.getAllResponseHeaders();
  return a6.indexOf(a5) != -1 ? this._request.getResponseHeader(a5) : null;
};
