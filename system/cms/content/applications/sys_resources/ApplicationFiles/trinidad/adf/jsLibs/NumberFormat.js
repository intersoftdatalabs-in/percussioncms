function TrNumberFormat(a0) {
  if (!a0) alert("type for TrNumberFormat not defined!");
  this._type = a0;
...
TrNumberFormat.prototype.format = function (a6) {
  if (this._type == "percent") return this.percentageToString(a6);
  else if (this._type == "currency") return this.currencyToString(a6);
  else if (this._type == "number") return this.numberToString(a6);
};
TrNumberFormat.prototype.parse = function (a7) {
  if (this._type == "percent") return this.stringToPercentage(a7);
  else if (this._type == "currency") return this.stringToCurrency(a7);
};
...
TrNumberFormat.prototype.moveDecimalAsString = function (a32, a33) {
  ...
  if (a33) {
    ...
    if (a39 != null) {
      a35 =
        a35.substring(0, a39.index) +
        a39[1] +
        a36 +
        a35.substring(a39.index + a39[0].length);
    }
    var a38 = new RegExp("(-?)([0-9]*)(\\.?)([0-9]{" + a34 + "})");
