...
TrRequestQueue._RequestItem = function (a1, a2, a3, a4, a5, a6) {
  this._type = a1;
  this._context = a2;
  this._actionURL = a3;
  ...
  if (a8) {
    try {
      ...
      TrRequestQueue._logError(
        "Error ",
        e,
        " delivering XML request status changed to ",
        a8
      );
    }
  }
...
TrRequestQueue.prototype._addRequestToQueue = function (
  ...
  var a16 = new TrRequestQueue._RequestItem(a10, a11, a13, a15, a14, a12);
  this._requestQueue.push(a16);
  try {
    var a17 = new TrXMLRequestEvent(TrXMLRequestEvent.STATUS_QUEUED, null);
    this._broadcastRequestStatusChanged(a11, a12, a17);
  } catch (e) {
    TrRequestQueue._logError(
      "Error on listener callback invocation - STATUS_QUEUED",
      e
    );
  }
...
TrRequestQueue.prototype.sendFormPost = function (a18, a19, a20, a21, a22) {
...
TrRequestQueue.prototype._isMultipartForm = function (a24) {
  if (a24.enctype.toLowerCase() != "multipart/form-data") return false;
  var a25 = a24.getElementsByTagName("input"),
    inputCount = a25.length,
    multiPartForm = null;
      ...
      if (a33.name && !a33.disabled) {
        if (a33.options) {
          ...
          for (var a34 = 0; a34 < a33.options.length; a34++) {
            ...
            if (a35.selected) {
              var a36 = a35.value === null ? a35.text : a35.value;
              a31[a33.name].push(a36);
            }
          }
        } else if (
          !((a33.type == "checkbox" || a33.type == "radio") && !a33.checked)
        ) {
...
TrRequestQueue._appendUrlFormEncoded = function (a45, a46, a47) {
  if (a45.length > 0) {
    a45 = a45 + "&";
  }
  return (
...
TrRequestQueue.prototype.sendRequest = function (a48, a49, a50, a51, a52) {
  this._addRequestToQueue(
    TrRequestQueue._XMLHTTP_TYPE,
    a48,
    a49,
    a50,
    a51,
...
TrRequestQueue.prototype.sendMultipartRequest = function (
  ...
  var a58 = { htmlForm: a56, params: a57, context: a53, method: a54 };
...
TrRequestQueue.prototype._doRequestThroughIframe = function (a66) {
  ...
  var a72 = a71.getElementById(a70),
    iframeDoc;
  var a73 = _agent.isIE;
  if (!a72) {
  ...
  if (this._iframeLoadCallback == null)
    this._iframeLoadCallback = TrUIUtils.createCallback(
      this,
...
TrRequestQueue.prototype._handleIFrameLoad = function () {
  ...
  try {
    if (
      !a90.documentElement ||
      !a90.documentElement.firstChild ||
      (a87 && a90.readyState != "complete")
    ) {
      this._window.setTimeout(this._iframeLoadCallback, 50);
    } else {
      this._onIFrameLoadComplete(a90, this._dtsContext, this._dtsRequestMethod);
    }
  } catch (e) {
...
TrRequestQueue.prototype._onIFrameLoadComplete = function (a91, a92, a93) {
  try {
    var a94 = new TrIFrameXMLRequestEvent(a91);
    this._broadcastRequestStatusChanged(a92, a93, a94);
  } finally {
    if (a91.firstChild) a91.removeChild(a91.firstChild);
    this._htmlForm.action = this._savedActionUrl;
    this._htmlForm.target = this._savedTarget;
...
TrRequestQueue.prototype._handleRequestCallback = function (a95) {
  var a96 = a95.getCompletionState();
  if (a96 != TrXMLRequest.COMPLETED) return;
  var a97 = 0;
  ...
  try {
    if (a97 != 0) {
      var a99 = new TrXMLRequestEvent(TrXMLRequestEvent.STATUS_COMPLETE, a95);
  ...
  if (a111) {
    ...
    for (var a113 = 0; a113 < a112; a113++) {
      try {
        ...
        a113++;
        var a115 = a111[a113];
        if (a115 != null) a114.call(a115, a110);
        else a114(a110);
      } catch (e) {
...
TrRequestQueue._alertError = function () {
  ...
  if (a116 != null) alert(a116);
};
TrRequestQueue._logWarning = function (a117) {
  if (console && console.warn) console.warn(arguments);
};
