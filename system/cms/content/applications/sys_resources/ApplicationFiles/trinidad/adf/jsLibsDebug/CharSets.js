...
function TrByteLengthValidator(length, messages) {
  this._length = length;
...
function CjkFormat(length, messages) {
...
CjkFormat.prototype.getHints = function (converter) {
  var messages = null;

  if (this._messages["hint"]) {
    messages = new Array();
    messages.push(
      TrMessageFactory.createCustomMessage(this._messages["hint"], this._length)
    );
  }
  return messages;
};
CjkFormat.prototype.validate = function (parseString, label, converter) {
  var i = 0;
...
function Utf8Format(length, messages) {
  this._base = TrByteLengthValidator;
  this._base(length, messages);
...
Utf8Format.prototype.getHints = function (converter) {
  var messages = null;
...
Utf8Format.prototype.validate = function (parseString, label, converter) {
  var i = 0;
  var length = this._length;
...
function SBFormat(length, messages) {
  this._base = TrByteLengthValidator;
  this._base(length, messages);
...
SBFormat.prototype.getHints = function (converter) {
  var messages = null;
...
SBFormat.prototype.validate = function (parseString, label, converter) {
