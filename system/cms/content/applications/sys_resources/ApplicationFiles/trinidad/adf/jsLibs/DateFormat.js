...
function _isStrict(a0, a1) {
  ...
  for (var a3 = 0; a3 < a2.length; a3++) {
    var a4 = "parsed" + a2[a3];
    if (a0[a4] != null && a0[a4] != a1["get" + a2[a3]]()) {
      return false;
    }
  }
  return true;
}
function _doClumping(a0, a1, a2, a3, a4) {
  var a5 = a0.length;
  var a6 = false;
  var a7 = 0;
  var a8 = void 0;
  ...
  if ((a2 >= "A" && a2 <= "Z") || (a2 >= "a" && a2 <= "z")) {
    switch (a2) {
      ...
      case "E":
        {
          var a9 = a5.getDay();
          a7 = a4 <= 3 ? a1.getShortWeekdays()[a9] : a1.getWeekdays()[a9];
        }
        break;
      case "F":
      ...
      case "G":
        {
          var a10 = a1.getEras();
          a7 = a5.getTime() < _getADEra().getTime() ? a10[0] : a10[1];
        }
        break;
      case "M":
        {
      ...
      case "a":
        {
          ...
          a7 = _isPM(a5.getHours()) ? a12[1] : a12[0];
        }
        break;
      case "d":
...
function _subparse(a0, a1, a2, a3, a4, a5, a6) {
  var a7 = a5.currIndex;
  if ((a2 >= "A" && a2 <= "Z") || (a2 >= "a" && a2 <= "z")) {
    switch (a2) {
      case "D":
      ...
      case "E":
        {
          var a8 = _matchArray(
            a5,
            a4 <= 3 ? a1.getShortWeekdays() : a1.getWeekdays()
          );
          if (a8 == null) {
            return false;
          }
      ...
      case "M":
        {
          ...
          if (a4 <= 2) {
            ...
            var a12 = a4 == 3 ? a1.getShortMonths() : a1.getMonths();
      ...
      case "a":
        {
          var a14 = _matchArray(a5, a1.getAmPmStrings());
          if (a14 == null) {
            return false;
          } else {
            if (a14 == 1) {
      ...
      case "K":
        {
          ...
          if (a16 != null) {
            if (a2 == "h" && a16 == 12) a16 = 0;
            if (a2 == "k" && a16 == 24) a16 = 0;
            a5.parsedHour = a16;
          } else {
            return false;
          }
      ...
      case "y":
        {
          ...
          if (a19 != null) {
            if (a20 > 2 && a4 <= 2 && a19 <= 999) {
              return false;
            } else if (a4 <= 2 && a19 >= 0 && a19 <= 100) {
              a19 = _fix2DYear(a19);
            } else if (a4 == 4) {
              if (a20 == 3) return false;
              if (a20 <= 2) a19 = _fix2DYear(a19);
            }
            if (a19 == 0) return false;
      ...
      case "z":
        {
          ...
          if (a5.parseString.length - a5.currIndex > 0) {
            ...
            if (
              a5.parseString.length - a5.currIndex < 2 ||
    ...
    return _matchText(a5, a0.substring(a3, a3 + a4));
  }
  return true;
}
...
function _accumulateNumber(a0, a1) {
  var a2 = a0.currIndex;
  var a3 = a2;
  var a4 = a0.parseString;
  var a5 = a4.length;
  if (a5 > a3 + a1) a5 = a3 + a1;
  var a6 = 0;
  while (a3 < a5) {
...
function _getPaddedNumber(a0, a1, a2) {
  var a3 = a0.toString();
  if (a1 != null) {
    var a4 = a1 - a3.length;
    while (a4 > 0) {
  ...
  if (a2 != null) {
    var a5 = a3.length - a2;
    if (a5 > 0) {
      a3 = a3.substring(a5, a5 + a2);
    }
  }
  return a3;
}
function TrDateTimeConverter(a0, a1, a2, a3, a4) {
  ...
  if (a0 == null) a0 = this._localeSymbols.getShortDatePatternString();
...
TrDateTimeConverter.prototype.getFormatHint = function () {
  if (this._messages && this._messages["hint"]) {
    ...
    var a6 =
      ...
      this._type +
      "_HINT";
    return TrMessageFactory.createMessage(a6, "" + this._exampleString);
  }
};
TrDateTimeConverter.prototype.getAsString = function (a7) {
  if (this._offset) {
  ...
  if (typeof a10 != "string") a10 = a10[0];
  _doClumping(a10, this._localeSymbols, _subformat, a7, a9);
  if (this._offset) {
...
TrDateTimeConverter.prototype.setDiffInMins = function (a12) {
  this._offset = a12;
};
...
TrDateTimeConverter.prototype.getAsObject = function (a13, a14) {
  if (a13 == null) return null;
  a13 = TrUIUtils.trim(a13);
  if (a13.length == 0) return null;
  var a15 = this._pattern;
  var a16;
  var a17 =
    "org.apache.myfaces.trinidad.convert.DateTimeConverter.CONVERT_" +
    this._type;
  if (this._messages && this._messages["detail"]) {
    a16 = _createCustomFacesMessage(
      TrMessageFactory.getSummaryString(a17),
    ...
    a16 = _createFacesMessage(a17, a14, a13, this._exampleString);
  }
  if (typeof a15 == "string") {
    return this._simpleDateParseImpl(a13, a15, this._localeSymbols, a16);
  } else {
    var a18;
    for (a18 = 0; a18 < a15.length; a18++) {
      try {
        var a19 = this._simpleDateParseImpl(
          a13,
          a15[a18],
          this._localeSymbols,
          a16
        ...
        if (a18 == a15.length - 1) throw e;
      }
    }
  }
};
TrDateTimeConverter.prototype._initPatterns = function (a20) {
  var a21 = new Array();
  if (a20) a21 = a21.concat(a20);
  var a22 = a21.length;
...
TrDateTimeConverter.prototype._simpleDateParseImpl = function (
  ...
  var a29 = new Date(0);
  a29.setDate(1);
  if (_doClumping(a25, a26, _subparse, a28, a29)) {
    ...
    if (a31 != null) a29.setMonth(a31);
    var a32 = a28.parsedDate;
    if (a32 != null) a29.setDate(a32);
    ...
    if (a34 != null) a29.setMinutes(a34);
    var a35 = a28.parsedSeconds;
    if (a35 != null) a29.setSeconds(a35);
    var a36 = a28.parsedMilliseconds;
    if (a36 != null) a29.setMilliseconds(a36);
