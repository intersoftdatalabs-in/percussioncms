...
TrPage.prototype.sendPartialFormPost = function (a0, a1, a2) {
...
TrPage.prototype._handlePprResponse = function (a6) {
  ...
  if (a7 == "content") {
    ...
    if (a14 == null) a14 = "Unknown error during PPR";
    alert(a14);
  } else if (a7 == "noop") {
  } else {
  }
...
TrPage.prototype._handlePprResponseFragment = function (a20) {
  ...
  var a26 = null;
  if (a25 && TrPage._isDomAncestorOf(a25, a24)) a26 = a25.id;
  if (a24 == null) {
  } else {
...
TrPage._getTextContent = function (a45) {
  ...
  if (_agent.isSafari) {
    ...
    while (a48) {
      ...
      if (a49 == 3 || a49 == 4) a47 = a47 + a48.data;
      a48 = a48.nextSibling;
    }
    return a47;
  }
...
TrPage.prototype.addStyleClassMap = function (a55) {
  ...
  for (var a56 in a55) this._styleClassMap[a56] = a55[a56];
};
