...
function _tableSort(formName, vld, src, val, order) {
...
// Constructor
function CollectionComponent(formName, name) {
...
CollectionComponent.defineSubmit = function (eventParam, sourceParam) {
  ...
  if (this._eventParam != void 0) return;
...
CollectionComponent.defineMultiSelect = function (
  selectedKey,
  selectedModeKey,
  auto
) {
  // check to make sure we are called only once:
  if (this._selectedKey != void 0) return;
...
CollectionComponent.defineTree = function (
  eventParam,
  sourceParam,
  pathParam,
  startParam,
  ...
  // check to make sure we are called only once:
  if (this._pathParam != void 0) return;
