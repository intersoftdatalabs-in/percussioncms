...
function _getDigits() {
  if (_digits == null) {
    var a0 = [
      0x0030, 0x0660, 0x06f0, 0x0966, 0x09e6, 0x0a66, 0x0ae6, 0x0b66, 0x0be7,
      0x0c66, 0x0ce6, 0x0d66, 0x0e50, 0x0ed0, 0x0f20, 0xff10,
    ];
    _digits = new Object();
...
function _isLowerCaseStrict(a0) {
  var a1 = a0.charCodeAt(0);
  return (a1 >= 0x61 && a1 <= 0x7a) || (a1 >= 0xdf && a1 <= 0xff);
}
...
function _isUpperCaseStrict(a0) {
  var a1 = a0.charCodeAt(0);
  return (a1 >= 0x41 && a1 <= 0x5a) || (a1 >= 0xc0 && a1 <= 0xde);
}
...
function getJavaLanguage(a0) {
  ...
  var a5 = a0.substring(a1, a4);
  a3 += a5.toUpperCase();
  if (a4 != a2) {
    a3 += "_";
    a3 += a0.substring(a4 + 1, a2);
  }
  return a3;
}
...
function TrConverterException(a0, a1, a2) {
  if (a0 == null) {
...
function TrValidatorException(a0, a1, a2) {
  if (a0 == null) {
    this._facesMessage = new TrFacesMessage(
      a1,
      a2,
...
function TrFacesMessage(a0, a1, a2) {
  this._summary = a0;
  this._detail = a1;
  if (a2 == null) {
...
TrFacesMessage.prototype.setDetail = function (a3) {
  this._detail = a3;
};
TrFacesMessage.prototype.setSummary = function (a4) {
  this._summary = a4;
};
TrFacesMessage.prototype.getSeverity = function () {
  return this._severity;
};
TrFacesMessage.prototype.setSeverity = function (a5) {
  this._severity = a5;
};
var TrFastMessageFormatUtils = new Object();
TrFastMessageFormatUtils.format = function (a6, a7) {
  var a8 = new Array();
...
TrMessageFactory.createFacesMessage = function (a10, a11, a12, a13) {
...
TrMessageFactory.getSummaryString = function (a17) {
  if (a17 == null) return null;
  return TrMessageFactory._TRANSLATIONS[a17];
};
TrMessageFactory.getDetailString = function (a18) {
  if (a18 == null) return null;
  return TrMessageFactory._TRANSLATIONS[a18 + "_detail"];
};
TrMessageFactory.getString = function (a19) {
  return TrMessageFactory.getSummaryString(a19);
};
TrMessageFactory.createMessage = function (a20, a21, a22) {
...
TrMessageFactory.createCustomMessage = function (a24, a25, a26) {
  var a27;
  if (a24 != null) {
