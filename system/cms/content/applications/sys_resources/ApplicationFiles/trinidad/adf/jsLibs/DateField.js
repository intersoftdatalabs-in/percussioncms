function _dfsv(a0, a1) {
  if (a0 == void 0 || a1 == void 0) return;
...
function _returnCalendarValue(a0, a1) {
...
function _returnPopupCalendarValue(a0, a1) {
  if (a1 != void 0) {
    var a2 = a0["formName"];
    var a3 = a0["fieldName"];
...
function _ldp(a0, a1, a2, a3, a4, a5) {
  ...
  if (a2) {
    TrPopupDialog._launchDialog(a5, {}, _returnPopupCalendarValue, {
      formName: a0,
      fieldName: a1,
    });
  } else {
...
function _getTimePortion(a0) {
  var a1 = _dfgv(a0);
  if (!a1) a1 = new Date();
  var a2 = new Date(a1.getFullYear(), a1.getMonth(), a1.getDate());
  return a1 - a2;
}
function _getLocaleTimeZoneDifference() {
  ...
  var a2 = 0;
  if (_uixLocaleTZ) a2 = (_uixLocaleTZ - a1) * 60 * 1000;
  return a2;
}
function _dfb(a0, a1) {
  _fixDFF(a0);
...
function _updateCal(a0, a1, a2) {
  ...
  if (a2) _firePartialChange(a1);
  else document.location.href = a1;
}
function _doCancel() {
