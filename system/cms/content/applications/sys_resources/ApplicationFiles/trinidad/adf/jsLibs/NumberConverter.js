function TrNumberConverter(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) {
  this._pattern = a0;
  this._type = a1;
  this._locale = a2;
  this._messages = a3;
  ...
  if (a4 !== undefined) this._integerOnly = a4;
  else this._integerOnly = false;
  if (a5 !== undefined) this._groupingUsed = a5;
...
TrNumberConverter.prototype.getAsString = function (a20, a21) {
...
TrNumberConverter.prototype.getAsObject = function (a23, a24) {
  if (this._isConvertible()) {
    var a25;
    if (this._type == "percent" || this._type == "currency") {
      try {
        ...
        if (this._messages && this._messages[this._type]) {
          a26 = _createCustomFacesMessage(
            TrMessageFactory.getSummaryString(a28),
          ...
          a26 = _createFacesMessage(a28, a24, a23, a27);
        }
