function TrColorConverter(a0, a1, a2, a3) {
...
TrColorConverter.prototype.getAsString = function (a4) {
  if (a4 == null) return null;
  if (a4.alpha == 0) return _cfTrans;
  var a5 = new Object();
  a5.value = "";
  var a6 = this._pattern;
  if (typeof a6 != "string") a6 = a6[0];
  _cfoDoClumping(a6, _cfoSubformat, a4, a5);
  return a5.value;
};
TrColorConverter.prototype.getAsObject = function (a7, a8) {
  if (a7 == null) return null;
  a7 = TrUIUtils.trim(a7);
  if (a7.length == 0) return null;
  if (this._allowsTransparent && _cfTrans == a7) return new TrColor(0, 0, 0, 0);
  var a9;
  ...
  if (this._messages && this._messages["detail"]) {
    ...
    a9 = _createFacesMessage(a10, a8, a7, this._patternsString);
  }
  var a11 = this._pattern;
  if (typeof a11 == "string") {
    return this._rgbColorParseImpl(a7, a11, a9);
  } else {
    var a12;
    for (a12 = 0; a12 < a11.length; a12++) {
      try {
        var a13 = this._rgbColorParseImpl(a7, a11[a12], a9);
        return a13;
      } catch (e) {
        if (a12 == a11.length - 1) throw e;
      }
    }
  }
};
TrColorConverter.prototype._rgbColorParseImpl = function (a14, a15, a16) {
  var a17 = new Object();
  a17.currIndex = 0;
  a17.parseString = a14;
  a17.parseException = new TrConverterException(a16);
  var a18 = new TrColor(0x00, 0x00, 0x00);
  if (_cfoDoClumping(a15, _cfoSubParse, a17, a18)) {
...
var _cfTrans;
function _cfoDoClumping(a0, a1, a2, a3) {
  var a4 = a0.length;
  var a5 = false;
  var a6 = 0;
  var a7 = null;
...
function _cfoSubformat(a0, a1, a2, a3, a4, a5) {
  var a6 = null;
  if ((a1 >= "A" && a1 <= "Z") || (a1 >= "a" && a1 <= "z")) {
    switch (a1) {
      ...
      case "a":
        ...
        break;
      case "R":
        a6 = _cfoGetPaddedNumber(a4.red, a3, 2, 16).toUpperCase();
        break;
      case "G":
        a6 = _cfoGetPaddedNumber(a4.green, a3, 2, 16).toUpperCase();
        break;
      case "B":
        a6 = _cfoGetPaddedNumber(a4.blue, a3, 2, 16).toUpperCase();
        break;
      case "A":
        a6 = _cfoGetPaddedNumber(a4.alpha, a3, 2, 16).toUpperCase();
        break;
      default:
        a6 = "";
    }
...
function _cfoSubParse(a0, a1, a2, a3, a4, a5) {
  var a6 = a4.currIndex;
  if ((a1 >= "A" && a1 <= "Z") || (a1 >= "a" && a1 <= "z")) {
    switch (a1) {
      case "r":
    ...
    return _cfoMatchText(a4, a0.substring(a2, a2 + a3));
  }
  return true;
}
function _cfoMatchText(a0, a1) {
  if (!a1) return false;
  var a2 = a1.length;
  var a3 = a0.currIndex;
  ...
  if (a5 != a1) return false;
  a0.currIndex += a2;
  return true;
}
function _cfoAccumulateNumber(a0, a1, a2, a3) {
  var a4 = a0.currIndex;
  var a5 = a4;
  var a6 = a0.parseString;
  var a7 = a6.length;
  if (a7 > a5 + a2) a7 = a5 + a2;
  var a8 = 0;
  while (a5 < a7) {
...
function _cfoGetPaddedNumber(a0, a1, a2, a3) {
