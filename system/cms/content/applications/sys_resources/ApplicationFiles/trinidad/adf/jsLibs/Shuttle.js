...
TrShuttleProxy.prototype.getItems = function (a5) {
  if (a5 == void 0) {
    a5 = true;
  }
...
TrShuttleProxy.prototype.getSelectedItems = function (a10) {
  if (a10 == void 0) {
    a10 = true;
  }
...
TrShuttleProxy.prototype.getItemCount = function (a16) {
  if (a16 == void 0) {
    a16 = true;
  }
...
TrShuttleProxy.prototype.getSelectedItemCount = function (a18) {
  if (a18 == void 0) {
    a18 = true;
  }
...
TrShuttleProxy.prototype.addItem = function (a23, a24, a25, a26, a27) {
  if (a26 == void 0) {
    a26 = "";
  }
  if (a25 == void 0) {
  ...
  a29.options[a29.length] = new Option(
    a29.options[a29.length - 1].text,
...
TrShuttleProxy.prototype.deleteItemByValue = function (a32, a33) {
  if (a33 == void 0) {
    return;
  }
...
TrShuttleProxy.prototype.deleteSelectedItems = function (a39) {
  if (a39 == void 0) {
    a39 = true;
  }
...
TrShuttleProxy.prototype.move = function (a45, a46) {
  if (a46 == void 0) {
    a46 = false;
  }
  if (a45 == void 0) {
...
TrShuttleProxy.prototype.reorderList = function (a49, a50, a51) {
  if (a51 == void 0) {
    a51 = true;
  }
  if (a50 == void 0) {
...
TrShuttleProxy._remove = function (a53, a54, a55) {
  ...
  for (var a57 = a54; a57 < a56; a57++) {
    if (a57 < a56 - a55) a53[a57] = a53[a57 + a55];
    else a53[a57] = void 0;
  }
  a53.length = a56 - a55;
};
TrShuttleProxy._displayDesc = function (a58, a59) {
  if (a59 == void 0) {
...
TrShuttleProxy._getDescArray = function (a64) {
  var a65 = window[a64.replace(":", "_") + "_desc"];
  return a65;
};
TrShuttleProxy._getSelectedDesc = function (a66, a67, a68) {
  var a69 = TrShuttleProxy._getSelectedArray(a66);
  if (a68.length == 1) return a67[a68[0]];
  if (a68.length - a69.length != 1) return "";
  for (var a70 = 0; a70 < a68.length; a70++) {
    if (a70 >= a69.length || a69[a70] != a68[a70]) return a67[a68[a70]];
  }
  return "";
};
TrShuttleProxy._getSelectedArray = function (a71) {
  var a72 = window[a71.replace(":", "_") + "_sel"];
  return a72;
};
TrShuttleProxy._setSelected = function (a73, a74) {
...
TrShuttleProxy._addDescAtIndex = function (a78, a79, a80) {
  if (a78 != void 0) {
    var a81 = a78.length;
...
TrShuttleProxy._deleteDescAtIndex = function (a83, a84) {
  if (a83 != void 0) TrShuttleProxy._remove(a83, a84, 1);
};
TrShuttleProxy._deleteDescAtIndexes = function (a85, a86) {
  if (a85 != void 0) {
...
TrShuttleProxy._clearDescAreas = function (a88, a89, a90) {
...
TrShuttleProxy._moveItems = function (a93, a94, a95) {
  if (a95 == void 0) {
  ...
  if (a96 == void 0 || a97 == void 0) return;
  ...
  for (var a103 = 0; a103 < a98.length; a103++) {
    ...
    if (a100 != void 0 && a99 != void 0) a100[a101] = a99[a98[a103]];
  ...
  for (var a103 = a98.length - 1; a103 >= 0; a103--) {
    if (a99 != void 0) TrShuttleProxy._remove(a99, a98[a103], 1);
...
TrShuttleProxy._moveAllItems = function (a106, a107, a108) {
  if (a108 == void 0) {
  ...
  var a111 = a110.options[document.forms[a108].elements[a107].length - 1].text;
  ...
  if (a109.length > 1) {
    ...
    for (var a116 = 0; a116 < a115 - 1; a116++) {
      ...
      if (a114 != void 0 && a113 != void 0) a114[a112] = a113[a116];
      a112++;
    }
...
TrShuttleProxy._orderList = function (a120, a121, a122) {
  if (a122 == void 0) {
  ...
  while (a126 >= 0) {
    ...
    var a128 = a127;
    var a129 = a126;
    while (a129 > 0 && a124[a129] - a124[a129 - 1] == 1) {
      a129--;
      a128--;
    }
    if (a120 == 0) {
      if (a128 != 0) {
        ...
        if (a125 != void 0) var a132 = a125[a128 - 1];
...
TrShuttleProxy._orderTopBottomList = function (a134, a135, a136) {
  if (a136 == void 0) {
  ...
  if (a134 == 0) {
    var a145 = 0;
    var a144 = 0;
    for (var a146 = 0; a146 < a138[a138.length - 1]; a146++) {
      if (a146 != a138[a145]) {
        a142[a144] = a137.options[a146].text;
        a143[a144] = a137.options[a146].value;
        if (a139 != void 0) a140[a144] = a139[a146];
        a144++;
      } else {
        if (a139 != void 0) a141[a145] = a139[a146];
        a145++;
      }
    }
    if (a139 != void 0) a141[a145] = a139[a146];
    for (var a147 = 0; a147 < a138.length; a147++) {
      ...
      if (a139 != void 0) a139[a147] = a141[a147];
    }
    for (var a148 = 0; a148 < a142.length; a148++) {
      ...
      if (a139 != void 0) a139[a147] = a140[a148];
      a147++;
    }
  } else {
    var a145 = 1;
    var a144 = 0;
    if (a139 != void 0) a141[0] = a139[a138[0]];
    for (var a149 = a138[0] + 1; a149 <= a137.length - 2; a149++) {
      if (a145 == a138.length || a149 != a138[a145]) {
        a142[a144] = a137.options[a149].text;
        a143[a144] = a137.options[a149].value;
        if (a139 != void 0) a140[a144] = a139[a149];
        a144++;
      } else {
        if (a139 != void 0) a141[a145] = a139[a149];
        a145++;
      }
    }
    ...
    for (var a147 = a138.length - 1; a147 >= 0; a147--) {
      ...
      if (a139 != void 0) a139[a148] = a141[a147];
      a148--;
    }
    for (var a147 = a142.length - 1; a147 >= 0; a147--) {
      ...
      if (a139 != void 0) a139[a148] = a140[a147];
      a148--;
    }
  }
...
TrShuttleProxy._getSelectedIndexes = function (a150, a151) {
...
TrShuttleProxy._findFormNameContaining = function (a156) {
...
TrShuttleProxy._makeList = function (a159, a160) {
  var a161 = document.forms[a159].elements[a160];
  if (a161 == null) return;
  var a162 = "";
  for (var a163 = 0; a163 < a161.length - 1; a163++) {
    if (a161.options[a163].value.length > 0) {
      a162 = a162 + TrShuttleProxy._trimString(a161.options[a163].value) + ";";
    } else {
      a162 = a162 + TrShuttleProxy._trimString(a161.options[a163].text) + ";";
    }
  }
  document.forms[a159].elements[a160 + ":items"].value = a162;
};
TrShuttleProxy._trimString = function (a164) {
...
TrShuttleProxy._getListName = function (a166, a167) {
  var a168 = a167 ? a166 + ":leading" : a166 + ":trailing";
  return a168;
};
TrShuttleProxy._resetItems = function (a169, a170) {
  if (a170 == void 0) {
...
TrShuttleProxy._getOriginalLists = function (a178, a179) {
  var a180 = window["_" + a179 + "_" + a178 + "_orig"];
  return a180;
};
TrShuttleProxy._resetToOriginalList = function (a181, a182, a183) {
  if (a181 == void 0 || a183 == void 0) return;
  ...
  for (; a184 < a181.options.length; a184++) {
    ...
    {
      a183.options[a184] = new Option(a185, a186, a187, a188);
      a183.options[a184].defaultSelected = a187;
      a183.options[a184].selected = a188;
    }
    if (a182 != void 0) a182[a184] = a181.descriptions[a184];
  }
  var a189 = a183.options.length - 1;
  while (a189 >= a184) {
    if (a182 != void 0) a182[a189] = null;
...
TrShuttleProxy._copyLists = function (a190, a191) {
  ...
  var a192 = new Object();
  a192.leading = TrShuttleProxy._copyList(
    TrShuttleProxy._getListName(a190, true),
    a191
  );
  a192.trailing = TrShuttleProxy._copyList(
    TrShuttleProxy._getListName(a190, false),
    a191
  );
  return a192;
};
TrShuttleProxy._copyList = function (a193, a194) {
  if (a194 == void 0 || a193 == void 0) return;
  ...
  for (var a198 = 0; a198 < a195.options.length; a198++) {
    a197.options[a198] = new Option(
      a195.options[a198].text,
    ...
    if (a196 != null) a197.descriptions[a198] = a196[a198];
  }
  return a197;
};
