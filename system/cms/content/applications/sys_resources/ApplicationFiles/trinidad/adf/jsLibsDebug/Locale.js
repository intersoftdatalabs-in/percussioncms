 ...
 */
function isLowerCase(alphaChar) {
  var charCode = alphaChar.charCodeAt(0);
...
function _isLowerCaseStrict(alphaChar) {
  var charCode = alphaChar.charCodeAt(0);

  return (
    (charCode >= 0x61 && charCode <= 0x7a) || // "a-z"
    (charCode >= 0xdf && charCode <= 0xff)
  ); // iso-latin1 lowercase
}
 ...
 * uppercase character.
 */
function isUpperCase(alphaChar) {
  var charCode = alphaChar.charCodeAt(0);
 ...
 * uppercase character.
 */
function isNotUpperCase(alphaChar) {
  var charCode = alphaChar.charCodeAt(0);
 ...
 */
function _isUpperCaseStrict(alphaChar) {
  var charCode = alphaChar.charCodeAt(0);

  return (
    (charCode >= 0x41 && charCode <= 0x5a) || // "A-Z"
    (charCode >= 0xc0 && charCode <= 0xde)
  ); // iso-latin1 lowercase
}
...
function getJavaLanguage(javascriptLang) {
  ...
  if (territoryIndex == -1) return javascriptLang;
  ...
  var territoryString = javascriptLang.substring(territoryIndex, variantIndex);
...
function getLocaleSymbols(jsLocaleString) {
...
function _getDecimalSeparator() {
  if (_decimalSep != null) return _decimalSep;

  return this.getLocaleElements()["NumberElements"][0];
}

function _getGroupingSeparator() {
  if (_groupingSep != null) return _groupingSep;
...
function LocaleSymbols(localeElements) {
...
LocaleSymbols.prototype.getMediumTimePatternString =
  _getMediumTimePatternString;
...
LocaleSymbols.prototype.getMediumDatePatternString =
  _getMediumDatePatternString;
...
function TrConverterException(facesMessage, summary, detail) {
  if (facesMessage == null) {
    this._facesMessage = new TrFacesMessage(
      summary,
      detail,
 ...
 */
TrConverterException.prototype.getFacesMessage = function () {
 ...
 * Returns the TrFacesMessage associated with the exception.
 */
TrValidatorException.prototype.getFacesMessage = function () {
  return this._facesMessage;
};
...
TrFacesMessage.prototype.getDetail = function () {
  return this._detail;
};
TrFacesMessage.prototype.getSummary = function () {
  return this._summary;
};
TrFacesMessage.prototype.setDetail = function (detail) {
  this._detail = detail;
};
TrFacesMessage.prototype.setSummary = function (summary) {
  this._summary = summary;
};

TrFacesMessage.prototype.getSeverity = function () {
  return this._severity;
};

TrFacesMessage.prototype.setSeverity = function (severity) {
  this._severity = severity;
};
...
TrMessageFactory.getSummaryString = function (key) {
  if (key == null) return null;
  return TrMessageFactory._TRANSLATIONS[key];
};

TrMessageFactory.getDetailString = function (key) {
  if (key == null) return null;
...
TrMessageFactory.getString = function (key) {
  return TrMessageFactory.getSummaryString(key);
};

TrMessageFactory.createMessage = function (key, param1, param2) {
  // the strings to create a facesMessage to use have been sent down
