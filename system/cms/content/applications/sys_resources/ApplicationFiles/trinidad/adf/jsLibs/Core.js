...
function _agentInit() {
  ...
  if (a0.indexOf("msie") != -1) {
    ...
    a2 = true;
    a9 = "opera";
  } else if (a0.indexOf("applewebkit") != -1 || a0.indexOf("safari") != -1) {
    a6 = true;
    a9 = "safari";
...
function _getBodyWidth(a0, a1, a2) {
      ...
      if (!a4) {
        if (a10 == a1 || a10 <= 1) {
          ...
          if (a8.parentNode != a8.offsetParent) {
            a11 = a11 - a8.parentNode.offsetLeft;
          }
          a9 = _getContentWidth(a8, a10, a11);
        } else {
          a9 = a10;
        }
      } else {
        ...
        if (a9 == 0) {
          ...
          if (a8.parentElement != a8.offsetParent) {
            a11 = a11 - a8.parentElement.offsetLeft;
          }
          a9 = _getContentWidth(a8, a10, a11);
        }
      }
...
function t(a0, a1) {
  if (_tURL) {
    ...
    if (a0) document.write(' width="' + a0 + '"');
    if (a1) document.write(' height="' + a1 + '"');
...
function _removeModalCaptureGecko(a0, a1) {
  ...
  for (var a4 = 0; a4 < a3; a4++) {
    var a5 = a2[a4];
    a1.removeEventListener(a5, a0._captureEventGecko, true);
  }
}
function _captureEventGecko(a0) {
  a0.stopPropagation();
...
function _getKeyValueString(a0, a1, a2) {
  var a3 = a0[a1];
  if (typeof a3 == "function") {
    a3 = "[function]";
  }
  var a4 = _agent.isGecko ? ((a2 + 1) % 3 == 0 ? "\n" : "    ") : "\t";
  return a1 + ":" + a3 + a4;
}
function _dumpSuppress(a0) {
  _dump(a0, { innerText: 1, outerText: 1, outerHTML: 1, innerHTML: 1 });
}
function _dump(a0, a1, a2) {
  var a3 = "";
  if (a0) {
    if (!a2) {
      a2 = a0["name"];
...
function _validateForm(a0, a1) {
  var a2 = "_" + _getJavascriptId(a0.name) + "Validator";
  var a3 = window[a2];
  if (a3) return a3(a0, a1);
  return false;
}
function _getNextNonCommentSibling(a0, a1) {
  var a2 = a0.children;
...
function _validateAlert(a0, a1, a2, a3, a4) {
  var a5 = _multiValidate(a0, a1, a2, a3);
  if (a5.length == 0) return true;
  var a6 = true;
  var a7 = a4 + "\n";
  for (var a8 = 0; a8 < a2.length; a8 += 5) {
    var a9 = a2[a8];
    var a10 = a5[a9];
    if (!a10 || a10.length == 0) continue;
    ...
    for (var a13 = 0; a13 < a10.length; a13 = a13 + 2) {
      ...
      var a14 = a10[a13];
      var a15 = _getGlobalErrorString(a11, a3, a14.getDetail(), a12);
      a7 += a15 + "\n";
    }
  }
...
function _validateInline(a0, a1, a2, a3, a4) {
  var a5 = _multiValidate(a0, a1, a2, a3);
  var a6 = true;
  for (var a7 = 0; a7 < a2.length; a7 += 5) {
    ...
    if (a11) a11.innerHTML = "";
    TrMessageBox.removeMessages(a8);
    var a12 = a5[a8];
    if (!a12 || a12.length == 0) {
      if (a11) a11.style.display = "none";
      if (a10) a10.style.display = "none";
      continue;
    }
    ...
    for (var a15 = 0; a15 < a12.length; a15 = a15 + 2) {
      ...
      var a16 = a12[a15];
      if (a11) a11.innerHTML += a16.getDetail();
      if (!a11 && !TrMessageBox.isPresent())
        alert("Field Error [" + a8 + "] - " + a16.getDetail());
      TrMessageBox.addMessage(a8, a14, a16);
    }
    if (a11) a11.style.display = "inline";
    if (a10) a10.style.display = "inline";
  }
  return a6;
}
function _validateInput(a0) {
  if (a0 == void 0) return true;
  var a1 = _getForm(a0);
  if (a1 == void 0) return true;
  var a2 = _getValidators(a1);
  if (a2 == void 0) return true;
  var a3 = new Array();
...
function _recordValidation(a0, a1) {
  ...
  if (a0) _lastValidationFailure = a1;
}
...
function _validateField(a0, a1, a2, a3, a4) {
  var a5 = _agent.isNav;
  if (a5 && a4) {
    return;
  }
  ...
  if (a6 && !window._validating && _focusChanging()) {
    ...
    if (a6) {
      ...
      if (a11) {
        ...
        var a14 = _getErrorString(a0, a2, a11);
        if (a14) {
...
function _commandChoice(a0, a1) {
  var a2 = document.forms[a0].elements[a1].value;
  if (a2 == void 0) a2 = document.forms[a0].elements[a1][0].value;
  var a3 = a2.indexOf("#");
  if (a3 == 0) window.document.location.href = a2.substring(1, a2.length);
  else {
    var a4 = a2.indexOf("[");
...
function submitForm(a0, a1, a2, a3) {
  var a4 = true;
  if (_agent.isIE) {
    a4 = false;
  ...
  if (a1 == void 0) a1 = true;
  var a8 = true;
  var a9;
  if (a2 != null) a9 = a2.source;
  else a9 = "";
  if (a1 && !_validateForm(a0, a9)) a8 = false;
  ...
  if (a8) {
    ...
    if (a3) {
      ...
      if (a13) {
        for (var a15 in a14) a0.removeChild(a14[a15]);
      }
    }
  }
  return a8;
...
function _submitOnEnter(a0, a1, a2) {
  if (window.event != void 0) a0 = window.event;
  var a3;
  if (a0.srcElement == undefined) a3 = a0.target;
  else a3 = a0.srcElement;
  if (!a3) return true;
          ...
          if (
            ...
            for (var a6 = 0; a6 < a4.options.length; a6++) {
              if (a4.options[a6].selected == true)
                a5 += a4.name + "=" + escape(a4.options[a6].value) + "&";
            }
            if (!a5) {
              var a7 = _getValue(a4);
              if (a7) {
...
function _getValue(a0) {
  ...
  if (a2 == "checkbox") {
    if (a0.length) {
      for (var a3 = 0; a3 < a0.length; a3++) {
        if (a0[a3].type == "checkbox" && a0[a3].checked) {
          return a0[a3].value;
        }
      }
    } else {
    ...
    if (a4 != void 0 && a4 != null && a4 >= 0) {
      var a5 = a0.options[a4];
      var a6 = a5.value;
      if (!a6) {
        for (var a3 = 0; a3 < a0.options.length; a3++) {
          if (a0.options[a3].value) return a6;
        }
        return a5.text;
      }
      return a6;
    ...
    if (a0.length) {
      for (var a3 = 0; a3 < a0.length; a3++) {
        if (a0[a3].type == "radio" && a0[a3].checked) {
          return a0[a3].value;
        }
      }
    } else {
...
function _setSelectIndexById(a0, a1) {
  ...
  if (a2 != null) a2.selectedIndex = a1;
}
...
function _clearPassword(a0, a1) {
  if (window.event != void 0) a1 = window.event;
  if (a0.value != "******") return true;
  if (a1.keyCode == 8 || (a1.keyCode >= 46 && a1.keyCode < 112)) a0.value = "";
  return true;
}
function _setFocus(a0) {
  if (_isShowing(a0)) {
    if (a0.focus) a0.focus();
    if (
      a0.type == "text" &&
      a0.value != void 0 &&
      a0.value != null &&
      ...
      if (true != _delayedEventParams["reset"]) a0.select();
    }
  }
}
...
function _createFacesMessage(a0, a1, a2, a3, a4) {
  ...
  return new TrFacesMessage(a5, a6, TrFacesMessage.SEVERITY_ERROR);
}
function _createCustomFacesMessage(a0, a1, a2, a3, a4, a5) {
  if (a1 != null) {
    a1 = TrFastMessageFormatUtils.format(a1, a2, a3, a4, a5);
  }
  return new TrFacesMessage(a0, a1, TrFacesMessage.SEVERITY_ERROR);
}
function _getGlobalErrorString(a0, a1, a2, a3) {
  var a4 = _getForm(a0);
...
function _isShowing(a0) {
  if (a0.type == "hidden") return false;
  if (_agent.isIE) {
    var a1 = a0;
    while (a1 != void 0) {
  ...
  if (_agent.isGecko || _agent.isSafari) {
    if (!a0.ownerDocument && a0.length) a0 = a0[0];
    var a2 = a0.ownerDocument.defaultView.getComputedStyle(a0, null);
    return a2["visibility"] != "hidden" && a2["display"] != "none";
  }
  return true;
}
function _getID(a0) {
  if (!_agent.isNav) {
    ...
    var a1 = a0.id;
    var a2 = a0.type;
    if (!a2 && a0.length) a2 = a0[0].type;
    if (a2 == "radio") {
      var a3;
      if (a0.length) {
        a3 = a0[0].parentNode;
        if (a3.tagName == "FIELDSET") a3 = a3.parentNode;
      } else {
        a3 = a0.parentNode;
      }
      a1 = a3.id;
...
function _getFormElement(a0, a1) {
  var a2 = null;
  if (_agent.isPIE) {
    a2 = a0.elements[a1];
  } else {
...
function _instanceof(a0, a1) {
  if (a1 == void 0) return false;
  if (a0 == void 0) return false;
  while (typeof a0 == "object") {
    if (a0.constructor == a1) return true;
    a0 = a0.prototype;
  }
  return false;
}
function _getLabel(a0, a1) {
...
function _getErrorString(a0, a1, a2) {
  var a3;
  var a4 = _getForm(a0);
  var a5 = _getValue(a0);
...
function _getValidators(a0) {
  return window["_" + _getJavascriptId(a0.name) + "_Validators"];
}
function _getValidationError(input, validationIndex, validations) {
  if (!validations) {
...
function _formatErrorString(a0, a1) {
  var a2 = a0;
  for (var a3 in a1) {
    var a4 = a1[a3];
    if (!a4) {
    ...
    var a5 = "{" + a3 + "}";
    a2 = a2.replace(new RegExp("%" + a3 + "%", "g"), a5);
    ...
    if (a4.indexOf && a4.indexOf(a5) >= 0) {
      ...
      while (a6 >= 0) {
        a2 = a2.substring(0, a6) + a7 + a2.substring(a6 + a5.length);
        a6 = a2.indexOf(a5);
      }
      a6 = a2.indexOf(a7);
      while (a6 >= 0) {
        a2 = a2.substring(0, a6) + a4 + a2.substring(a6 + a7.length);
        a6 = a2.indexOf(a7);
      }
    } else
      while (a6 >= 0) {
        a2 = a2.substring(0, a6) + a4 + a2.substring(a6 + a5.length);
        a6 = a2.indexOf(a5);
      }
  }
  var a8 = /''/g;
...
function _chain(a0, a1, a2, a3, a4) {
  var a5 = _callChained(a0, a2, a3);
  if (a4 && a5 == false) return false;
  var a6 = _callChained(a1, a2, a3);
  return !(a5 == false || a6 == false);
}
function _callChained(a0, a1, a2) {
  if (a0 && a0.length > 0) {
    if (a2 == void 0) {
      a2 = a1.window.event;
    }
...
function _checkLength(a0, a1, a2) {
  ...
  if (elementLength < a1) return true;
  if (_agent.isIE) {
    if (a2["type"] == "hidden") a2 = window.event;
  }
  if (a2.type == "change") return true;
  if (a2) {
    if (a2.which < 32 || (a2.which == 118 && a2["ctrlKey"])) return true;
  }
  return false;
}
function _getElementById(a0, a1) {
  if (typeof a0.getElementById != "undefined") {
    if ((_agent.kind != "ie" || _agent.version >= 5) && !_agent.isBlackBerry) {
      var a2 = a0.getElementById(a1);
      if (a2 == null || a2.id == a1) return a2;
      return _findElementById(a0, a1);
    }
    return a0.getElementById(a1);
  }
  if (_agent.isPIE) {
    if (a0.forms.length == 0) return window[a1];
    else
      for (var a3 = 0; a3 < a0.forms.length; a3++) {
        var a4 = a0.forms[a3];
        if (a4[a1]) return a4[a1];
      }
    return window[a1];
  }
  return a0.all[a1];
}
function _findElementById(a0, a1) {
  if (a0.id == a1) return a0;
  if (a0.childNodes) {
...
function _addParameter(a0, a1, a2) {
  var a3 = a0.indexOf("?");
  if (a3 == -1) {
    return a0 + "?" + a1 + "=" + a2;
  } else {
    var a4 = a0.indexOf("?" + a1 + "=", a3);
    if (a4 == -1) a4 = a0.indexOf("&" + a1 + "=", a3 + 1);
    if (a4 == -1) {
      return a0 + "&" + a1 + "=" + a2;
    } else {
...
function _addFormParameter(a0, a1, a2) {
  var a3 = new Object();
  if (a0) {
    for (var a4 in a0) a3[a4] = a0[a4];
  }
  a3[a1] = a2;
  return a3;
}
  ...
  if (_agent.isIE) {
    ...
    if (a1) {
      ...
      if (a4 != void 0) {
        ...
        if (
          !a0._pprFirstClickPass ||
          ((a4.type == "change" || a4.type == "blur") && a4.srcElement == a5) ||
    ...
    for (var a7 in a6) {
      if (a1) a2.addEventListener(a7, a3, true);
      else a2.removeEventListener(a7, a3, true);
    }
  }
}
...
function _pprStartBlocking(a0) {
  if (!a0._pprBlocking) {
    ...
    if (_agent.isGecko) {
      ...
      a0._pprBlockingTimeout = a0.setTimeout("_pprStopBlocking(window);", 8000);
    } else if (_agent.isIE) {
...
function _pprFocus(a0, a1) {
  if (_agent.isIE) {
    if (a0.parentNode == null) return;
    var a2 = _getElementById(a1, _pprdivElementName);
    if (a2 && a2["focus"]) a2.focus();
  }
  a0.focus();
}
...
function _firePartialChange(a0) {
  ...
  TrRequestQueue.getInstance().sendRequest(a1, a1._requestStatusChanged, a0);
}
function _submitPartialChange(a0, a1, a2) {
  if (!_supportsPPR()) return submitForm(a0, a1, a2);
  if (typeof a0 == "string") a0 = document[a0];
  if (!a0) return false;
...
function _getRequestedFocusNode(a0) {
  if (a0 == void 0) a0 = window;
  if (a0._TrFocusRequestDoc != null && a0._TrFocusRequestID != null) {
    var a1 = _getElementById(a0._TrFocusRequestDoc, a0._TrFocusRequestID);
    if (!a1) return null;
    if (a0._TrFocusRequestNext) {
      for (var a2 = a1.nextSibling; a2 != null; a2 = a2.nextSibling) {
        if (
          _isFocusable(a2) ||
...
function _getFirstFocusable(a0) {
  if (a0 == null || _isFocusable(a0)) return a0;
  if (a0.hasChildNodes) {
...
function _restoreFocus(a0, a1, a2) {
  ...
  if (_agent.isIE && a0.tagName == "INPUT" && _getAncestorByName(a0, "TABLE")) {
    _pprFocus(a0, a2);
  }
}
function _getAncestorByName(a0, a1) {
  a1 = a1.toUpperCase();
  while (a0) {
    if (a1 == a0.nodeName) return a0;
    a0 = a0.parentNode;
  }
  return null;
}
...
function _isFocusable(a0) {
  ...
  if ("a" == a1 && a0.href) {
    if (!_agent.isIE || a0.id) return true;
    var a2 = a0.childNodes;
    if (a2 && a2.length == 1) {
      var a3 = a2[0].nodeName;
      if ("img" == a3.toLowerCase()) return false;
    }
    return true;
  }
  if (a0.disabled) return false;
  if ("input" == a1) {
...
function _getInputField(a0) {
  ...
  if (a2 != void 0 && (a2.tagName == "INPUT" || a2.tagName == "TEXTAREA"))
    a1 = a2;
  return a1;
}
...
function _setCookie(a0, a1) {
  ...
  var a3 = a2.indexOf(":");
  if (a3 >= 0) a2 = a2.substr(0, a3);
  var a4 = new Date();
  a4.setFullYear(a4.getFullYear() + 10);
  var a5 =
    a0 + "=" + a1 + "; path=/;domain=" + a2 + "; expires=" + a4.toGMTString();
  document.cookie = a5;
}
...
function _radioSet_adfspu(a0, a1, a2, a3, a4) {
  ...
  if (_pendingRadioButton) {
    ...
    if (a0 != void 0 && a0 != null) a5 += "'" + a0 + "'";
    a5 += ",";
    if (a1 != void 0) a5 += a1;
    a5 += ",";
    if (a2 != void 0 && a2 != null) a5 += "'" + a2 + "'";
    a5 += ",";
    if (a3 != void 0 && a3 != null) a5 += "'" + a3 + "'";
    a5 += ");";
...
function _stepSpinboxValue(a0, a1, a2, a3, a4) {
  ...
  if (a6) {
    ...
    if (a1) {
      ...
      if (a8 < a4) a6.value = a8;
      else if (a5) a6.value = a3;
      else a6.value = a4;
    } else {
      var a9 = parseFloat(a7) - parseFloat(a2);
      if (a9 > a3) a6.value = a9;
      else if (a5) a6.value = a4;
      else a6.value = a3;
    }
    return true;
  }
