function _pprExecScript(a0, a1) {
  if (_pprLibStore && _pprLibStore.allLibraries != void 0) {
    ...
    for (var a0 = _pprLibStore.total - 1; a0 >= 0; a0--) {
      if (!_pprLibStore.loadedStatus[a0]) return;
    }
...
function _pprCopyObjectElement(a0, a1) {
  ...
  while (true) {
    ...
    var a4 = _getElementById(a0, a3);
    if (a4 == null) break;
    else {
      var a5 = _getCommentedScript(a0, a3);
    }
    if (a5 != null) {
      var a6 = "_pprObjectSpan" + a2;
      var a7 = _getElementById(a1, a6);
      if (a7 != null) a7.outerHTML = a5;
    }
    a2++;
  }
}
...
function _getNewActiveElement(a0, a1, a2) {
  if (a2.id) {
    var a3 = _getElementById(a0, a2.id);
    if (_isFocusable(a3)) return a3;
  }
  return null;
}
function _partialChange(a0) {
  ...
  for (var a6 = 0; a6 < _pprTargets.length; a6++) {
    ...
    if (a8 && a9) {
      ...
      if (a10 && a4 == null) {
        ...
        a4 = _getNewActiveElement(a2, a9, a3);
        if (a4 == null) {
  ...
  if (a11) a11.value = document.forms[0].action;
  _pprStopBlocking(parent);
...
function _setOuterHTML(a0, a1, a2) {
  var a3 = a2.tagName;
  if (_agent.isIE || _agent.isSafari) {
    ...
    if (a5 || a6) {
      ...
      if (_agent.isSafari && (a3 == "TR" || a3 == "TD")) {
        if (a3 == "TD") a7.innerHTML = a2.innerHTML;
        else a1.outerHTML = a2.outerHTML;
      } else a7.mergeAttributes(a2, false);
      if (a5) {
        ...
        if (a6) {
          ...
          while (a8 != null) {
            ...
            if (a8 != null) {
              a7.appendChild(_setOuterHTML(a0, null, a8));
            }
            a8 = a8.nextSibling;
          }
        }
      ...
      if (a1) {
        if (a1["parentNode"]) a1.parentNode.replaceChild(a7, a1);
      } else {
        a1 = a7;
      }
      a4 = false;
  ...
  if (a3 != null && window["_pprLibraries"] != void 0) {
    for (var a4 = 0; a4 < _pprLibraries.length; a4++) {
      if (a3.value.indexOf(_pprLibraries[a4]) == -1) {
        if (a3.value != "") a3.value += "," + _pprLibraries[a4];
        else a3.value += _pprLibraries[a4];
      }
    }
  }
}
function _firePartialChange(a0) {
  var a1 = _addParameter(a0, _getPartialParameter(), "true");
