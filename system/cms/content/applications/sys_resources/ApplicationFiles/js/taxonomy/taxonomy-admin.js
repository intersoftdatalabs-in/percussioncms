(function ($) {
  ...
  function tax_admin_rebuild_tags(theTreeDivId) {
    ...
    $("#" + tax_admin_get_save_load_id(theTreeDivId)).val(
  ...
  var methods = {
    tax_admin_init_tree: function (theTreeDivId) {
      tax_admin_init_tree(theTreeDivId);
    },
    tax_admin_rebuild_tags: function (theTreeDivId) {
      tax_admin_rebuild_tags(theTreeDivId);
    },
    tax_admin_un_check_disabled_nodes: function (theTreeDivId) {
      tax_admin_un_check_disabled_nodes(theTreeDivId);
    },
    tax_admin_unprefix_id: function (theId) {
      return tax_admin_unprefix_id(theId);
    }, // TODO note the return here... aaron wasted some time cause that was missing!!!
