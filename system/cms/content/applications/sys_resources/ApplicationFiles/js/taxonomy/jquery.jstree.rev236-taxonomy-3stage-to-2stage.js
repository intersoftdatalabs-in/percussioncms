 ...
 *
 * $Date: 2011-02-08 18:17:14 -0500 (Tue, 08 Feb 2011) $
 * $Revision: 236 $
 */
    ...
    $.fn.jstree = function (settings) {
      ...
      if (isMethodCall) {
        ...
        this.each(function () {
          ...
          $.each(
            instances[instance_id]._get_settings().plugins,
            function (i, val) {
            ...
            case "after":
              ...
              if (ml) {
                ml.css({
                  left: pos + 8 + "px",
                  top:
                    this.data.dnd.off.top + this.data.core.li_height - 1 + "px",
                }).show();
              }
              break;
            case "inside":
    ...
    $.jstree.plugin("checkbox", {
      ...
      _fn: {
        ...
        _prepare_checkboxes: function (obj) {
          ...
          if (!ts) {
            // ACS we comment out this because checking from a collapsed state don't work it checked everything!
            ...
            obj.parentsUntil(".jstree", "li").each(function () {
              ...
              if (state) {
                if (
                  ...
                  // ACS I'm not sure this code is used any more by we will change fron unchecked to checked just to be sure
                  ...
                  // ACS there are no checked children for a checked node we still want to keep checked state
                ...
                if (
                  ...
                  // ACS I don't understand the if statement but we need this if we are selecting a child node and parent is empty so we change from undetermined to checked
                  // $this.parentsUntil(".jstree", "li").andSelf().removeClass("jstree-checked jstree-unchecked").addClass("jstree-undetermined");
                  $this
                    .parentsUntil(".jstree", "li")
                    .andSelf()
                    .removeClass("jstree-checked jstree-unchecked")
                    .addClass("jstree-checked"); // ACS
                  if (rc) {
                    $this
                      .parentsUntil(".jstree", "li")
                      .andSelf()
      ...
      _fn: {
        search: function (str, skip_async) {
          ...
          if (
            !skip_async &&
            s.ajax !== false &&
            this.get_container_ul().find("li.jstree-closed:not(:has(ul)):eq(0)")
              .length > 0
          ) {
    ...
    $(function () {
      ...
      $.vakata.context.cnt
        ...
        .delegate("a", "mouseup", function (e) {
          if (
            !$(this).parent().hasClass("jstree-contextmenu-disabled") &&
        ...
        this.get_container()
          ...
          .delegate(
            ...
            $.proxy(function (e) {
              e.stopImmediatePropagation();
              if (
                $(e.currentTarget).children(".jstree-hovered, .jstree-clicked")
                  .length
              ) {
                return false;
              }
          ...
          .delegate(
            ...
            $.proxy(function (e) {
              if (
                $(e.currentTarget).children("a").hasClass("jstree-hovered")
                  .length
              ) {
                return;
              }
