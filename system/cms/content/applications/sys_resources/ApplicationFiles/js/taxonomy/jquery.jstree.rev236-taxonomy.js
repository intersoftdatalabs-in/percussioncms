...
(function () {
  ...
  (function ($) {
    $.vakata.xslt = function (xml, xsl, callback) {
      ...
      //IE9 Fix:
      //more info https://github.com/vakata/jstree/issues/98
   ...
   */
  (function ($) {
    $.expr[":"].jstree_text_contains = function (a, i, m) {
      return (
        ($(a).children("a").text() || "")
          .toLowerCase()
    ...
    $.jstree.plugin("search", {
      ...
      _fn: {
        search: function (str, skip_async) {
          ...
          // ACS hack the next 2 lines because we titles are in li not a... but we need to return a for the styles to work
          ...
          this.data.search.result = this.data.search.result.children("a");
          this.data.search.result
