...
function showWarningMessage() {
  window.parent.jQuery.perc_utils.alert_dialog({
    title: "Warning",
    content:
      'This content contains a reserved class name ("perc-widget", "perc-region", "perc-vertical", "perc-fixed", "perc-region-leaf", "perc-horizontal", "perc-itool-selectable-elem", "perc-itool-region-elem", "perc-zero-size-elem").  Please review your HTML and remove these references before submitting.',
    okCallBack: function () {
      return true;
    },
  });
