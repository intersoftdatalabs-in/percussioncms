...
function showCalendar(dateField, timevar, appendvar) {
  ...
  if (appendvar != null) appendflag = appendvar;
  ...
  if (is_safari) {
    ...
    calDoc =
      ...
      topBackground +
      '">\n' +
      '  <div id="calTop" style="background-color:' +
      topBackground +
      '">' +
      buildTopCalFrame() +
      "<div>\n" +
...
function buildTopCalFrame() {
  ...
  calDoc +=
    ...
    calDate.getFullYear() +
    '"type=text size=4 maxlength=4 onChange="' +
    _parent +
    'opener.setYear()">' +
    "</center>" +
    "</td>" +
    ...
    "<td colspan=7>" +
    "<input " +
    'type=button name="previousYear" value="<<"    onClick="' +
    _parent +
    'opener.setPreviousYear()"/><input ' +
    'type=button name="previousMonth" value=" < "   onClick="' +
    _parent +
    'opener.setPreviousMonth()"/><input ' +
    'type=button name="today" value="Today" onClick="' +
    _parent +
    'opener.setToday()"/><input ' +
    'type=button name="nextMonth" value=" > "   onClick="' +
    _parent +
    'opener.setNextMonth()"/><input ' +
    'type=button name="nextYear" value=">>"    onClick="' +
    _parent +
    'opener.setNextYear()"/>&nbsp;' +
    "</td>" +
    "</tr>";
...
function buildBottomCalFrame() {
  ...
  for (i = startingPos; i < days; i++) {
    ...
    if (currentDay == day + 300) {
      // Make this work correctly with added month and year logic
      dayType = "focusDay";
    } else {
      dayType = "weekDay";
    }
...
function getMonthSelect() {
  ...
  monthSelect =
    '<select name="month" onChange="parent.opener.setCurrentMonth()">';
...
function createWeekdayList() {
  ...
  for (i = 0; i < weekdayArray.length; i++) {
    weekdays +=
      '<td width="20" class="heading" align="center">' +
      weekdayArray[i] +
      "</td>";
  }
  weekdays += "</tr>";
...
function buildCalParts() {
  ...
  calStyleSheet =
    '<style type="text/css">' +
    "<!--" +
    "td.heading { text-decoration: none; color:" +
    headingTextColor +
    "; font: " +
    headingFontStyle +
    "; }" +
    "a.focusDay:link { color: " +
    focusColor +
    "; text-decoration: none; font: " +
    fontStyle +
    "; }" +
    "a.focusDay:hover { color: " +
    focusColor +
    "; text-decoration: none; font: " +
    fontStyle +
    "; }" +
    "a.focusDay:visited { color: " +
    focusColor +
    "; text-decoration: none; font: " +
    fontStyle +
    "; }" +
    "a.focusDay:active { color: " +
    focusColor +
    "; text-decoration: none; font: " +
    fontStyle +
    "; }" +
    "a.weekday:link { color: " +
    dateColor +
    "; text-decoration: none; font: " +
    fontStyle +
    "; }" +
    "a.weekday:hover { color: " +
    hoverColor +
    "; text-decoration: none; font: " +
    fontStyle +
    "; }" +
    "a.weekday:visited { color: " +
    hoverColor +
    "; text-decoration: none; font: " +
    fontStyle +
    "; }" +
    "a.weekday:active { color: " +
    hoverColor +
    "; text-decoration: none; font: " +
    fontStyle +
    "; }" +
  ...
  if (is_nav) {
    calendarBegin +=
      ...
      tableBGColor +
      '"><tr class="headercell"><td class="headercellfont">';
  }
  ...
  calendarEnd += "</tbody></table>" + "</center>" + "</body>" + "</html>";
}
...
function returnDate(inDay) {
  ...
  if (appendflag == "1") calDateField.value += outDate;
  else calDateField.value = outDate;
