					...
					<td valign="top">          <!-- View Start -->
						<table width="100%" height="100%" cellpadding="0"
							...
							<tr class="datacell1">
								...
								<td align="center" width="30%" class="headercell2font">Variant&nbsp;Name(id)&nbsp;&nbsp;&nbsp;&nbsp;
								</td>
								<td align="center" width="20%" class="headercell2font">Style&nbsp;Sheet&nbsp;&nbsp;&nbsp;&nbsp;
								</td>
								<td align="center" width="38%" class="headercell2font">Assembly&nbsp;URL&nbsp;&nbsp;&nbsp;&nbsp;
								</td>
								<td align="center" width="10%" class="headercell2font">Produces&nbsp;&nbsp;&nbsp;&nbsp;
								</td>
							</tr>
