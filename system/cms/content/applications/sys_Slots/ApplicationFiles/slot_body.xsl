...
<xsl:stylesheet version="1.1"
	...
	<xsl:template mode="slot_mainbody" match="*">
		...
		<xsl:variable name="slotlookup"
			select="document(/*/slotlookupurl)" />
		<xsl:variable name="slottype"
			select="$slotlookup//slottype" />
		<xsl:variable name="systemslot"
			select="$slotlookup//systemslot" />
					...
					<table width="100%" cellpadding="0" cellspacing="1"
						...
						<form name="newslot" method="post" action="editslot.html">
							...
							<input name="slotid" type="hidden">
								<xsl:attribute name="value"><xsl:value-of
									select="editslot/slotid" /></xsl:attribute>
							</input>
							<xsl:for-each select="$slotlookup/*">
								<input name="systemslot" type="hidden"
									value="{systemslot}" />
								<xsl:choose>
									<xsl:when test="systemslot=1">
										...
										<tr class="datacell2">
											...
											<td align="left" class="datacell1font">
												<input type="hidden" name="slotdesc"
													value="{slotdesc}" />
										...
										<tr class="datacell2">
											...
											<td align="left" class="datacell1font">
												<input type="hidden" name="slottype"
													value="{slottype}" />
												<xsl:choose>
													<xsl:when test="slottype=1">
														Inline Slot
													</xsl:when>
													<xsl:otherwise>
														Regular Slot
								...
								<tr class="datacell2">
									<td align="left" class="datacell1font">Allowed Active Assembly Relationship
										Type Name</td>
									<td align="left" class="datacell1font">
										<xsl:variable name="aarelationshiptype"
											select="aarelationshiptype" />
										<xsl:variable name="relationships"
											select="document(//aarellookupurl)//sys_Lookup" />
                  ...
                  &nbsp;
							...
							<tr class="headercell">
								...
								<td valign="top" width="40%" align="left"
									class="headercellfont" colspan="2">Edit Slot: Allowed Content</td>
								<td valign="top" width="55%" align="right"
									class="headercellfont">
									<a>
										<xsl:attribute name="href"><xsl:value-of
											select="editslot/addvariant" /><xsl:if
											test="$slottype='1'">&amp;outputformat=1&amp;outputformat=2</xsl:if></xsl:attribute>
										Add&nbsp;Allowed&nbsp;Content
									</a>
								</td>
							</tr>
							<tr class="headercell2">
								<td align="center" width="5%" class="headercell2font">&nbsp;
								</td>
								<td width="40%" align="center" class="headercell2font">Content&nbsp;Type&nbsp;(id)&nbsp;&nbsp;&nbsp;
								</td>
								<td width="55%" align="center" class="headercell2font">Variant&nbsp;(id)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</td>
							</tr>
											...
											<td align="center">
												<a href="javascript:delConfirm('{slotdelete}');">
													<img height="21" alt="Delete"
														src="/sys_resources/images/delete.gif" width="21"
														border="0" />
												</a>
											</td>
