								...
								<td width="100%" valign="top" align="right" colspan="10">
									<a>
										<xsl:attribute name="href"><xsl:value-of
											select="newsloturl" /></xsl:attribute>
										<b>New Slot</b>
									</a>
               &nbsp;&nbsp;&nbsp;
								</td>
							...
							<tr class="headercell2">
								...
								<td width="50%" align="left" class="headercell2font">Slot&nbsp;Name&nbsp;(ID)&nbsp;&nbsp;&nbsp;
								</td>
												...
												<xsl:choose>
													<xsl:when test="systemslot=1">
														<img height="21" alt="Delete"
															src="../sys_resources/images/nodelete.gif" width="21"
															border="0" />
													</xsl:when>
													<xsl:otherwise>
