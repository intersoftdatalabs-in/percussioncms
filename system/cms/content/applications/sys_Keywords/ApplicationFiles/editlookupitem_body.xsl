			...
			<tr class="headercell">
				<td>
					<table width="100%" cellpadding="0" cellspacing="1"
						border="0">
						<form name="updatelookupitem" method="post"
							action="updatelookupitem.html">
							...
							<input name="lookupid" type="hidden">
								<xsl:attribute name="value"><xsl:value-of
									select="lookupid" /></xsl:attribute>
							</input>
							<input name="lookuptype" type="hidden">
								<xsl:attribute name="value"><xsl:value-of
									select="lookuptype" /></xsl:attribute>
							</input>
							<tr class="datacell1">
								<td width="30%" align="left" class="datacell1font">Choice&nbsp;ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</td>
							...
							<tr class="datacell1">
								...
								<td class="datacell1font">
									<input name="lookupsequence" size="5">
										<xsl:attribute name="value"><xsl:value-of
											select="lookupsequence" /></xsl:attribute>
									</input>
								</td>
							</tr>
							<tr class="datacell2">
								<td colspan="2">
									<input type="button" value="Save" class="nav_body"
										name="save" language="javascript" onclick="save_onclick()" />&nbsp;
									<input type="button" value="Cancel" class="nav_body"
										name="cancel" language="javascript" onclick="history.back();" />
								</td>
							</tr>
						</form>
					</table>
