...
<xsl:stylesheet version="1.1"
	...
	<xsl:include
		href="file:sys_Keywords/editlookupitem_body.xsl" />
	<xsl:include
		...
		<html>
			<head>
				...
				<xsl:element name="script">
					...
					<xsl:for-each
						select="$lookupdoc/lookuplist/entry[not(@lookupid = $lookupid)]">
						<xsl:text>,"</xsl:text>
