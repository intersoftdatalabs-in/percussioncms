	...
	<xsl:template mode="editkeywords_mainbody" match="*">
		...
		<table width="100%" height="100%" cellpadding="0"
				...
				<td>
					<table width="100%" cellpadding="0" cellspacing="1"
						...
						<form name="updatekeyword" method="post">
							<xsl:attribute name="action"><xsl:choose><xsl:when
								test="categoryid=''">insertkeyword.html</xsl:when><xsl:otherwise>updatekeyword.html</xsl:otherwise></xsl:choose></xsl:attribute>
							...
							<input name="DBActionType" type="hidden">
								<xsl:attribute name="value"><xsl:value-of
									select="dbactiontype" /></xsl:attribute>
							</input>
							<input name="categoryid" type="hidden">
								<xsl:attribute name="value"><xsl:value-of
									select="categoryid" /></xsl:attribute>
							</input>
							...
							<tr class="datacell1">
								...
								<td width="70%" align="left" class="datacell1font">
									<input name="lookupname">
										<xsl:attribute name="value"><xsl:value-of
											select="lookupname" /></xsl:attribute>
									</input>
								</td>
							</tr>
							<tr class="datacell1">
								...
								<td width="70%" align="left" class="datacell1font">
									<input name="lookupdescription" size="40">
										<xsl:attribute name="value"><xsl:value-of
											select="lookupdescription" /></xsl:attribute>
									</input>
								</td>
							</tr>
							<tr class="datacell2">
								<td colspan="2">
									<input type="button" value="Save" class="nav_body"
										name="save" language="javascript"
										onclick="return save_onclick()" />&nbsp;
            ...
            &nbsp;&nbsp;&nbsp;
							...
							<tr class="headercell">
								<td align="left" class="headercellfont">Choice&nbsp;List
								</td>
								<td width="100%" align="right" class="headercellfont">
									<a>
										<xsl:attribute name="href"><xsl:value-of
											select="newlookupitemurl" /></xsl:attribute>
										<b>Add&nbsp;Choice
										</b>
									</a>
            &nbsp;&nbsp;&nbsp;
							...
							<tr>
								<td colspan="10">
									<table width="100%" cellpadding="0" cellspacing="1"
										border="0">
										<tr class="headercell2">
											<td width="5%" class="headercellfont">&nbsp;
											</td>
											<td width="30%" class="headercellfont">Choice&nbsp;Label&nbsp;
											</td>
											<td width="45%" class="headercellfont">Description&nbsp;
											</td>
											<td width="10%" class="headercellfont">Choice&nbsp;Value&nbsp;
											</td>
											<td width="10%" class="headercellfont">Sort&nbsp;Order&nbsp;
											</td>
										</tr>
