...
function search_onclick() {
	...
	document.componentsearch.componentid.value = document.componentsearch.componentid_display.value;
				...
				<form name="componentsearch"
					action="../sys_cmpComponents/components.html" method="get">
					<input type="hidden" name="sys_componentname"
						value="sys_compbyname" />
					<input type="hidden" name="sys_pagename"
						value="sys_compbyname" />
					...
					<table width="225" height="100%" cellspacing="0"
								...
								<table width="100%" cellpadding="0" cellspacing="0"
									...
									<tr class="datacell1" border="0">
										<td align="center" class="datacell2font">
											<input type="text" size="20" name="cmpname_display"
												class="monospace" />
										</td>
									</tr>
									<tr class="datacell1" border="0">
									...
									<tr class="datacell1" border="0">
										<td align="center" class="datacell2font">
											<input type="text" size="20"
												name="componentdisplayname_display" class="monospace" />
										</td>
									</tr>
									<tr class="datacell1" border="0">
									...
									<tr class="datacell1" border="0">
										<td align="center" class="datacell2font">
											<input type="text" size="20"
												name="componentdesc_display" class="monospace" />
										</td>
									</tr>
									<tr class="datacell1" border="0">
									...
									<tr class="datacell1" border="0">
										<td align="center" class="datacell2font">
											<input type="text" size="20"
												name="componenturl_display" class="monospace" />
										</td>
									</tr>
									<tr class="datacell1" border="0">
									...
									<tr class="datacell1" border="0">
										<td align="center" class="datacell2font">
											<input type="text" size="20" name="componentid_display"
												class="monospace" />
										</td>
									</tr>
									<tr class="datacell1" border="0">
									...
									<tr class="headercell2">
										<td align="center" class="headercell2font">
											<br />
											<input type="submit" name="Submit" value="Search"
												class="nav_body" onclick="return search_onclick();" />
											&#160;
