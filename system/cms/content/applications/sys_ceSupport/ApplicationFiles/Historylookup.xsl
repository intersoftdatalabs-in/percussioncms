		...
		<html>
			...
			<body>
				<table border="0" cellspacing="1" cellpadding="1"
					...
					<tr>
						<td colspan="16" bgcolor="FFFFFF" class="largeheadline">ContentStatus History
							for contentid:</td>
					</tr>
	...
	<xsl:template match="*/historyentry" mode="mode1">
		<xsl:for-each select=".">
			<tr>
				...
				<td>
					<xsl:apply-templates
						select="historytransitionid" />
				</td>

				<td>
					<xsl:apply-templates
						select="historytransitiondesc" />
				</td>
				...
				<td>
					<xsl:apply-templates
						select="historycheckoutusername" />
				</td>

				<td>
					<xsl:apply-templates
						select="historylastmodifiername" />
				</td>

				<td>
					<xsl:apply-templates
						select="historylastmodifieddate" />
				</td>
