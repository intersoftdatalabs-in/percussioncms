			...
			<tr class="headercell">
				<td>
					<table width="100%" cellpadding="0" cellspacing="1"
						border="0">
						<form name="copyvariant" method="post"
							...
							<tr class="headercell">
								<td valign="top" align="left" class="headercellfont"
									colspan="2">Source Content Type</td>
							</tr>
							<tr class="datacell1">
								...
								<td width="100%" align="left" class="datacell1font">
									<select name="srccontenttype"
										onchange="javascript:contenttype_onchange()">
