									...
									<td valign="top" align="right" colspan="4">
										<a>
											<xsl:attribute name="href"><xsl:value-of
												select="addvarianturl" /></xsl:attribute>
											<b>New Variant</b>
										</a>
               &nbsp;&nbsp;&nbsp;
										<a>
											<xsl:attribute name="href"><xsl:value-of
												select="copyvarianturl" /></xsl:attribute>
											<b>Copy Variant</b>
										</a>
               &nbsp;&nbsp;&nbsp;
									</td>
								...
								<tr class="headercell2">
									...
									<td width="30%" align="left" class="headercell2font">Variant&nbsp;Name&nbsp;(ID)&nbsp;
									</td>
									<td width="45%" align="left" class="headercell2font">Description&nbsp;
									</td>
									<td width="20%" align="left" class="headercell2font">Produces&nbsp;
									</td>
								</tr>
		...
		<xsl:if test="not(ID='')">
			<tr class="datacell1">
				...
				<td align="left" class="datacell1font" width="30%">
					<a>
						<xsl:attribute name="href"><xsl:value-of
							select="editvarianturl" /></xsl:attribute>
				...
				<td align="left" class="datacell1font" width="20%">
					<!-- begin XSL -->
					<xsl:choose>
						<xsl:when test="./output='1'">
							Page
						</xsl:when>
						<xsl:when test="./output='2'">
							Snippet
						</xsl:when>
					</xsl:choose>
					<!-- end XSL -->
