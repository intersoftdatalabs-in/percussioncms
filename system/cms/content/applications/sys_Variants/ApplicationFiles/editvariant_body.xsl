...
<xsl:stylesheet version="1.1"
	...
	<xsl:template mode="editvariant_mainbody" match="*">
		...
		<xsl:variable name="contenttype"
			select="/*/contenttypeurl" />
		<xsl:variable name="variantslot"
			select="/*/variantsloturl" />
		<xsl:variable name="contentlookup"
			select="/*/contentlookupurl" />
				...
				<tr class="headercell">
					<td>
						<table width="100%" cellpadding="0" cellspacing="1"
							border="0">
							<xsl:apply-templates
								select="document($contenttype)" mode="mode7" />
							<form name="newvariant" method="get">
								<xsl:attribute name="action"><xsl:choose><!--when variant is created --><xsl:when
									test="variantid=''"><xsl:choose><xsl:when test="//sys_community=0">edit_gen.html</xsl:when><xsl:otherwise>edit_comm.html</xsl:otherwise></xsl:choose></xsl:when><!--when variant is updated --><xsl:otherwise><xsl:value-of
									select="'update.html'" /></xsl:otherwise></xsl:choose></xsl:attribute>
								<input name="DBActionType" type="hidden" value="UPDATE" />
								<xsl:apply-templates
									select="document($contenttype)" mode="mode8" />
								<input name="variantid" type="hidden">
									<xsl:attribute name="value"><xsl:value-of
										select="variantid" /></xsl:attribute>
								</input>
                  ...
                  &nbsp;
									...
									<td width="70%" align="center" class="headercell2font">&nbsp;
									</td>
								</tr>
								<tr class="datacell1">
									...
									<td align="left" class="datacell1font">
										<input size="45" name="desc">
											<xsl:attribute name="value"><xsl:value-of
												select="variantdesc" /></xsl:attribute>
										</input>
									</td>
								</tr>
								<tr class="datacell1">
								...
								<tr class="datacell2">
									...
									<td align="left" class="datacell1font">
										<input size="45" name="stylesheet">
											<xsl:attribute name="value"><xsl:value-of
												select="variantstylesheet" /></xsl:attribute>
										</input>
									</td>
								</tr>
								<tr class="datacell1">
									...
									<td align="left" class="datacell1font">
										<input size="45" name="url">
											<xsl:attribute name="value"><xsl:value-of
												select="varianturl" /></xsl:attribute>
										</input>
									</td>
								</tr>
								<tr class="datacell1">
									...
									<td align="left" class="datacell1font">
										<input size="10" name="locprefix">
											<xsl:attribute name="value"><xsl:value-of
												select="locprefix" /></xsl:attribute>
										</input>
									</td>
								</tr>
								<tr class="datacell1">
									...
									<td align="left" class="datacell1font">
										<input size="10" name="locsuffix">
											<xsl:attribute name="value"><xsl:value-of
												select="locsuffix" /></xsl:attribute>
										</input>
									</td>
								</tr>
								<tr class="datacell2">
									...
									<td align="left" class="datacell1font">
										<input type="radio" name="outputform" value="2">
											<xsl:if
												test="variantoutputform=&apos;2&apos; or variantoutputform=''">
							...
							<xsl:if test="string-length(variantid)">
								<tr class="headercell">
									<td class="headercellfont" colspan="2">&nbsp;
									</td>
								</tr>
								<tr class="headercell">
									...
									<td valign="top" align="right" class="headercellfont">
										<a>
											<xsl:attribute name="href"><xsl:value-of
												select="addsloturl" /></xsl:attribute>
											Add Slot
										</a>
									</td>
								</tr>
								<tr>
									<td colspan="2">
										<table width="100%" cellpadding="0" cellspacing="1"
											...
											<xsl:apply-templates
												select="document(/*/variantsloturl)/*/item" mode="mode1" />
										</table>
									</td>
								</tr>
								<tr class="headercell">
								...
								<tr class="headercell">
									...
									<td valign="top" align="right" class="headercellfont">
										<a>
											<xsl:attribute name="href"><xsl:value-of
												select="addsiteurl" /></xsl:attribute>
											Add Site
										</a>
									</td>
								</tr>
								<tr>
									<td colspan="2">
										<table width="100%" cellpadding="0" cellspacing="1"
											...
											<xsl:apply-templates
												select="document(/*/variantsiteurl)/*/item" mode="mode10" />
										</table>
									</td>
								</tr>
							</xsl:if>
