			...
			<tr class="headercell">
				<td>
					<table width="100%" cellpadding="0" cellspacing="1"
						border="0">
						<form name="editcompproperty" method="post"
							action="updatecompproperty.html">
							...
							<tr class="headercell2">
								<td width="30%" align="left" class="headercell2font">Property&nbsp;ID&nbsp;
								</td>
							...
							<tr class="datacell1">
								<td class="datacell1font" width="30%">
									<font class="reqfieldfont">*</font>
									Property Name
								</td>
								<td class="datacell1font">
									<input name="propertyname" size="20"
										value="{propertyname}" />
								</td>
							</tr>
							<tr class="datacell2">
								...
								<td class="datacell1font">
									<input name="propertyvalue" size="20"
										value="{propertyvalue}" />
								</td>
							</tr>
							<tr class="datacell2">
								...
								<td class="datacell1font">
									<input name="propertydesc" size="50"
										value="{propertydesc}" />
								</td>
							</tr>
							<tr class="datacell1">
