...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="*" mode="mode0">
		<tr class="headercell">
			<td align="center" class="outerboxcellfont" colspan="2">
				Parents of:
				<xsl:value-of select="parentsfor" />
			</td>
		</tr>
		<tr class="headercell2">
			<td width="40%" class="headercell2font" align="left">Name&nbsp;
			</td>
			<td width="60%" class="headercell2font" align="left">Display
				Name&nbsp;
			</td>
		</tr>
		<xsl:choose>
			<xsl:when test="count(list)=1 and list/componentid=''">
				<tr class="datacell1">
					<td class="datacellnoentriesfound" colspan="2" align="center">No
						entries found.&nbsp;
					</td>
				</tr>
			</xsl:when>
	...
	<xsl:template match="list" mode="mode1">
		<tr class="datacell1">
			...
			<td valign="top" class="datacell1font">
				<xsl:comment>
