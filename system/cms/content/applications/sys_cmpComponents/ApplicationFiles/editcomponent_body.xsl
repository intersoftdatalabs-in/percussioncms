...
<xsl:stylesheet version="1.1"
	...
	<xsl:template mode="editcomponent_mainbody" match="*">
		<xsl:variable name="userroles"
			select="document(userrolesurl)/UserStatus" />
		<xsl:variable name="componentcontext"
			select="document(contexturl)/componentcontext/context" />
		...
		<table width="100%" height="100%" cellpadding="0"
			...
			<tr class="outerboxcell">
				<td class="outerboxcell" align="right" valign="top" colspan="2">
					<span class="outerboxcellfont">Edit
						Component&nbsp;&nbsp;
					</span>
				</td>
			</tr>
			<tr class="headercell">
				<td>
                  ...
                  <xsl:choose><xsl:when
								test="//sys_community=0">newcomponent_gen.html</xsl:when><xsl:otherwise>newcomponent_comm.html</xsl:otherwise></xsl:choose>
						</xsl:when>
                ...
                <xsl:value-of select="componentname" />
							...
							<tr class="headercell2">
								<td width="30%" align="left" class="headercell2font">Component&nbsp;ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</td>
                ...
                <xsl:value-of select="componenturl" />
							...
							<tr class="datacell2">
								...
								<td class="datacell1font">
									<select name="componenttype">
										<option value="1">
											<xsl:if test="componenttype=1">
												<xsl:attribute name="selected" />
											</xsl:if>Page
											Component&nbsp;
										</option>
										<option value="2">
											<xsl:if test="componenttype=2">
												<xsl:attribute name="selected" />
											</xsl:if>Page&nbsp;
										</option>
									</select>
							...
							<tr class="datacell1">
								<td colspan="2">
									<input type="button" value="Save" class="nav_body"
										name="save" onclick="javascript:save_onclick()" />&nbsp;
									<input type="button" value="Cancel" class="nav_body"
										name="cancel" language="javascript" onclick="cancelFunc();" />
								</td>
							</tr>
						</form>
					</table>
					<xsl:if test="not(componentid='')">
						<xsl:apply-templates
							select="document(childlookupurl)/*" mode="complookup">
							<xsl:with-param name="viewparenturl"
								select="viewparenturl" />
						</xsl:apply-templates>
					</xsl:if>
					<xsl:if test="not(componentid='')">
						<xsl:apply-templates
							select="document(propertylookupurl)/*" mode="propertylookup" />
					</xsl:if>
				</td>
			</tr>
			<tr class="headercell">
		...
		<table width="100%" cellpadding="0" cellspacing="1" border="0">
			...
			<tr class="outerboxcell">
				<td class="outerboxcell" align="left" valign="top" colspan="5">
					<span class="outerboxcellfont">Child
						Components&nbsp;&nbsp;
					</span>
				</td>
			</tr>
			...
			<tr class="headercell2">
				<td width="5%" align="center" class="headercell2font">&nbsp;
				</td>
				<td width="5%" align="center" class="headercell2font">&nbsp;
				</td>
				<td width="40%" align="left" class="headercell2font">Name&nbsp;(ID)&nbsp;&nbsp;&nbsp;
				</td>
				<td width="40%" align="left" class="headercell2font">Display&nbsp;Name&nbsp;
				</td>
				<td width="10%" align="left" class="headercell2font">Sort
					Order&nbsp;
				</td>
			</tr>
			<xsl:for-each select="slot">
				<xsl:if test="not(count(list)=1 and list/componentid='')">
					<tr class="headercell2">
						<td colspan="3" align="left" class="headercell2font">
							Slot Name:
						...
						<td colspan="2" align="right" class="headercell2font">
							<a>
								<xsl:attribute name="href">
					  <xsl:value-of
									select="concat(/*/addurl,'&amp;slotcategoryname=',slotname)" />
					</xsl:attribute>
								Add&nbsp;Child&nbsp;to&nbsp;Slot
							</a>&nbsp;&nbsp;&nbsp;
						</td>
							...
							<xsl:otherwise>
								<td align="center" class="datacell1font">
									<a href="javascript:delConfirm('{deleteurl}');">
										<img height="21" alt="Delete"
											src="/sys_resources/images/delete.gif" width="21" border="0" />
									</a>
								</td>
								<td align="center" class="datacell1font">
									<a href="{editcomponenturl}">
										<img height="17" alt="Edit"
											src="../sys_resources/images/update.gif" width="17"
											border="0" />
									</a>
								</td>
			...
			<tr>
				<td class="datacell1font" colspan="5">
					<input type="button" name="parentview" value="View Parents"
						onClick="window.open('')">
						<xsl:attribute name="onClick">window.open(&#34;<xsl:value-of
							select="$viewparenturl" />&#34;,&#34;viewparents&#34;,&#34;toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=500,height=400,z-lock=1&#34;)</xsl:attribute>
					</input>
				</td>
			</tr>
		</table>
		...
		<table width="100%" cellpadding="0" cellspacing="1" border="0">
			...
			<tr class="outerboxcell">
				<td class="outerboxcell" align="left" valign="top" colspan="4">
					<span class="outerboxcellfont">Component&nbsp;Properties&nbsp;
					</span>
				</td>
			</tr>
			<tr class="headercell">
			...
			<tr class="headercell2">
				...
				<td width="25%" align="left" class="headercell2font">Property&nbsp;Name&nbsp;
				</td>
				<td width="25%" align="left" class="headercell2font">Property&nbsp;Value&nbsp;
				</td>
				<td width="45%" align="left" class="headercell2font">Property&nbsp;Description&nbsp;
				</td>
			</tr>
			<xsl:for-each select="list">
				<tr class="datacell1">        <!-- Repeats once per view row -->
