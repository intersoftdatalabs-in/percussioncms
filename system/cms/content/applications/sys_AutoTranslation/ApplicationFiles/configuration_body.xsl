		...
		<table width="100%" height="100%" cellpadding="0"
            ...
            &nbsp;&nbsp;&nbsp;
						...
						<tr class="headercell2">
							...
							<td width="25%" align="left" class="headercell2font">Content&nbsp;Type&nbsp;(ID)
							</td>
							<td width="20%" align="left" class="headercell2font">Locale</td>
							<td width="25%" align="left" class="headercell2font">Community&nbsp;(ID)
							</td>
							<td width="25%" align="left" class="headercell2font">Workflow&nbsp;(ID)
							</td>
						</tr>
