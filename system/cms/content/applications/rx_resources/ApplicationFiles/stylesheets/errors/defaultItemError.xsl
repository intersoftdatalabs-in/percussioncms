			...
			<body>
					...
					<tr class="outerboxcell">
						<td>
							<table width="100%" cellpadding="0" cellspacing="1"
								...
								<xsl:apply-templates select="*/ErrorSet"
									mode="mode1" />
							</table>
						</td>
					</tr>
				...
				<tr>
					<td class="datacell1font">
						Please go back to the Rhythmyx content administrator
						and make necessary
						corrections.
					</td>
				</tr>
		...
		<xsl:for-each select=".">
			<tr class="datacell1">
				<td width="20%" class="datacell1font">
					<xsl:apply-templates
						select="ErrorFieldSet/ErrorField/@displayName" />
				</td>
				<td width="20%" class="datacell1font">
					<xsl:apply-templates
						select="ErrorFieldSet/ErrorField/@submitName" />
				</td>
