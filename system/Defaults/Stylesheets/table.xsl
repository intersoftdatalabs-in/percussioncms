<!-- Default table-based generic style sheet, can be used to generate table-centric
	view of XML data. Handles product specific page request nodes. -->
										...
										<xsl:when test="./*/PSXPrevPage">
											<A>
												<xsl:attribute name="HREF"><xsl:value-of
													select="./*/PSXPrevPage" /></xsl:attribute>
												Prev
											</A>
										</xsl:when>
								...
								<TD>
									<xsl:choose>
										<xsl:when test="./*/PSXNextPage">
											<A>
												<xsl:attribute name="HREF"><xsl:value-of
													select="./*/PSXNextPage" /></xsl:attribute>
												Next
											</A>
										</xsl:when>
