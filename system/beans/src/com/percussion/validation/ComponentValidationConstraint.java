...
public interface ComponentValidationConstraint extends ValidationConstraint {
    ...
    * If {@code compLabel} is supplied, the error message includes the
    * label to identify the component.
    * 
    * @param compLabel the label of the component, may be {@code null} or
    * empty.
    * 
    * @return the message, never {@code null}, may be empty.
    */
   String getErrorText(String compLabel);
}
