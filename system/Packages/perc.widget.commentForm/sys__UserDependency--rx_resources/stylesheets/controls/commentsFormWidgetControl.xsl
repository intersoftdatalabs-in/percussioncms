...
<xsl:stylesheet version="1.1"
	...
	<psxctl:ControlMeta name="commentsFormWidgetControl"
		...
		<psxctl:AssociatedFileList>
			...
			<psxctl:FileDescriptor
				name="perc-comments-form-widget.css" type="css" mimetype="text/css">
			...
			<!-- TinyMce -->
			<psxctl:FileDescriptor name="jquery.tinymce.js"
				type="script" mimetype="text/javascript">
			...
			<psxctl:FileDescriptor name="TinymceConfig.js"
				type="script" mimetype="text/javascript">
			...
			<psxctl:FileDescriptor
				name="PercUtilService.js" type="script" mimetype="text/javascript">
	...
	<xsl:template
		match="Control[@name='commentsFormWidgetControl']" mode="psxcontrol">
		...
		<div id="{@paramName}" class="PercFormWidget">
			<div id="perc-form-top-row">
				<div id="perc-control-menu-button">
					<img
						src="/rx_resources/widgets/commentsForm/images/control.png"
						title="Form controls menu" />
				</div>
	...
	<xsl:template
		match="Control[@name='commentsFormWidgetControl' and @isReadOnly='yes']"
