...
(function ($) {
  ...
  var issueMessages = {
    ...
    MISSING_DESCRIPTION: I18N.message(
      "perc.ui.gadgets.seo@Missing Description"
    ),
    MISSING_KEYWORD_DESCRIPTION: I18N.message(
      "perc.ui.gadgets.seo@Missing Keyword Description"
    ),
    MISSING_KEYWORD_LINK: I18N.message(
      "perc.ui.gadgets.seo@Missing Keyword Link"
    ),
    MISSING_KEYWORD_TITLE: I18N.message(
      "perc.ui.gadgets.seo@Missing Keyword Title"
    ),
    TITLE_TOO_LONG: I18N.message("perc.ui.gadgets.seo@Title Too Long"),
    TEST: "Very Long Test message",
    DESCRIPTION_TOO_LONG: I18N.message(
      "perc.ui.gadgets.seo@Description Too Long"
    ),
  };
  ...
  function createStatusTable(data) {
    ...
    for (i = 0; i < pageStats.length; i++) {
      ...
      issuesMessageTitle = issuesMessageTitle.substring(
        0,
        issuesMessageTitle.length - 2
      );
      ...
      if ($.browser.mozilla)
        issuesMessageTitle = sevText + "; " + issuesMessageTitle;
      else issuesMessageTitle = sevText + "&#xD;" + issuesMessageTitle;
      var toolTip = issuesMessageTitle;

      imageName =
        "<img src='/cm/gadgets/repository/common/images/" +
        imageName +
        "' data-severity='" +
        stats.severity +
        "' alt='" +
    ...
    var headers = [
      ...
      I18N.message("perc.ui.seo.gadget@Title Tag"),
      I18N.message("perc.ui.seo.gadget@Issues"),
      I18N.message("perc.ui.seo.gadget@Severity"),
    ];
  ...
  function declareCustomSortingFunctions() {
    ...
    $.fn.dataTableExt.afnSortData["perc-type-html-img"] = function (
      oSettings,
      iColumn
    ) {
      var aData = [];
