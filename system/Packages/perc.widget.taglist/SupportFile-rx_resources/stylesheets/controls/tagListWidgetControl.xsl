...
<xsl:stylesheet version="1.1"
	...
	<psxctl:ControlMeta name="tagListWidgetControl"
		dimension="single" choiceset="none">
		<psxctl:Description>The control for building the JCR query for the Tag
		...
		<psxctl:AssociatedFileList>
			...
			<psxctl:FileDescriptor name="ui.dynatree.css"
				type="css" mimetype="text/css">
				<psxctl:FileLocation>/cm/css/dynatree/skin/ui.dynatree.css</psxctl:FileLocation>
				<psxctl:Timestamp />
			</psxctl:FileDescriptor>
			<psxctl:FileDescriptor
				name="jquery.tagList.css" type="css" mimetype="text/css">
			...
			<!-- Tag List Control JS -->
			<psxctl:FileDescriptor
				name="jquery.tagListControl.js" type="script"
				mimetype="text/javascript">
	...
	<xsl:template
		match="Control[@name='tagListWidgetControl']" mode="psxcontrol">
		...
		<script>
			...
			*********************************************************************
			...
			'/rx_resources/widgets/tagList/images/calendar.gif', buttonImageOnly:
			true, altFormat: 'yy-mm-dd', buttonText: ''
			});
		...
		<script>
			...
			$("#taglist-title").on("click",
			function () {
			$("#criteria_for_list").toggle();
			$("#taglist-title").toggleClass("taglist-expand-image
			taglist-close-image");
			});
			});
		</script>
		<div id="perc-taglist-wrapper">
			...
			<div id="criteria_for_list">
						...
						<tr>
							...
							<td>
								...
								<input size="16" type="text" name="display_start_date"
									id="display_start_date" class="date-pick" />
							</td>
							<td width="10px"></td>
							<td>
								...
								<input size="16" type="text" name="display_end_date"
									id="display_end_date" class="date-pick" />
							</td>
						</tr>
					</table>
				</div>
				...
				<div>
					<span class="taglistlabel">
						<label for='perc_taglist_resultspage'
							style="font-weight:bold">Results page:</label>
					</span>
					<div style="margin-top: 5px;">
						<input type='text' name='display_tag_page_result'
							id='display_tag_page_result' />
	...
	<xsl:template
		match="Control[@name='tagListWidgetControl' and @isReadOnly='yes']"
	...
	<![CDATA[
		...
		<div id="perc-taglist-wrapper">
			...
			<div id="criteria_for_list">
				...
				<br />
				<div class="datadisplay" id="perc_display_tag_page_result">
					<xsl:value-of
						select="//DisplayField/Control[@paramName='tag_page_result']/Value" />
				</div>
