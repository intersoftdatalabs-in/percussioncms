...
<xsl:stylesheet version="1.1"
	...
	<psxctl:ControlMeta name="percGoogleCalendarControl"
		...
		<psxctl:AssociatedFileList>
			...
			<psxctl:FileDescriptor name="perc_save_as.js"
				type="script" mimetype="text/javascript">
	...
	<xsl:template
		match="Control[@name='percGoogleCalendarControl']" mode="psxcontrol">
		<input type="hidden" name="{@paramName}"
			id="perc-content-edit-{@paramName}" value="{Value}" />
		<span id="perc-google-setup-toggle"
			class="perc-toggle-google-setup fa fa-cogs"
			title="Click to toggle Google Calendar Setup (Calendar 2.0 Only)"></span>
		<label for="perc-google-setup-toggle">
			Click to toggle Google Calendar Setup
			<i>(Calendar 2.0 Only)</i>
		</label>
		<div class="perc-google-calendar" id="{@paramName}">
			<h2>Google Calendar Setup</h2>
			<span id="perc-help-toggle"
				class="perc-toggle-help fa fa-question-circle"
				title="Click to toggle help"></span>
			<label for="perc-help-toggle">Click to toggle help.</label>
			<div class="perc-help">
				Integration of Google Calendar sources requires the following
				information:
				...
				If all of the Google Calendars you are planning to integrate are
				managed by the same Google account, the same API key can be used for
				each calendar. However, if the they are managed by separate Google
				accounts, it is a best practice to create an API key for each
				calendar within the calendar owner accounts.
				<br />
				<br />
				The steps below must be followed to enable Google Calendar
				integration.
				<ul>
					<li>
						<b>Generate a Google Calendar API key:</b>
						<ul>
							<li>
								Navigate to the
								<a href="https://console.developers.google.com/"
									target="_blank" rel="noopener noreferrer">Google Developer Console</a>
								and create a new project.
							</li>
							<li>
								Enter the newly created project and select
								<b>Library</b>
								on the sidebar.
							</li>
							<li>*Find &quot;Calendar API&quot; in the list and set it to
								ENABLE.</li>
							<li>
								On the sidebar, select Credentials and choose
								<b>Create credentials &gt; API key</b>
								and then select &quot;Browser key&quot;
							</li>
							<li>To control your API key usage, it is recommended to enter the
								domains that will be hosting your calendar.</li>
							<li>The new API key will be generated, but may take a short
								period of time before it can be actively used.</li>
						</ul>
					</li>
					<br />
					<li>
						<b>Make your Google Calendar public:</b>
						<ul>
							<li>Within Google Calendar settings, select
								&quot;Calendars&quot;, and choose the calendar you would like to
								configure.</li>
							<li>Select &quot;Share this Calendar&quot;.</li>
							<li>Check the &quot;Make this calendar public&quot; option.</li>
							<li>&quot;See all event details&quot; should be chosen from the
								dropdown.</li>
					...
					<br />
					<li>
						<b>Retrieve your Google Calendar ID:</b>
						<ul>
							<li>Within Google Calendar settings, select
								&quot;Calendars&quot;, and choose the calendar you would like to
								view.</li>
							<li>
								Across from the
								<b>Calendar Address:</b>
								section, next to the
								<b>ICAL</b>
								and
								<b>HTML</b>
								buttons, will be your Calendar ID.
							</li>
						</ul>
					</li>
				</ul>
			</div>
			<div id="perc-google-calendar-setup-editor"
				class="perc-google-calendar-setup-editor">
				<span class="perc-table-add fa fa-plus-square"></span>
				<table class="perc-table">
					<tbody>
						<tr>
							<td class="perc-input-header">*Calendar Name</td>
							<td class="perc-input-header">*Calendar ID</td>
							<td class="perc-input-header">*API Key</td>
							<td class="perc-input-header">*Background Color</td>
							<td class="perc-input-header">*Text Color</td>
							<td></td>
						</tr>
						<!-- This is the template table row -->
						<tr class="hide perc-google-calendar-row" role="presentation">
							<td class="perc-input-td">
								<input id="perc-google-calendar-name"
									class="perc-google-calendar-name" type="text"></input>
							</td>
							<td class="perc-input-td">
								<input id="perc-google-calendar-id"
									class="perc-google-calendar-id" type="text"></input>
							</td>
							<td class="perc-input-td">
								<input id="perc-google-calendar-api-key"
									class="perc-google-calendar-api-key" type="text"></input>
							</td>
							<td class="perc-input-td">
								<input id="perc-google-calendar-background-color"
									class="perc-google-calendar-background-color"
									data-control="hue" value="#3a87ad" type="text"></input>
							</td>
							<td class="perc-input-td">
								<input id="perc-google-calendar-text-color"
									class="perc-google-calendar-text-color" data-control="hue"
									value="#ffffff" type="text"></input>
							</td>
							<td class="perc-input-td">
	...
	<xsl:template
		match="Control[@name='percGoogleCalendarControl' and @isReadOnly='yes']"
