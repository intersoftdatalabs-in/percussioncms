...
<xsl:stylesheet version="1.1"
	...
	<psxctl:ControlMeta name="blogIndexPageControl"
		...
		<psxctl:AssociatedFileList>
			...
			<psxctl:FileDescriptor
				name="jquery.blogIndexPage.js" type="script"
				mimetype="text/javascript">
	...
	<xsl:template
		match="Control[@name='blogIndexPageControl']" priority="10"
		mode="psxcontrol">
