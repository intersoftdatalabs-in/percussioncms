...
(function ($) {
  $.PercEditSiteUser = function (site, userData, successCalBack) {
    ...
    function saveUserData() {
      ...
      $.PercMembershipService.saveUser(
        siteName,
        userObj,
    ...
    function createDialogHtml() {
      var dialogHtml =
        ...
        `<label class = "perc_dialog_label" >${I18N.message(
          "perc.ui.common.label@Cancel"
        )}:</label>` +
        "</div>" +
        '<div id="perc_user">' +
        '<label style = "font-weight:bold" class = "perc_dialog_input perc_dialog_field">' +
        userData.account +
        "</label>" +
        "</div>" +
        "<br />" +
        ...
        `<label class = "perc_dialog_label" >${I18N.message(
          "perc.ui.common.label@Groups"
        )}:</label>` +
        "</div>" +
        '<div id="perc_groups">' +
        '<input type="text" id="perc_user_groups" class = "perc_dialog_input perc_dialog_field" name="perc_user_groups" maxlength="4000" value="' +
        userData.groups +
        '"/><br />' +
        I18N.message(
