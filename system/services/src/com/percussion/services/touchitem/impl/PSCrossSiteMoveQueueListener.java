 ...
 *
 */
public class PSCrossSiteMoveQueueListener extends PSMessageQueueListenerAdapter<PSCrossSiteFolderMoveActionData>
{

   /**
    * {@inheritDoc}
    */
   public void onMessage(PSCrossSiteFolderMoveActionData object)
   {
      try
      {
         PSCrossSiteFolderMoveActionProcessor ap = new PSCrossSiteFolderMoveActionProcessor(object);
    ...
    */
   @Override
   public Class<PSCrossSiteFolderMoveActionData> getType()
   {
