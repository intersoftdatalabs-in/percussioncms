...
public class PSNamespaceCleanup2 implements IPSPropertyInterceptor {

    private static final PSNamespaceCleanup2 instance = new PSNamespaceCleanup2();

    private PSNamespaceCleanup2(){}
