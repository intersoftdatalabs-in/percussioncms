...
public class PSDivTagCleanup2 implements IPSPropertyInterceptor {

    private static final PSDivTagCleanup2 instance = new PSDivTagCleanup2();

    public static IPSPropertyInterceptor getInstance(){
        return instance;
    }

    private PSDivTagCleanup2(){}
