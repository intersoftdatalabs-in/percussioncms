 ...
 * catalog ({@code http.file} / {@code pages.json} / {@code http.url} body) edit, or an RSS/Atom
 * feed ({@code rss.file} / {@code feed.xml} / {@code atom.xml} / {@code rss.url} body) edit)
 * must see the new bytes. File watchers are not required; the next explicit build is the
 * refresh.
 */
