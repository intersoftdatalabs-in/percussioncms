...
//         new PSAppGuidConverter());
   ...
   private PSSearchField getLocaleSearchField(IPSGuid guid)
   {
      ...
      PSLocale locale = objMgr.loadLocale(guid.getUUID()).orElse(null);  // safe cast
      if (locale == null)
         throw new IllegalArgumentException(
            "Could not locate object identified by id: " + guid.toString());
   ...
   private class PSLocaleGuidConverter implements IPSGuidConverter
   {
         ...
         throws PSException
      {
         ...
         String name = null;
         IPSCmsObjectMgr objMgr = PSCmsObjectMgrLocator.getObjectManager();
         PSLocale locale = objMgr.loadLocale((int)id).orElse(null);  // safe cast
         if (locale != null)
         {
         ...
         throws PSException
      {
         ...
         String id = null;
         IPSCmsObjectMgr objMgr = PSCmsObjectMgrLocator.getObjectManager();
         PSLocale locale = objMgr.findLocaleByLanguageString(name).orElse(null);
         if (locale != null)
         {
