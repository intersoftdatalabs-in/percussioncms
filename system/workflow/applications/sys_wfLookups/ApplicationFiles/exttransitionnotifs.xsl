...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="*" mode="exttransitionnotifs">
		...
		<tr class="headercell2">
			<td height="21" width="5%" align="center" class="headercell2font">&nbsp;
			</td>
			<td height="21" width="25%" align="left" class="headercell2font">Subject
				(Notification ID)</td>
			<td height="21" width="20%" align="left" class="headercell2font">State Role
				Recipient Type</td>
			<td height="21" width="25%" align="left" class="headercell2font">Additional
				Recipient List</td>
			...
			<xsl:if test="not(notificationid = '')">
				...
				<xsl:choose>
					...
					<td class="datacell1font" height="25" align="center">
						<a>
							<xsl:attribute name="href">javascript: delConfirm('<xsl:value-of
								select="deletelink" />' );</xsl:attribute>
							<img src="/sys_resources/images/delete.gif" width="21"
								height="21" border="0" />
						</a>
					</td>
                ...
                <xsl:value-of select="link" />
					...
					<td class="datacell1font" height="20" align="left">
						<xsl:variable name="reciptype">
							<xsl:value-of select="staterolerecipienttypes" />
						</xsl:variable>
						<xsl:apply-templates
							select="document(reciptypeurl)/*/item[value=$reciptype]/display" />&nbsp;
					</td>
					<td class="datacell1font" height="20" align="left">
						<xsl:apply-templates
							select="additionalrecipientlist" />
					</td>
					<td class="datacell1font" height="20" align="left">
