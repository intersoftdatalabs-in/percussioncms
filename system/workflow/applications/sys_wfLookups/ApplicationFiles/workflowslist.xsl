		...
		<table width="100%" cellpadding="0" cellspacing="1" border="0">
			<tr class="datacelll">
				...
				<td height="21" width="100%" align="right"
					class="outerboxcellfont" colspan="4">Workflows</td>
			</tr>
			<tr class="headercell">
				<!-- Repeats once per view row -->
				<td height="21" width="100%" align="right" class="headercellfont"
					colspan="4">
					<a href="{newwflink}"> New Workflow</a>&nbsp;&nbsp;
					<a href="{copywflink}">Copy Workflow</a>
				</td>
			</tr>
			<tr class="datacell2">
				<!-- Repeats once per view row -->
				<td height="21" width="5%" align="center" class="headercellfont">&nbsp;
				</td>
			...
			<xsl:for-each select="workflow">
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						...
						<td class="datacell1font" height="21" align="center">
							<a>
								<xsl:attribute name="href">javascript: delConfirmWf('<xsl:value-of
									select="deletelink" />' );</xsl:attribute>

								<img src="/sys_resources/images/delete.gif" width="21"
									height="21" border="0" alt="Delete" title="Delete" />
							</a>
						</td>
                ...
                <xsl:value-of select="link" />
						...
						<xsl:text>', 'previewworkflow', 'width=860,height=500,location=0;0,toolbar=no,menubar=no,scrollbars=yes,resizable=yes')</xsl:text>
								...
								<img src="/sys_resources/images/preview.gif" width="21"
									height="21" border="0" alt="Preview Workflow"
