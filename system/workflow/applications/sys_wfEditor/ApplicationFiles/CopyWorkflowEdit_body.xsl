...
<xsl:stylesheet version="1.1"
	...
	<xsl:template mode="copyworkfloweditbody" match="*">
		<table width="100%" height="100%" cellpadding="0"
			...
			<form name="CopyWorkflow" action="" method="post"
				enctype="multipart/form-data" onsubmit="return save_onclick()">
							...
							<tr class="datacell1">
								<td colspan="2" align="left" class="datacell1font">
									<input type="button" class="nav_body" name="DBActionType"
										value="Create" onclick="javascript:save_onclick	();" />&nbsp;
									<input type="button" class="nav_body" name="Cancel"
