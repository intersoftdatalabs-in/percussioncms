...
<xsl:stylesheet version="1.1"
	...
	<xsl:variable name="statelookup"
		select="document(//statelookupurl)//sys_Lookup" />
	<xsl:variable name="initialstateid"
		select="//initialstate" />
	<xsl:template mode="workfloweditbody" match="*">
		<table width="100%" height="100%" cellpadding="0"
			cellspacing="0" border="0">
			<form name="UpdateWorkflow" action="UpdateWorkflow.htm"
				...
				<tr class="headercell">
					<td valign="top" colspan="2">
						...
						<table width="100%" height="100%" cellpadding="0"
							...
							<xsl:apply-templates select="workflowEdit"
								mode="mode17" />
						</table>
					</td>
				</tr>
				<tr class="headercell">
					<td valign="top" align="center">
						<table width="100%" cellpadding="0" cellspacing="1"
							...
							<xsl:apply-templates
								select="document($extstates)" mode="statelist" />
						</table>
					</td>
				</tr>
				<tr class="headercell">
					<td valign="top">
						<table width="100%" cellpadding="0" cellspacing="1"
							...
							<xsl:apply-templates
								select="document($extroles)" mode="rolelist" />
						</table>
					</td>
				</tr>
				<tr class="headercell">
					<td valign="top">
						<table width="100%" cellpadding="0" cellspacing="1"
							...
							<xsl:apply-templates
								select="document($extstatenotifs)" mode="statenotiflist" />
						</table>
					</td>
				</tr>
				<tr class="headercell">
