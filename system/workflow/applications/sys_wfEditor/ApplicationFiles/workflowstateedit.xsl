...
<xsl:stylesheet version="1.1"
	...
	<xsl:include
		href="file:sys_wfLookups/agingtransitionslist.xsl" />
	<xsl:include
		href="file:sys_wfEditor/workflowstateedit_body.xsl" />
	<xsl:variable name="relatedlinks" select="/*/relatedlinks" />
	<xsl:variable name="this" select="/" />
	<xsl:variable name="extstateroles"
		select="/*/URL/extstateroles" />
	<xsl:variable name="exttransitions"
		select="/*/URL/exttransitions" />
	<xsl:variable name="extagingtransitions"
		select="/*/URL/extagingtransitions" />
				...
				<table width="100%" cellpadding="0" height="100%"
					...
					<tr>
						...
						<td align="middle" width="100%" valign="top" height="100%"
							...
							<!-- start main body slot -->
							<xsl:apply-templates
								mode="workflowstateeditbody" select="*" />
							<!-- end main body slot -->
						</td>
					</tr>
				</table>
