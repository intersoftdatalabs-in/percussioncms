						...
						<td align="middle" width="100%" valign="top" height="100%"
							...
							<form name="UpdateWorkflow" method="get">
								...
								<xsl:attribute name="action"><xsl:choose><xsl:when
									test="//sys_community=0">NewWorkflow_gen.html</xsl:when><xsl:otherwise>NewWorkflow_comm.html</xsl:otherwise></xsl:choose></xsl:attribute>
						...
						<span class="outerboxcellfont">
							<a>
								<xsl:attribute name="href"><xsl:value-of
									select="../workflowlink" /></xsl:attribute>
								Workflows
							</a>
							&gt;
