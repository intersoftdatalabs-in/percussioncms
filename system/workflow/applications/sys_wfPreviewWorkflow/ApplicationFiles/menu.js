...
function writeMenus(container) {
  ...
  for (var i = 0; i < container.menus.length; i++, countMenus++) {
    ...
    content +=
      ...
      ";top:" +
      proto.menuBorder +
      ';visibility:hide;" onMouseOut="hideMenu(this);">\n' +
      '    <DIV ID="menuFg' +
      countMenus +
      '" STYLE="position:absolute;left:1;top:1;visibility:hide;">\n' +
      "";
    var x = i;
    for (var i = 0; i < menu.items.length; i++) {
      ...
      if (document.all)
        itemProps +=
          "font-size:" +
          proto.fontSize +
          ';" onMouseOver="onMenuItemOver(null,this);" onMouseOut="onMenuItemOut(null,this);" onClick="onMenuItemAction(null,this);';
      var dTag =
        '<DIV ID="menuItem' +
        countItems +
        '" STYLE="position:absolute;left:0;top:' +
        i * proto.menuItemHeight +
        ";" +
        itemProps +
        '">';
      var dText =
      ...
      if (item == "separator") {
        content +=
          ...
          countItems +
          '" STYLE="position:absolute;left:1;top:2;"></DIV>\n<DIV ID="menuSeparatorLite' +
          countItems +
          '" STYLE="position:absolute;left:1;top:2;"></DIV>\n</DIV>';
      } else if (childMenu) {
        content +=
    ...
    content +=
      '      <DIV ID="focusItem' +
      countMenus +
      '" STYLE="position:absolute;left:0;top:0;visibility:hide;" onClick="onMenuItemAction(null,this);">&nbsp;</DIV>\n';
    content += "   </DIV>\n  </DIV>\n</DIV>\n";
    i = x;
  }
  if (!container) return;
  ...
  if (container.document.layers) {
    ...
    for (var i = 0; i < container.document.layers.length; i++) {
      proto =
        container.menus[i].prototypeStyles ||
      ...
      for (var n = 0; n < body.document.layers.length - 1; n++) {
        ...
        l.clip.width =
          proto.menuItemWidth || body.clip.width + proto.menuItemIndent;
    ...
    for (var x = 0; x < container.menus.length; x++) {
      ...
      proto =
        container.menus[x].prototypeStyles ||
        this.prototypeStyles ||
        container.menus[x];
      ...
      for (var i = 0; i < container.menus[x].items.length; i++) {
        ...
        if (i > 0)
          l.style.pixelTop =
            container.document.all["menuItem" + (menuCount - 1)].style
              .pixelTop +
            container.document.all["menuItem" + (menuCount - 1)].style
              .pixelHeight +
            proto.menuItemBorder;
      ...
      container.menus[x].menuLayer.style.pixelWidth =
        proto.menuWidth || proto.menuItemWidth + proto.menuBorder * 2 + 2;
      container.menus[x].menuLayer.style.pixelHeight =
        proto.menuHeight + proto.menuBorder * 2 + 2;
      if (menu.Menu.enableTracker) {
        menu.Menu.disableHide = true;
        setMenuTracker(menu.Menu);
      }
    }
    container.document.all("menuContainer").style.backgroundColor =
      container.menus[0].menuContainerBgColor;
  ...
  if (document.layers) {
    ...
    if (l.parentLayer) {
      ...
      if (l.parentLayer.isContainer) {
        ...
        if (l.parentLayer.menuContainerBgColor)
...
function hideMenu(e) {
  ...
  if (a && document.layers) {
    ...
    if (a.childMenu) a.document.layers[1].document.images[0].src = a.icon;
    if (
      mDrag.oldX <= e.pageX + 3 &&
      mDrag.oldX >= e.pageX - 3 &&
      mDrag.oldY <= e.pageY + 3 &&
      mDrag.oldY >= e.pageY - 3
    ) {
  ...
  if (l.childMenu) {
    if (document.layers) {
      ...
      if (l.childMenu.left + l.childMenu.clip.width > window.innerWidth) {
        l.childMenu.left =
          l.parentLayer.left -
          l.childMenu.clip.width +
          l.Menu.menuLayer.top +
          15;
      ...
      l.childMenu.style.pixelTop =
        l.style.pixelTop + l.Menu.menuLayer.style.pixelTop;
      if (
        l.childMenu.style.pixelLeft + l.childMenu.style.pixelWidth >
        document.width
      ) {
        l.childMenu.style.pixelLeft =
          l.childMenu.style.pixelWidth + l.Menu.menuLayer.style.pixelTop + 15;
      } else if (l.Menu.childMenuDirection == "left") {
        //l.childMenu.style.pixelLeft = l.parentLayer.left - l.parentLayer.clip.width;
      } else {
        l.childMenu.style.pixelLeft =
          l.Menu.menuLayer.style.pixelWidth +
          l.Menu.menuLayer.style.pixelLeft -
          5;
      }
