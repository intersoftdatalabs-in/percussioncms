...
<xsl:stylesheet version="1.1"
	...
	<!-- replace all of the existing PSXRelationshipConfig elements with the
		given ones -->
	<xsl:template match="PSXRelationshipConfigSet" mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
			<PSXRelationshipConfig category="rs_copy"
				label="New Copy" name="New Copy" type="system">
				...
				<PSXPropertySet>
					<PSXProperty locked="yes" name="rs_allowcloning">
						...
						<Description>Specifies whether or not this relationship can be
							cloned. This property can be overridden in the request if
							associated locked property is not checked.</Description>
					</PSXProperty>
					<PSXProperty locked="yes" name="rs_useownerrevision">
						<Value type="Boolean">yes</Value>
						<Description>Defines whether or not to use the owner revision as
							part of the owner locator.</Description>
					</PSXProperty>
					<PSXProperty locked="yes"
						name="rs_usedependentrevision">
						<Value type="Boolean">no</Value>
						<Description>Defines whether or not to use the dependent revision
							as part of the dependent locator.</Description>
					</PSXProperty>
					<PSXProperty locked="no" name="rs_expirationtime">
						<Value type="Date" />
						<Description>Specifies the expiry date and time if this
							relationship can expire. Do not specify a value if the
							relationship should not be expired.</Description>
					</PSXProperty>
					<PSXProperty locked="no" name="rs_useserverid">
						<Value type="Boolean">yes</Value>
						<Description>Specifies the user to be used while executing
							effects. If checked the user RXSERVER will be used, otherwise the
							current user will be used.</Description>
					</PSXProperty>
					<PSXProperty locked="no" name="rs_islocaldependency">
						<Value type="Boolean">no</Value>
						<Description>Specifies if this relationship must be packaged and
							deployed with the owner. If checked, the relationship must be
							deployed, if not, it is optional.</Description>
					</PSXProperty>
				</PSXPropertySet>
				<ProcessChecks>
					<PSXProcessCheck context="relationship"
						name="rs_cloneshallow" sequence="1">
						<Conditions>
							<PSXRule boolean="and">
								<PSXConditional id="1">
									<variable>
			...
			<PSXRelationshipConfig category="rs_promotable"
				label="Promotable Version" name="Promotable Version" type="system">
				<PSXCloneOverrideFieldList id="0">
					<PSXCloneOverrideField id="0"
						name="sys_title">
						<value>
			...
			<PSXRelationshipConfig
				category="rs_activeassembly" label="Active Assembly"
				name="Active Assembly" type="system">
				<PSXCloneOverrideFieldList id="0" />
				<PSXPropertySet>
					<PSXProperty locked="yes" name="rs_allowcloning">
						<Value type="Boolean">yes</Value>
			...
			<PSXRelationshipConfig
				category="rs_activeassembly" label="Active Assembly - Mandatory"
				name="Active Assembly - Mandatory" type="system">
				<PSXCloneOverrideFieldList id="0" />
				<EffectSet>
					<PSXConditionalEffect
			...
			<PSXRelationshipConfig
				category="rs_translation" label="Translation" name="Translation"
				type="system">
				<PSXCloneOverrideFieldList id="0">
					<PSXCloneOverrideField id="0"
						name="sys_title">
			...
			<PSXRelationshipConfig
				category="rs_translation" label="Translation - Mandatory"
				name="Translation - Mandatory" type="system">
				<PSXCloneOverrideFieldList id="0">
					<PSXCloneOverrideField id="0"
						name="sys_title">
						<value>
			...
			<PSXRelationshipConfig category="rs_folder"
				label="Folder Content" name="Folder Content" type="system">
				<PSXCloneOverrideFieldList id="0" />
				<EffectSet>
					<PSXConditionalEffect
						activationEndpoint="owner">
				...
				<PSXPropertySet>
					...
					<PSXProperty locked="yes" name="rs_usecommunityfilter">
						<Value type="Boolean">yes</Value>
						<Description>Specifies if this relationship will be filtered by
