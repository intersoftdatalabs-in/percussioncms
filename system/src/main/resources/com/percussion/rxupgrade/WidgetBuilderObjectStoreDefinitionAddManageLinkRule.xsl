...
<xsl:stylesheet version="1.1"
	...
	<xsl:template
		...
		<xsl:copy>
			...
			<xsl:apply-templates mode="copy" />
			<xsl:if
				test="../PSXPropertySet/PSXProperty[@name='mayHaveInlineLinks']/Value='yes' and not(FieldInputTranslation/PSXFieldTranslation/PSXExtensionCallSet/PSXExtensionCall/name='Java/global/percussion/content/sys_manageLinksConverter')">
