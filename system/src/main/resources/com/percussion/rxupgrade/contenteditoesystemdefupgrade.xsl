...
<xsl:stylesheet version="1.1"
	...
	<!-- Add <PSXUrlRequest name="ComponentLookupURL"> element if does not exist
		to <SectionLinkList> element -->
	...
	<xsl:template match="PSXField" mode="copy">
		<xsl:variable name="readonly"
			select="generate-id(@readOnly)" />
		<xsl:copy>
			<xsl:apply-templates
				select="@*[generate-id(.) != $readonly]" mode="copy" />
			<xsl:choose>
			...
			<xsl:if test="@name='sys_contenttypeid'">
				<xsl:if test="not(PSXChoices)">
					<PSXChoices sortOrder="ascending" type="internalLookup">
						...
						<PSXChoiceFilter>
							<DependentField fieldRef="sys_communityid"
	...
	<xsl:template match="PSXFieldSet" mode="copy">
		<xsl:copy>
			...
			<xsl:if test="not(PSXField[@name='sys_currentview'])">
				<PSXField name="sys_currentview" showInSummary="yes"
			...
			<xsl:if test="not(PSXField[@name='sys_lang'])">
				<PSXField name="sys_lang" defaultSearchLabel="Locale ID"
					modificationType="userCreate" showInSummary="yes"
					showInPreview="yes" forceBinary="no" tokenizeSearchContent="yes">
					<DataLocator>
			...
			<xsl:if test="not(PSXField[@name='sys_assignees'])">
				<PSXField defaultSearchLabel="Assignees" forceBinary="no"
					modificationType="none" name="sys_assignees" showInPreview="no"
					showInSummary="no" type="system">
					<DataLocator>
						<PSXExtensionCall id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_assignmenttypeid'])">
				<PSXField defaultSearchLabel="Assignment type ID"
					forceBinary="no" modificationType="none"
					name="sys_assignmenttypeid" showInPreview="no" showInSummary="no"
					type="system">
					<DataLocator>
						<PSXExtensionCall id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_assignmenttype'])">
				<PSXField defaultSearchLabel="Assignment type"
					forceBinary="no" modificationType="none" name="sys_assignmenttype"
					showInPreview="no" showInSummary="no" type="system">
					<DataLocator>
						<PSXExtensionCall id="0">
							<name>Java/global/percussion/workflow/sys_ComputeAssignmenType</name>
							<PSXExtensionParamValue id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_checkoutstatus'])">
				<PSXField defaultSearchLabel="Checkout status"
					forceBinary="no" modificationType="none" name="sys_checkoutstatus"
					showInPreview="no" showInSummary="no" type="system">
					<DataLocator>
						<PSXExtensionCall id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_contenttypename'])">
				<PSXField defaultSearchLabel="Content Type Name"
					forceBinary="no" modificationType="none" name="sys_contenttypename"
					showInPreview="no" showInSummary="no" type="system"
					userSearchable="yes">
					<DataLocator>
						<PSXExtensionCall id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_statename'])">
				<PSXField defaultSearchLabel="Workflow State Name"
					forceBinary="no" modificationType="none" name="sys_statename"
					showInPreview="no" showInSummary="no" type="system"
					userSearchable="yes">
					<DataLocator>
						<PSXExtensionCall id="0">
					...
					<PSXChoices sortOrder="ascending" type="internalLookup">
						...
						<PSXChoiceFilter>
							<DependentField fieldRef="sys_workflowid"
								dependencyType="required" />
							<PSXUrlRequest>
			...
			<xsl:if test="not(PSXField[@name='sys_communityname'])">
				<PSXField defaultSearchLabel="Community Name"
					forceBinary="no" modificationType="none" name="sys_communityname"
					showInPreview="no" showInSummary="no" type="system"
					userSearchable="yes">
					<DataLocator>
						<PSXExtensionCall id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_localename'])">
				<PSXField defaultSearchLabel="Locale Name" forceBinary="no"
					modificationType="none" name="sys_localename" showInPreview="no"
					showInSummary="no" type="system" userSearchable="yes">
					<DataLocator>
						<PSXExtensionCall id="0">
							<name>Java/global/percussion/cms/sys_CmsObjectNameLookup</name>
							<PSXExtensionParamValue id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_workflowname'])">
				<PSXField defaultSearchLabel="Workflow Name"
					forceBinary="no" modificationType="none" name="sys_workflowname"
					showInPreview="no" showInSummary="no" type="system"
					userSearchable="yes">
					<DataLocator>
						<PSXExtensionCall id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_contentid'])">
				<PSXField defaultSearchLabel="Content id" forceBinary="no"
					modificationType="systemCreate" name="sys_contentid"
					showInPreview="yes" showInSummary="yes" type="system">
					<DataLocator>
			...
			<xsl:if test="not(PSXField[@name='sys_contentstateid'])">
				<PSXField defaultSearchLabel="Workflow State ID"
					forceBinary="no" modificationType="system"
					name="sys_contentstateid" showInPreview="yes" showInSummary="yes"
					type="system">
					<DataLocator>
						<PSXBackEndColumn id="1">
							<tableAlias>CONTENTSTATUS</tableAlias>
			...
			<xsl:if
				test="not(PSXField[@name='sys_contentcheckoutusername'])">
				<PSXField defaultSearchLabel="Checked out user name"
					forceBinary="no" modificationType="system"
					name="sys_contentcheckoutusername" showInPreview="yes"
					showInSummary="yes" type="system">
					<DataLocator>
						<PSXBackEndColumn id="1">
							<tableAlias>CONTENTSTATUS</tableAlias>
							<column>CONTENTCHECKOUTUSERNAME</column>
			...
			<xsl:if test="not(PSXField[@name='sys_contentlastmodifier'])">
				<PSXField defaultSearchLabel="Last modified by"
					forceBinary="no" modificationType="system"
					name="sys_contentlastmodifier" showInPreview="yes"
					showInSummary="yes" type="system">
					<DataLocator>
						<PSXBackEndColumn id="1">
							<tableAlias>CONTENTSTATUS</tableAlias>
			...
			<xsl:if
				test="not(PSXField[@name='sys_contentlastmodifieddate'])">
				<PSXField defaultSearchLabel="Last modified date"
					forceBinary="no" modificationType="system"
					name="sys_contentlastmodifieddate" showInPreview="yes"
					showInSummary="yes" type="system">
					<DataLocator>
						<PSXBackEndColumn id="1">
							<tableAlias>CONTENTSTATUS</tableAlias>
			...
			<xsl:if test="not(PSXField[@name='sys_objecttype'])">
				<PSXField defaultSearchLabel="Object type" forceBinary="no"
					modificationType="systemCreate" name="sys_objecttype"
					showInPreview="yes" showInSummary="yes" type="system"
					userSearchable="no">
					<DataLocator>
						<PSXBackEndColumn id="1">
			...
			<xsl:if test="not(PSXField[@name='sys_contenttypeid'])">
				<PSXField defaultSearchLabel="Content Type"
					forceBinary="no" modificationType="systemCreate"
					name="sys_contenttypeid" showInPreview="yes" showInSummary="yes"
					type="system">
					<DataLocator>
						<PSXBackEndColumn id="1">
							<tableAlias>CONTENTSTATUS</tableAlias>
			...
			<xsl:if test="not(PSXField[@name='sys_contentcreateddate'])">
				<PSXField defaultSearchLabel="Created on" forceBinary="no"
					modificationType="systemCreate" name="sys_contentcreateddate"
					showInPreview="yes" showInSummary="yes" type="system">
					<DataLocator>
						<PSXBackEndColumn id="1">
							<tableAlias>CONTENTSTATUS</tableAlias>
			...
			<xsl:if test="not(PSXField[@name='sys_contentcreatedby'])">
				<PSXField defaultSearchLabel="Created by" forceBinary="no"
					modificationType="systemCreate" name="sys_contentcreatedby"
					showInPreview="yes" showInSummary="yes" type="system">
					<DataLocator>
						<PSXBackEndColumn id="1">
							<tableAlias>CONTENTSTATUS</tableAlias>
			...
			<xsl:if test="not(PSXField[@name='sys_publishabletype'])">
				<PSXField defaultSearchLabel="Publishable status"
					forceBinary="no" modificationType="none" name="sys_publishabletype"
					showInPreview="no" showInSummary="no" type="system">
					<DataLocator>
						<PSXExtensionCall id="0">
							<name>Java/global/percussion/cms/sys_CmsObjectNameLookup</name>
			...
			<xsl:if test="not(PSXField[@name='sys_variantname'])">
				<PSXField defaultSearchLabel="Variant Name"
					forceBinary="no" modificationType="none" name="sys_variantname"
					showInPreview="no" showInSummary="no" type="system"
					userSearchable="yes">
					<DataLocator>
						<PSXExtensionCall id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_relevancy'])">
				<xsl:variable name="FTSEnabled"
					select="document('../rxconfig/Server/config.xml')//PSXServerConfiguration/PSXSearchConfig/@fullTextSearchEnabled" />
				<xsl:if test="$FTSEnabled='yes'">
					<PSXField defaultSearchLabel="Rank" forceBinary="no"
						modificationType="none" name="sys_relevancy" showInPreview="no"
						showInSummary="no" type="system" userSearchable="yes">
						<DataLocator>
							<PSXExtensionCall id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_variantid'])">
				<PSXField defaultSearchLabel="Variant" forceBinary="no"
					modificationType="none" name="sys_variantid" showInPreview="no"
					showInSummary="no" type="system" userSearchable="yes">
					<DataLocator>
						<PSXTextLiteral id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_siteid'])">
				<PSXField defaultSearchLabel="Site" forceBinary="no"
					modificationType="none" name="sys_siteid" showInPreview="no"
					showInSummary="no" type="system" userSearchable="yes">
					<DataLocator>
						<PSXTextLiteral id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_folderid'])">
				<PSXField defaultSearchLabel="Folder Path" forceBinary="no"
					modificationType="none" name="sys_folderid" showInPreview="no"
					showInSummary="no" type="system" userSearchable="yes">
					<DataLocator>
						<PSXTextLiteral id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_thumbnail'])">
				<PSXField defaultSearchLabel="Thumbnail" forceBinary="no"
					modificationType="none" name="sys_thumbnail" showInPreview="no"
					showInSummary="no" systemMandatory="no" type="system"
					userCustomizable="yes" userSearchable="yes">
					<DataLocator>
						<PSXExtensionCall id="0">
							<name>Java/global/percussion/generic/sys_Literal</name>
							<PSXExtensionParamValue id="0">
			...
			<xsl:if test="not(PSXField[@name='sys_hibernateVersion'])">
				<PSXField forceBinary="no" modificationType="system"
					name="sys_hibernateVersion" showInPreview="no" showInSummary="no"
					systemMandatory="yes" userSearchable="no" systemInternal="yes">
					<DataLocator>
						<PSXBackEndColumn id="1">
							<tableAlias>CONTENTSTATUS</tableAlias>
	...
	<xsl:template
		match="PSXFieldSet/PSXField[@name='sys_view']" mode="copy" />
	<!-- Add PSXDisplayMapping/sys_communityid if does not exist to <PSXDisplayMapper
		fieldSetRef='systemFieldset'> element -->
	<xsl:template
		match="PSXDisplayMapper[@fieldSetRef='systemFieldset']" mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
			<xsl:apply-templates mode="copy" />
			<xsl:if
				test="not(PSXDisplayMapping/FieldRef='sys_communityid')">
				<PSXDisplayMapping>
			...
			<xsl:if
				test="not(PSXDisplayMapping/FieldRef='sys_reminderdate')">
				<PSXDisplayMapping>
			...
			<xsl:if
				test="not(PSXDisplayMapping/FieldRef='sys_currentview')">
				<PSXDisplayMapping>
			...
			<xsl:if
				test="not(PSXDisplayMapping/FieldRef='sys_hibernateVersion')">
				<PSXDisplayMapping>
	...
	<!-- Remove sys_view FieldRef element from PSXDisplayMapping element if
		exists -->
	<xsl:template
		match="PSXDisplayMapper[@fieldSetRef='systemFieldset']/PSXDisplayMapping[FieldRef='sys_view']"
		mode="copy" />
	<!-- Add sys_commAuthenticateUser exit to InputDataExits of CommandHandlerExits
		with commandName=edit -->
	<xsl:template
		match="CommandHandlerExits[@commandName='edit']/InputDataExits/PSXExtensionCallSet"
		mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
	...
	<!-- Add sys_commAuthenticateUser exit to InputDataExits of CommandHandlerExits
		with commandName=modify -->
	<xsl:template
		match="CommandHandlerExits[@commandName='modify']/InputDataExits/PSXExtensionCallSet"
		mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
	...
	<!-- Add sys_casInsertAsRelatedItem exit to ResultDataExits of CommandHandlerExits
		with commandName=modify -->
	<xsl:template
		match="CommandHandlerExits[@commandName='modify']/ResultDataExits/PSXExtensionCallSet"
		mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
			<xsl:if
				test="not(PSXExtensionCall/name='Java/global/percussion/assemblers/sys_casInsertAsRelatedItem')">
				<PSXExtensionCall id="285">
					<name>Java/global/percussion/assemblers/sys_casInsertAsRelatedItem</name>
				</PSXExtensionCall>
			</xsl:if>
			<xsl:if
				test="not(PSXExtensionCall/name='Java/global/percussion/cx/sys_addNewItemToFolder')">
				<PSXExtensionCall id="0">
	...
	<!-- Add sys_commAuthenticateUser exit to InputDataExits of CommandHandlerExits
		with commandName=workflow -->
	<xsl:template
		match="CommandHandlerExits[@commandName='workflow']/InputDataExits/PSXExtensionCallSet"
		mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
	...
	<xsl:template
		match="PSXCommandHandlerStylesheets/CommandHandler[@name='edit']"
		mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
			<xsl:if
				test="not(PSXConditionalStylesheet/PSXStylesheet/PSXUrlRequest/Href='file:../sys_resources/stylesheets/activeEdit.xsl')">
			...
			<xsl:if
				test="not(PSXConditionalStylesheet/PSXStylesheet/PSXUrlRequest/Href='file:../sys_resources/stylesheets/singleFieldEdit.xsl')">
				<PSXConditionalStylesheet>
					<PSXStylesheet>
						<PSXUrlRequest>
	...
	<xsl:template
		match="PSXCommandHandlerStylesheets/CommandHandler[@name='preview']"
		mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
			<xsl:if
			...
			<xsl:if
				test="not(PSXConditionalStylesheet/PSXStylesheet/PSXUrlRequest/Href='file:../sys_resources/stylesheets/revisionEdit.xsl')">
				<PSXConditionalStylesheet>
					<PSXStylesheet>
						<PSXUrlRequest>
			...
			<xsl:if
				test="not(PSXConditionalStylesheet/PSXStylesheet/PSXUrlRequest/Href='file:../sys_resources/stylesheets/auditTrail.xsl')">
				<PSXConditionalStylesheet>
					<PSXStylesheet>
						<PSXUrlRequest>
	...
	<xsl:template
		match="PSXApplicationFlow/CommandHandler[not(@name='relate')]/PSXConditionalRequest/PSXUrlRequest/PSXExtensionCall | PSXApplicationFlow/CommandHandler/PSXUrlRequest/PSXExtensionCall"
		mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
			...
			<xsl:variable name="sysviewcheck">
				<xsl:for-each select="PSXExtensionParamValue">
					<xsl:if test="./value/PSXTextLiteral/text='sys_view'">
						found
					</xsl:if>
				</xsl:for-each>
			</xsl:variable>
	...
	<xsl:template
		match="PSXApplicationFlow/CommandHandler[(@name='relate')]/PSXConditionalRequest[position()=1]/Conditions"
		mode="copy">
		<Conditions>
			<PSXRule boolean="and">
				<PSXConditional id="28">
	...
	<xsl:template
		match="PSXApplicationFlow/CommandHandler[(@name='relate')]/PSXConditionalRequest/PSXUrlRequest/PSXExtensionCall"
		mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
			<xsl:for-each select="PSXExtensionParamValue | name">
			...
			<xsl:variable name="refreshhintcheck">
				<xsl:for-each select="PSXExtensionParamValue">
					<xsl:if test="./value/PSXTextLiteral/text='refreshHint'">
						found
					</xsl:if>
				</xsl:for-each>
			</xsl:variable>
	...
	<xsl:template
		match="PSXField[@name='sys_contenttypeid']/PSXChoices" mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
			<xsl:apply-templates mode="copy" />
	...
	<xsl:template
		match="PSXField[@name='sys_variantname' and @defaultSearchLabel!='Variant Name']"
		mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
	...
	<xsl:template match="PSXField[@name='sys_statename']"
		mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
			<xsl:apply-templates mode="copy" />
	...
	<xsl:template
		match="PSXField[@name='sys_checkoutstatus' and DataLocator/PSXExtensionCall/name='Java/global/percussion/workflow/sys_ComputeCheckoutStatus']"
		mode="copy">
		<xsl:copy>
			<xsl:apply-templates select="@*" mode="copy" />
			<DataLocator>
				<PSXExtensionCall id="0">
					...
					<xsl:for-each
						select="DataLocator/PSXExtensionCall/PSXExtensionParamValue[position()&gt;1]">
						<xsl:apply-templates select="." mode="copy" />
					</xsl:for-each>
				</PSXExtensionCall>
			</DataLocator>
			<xsl:apply-templates
				select="*[name()!='DataLocator']" mode="copy" />
		</xsl:copy>
	</xsl:template>
	<xsl:template
		match="PSXDisplayMapping[FieldRef='sys_workflowid']/PSXUISet/PSXChoices/PSXChoiceFilter"
		mode="copy">
		<PSXChoiceFilter>
			<DependentField fieldRef="sys_communityid"
				dependencyType="required" />
