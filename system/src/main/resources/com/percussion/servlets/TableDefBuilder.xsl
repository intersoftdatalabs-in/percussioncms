...
<!-- Transforms documents conforming to the tabledef.dtd to a document conforming
	to the sys_Tabledef.dtd. -->
<xsl:stylesheet version="1.0"
	...
	<!-- Transform all elements 'row' to 'rowdef' and copy all attributes without
		changes. -->
