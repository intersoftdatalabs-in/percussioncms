...
public class PSSystemMapping {
  ...
  public PSSystemMapping(PSBackEndTable table, String columnName, IPSDocumentMapping docMapping) {
    ...
    if (columnName == null) throw new IllegalArgumentException("columnName may not be null");

    if (docMapping == null) throw new IllegalArgumentException("docMapping may not be null");
