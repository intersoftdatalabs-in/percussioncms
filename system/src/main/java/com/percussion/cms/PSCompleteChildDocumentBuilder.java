 ...
 *
 * <p>Unlike other builders, this builder isn't trying to create a content editor type doc that will
 * be used to generate an html page for end user editing. It is creating a dataset that includes all
 * of the non-binary fields in a given child, regardless of the showInPreview and showInSummary
 * flags.
 */
public class PSCompleteChildDocumentBuilder extends PSEditorDocumentBuilder {
   ...
   *    </code>.
   */
  public PSCompleteChildDocumentBuilder(
      PSContentEditor ce,
    ...
    addBuildStep(
        new PSTableValueBuilder(
            fields, mapping.getUISet(), mapping.getDisplayMapper(), this, true));
  }

  /**
   * See base for description. Overridden because we don't care about this stuff.
   *
   * @return Always <code>null</code> which prevents the information from being added to the doc.
   */
