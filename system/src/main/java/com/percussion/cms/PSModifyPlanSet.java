...
/**
 * Container for a set of plans used to process different modify requests for a particular display
 * mapper.
 */
public class PSModifyPlanSet {
   ...
   *
   * @param plan The plan to add. A plan with the same type must not have already been added. May
   *     not be <code>null</code>.
   * @throws IllegalArgumentException if plan is <code>null</code> or if a plan with the same type
   ...
   * @return The plan matching that type. May be <code>null</code> if a plan for that type has not
   *     been added.
   */
  ...
  /**
   * Returns an Iterator over <code>zero</code> or more PSModifyPlan objects, which is all the plans
   * that have been added to this set.
   *
  ...
  /**
   * Map of plans where key is the type and value is a PSModifyPlan object, never <code>null</code>.
   */
