...
public class PSPreviewDocumentBuilder extends PSRowEditorDocumentBuilder {
  ...
  protected Node createVariantList(Document doc, PSExecutionData data)
    ...
    try {
      String reqName = IPSConstants.EDITOR_SUPPORT_APPNAME + "/" + VARIANTLIST_DATASET_NAME;
      ...
      if (fragmentDoc != null) {
        ...
        if (root != null) {
          ...
          result = tree.getNextElement(VARIANTLIST_NAME, PSXmlTreeWalker.GET_NEXT_ALLOW_CHILDREN);
        }
      }
