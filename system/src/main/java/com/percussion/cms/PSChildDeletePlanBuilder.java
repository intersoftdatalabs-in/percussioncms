...
public class PSChildDeletePlanBuilder extends PSModifyPlanBuilder {
  ...
  public PSModifyPlan createModifyPlan(PSDisplayMapper mapper, PSFieldSet fieldSet)
    ...
    PSModifyPlan plan = new PSModifyPlan(PSModifyPlan.TYPE_DELETE_COMPLEX_CHILD);
    ...
    PSApplicationBuilder.createDeleteDataset(
        m_internalApp, delReqName, m_ce, null, null, delChildSystemMapper);
    ...
    PSDataMapper childDeleteSystemMapper = getSystemUpdateMapper(mapper, fieldSet);

    PSApplicationBuilder.createUpdateDataset(
        m_internalApp, sysReqName, m_ce, null, null, childDeleteSystemMapper, false);
