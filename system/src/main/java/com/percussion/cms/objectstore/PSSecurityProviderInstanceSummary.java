...
public final class PSSecurityProviderInstanceSummary implements IPSCmsComponent {
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof PSSecurityProviderInstanceSummary)) return false;
    PSSecurityProviderInstanceSummary provider = (PSSecurityProviderInstanceSummary) obj;
    return m_type == provider.getTypeId() && m_instance.equals(provider.getInstanceName());
  }
