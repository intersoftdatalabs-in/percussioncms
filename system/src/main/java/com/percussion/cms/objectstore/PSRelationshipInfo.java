...
public final class PSRelationshipInfo implements IPSCmsComponent {
  ...
  public PSRelationshipInfo(PSRelationshipConfig config) {
    ...
    m_description = (config.getDescription() == null) ? "" : config.getDescription();
  ...
  public Element toXml(Document doc) {
    ...
    if (m_category != null) {
      PSXmlDocumentBuilder.addElement(doc, root, CATEGORY_ATTR, m_category);
    }
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    if (node != null) m_description = tree.getElementData(node);
    else m_description = "";
  }
