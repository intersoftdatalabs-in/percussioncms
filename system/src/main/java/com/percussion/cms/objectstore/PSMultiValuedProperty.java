...
public abstract class PSMultiValuedProperty extends PSCmsProperty {
  ...
  public void toDbXml(Document doc, Element root, IPSKeyGenerator keyGen, PSKey parent)
    ...
    if (null == parent || !parent.isAssigned()) {
      throw new IllegalArgumentException("Invalid parent key supplied. Must be assigned.");
    }
  ...
  public boolean equals(Object o) {
    ...
    if (!getName().equalsIgnoreCase(other.getName())) return false;
    else if (!m_props.equals(other.m_props)) return false;
    return true;
  }
  ...
  // see base class for description
  public int hashCode() {
    return super.hashCode() + m_props.hashCode();
  }
