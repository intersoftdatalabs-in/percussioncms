...
public final class PSServerBinaryLocator extends PSFieldRetriever implements IPSBinaryLocator {
  ...
  public PSServerBinaryLocator(
    ...
    if (locator == null && isLocatorValid(locator))
      throw new IllegalArgumentException("locator must not be null or invalid");
  ...
  public PSPurgableTempFile getDataFile() throws PSCmsException, PSInvalidContentTypeException {
    return getFieldContentFile(m_request, m_locator, m_fieldName, m_childRowId);
  }
  ...
  public Object clone() {
    ...
    if (m_request != null) copy.m_request = m_request.cloneRequest();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof PSServerBinaryLocator)) isEqual = false;
    else {
      PSServerBinaryLocator other = (PSServerBinaryLocator) o;
      if (!super.equals(o)) isEqual = false;
      else if (m_childRowId != other.m_childRowId) isEqual = false;
      else if (!m_fieldName.equals(other.m_fieldName)) isEqual = false;
      else if (!m_locator.equals(other.m_locator)) isEqual = false;
    }
