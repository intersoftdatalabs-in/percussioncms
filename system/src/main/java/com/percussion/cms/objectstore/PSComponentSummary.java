...
@NamedQueries({
  @NamedQuery(
      name = "summary.findPublicOrCurrent",
      query =
          "select m_contentId, m_currRevision, m_publicRevision"
...
public class PSComponentSummary extends PSDbComponent implements Serializable {
  ...
  public PSComponentSummary(
    ...
    if (contentId < 0) throw new IllegalArgumentException("contentId may not be < 0");
  ...
  public int getPublicRevision() {
    ...
    else return m_publicRevision.intValue();
  }
  ...
  public PSLocator getTipLocator() {
    if (m_tipLocator == null) m_tipLocator = new PSLocator(m_contentId, m_tipRevision);
  ...
  public PSLocator getEditLocator() {
    if (m_editLocator == null) m_editLocator = new PSLocator(m_contentId, m_editRevision);
  ...
  public boolean equals(Object o) {
    if (!(o instanceof PSComponentSummary)) return false;
    PSComponentSummary obj2 = (PSComponentSummary) o;
    return new EqualsBuilder()
        .append(m_name, obj2.m_name)
        .append(m_contentId, obj2.m_contentId)
        .append(m_currRevision, obj2.m_currRevision)
        .append(m_tipRevision, obj2.m_tipRevision)
        .append(m_editRevision, obj2.m_editRevision)
        .append(m_objectType, obj2.m_objectType)
        .append(m_contentTypeId, obj2.m_contentTypeId)
        .append(m_locale, obj2.m_locale)
        .append(m_checkoutUserName, obj2.m_checkoutUserName)
        .append(m_clonedParentContentId, obj2.m_clonedParentContentId)
        .append(m_communityId, obj2.m_communityId)
        .append(m_contentCreatedDate, obj2.m_contentCreatedDate)
        .append(m_contentExpiryDate, obj2.m_contentExpiryDate)
        .append(m_contentLastModifiedDate, obj2.m_contentLastModifiedDate)
        .append(m_contentLastModifier, obj2.m_contentLastModifier)
        .append(m_contentStartDate, obj2.m_contentStartDate)
        .append(m_contentStateId, obj2.m_contentStateId)
        .append(m_workflowAppId, obj2.m_workflowAppId)
        .append(m_nextAgingDate, obj2.m_nextAgingDate)
        .append(m_nextAgingTransition, obj2.m_nextAgingTransition)
        .append(m_stateEnteredDate, obj2.m_stateEnteredDate)
        .append(m_revisionLock, obj2.m_revisionLock)
        .append(m_reminderDate, obj2.m_reminderDate)
        .append(m_repeatedAgingTransStartDate, obj2.m_repeatedAgingTransStartDate)
        .append(m_contentCreatedBy, obj2.m_contentCreatedBy)
        .append(m_contentAgingTime, obj2.m_contentAgingTime)
        .append(m_contentPublishDate, obj2.m_contentPublishDate)
        .append(m_contentPathName, obj2.m_contentPathName)
        .append(m_contentSuffix, obj2.m_contentSuffix)
        .isEquals();
  }
  ...
  public int hashCode() {
    return new HashCodeBuilder()
        .append(m_name)
        .append(m_contentId)
        .append(m_currRevision)
        .append(m_tipRevision)
        .append(m_editRevision)
        .append(m_objectType)
        .append(m_contentTypeId)
        .append(m_locale)
        .append(m_checkoutUserName)
        .append(m_clonedParentContentId) //
        .append(m_communityId)
        .append(m_contentCreatedDate) //
        .append(m_contentExpiryDate)
        .append(m_contentLastModifiedDate)
        .append(m_contentLastModifier)
        .append(m_contentStartDate) //
        .append(m_contentStateId)
        .append(m_workflowAppId) //
        .append(m_nextAgingDate)
        .append(m_nextAgingTransition) //
        .append(m_stateEnteredDate)
        .append(m_revisionLock) //
        .append(m_reminderDate)
        .append(m_repeatedAgingTransStartDate)
        .append(m_contentCreatedBy)
        .append(m_contentAgingTime) //
        .append(m_contentPublishDate)
        .append(m_contentPathName) //
        .append(m_contentSuffix)
        .toHashCode();
  }
  ...
  public Element toXml(Document doc) {
    ...
    root.setAttribute(XML_ATTR_CLONEDPARENT, intformat(m_clonedParentContentId));
    ...
    root.setAttribute(XML_ATTR_CONTENTCREATEDDATE, dateformat(m_contentCreatedDate));
    root.setAttribute(XML_ATTR_CONTENTEXPIRYDATE, dateformat(m_contentExpiryDate));
    root.setAttribute(XML_ATTR_CONTENTLASTMODIFIEDDATE, dateformat(m_contentLastModifiedDate));
    root.setAttribute(XML_ATTR_CONTENTLASTMODIFIER, m_contentLastModifier);
    root.setAttribute(XML_ATTR_CONTENTSTARTDATE, dateformat(m_contentStartDate));
    ...
    root.setAttribute(XML_ATTR_CONTENTPUBLISHDATE, dateformat(m_contentPublishDate));
    root.setAttribute(XML_ATTR_CONTENTPOSTDATE, dateformat(m_contentPostDate));
    ...
    root.setAttribute(
        XML_ATTR_REPEATEDAGINGTRANSSTARTDATE, dateformat(m_repeatedAgingTransStartDate));
    root.setAttribute(XML_ATTR_STATEENTEREDDATE, dateformat(m_stateEnteredDate));
    root.setAttribute(XML_ATTR_NEXTAGINGTRANSITION, intformat(m_nextAgingTransition));
    root.setAttribute(XML_ATTR_REVISIONLOCK, isRevisionLock() ? "Y" : "N");
    root.setAttribute(XML_ATTR_CONTENTAGINGTIME, intformat(m_contentAgingTime));
    ...
    if (m_permissions != null)
      root.setAttribute(XML_ATTR_PERMISSIONS, "" + m_permissions.getPermissions());
  ...
  public final void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    // Object Type
    m_objectType = PSXMLDomUtil.checkAttributeInt(sourceNode, XML_ATTR_TYPE, true);

    // Content typeid
    m_contentTypeId = PSXMLDomUtil.checkAttributeLong(sourceNode, XML_ATTR_CONTENTTYPE_ID, true);

    // Contentid
    m_contentId = PSXMLDomUtil.checkAttributeInt(sourceNode, XML_ATTR_CONTENT_ID, true);

    // Hibernate version
    m_version = PSXMLDomUtil.checkAttributeInt(sourceNode, XML_ATTR_HIB_VERSION, false);

    // Current Revision
    m_currRevision = PSXMLDomUtil.checkAttributeInt(sourceNode, XML_ATTR_CURR_REV, true);

    // Tip revision
    m_tipRevision = PSXMLDomUtil.checkAttributeInt(sourceNode, XML_ATTR_TIP_REV, true);

    // Edit revision
    m_editRevision = PSXMLDomUtil.checkAttributeInt(sourceNode, XML_ATTR_EDIT_REV, true);

    int publicRevision = PSXMLDomUtil.checkAttributeInt(sourceNode, XML_ATTR_PUBLIC_REV, false);
    m_publicRevision = (publicRevision == -1) ? null : publicRevision;

    // Locale string
    m_locale = PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_LOCALE, false);
    if (m_locale.length() < 1) m_locale = PSI18nUtils.DEFAULT_LANG;

    // Checkout User Name
    m_checkoutUserName =
        PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_CONTENTCHECKOUTUSERNAME, false);

    // Cloned parent contentid
    m_clonedParentContentId =
        parseIntegerOrNull(
            PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_CLONEDPARENT, false).trim());

    // Communityid
    m_communityId =
        parseIntegerOrNull(
            PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_COMMUNITYID, false).trim());

    // Created Date
    m_contentCreatedDate =
        PSXMLDomUtil.checkAttributeDate(sourceNode, XML_ATTR_CONTENTCREATEDDATE, false);

    // Expiry Date
    m_contentExpiryDate =
        PSXMLDomUtil.checkAttributeDate(sourceNode, XML_ATTR_CONTENTEXPIRYDATE, false);

    // Last Modfied Date
    m_contentLastModifiedDate =
        PSXMLDomUtil.checkAttributeDate(sourceNode, XML_ATTR_CONTENTLASTMODIFIEDDATE, false);

    // Last modifer name
    m_contentLastModifier =
        PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_CONTENTLASTMODIFIER, false);

    // Content Start Date
    m_contentStartDate =
        PSXMLDomUtil.checkAttributeDate(sourceNode, XML_ATTR_CONTENTSTARTDATE, false);

    // Current Stateid
    m_contentStateId =
        parseIntegerOrNull(
            PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_CONTENTSTATEID, false).trim());

    // Workflowid
    m_workflowAppId =
        parseIntegerOrNull(
            PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_WORKFLOWAPPID, false).trim());

    // Revision locked?
    setRevisionLock(
        PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_REVISIONLOCK, false)
            .trim()
            .equalsIgnoreCase("Y"));

    // Creator's name
    m_contentCreatedBy = PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_CONTENTCREATEDBY, false);

    // Content Path Name
    m_contentPathName = PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_CONTENTPATHNAME, false);

    // Content Suffix
    m_contentSuffix = PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_CONTENTSUFFIX, false);

    // Next Aging Date
    m_nextAgingDate = PSXMLDomUtil.checkAttributeDate(sourceNode, XML_ATTR_NEXTAGINGDATE, false);

    // Content Publish Date
    m_contentPublishDate =
        PSXMLDomUtil.checkAttributeDate(sourceNode, XML_ATTR_CONTENTPUBLISHDATE, false);

    // Content Post Date
    m_contentPostDate =
        PSXMLDomUtil.checkAttributeDate(sourceNode, XML_ATTR_CONTENTPOSTDATE, false);

    // Content Path Name timezone
    m_contentPostDateTz =
        PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_CONTENTPOSTDATETZ, false);

    // Reminder Date
    m_reminderDate = PSXMLDomUtil.checkAttributeDate(sourceNode, XML_ATTR_REMINDERDATE, false);

    // State Entry Date
    m_stateEnteredDate =
        PSXMLDomUtil.checkAttributeDate(sourceNode, XML_ATTR_STATEENTEREDDATE, false);

    // Repeating Aging Transition Date
    m_repeatedAgingTransStartDate =
        PSXMLDomUtil.checkAttributeDate(sourceNode, XML_ATTR_REPEATEDAGINGTRANSSTARTDATE, false);

    // Aging time
    m_contentAgingTime =
        parseIntegerOrNull(
            PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_CONTENTAGINGTIME, false).trim());

    // Aging Transitionid
    m_nextAgingTransition =
        parseIntegerOrNull(
            PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_NEXTAGINGTRANSITION, false).trim());

    boolean permissionsRequired = false;
    if (m_objectType == TYPE_FOLDER) permissionsRequired = true;

    int permissions =
        PSXMLDomUtil.checkAttributeInt(sourceNode, XML_ATTR_PERMISSIONS, permissionsRequired);
    if (permissionsRequired) m_permissions = new PSFolderPermissions(permissions);
  }
  ...
  public void toDbXml(Document doc, Element root, IPSKeyGenerator keyGen, PSKey parent)
    ...
    throw new UnsupportedOperationException("PSComponentSummary is read-only.");
  }
  ...
  public Object clone() {
    ...
    copy.m_permissions = m_permissions == null ? null : (PSFolderPermissions) m_permissions.clone();
  ...
  public String toString() {
    return "PSComponentSummary [m_contentId="
        + m_contentId
        + ", m_version="
        + m_version
        + ", m_currRevision="
  ...
  public static final String XML_ATTR_TYPE = "objectType";

  public static final String XML_ATTR_FOLDER_TYPE = "folderType";

  public static final String XML_ATTR_CONTENTTYPE_ID = "contentTypeId";

  public static final String XML_ATTR_CONTENT_ID = "contentId";

  public static final String XML_ATTR_HIB_VERSION = "hibVersion";

  public static final String XML_ATTR_CURR_REV = "currRevision";

  public static final String XML_ATTR_TIP_REV = "tipRevision";

  public static final String XML_ATTR_EDIT_REV = "editRevision";

  public static final String XML_ATTR_PUBLIC_REV = "publicRevision";

  public static final String XML_ATTR_PERMISSIONS = "permissions";

  public static final String XML_NODE_DESCRIPTION = "Description";

  public static final String XML_ATTR_LOCALE = "locale";

  public static final String XML_ATTR_CLONEDPARENT = "clonedParent";

  public static final String XML_ATTR_COMMUNITYID = "communityId";

  public static final String XML_ATTR_CONTENTCHECKOUTUSERNAME = "contentCheckoutUserName";

  public static final String XML_ATTR_CONTENTCREATEDDATE = "contentCreatedDate";

  public static final String XML_ATTR_CONTENTEXPIRYDATE = "contentExpiryDate";

  public static final String XML_ATTR_CONTENTLASTMODIFIEDDATE = "contentLastModifiedDate";

  public static final String XML_ATTR_CONTENTLASTMODIFIER = "contentLastModifier";

  public static final String XML_ATTR_CONTENTSTARTDATE = "contentStartDate";

  public static final String XML_ATTR_CONTENTSTATEID = "contentStateId";

  public static final String XML_ATTR_WORKFLOWAPPID = "workflowAppId";

  public static final String XML_ATTR_NEXTAGINGDATE = "nextAgingDate";

  public static final String XML_ATTR_CONTENTCREATEDBY = "contentCreatedBy";

  public static final String XML_ATTR_CONTENTAGINGTIME = "contentAgingTime";

  public static final String XML_ATTR_CONTENTPUBLISHDATE = "contentPublishDate";

  public static final String XML_ATTR_CONTENTPOSTDATE = "contentPostDate";

  public static final String XML_ATTR_CONTENTPOSTDATETZ = "contentPostDateTz";

  public static final String XML_ATTR_CONTENTPATHNAME = "contentPathName";

  public static final String XML_ATTR_CONTENTSUFFIX = "contentSuffix";

  public static final String XML_ATTR_REVISIONLOCK = "revisionLock";

  public static final String XML_ATTR_REMINDERDATE = "reminderDate";

  public static final String XML_ATTR_STATEENTEREDDATE = "stateEnteredDate";

  public static final String XML_ATTR_NEXTAGINGTRANSITION = "nextAgingTransition";

  public static final String XML_ATTR_REPEATEDAGINGTRANSSTARTDATE = "repeatedAgingTransStartDate";
