...
public final class PSCmsObject implements IPSCmsComponent {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof PSCmsObject)) return false;
  ...
  public Element toXml(Document doc) {
    ...
    PSXmlDocumentBuilder.addElement(doc, root, XML_NODE_FACTORY, m_factory);
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    m_typeId = PSXMLDomUtil.checkAttributeInt(sourceNode, XML_ATTR_TYPEID, true);

    String sWorkflowable = PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_ISWORKFLOWABLE, true);
    m_isWorkflowable = sWorkflowable.equals("1") ? 1 : 0;

    String sRevisionable = PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_ISREVISIONABLE, true);
    m_isRevisionable = sRevisionable.equals("1") ? 1 : 0;

    Element descEl = PSXMLDomUtil.getFirstElementChild(sourceNode, XML_NODE_DESCRIPTION);
    m_description = PSXMLDomUtil.getElementData(descEl);

    Element factoryEl = PSXMLDomUtil.getNextElementSibling(descEl, XML_NODE_FACTORY);
  ...
  private static final String XML_ATTR_TYPEID = "typeId";
  private static final String XML_ATTR_ISWORKFLOWABLE = "isWorkflowable";
  private static final String XML_ATTR_ISREVISIONABLE = "isRevisionable";
  private static final String XML_NODE_DESCRIPTION = "Description";
  private static final String XML_NODE_FACTORY = "Factory";
  private static final String XML_TRUE = "1";
  private static final String XML_FALSE = "0";
}
