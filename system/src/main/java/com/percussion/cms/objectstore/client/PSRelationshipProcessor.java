...
public class PSRelationshipProcessor implements IPSRelationshipProcessor {
  ...
  private PSComponentSummary[] getComponentSummaries(
      String method, String type, String relationshipType, PSKey locator) throws PSCmsException {
   ...
   * @throws UnsupportedOperationException Always.
   */
  public PSComponentSummary getSummaryByPath(String type, String path, String relationshipTypeName)
      throws PSCmsException {
    throw new UnsupportedOperationException("Not supported by this processor.");
  }
  ...
  private void validateComponentType(String type) {
    ...
    if (!type.equalsIgnoreCase(COMPONENT_TYPE))
      throw new IllegalArgumentException(
          "type cannot be " + type + ". " + "It must be " + COMPONENT_TYPE);
  }
  ...
  public String[] getRelationshipOwnerPaths(
    ...
    throw new UnsupportedOperationException(
        "getRelationshipOwnerPaths() is not implemented in : " + this.getClass().getName());
  }
