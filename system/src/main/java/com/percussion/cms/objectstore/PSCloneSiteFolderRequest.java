...
public final class PSCloneSiteFolderRequest extends PSComponent {
   ...
   */
  public int hashCode() {
    int hash = m_source.hashCode() + m_target.hashCode() + m_options.hashCode();
  ...
  public boolean equals(Object o) {
    ...
    if (!compare(t.m_source, m_source)) return false;
    if (!compare(t.m_target, m_target)) return false;
    if (!compare(t.m_options, m_options)) return false;
