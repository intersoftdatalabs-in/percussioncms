...
public final class PSSecurityProviderCataloger {
  ...
  public void fromXml(Element src) throws PSUnknownNodeTypeException {
    ...
    Element elem = null;
    NodeList nodes = src.getElementsByTagName(PSSecurityProviderInstanceSummary.XML_ELEMENT_ROOT);
  ...
  public PSSecurityProviderInstanceSummary getProviderById(int id) {
    ...
    while (it.hasNext()) {
      ...
      if (provider.getTypeId() == id) return provider;
    }
    return null;
  }
  ...
  public PSSecurityProviderInstanceSummary getProviderByName(String name) {
    ...
    while (it.hasNext()) {
      provider = (PSSecurityProviderInstanceSummary) it.next();
      if (provider.getTypeName().equals(name)) return provider;
    }
    return null;
  }
