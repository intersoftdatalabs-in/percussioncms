...
public final class PSDateValue extends PSFieldValue {
  ...
  public void setValue(Date date, FastDateFormat format) {
    ...
    if (format == null) format = FastDateFormat.getInstance(DEFAULT_FORMAT, DEFAULT_LOCALE);
  ...
  public static PSDateValue getDateValueFromString(String dateString) {
    ...
    if (tDate == null) throw new IllegalArgumentException("dateString - invalid format");
  ...
  public boolean equals(Object obj) {
    ...
    if (!compare(m_date, comp.m_date)) return false;
    if (!compare(m_format, comp.m_format)) return false;
