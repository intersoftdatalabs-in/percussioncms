...
/**
 * The utility class to hold search criteria, build search request and execute it remotely from the
 * Rhythmyx server.
 */
public class PSWSExecutableSearch extends PSBaseExecutableSearch {
   ...
   *
   * @param requester the requester is used to communicate with the remote Rhythmyx server, it may
   ...
   *     not be <code>null</code>
   */
  public PSWSExecutableSearch(IPSRemoteRequester requester, List columnNames, PSSearch search) {
    if (requester == null)
   ...
   *     empty.
   */
  public PSWSExecutableSearch(IPSRemoteRequester requester, List columnNames, List contentIdList) {
    if (requester == null)
      throw new IllegalArgumentException("requester must not be null or empty");
   ...
   *     not be <code>null</code>.
   * @param columnNames the names of the columns to include in the search results as <code>String
   *     </code> objects, it may not be <code>null</code> but may be empty.
   ...
   */
  protected void init(
      IPSRemoteRequester requester, List columnNames, PSSearch search, List contentIdList) {
    if (requester == null) throw new IllegalArgumentException("requester request must not be null");
  ...
  /**
   * The requester is used to communicate with the remote Rhythmyx server. Initialized by {@link
   * #init(IPSRemoteRequester,List,PSSearch,List)}, never <code>null</code> after that.
   */
