...
public final class PSFolderPermissions extends PSObjectPermissions {
  ...
  public PSFolderPermissions(PSFolderAcl folderAcl)
    ...
    if (folderAcl == null) throw new IllegalArgumentException("folderAcl may not be null");
  ...
  public boolean equals(Object obj) {
    ...
    if (equals) {
      if (!(obj instanceof PSFolderPermissions)) equals = false;
    }
    return equals;
  }
