 ...
 *   <li>The object would then be passed to the {@link #save(IPSDbComponent[]) save} method of this
 *       class.
...
public class PSComponentProcessorProxy extends PSProcessorProxy implements IPSComponentProcessor {
   ...
   * (component processor) object from the configuration.
   *
   * @param componentType component type for the processor assumed not <code>null</code>.
