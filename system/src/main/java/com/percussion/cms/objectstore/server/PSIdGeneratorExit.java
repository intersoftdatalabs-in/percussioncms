 ...
 * @version 1.0
 */
public class PSIdGeneratorExit extends PSDefaultExtension implements IPSResultDocumentProcessor {
  /**
  ...
  public Document processResultDocument(
    ...
    try {
      ...
      int count;
      try {
        if (null != val && val.trim().length() > 0) count = Integer.parseInt(val);
        else count = 1;
      ...
      if (null == root) root = PSXmlDocumentBuilder.createRoot(resultDoc, "PSXIdGenerator");
