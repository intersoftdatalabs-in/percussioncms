...
/**
 * This property class is used by the <code>PSFolder</code> class. The <code>PSFolder</code> object
 * represent an item of <code>Folder</code> content type. Which contains a child table with
...
public final class PSFolderProperty extends PSCmsProperty {
  ...
  /**
   * Creates a new object with the given parameters. This object is not persisted.
   *
  ...
  /**
   * Just like the {@link PSCmsProperty#PSCmsProperty(Element)} except the key part definition is
   * <code>KEY_ID</code>.
   */
   ...
   *
   * @return <code>-1</code> if it is undefined; otherwise it is >= <code>0</code>
   */
  public int getId() {
  ...
  /**
   * The key part definition, which is also the column name of the properties table, or the row id
   * of the child entry.
   */
