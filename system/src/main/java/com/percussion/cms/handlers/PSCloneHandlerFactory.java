...
public class PSCloneHandlerFactory {
  ...
  public static IPSCloneHandler getCloneHandler(String type, IPSCopyHandler copyHandler)
    ...
    if (copyHandler == null) throw new IllegalArgumentException("copy handler cannot be null");
    ...
    if (handler == null) throw new IllegalArgumentException("Unknown object type");
  ...
  public static int getObjectTypeId(String type) {
    ...
    if (type.equals(ITEM)) return ITEM_ID;
