...
public interface IPSCopyHandler {
  /**
   * Create a copy of the source object using the locator information provided in the target.
   *
   ...
   * @throws PSAuthenticationFailedException if the user is not authenticated to create a copy.
   * @throws PSNotFoundException if required files or resources cannot be found.
