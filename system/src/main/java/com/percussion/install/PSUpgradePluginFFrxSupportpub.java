...
public class PSUpgradePluginFFrxSupportpub implements IPSUpgradePlugin {
  ...
  public PSPluginResponse process(IPSUpgradeModule config, Element elemData) {
    ...
    try {
      ...
      String srcFilePath = RxUpgrade.getRxRoot() + "ObjectStore/rx_Support_pub.xml";
      ...
      String xslFilePath = RxUpgrade.getUpgradeRoot() + "UpgradeFF_rx_Support_pub.xsl";
      ...
      File extFile =
          new File(RxUpgrade.getUpgradeRoot(), "UpgradeFF_rxs_pubAppendPurgedOrMovedItems.xml");
      ...
      try {
        ...
        logMessage(
            "Exception creating extension doc from 'UpgradeFF_rxs_pubAppendPurgedOrMovedItems.xml':"
                + " "
                + e.toString());
        return null;
      } finally {
      ...
      PSExtensionInstallTool.InstallExtensions(
          doc, RxUpgrade.getRxRoot(), RxUpgrade.getUpgradeRoot());
