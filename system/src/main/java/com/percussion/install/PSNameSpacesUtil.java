...
public class PSNameSpacesUtil {
  ...
  /**
   * Replaces whitespace characters with underscores. Make sure new name does not clash with any
   * existing names. If generated name already exists the method adds "1" to the name, if that name
   * exists, it adds "2" and so on until it finds unused name.
   *
