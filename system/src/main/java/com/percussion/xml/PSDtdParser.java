...
public class PSDtdParser extends XMLDTDLoader
  ...
  public void startDTD(XMLLocator locator, Augmentations augs) throws XNIException {
    ...
    if (fDTDHandler != null) fDTDHandler.startDTD(locator, augs);
  }
  ...
  public void parseXmlForDtd(InputStream insm, boolean generate)
      throws IOException, PSCatalogException, SAXException {
    if (insm == null) throw new IllegalArgumentException("ins may not be null");
  ...
  public void parseXmlForDtd(String uri, boolean generate)
    ...
    try {
      ...
      File f = new File(uri);
      if (f.isFile()) parseXmlForDtd(f, generate);
      return;
    }
    if (url == null) return;
    InputStream is = null;
  ...
  public void parseXmlForDtd(InputSource ins, boolean generate)
      throws IOException, PSCatalogException, SAXException {
    if (ins == null) throw new IllegalArgumentException("xis may not be null");
    ...
    if (doc != null) parseXmlForDtd(doc, generate);
  }
  ...
  public void parseXmlForDtd(Document doc, boolean generate)
    ...
    if (docType != null) {
      ...
      if (!((internalSubset == null) || (internalSubset.trim().length() == 0))) {
        ByteArrayInputStream bais = new ByteArrayInputStream(internalSubset.getBytes());
        parseDtd(bais, null);
  ...
  public void generateDtd(Document doc) throws IOException, PSCatalogException {
    ...
    if ((strDtd == null) || (strDtd.trim().length() == 0)) return;

    ByteArrayInputStream bais = new ByteArrayInputStream(strDtd.getBytes());
    parseDtd(bais, null);
  }
  ...
  public void parseDtd(XMLInputSource xis) throws IOException, PSCatalogException {
    fDTDGrammar = null;
    if (xis == null) throw new IllegalArgumentException("xis may not be null");
    ...
    XMLInputSource xisDtd = new XMLInputSource(null, systemId, null, bis, null);
  ...
  public PSDtd getDtd() {
    ...
    if (fDTDGrammar instanceof PSDtd) return (PSDtd) fDTDGrammar;
    return null;
  }
  ...
  public Grammar loadGrammar(XMLInputSource source) throws IOException, XNIException {
    ...
    StandardParserConfiguration parserConf = new StandardParserConfiguration(fSymbolTable);
