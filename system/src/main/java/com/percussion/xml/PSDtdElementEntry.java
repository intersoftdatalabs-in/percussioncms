...
public class PSDtdElementEntry extends PSDtdNode {
  ...
  */
  ...
  public void print(String tab) {
    if (m_element != null) m_element.print(tab, "-" + m_occurrenceType + "-");
    else log.info(tab + " NULL Element");
  }
  ...
  public void catalog(HashMap<Object, Object> stack, List<String> catalogList, String cur, String sep, String attribId) {
    ...
    if (stack.containsKey(m_element.getName())) {
      ...
      if (cur.equals("")) cur = m_element.getName();
      else cur = cur + sep + m_element.getName();
