...
public class PSConditionalEvaluator {
      ...
      if (!popFlag) {
        ...
        if ((opCode == OPCODE_ISNULL) || (opCode == OPCODE_ISNOTNULL)) {
          ...
          if (variable instanceof List<?>) {
            ...
            try {
              variable = PSDataConverter.convert(variable, PSDataConverter.DATATYPE_NULL, null);
  ...
  private static boolean makeComparable2Obj(Object left, Object right, int opCode)
    ...
    */
    // REFACTORED: CP-JAVA11 - Removed unsupported set type checks (DATATYPE_SET_FLAG) as not
    // present in PSDataConverter
