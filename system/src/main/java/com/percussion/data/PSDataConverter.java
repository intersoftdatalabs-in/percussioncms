...
public final class PSDataConverter
{
   ...
   public static Object convertToSet(Object data)
   {
      ...
      return tryConvertToDateLiterals(valueSet)
         .orElseGet(() -> tryConvertToNumericLiterals(valueSet)
   ...
   {
      var number = (data instanceof PSNumericLiteral)
         ? ((PSNumericLiteral) data).getNumber()
         : (Number) data;
      ...
      switch (dstType) {
         ...
         case DATATYPE_LONG:
         case DATATYPE_DOUBLE:
            throw new IllegalArgumentException("Invalid conversion from " +
               getTypeString(DATATYPE_NUMERIC) + " to " + getTypeString(dstType));
         default:
            return data;
      }
   }
   ...
   private static Object convertFromDouble(Object data, int dstType)
   {
      ...
      switch (dstType) {
         ...
         case DATATYPE_LONG:
            throw new IllegalArgumentException("Invalid conversion from " +
               getTypeString(DATATYPE_DOUBLE) + " to " + getTypeString(dstType));
         default:
            return data;
      }
   }
   ...
   private static Object convertFromLong(Object data, int dstType)
   {
      ...
      switch (dstType) {
         ...
         case DATATYPE_DOUBLE:
            throw new IllegalArgumentException("Invalid conversion from " +
               getTypeString(DATATYPE_LONG) + " to " + getTypeString(dstType));
         default:
            return data;
      }
   }
   ...
   {
      var date = (data instanceof PSDateLiteral)
         ? ((PSDateLiteral) data).getDate()
         : (Date) data;
      ...
      switch (dstType) {
         ...
         case DATATYPE_INT:
            throw new IllegalArgumentException("Invalid conversion from " +
               getTypeString(DATATYPE_DATE) + " to " + getTypeString(dstType));
         default:
            return data;
      }
   }
   ...
   private static Date convertTextToDate(String text, FastDateFormat dateFormat)
   {
      if (dateFormat != null) {
         try {
            ...
            PSConsole.printMsg("DataConverter",
               "Not in specified format, trying to check all valid formats");
         }
      }
   ...
   private static Optional<PSLiteralSet> tryConvertToDateLiterals(List<String> valueSet)
   {
      ...
      for (var value : valueSet) {
         try {
            ...
            if (date != null) {
               var dateLiteral = new PSDateLiteral(date,
   ...
   private static PSLiteralSet convertToTextLiterals(List<String> valueSet)
   {
      ...
      valueSet.stream()
         .map(PSTextLiteral::new)
         .forEach(literalSet::add);
   ...
   private static String getTypeString(int type)
   {
      switch (type) {
         ...
         case DATATYPE_DATE: return "DATE";
         case DATATYPE_TEXT: return "TEXT";
         case DATATYPE_NULLTEXT: return "NULLTEXT";
         case DATATYPE_FILE: return "FILE";
