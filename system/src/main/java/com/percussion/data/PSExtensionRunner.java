...
public class PSExtensionRunner {
  ...
  protected PSExtensionRunner(PSExtensionCall call) {
    ...
    if (extMgr == null) throw new IllegalStateException("extMgr cannot be null");
    ...
    try {
      ...
      throw new IllegalStateException(
          "Error when getting metadata for extension "
              + extRef.toString()
              + ", msg: "
              + ex.getMessage());
    }
  ...
  public Document processResultDoc(PSExecutionData data, Document doc)
    ...
    if (lh instanceof PSDebugLogHandler) {
      ...
      if (dh.isTraceEnabled(PSTraceMessageFactory.EXIT_PROC_FLAG)) {
        Object[] traceArgs = {
          "IPSResultDocumentProcessor", m_extCall.getExtensionRef().getExtensionName(), args
        };
    ...
    if (lh instanceof PSDebugLogHandler) {
      ...
      if (dh.isTraceEnabled(PSTraceMessageFactory.POST_EXIT_XML_FLAG))
        dh.printTrace(
            PSTraceMessageFactory.POST_EXIT_XML_FLAG,
            new Object[] {doc, m_extCall.getExtensionRef().getExtensionName()});
    }
  ...
  public void preProcessRequest(PSExecutionData data)
      throws PSExtensionProcessingException, PSParameterMismatchException,
          PSRequestValidationException, PSDataExtractionException, PSAuthorizationException {
    ...
    if (dh.isTraceEnabled(PSTraceMessageFactory.EXIT_PROC_FLAG)) {
      Object[] traceArgs = {
        "IPSRequestPreProcessor", m_extCall.getExtensionRef().getExtensionName(), args
      };
      dh.printTrace(PSTraceMessageFactory.EXIT_PROC_FLAG, traceArgs);
    }
    PSRequestContext context = new PSRequestContext(data.getRequest());
  ...
  public Object processUdfCallExtractor(PSExecutionData data)
      throws
          ...
          PSConversionException, PSDataExtractionException {
    ...
    if (lh instanceof PSDebugLogHandler) {
      ...
      if (dh.isTraceEnabled(PSTraceMessageFactory.MAPPER_FLAG)) {
        Object[] traceArgs = {m_extCall.getExtensionRef().getExtensionName(), args, result};
  ...
  public List runSearchResultProcessor(PSExecutionData data, List searchResultRows)
    ...
    if (searchResultRows == null || searchResultRows.isEmpty())
      throw new IllegalArgumentException("searchResultRows must not be null or empty");
    ...
    if (lh instanceof PSDebugLogHandler) {
      ...
      if (dh.isTraceEnabled(PSTraceMessageFactory.EXIT_PROC_FLAG)) {
        Object[] traceArgs = {
          "IPSSearchResultsProcessor", m_extCall.getExtensionRef().getExtensionName(), args
        };
        dh.printTrace(PSTraceMessageFactory.EXIT_PROC_FLAG, traceArgs);
      }
    }
  ...
  protected PSResult executeEffect(
    ...
    if (m_effect != null) {
      ...
      try {
        ...
        ms_log.info(msg);
        throw ce;
      } catch (PSExtensionProcessingException
          | PSParameterMismatchException
          | RuntimeException e1) {
      ...
      if (lh instanceof PSDebugLogHandler) {
        PSDebugLogHandler dh = (PSDebugLogHandler) lh;
        if (dh.isTraceEnabled(PSTraceMessageFactory.EXIT_PROC_FLAG)) {
          Object[] traceArgs = {"IPSEffect", m_extCall.getExtensionRef().getExtensionName(), args};
          dh.printTrace(PSTraceMessageFactory.EXIT_PROC_FLAG, traceArgs);
        }
      }
      return result;
   ...
   */
  private String getExceptionInfo(Object[] args, IPSEffect effect, int executeMethod) {
  ...
  public PSExtensionRef getExtensionRef() {
    if (m_extCall == null) throw new IllegalStateException("m_extCall cannot not be null");
  ...
  public IPSExtensionDef getExtensionDef() {
    if (m_extDef == null) throw new IllegalStateException("m_extDef cannot be null");
  ...
  private void buildExtractors(PSExtensionCall call) {
    ...
    for (int i = 0; i < vals.length; i++) {
      ...
      if (vals[i] != null) {
        extractors.add(PSDataExtractorFactory.createReplacementValueExtractor(val.getValue()));
      } else {
