...
/**
 * The PSIndexedLookupJoiner class is used internally by the E2 server to take the results of one
 * query, issue queries against another data store and combine the results into a single result set.
 *
 * <p>The Query Optimizer (PSQueryOptimizer) chooses an execution plan which will optimally access
 * the data from each back-end. It also defines the join requirements.
 *
...
public class PSIndexedLookupJoiner extends PSQueryJoiner {
   ...
   * @param rStmt the statement to execute against the right side table
