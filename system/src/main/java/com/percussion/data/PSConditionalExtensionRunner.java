...
public class PSConditionalExtensionRunner extends PSExtensionRunner {
   ...
   */
  public PSConditionalExtensionRunner(PSExtensionCall call, IPSExtension ext, Iterator conditions)
    ...
    if (conditions != null) m_evaluator = new PSRuleListEvaluator(conditions);
  }
  ...
  public PSResult testEffect(PSExecutionData data, IPSExecutionContext context)
    ...
    if (m_evaluator != null && !m_evaluator.isMatch(data)) return new PSResult();
  ...
  public void preProcessRequest(PSExecutionData data)
    ...
    if (m_evaluator != null && !m_evaluator.isMatch(data)) return;
  ...
  public Document processResultDoc(PSExecutionData data, Document doc)
    ...
    if (m_evaluator != null && !m_evaluator.isMatch(data)) return doc;
  ...
  public Object processUdfCallExtractor(PSExecutionData data)
    ...
    if (m_evaluator != null && !m_evaluator.isMatch(data)) return null;
