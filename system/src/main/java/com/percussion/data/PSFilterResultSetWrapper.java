...
public class PSFilterResultSetWrapper implements ResultSet {
  ...
  public PSFilterResultSetWrapper(
      PSExecutionData data, ResultSet rs, IPSResultSetDataFilter filter) {
    if (data == null) throw new IllegalArgumentException("Need a valid execution data!");

    if (rs == null) throw new IllegalArgumentException("There must be a result set!");
