...
public abstract class PSDataExtractorFactory {
  ...
  public static IPSDataExtractor createReplacementValueExtractor(IPSReplacementValue replValue) {
      ...
      if (constructor != null) {
        try {
          ...
          ret = (IPSDataExtractor) constructor.newInstance(args);
            ...
            | ExceptionInInitializerError inst) {
    ...
    if (ret == null) {
      ...
      if (errString != null) arg0 += "; " + errString;

      throw new IllegalArgumentException(
          "unknown parameter type " + arg0 + " " + replValue.getClass().getName());
    }
  ...
  private static Constructor getExtractorConstructor(IPSReplacementValue replValue)
    ...
    if (extractorClass != null) {
      return extractorClass.getConstructor(new Class[] {replValue.getClass()});
    }
  ...
  static {
    ...
    ms_extractors.addReplaceMapping(PSBackEndColumn.class, PSBackEndColumnExtractor.class);
    ms_extractors.addReplaceMapping(PSCgiVariable.class, PSCgiVariableExtractor.class);
    ms_extractors.addReplaceMapping(PSCookie.class, PSCookieExtractor.class);
    ms_extractors.addReplaceMapping(PSDisplayFieldRef.class, PSDisplayFieldRefExtractor.class);
    ms_extractors.addReplaceMapping(PSHtmlParameter.class, PSHtmlParameterExtractor.class);
    ms_extractors.addReplaceMapping(PSExtensionCall.class, PSUdfCallExtractor.class);
    ms_extractors.addReplaceMapping(PSFunctionCall.class, PSFunctionCallExtractor.class);
    ms_extractors.addReplaceMapping(PSUserContext.class, PSUserContextExtractor.class);
    ms_extractors.addReplaceMapping(PSXmlField.class, PSXmlFieldExtractor.class);
    ms_extractors.addReplaceMapping(PSUrlRequest.class, PSUrlRequestExtractor.class);
    ms_extractors.addReplaceMapping(
        PSSingleHtmlParameter.class, PSSingleHtmlParameterExtractor.class);
    ms_extractors.addReplaceMapping(PSContentItemStatus.class, PSContentItemStatusExtractor.class);
    ms_extractors.addReplaceMapping(PSContentItemData.class, PSContentItemDataExtractor.class);
    ms_extractors.addReplaceMapping(
        PSRelationshipProperty.class, PSRelationshipPropertyExtractor.class);
    ms_extractors.addReplaceMapping(
        PSOriginatingRelationshipProperty.class, PSOriginatingRelationshipPropertyExtractor.class);
    ...
    ms_extractors.addReplaceMapping(PSDateLiteral.class, PSDateLiteralExtractor.class);
    ms_extractors.addReplaceMapping(PSLiteralSet.class, PSLiteralSetExtractor.class);
    ms_extractors.addReplaceMapping(PSNumericLiteral.class, PSNumericLiteralExtractor.class);
    ms_extractors.addReplaceMapping(PSTextLiteral.class, PSTextLiteralExtractor.class);
    ms_extractors.addReplaceMapping(
        PSDisplayTextLiteral.class, PSDisplayTextLiteralExtractor.class);
  }
}
