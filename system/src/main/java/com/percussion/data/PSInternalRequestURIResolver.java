  ...
  public Source resolve(String href, String base) throws TransformerException {
    ...
    if (href.toLowerCase().startsWith(baseUrl)) {
      try {
        ...
        if (req == null) throw new IllegalStateException("req must not be null");
        iReq = PSServer.getInternalRequest(href, req, null, false);
        ...
        if (iReq == null) {
          ...
          href = href + (href.contains("?") ? "&pssessionid=" : "?pssessionid=") + sess.getId();
          return new StreamSource(href);
        }
        String pageExt = iReq.getRequest().getRequestPageExtension();
        IPSInternalRequestHandler handler = iReq.getInternalRequestHandler();
        if (pageExt.toLowerCase().equals(".xml") || pageExt.toLowerCase().equals(".txt")) {
          ...
          if (handler instanceof PSQueryHandler) {
            ...
            if (dset != null) {
              ...
              if (rqr.getMimeType(pageExt) == null) domResult = true;
            }
          }
        }
