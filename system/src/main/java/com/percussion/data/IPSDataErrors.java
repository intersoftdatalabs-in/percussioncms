...
/**
 * The IPSDataErrors inteface is provided as a convenient mechanism for accessing the various data
 ...
 * </TABLE>
 *
 * The text of the error messages is stored in the properties file <code>
 * com.percussion.error.PSErrorStringBundle</code>
 *
...
public interface IPSDataErrors {
  ...
  /**
   * This error is reported by the com.percussion.error.PSBackEndQueryProcessingError object.
   *
  ...
  /**
   * This error is reported by the com.percussion.error.PSBackEndUpdateProcessingError object.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * the back-end column used in PSStatementColumnMapper.put was not of type PSStatementColumn
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * the back-end values specified to the request link generator don't pair up with the defined
   * columns
   *
   * <p>The arguments passed in for this message are:
   *
   ...
   *
   * <p>No arguments for this message.
   */
  public static final int REPLACEMENT_VALUE_REQD = 5205;

  /**
   * the source data set specified to the request link generator cannot be null
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * the target of an update request link generator contains a key column without a data mapping
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * the generated column count does not match the expected count for the joined result set
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * the new right side result set column count does not match the expected count for the right side
   * result set
   *
   * <p>The arguments passed in for this message are:
   *
  ...
  /**
   * log the XML field being treated as the root for the walker when processing the updates for the
   * specified statement
   *
   * <p>The arguments passed in for this message are:
   *
  ...
  /**
   * log the rebased XML field being treated as the root for the walker when processing the updates
  ...
  /**
   * no updatable columns are defined for this table, it will be removed from the update plan
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * no key columns are defined for this delete, which may be undesirable (this is a warning)
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * the number of joins defined is insufficient to handle the number of tables being joined
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * an exception occurred attempting to estimate the join cardinality between these tables
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * an exception occurred attempting to estimate the join selectivity between these tables
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * we do not support applying a translator to join conditions in a heterogeneous join through the
   * builder. the optimizer must build a homogeneous join to handle this.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * a join path could not be found between the two tables. When this occurs, we can't perform the
   * query
   *
   * <p>The arguments passed in for this message are:
   *
   ...
   *
   * <p>One example is to compare a string abc with a number 123.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * Conversion from the specified type to the specified type is not supported
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
   ...
   *
   * <p>No arguments passed in for this message.
   */
  ...
  /**
   * the XML field name used in PSStatementColumnMapper.put was not of type String
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * there must be 1 column used in the data mapping for MIME output generation
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * An XSL variable name was used for both a link URL name and a data mapping field.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * mapping to XML parent nodes (nodes with children nodes) is not supported
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * A call is being mapped to a key column used by a link, any associated HTML parameters with the
   * call will be passed with key infomation for that column.
   *
   * <p>No arguments.
   */
  ...
  /**
   * The internal request was not authorized to perform the requested action. This error code is
   * required because the <code>IPSInternalRequest</code> interface does not allow <code>
   * PSAuthorizationException</code> to be thrown by the get methods.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
   ...
   * </TABLE>
   */
  public static final int INTERNAL_REQUEST_AUTHENTICATION_FAILED_EXCEPTION = 6040;
