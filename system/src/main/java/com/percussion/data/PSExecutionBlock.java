...
/**
 * The PSExecutionBlock class defines a block of statements to process as a group if the specified
 * conditions are met.
 *
...
public class PSExecutionBlock implements IPSExecutionStep {
   ...
   *
   * @param conds the conditions this block will be executed on (PSConditional objects)
   * @exception PSIllegalArgumentException if conds does not contain PSConditional objects
   */
