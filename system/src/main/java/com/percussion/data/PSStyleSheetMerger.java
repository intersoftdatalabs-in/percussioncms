...
public abstract class PSStyleSheetMerger {
  ...
  public static void merge(PSRequest req, Document doc, OutputStream out, String encoding)
    ...
    if (merger != null) {
      ...
      try {
        ...
        PSXmlDocumentBuilder.write(doc, writer, PSCharSets.rxStdEnc()); // use just the XML data
  ...
  protected static void throwConversionException(Document doc, java.net.URL styleURL, String text)
