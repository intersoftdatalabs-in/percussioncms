...
public class SQLParser /*@bgen(jjtree)*/ implements SQLParserTreeConstants, SQLParserConstants {
  /*@bgen(jjtree)*/
   ...
   * contains the valid statements
   * **********************************************************************
   */
  public static final ASTStatementRoot StatementRoot() throws ParseException {
   ...
   * (Sec. 20.1, p.443) **********************************************************************
   */
  public static final void DirectSQLStatement() throws ParseException {
    DirectlyExecutableStatement();
    jj_consume_token(Semicolon);
  }

  public static final void DirectlyExecutableStatement() throws ParseException {
    DirectSQLDataStatement();
  }

  public static final void DirectSQLDataStatement() throws ParseException {
  ...
  /**
   * *********************************************************************** DIRECT SELECT
   * STATEMENT: MULTIPLE ROWS (Sec. 20.2, p.447)
   * **********************************************************************
   */
  public static final void DirectSelectStatementMultipleRows() throws ParseException {
    /*@bgen(jjtree) DirectSelectStatementMultipleRows */
    ASTDirectSelectStatementMultipleRows jjtn000 =
        new ASTDirectSelectStatementMultipleRows(JJTDIRECTSELECTSTATEMENTMULTIPLEROWS);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);
    try {
      QueryExpression();
  ...
  /**
   * *********************************************************************** QUERY EXPRESSION (Sec.
   * 7.10, p.159) **********************************************************************
   */
  public static final void QueryExpression() throws ParseException {
    NonJoinQueryExpression();
  }

  public static final void NonJoinQueryExpression() throws ParseException {
    NonJoinQueryTerm();
    label_1:
    while (true) {
      switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
  ...
  public static final void QueryTerm() throws ParseException {
    NonJoinQueryTerm();
  }

  public static final void NonJoinQueryTerm() throws ParseException {
    NonJoinQueryPrimary();
  }

  public static final void QueryPrimary() throws ParseException {
    NonJoinQueryPrimary();
  }

  public static final void NonJoinQueryPrimary() throws ParseException {
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case SELECT:
        SimpleTable();
        break;
  ...
  public static final void SimpleTable() throws ParseException {
    QuerySpecification();
  }

  /**
   * *********************************************************************** NUMERIC LITERALS Note
   * that some of the numeric literals are tokens (where we could get away with it) and some of them
   * are productions (where we couldn't make tokens out of them). The general philosophy is that
   * most productions don't get addet to the tree, but instead return on object, the class of which
   * is the most specific class I felt safe using to represent that object (for example, a
   * SignedNumericLiteral returns a java.math.BigDecimal, but a Literal returns a
   * java.lang.Comparable because it could be either a Number or a String).
   * **********************************************************************
   */
  public static final java.math.BigDecimal SignedNumericLiteral() throws ParseException {
  ...
  public static final java.math.BigDecimal UnsignedNumericLiteral() throws ParseException {
    Token t;
  ...
  public static final Comparable UnsignedLiteral() throws ParseException {
    Comparable val = null;
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case ExactNumericLiteral:
      case ApproximateNumericLiteral:
  ...
  public static final String GeneralLiteral() throws ParseException {
    Token t;
  ...
  public static final void ColumnReference() throws ParseException {
  ...
  public static final String ColumnNameQualifier() throws ParseException {
    String tab = null;
    tab = TableName();
    {
      if (true) return tab;
  ...
  public static final String CorrelationName() throws ParseException {
    Token t;
    t = jj_consume_token(Identifier);
    {
      if (true) return t.image;
  ...
  /**
   * *********************************************************************** TABLE REFERENCES (Sec.
   * 6.3, p. 94) **********************************************************************
   */
  public static final void TableReference() throws ParseException {
  ...
  public static final void ParameterSpecification() throws ParseException {
   ...
   * (Sec. 7.9, p. 155) **********************************************************************
   */
  public static final int SetQuantifier() throws ParseException {
    int type;
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case DISTINCT:
  ...
  public static final void QuerySpecification() throws ParseException {
  ...
  public static final void SelectList() throws ParseException {
  ...
  public static final void DerivedColumn() throws ParseException {
  ...
  public static final String AsClause() throws ParseException {
    Token t;
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case AS:
        jj_consume_token(AS);
  ...
  /**
   * *********************************************************************** TABLE EXPRESSION (Sec.
   * 7.3, p. 142) **********************************************************************
   */
  public static final void TableExpression() throws ParseException {
   ...
   * p. 143) **********************************************************************
   */
  public static final void FromClause() throws ParseException {
  ...
  /**
   * *********************************************************************** WHERE CLAUSE (Sec. 7.6,
   * p. 150) **********************************************************************
   */
  public static final void WhereClause() throws ParseException {
   ...
   * 7.7, p. 151) **********************************************************************
   */
  public static final void GroupByClause() throws ParseException {
  ...
  public static final void GroupingColumnReferenceList() throws ParseException {
  ...
  public static final void GroupingColumnReference() throws ParseException {
    ColumnReference();
  }
   ...
   * 7.8, p. 153) **********************************************************************
   */
  public static final void HavingClause() throws ParseException {
  ...
  */
  ...
  public static final void SearchCondition() throws ParseException {
    Token t;
  ...
  public static final void BooleanTerm() throws ParseException {
  ...
  public static final ASTBooleanFactor BooleanFactor() throws ParseException {
  ...
  public static final void BooleanTest() throws ParseException {
    BooleanPrimary();
  }

  public static final void BooleanPrimary() throws ParseException {
    if (jj_2_4(4)) {
      Predicate();
    } else {
      switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
   ...
   * (Sec. 8.2, p. 169) **********************************************************************
   */
  public static final void ComparisonPredicate() throws ParseException {
  ...
  public static final int CompOp() throws ParseException {
    int compType;
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case EqualsOperator:
  ...
  /**
   * *********************************************************************** BETWEEN PREDICATE (Sec.
   * 8.3, p. 172) **********************************************************************
   */
  public static final void BetweenPredicate() throws ParseException {
   ...
   * 8.5, p. 175) **********************************************************************
   */
  public static final void LikePredicate() throws ParseException {
  ...
  public static final void EscapeClause() throws ParseException {
   ...
   * 8.6, p. 178) **********************************************************************
   */
  public static final void NullPredicate() throws ParseException {
   ...
   * (Sec. 7.1, p. 139) **********************************************************************
   */
  public static final void RowValueConstructor() throws ParseException {
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case Identifier:
      case ParameterName:
      case ExactNumericLiteral:
  ...
  public static final void NullSpecification() throws ParseException {
    jj_consume_token(NULL);
  }
   ...
   * 10.5, p. 207) **********************************************************************
   */
  public static final String CollateClause() throws ParseException {
    String coll = null;
  ...
  public static final String CollationName() throws ParseException {
    Token t;
    t = jj_consume_token(Identifier);
    {
      if (true) return t.image;
   ...
   * 13.1, p. 307) **********************************************************************
   */
  public static final void OrderByClause() throws ParseException {
  ...
  public static final void SortSpecificationList() throws ParseException {
    SortSpecification();
    label_8:
    while (true) {
      switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
  ...
  public static final void SortSpecification() throws ParseException {
  ...
  public static final void SortKey() throws ParseException {
    /*@bgen(jjtree) SortKey */
  ...
  public static final int OrderingSpecification() throws ParseException {
  ...
  private static final int[] jj_la1 = new int[40];
  private static final int[] jj_la1_0 = {
    0x0, 0x0, 0x4000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x400, 0x0, 0x4000, 0x4000, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x100000, 0x100000, 0x0, 0x0, 0x20000, 0x20000, 0x20000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x200000, 0x0, 0x200000,
  };
  private static final int[] jj_la1_1 = {
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x400, 0x0,
    0x0, 0x0,
  };
  private static final int[] jj_la1_2 = {
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4000, 0x4000, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x200000, 0x0, 0x0, 0x0,
    0x0, 0x200, 0x0, 0x200,
  };
  private static final int[] jj_la1_3 = {
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x800, 0x1000, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0,
  };
  ...
  private static final int[] jj_la1_5 = {
    0x0, 0x8000000, 0x0, 0x8000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0,
  };
  ...
  private static final int[] jj_la1_8 = {
    0x0, 0x4000, 0x0, 0x4000, 0xa0000, 0xa0000, 0x0, 0xa0002, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x40000, 0xb0002, 0xa0002, 0x0, 0x0, 0x40000, 0x40000, 0x0, 0x0, 0x0, 0x0, 0x4000, 0xa0002,
    0x39c, 0x0, 0x0, 0x0, 0x0, 0xa0002, 0x40000, 0x0, 0x0, 0x0, 0x0,
  };
  private static final JJCalls[] jj_2_rtns = new JJCalls[7];
