...
public class PSFileSystemDatabaseMetaData implements DatabaseMetaData {
   ...
   *     <p>Constructs a new, empty meta data object.
   */
   ...
   * @author chadloder
   * @version 1.7 1999/04/21
   *     <p>Constructs a new meta data object owned by the given connection.
  ...
  /**
   * sor Can all the tables returned by getTables be SELECTed by the current user? This always
   * returns false as file permissions may prevent reading.
   *
   * @return always returns <code>false</code>
   * @throws SQLException if an error occurs
   */
  ...
  public java.lang.String getDatabaseProductVersion() throws SQLException {
     ...
     */
    return m_conn.getDriver().getMajorVersion() + "." + m_conn.getDriver().getMajorVersion();
  }
  ...
  public java.lang.String getDriverVersion() throws SQLException {
     ...
     * (convert method return values to String)
     */
    return "" + m_conn.getDriver().getMajorVersion() + "." + m_conn.getDriver().getMinorVersion();
  }
  ...
  /**
   * Does the database store tables in a local file? At this time, only the local file system is
   * supported, thus <code>true</code> is always returned
   *
   * @return <code>true</code> is always returned
   * @throws SQLException if an error occurs
   */
  ...
  /**
   * Does the database use a file for each table? <code>false</code> is always returned as a
   * directory may represent a table. When this is the case, the files stored in the directory are
   * considered to be the rows of the table.
   *
   * @return <code>false</code> is always returned
   * @throws SQLException if an error occurs
   */
  ...
  /**
   * Get a listing of the files and directories (tables) available in a drive or directory
   * (catalog).
   *
  ...
  public java.sql.ResultSet getTables(
    ...
    PSPatternMatcher filt =
        PSPatternMatcher.FileWildcardMatcher(tableNamePattern.replace('%', '*').replace('_', '?'));
    ...
    File[] fileList = startDir.listFiles((java.io.FileFilter) (new PSFileFilter(filt)));
    ...
    if ((types == null) || (types.length == 0)) {
      ...
      for (int i = 0; i < types.length; i++) {
        ...
        if (tableTypeFile.equalsIgnoreCase(curType)) includeFiles = true;
        else if (tableTypeDir.equalsIgnoreCase(curType)) includeDirectories = true;
      }
    }
  ...
  /**
   * Get the directories (catalog names) available in this database. If "" was used as the database
   * (catalog) when making the connection, drive names or root directories will be returned. The
  ...
  public java.sql.ResultSet getCatalogs() throws SQLException {
    if (m_conn == null) throw new SQLException("no connection");
  ...
  public java.sql.ResultSet getTablePrivileges(
      java.lang.String catalog, java.lang.String schemaPattern, java.lang.String tableNamePattern)
      throws SQLException {
    return null;
  }
  ...
  /** The result set meta data objects for the different kinds of results */
  protected static final PSResultSetMetaData ms_getCatalogsRSMeta = new PSResultSetMetaData();

  protected static final PSResultSetMetaData ms_getTablesRSMeta = new PSResultSetMetaData();
  protected static final PSResultSetMetaData ms_getTableTypesRSMeta = new PSResultSetMetaData();
  protected static final PSResultSetMetaData ms_getColumnsRSMeta = new PSResultSetMetaData();
  protected static final PSResultSetMetaData ms_getPrimaryKeysRSMeta = new PSResultSetMetaData();

  static {
    // result set meta data for getCatalogs
    ms_getCatalogsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("TABLE_CAT", java.sql.Types.VARCHAR, 255));

    // result set meta data for getTables
    ms_getTablesRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("TABLE_CAT", java.sql.Types.VARCHAR, 255));
    ms_getTablesRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("TABLE_SCHEM", java.sql.Types.VARCHAR, 255));
    ms_getTablesRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("TABLE_NAME", java.sql.Types.VARCHAR, 255));
    ms_getTablesRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("TABLE_TYPE", java.sql.Types.VARCHAR, 255));
    ms_getTablesRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("REMARKS", java.sql.Types.VARCHAR, 255));
    ...
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("TABLE_NAME", java.sql.Types.VARCHAR, 255));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("COLUMN_NAME", java.sql.Types.VARCHAR, 255));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("DATA_TYPE", java.sql.Types.SMALLINT, 2));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("TYPE_NAME", java.sql.Types.VARCHAR, 255));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("COLUMN_SIZE", java.sql.Types.INTEGER, 4));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("BUFFER_LENGTH", java.sql.Types.VARCHAR, 255));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("DECIMAL_DIGITS", java.sql.Types.INTEGER, 4));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("NUM_PREC_RADIX", java.sql.Types.INTEGER, 4));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("NULLABLE", java.sql.Types.INTEGER, 4));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("REMARKS", java.sql.Types.VARCHAR, 255));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("COLUMN_DEF", java.sql.Types.VARCHAR, 255));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("SQL_DATA_TYPE", java.sql.Types.INTEGER, 4));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("SQL_DATETIME_SUB", java.sql.Types.INTEGER, 4));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("CHAR_OCTET_LENGTH", java.sql.Types.INTEGER, 4));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("ORDINAL_POSITION", java.sql.Types.INTEGER, 4));
    ms_getColumnsRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("IS_NULLABLE", java.sql.Types.VARCHAR, 255));
    ...
    ms_getPrimaryKeysRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("COLUMN_NAME", java.sql.Types.VARCHAR, 255));
    ms_getPrimaryKeysRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("KEY_SEQ", java.sql.Types.VARCHAR, 255));
    ms_getPrimaryKeysRSMeta.addColumnMetaData(
        new PSResultSetColumnMetaData("PK_NAME", java.sql.Types.VARCHAR, 255));
  } // end static init
