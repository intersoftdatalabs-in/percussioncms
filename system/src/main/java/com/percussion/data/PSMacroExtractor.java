...
public class PSMacroExtractor extends PSDataExtractor {
   ...
   *
   * @param source the object defining the source of this value, may be <code>null</code>.
   */
  public PSMacroExtractor(PSMacro source) {
    ...
    m_source = source;
    if (m_source != null)
      m_macroDefinition = PSServer.getMacros().getMacroDefinition(m_source.getName());
  }

  /** Convenience method signature that calls {@link extract(PSExecution Data, Object)}. */
   ...
   * @param defValue the default value to use if a value is not found, may be <code>null</code>.
   * @return the associated value as <code>String</code>, <code>null</code> if a value is not found.
  ...
  public Object extract(PSExecutionData data, Object defaultValue)
    ...
    if (m_macroDefinition != null) {
      ...
      try {
        ...
        IPSMacroExtractor extractor = (IPSMacroExtractor) ctor.newInstance(new Object[] {});
  ...
  /**
   * The source for which to extract the data, initialized in constructor, may be <code>null</code>.
   */
  protected PSMacro m_source = null;

  /**
   * The macro definition for which to extract the data, initialized in constructor, may be <code>
   * null</code>.
   */
