...
public class PSUrlRequestExtractor extends PSDataExtractor {
   ...
   *    </code>.
   */
  public PSUrlRequestExtractor(PSUrlRequest req) throws PSExtensionException, PSNotFoundException {
    super(req);
    if (null == req) throw new IllegalArgumentException("Request param cannot be null.");
