...
public class PSQueryOptimizer extends PSOptimizer {
      ...
      for (int i = 0; i < joinSize; i++) {
        ...
        if (curJoin.getTranslator() != null) {
          ...
          if (driverServerCombo.equals(right.getTable().getServerKey())) {
            ...
            connKeys.put(
                driverServerCombo, Integer.valueOf(originalConnectionIndex.intValue() + 1));
          }
        }
  ...
  private static void addSelectColumn(
      PSBackEndColumn curCol,
      HashMap<String, PSBackEndTable> taken,
  ...
  private static boolean isIndexedLookupOptimal(
      ...
      PSDataSet ds,
      PSBackEndJoin join,
      Map<String, PSTableMetaData> tmdMap,
      Map<PSBackEndTable, PSSqlQueryBuilder> builderMap,
      PSDataSelector sel,
