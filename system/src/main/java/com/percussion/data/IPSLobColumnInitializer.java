...
public interface IPSLobColumnInitializer {
  /**
   * Get the Lob Initializer for the specified Clob value. This is the text that will be put in
   * place of the placeholders for initial insert and update statements.
   *
   * @param clobVal the object to be placed in the clob column
   * @param isNull is the object considered to be null?
   * @return the initializer for clobs for this DBMS or <code>null</code> to use a placeholder <I>
   *     Some DBMS' may allow the value to be sent directly in the future... allowing null to be
   *     returned will facilitate this</I>
   */
  public String getClobInitializer(Object clobVal, boolean isNull);

  /**
   * Get the Lob Initializer for the specified Blob value. This is the text that will be put in
   * place of the placeholders for initial insert and update statements.
   *
   * @param blobVal the object to be placed in the blob column
   * @param isNull is the object considered to be null?
   * @return the initializer for blobs for this DBMS or <code>null</code> to use a placeholder <I>
   *     Some DBMS' may allow the value to be sent directly in the future... allowing null to be
   *     returned will facilitate this</I>
   */
