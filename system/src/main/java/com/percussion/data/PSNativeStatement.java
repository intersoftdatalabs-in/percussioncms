...
/**
 * The PSNativeStatement class defines a native statement which can be executed as part of a query
 * execution plan.
 *
...
public class PSNativeStatement extends PSStatement {
   ...
   */
  public PSNativeStatement(int connKey, IPSStatementBlock[] blocks)
  ...
  /**
   * Execute the native statement as a step in the execution plan. The result set generated by
   * executing this statement will be added to the execution data.
   *
  ...
  public void execute(PSExecutionData data)
    ...
    try {
      ...
      if (rs != null) data.getResultSetStack().push(rs);
      ...
      if (conn != null) {
        ...
        if (stmt != null) wStmt = stmt.getWarnings();
