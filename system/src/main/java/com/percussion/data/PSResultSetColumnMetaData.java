...
public class PSResultSetColumnMetaData {
  ...
  public int isNullable() {
    ...
    else if ((m_flags & COL_NULLABLE) == COL_NULLABLE) return ResultSetMetaData.columnNullable;
  ...
  public void setAutoIncrement(boolean enable) {
    ...
    else m_flags &= ~COL_AUTO_INCREMENT;
  }
  ...
  public void setCaseSensitive(boolean enable) {
    ...
    else m_flags &= ~COL_CASE_SENSITIVE;
  }
  ...
  public void setNullable(int flag) {
    ...
    if (flag == ResultSetMetaData.columnNoNulls) m_flags |= COL_NO_NULL;
    else if (flag == ResultSetMetaData.columnNullable) m_flags |= COL_NULLABLE;
    else m_flags |= COL_NULL_UNKNOWN;
  }
  ...
  public void setWritable(boolean enable) {
    ...
    else m_flags &= ~COL_WRITE_POSSIBLE;
  }
  ...
  public void setDefinitelyWritable(boolean enable) {
    ...
    else m_flags &= ~COL_WRITE_DEFINITE;
  }
