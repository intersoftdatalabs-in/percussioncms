...
public class PSUpdateStatement extends PSStatement {
  ...
  public void execute(PSExecutionData data)
    ...
    try {
      ...
      if (preparedStatementHasParams) stmt.clearParameters();
      int bindStart = 1;
      ...
      if (tableChangeData != null) tableChangeData.collectTableChangeEvent(rowCount);
      ...
      switch (m_statementType) {
        ...
        case TYPE_DELETE:
          ...
          traceRowAction(req, "traceResourceHandler_updateDeleted", rowCount);
          break;
      }
