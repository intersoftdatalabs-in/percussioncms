...
public abstract class PSDataExtractor implements IPSDataExtractor {
  ...
  /**
   * Get the source IPSReplacementValue object used to create this extractor.
   *
  ...
  public IPSReplacementValue getSingleSource() {
    if (m_sourceReplacementValues == null || m_sourceReplacementValues.length == 0) return null;
