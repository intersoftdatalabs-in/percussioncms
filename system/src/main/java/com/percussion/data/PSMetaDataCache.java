...
public class PSMetaDataCache {
  ...
  public static PSMetaDataCache getInstance() {
    if (ms_instance == null) ms_instance = new PSMetaDataCache();
  ...
  public static PSTableMetaData getTableMetaData(PSBackEndLogin login, PSBackEndTable table)
    ...
    PSTableMetaData tmd = dmd.getTableMetaData(detail.getOrigin(), table.getTable());
   ...
   */
  public static PSConnectionDetail getConnectionDetail(IPSConnectionInfo info) throws SQLException {
    PSDatabaseMetaData dmd = null;
    String datasource = info == null ? null : info.getDataSource();
  ...
  public static void loadConnectionDetail(PSBackEndTable table) throws SQLException {
    ...
    if (table.getConnectionDetail() != null) return;

    PSDatabaseMetaData dbmd = getCachedDatabaseMetaData(table.getDataSource());
