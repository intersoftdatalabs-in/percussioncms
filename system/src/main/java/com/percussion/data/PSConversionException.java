...
/**
 * PSConversionException is thrown to indicate that the requested conversion failed.
 *
...
public class PSConversionException extends PSException {
  ...
  /** See {@link PSException#PSException(int,Throwable,Object[]) base class} for desc. */
   ...
   * @param arrayArgs the array of arguments to use as the arguments in the error message
   */
  public PSConversionException(String language, int msgCode, Object[] arrayArgs) {
