...
/**
 * The PSDatabasePoolDatabaseMetaData class is used as a wrapper on top of a
 * java.sql.DatabaseMetaData implementation. We've found that various methods, such as getTables
 * require the parameters to be setup just right or else the call will not return the appropriate
 * data. To avoid these problems, we've created this wrapper which is used to perform the
 * appropriate parameter fixup.
 *
 * <p>This class is used to fix bug id Rx-99-11-0029
 *
...
public class PSDatabasePoolDatabaseMetaData implements DatabaseMetaData {
  public PSDatabasePoolDatabaseMetaData(DatabaseMetaData md) {
    ...
    m_flags = 0;
    try {
      if (m_md.supportsCatalogsInDataManipulation()) m_flags |= FLAGS_SUPPORTS_CATALOG;
    } catch (java.sql.SQLException e) {
      // we will ignore these for now
    }

    try {
      if (m_md.supportsSchemasInDataManipulation()) m_flags |= FLAGS_SUPPORTS_SCHEMA;
    } catch (java.sql.SQLException e) {
      // we will ignore these for now
    }

    try {
      if (m_md.storesUpperCaseIdentifiers()) m_flags |= FLAGS_STORES_UPPERCASE;
      else if (m_md.storesLowerCaseIdentifiers()) m_flags |= FLAGS_STORES_LOWERCASE;
    } catch (java.sql.SQLException e) {
      // we will ignore these for now
    }
  }
  ...
  /**
   * Does the database treat mixed case unquoted SQL identifiers as case insensitive and store them
   * in upper case?
   *
   * @return <code>true</code> if so; <code>false</code> otherwise
   * @exception SQLException if a database access error occurs
  ...
  /**
   * Does the database treat mixed case quoted SQL identifiers as case insensitive and store them in
   * upper case?
   *
   * @return <code>true</code> if so; <code>false</code> otherwise
   * @exception SQLException if a database access error occurs
  ...
  /**
   * Gets a comma-separated list of math functions. These are the X/Open CLI math function names
   * used in the JDBC function escape clause.
   *
   * @return the list
   * @exception SQLException if a database access error occurs
   */
  ...
  /**
   * Gets a comma-separated list of string functions. These are the X/Open CLI string function names
   * used in the JDBC function escape clause.
   *
   * @return the list
   * @exception SQLException if a database access error occurs
  ...
  /**
   * Gets a comma-separated list of system functions. These are the X/Open CLI system function names
   * used in the JDBC function escape clause.
   *
   * @return the list
   * @exception SQLException if a database access error occurs
  ...
  /**
   * Gets the string that can be used to escape wildcard characters. This is the string that can be
   * used to escape '_' or '%' in the string pattern style catalog search parameters.
   *
  ...
  /**
   * Gets all the "extra" characters that can be used in unquoted identifier names (those beyond
   * a-z, A-Z, 0-9 and _).
   *
   ...
   *
   * @return max binary literal length in hex characters; a result of zero means that there is no
   *     limit or the limit is not known
   * @exception SQLException if a database access error occurs
   */
   ...
   *
   * @return max literal length; a result of zero means that there is no limit or the limit is not
   *     known
   * @exception SQLException if a database access error occurs
   */
   ...
   *
   * @return max column name length; a result of zero means that there is no limit or the limit is
   *     not known
   * @exception SQLException if a database access error occurs
   */
   ...
   *
   * @return max number of columns; a result of zero means that there is no limit or the limit is
   *     not known
   * @exception SQLException if a database access error occurs
   */
   ...
   *
   * @return max number of active connections; a result of zero means that there is no limit or the
   *     limit is not known
   * @exception SQLException if a database access error occurs
   */
   ...
   *
   * @return max cursor name length in bytes; a result of zero means that there is no limit or the
   *     limit is not known
   * @exception SQLException if a database access error occurs
   */
   ...
   *
   * @return max index length in bytes; a result of zero means that there is no limit or the limit
   *     is not known
   * @exception SQLException if a database access error occurs
   */
   ...
   *
   * @return max name length in bytes; a result of zero means that there is no limit or the limit is
   *     not known
   * @exception SQLException if a database access error occurs
   */
   ...
   *
   * @return max row size in bytes; a result of zero means that there is no limit or the limit is
   *     not known
   * @exception SQLException if a database access error occurs
   */
   ...
   *
   * @return max length in bytes; a result of zero means that there is no limit or the limit is not
   *     known
   * @exception SQLException if a database access error occurs
   */
   ...
   *
   * @return the maximum number of tables allowed in a SELECT statement; a result of zero means that
   ...
   *
   * @return max user name length in bytes; a result of zero means that there is no limit or the
   *     limit is not known
   * @exception SQLException if a database access error occurs
   */
  ...
  /**
   * What's the database's default transaction isolation level? The values are defined in <code>
  ...
  /**
   * Are transactions supported? If not, invoking the method <code>commit</code> is a noop and the
   ...
   *
   * <p>Only procedure descriptions matching the schema and procedure name criteria are returned.
   ...
   * They are ordered by PROCEDURE_SCHEM and PROCEDURE_NAME. Within this, the return value, if any,
   * is first. Next are the parameter descriptions in call order. The column descriptions follow in
   * column number order.
   *
   * <p>Each row in the ResultSet is a parameter description or column description with the
   * following fields:
   *
   * <OL>
   *   <LI><B>PROCEDURE_CAT</B> String => procedure catalog (may be null)
  ...
  public ResultSet getProcedureColumns(
    ...
    return m_md.getProcedureColumns(
   ...
   *   <LI><B>DATA_TYPE</B> short => SQL type from java.sql.Types
   *   <LI><B>TYPE_NAME</B> String => Data source dependent type name, for a UDT the type name is
   *       fully qualified
  ...
  /**
   * Gets a description of the access rights for each table available in a catalog. Note that a
   * table privilege applies to one or more columns in the table. It would be wrong to assume that
   * this priviledge applies to all columns (this may be true for some systems but is not true for
   * all.)
   *
  ...
  /**
   * Gets a description of a table's optimal set of columns that uniquely identifies a row. They are
   * ordered by SCOPE.
   *
   * <p>Each column description has the following columns:
   *
  ...
  /**
   * Gets a description of a table's columns that are automatically updated when any value in a row
  ...
  /**
   * Gets a description of the primary key columns that are referenced by a table's foreign key
  ...
  /**
   * Gets a description of the foreign key columns that reference a table's primary key columns (the
   * foreign keys exported by a table). They are ordered by FKTABLE_CAT, FKTABLE_SCHEM,
  ...
  /**
   * Gets a description of the foreign key columns in the foreign key table that reference the
   ...
   * </OL>
   *
   * @param primaryCatalog a catalog name; "" retrieves those without a catalog; null means drop
   *     catalog name from the selection criteria
   * @param primarySchema a schema name; "" retrieves those without a schema
   * @param primaryTable the table name that exports the key
   * @param foreignCatalog a catalog name; "" retrieves those without a catalog; null means drop
   *     catalog name from the selection criteria
  ...
  /**
   * Gets a description of all the standard SQL types supported by this database. They are ordered
   * by DATA_TYPE and then by how closely the data type maps to the corresponding JDBC SQL type.
   *
  ...
  /**
   * Gets a description of a table's indices and statistics. They are ordered by NON_UNIQUE, TYPE,
   ...
   * JDBC 2.0
   *
   * <p>Does the database support the concurrency type in combination with the given result set
   * type?
   *
   * @param type defined in <code>java.sql.ResultSet</code>
   ...
   * JDBC 2.0
   *
   * <p>Indicates whether or not a visible row delete can be detected by calling
   ...
   * JDBC 2.0
   *
   * <p>Gets a description of the user-defined types defined in a particular schema. Schema-specific
   * UDTs may have type JAVA_OBJECT, STRUCT, or DISTINCT.
   *
   ...
   * @param types a list of user-named types to include (JAVA_OBJECT, STRUCT, or DISTINCT); null
   *     returns all types
