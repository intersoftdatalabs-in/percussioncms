...
public class PSParamDef {
   ...
   *
   * @param source The element containing the XML represention, may not be <code>null</code>. See
   ...
   * <code>null</code>, a space is assumed which will result in two separate command arguments for
   * name and value. If not, then a single command argument is formed by concatenating name +
   * separator + value.
   *
   ...
   * @return The XML representation, never <code>null</code>, conforms to the PSXParam element as
  ...
  public Element toXml(Document doc) {
    ...
    if (m_separator != null) el.setAttribute(ATTR_SEPARATOR, m_separator);
  ...
  /**
   * Indicates whether this param is the first param of the group. Defaults to <code>false</code>.
   */
  private boolean m_beginGroup = false;

  /**
   * Indicates whether this param is the last param of the group. Defaults to <code>false</code>.
   */
  ...
  /**
   * The name of this parameter, may be <code>null</code>, never empty or modified after
   * construction.
   */
  private String m_name;

  /** The value and its resolver, never <code>null</code> or modified after construction. */
  private PSResolvableValue m_value;

  /**
   * The variable name used to control the inclusion of this parameter in the process request. See
   * {@link #getIfDefinedName()} for more info. Initialized during construction, may be <code>null
   * </code>, never emtpy, never modified after that.
   */
  private String m_ifDefinedName;

  /**
   * The value to use as a separator between the name and resolved value. See {@link
   * #getSeparator()} for more info. May be <code>null</code>, never empty or modified after
   * construction.
   */
