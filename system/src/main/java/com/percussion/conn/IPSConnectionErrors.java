...
/**
 * The IPSConnectionErrors inteface is provided as a convenient mechanism for accessing the various
...
public interface IPSConnectionErrors {
   ...
   *
   * <p>No arguments are used in this message.
   */
  ...
  /**
   * used when throwing IllegalStateException due to socket already being opened
   *
   * <p>No arguments are used in this message.
   */
