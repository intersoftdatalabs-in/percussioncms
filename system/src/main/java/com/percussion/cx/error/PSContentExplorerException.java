...
public class PSContentExplorerException extends PSStandaloneException {
   ...
   * based on the users session {@link com.percussion.util.IPSHtmlParameters#SYS_LANG
  ...
  private String createMessage() {
    ...
    String msg =
        PSI18NTranslationKeyValues.getInstance().getTranslationValue("" + super.getErrorCode());
