...
public class PSMenuAction implements IPSComponent, Cloneable {
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    m_sortrank = 0;
    m_hideFromMenu =
        Boolean.valueOf(PSComponentUtils.getAttribute(sourceNode, HIDEFROMMENU_ATTR, "false"));
    ...
    Element paramsEl =
        PSComponentUtils.getChildElement(sourceNode, PSParameters.XML_NODE_NAME, false);
    m_params = null;

    if (paramsEl != null) m_params = new PSParameters(paramsEl);
  ...
  private boolean validType(String type) {
    ...
    if (!(TYPE_MENU.equals(type) || TYPE_MENUITEM.equals(type) || TYPE_CONTEXTMENU.equals(type)))
      throw new IllegalArgumentException(
  ...
  public boolean isContextMenu() {
    if (TYPE_CONTEXTMENU.equals(m_type)) return true;
  ...
  public boolean isMenuItem() {
    if (TYPE_MENUITEM.equals(m_type)) return true;
  ...
  public boolean isClientAction() {
    if (HANDLER_CLIENT.equals(m_handler)) return true;
  ...
  public String getProperty(String name) {
    ...
    if (m_props != null) value = m_props.getProperty(name);
  ...
  public String getParameter(String name) {
    ...
    if (m_params != null) value = m_params.getParameter(name);
  ...
  public void setParameter(String name, String value) {
    ...
    if (m_params == null) m_params = new PSParameters();
  ...
  public void setChildren(Iterator children) {
    if (isMenuItem())
      throw new IllegalStateException("Can not set children to " + TYPE_MENUITEM + "action");
    ...
    while (children.hasNext()) {
      ...
      if (obj instanceof PSMenuAction) {
        ...
        if (!maction.m_hideFromMenu) m_children.add(obj);
      } else {
        throw new IllegalArgumentException(
  ...
  public Element toXml(Document doc) {
    ...
    if (m_props != null) root.appendChild(m_props.toXml(doc));

    if (m_params != null) root.appendChild(m_params.toXml(doc));
  ...
  public PSMenuAction findChildAction(PSMenuAction action) {
    ...
    while (iter.hasNext()) {
      child = (PSMenuAction) iter.next();
      if (child.equals(action)) return child;
    }
    return null;
  }
  ...
  public boolean containsChildAction(PSMenuAction action) {
    ...
    while (iter.hasNext()) {
      child = (PSMenuAction) iter.next();
      if (child.equals(action)) return true;
    }
    return false;
  }
  ...
  public void setAdhocParam(boolean value) {
    if (value) setParameter(SHOW_ADHOC, VAL_BOOLEAN_TRUE);
    else setParameter(SHOW_ADHOC, null);
  }
  ...
  public int compare(Object obj1, Object obj2) {
    ...
    if (ret == 0) {
      return a1.getLabel().toUpperCase().compareTo(a2.getLabel().toUpperCase());
    }
    return (ret);
  }
  ...
  public boolean equals(Object obj) {
    boolean equals = true;
    if (!(obj instanceof PSMenuAction)) equals = false;
    else {
      PSMenuAction other = (PSMenuAction) obj;
      if (m_actionid != other.m_actionid) equals = false;
      else if (!m_name.equals(other.m_name)) equals = false;
      ...
      else if (m_params == null ^ other.m_params == null) equals = false;
      else if (m_params != null && !m_params.equals(other.m_params)) equals = false;
