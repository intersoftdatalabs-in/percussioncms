...
public class PSProperties implements IPSComponent {
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    while (list.hasNext()) {
      ...
      if (prop.getFirstChild() instanceof Text) {
        m_props.put(attrib.getNodeValue(), prop.getFirstChild().getNodeValue());
      } else {
  ...
  public Element toXml(Document doc) {
    ...
    if (!m_props.isEmpty()) {
      ...
      while (properties.hasNext()) {
        ...
        if (value != null) propEl.appendChild(doc.createTextNode(value));
        else propEl.appendChild(doc.createTextNode(""));
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof PSProperties) {
      ...
      if (m_props.equals(other.m_props)) equals = true;
    }
