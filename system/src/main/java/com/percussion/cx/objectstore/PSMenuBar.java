...
public class PSMenuBar implements IPSComponent {
  ...
  public PSMenuBar(Iterator actions) {
    ...
    while (actions.hasNext()) {
      ...
      if (obj instanceof PSMenuAction) {
        ...
        if (action.isMenu()) m_actions.add(obj);
        else throw new IllegalArgumentException("action must be a menu");
      } else
        throw new IllegalArgumentException("Elements of children must be instances of PSAction");
    }
  }
  ...
  public Element toXml(Document doc) {
    ...
    while (actions.hasNext()) root.appendChild(((PSMenuAction) actions.next()).toXml(doc));
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PSMenuBar)) equals = false;
    else {
      PSMenuBar other = (PSMenuBar) obj;
      if (m_props == null ^ other.m_props == null) equals = false;
      else if (m_props != null && !m_props.equals(other.m_props)) equals = false;
      else if (!m_actions.equals(other.m_actions)) equals = false;
    }
