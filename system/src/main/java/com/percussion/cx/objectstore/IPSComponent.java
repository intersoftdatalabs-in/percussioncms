...
public interface IPSComponent {
   ...
   * null</code>
   * @return the newly created XML element node, may be <code>null</code> if the component does not
   *     have any data to represent.
  ...
  /**
   * Determines if this object is equal to another. See {@link java.lang.Object#equals(Object)
   * Object.equals()} for more info.
   */
