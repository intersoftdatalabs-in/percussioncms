...
public class PSParameters implements IPSComponent {
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    Iterator list = PSComponentUtils.getChildElements(sourceNode, PARAM_NODE_NAME);
    if (!list.hasNext()) {
    ...
    while (list.hasNext()) {
      ...
      if (param.getFirstChild() instanceof Text) {
        m_params.put(attrib.getNodeValue(), param.getFirstChild().getNodeValue());
      } else {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof PSParameters) {
      ...
      if (m_params.equals(other.m_params)) equals = true;
    }
