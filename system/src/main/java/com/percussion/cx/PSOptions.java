...
public class PSOptions implements IPSClientObjects {
  ...
  public void fromXml(Element sourceNode) throws PSContentExplorerException {
    ...
    try {
      ...
      setCategory(PSXMLDomUtil.checkAttribute(sourceNode, ATTR_CATEGORY, true));
  ...
  public void addOption(String context, String optionId, Object optionValue) {
    ...
    if (optionValue == null) throw new IllegalArgumentException("optionValue may not be null.");
  ...
  private void addOption(String theOptionId, PSOption option) {
    if (option == null) throw new IllegalArgumentException("option must not be null");
  ...
  public boolean equals(Object obj) {
    ...
    if (!PSOptionManagerConstants.compare(m_category, comp.m_category)) return false;
    if (!PSOptionManagerConstants.compare(m_optionMap, comp.m_optionMap)) return false;
