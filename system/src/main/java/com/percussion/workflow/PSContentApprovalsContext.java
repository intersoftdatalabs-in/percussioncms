...
public class PSContentApprovalsContext implements IPSContentApprovalsContext {
  ...
  public PSContentApprovalsContext(
    ...
    if (null == transContext) {
      throw new IllegalArgumentException(
          "The transitions context may " + "not be null in PSContentApprovalsContext");
    }
  ...
  public String toString(int i) {
    ...
    if (i >= m_nCount) {
      throw new IllegalArgumentException("The number of approvers must exceed the index.");
    }
  ...
  public void addContentApproval(String userName, int roleId) throws SQLException {
    int nRows = 0;
  ...
  public boolean hasUserActed(String userName) {
    ...
    try {
      m_Rs = null;
      m_Statement = null;
      m_Statement = PSPreparedStatement.getPreparedStatement(m_Connection, USER_QUERYSTRING);
      m_Statement.clearParameters();
  ...
  public boolean hasRoleActed(int roleId) {
    ...
    try {
      m_Rs = null;
      m_Statement = null;
      m_Statement = PSPreparedStatement.getPreparedStatement(m_Connection, ROLEID_QRYSTRING);
      m_Statement.clearParameters();
