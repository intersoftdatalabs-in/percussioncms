...
/**
 * The PSLogFullUserActivity class is used to log more informative information concerning the
 * handling of the user's request. This information is not necessarily structured and is anything
...
public class PSLogFullUserActivity extends PSLogInformation {
   ...
   * reported when this object was created. See the {@link #PSLogFullUserActivity constructor} for
   * more details.
   *
