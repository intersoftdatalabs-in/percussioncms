...
/**
 * IPSLogWriter defines an interface for writing log messages (PSLogInformation sub-objects) to a
 * log implementation. Log writers should only be used by the PSLogManager object.
 *
...
public interface IPSLogWriter {
   ...
   * attempts to write through this object will throw an exception. It is not an error to call
   * close() on a closed log writer.
   *
   * @see #isOpen
   */
  public void close();
   ...
   *
   * @return Returns true if the log writer is open, false if the log writer is not open.
   * @see #close
   */
   ...
   */
  public void write(PSLogInformation msg) throws java.lang.IllegalStateException;
