...
public class PSLogDetailedUserActivity extends PSLogInformation {
  ...
  /**
   * Construct a log message containing the detailed user activity information.
   *
   ...
   *   <li>postBody - (subtype 2) the body of the POST request
   *   <li>xmlFile - (subtype 3) the XML file submitted with the request
   *   <li>rowsSelected - (subtype 4) the number of rows selected
   *   <li>rowsInserted - (subtype 5) the number of rows inserted
   *   <li>rowsUpdated - (subtype 6) the number of rows updated
   *   <li>rowsDeleted - (subtype 7) the number of rows deleted
   *   <li>rowsSkipped - (subtype 8) the number of rows skipped
   *   <li>rowsFailed - (subtype 9) the number of rows failed
   *   <li>duration - (subtype 10) the amount of time to process the request (in milliseconds)
   * </ul>
   *
   ...
   * #PSLogDetailedUserActivity(int,java.util.Map) constructor} for more details.
   *
