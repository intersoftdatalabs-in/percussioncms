...
/**
 * IPSLogReader defines an interface for reading log messages (PSLogInformation sub-objects) from a
 * log implementation. Log readers should only be used by the PSLogManager object.
 *
 * <p>Log entries can be located using one of the following mechanisms:
 *
 * <ul>
...
public interface IPSLogReader {
   ...
   * attempts to read from this object will throw an exception. It is not an error to call close()
   * on a closed log reader.
   *
   * @see #isOpen
   */
  public void close();
