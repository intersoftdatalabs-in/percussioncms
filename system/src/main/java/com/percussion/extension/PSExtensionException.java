...
public class PSExtensionException extends PSException {
   ...
   *
   * @param ext object used to refer uniquely to an extension by its handler name, context within
   *     the handler, and the extension name itself.
   * @param errorText
   */
  public PSExtensionException(PSExtensionRef ext, String errorText) {
    super(
        IPSExtensionErrors.EXT_INIT_FAILED,
  ...
  /**
   * Constructs an extension handler exception that includes the unique handler name and the
  ...
  public PSExtensionException(String handlerName, String errorText) {
    super(IPSExtensionErrors.EXT_HANDLER_INIT_FAILED, new Object[] {handlerName, errorText});
  }
