...
public class PSExtensionDef implements IPSExtensionDef, Serializable, IPSCloneTuner {
   ...
   * all locations supplied by {@link #m_resURLs}, unless it is a jar file, in which case the jar is
   * included in this list as a file. May be <code>null</code>, unless {@link
