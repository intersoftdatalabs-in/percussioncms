...
public interface IPSExtensionParamDef extends IPSComponent {
   ...
   * the parameter and possibly its usage and constraints. Can be <CODE>null</CODE>.
   *
   * @return The human readable description, or <CODE>null</CODE> if none is provided.
   */
   ...
   *     created element. Must not be <CODE>null</CODE>.
