...
public interface IPSExtensionErrors {
  ...
  /**
   * The wrong number of parameters was passed in to an extension method.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * If the suppliedResources element is specified, also a deploy name is expected in the extension
   * definition.
   *
   * <p>The arguments passed in for this message are:
   *
  ...
  /**
   * An error occurred when constructing or initializing the extension manager.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * An error occurred when constructing or initializing an extension handler.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * The extension def does not specify that it implements the correct interface for the context in
  ...
  /**
   * the extractor returned null for the style sheet to use, which is not permitted
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * The user name must not be empty after removing host names from the input parameter.
   *
   * <p>No arguments are passed in for this message.
   */
  ...
  /**
   * Operation not allowed while the content is not checked out by you and you are not the
   * administrator. An administrator might have overriden your checkout. You must go back and
   * check-out the item again before attempting this operation.
   *
   * <p>No arguments are passed in for this message.
   */
  ...
  /**
   * No Roles are assigned with assignment type >= for specified accessLevel for specified stateid
   * and workflow id.
   *
   * <p>The arguments passed in for this message are:
   *
  ...
  /**
   * Only an administrator may perform a transitions if the content item is checked out.
   *
   * <p>No arguments are passed in for this message.
   */
  ...
  /**
   * You can not check in an item when it is checked out by somebody else and you are not an
   * administrator.
   *
   * <p>No arguments are passed in for this message.
   */
  ...
  /**
   * Not able to check-in item as an administrator has overridden your checkout. You must go back
   ...
   *
   * <p>No arguments passed in
   */
  public static final int VALIDATE_SLOTNAME_NOT_UNIQUE = 7457;

  /**
   * Error message specifying that items cannot be checked out if they are in any public state.
   *
   * <p>No arguments passed in
   */
  ...
  /**
   * The specified transition is invalid as the current state id of the item does not match with the
   * from stateid of this transition.
   *
   * <p>Five arguments are needed for this message namely, contentid, workflowid, current stateid of
   * the item, from stateid of transition and the transitionid.
   */
  public static final int INVALID_TRANSITION = 7459;

  /**
   * The specified transition by internal name or id does not exist for the current state of the
   * content item.
   *
   * <p>Four arguments are needed for this message namely, contentid, workflowid, current stateid of
   * the item and intrenal name/transitonid of the transition.
   */
   ...
   * <p>No arguments are passed in for this message.
   */
  public static final int AUTHENTICATION_FAILED_DIFFERENT_ITEM_USER_COMMUNITIES = 7461;

  /**
   * Illegal execution context for the effect.
   *
   * <p>Two arguments are required for this message, namely the name of the effect and the context
   * names this effect works under.
   */
   ...
   *
   * <p>Two arguments are required for this message, namely the name of the effect and the
   * relationship name this effect is trying to process.
   */
  public static final int NONPROMOTABLE_RELATIONSHIP = 7463;

  /**
   * Workflowid in the request is null while processing the effect and is ignored.
   *
   * <p>One argument is required for this message, namely the name of the effect.
   */
   ...
   *
   * <p>Two argument are required for this message, namely the name of the effect and the workflow
   * action name.
   */
   ...
   *
   * <p>Two arguments are required, namely the name of the effect and the current or incorrect
   * option for the effect.
   */
   ...
   *
   * <p>Three arguments are required, namely the name of the effect, from state and to state.
   */
   ...
   *
   * <p>two arguments are required, namely the name of the effect and the app/resource name.
   */
  ...
  /**
   * A dependent item is not in a state from where it cannot go to a desired state.
   *
   * <p>
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * The transition needed to move the promoted-over item to the 'archive' state failed for some
   * reason (possibly validation failed).
   *
   * <p>
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * Error message to indicate that the workflow comment exceeded the max length of 255 characters.
   *
   * <p>No arguments are required to pass in
   */
