...
/**
 * IPSExtension is a lightweight interface to be implemented by extensions of any kind. Implementing
 * classes may support direct invocation, inspection, etc. in their own way.
 *
 * <p>Generally, an extension handler will return an IPSExtension object from the prepare() method,
 * and the caller will cast this to some known subtype, if necessary.
 */
public interface IPSExtension {
   ...
   */
  void init(IPSExtensionDef def, File codeRoot) throws PSExtensionException;

  /**
   * The indicator flag which reflects that the implementing extension has not been initialized yet.
   */
  ...
  String BINARY_ASSEMBLER = "Java/global/percussion/assembly/binaryAssembler";

  /** Name of the text page assembler. */
  String DATABASE_ASSEMBLER = "Java/global/percussion/assembly/databaseAssembler";

  /** Name of the debugging assembler used during development. */
  String DEBUG_ASSEMBLER = "Java/global/percussion/assembly/debugAssembler";

  /** Name of the dispatch assembler */
  String DISPATCH_ASSEMBLER = "Java/global/percussion/assembly/dispatchAssembler";

  /** Name of the legacy assembler. */
  String LEGACY_ASSEMBLER = "Java/global/percussion/assembly/legacyAssembler";

  /** Name of the text page assembler. */
  String VELOCITY_ASSEMBLER = "Java/global/percussion/assembly/velocityAssembler";

  Set<String> KNOWN_ASSEMBLERS =
