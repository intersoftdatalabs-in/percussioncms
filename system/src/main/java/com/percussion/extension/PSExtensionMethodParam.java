...
public class PSExtensionMethodParam implements Serializable {
  ...
  /** The parameter description, never <code>null</code> after construcrion, may be empty. */
   ...
   * @param description the parameter description, may be <code>null</code> or empty.
   */
   ...
   *
   * @param source the source element from which to construct this, not <code>null</code>.
   ...
   *
   * @param source element the xml element from which to construct this object, nor <code>null
   *     </code>.
  ...
  public void fromXML(Element source) throws PSExtensionException {
    ...
    if (StringUtils.isBlank(test))
      throw new PSExtensionException(IPSExtensionErrors.MISSING_REQUIRED_ATTRIBUTE, TYPE_ATTR);
    setType(test);
