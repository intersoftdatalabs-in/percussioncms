...
public class PSExtensionRef implements Serializable {
   ...
   * @see #isValidContext
   */
  public PSExtensionRef(String handlerName, String context, String extensionName) {
   ...
   * @see #isValidContext
   */
  public PSExtensionRef(String category, String handlerName, String context, String extensionName) {
  ...
  public PSExtensionRef(String fullName) {
    ...
    if (parsed == null)
      throw new IllegalArgumentException("extension name not valid for full name " + fullName);
  ...
  public static PSExtensionRef handlerRef(String handlerName) {
    return new PSExtensionRef(
        IPSExtensionHandler.HANDLER_HANDLER, IPSExtensionHandler.HANDLER_CONTEXT, handlerName);
  }
  ...
  public void setExtName(String extName) {
    if (extName == null || extName.length() == 0) {
      throw new IllegalArgumentException("extName must not " + "be null or empty");
    }
    m_extName = extName;
  }
  ...
  public boolean equals(Object b) {
    if (!(b instanceof PSExtensionRef)) return false;
  ...
  public static boolean isValidContext(String context) {
    ...
    while (toker.hasMoreTokens()) {
      ...
      if (!isValidContextName(contextPart)) return false;
    }
  ...
  public static boolean isValidFullName(String fullName) {
    ...
    if (fullName == null) return isValid;
    ...
    if (parsedName != null) {
      ...
      if (isValidExtensionName(handlerName)
          ...
          && isValidExtensionName(extName)) isValid = true;
    }
    return isValid;
  }
  ...
  private static String[] parseFullName(String fullName) {
    ...
    if (-1 == firstSlash || firstSlash == (fullName.length() - 1)) isValid = false;

    int lastSlash = fullName.lastIndexOf('/');
    if (-1 == lastSlash || lastSlash == firstSlash || lastSlash == (fullName.length() - 1))
      isValid = false;
  ...
  private void init(String handlerName, String context, String extName, String category) {
    ...
    if (!isValidExtensionName(handlerName)) {
      throw new IllegalArgumentException(handlerName + " is not a valid extension handler name.");
    }
    ...
    if (!isValidExtensionName(extName)) {
      throw new IllegalArgumentException(extName + " is not a valid extension name.");
    }
  ...
  private static class PSExtensionRefComparator implements Comparator {
    ...
    public int compare(Object o1, Object o2) {
      ...
      return ((PSExtensionRef) o1)
          .getExtensionName()
          .compareToIgnoreCase(((PSExtensionRef) o2).getExtensionName());
    }
  }
}
