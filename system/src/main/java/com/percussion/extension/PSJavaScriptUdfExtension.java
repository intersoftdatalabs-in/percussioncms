...
public class PSJavaScriptUdfExtension implements IPSUdfProcessor {
  ...
  private Object getDate(Object o) throws com.percussion.data.PSConversionException {
    ...
    } else if ((o instanceof java.lang.String) || (o instanceof PSTextLiteral)) {
  ...
  private Object getNumber(Object o) throws com.percussion.data.PSConversionException {
    try {
      ...
      else if (o instanceof java.lang.String) return new java.lang.Double((java.lang.String) o);
  ...
  private int getTypeCode(String str) {
    if (str == null || str.length() == 0) return JAVASCRIPT_TYPECODE_STRING;
    else if (str.equals(JAVASCRIPT_TYPE_STRING)) return JAVASCRIPT_TYPECODE_STRING;
    else if (str.equals(JAVASCRIPT_TYPE_NUMBER)) return JAVASCRIPT_TYPECODE_NUMBER;
    else if (str.equals(JAVASCRIPT_TYPE_BOOLEAN)) return JAVASCRIPT_TYPECODE_BOOLEAN;
    else if (str.equals(JAVASCRIPT_TYPE_DATE)) return JAVASCRIPT_TYPECODE_DATE;
    else return JAVASCRIPT_TYPECODE_UNKNOWN;
  }
  ...
  static {
    ...
    //      ms_truthMap.put ("True", btrue);      ms_truthMap.put ("False", bfalse);
    ms_truthMap.put("true", true);
    ms_truthMap.put("false", false);
    ms_truthMap.put("t", true);
    ms_truthMap.put("f", false);
    //      ms_truthMap.put ("T", btrue);         ms_truthMap.put ("F", bfalse);
    //      ms_truthMap.put ("YES", btrue);      ms_truthMap.put ("NO", bfalse);
    //      ms_truthMap.put ("Yes", btrue);      ms_truthMap.put ("No", bfalse);
    ms_truthMap.put("yes", true);
    ms_truthMap.put("no", false);
    ms_truthMap.put("y", true);
    ms_truthMap.put("n", false);
    //      ms_truthMap.put ("Y", btrue);         ms_truthMap.put ("N", bfalse);
    ms_truthMap.put("1", true);
    ms_truthMap.put("0", false);
  }
