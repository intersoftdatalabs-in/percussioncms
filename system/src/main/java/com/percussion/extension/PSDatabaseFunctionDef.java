...
public class PSDatabaseFunctionDef implements Cloneable {
  ...
  void fromXml(Element sourceNode, boolean canBeDefault, boolean fromDefault)
    ...
    if ((sTemp == null) || (sTemp.trim().length() == 0) || (sTemp.equals(DRIVER_TYPE_DEFAULT))) {
      if (canBeDefault) {
    ...
    if (el != null) sTemp = PSXmlTreeWalker.getElementData(el);
    ...
    el = walker.getNextElement(PSDatabaseFunctionDefParam.getNodeName(), nextFlags);
    if (el != null) m_params.clear();
    ...
    if (firstChild != null) {
      ...
      el = walker.getNextElement(EL_DESCRIPTION, PSXmlTreeWalker.GET_NEXT_ALLOW_SIBLINGS);
    }
    if (el != null) sTemp = PSXmlTreeWalker.getElementData(el);
    if ((el == null) || (sTemp == null) || (sTemp.trim().length() < 1)) {
      if (!fromDefault) {
  ...
  public void copyFrom(PSDatabaseFunctionDef dbFuncDef) {
    ...
    if (!(dbFuncDef.getName().equalsIgnoreCase(m_name)))
      throw new IllegalArgumentException(
          "Cannot set value of the database function definition ("
              + m_name
  ...
  public Object clone() {
    ...
    return new PSDatabaseFunctionDef(
        getType(), getName(), getDriver(), getBody(), getDescription(), params);
  }
  ...
  public boolean equals(Object obj) {
    ...
    boolean equals = true;
    if (!(obj instanceof PSDatabaseFunctionDef)) equals = false;
    else {
      ...
      else if (!(m_driver.equalsIgnoreCase(other.m_driver))) equals = false;
    }
    return equals;
  }
  ...
  public boolean equalsFull(Object obj) {
    ...
    PSDatabaseFunctionDef other = (PSDatabaseFunctionDef) obj;
    if (!(m_body.equals(other.m_body))) equals = false;
   ...
   */
  public int hashCode() {
    return m_name.toLowerCase().hashCode() + m_type + m_driver.toLowerCase().hashCode();
  }
  ...
  public int hashCodeFull() {
    return hashCode() + m_body.hashCode() + m_params.hashCode() + m_desc.hashCode();
  }
