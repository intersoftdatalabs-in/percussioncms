...
/**
 * PSExtensionProcessingException is thrown by classes implementing IPSRequestPreProcessor and
 * similar extension sub-interfaces to indicate that a processing error occurred.
 *
...
public class PSExtensionProcessingException extends PSException {
   ...
   * @param singleArg the argument to use as the sole argument in the error message
   */
  public PSExtensionProcessingException(String language, int msgCode, Object singleArg) {
   ...
   * @param arrayArgs the array of arguments to use as the arguments in the error message
   */
  public PSExtensionProcessingException(String language, int msgCode, Object[] arrayArgs) {
    this(language, msgCode, arrayArgs, null);
  }

  /**
   * Same as {@link #PSExtensionProcessingException(String, int, Object[])} but allows to specify
   ...
   *     cause is unknown.
   */
  public PSExtensionProcessingException(
      String language, int msgCode, Object[] arrayArgs, Throwable cause) {
   ...
   *
   * @param message message to use in the exception may be <code>null</code> but never empty
