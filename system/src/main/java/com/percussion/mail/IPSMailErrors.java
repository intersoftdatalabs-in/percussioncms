...
/**
 * The IPSMailErrors interface is provided as a convenient mechanism for accessing the various mail
 * related error codes. Mail errors are in the range 3501 - 4000.
 */
