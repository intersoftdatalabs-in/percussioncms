...
public final class PSCalculation
{
   ...
   public static Number numberVerify(Object o)
   {
      ...
      if (o instanceof String) {
         try {
            ...
            throw new IllegalArgumentException("NumberFormatException: numberVerify exception - cannot parse string: " + o, e);
         }
      }
      ...
      if (o instanceof PSTextLiteral) {
         ...
         try {
            ...
            throw new IllegalArgumentException("NumberFormatException: numberVerify exception - cannot parse PSTextLiteral: " + text, e);
         }
      }

      // The rest of data types are not numbers, even Date and Boolean
      throw new IllegalArgumentException("numberVerify exception: input is not a number related object: " + o.getClass().getSimpleName());
   }
   ...
   {
      return performBinaryOperation(o1, o2, (a, b) -> {
         if (b == 0.0) {
    ...
    */
   private static Double performBinaryOperation(Object o1, Object o2,
                                               ...
                                               String operationName)
   {
      ...
      if (o1 == null || o2 == null) {
         throw new IllegalArgumentException("PSCalculation/" + operationName + " exception: null parameter(s)");
      }
      ...
      try {
         ...
         throw new IllegalArgumentException("PSCalculation/" + operationName + " exception: " + e.getMessage(), e);
      }
   }
