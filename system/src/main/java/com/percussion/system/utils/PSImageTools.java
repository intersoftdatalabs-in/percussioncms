...
public class PSImageTools {
   ...
   */
  public static BufferedImage getImageInformation(IPSRequestContext request, String casUrl)
      throws IOException, PSInternalRequestCallException {
     ...
     */
    IPSInternalRequest imageReq = request.getInternalRequest(casUrl, null, false);
