...
public class PSFormatVersion {
  ...
  public PSFormatVersion(String packageName) {
    ...
    if (!(bundle == null)) {
      ...
      m_interfaceVersion = (Integer.parseInt(bundle.getString(KEY_INTERFACE_VERSION)));
  ...
  public PSFormatVersion(Class clazz, String path) {
    ...
    m_interfaceVersion = (Integer.parseInt(props.getProperty(KEY_INTERFACE_VERSION)));
  ...
  protected ResourceBundle getResources(String packageName) {
    try {
      if (m_res == null)
        m_res = ResourceBundle.getBundle(packageName + ".Version", Locale.getDefault());
  ...
  public Element toXml(Document doc) {
    ...
    root.setAttribute(KEY_INTERFACE_VERSION, Integer.toString(m_interfaceVersion));
  ...
  private String getAttribute(PSXmlTreeWalker tree, String attrName, boolean required, String def)
    ...
    if (attrName == null) throw new IllegalArgumentException("attrName cannot be null");
