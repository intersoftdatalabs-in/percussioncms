...
public class PSHttpUtils extends PSBaseHttpUtils {
  ...
  public static String getRequestorOS(IPSRequestContext request) {
    ...
    Object userAgentObj = request.getCgiVariable(IPSCgiVariables.CGI_REQUESTOR_SOFTWARE);
    if (userAgentObj != null) {
      ...
      if (userAgent.indexOf("windows") != -1 || userAgent.indexOf("winnt") != -1) {
    ...
    if (returnValue == null) returnValue = OS_OTHER;
