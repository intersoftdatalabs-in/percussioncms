...
public class PSSessionCheckServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    long warning = warning_s > 0 ? PSServer.getServerConfiguration().getUserSessionWarning() : -1;
    ...
    try {
      ...
      log.error(
          "Invalid json object for sessioncheck. Error: {}", PSExceptionUtils.getMessageForLog(e));
