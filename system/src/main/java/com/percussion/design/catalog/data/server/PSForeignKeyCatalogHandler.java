...
public class PSForeignKeyCatalogHandler
  ...
  public void processRequest(PSRequest request) {
    ...
    root = PSXmlDocumentBuilder.createRoot(retDoc, "PSXForeignKeyCatalogResults");
    ...
    try {
      ...
      ResultSet rs = meta.getImportedKeys(detail.getDatabase(), detail.getOrigin(), table);
      if (rs != null) {
        while (rs.next()) {
          ...
          colNode = PSXmlDocumentBuilder.addEmptyElement(retDoc, root, "ForeignKey");

          PSXmlDocumentBuilder.addElement(retDoc, colNode, "name", locCol);

          colNode = PSXmlDocumentBuilder.addEmptyElement(retDoc, colNode, "ExternalColumn");

          PSXmlDocumentBuilder.addElement(retDoc, colNode, "tableName", impTable);

          PSXmlDocumentBuilder.addElement(retDoc, colNode, "columnName", impCol);
        }
