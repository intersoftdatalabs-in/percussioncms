 ...
 * com.percussion.design.catalog.system.PSMimeTypeCatalogHandler}. See that class for more info.
 */
public class PSMimeTypeCatalogHandler extends PSCatalogRequestHandler
  ...
  public void processRequest(PSRequest request) {
    ...
    for (String mimetype : mimetypes) {
      Element mtEl = PSXmlDocumentBuilder.addEmptyElement(doc, root, "mimetype");
