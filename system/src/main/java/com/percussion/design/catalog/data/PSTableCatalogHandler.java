 ...
 *
 * <p>Table catalog requests are sent to the server using the PSXTableCatalog XML document. Its
 ...
 * </pre>
 *
 * The PSXTableCatalogResults XML document is sent as the response. Its definition is as follows:
 *
 * <pre>
