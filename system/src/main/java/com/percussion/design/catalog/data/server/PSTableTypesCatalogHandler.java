 ...
 * com.percussion.design.catalog.data.PSTableTypesCatalogHandler
...
public class PSTableTypesCatalogHandler
  ...
  public void processRequest(PSRequest request) {
    ...
    root = PSXmlDocumentBuilder.createRoot(retDoc, "PSXTableTypesCatalogResults");
    ...
    try {
      ...
      if (rs != null) {
        while (rs.next()) {
          node = PSXmlDocumentBuilder.addEmptyElement(retDoc, root, "TableType");
