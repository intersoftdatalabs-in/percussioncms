...
/**
 * The IPSCatalogHandler interface must be implemented by all catalog request handlers. Each type of
 * catalog request has its own handler. The handler must construct the appropriate request from the
