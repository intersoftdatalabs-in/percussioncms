...
public class PSExtensionCatalogHandler extends PSCatalogRequestHandler
  ...
  public void processRequest(PSRequest request) {
    ...
    try {
      Iterator extensions =
          m_extensionMgr.getExtensionNames(
      ...
      if (StringUtils.isBlank(interfacePattern) || interfacePattern.equals(JEXL_INTERFACE)) {
        Collection<IPSExtensionDef> veldefs = PSJexlExtensionHelper.getVelocityTools();
  ...
  private static final String JEXL_INTERFACE = "com.percussion.extension.IPSJexlExpression";
}
