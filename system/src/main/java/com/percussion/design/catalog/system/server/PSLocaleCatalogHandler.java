 ...
 * com.percussion.design.catalog.system.PSLocaleCatalogHandler}. See that class for more info.
 */
public class PSLocaleCatalogHandler extends PSCatalogRequestHandler
  ...
  public void processRequest(PSRequest request) {
    ...
    try {
      ...
      while (locales.hasNext()) {
        Element locEl = PSXmlDocumentBuilder.addEmptyElement(doc, root, "locale");

        PSXmlDocumentBuilder.addElement(
            doc, locEl, "languageString", locales.next().getLanguageString());
      }
