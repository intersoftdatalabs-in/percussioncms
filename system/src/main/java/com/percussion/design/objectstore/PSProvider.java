...
public class PSProvider extends PSComponent {
  ...
  public void setClassName(String className) {
    ...
    if (className.length() == 0) throw new IllegalArgumentException("className cannot be null");
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List<IPSComponent> parentComponents)
    ...
    setType(getEnumeratedAttribute(tree, PROVIDER_TYPE_ATTR, TYPE_ENUM));
  ...
  public Element toXml(Document doc) {
    ...
    if (m_reference != null) root.appendChild(m_reference.toXml(doc));
