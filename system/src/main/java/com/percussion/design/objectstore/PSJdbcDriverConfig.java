...
public class PSJdbcDriverConfig extends PSComponent {
  ...
  public PSJdbcDriverConfig(String driverName, String className, String containerTypeMapping) {
    ...
    if (StringUtils.isBlank(containerTypeMapping))
      throw new IllegalArgumentException("containerTypeMapping may not be null or empty");
  ...
  public void copyFrom(PSComponent obj) {
    ...
    if (!(obj instanceof PSJdbcDriverConfig))
      throw new IllegalArgumentException("obj must be instance of PSJdbcDriverConfig");
  ...
  public void fromXml(
    ...
    m_driverName = PSXMLDomUtil.checkAttribute(sourceNode, DRIVER_NAME_ATTR, true);
    m_className = PSXMLDomUtil.checkAttribute(sourceNode, CLASS_NAME_ATTR, true);
    m_containerTypeMapping = PSXMLDomUtil.checkAttribute(sourceNode, TYPE_MAPPING_ATTR, true);
  }
  ...
  public void setContainerTypeMapping(String typeMapping) {
    if (StringUtils.isBlank(typeMapping))
      throw new IllegalArgumentException("typeMapping may not be null or empty");
