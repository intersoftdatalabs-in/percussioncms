...
/**
 * The PSGlobalSubject class defines a subject (group or user) to be stored in the global context.
 * This extension of <code>PSSubject</code> is responsible for persisting the subject data to the
 * back end database. See {@link #toXml(Document) toXml} for a more complete definition of this
 * class.
 *
 * @see PSSubject
 */
public class PSGlobalSubject extends PSSubject {
   ...
   *
   * @return A new subject with all of the same internal properties, but with no attributes.
   */
   ...
   * </code></pre>
   *
   * see {@link PSDatabaseComponent#toDatabaseXml} for information about this methods parameters and
   * exceptions.
   */
