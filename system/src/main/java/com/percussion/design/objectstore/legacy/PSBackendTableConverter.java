...
public class PSBackendTableConverter extends PSBaseComponentConverter {
  ...
  private String resolveToDatasource(PSLegacyBackEndTable oldBeTable)
    ...
    String ds =
        resolveToDatasource(
            oldBeTable.getDriver(),
            oldBeTable.getServer(),
            oldBeTable.getDatabase(),
            oldBeTable.getOrigin());
    return ds;
  }
   ...
   */
  private void copyFrom(PSBackEndTable convertedObj, PSLegacyBackEndTable oldBeTable) {
