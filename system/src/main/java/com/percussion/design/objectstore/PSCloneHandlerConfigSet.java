...
public class PSCloneHandlerConfigSet extends PSCollectionComponent implements IPSConfig {
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List<IPSComponent> parentComponents)
    ...
    try {
      ...
      node = tree.getNextElement(PSCloneHandlerConfig.XML_NODE_NAME, firstFlags);
      while (node != null) {
        PSCloneHandlerConfig config =
            new PSCloneHandlerConfig((Element) tree.getCurrent(), parentDoc, parentComponents);
        ...
        node = tree.getNextElement(PSCloneHandlerConfig.XML_NODE_NAME, nextFlags);
      }
    } finally {
