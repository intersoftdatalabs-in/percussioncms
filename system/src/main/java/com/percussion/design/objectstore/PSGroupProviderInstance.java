...
public abstract class PSGroupProviderInstance extends PSComponent
  ...
  public final Element toXml(Document doc) {
    ...
    root.setAttribute(TYPE_ATTR, PSSecurityProvider.getSecurityProviderTypeString(m_type));
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PSGroupProviderInstance)) isMatch = false;
    else {
      PSGroupProviderInstance other = (PSGroupProviderInstance) obj;
      if (!super.equals(other)) isMatch = false;
      else if (!this.m_className.equals(other.m_className)) isMatch = false;
      else if (!this.m_name.equals(other.m_name)) isMatch = false;
      else if (this.m_type != other.m_type) isMatch = false;
    }
  ...
  @Override
  public int hashCode() {
    return super.hashCode() + m_name.hashCode() + m_className.hashCode() + m_type;
  }
