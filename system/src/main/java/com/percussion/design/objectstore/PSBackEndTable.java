...
public class PSBackEndTable extends PSComponent {
  ...
  public PSBackEndTable(
    ...
    if (converter != null && converter.isForcedConversion()) {
      PSBackEndTable convertedTable = (PSBackEndTable) converter.convertComponent(sourceNode);
  ...
  public int hashCode() {
    ...
    if (null != m_dataSource) hash += m_dataSource.hashCode();
  ...
  public boolean equals(Object o) {
    if (!(o instanceof PSBackEndTable)) return false;
    ...
    if (m_dataSource == null || other.m_dataSource == null) {
      if (m_dataSource != null || other.m_dataSource != null) return false;
    } else if (!m_dataSource.equals(other.m_dataSource)) return false;
  ...
  public boolean isSameDatasource(PSBackEndTable secondTable) {
    ...
    return StringUtils.equals(getDataSource(), secondTable.getDataSource());
  }
