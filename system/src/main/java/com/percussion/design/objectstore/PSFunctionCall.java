...
public class PSFunctionCall extends PSNamedReplacementValue
  ...
  public PSFunctionParamValue[] getParamValues() {
    PSFunctionParamValue[] retArray = new PSFunctionParamValue[m_params.size()];
  ...
  public PSDatabaseFunctionDef getDatabaseFunctionDef() {
    if (m_dbFuncDef == null)
      throw new IllegalStateException("Function call has not been initialized.");
  ...
  public void fromXml(
    ...
    try {
      ...
      if (nameEl != null) sTemp = PSXmlTreeWalker.getElementData(nameEl);
      ...
      while (paramEl != null) {
        ...
        paramEl = tree.getNextElement(PSFunctionParamValue.NODE_NAME, nextFlags);
      }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PSFunctionCall)) return false;

    boolean equals = true;
    PSFunctionCall other = (PSFunctionCall) obj;
    if (!m_dbFuncName.equalsIgnoreCase(other.m_dbFuncName)) equals = false;
    else if (!compare(m_params, other.m_params)) equals = false;
  ...
  public String getDriver() {
    ...
    if ((driver == null) && (m_parentComponents != null) && (!m_parentComponents.isEmpty())) {
      ...
      if (whereClause != null) {
        ...
        if (repVar != this) driver = getDriver(repVar);

        if (driver == null) {
          IPSReplacementValue repVal = whereClause.getValue();
          if (repVal != this) driver = getDriver(repVal);
        }
      }
    }
    ...
    if (driver == null) {
      ...
      try {
        ...
        // this is fatal
        RuntimeException re =
            new RuntimeException("Cannot determine driver type: " + e.getLocalizedMessage());
  ...
  private String getDriver(IPSReplacementValue repVal) {
    ...
    if ((repVal != null) && (repVal instanceof PSFunctionCall)) {
    ...
    if ((repVal != null) && (repVal instanceof PSBackEndColumn)) {
      PSBackEndTable table = ((PSBackEndColumn) repVal).getTable();
      driver = getDriverFromTable(table);
    }
    if ((driver != null) && (driver.trim().length() < 1)) driver = null;
