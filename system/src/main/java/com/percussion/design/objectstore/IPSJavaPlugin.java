...
public interface IPSJavaPlugin extends IPSComponent {
  ...
  public static final String VERSIONING_TYPE_STATIC = "static";
  public static final String VERSION_STATIC = "jpi-version";

  public static final String VERSIONING_TYPE_DYNAMIC = "dynamic";
  ...
  /** DTD constant. */
  public static final String XML_NODE_NAME = "PSXJavaPlugin";

  /** DTD constant. */
  public static final String ATTR_OSKEY = "oskey";

  /** DTD constant. */
  public static final String ATTR_BROWSERKEY = "browserkey";

  /** DTD constant. */
  public static final String ATTR_VERSIONTOUSE = "versiontouse";

  /** DTD constant. */
  public static final String ATTR_VERSIONINGTYPE = "versioningtype";

  /** DTD constant. */
  public static final String ATTR_DOWNLOADLOCATION = "downloadlocation";
}
