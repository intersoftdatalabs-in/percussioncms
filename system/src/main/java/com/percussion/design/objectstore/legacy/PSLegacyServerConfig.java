...
public class PSLegacyServerConfig extends PSServerConfiguration {
  ...
  public void fromXml(Document sourceDoc)
    ...
    if (tree.getNextElement("Performance", firstFlags) != null) {
      ...
      if (sTemp == null) m_maxThreadsPerApp = 0;
      else {
        try {
      ...
      if (sTemp == null) m_minThreadsOnServer = 0;
      else {
        try {
      ...
      if (sTemp == null) m_maxThreadsOnServer = 0;
      else {
        try {
      ...
      if (sTemp == null) m_idleThreadTimeout = 0;
      else {
        try {
      ...
      if (sTemp == null) m_maxRequestsInQueuePerApp = 0;
      else {
        try {
      ...
      if (sTemp == null) m_maxRequestsInQueueOnServer = 0;
      else {
        try {
    ...
    if (authentications != null) {
      ...
      while (authentication != null) {
        m_authentications.add(new PSAuthentication(authentication, this, null, true));
