...
public interface IPSObjectStoreLockManager {
   ...
   */
  public Object getLockKey(Object lockOb, int lockType) throws PSIllegalArgumentException;

  /**
   * Returns the uniquely identifying lock key for this object under the given type of lock,
   * throwing an exception if no lock key can be found for this object or if the lock type is not
   * supported.
   *
   * @author chad loder
   * @version 1.0 1999/6/18
