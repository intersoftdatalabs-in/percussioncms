...
public class PSLegacyTableLocator extends PSComponent {
  ...
  public Element toXml(Document doc) {
    ...
    if (m_database != null) PSXmlDocumentBuilder.addElement(doc, root, DATABASE_ELEM, m_database);

    // OPTIONAL: create the origin
    if (m_origin != null) PSXmlDocumentBuilder.addElement(doc, root, ORIGIN_ELEM, m_origin);
