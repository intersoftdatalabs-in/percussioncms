...
public class PSLoginWebPage extends PSComponent {
  ...
  public Element toXml(Document doc) {
    ...
    if (m_url == null) PSXmlDocumentBuilder.addElement(doc, root, "url", "");
    else PSXmlDocumentBuilder.addElement(doc, root, "url", m_url.toExternalForm());
  ...
  public boolean equals(Object o) {
    if (!(o instanceof PSLoginWebPage)) return false;

    PSLoginWebPage other = (PSLoginWebPage) o;

    if (m_isSecure != other.m_isSecure) return false;
  ...
  @Override
  public int hashCode() {
    return Boolean.valueOf(isSecure()).hashCode() + (getUrl() == null ? 0 : getUrl().hashCode());
  }
