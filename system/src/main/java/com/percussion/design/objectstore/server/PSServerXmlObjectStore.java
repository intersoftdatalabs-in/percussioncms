...
public class PSServerXmlObjectStore extends PSObjectFactory {
   ...
   */
  public static synchronized PSServerXmlObjectStore createInstance(PSXmlObjectStoreHandler os) {
    // make sure this hasn't already been created.
    if (ms_objectStore != null)
      throw new IllegalStateException("PSServerXmlObjectStore already created.");
  ...
  public static synchronized PSServerXmlObjectStore getInstance() {
    ...
    if (ms_objectStore == null)
      throw new IllegalArgumentException("PSServerXmlObjectStore not yet created.");
  ...
  public static class RecoverableFile {
    ...
    void renameSrcToBackup() throws PSException {
      ...
      String errorMsg =
          "failed to make backup for '" + m_src.getAbsolutePath() + "' file/directory.";
      log.error(errorMsg);
  ...
  public PSApplication getApplicationObject(String appName, PSSecurityToken tok)
    ...
    if (appName == null) throw new IllegalArgumentException("appName may not be null");
  ...
  public PSApplication getApplicationObject(IPSLockerId lockId, String appName, PSSecurityToken tok)
      throws PSServerException, PSNotFoundException, PSLockedException, PSNotLockedException,
          PSAuthorizationException {
    // validate params
    if (lockId == null) throw new IllegalArgumentException(LOCKID_NOT_NULL_ERROR);
   ...
   */
  public PSApplication getApplicationObject(
      IPSLockerId lockId, String appName, PSSecurityToken tok, boolean fixupCeFields)
      throws PSServerException, PSNotFoundException, PSLockedException, PSNotLockedException,
          PSAuthorizationException {
    // validate params
    if (lockId == null) throw new IllegalArgumentException(LOCKID_NOT_NULL_ERROR);
  ...
  public Iterator<File> getAppRootFileList(String appRoot, boolean includeDirs, boolean recurse)
    ...
    if (appDir.exists() && appDir.isDirectory()) {
      ...
      for (File file : fileList) {
        ...
        if (sepPos > -1) tmpPath = tmpPath.substring(sepPos + 1);
  ...
  public InputStream getApplicationFile(String appName, File appFile, PSSecurityToken tok)
    ...
    if (appFile == null) throw new IllegalArgumentException(APPFILE_NOTNULL_ERROR);
    ...
    try {
      ...
      return new ByteArrayInputStream(tmpOut.toByteArray());
   ...
   * @throws PSServerException If any other errors occur.
   */
  public boolean saveApplicationFile(
      String appName,
      File appFile,
      InputStream in,
      boolean overWrite,
      IPSLockerId lockId,
      PSSecurityToken tok)
      throws PSAuthorizationException, PSNotFoundException, PSNotLockedException, PSLockedException,
          PSServerException {
    return saveApplicationFile(appName, appFile, in, overWrite, lockId, tok, false);
  }
   ...
   * @throws PSServerException If any other errors occur.
   */
  public boolean removeApplicationFile(
      PSApplication app, File appFile, IPSLockerId lockId, PSSecurityToken tok)
      throws PSAuthorizationException, PSNotFoundException, PSNotLockedException, PSLockedException,
          PSServerException {
    if (app == null) throw new IllegalArgumentException("app may not be null or empty");
   ...
   */
  public boolean removeApplicationFile(
      PSApplication app, File appFile, IPSLockerId lockId, PSSecurityToken tok, boolean dontLockApp)
      throws PSAuthorizationException, PSNotFoundException, PSNotLockedException, PSLockedException,
          PSServerException {
    if (app == null) throw new IllegalArgumentException("app may not be null or empty");
  ...
  private List<File> catalogFiles(String dirName, boolean includeDirs, boolean recurse) {
    ...
    if (dir.isDirectory()) {
      ...
      if (files != null) {
        for (File value : files) {
          ...
          if (value.isFile()) retFiles.add(file);
          else dirFiles.add(file);
        }
      }
    }
    ...
    if (recurse && !dirFiles.isEmpty()) {
      for (File subDir : dirFiles) {
        retFiles.addAll(catalogFiles(subDir.getPath(), includeDirs, recurse));
      }
    }
    if (includeDirs) retFiles.addAll(dirFiles);
    return retFiles;
  }
  ...
  public void saveApplication(
      ...
      throws PSServerException, PSNotLockedException, PSSystemValidationException,
          PSUnknownDocTypeException, PSUnknownNodeTypeException, IOException, PSLockedException,
          PSNonUniqueException, PSAuthorizationException, PSNotFoundException {
    // validate inputs
    if (appDoc == null) throw new IllegalArgumentException("appDoc may not be null");
  ...
  public boolean deleteApplication(String appName, IPSLockerId lockId, PSSecurityToken tok)
      throws PSAuthorizationException, PSNotFoundException, PSServerException, PSNotLockedException,
          PSLockedException {
    ...
    if (appId != 0) deleted = deleteApplication(appId, lockId, tok);
   ...
   * @throws PSServerException If any other errors occur.
   */
  public boolean deleteApplication(int appId, IPSLockerId lockId, PSSecurityToken tok)
      throws PSAuthorizationException, PSNotFoundException, PSServerException, PSNotLockedException,
          PSLockedException {
    if (lockId == null) throw new IllegalArgumentException(LOCKID_NOT_NULL_ERROR);
  ...
  public void saveApplication(
      ...
      throws PSServerException, PSNotLockedException, PSSystemValidationException, IOException,
    ...
    if (curSum != null) {
      ...
      if (!curName.equals(app.getName())) renameApp = true;
      if (!curRoot.equals(app.getRequestRoot())) renameRoot = true;
    } else {
      isNewApp = true;
    }
    ...
    try {
      if (renameApp) {
        curAppFile = new RecoverableFile(m_objectStoreHandler.getApplicationFile(curName));
      }
       ...
       */
      if (renameRoot) {
        m_objectStoreHandler.removeVirtualAppDirectory(curSum.getAppRoot());
      }
      ...
      if (isNewApp || app.getId() < 1) {
        synchronized (appSums) {
          ...
          if (reqRoot != null && reqRoot.length() > 0) {
            ...
            m_objectStoreHandler.addVirtualAppDirectory(reqRoot, getAppRootDir(reqRoot));
          }

          com.percussion.server.PSConsole.printMsg(
              "ObjectStore",
              "Allocated application ID: " + id + " for application " + app.getName(),
              null);
        }
      }

      // finally, write it to the disk file
      OutputStream fout = new BufferedOutputStream(m_objectStoreHandler.lockOutputStream(appFile));
      try {
      ...
      synchronized (appSums) {
        ...
        if (renameRoot || renameApp) {
          ...
          if (renameRoot) {
            ...
            // do it now
            if (!renameApp) curSum.setAppRoot(app.getRequestRoot());
          }
      ...
      if (!success) {
        ...
        if (curAppFile != null) curAppFile.recover();
        if (curAppRoot != null) curAppRoot.recover();
      }
    }
  }
  ...
  public PSServerConfiguration getServerConfigObject(PSSecurityToken tok) throws PSServerException {
    ...
    try {
      ...
      throw new PSServerException(
          ne.getClass().toString(), ne.getErrorCode(), ne.getErrorArguments());
    }
  ...
  public PSServerConfiguration getServerConfigObject(IPSLockerId lockId, PSSecurityToken tok)
      throws PSNotLockedException, PSServerException, PSLockedException, PSAuthorizationException {
    // validate params
    if (lockId == null) throw new IllegalArgumentException(LOCKID_NOT_NULL_ERROR);
  ...
  public void saveRoleConfiguration(
      PSRoleConfiguration config, IPSLockerId lockId, PSSecurityToken tok)
      throws PSNotLockedException, PSServerException, PSLockedException, PSAuthorizationException {
    // validate inputs
    ...
    try {
      ...
      IPSInternalRequestHandler rh =
          PSServer.getInternalRequestHandler("sys_components/UpdateRoleCfg");

      data = rh.makeInternalRequest(req);
    } catch (PSInternalRequestCallException | PSDatabaseComponentException ire) {
      throw new PSServerException(ire.getErrorCode(), ire.getErrorArguments());
    } catch (PSAuthenticationFailedException afe) {
      throw new PSAuthenticationRequiredException(afe.getErrorCode(), afe.getErrorArguments());
    } finally {
  ...
  public void saveServerConfig(
      PSServerConfiguration config, IPSLockerId lockId, PSSecurityToken tok)
    ...
    try {
      // validate the config
      PSValidatorAdapter validator = new PSValidatorAdapter(m_objectStoreHandler);
      ...
      OutputStream fout = new BufferedOutputStream(m_objectStoreHandler.lockOutputStream(cfgFile));
      try {
   ...
   * @throws PSServerException for any other errors encountered.
   */
  public void saveServerConfig(Document config, IPSLockerId lockId, PSSecurityToken tok)
    ...
    if (lockId == null) throw new IllegalArgumentException("lockId cannot be null.");
  ...
  public void getApplicationLock(IPSLockerId id, String appName, int lockMins)
    ...
    if (lockMins < 0) throw new IllegalArgumentException("lockMins must be a non-negative number");

    try {
      Object lockKey =
          m_objectStoreHandler.m_lockMgr.getLockKey(
              PSObjectFactory.createApplication().getClass(),
              appName,
      ...
      boolean acquired =
          m_objectStoreHandler.m_lockMgr.acquireLock(
              id,
              lockKey,
              lockMins * 60000L, // convert minutes to milliseconds
              0, // don't time out
              ex);
   ...
   */
  public void releaseApplicationLock(IPSLockerId id, String appName) throws PSServerException {
    if (id == null) throw new IllegalArgumentException(ID_NOT_NULL_ERROR);
  ...
  public void getServerConfigLock(IPSLockerId id, int lockMins)
    ...
    m_objectStoreHandler.printMsg("Locking server configuration for " + lockMins + " minutes");
  ...
  public void checkCanReadApplication(String appName, PSSecurityToken tok, boolean isEditing)
    ...
    try {
      ...
      // get app aclhandler
      PSAclHandler aclHandler = m_objectStoreHandler.loadAclHandler(appName);

      // see if user has required acess to read
      int appAccessLevel = aclHandler.getUserAccessLevel(tok);

      if ((PSAclEntry.AACE_DESIGN_READ & appAccessLevel) != PSAclEntry.AACE_DESIGN_READ)
        throw new PSAuthorizationException("read application", appName, tok.getUserSessionId());

      if (isEditing) {
        // must have update and delete
        if ((PSAclEntry.AACE_DESIGN_UPDATE & appAccessLevel) != PSAclEntry.AACE_DESIGN_UPDATE)
          throw new PSAuthorizationException("edit application", appName, tok.getUserSessionId());
      }
    } catch (PSNotFoundException e) {
      throw new PSServerException(e);
    }
  ...
  public void checkCanSaveApplication(PSApplication app, PSSecurityToken tok)
      throws PSAuthorizationException, PSAuthenticationRequiredException, PSNotFoundException,
          PSServerException {
    if (app == null) throw new IllegalArgumentException("app may not be null.");
    ...
    boolean isNewApp = false;
    PSApplicationSummary sum = m_objectStoreHandler.m_appSums.getSummary(app.getId());
    if (sum == null) {
    ...
    if (isNewApp) {
      ...
      if ((PSAclEntry.AACE_DESIGN_MODIFY_ACL & appAccessLevel)
        ...
        try {
          ...
          throw new PSAuthorizationException(
              "AclModificationCheck", curAppName, tok.getUserSessionId());
        }
        if (!newAcl.getEntries().equals(oldAcl.getEntries()))
          throw new PSAuthorizationException("AclModification", curAppName, tok.getUserSessionId());
      }
    }
  }
  ...
  private PSServerXmlObjectStore(PSXmlObjectStoreHandler os) {
    if (os == null) throw new IllegalArgumentException("os may not be null");
   ...
   * @throws PSServerException for any other errors encountered.
   */
  private PSApplication loadApplicationObject(String appName, boolean fixupCeFields)
      throws PSServerException, PSNotFoundException {
    if (appName == null) throw new IllegalArgumentException("appName may not be null");
  ...
  private void clearElementsByTagName(Element rootElement, String tagName) {
    if (rootElement == null) throw new IllegalArgumentException("rootElement may not be null.");
    if (tagName == null) throw new IllegalArgumentException("tagName may not be null.");
   ...
   * @throws PSServerException for any other errors encountered.
   */
  PSAclHandler loadAclHandler(PSApplication app) throws PSNotFoundException, PSServerException {
    if (app == null) throw new IllegalArgumentException("app may not be null");

    String appName = m_objectStoreHandler.getApplicationNameFromId(app.getId());

    if (appName == null) appName = app.getName();
    ...
    try {
      ...
      if (isModifedOnDisk) {
        ...
        try {
          ...
          Document cfgDoc = PSXmlDocumentBuilder.createXmlDocument(in, false);
          ...
          PSContainerLocator loc = m_contentEditorSystemDef.getSystemLocator();
          if (null != fs && null != loc) {
  ...
  public void saveContentEditorSystemDef(PSContentEditorSystemDef def) throws IOException {
    ...
    try {
      ...
      if (out != null) {
        try {
          m_objectStoreHandler.releaseOutputStream(out, m_cfgFileSystemDef);
        } catch (IOException e) {
        }
      }
    }
  ...
  public PSContentEditorSharedDef getContentEditorSharedDef()
    ...
    for (int i = 0; i < defs.length; i++) {
      ...
      if (m_SharedDefFilesAndModifedDates.containsKey(curFilePath)) {
        PSPair timeAndSize = m_SharedDefFilesAndModifedDates.get(curFilePath);
        dateTime = (Long) timeAndSize.getFirst();
        size = (Long) timeAndSize.getSecond();
        if (dateTimeCurrent != dateTime || size != sizeCurrent) {
          m_SharedDefFilesAndModifedDates.put(
              curFilePath, new PSPair(curFile.lastModified(), curFile.length()));
    ...
    if (m_contentEditorSharedDef != null) {
      ...
      while (fgIter.hasNext()) {
        ...
        filesInDef.add(new File(m_cfgDirShared, fg.getFilename()).getPath());
      }
    ...
    if (!isModifiedOnDisk && m_contentEditorSharedDef != null) return m_contentEditorSharedDef;
    /*
    ...
    for (File def : defs) {
      ...
      PSContentEditorSharedDef tmpDef = getContentEditorSharedDef(def.getName());

      // merge it into the def to return
      if (resultDef == null) resultDef = tmpDef;
      else {
        // first copy app flow
        ...
        if (resAppFlow != null) {
          if (curAppFlow != null) {
            ...
            while (flows.hasNext()) {
              ...
              PSCollection coll = new PSCollection(curAppFlow.getRedirects(name));
              resAppFlow.addRedirects(name, coll);
            }
          }
        } else if (curAppFlow != null) resultDef.setApplicationFlow(curAppFlow);
        ...
        } else if (curFields != null) resultDef.setFieldGroups(curFields);

        // copy stylesheets
        PSCommandHandlerStylesheets resSheets = resultDef.getStylesheetSet();
        ...
        if (resSheets != null) {
          if (curSheets != null) {
            ...
            while (sheets.hasNext()) {
              ...
              resSheets.addStylesheets(name, new PSCollection(curSheets.getStylesheets(name)));
            }
          }
        } else if (curSheets != null) resultDef.setStylesheetSet(curSheets);
      }
  ...
  public PSContentEditorSharedDef getContentEditorSharedDef(String fileName)
      throws IOException, SAXException, PSUnknownDocTypeException, PSUnknownNodeTypeException {
    if (fileName == null) throw new IllegalArgumentException("fileName may not be null");
    ...
    try {
      ...
      if (def.getApplicationFlow() != null) def.getApplicationFlow().setFilename(fileName);

      if (def.getStylesheetSet() != null) def.getStylesheetSet().setFilename(fileName);
    ...
    FileFilter filter =
        new FileFilter() {
          public boolean accept(File f) {
            return (f.isFile()
                && f.canRead()
                && f.getName().length() > XML_FILE_EXTENSION.length()
                && f.getName().toLowerCase().endsWith(XML_FILE_EXTENSION));
          }
        };
  ...
  public void saveContentEditorSharedDefFile(PSContentEditorSharedDef sharedDef, String name)
      throws IOException {
    if (sharedDef == null) throw new IllegalArgumentException("sharedDef may not be null");

    if (name == null || name.trim().length() == 0)
      throw new IllegalArgumentException("name may not be null or empty");

    if (!name.endsWith(".xml")) throw new IllegalArgumentException("invalid name");
   ...
   */
  public void saveContentEditorSharedDefFile(PSContentEditorSharedDef def) throws IOException {
    if (def == null) throw new IllegalArgumentException("def may not be null");
    ...
    Iterator fieldGroups = def.getFieldGroups();
    while (fieldGroups.hasNext()) {
      PSSharedFieldGroup fieldGroup = (PSSharedFieldGroup) fieldGroups.next();
    ...
    for (File f : existing) {
      ...
      if (!newFiles.contains(f.getName())) {
        ...
        if (!defFile.delete()) {
          PSConsole.printMsg("ObjectStore", "Failed to delete the shared def file: " + f.getName());
        }
      }
    }
  }
  ...
  public PSApplicationSummary[] getApplicationSummaryObjects(
    ...
    synchronized (m_objectStoreHandler.m_appSums) {
      PSApplicationSummary[] sums = m_objectStoreHandler.m_appSums.getSummaries();
      for (PSApplicationSummary sum : sums) {
        if (!showHiddenApps && sum.isHidden()) continue;

        try {
          if (!isServerAdmin) checkCanReadApplication(sum.getName(), tok, false);
          retSums.add(sum);
        } catch (Exception e) {
    ...
    PSApplicationSummary[] retArray = new PSApplicationSummary[retSums.size()];
    if (!retSums.isEmpty()) {
  ...
  public static void fixupFields(
      ...
      throws SQLException {
    if (null == fs) throw new IllegalArgumentException("Fieldset must be supplied.");
    if (null == tableSets) throw new IllegalArgumentException("Table sets must be supplied.");
    ...
    for (PSField psField : allFields) {
      if (psField.getLocator() instanceof PSBackEndColumn) beFields.add(psField);
      else {
        // set the data type if we know it, otherwise, leave blank
        if (psField.getLocator() instanceof PSDateLiteral) psField.setDataType(PSField.DT_DATETIME);
          ...
          PSExtensionParamValue[] params =
              ((PSExtensionCall) psField.getLocator()).getParamValues();
          for (PSExtensionParamValue param : params) {
            if ((null != param) && (param.isBackEndColumn())) {
              PSBackEndColumn col = (PSBackEndColumn) param.getValue();
    ...
    boolean searchEnabled = PSServer.getServerConfiguration().getSearchConfig().isFtsEnabled();
    while (itFields.hasNext()) {
      ...
      for (PSDatabaseMetaData psDatabaseMetaData : dbMeta) {
        ...
        if (tableName == null) tableName = t.getAlias();

        PSMetaDataCache.loadConnectionDetail(t);
        PSTableMetaData tableMeta =
            psDatabaseMetaData.getTableMetaData(t.getConnectionDetail().getOrigin(), tableName);
        if (null != tableMeta) {
          tableMeta.loadDataTypes(col.getTable().getAlias());
          field.fixupDataType(
              tableMeta.getColumnType(colName),
              tableMeta.getSize(colName),
              tableMeta.getScale(colName),
              tableMeta.getTypeName(colName),
              searchEnabled);
        }
      }
    }
    ...
    for (PSField allField : allFields) {
      ...
      if (null == mimeType) {
        ...
        else allField.setMimeType("text/plain");
      }
    }
  }
  ...
  public List<PSCatalogerConfig> getCatalogerConfigs(IPSLockerId lockId, PSSecurityToken tok)
      throws PSAuthorizationException, PSServerException, PSNotLockedException, PSLockedException {
    if (tok == null) throw new IllegalArgumentException(TOK_NOT_NULL_ERROR);

    checkCanEditServerConfig(tok);

    // Check to see if config is locked
    if (lockId != null) extendServerConfigLock(lockId);
  ...
  public void saveCatalogerConfigs(
      List<PSCatalogerConfig> configs, IPSLockerId lockId, PSSecurityToken tok)
      throws PSAuthorizationException, PSServerException, PSNotLockedException, PSLockedException {
    if (configs == null) throw new IllegalArgumentException("resolver may not be null");
  ...
  public List<IPSJndiDatasource> getJndiDatasources(IPSLockerId lockId, PSSecurityToken tok)
      throws PSServerException, PSNotLockedException, PSLockedException, PSAuthorizationException {
    if (tok == null) throw new IllegalArgumentException(TOK_NOT_NULL_ERROR);
  ...
  public void saveJndiDatasources(
      List<IPSJndiDatasource> datasources, IPSLockerId lockId, PSSecurityToken tok)
      throws PSServerException, PSNotLockedException, PSLockedException, PSAuthorizationException {
    if (datasources == null || datasources.isEmpty())
      throw new IllegalArgumentException("datasources may not be null or empty");
    if (lockId == null) throw new IllegalArgumentException(LOCKID_NOT_NULL_ERROR);
    if (tok == null) throw new IllegalArgumentException(TOK_NOT_NULL_ERROR);
    ...
    try {
      DefaultConfigurationContextImpl configContext =
  ...
  public void saveDatasourceConfigs(
      IPSDatasourceResolver resolver, IPSLockerId lockId, PSSecurityToken tok)
      throws PSAuthorizationException, PSServerException, PSNotLockedException, PSLockedException {
    if (resolver == null) throw new IllegalArgumentException("resolver may not be null");
  ...
  public PSHibernateDialectConfig getHibernateDialectConfig(IPSLockerId lockId, PSSecurityToken tok)
    ...
    try {
      ...
      PSSpringConfiguration springConfig = new PSSpringConfiguration(configFile);

      return (PSHibernateDialectConfig)
          springConfig.getBean(PSServletUtils.HIBERNATE_DIALECTS_NAME);
  ...
  public void saveHibernateDialectConfig(
      PSHibernateDialectConfig config, IPSLockerId lockId, PSSecurityToken tok)
      throws PSAuthorizationException, PSServerException, PSNotLockedException, PSLockedException {
