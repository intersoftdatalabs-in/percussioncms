...
/**
 * The IPSObjectStoreHandler interface extends the IPSRequestHandler interface, defining the
 * mechanism by which an object store request should be handled by an object store handler.
 *
...
public interface IPSObjectStoreHandler extends IPSRequestHandler {
   ...
   */
  public abstract PSApplication[] init() throws PSServerException, PSAuthorizationException;
   ...
   *     events
   */
  public abstract void addServerListener(IPSServerConfigurationListener listener)
      throws PSAuthorizationException;
   ...
   * @exception PSAuthorizationException if the user is not permitted to create applications on the
   *     server
   * @exception PSLockedException if another user has acquired the application lock. This usually
   *     occurs if the application was not previously locked or the lock was lost due to a timeout.
   * @exception PSUnknownDocTypeException if doc does not contain the appropriate format for this
   *     request type
   ...
   * @return the XML response document
   * @exception PSServerException if the server is not responding
   * @exception PSAuthorizationException if user does not have designer access to the application
   * @exception PSLockedException if lockApp is <code>true</code> but another user already has the
   *     application locked
   * @exception PSNotFoundException if an application be that name does not exist
   * @exception PSUnknownDocTypeException if doc does not contain the appropriate format for this
   *     request type
   * @see com.percussion.design.objectstore.PSApplication
   */
   ...
   * @exception PSNotFoundException if the configuration information cannot be found
   */
  public abstract PSServerConfiguration getServerConfigurationObject()
      throws PSServerException, PSNotFoundException;

  /**
   * Saves the server configuration information for the specified user to the object store.
   *
   * @param doc the XML document containing the server configuration data
   * @param req the request context (for security)
   * @return the XML response document
   * @throws PSUnknownDocTypeException if doc does not contain the appropriate format for this
   *     request type
   * @throws PSLockedException If the config is already locked by someone else.
   ...
   * @exception PSAuthorizationException if the user is not permitted to create applications on the
   *     server
   * @exception PSLockedException if another user has acquired the server config lock. This usually
   *     occurs if the server config lock was broken or expired.
   * @exception PSUnknownDocTypeException if doc does not contain the appropriate format for this
   *     request type
   * @see com.percussion.design.objectstore.PSServerConfiguration
   */
   ...
   * @exception PSServerException if the server is not responding
   * @exception PSAuthorizationException if the user does not have design access to the server
   */
   ...
   *     empty)
   */
  public abstract PSApplicationSummary[] getApplicationSummaryObjects(PSRequest req);
   ...
   * @return the XML response document
   * @exception PSServerException if the server is not responding
   * @exception PSAuthorizationException if the user does not have delete access to the application
   * @exception PSLockedException if another user has the application locked
   * @exception PSUnknownDocTypeException if doc does not contain the appropriate format for this
   *     request type
   * @see com.percussion.design.objectstore.PSApplication
   */
   ...
   * @return the XML response document
   * @exception PSServerException if the server is not responding
   * @exception PSAuthorizationException if user does not have update access to the application
   * @exception PSLockedException if another user has the application locked
   * @exception PSNonUniqueException if an application with the new name already exists
   * @exception PSNotFoundException if an application with the old name does not exist
   * @exception PSUnknownDocTypeException if doc does not contain the appropriate format for this
   *     request type
   * @see com.percussion.design.objectstore.PSApplication
   */
   ...
   * @return the XML response document
   * @exception PSServerException if the server is not responding
   * @exception PSAuthorizationException if creating a new application, the user does not have
   *     create access on the server. If updating an existing application, the user does not have
   *     update access on the application.
   * @exception PSNotLockedException when updating an existing application and a lock is not
   *     currently held (the timeout already expired or getApplication was not used to lock the
   *     application)
   * @exception PSNonUniqueException if creating an application and an application by the same name
   *     already exists
   * @exception PSSystemValidationException if validate is <code>true</code> and a validation error
   *     is encountered
   * @exception PSUnknownDocTypeException if doc does not contain the appropriate format for this
   *     request type
   * @see com.percussion.design.objectstore.PSApplication
   ...
   * @return the XML response document
   * @exception PSServerException if the server is not responding
   * @exception PSAuthorizationException if user does not have designer access to the server
   * @exception PSUnknownDocTypeException if doc does not contain the appropriate format for this
   *     request type
   ...
   * @exception PSServerException if the server is not responding
   * @exception PSAuthorizationException if user does not have designer access to the server
   * @exception PSAuthenticationFailedException if the user is not authenticated to perform this
   *     command
   * @exception PSUnknownDocTypeException if doc does not contain the appropriate format for this
   *     request type
   ...
   * @exception PSUnknownDocTypeException if doc does not contain the appropriate format for this
   *     request type
   * @exception PSNotFoundException if user configuration information does not exist for the
   *     specified user
   * @see com.percussion.design.objectstore.PSUserConfiguration
   */
   ...
   *
   * @param doc The XML document containing the application file data.
   * @param req the request context (for security)
   * @return The XML response document
   * @exception PSServerException if the server is not responding
