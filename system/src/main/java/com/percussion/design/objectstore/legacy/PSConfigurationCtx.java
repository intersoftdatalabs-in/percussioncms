...
public class PSConfigurationCtx {
  ...
  public PSConfigurationCtx(IPSConfigFileLocator fileLocator, String secretKey)
      throws PSInvalidXmlException, IOException, SAXException, PSMissingApplicationPolicyException,
          PSUnknownDocTypeException, PSUnknownNodeTypeException {
    if (fileLocator == null) throw new IllegalArgumentException("fileLocator may not be null");

    if (StringUtils.isBlank(secretKey))
      throw new IllegalArgumentException("secretkey may not be null or empty");
    ...
    m_springConfig = new PSSpringConfiguration(m_locator.getSpringConfigFile());
  ...
  public void saveConfigs() throws IOException, SAXException {
    ...
    m_springConfig.save();
    DefaultConfigurationContextImpl configurationContext =
