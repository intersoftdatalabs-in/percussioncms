...
public class PSRelationshipPropertyData implements Serializable {
  ...
  public void setRid(int rid) {
    if (rid <= 0) throw new IllegalArgumentException("rid must be > 0.");
  ...
  public boolean equals(Object obj) {
    if (obj == null || !(obj instanceof PSRelationshipPropertyData)) return false;
  ...
  public int hashCode() {
    ...
    return new HashCodeBuilder(13, 3).append(m_propertyName).append(m_propertyValue).toHashCode();
  }
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    m_isPersisted =
        PSXMLDomUtil.checkAttributeBool(
            sourceNode, XML_ATTR_ISPERSISTED, false, PSRelationship.XML_TRUE);
    m_propertyName = PSXMLDomUtil.checkAttribute(sourceNode, XML_ATTR_NAME, true);
  ...
  private static final String XML_NODE_NAME = "Property";
  private static final String XML_ATTR_ISPERSISTED = "persisted";
