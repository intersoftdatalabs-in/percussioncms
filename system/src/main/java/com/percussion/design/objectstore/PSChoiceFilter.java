...
public class PSChoiceFilter extends PSComponent {
  ...
  public static class DependentField extends PSComponent {
     ...
     * @throws PSUnknownNodeTypeException
     */
    public DependentField(Element el) throws PSUnknownNodeTypeException {
    ...
    public boolean equals(Object o) {
      ...
      boolean equal = true;
      if (!compare(m_fieldRef, t.m_fieldRef)) equal = false;
      else if (!compare(m_dependencyType, t.m_dependencyType)) equal = false;
