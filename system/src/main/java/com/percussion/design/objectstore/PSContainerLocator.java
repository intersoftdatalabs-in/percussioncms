...
public final class PSContainerLocator extends PSComponent {
  ...
  public void setTableSets(PSCollection tableSets) {
    ...
    if (!tableSets.getMemberClassName().equals(m_tableSets.getMemberClassName()))
  ...
  public void mergeTableSets(
      ...
      Collection sharedFieldIncludes)
    ...
    if (sharedDef != null) {
      ...
      while (groups.hasNext()) {
        ...
        if (!sharedFieldIncludes.contains(group.getName().toUpperCase())
            && !groupFields.hasMandatorySystemFields()) continue;
  ...
  private void mergeTableSet(PSTableSet source, Map refMap) throws PSSystemValidationException {
    ...
    while (sourceRefs.hasNext()) {
       ...
       */
      PSTableSet targetTableSet = (PSTableSet) refMap.get(sourceRef.getAlias().toUpperCase());
    ...
    while (targetSets.hasNext()) {
      ...
      if (sourceLocator.isSameLocation(targetTableSet.getTableLocation())) {
        ...
        PSCollection targetTableRefs = new PSCollection(targetTableSet.getTableRefs());
