...
public class PSWorkflow extends PSComponent {
  ...
  public Element toXml(Document doc) {
    ...
    if (getDescription() != null)
      PSXmlDocumentBuilder.addElement(doc, root, XML_DESCRIPTION, getDescription());
    if (getAdministrator() != null)
      PSXmlDocumentBuilder.addElement(doc, root, XML_ADMINISTRATOR, getAdministrator());
    if (getInitialState() != NOT_ASSIGNED)
      PSXmlDocumentBuilder.addElement(
          doc, root, XML_INITIAL_STATE, String.valueOf(getInitialState()));
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List<IPSComponent> parentComponents)
    ...
    setInitialState(Integer.parseInt(tree.getElementData(XML_INITIAL_STATE)));
  }
  ...
  private boolean equals(PSWorkflow test) {
    return (getDbId() == test.getDbId())
        ...
        && (PSComponent.compare(getAdministrator(), test.getAdministrator()))
        && (PSComponent.compare(getDescription(), test.getDescription()))
  ...
  public int hashCode() {
    return Objects.hash(
        super.hashCode(), m_name, m_administrator, m_description, m_initialState, m_dbId);
  }
  ...
  public void copyFrom(PSComponent c) {
    super.copyFrom(c);
    if (!(c instanceof PSWorkflow)) throw new IllegalArgumentException("invalid object for copy");
