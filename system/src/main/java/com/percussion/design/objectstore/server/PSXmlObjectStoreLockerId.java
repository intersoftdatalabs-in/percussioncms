...
public class PSXmlObjectStoreLockerId implements IPSLockerId {
  ...
  public void writeTo(Properties props) {
    ...
    if (m_sessionId != null) props.setProperty("sessionId", m_sessionId);
  }
  ...
  public boolean sameId(IPSLockerId other, PSLockedException ex) {
    ...
    boolean sameSession =
        (m_sessionId != null && o.m_sessionId != null && m_sessionId.equals(o.m_sessionId));

    boolean sameUser =
        (m_userName != null && o.m_userName != null && m_userName.equals(o.m_userName));

    if (sameUser) {
      if (sameSession || m_overrideSameUser || o.m_overrideSameUser) return true;
      else {
        if (ex != null) {
