...
public class PSEntry extends PSComponent {
  ...
  public void setSequence(int sequence) {
    if (sequence < 0) m_sequence = -1;
    else m_sequence = sequence;
  }
  ...
  public boolean equals(Object o) {
    ...
    boolean equal = true;
    if (!compare(m_label, t.m_label)) equal = false;
    else if (!compare(getValue(), t.getValue())) equal = false;
    else if (m_default != t.m_default) equal = false;
    else if (m_sequence != t.m_sequence) equal = false;
    else if (!compare(m_sourceType, t.m_sourceType)) equal = false;
  ...
  public int hashCode() {
    ...
    int type = m_sourceType != null ? m_sourceType.hashCode() : 0;
    return super.hashCode() + m_label.hashCode() + getValue().hashCode() + bool + m_sequence + type;
  }
  ...
  public Element toXml(Document doc) {
    ...
    root.setAttribute(DEFAULT_ATTR, m_default ? BOOLEAN_ENUM[0] : BOOLEAN_ENUM[1]);
