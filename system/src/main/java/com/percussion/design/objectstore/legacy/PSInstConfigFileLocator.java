...
/** Class which provides the installer with the appropriate configuration file locations. */
public class PSInstConfigFileLocator implements IPSConfigFileLocator {
  /**
   * Construct the file locator
   *
   * @param rxRoot Supplies the rhythmyx root installation directory, may not be <code>null</code>.
   */
  ...
  /** The server config file, may not be <code>null</code>. */
