...
public class PSConditional extends PSComponent {
  ...
  public Object clone() {
    ...
    if (m_value != null) copy.m_value = (IPSReplacementValue) m_value.clone();
    if (m_variable != null) copy.m_variable = (IPSReplacementValue) m_variable.clone();
    return copy;
  }
  ...
  public String negate() {
    ...
    if (m_operator == OPTYPE_EQUALS) m_operator = OPTYPE_NOTEQUALS;
    else if (m_operator == OPTYPE_NOTEQUALS) m_operator = OPTYPE_EQUALS;
    else if (m_operator == OPTYPE_LESSTHAN) m_operator = OPTYPE_GREATERTHANOREQUALS;
    else if (m_operator == OPTYPE_LESSTHANOREQUALS) m_operator = OPTYPE_GREATERTHAN;
    else if (m_operator == OPTYPE_GREATERTHAN) m_operator = OPTYPE_LESSTHANOREQUALS;
    else if (m_operator == OPTYPE_GREATERTHANOREQUALS) m_operator = OPTYPE_LESSTHAN;
    else if (m_operator == OPTYPE_ISNULL) m_operator = OPTYPE_ISNOTNULL;
    else if (m_operator == OPTYPE_ISNOTNULL) m_operator = OPTYPE_ISNULL;
    else if (m_operator == OPTYPE_BETWEEN) m_operator = OPTYPE_NOTBETWEEN;
    else if (m_operator == OPTYPE_NOTBETWEEN) m_operator = OPTYPE_BETWEEN;
    else if (m_operator == OPTYPE_IN) m_operator = OPTYPE_NOTIN;
    else if (m_operator == OPTYPE_NOTIN) m_operator = OPTYPE_IN;
    else if (m_operator == OPTYPE_LIKE) m_operator = OPTYPE_NOTLIKE;
    else if (m_operator == OPTYPE_NOTLIKE) m_operator = OPTYPE_LIKE;
  ...
  public void setOperator(java.lang.String op) {
    ...
    if (op.equalsIgnoreCase(OPTYPE_EQUALS)) m_operator = OPTYPE_EQUALS;
    else if (op.equalsIgnoreCase(OPTYPE_NOTEQUALS)) m_operator = OPTYPE_NOTEQUALS;
    else if (op.equalsIgnoreCase(OPTYPE_LESSTHAN)) m_operator = OPTYPE_LESSTHAN;
    else if (op.equalsIgnoreCase(OPTYPE_LESSTHANOREQUALS)) m_operator = OPTYPE_LESSTHANOREQUALS;
    else if (op.equalsIgnoreCase(OPTYPE_GREATERTHAN)) m_operator = OPTYPE_GREATERTHAN;
    else if (op.equalsIgnoreCase(OPTYPE_GREATERTHANOREQUALS))
      m_operator = OPTYPE_GREATERTHANOREQUALS;
    else if (op.equalsIgnoreCase(OPTYPE_ISNULL)) m_operator = OPTYPE_ISNULL;
    else if (op.equalsIgnoreCase(OPTYPE_ISNOTNULL)) m_operator = OPTYPE_ISNOTNULL;
    else if (op.equalsIgnoreCase(OPTYPE_BETWEEN)) m_operator = OPTYPE_BETWEEN;
    else if (op.equalsIgnoreCase(OPTYPE_NOTBETWEEN)) m_operator = OPTYPE_NOTBETWEEN;
    else if (op.equalsIgnoreCase(OPTYPE_IN)) m_operator = OPTYPE_IN;
    else if (op.equalsIgnoreCase(OPTYPE_NOTIN)) m_operator = OPTYPE_NOTIN;
    else if (op.equalsIgnoreCase(OPTYPE_LIKE)) m_operator = OPTYPE_LIKE;
    else if (op.equalsIgnoreCase(OPTYPE_NOTLIKE)) m_operator = OPTYPE_NOTLIKE;
    else throw new IllegalArgumentException("cond optype is unknown" + op);
  }
  ...
  public void setBoolean(java.lang.String bool) {
    ...
    if (bool.equalsIgnoreCase(OPBOOL_AND)) valid = true;
    else if (bool.equalsIgnoreCase(OPBOOL_OR)) valid = true;

    if (false == valid) throw new IllegalArgumentException("cond bool unknown" + bool);
    ...
    try {
        ...
        try {
          ...
          setVariable(
              PSReplacementValueFactory.getReplacementValueFromXml(
                  parentDoc, parentComponents, tree.getNextElement(true), ms_NodeType, "variable"));
      ...
      try {
        ...
        throw new PSUnknownNodeTypeException(
            ms_NodeType, "operator", new PSException(e.getLocalizedMessage()));
      }
      ...
      if (firstChild != null) {
        ...
        valueEl = tree.getNextElement("value", PSXmlTreeWalker.GET_NEXT_ALLOW_SIBLINGS);
      }
      ...
      if (valueEl != null) {
        ...
        setValue(
            PSReplacementValueFactory.getReplacementValueFromXml(
                parentDoc, parentComponents, tree.getNextElement(true), ms_NodeType, "value"));
      }
      ...
      try {
        ...
        throw new PSUnknownNodeTypeException(
            ms_NodeType, "boolean", new PSException(e.getLocalizedMessage()));
      }
    } finally {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof PSConditional)) return false;

    PSConditional other = (PSConditional) o;

    if (m_variable == null || other.m_variable == null) {
      if (m_variable != null || other.m_variable != null) return false;
    } else if (!m_variable.equals(other.m_variable)) return false;

    if (m_operator == null || other.m_operator == null) {
      if (m_operator != null || other.m_operator != null) return false;
    } else if (!m_operator.equals(other.m_operator)) return false;
    ...
    if (m_boolean == null || other.m_boolean == null) {
      if (m_boolean != null || other.m_boolean != null) return false;
    } else if (!m_boolean.equals(other.m_boolean)) return false;

    return true;
  }

  public boolean isUnary() {
    if (m_operator == null) return false;
    else return isUnaryOp(m_operator);
  }

  public static boolean isUnaryOp(String str) {
    return (str.equalsIgnoreCase(OPTYPE_ISNULL) || str.equalsIgnoreCase(OPTYPE_ISNOTNULL));
  }
