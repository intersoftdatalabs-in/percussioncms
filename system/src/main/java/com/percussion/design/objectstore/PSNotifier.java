...
public class PSNotifier extends PSComponent {
  ...
  public PSNotifier() {
    ...
    m_recipients = new PSCollection(com.percussion.design.objectstore.PSRecipient.class);
  }
  ...
  private static PSIllegalArgumentException validateRecipients(PSCollection recipients) {
    if (recipients != null) {
  ...
  public Element toXml(Document doc) {
    ...
    else PSXmlDocumentBuilder.addElement(doc, root, "providerType", "");
  ...
  public final void fromXml(
    ...
    try {
      ...
      if (tree.getNextElement(curNodeType, firstFlags) != null) {
        do {
          recipient = new PSRecipient((Element) tree.getCurrent(), parentDoc, parentComponents);
