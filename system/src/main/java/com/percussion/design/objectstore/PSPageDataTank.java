...
public final class PSPageDataTank extends PSComponent {
  ...
  private static IllegalArgumentException validateSchemaSource(URL schemaSource) {
    if (null == schemaSource) return new IllegalArgumentException("page tank schema is null");
  ...
  private static IllegalArgumentException validateActionTypeXmlField(String xmlField) {
    if (null != xmlField && xmlField.length() > MAX_XML_FIELD_NAME_LEN) {
      return new IllegalArgumentException(
          "page tank XML field is too big" + MAX_XML_FIELD_NAME_LEN + " " + xmlField.length());
    }
  ...
  public Element toXml(Document doc) {
    ...
    PSXmlDocumentBuilder.addElement(doc, root, "schemaSource", m_schemaSource.toExternalForm());

    String xmlField = null == m_xmlField ? "" : m_xmlField;
    PSXmlDocumentBuilder.addElement(doc, root, "actionTypeXmlField", xmlField);
  ...
  public final void fromXml(Element sourceNode, IPSDocument parentDoc, List parentComponents)
    ...
    try {
      ...
      throw new PSUnknownNodeTypeException(
          ms_NodeType, "actionTypeXmlField", new PSException(e.getLocalizedMessage()));
    }
  }
