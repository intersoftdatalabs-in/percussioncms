...
public class PSNumericLiteral extends PSLiteral {
  ...
  private static IllegalArgumentException validateNumberFormat(DecimalFormat format) {
    if (format == null) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof PSNumericLiteral)) result = false;
    else {
      PSNumericLiteral other = (PSNumericLiteral) o;

      if (!m_number.equals(other.m_number)) result = false;
      else if (!m_format.equals(other.m_format)) result = false;
    }
