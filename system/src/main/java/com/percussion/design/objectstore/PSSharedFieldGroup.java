...
public class PSSharedFieldGroup extends PSComponent {
   ...
   */
  public PSSharedFieldGroup(
      String name, PSContainerLocator locator, PSFieldSet fieldSet, PSUIDefinition uiDefinition) {
    setName(name);
    setLocator(locator);
  ...
  public void setValidationRules(PSValidationRules validationRules) {
    ...
    else m_validationRules = validationRules;
  }
  ...
  public void setInputTranslations(PSInputTranslations inputTranslations) {
    ...
    else m_inputTranslations = inputTranslations;
  }
  ...
  public void setOutputTranslations(PSOutputTranslations outputTranslations) {
    ...
    else m_outputTranslations = outputTranslations;
  }
  ...
  public boolean equals(Object o) {
    ...
    boolean equal = true;
    if (!compare(m_fieldSet, t.m_fieldSet)) equal = false;
    else if (!compare(m_inputTranslations, t.m_inputTranslations)) equal = false;
    else if (!compare(m_locator, t.m_locator)) equal = false;
    else if (!compare(getName(), t.getName())) equal = false;
    else if (!compare(m_outputTranslations, t.m_outputTranslations)) equal = false;
    else if (!compare(m_uiDefinition, t.m_uiDefinition)) equal = false;
    else if (!compare(m_validationRules, t.m_validationRules)) equal = false;
