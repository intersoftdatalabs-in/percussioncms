...
public class PSConditionalExtension extends PSComponent {
  ...
  public PSConditionalExtension(PSExtensionCall extension) {
    if (extension == null) throw new IllegalArgumentException("extension may not be null.");
  ...
  public Object clone() {
    ...
    if (m_conditions != null) exit.m_conditions = (PSCollection) m_conditions.clone();
    if (m_extension != null) exit.m_extension = (PSExtensionCall) m_extension.clone();
