...
public final class PSUpdatePipe extends PSPipe {
  ...
  private static IllegalArgumentException validateDataSynchronizer(
    ...
    if (synchronizer == null) return new IllegalArgumentException("updatepipe data synch is null");
  ...
  public Element toXml(Document doc) {
    ...
    if (m_dataSynchronizer != null) root.appendChild(m_dataSynchronizer.toXml(doc));
  ...
  public final void fromXml(Element sourceNode, IPSDocument parentDoc, List<IPSComponent> parentComponents)
    ...
    try {
      ...
      if (tree.getNextElement(PSDataSynchronizer.ms_NodeType, firstFlags) != null) {
        m_dataSynchronizer =
            new PSDataSynchronizer((Element) tree.getCurrent(), parentDoc, parentComponents);
      }
  ...
  public void validate(IPSValidationContext cxt) throws PSSystemValidationException {
    ...
    cxt.pushParent(this);
    try {
      if (m_dataSynchronizer != null) m_dataSynchronizer.validate(cxt);
    } finally {
      cxt.popParent();
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    if (bEqual && o instanceof PSUpdatePipe) {
      ...
      if (!compare(m_dataSynchronizer, other.m_dataSynchronizer)) bEqual = false;
    }
