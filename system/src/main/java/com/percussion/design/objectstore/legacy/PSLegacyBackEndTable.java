...
public class PSLegacyBackEndTable extends PSComponent {
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List<IPSComponent> parentComponents)
    ...
    try { // private      String          m_alias;
      ...
      throw new PSUnknownNodeTypeException(
          ms_NodeType, "alias", new PSException(e.getLocalizedMessage()));
    }
    ...
    try { // private      String          m_driver;
      ...
      throw new PSUnknownNodeTypeException(
          ms_NodeType, "driver", new PSException(e.getLocalizedMessage()));
    }
    ...
    try { // private      String          m_server;
      ...
      throw new PSUnknownNodeTypeException(
          ms_NodeType, "server", new PSException(e.getLocalizedMessage()));
    }
    ...
    try { // private      String          m_database;
      ...
      throw new PSUnknownNodeTypeException(
          ms_NodeType, "database", new PSException(e.getLocalizedMessage()));
    }
    ...
    try { // private      String          m_origin;
      ...
      throw new PSUnknownNodeTypeException(
          ms_NodeType, "origin", new PSException(e.getLocalizedMessage()));
    }
    ...
    try { // private      String          m_table;
      ...
      throw new PSUnknownNodeTypeException(
          ms_NodeType, "table", new PSException(e.getLocalizedMessage()));
    }
  }
  ...
  public int hashCode() {
    int hash = 0;
    if (null != m_alias) hash += m_alias.hashCode();
    if (null != m_driver) hash += m_driver.hashCode();
    if (null != m_server) hash += m_server.hashCode();
    if (null != m_database) hash += m_database.hashCode();
    if (null != m_origin) hash += m_origin.hashCode();
    if (null != m_table) hash += m_table.hashCode();
    return hash;
  }
  ...
  public boolean equals(Object o) {
    if (!(o instanceof PSLegacyBackEndTable)) return false;

    PSLegacyBackEndTable other = (PSLegacyBackEndTable) o;

    if (m_alias == null || other.m_alias == null) {
      if (m_alias != null || other.m_alias != null) return false;
    } else if (!m_alias.equals(other.m_alias)) return false;

    if (m_driver == null || other.m_driver == null) {
      if (m_driver != null || other.m_driver != null) return false;
    } else if (!m_driver.equals(other.m_driver)) return false;

    if (m_server == null || other.m_server == null) {
      if (m_server != null || other.m_server != null) return false;
    } else if (!m_server.equals(other.m_server)) return false;

    if (m_database == null || other.m_database == null) {
      if (m_database != null || other.m_database != null) return false;
    } else if (!m_database.equals(other.m_database)) return false;

    if (m_origin == null || other.m_origin == null) {
      if (m_origin != null || other.m_origin != null) return false;
    ...
    } else if (!m_table.equals(other.m_table)) return false;
