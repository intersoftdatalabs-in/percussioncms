...
/**
 * The PSDateLiteral class is used to define a replacement value is a static date literal value.
 *
...
public class PSDateLiteral extends PSLiteral {
  ...
  private static IllegalArgumentException validateDateFormat(FastDateFormat format) {
    if (format == null) {
  ...
  /**
   * @author chadloder
   *     <p>Tests whether this object is equal to another PSDateLiteral object. Formatting data does
   *     not have an effect on the comparison.
  ...
  public boolean equals(Object o) {
    if (!(o instanceof PSDateLiteral)) return false;

    PSDateLiteral other = (PSDateLiteral) o;

    if ((m_date != null) && (other.m_date != null)) return m_date.equals(other.m_date);
  ...
  /**
   * This method is called to create a PSXDateLiteral XML element node containing the data described
   * in this object.
   *
  ...
  /**
   * This method is called to populate a PSDateLiteral Java object from a PSXDateLiteral XML element
