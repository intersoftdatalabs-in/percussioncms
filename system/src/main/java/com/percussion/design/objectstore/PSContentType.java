...
public class PSContentType extends PSComponent {
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List parentComponents)
    ...
    if (hideFromMenu != null) m_hideFromMenu = (hideFromMenu.equals(XML_TRUE)) ? false : true;
  }
  ...
  public Element toXml(Document doc) {
    ...
    root.setAttribute(HIDE_FROM_MENU_ATTR, m_hideFromMenu ? XML_TRUE : XML_FALSE);
    PSXmlDocumentBuilder.addElement(doc, root, "id", String.valueOf(getDbId()));
  ...
  public void setObjectType(int type) {
    if (!PSCmsObject.isValidType(type))
      throw new IllegalArgumentException("type must be one of PSCmsObject.TYPE_xxx values");
