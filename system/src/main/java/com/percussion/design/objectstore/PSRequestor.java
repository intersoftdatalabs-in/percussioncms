...
public class PSRequestor extends PSComponent {
  ...
  public PSRequestor() {
    ...
    m_validationRules = new PSCollection(com.percussion.design.objectstore.PSConditional.class);
  }
  ...
  public void setSelectionCriteria(com.percussion.util.PSCollection params) {
    ...
    if (null == params) m_selectionParams.clear();
    else m_selectionParams = params;
  }

  private static IllegalArgumentException validateSelectionCriteria(PSCollection params) {
    if (params != null) {
      if (!com.percussion.design.objectstore.PSConditional.class.isAssignableFrom(
          params.getMemberClassType())) {
        return new IllegalArgumentException(
            "coll bad content type, Selection Parameters: " + params.getMemberClassName());
      }
    }
  ...
  public void setValidationRules(com.percussion.util.PSCollection rules) {
    ...
    if (null == rules) m_validationRules.clear();
    else m_validationRules = rules;
  }

  private static IllegalArgumentException validateValidationRules(PSCollection rules) {
    if (rules != null) {
      if (!com.percussion.design.objectstore.PSConditional.class.isAssignableFrom(
          rules.getMemberClassType())) {
        return new IllegalArgumentException(
            "coll bad content type, Validation Rules: " + rules.getMemberClassName());
      }
    }
  ...
  public Element toXml(Document doc) {
    ...
    Element configNode = PSXmlDocumentBuilder.addEmptyElement(doc, root, "MimeProperties");
    ...
    if (m_mimeProps != null) {
      ...
      while (iKey.hasNext()) {
        ...
        parent = PSXmlDocumentBuilder.addEmptyElement(doc, configNode, key);
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List parentComponents)
    ...
    try {
      ...
      if (m_requestPageName == null) m_requestPageName = "";
      ...
      if (tree.getNextElement("SelectionParams", firstFlags) != null) {
        ...
        if (tree.getNextElement(curNodeType, firstFlags) != null) {
          ...
          do {
            selector = new PSConditional((Element) tree.getCurrent(), parentDoc, parentComponents);
      ...
      if (sTemp != null) m_directDataStream = sTemp.equalsIgnoreCase("yes");
      ...
      if (tree.getNextElement("MimeProperties", firstFlags) != null) {
        ...
        while ((cur = tree.getNextElement(treeFlags)) != null) {
          ...
          Element replElement = tree.getNextElement(PSXmlTreeWalker.GET_NEXT_ALLOW_CHILDREN);
          Element node = (Element) tree.getCurrent();
          val =
              PSReplacementValueFactory.getReplacementValueFromXml(
                  parentDoc, parentComponents, node, extension, node.getNodeName());
    ...
    try {
      if (m_selectionParams != null) {
        for (int i = 0; i < m_selectionParams.size(); i++) {
          ...
          if (o == null) cxt.validationError(this, 0, "selection param " + i + " == null");
      ...
      for (int i = 0; i < m_validationRules.size(); i++) {
        ...
        if (o == null) cxt.validationError(this, 0, "validation rule " + i + " == null");
        else if (!(o instanceof PSConditional)) {
  ...
  public IPSReplacementValue getMimeType(String fileExtension) {
    ...
    if (m_outputMimeType != null) return m_outputMimeType;
  ...
  public boolean isExtensionSupported(String extension) {
    ...
    if (m_outputMimeType != null) return true;

    if (m_mimeProps.get(extension) != null) return true;
  ...
  public static final String ms_NodeType = "PSXRequestor";
}
