...
public class PSBackEndDataTank extends PSComponent {
  ...
  public PSBackEndDataTank() {
    super();
    m_tables = new PSCollection(com.percussion.design.objectstore.PSBackEndTable.class);
    m_joins = new PSCollection(com.percussion.design.objectstore.PSBackEndJoin.class);
  }
  ...
  public void setTables(com.percussion.util.PSCollection tables) {
    ...
    if (!com.percussion.design.objectstore.PSBackEndTable.class.isAssignableFrom(
      ...
      throw new IllegalArgumentException(
          "coll bad content type: Back-end Table " + tables.getMemberClassName());
    }
  ...
  public void setJoins(com.percussion.util.PSCollection joins) {
    if (joins != null) {
      ...
      if (!com.percussion.design.objectstore.PSBackEndJoin.class.isAssignableFrom(
        ...
        Object[] args = {"Back-end Join", "PSBackEndJoin", joins.getMemberClassName()};
        throw new IllegalArgumentException(
            "coll bad content type: Back-end Join " + joins.getMemberClassName());
      }
    }
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List<IPSComponent> parentComponents)
    ...
    try {
      ...
      if (tree.getNextElement(PSBackEndTable.ms_NodeType, firstFlags) != null) {
        do {
          PSBackEndTable table =
              new PSBackEndTable((Element) tree.getCurrent(), parentDoc, parentComponents);
          m_tables.add(table);
        } while (tree.getNextElement(PSBackEndTable.ms_NodeType, nextFlags) != null);
      }
      ...
      if (tree.getNextElement(PSBackEndJoin.ms_NodeType, firstFlags) != null) {
        ...
        do {
          PSBackEndJoin join =
              new PSBackEndJoin((Element) tree.getCurrent(), parentDoc, parentComponents);
          m_joins.add(join);
        } while (tree.getNextElement(PSBackEndJoin.ms_NodeType, nextFlags) != null);
      }
    } finally {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(m_tables, that.m_tables) && Objects.equals(m_joins, that.m_joins);
  }
  ...
  public Object clone() {
    ...
    if (m_tables != null) copy.m_tables = (PSCollection) m_tables.clone();
    if (m_joins != null) copy.m_joins = (PSCollection) m_joins.clone();
    return copy;
  }
