...
public class PSDisplayTextLiteral extends PSLiteral implements IPSMutatableReplacementValue {
  ...
  public PSDisplayTextLiteral(String displayValue, String value) {
    if (null == displayValue || 0 == displayValue.trim().length())
      throw new IllegalArgumentException("displayValue may not be null or empty");
    if (null == value) throw new IllegalArgumentException("value may not be null");
  ...
  public boolean equals(Object o) {
    if (o instanceof PSDisplayTextLiteral) {
      ...
      if (m_displayValue.equals(literal.m_displayValue) && m_value.equals(literal.m_value))
        return true;
    }
    return false;
  }
