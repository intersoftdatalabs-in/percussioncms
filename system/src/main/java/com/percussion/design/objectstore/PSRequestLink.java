...
public class PSRequestLink extends PSComponent implements IPSResults {
  ...
  public Element toXml(Document doc) {
    ...
    root.setAttribute("useHttpResponseForRedirect", m_useHttpResponseForRedirect ? "yes" : "no");

    // private          int         m_requestType = RL_TYPE_NONE;
    if (m_requestType == RL_TYPE_QUERY) root.setAttribute("type", "query");
    else if (m_requestType == RL_TYPE_INSERT) root.setAttribute("type", "insert");
    else if (m_requestType == RL_TYPE_UPDATE) root.setAttribute("type", "update");
    else if (m_requestType == RL_TYPE_DELETE) root.setAttribute("type", "delete");
    else root.setAttribute("type", "none");
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List parentComponents)
    ...
    m_useHttpResponseForRedirect = (sTemp == null || !sTemp.equalsIgnoreCase("no"));
    ...
    else if (sTemp.equalsIgnoreCase("update")) m_requestType = RL_TYPE_UPDATE;
  ...
  public int hashCode() {
    return Objects.hash(
        super.hashCode(), m_useHttpResponseForRedirect, m_xmlField, m_requestType, m_dataSet);
  }
