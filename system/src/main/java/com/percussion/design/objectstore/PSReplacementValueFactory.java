...
public abstract class PSReplacementValueFactory {
  ...
  public static IPSReplacementValue getReplacementValueFromXmlFieldName(String xmlField) {
    try {
      ...
      if (value == null) value = new PSXmlField(xmlField);

      return value;
    } catch (InvocationTargetException e) {
      Throwable orig = e.getTargetException();
      throw new IllegalArgumentException("XML param invalid: " + xmlField + " " + orig.toString());
    } catch (IllegalAccessException e) {
      throw new IllegalArgumentException("XML param invalid: " + xmlField + " " + e.toString());
   ...
   * @return the replacement value, never <code>null</code>
   */
  public static IPSReplacementValue getReplacementValueFromString(String repString) {
  ...
  public static boolean isValidFieldName(String field) {
    ...
    return (!ms_rvClasses.containsKey(name) || getReplacementValueCtor(name) != null);
  }
  ...
  static {
    ...
    ms_rvClasses.put(PSBackEndColumn.ms_NodeType.toLowerCase(), PSBackEndColumn.class);
    ms_rvClasses.put(PSCgiVariable.ms_NodeType.toLowerCase(), PSCgiVariable.class);
    ms_rvClasses.put(PSHtmlParameter.ms_NodeType.toLowerCase(), PSHtmlParameter.class);
    ms_rvClasses.put(PSCookie.ms_NodeType.toLowerCase(), PSCookie.class);
    ms_rvClasses.put(PSExtensionCall.ms_NodeType.toLowerCase(), PSExtensionCall.class);
    ms_rvClasses.put(PSFunctionCall.XML_NODE_NAME.toLowerCase(), PSFunctionCall.class);
    ms_rvClasses.put(PSUserContext.ms_NodeType.toLowerCase(), PSUserContext.class);
    ms_rvClasses.put(PSXmlField.ms_NodeType.toLowerCase(), PSXmlField.class);
    ms_rvClasses.put(PSSingleHtmlParameter.ms_NodeType.toLowerCase(), PSSingleHtmlParameter.class);
    ms_rvClasses.put(PSDisplayFieldRef.XML_NODE_NAME.toLowerCase(), PSDisplayFieldRef.class);
    ms_rvClasses.put(PSUrlRequest.XML_NODE_NAME.toLowerCase(), PSUrlRequest.class);
    ms_rvClasses.put(
        PSRelationshipProperty.XML_NODE_NAME.toLowerCase(), PSRelationshipProperty.class);
    ms_rvClasses.put(
        PSOriginatingRelationshipProperty.XML_NODE_NAME.toLowerCase(),
        PSOriginatingRelationshipProperty.class);
    ms_rvClasses.put(PSContentItemStatus.XML_NODE_NAME.toLowerCase(), PSContentItemStatus.class);
    ms_rvClasses.put(PSContentItemData.XML_NODE_NAME.toLowerCase(), PSContentItemData.class);
    ms_rvClasses.put(PSMacro.ms_NodeType.toLowerCase(), PSMacro.class);

    // literals
    ms_rvClasses.put(PSDateLiteral.ms_NodeType.toLowerCase(), PSDateLiteral.class);
    ms_rvClasses.put(PSLiteralSet.ms_NodeType.toLowerCase(), PSLiteralSet.class);
    ms_rvClasses.put(PSNumericLiteral.ms_NodeType.toLowerCase(), PSNumericLiteral.class);
    ms_rvClasses.put(PSTextLiteral.ms_NodeType.toLowerCase(), PSTextLiteral.class);
    ms_rvClasses.put(PSDisplayTextLiteral.XML_NODE_NAME.toLowerCase(), PSDisplayTextLiteral.class);
