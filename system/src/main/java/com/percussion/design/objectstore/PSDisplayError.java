...
public class PSDisplayError implements Serializable {
  ...
  public PSDisplayError(String sourceDoc)
      throws IOException, SAXException, PSUnknownNodeTypeException, PSInvalidXmlException {
    if (StringUtils.isBlank(sourceDoc))
      throw new IllegalArgumentException("sourceDoc must not be null or empty");
    Document errorDoc =
