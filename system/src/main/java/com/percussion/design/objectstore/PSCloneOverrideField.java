...
public class PSCloneOverrideField extends PSComponent {
    ...
    try {
      setReplacementValue(
          PSReplacementValueFactory.getReplacementValueFromXml(
              parentDoc, parentComponents, repElem, "value", "value"));
  ...
  public void setRules(PSCollection rules) {
    ...
    if (!rules.getMemberClassType().equals(PSRule.class))
      throw new IllegalArgumentException("rules must be of type PSRule.class");
  ...
  public Object clone() {
    PSCloneOverrideField field =
        new PSCloneOverrideField(m_name, (IPSReplacementValue) m_replacementValue.clone());
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof PSCloneOverrideField)) return false;
   ...
   */
  public int hashCode() {
    return new HashCodeBuilder(23, 4)
