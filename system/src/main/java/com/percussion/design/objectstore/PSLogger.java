...
public class PSLogger extends PSComponent {
  ...
  public void setServerStartStopLoggingEnabled(boolean enable) {
    ...
    else m_options &= ~LOG_SERVER_START_STOP;
  }
  ...
  public void setAppStartStopLoggingEnabled(boolean enable) {
    ...
    else m_options &= ~LOG_APP_START_STOP;
  }
  ...
  public void setAppStatisticsLoggingEnabled(boolean enable) {
    ...
    else m_options &= ~LOG_APP_STATISTICS;
  }
  ...
  public void setExecutionPlanLoggingEnabled(boolean enable) {
    ...
    else m_options &= ~LOG_EXECUTION_PLAN;
  }
  ...
  public void setBasicUserActivityLoggingEnabled(boolean enable) {
    ...
    else m_options &= ~LOG_BASIC_USER_ACTIVITY;
  }
  ...
  public void setDetailedUserActivityLoggingEnabled(boolean enable) {
    ...
    else m_options &= ~LOG_DETAILED_USER_ACTIVITY;
  }
  ...
  public void setFullUserActivityLoggingEnabled(boolean enable) {
    ...
    else m_options &= ~LOG_FULL_USER_ACTIVITY;
  }
  ...
  public void setMultipleHandlerLoggingEnabled(boolean enable) {
    if (enable) m_options |= LOG_MULTIPLE_HANDLERS;
    else m_options &= ~LOG_MULTIPLE_HANDLERS;
  }
  ...
  public Element toXml(Document doc) {
    ...
    root.setAttribute("logErrors", isErrorLoggingEnabled() ? "yes" : "no");

    root.setAttribute("logServerStartStop", isServerStartStopLoggingEnabled() ? "yes" : "no");

    root.setAttribute("logAppStartStop", isAppStartStopLoggingEnabled() ? "yes" : "no");

    root.setAttribute("logAppStatistics", isAppStatisticsLoggingEnabled() ? "yes" : "no");

    root.setAttribute("logExecutionPlan", isExecutionPlanLoggingEnabled() ? "yes" : "no");

    root.setAttribute("logBasicUserActivity", isBasicUserActivityLoggingEnabled() ? "yes" : "no");

    root.setAttribute(
        "logDetailedUserActivity", isDetailedUserActivityLoggingEnabled() ? "yes" : "no");

    root.setAttribute("logFullUserActivity", isFullUserActivityLoggingEnabled() ? "yes" : "no");

    root.setAttribute("logMultipleHandlers", isMultipleHandlerLoggingEnabled() ? "yes" : "no");
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List<IPSComponent> parentComponents)
    ...
    if ((sTemp != null) && sTemp.equalsIgnoreCase("yes")) m_options |= LOG_ERRORS;

    sTemp = tree.getElementData("logServerStartStop");
    if ((sTemp != null) && sTemp.equalsIgnoreCase("yes")) m_options |= LOG_SERVER_START_STOP;

    sTemp = tree.getElementData("logAppStartStop");
    if ((sTemp != null) && sTemp.equalsIgnoreCase("yes")) m_options |= LOG_APP_START_STOP;

    sTemp = tree.getElementData("logExecutionPlan");
    if ((sTemp != null) && sTemp.equalsIgnoreCase("yes")) m_options |= LOG_EXECUTION_PLAN;

    sTemp = tree.getElementData("logAppStatistics");
    if ((sTemp != null) && sTemp.equalsIgnoreCase("yes")) m_options |= LOG_APP_STATISTICS;

    sTemp = tree.getElementData("logBasicUserActivity");
    if ((sTemp != null) && sTemp.equalsIgnoreCase("yes")) m_options |= LOG_BASIC_USER_ACTIVITY;

    sTemp = tree.getElementData("logDetailedUserActivity");
    if ((sTemp != null) && sTemp.equalsIgnoreCase("yes")) m_options |= LOG_DETAILED_USER_ACTIVITY;

    sTemp = tree.getElementData("logFullUserActivity");
    if ((sTemp != null) && sTemp.equalsIgnoreCase("yes")) m_options |= LOG_FULL_USER_ACTIVITY;

    sTemp = tree.getElementData("logMultipleHandlers");
    if ((sTemp != null) && sTemp.equalsIgnoreCase("yes")) m_options |= LOG_MULTIPLE_HANDLERS;
  }
  ...
  public void validate(IPSValidationContext cxt) throws PSSystemValidationException {
    ...
    final int all_flags_compliment =
        ~(LOG_ERRORS
            | LOG_SERVER_START_STOP
            | LOG_APP_START_STOP
            | LOG_APP_STATISTICS
            | LOG_BASIC_USER_ACTIVITY
            | LOG_DETAILED_USER_ACTIVITY
            | LOG_FULL_USER_ACTIVITY
            | LOG_MULTIPLE_HANDLERS
            | LOG_EXECUTION_PLAN);
  ...
  public boolean equals(Object o) {
    if (!(o instanceof PSLogger)) return false;

    PSLogger other = (PSLogger) o;

    if (m_options != other.m_options) return false;
  ...
  public void or(PSLogger logger) {
    if (logger != null) m_options |= logger.m_options;
  }
