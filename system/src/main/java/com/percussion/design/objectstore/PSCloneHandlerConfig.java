...
public class PSCloneHandlerConfig extends PSComponent {
  ...
  public PSProcessCheck getProcessCheck(String name, String context) {
    ...
    while (checks.hasNext()) {
      ...
      if (check.getName().equals(name) && check.getContext().equals(context)) return check;
    }
    ...
    try {
      ...
      if (node != null) {
        ...
        while (node != null) {
          ...
          if (!inserted) m_processChecks.add(check);
  ...
  public Element toXml(Document doc) {
    ...
    while (checks.hasNext()) elem.appendChild(((IPSComponent) checks.next()).toXml(doc));
