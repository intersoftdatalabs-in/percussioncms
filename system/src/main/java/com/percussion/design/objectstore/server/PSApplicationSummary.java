...
public class PSApplicationSummary {
  ...
  public String toString() {
    ...
    buf.append(m_name)
        ...
        .append(m_id)
        .append(") v")
        .append(m_majorVersion)
        .append(".")
        .append(m_minorVersion)
        .append(" modified ");

    // append the modification date to the buffer
    buf.insert(
        new FieldPosition(0).getBeginIndex(),
        FastDateFormat.getInstance().format(new Date(m_fileLastModified)));
  ...
  private static class PSApplicationSummaryComparator implements Comparator {
    ...
    public int compare(Object o1, Object o2) {
      ...
      return ((PSApplicationSummary) o1)
          .getName()
          .compareToIgnoreCase(((PSApplicationSummary) o2).getName());
    }
  }
}
