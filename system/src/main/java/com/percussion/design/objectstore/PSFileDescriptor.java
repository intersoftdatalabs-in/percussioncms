...
public class PSFileDescriptor extends PSComponent {
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List<IPSComponent> parentComponents)
    ...
    if (m_timestamp == null) m_timestamp = "";
  }
  ...
  public Element toXml(Document doc) {
    ...
    PSXmlDocumentBuilder.addElement(doc, root, XML_EL_FILE_LOC, m_fileLocation);
    PSXmlDocumentBuilder.addElement(
        doc, root, XML_EL_FILE_TIMESTAMP, m_timestamp == null ? "" : m_timestamp);
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PSFileDescriptor)) isEqual = false;
    else {
      PSFileDescriptor other = (PSFileDescriptor) obj;
      if (m_id != other.m_id) isEqual = false;
      else if (!m_name.equals(other.m_name)) isEqual = false;
      else if (!m_type.equals(other.m_type)) isEqual = false;
      else if (!m_mimetype.equals(other.m_mimetype)) isEqual = false;
      else if (!m_fileLocation.equals(other.m_fileLocation)) isEqual = false;
      else if (!m_originalLocation.equals(other.m_originalLocation)) isEqual = false;
      else if (!m_timestamp.equals(other.m_timestamp)) isEqual = false;
    }
  ...
  public int hashCode() {
    return m_id
        ...
        + m_type.hashCode()
        + m_mimetype.hashCode()
        + m_fileLocation.hashCode()
        + m_originalLocation.hashCode()
