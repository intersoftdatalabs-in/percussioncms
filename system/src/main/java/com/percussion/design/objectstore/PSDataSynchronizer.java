...
public final class PSDataSynchronizer extends PSComponent {
  ...
  public PSDataSynchronizer() {
    super();
    m_columns = new PSCollection(com.percussion.design.objectstore.PSUpdateColumn.class);
  }
  ...
  private static IllegalArgumentException validateUpdateColumns(PSCollection cols) {
    if (cols != null) {
      if (!com.percussion.design.objectstore.PSUpdateColumn.class.isAssignableFrom(
          cols.getMemberClassType())) {
        return new IllegalArgumentException(
            "coll bad content type, Update Column: " + cols.getMemberClassName());
      }
    }
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List<IPSComponent> parentComponents)
    ...
    try {
      ...
      if (tree.getNextElement(curNodeType, firstFlags) != null) {
        ...
        do {
          column = new PSUpdateColumn((Element) tree.getCurrent(), parentDoc, parentComponents);
