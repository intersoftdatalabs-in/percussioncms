...
public class PSOutputTranslations extends PSCollectionComponent {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof PSOutputTranslations)) return false;

    PSOutputTranslations t = (PSOutputTranslations) o;
  ...
  @Override
  public int hashCode() {
    // AP: does not feel right - equals redefined, but hashCode is not
  ...
  /** the XML node name */
  public static final String XML_NODE_NAME = "PSXOutputTranslations";
}
