...
public class PSConditionalStylesheet extends PSStylesheet {
  ...
  public void setConditions(PSCollection conditions) {
    ...
    if (conditions.isEmpty()) throw new IllegalArgumentException("conditions can't be empty");

    if (!conditions.getMemberClassName().equals(m_conditions.getMemberClassName()))
