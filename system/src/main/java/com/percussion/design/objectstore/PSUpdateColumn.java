...
public class PSUpdateColumn extends PSComponent {
  ...
  public Object clone() {
    ...
    if (m_backEndColumn != null) copy.m_backEndColumn = (PSBackEndColumn) m_backEndColumn.clone();
    return copy;
  }
  ...
  private static IllegalArgumentException validateColumn(PSBackEndColumn col) {
    if (col == null) return new IllegalArgumentException("update col is null");
  ...
  public Element toXml(Document doc) {
    ...
    if (null != m_backEndColumn) root.appendChild(m_backEndColumn.toXml(doc));
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List<IPSComponent> parentComponents)
    ...
    try {
      ...
      m_backEndColumn =
          new PSBackEndColumn((Element) tree.getCurrent(), parentDoc, parentComponents);
    } finally {
  ...
  public void validate(IPSValidationContext cxt) throws PSSystemValidationException {
    ...
    cxt.pushParent(this);
    try {
      if (m_backEndColumn != null) m_backEndColumn.validate(cxt);
    } finally {
      cxt.popParent();
    }
  }
