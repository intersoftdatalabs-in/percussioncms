...
/**
 * PSUnknownDocTypeException is thrown when fromXml is called in one of the IPSComponent
 * implementations and the implementation does not support the specified XML document type.
 *
...
public class PSUnknownDocTypeException extends PSException {
  ...
  public java.lang.String getLocalizedMessage(java.util.Locale locale) {
    ...
    if (m_exception != null) m_args[2] = m_exception.getLocalizedMessage(locale);
