...
public class PSView implements Serializable {
  ...
  public PSView(String name, Iterator fields) {
    ...
    if (fields == null) throw new IllegalArgumentException("fields may not be null");
    ...
    while (fields.hasNext()) {
      ...
      if (!(o instanceof String))
        throw new IllegalArgumentException("fields must contain only Strings");

      String field = (String) o;
      if (field.trim().length() == 0)
        throw new IllegalArgumentException("fields may not contain empty Strings");
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PSView)) isMatch = false;
    else {
      PSView other = (PSView) obj;
      if (!this.m_name.equals(other.m_name)) isMatch = false;
      else if (!this.m_fields.equals(other.m_fields)) isMatch = false;
    }
