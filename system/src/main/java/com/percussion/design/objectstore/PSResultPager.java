...
public class PSResultPager extends PSComponent {
  ...
  public Element toXml(Document doc) {
    ...
    PSXmlDocumentBuilder.addElement(doc, root, "maxRowsPerPage", String.valueOf(m_maxRowsPerPage));

    PSXmlDocumentBuilder.addElement(doc, root, "maxPages", String.valueOf(m_maxPages));

    PSXmlDocumentBuilder.addElement(doc, root, "maxPageLinks", String.valueOf(m_maxPageLinks));
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List<IPSComponent> parentComponents)
    ...
    if (sTemp == null) m_maxRowsPerPage = DEFAULT_MAX_ROWS_PER_PAGE;
    else {
      try {
    ...
    if (sTemp == null) m_maxPages = DEFAULT_MAX_PAGES;
    else {
      try {
    ...
    if (sTemp == null) m_maxPageLinks = DEFAULT_MAX_PAGE_LINKS;
    else {
      try {
