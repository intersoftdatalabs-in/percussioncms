...
public class PSConditionalSet extends PSCollection {
  ...
  public String toString() {
    ...
    while (it.hasNext()) {
      ...
      String value = cond.getValue() != null ? cond.getValue().getValueDisplayText() : null;
      String variable =
          cond.getVariable() != null ? cond.getVariable().getValueDisplayText() : null;
      ...
      if (it.hasNext()) sb.append(" " + bool + " ");
    }
    if (sb.length() <= m_maxLength) return sb.toString();
