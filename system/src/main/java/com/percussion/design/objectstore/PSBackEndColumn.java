...
public class PSBackEndColumn extends PSComponent implements IPSBackEndMapping, IPSReplacementValue {
  ...
  protected PSBackEndColumn(PSBackEndColumn source) {
    if (null == source) throw new IllegalArgumentException("source may not be null");
  ...
  private static IllegalArgumentException validateTable(PSBackEndTable table) {
    if (table == null) return new IllegalArgumentException("back end table is null");
  ...
  private static IllegalArgumentException validateColumn(String name) {
    if ((null == name) || (name.length() == 0)) {
      ...
      return new IllegalArgumentException(
          "back end column name is too big: " + MAX_COL_NAME_LEN + " " + name.length());
    }
  ...
  public boolean equals(Object o) {
    ...
    boolean bEqual = true;
    if (!doesMatch(other)) bEqual = false;
    else if (!compare(m_table, other.m_table)) bEqual = false;
  ...
  public boolean isSameColumn(Object o) {
    ...
    if ((m_table.equals(other.getTable())) && (m_column.equals(other.getColumn()))) {
      bEqual = true;
    }
    return bEqual;
  }
  ...
  public boolean doesMatch(Object o) {
    ...
    PSBackEndColumn other = (PSBackEndColumn) o;
    boolean bEqual = true;
    if (!compare(m_column, other.m_column)) bEqual = false;
    else if (!compare(m_table.getAlias(), other.m_table.getAlias())) bEqual = false;
      ...
      */
      if ((other.m_alias == null || other.m_alias.equals(""))
          && (this.m_alias == null
              || this.m_alias.equals("")
              || this.m_alias.equals(this.m_column))) bEqual = true;
      else if ((this.m_alias == null || this.m_alias.equals(""))
          && (other.m_alias.equals(other.m_column))) bEqual = true;
      else bEqual = false;
    }
  ...
  public static PSBackEndColumn findColumnFromDisplay(String display, PSCollection tables) {
    ...
    if (strAlias == null || strAlias.trim().length() == 0) return null;
  ...
  public String getValueText() {
    ...
    if (tableName == null) return m_column;
  ...
  public Element toXml(Document doc) {
    ...
    PSXmlDocumentBuilder.addElement(doc, root, "tableAlias", m_table.getAlias());
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List parentComponents)
    ...
    if (parentComponents != null) {
      ...
      for (int i = parentComponents.size(); i != 0; ) {
        ...
        else if (parent instanceof com.percussion.design.objectstore.PSDataSet) {
          PSDataSet ds;

          ds = (PSDataSet) parent;
          /* Get pipe from ds */
          PSPipe pipe = ds.getPipe();
          if (pipe != null) dt = pipe.getBackEndDataTank();
          else continue;
    ...
    if (m_table == null) {
      try {
        ...
        throw new PSUnknownNodeTypeException(
            ms_NodeType, "tableAlias", new PSException(e.getLocalizedMessage()));
      }
    }
    ...
    try {
      ...
      throw new PSUnknownNodeTypeException(
          ms_NodeType, "column", new PSException(e.getLocalizedMessage()));
    }
    ...
    try {
      ...
      throw new PSUnknownNodeTypeException(
          ms_NodeType, "columnAlias", new PSException(e.getLocalizedMessage()));
    }
  }
