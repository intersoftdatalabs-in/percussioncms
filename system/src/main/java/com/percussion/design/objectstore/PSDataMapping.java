...
public final class PSDataMapping extends PSComponent {
  ...
  public PSDataMapping(java.lang.String xmlField, IPSBackEndMapping backEndMap) {
    this(
        (IPSDocumentMapping)
            PSReplacementValueFactory.getReplacementValueFromXmlFieldName(xmlField),
        backEndMap);
  }
  ...
  private static IllegalArgumentException validateBackEndMapping(IPSBackEndMapping backEndMap) {
    if (backEndMap == null)
    ...
    if (conds != null) {
      if (!com.percussion.design.objectstore.PSConditional.class.isAssignableFrom(
        ...
        throw new IllegalArgumentException(
            "BackEndMapping exception: Data Mapping conds does not contain PSConditional objects");
      }
    }
  ...
  public Element toXml(Document doc) {
    ...
    if (m_docMapping != null) root.appendChild(m_docMapping.toXml(doc));

    // private              PSExtensionCall   m_backEndMapping;
    if (m_backEndMapping != null) root.appendChild(((IPSComponent) m_backEndMapping).toXml(doc));
    ...
    if (m_textFormatter != null) {
      ...
      try {
        ...
        java.io.ObjectOutputStream objOut = new java.io.ObjectOutputStream(bOut);
        ...
        PSXmlDocumentBuilder.addElement(
            doc, root, "textFormatter", new String(bOut.toByteArray(), PSCharSets.rxJavaEnc()));
  ...
  public void fromXml(Element sourceNode, IPSDocument parentDoc, List parentComponents)
    ...
    try {
      ...
      try {
        if ((sTemp == null) || (sTemp.length() == 0)) m_groupId = 0;
      ...
      try {
        if ("xmlField".equals(node.getTagName())) {
          ...
          try {
            m_docMapping =
                (IPSDocumentMapping)
                    createMappingObject(node, "documentMapping", parentDoc, parentComponents);
  ...
  private static IllegalArgumentException validateGroupId(int groupId) {
    if (groupId < 0) {
      return new IllegalArgumentException(
          "BackEndMapping exception: Data Mapping group ID:" + groupId + "invalid");
    }
    return null;
  }
  ...
  public void validate(IPSValidationContext cxt) throws PSSystemValidationException {
    ...
    try {
      if (m_docMapping != null) m_docMapping.validate(cxt);
  ...
  private IPSComponent createMappingObject(
    ...
    return (IPSComponent)
        PSReplacementValueFactory.getReplacementValueFromXml(
            parentDoc, parentComponents, mappingNode, mappingNode.getNodeName(), nodeSource);
  }
