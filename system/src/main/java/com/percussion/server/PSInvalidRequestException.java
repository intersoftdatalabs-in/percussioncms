 ...
 * that a reply could be sent.
 */
public class PSInvalidRequestException extends PSRequestParsingException {
  /**
   * Default constructor. This exception is created when the request has insufficient information
  ...
  /**
   * Constructs a request parsing exception with the specified error contents. The error string is
   * formatted by loading the string associated with the error code and passing it the array of
   * arguments. Be sure to store the arguments in the correct order in the array, where {0} in the
   ...
   */
  public PSInvalidRequestException(int errorCode, Object[] arrayArgs) {
   ...
   *
   * @param msg the error string describing the error, may be <code>null</code> or empty
   */
