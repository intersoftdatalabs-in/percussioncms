...
public class PSRequestHandlerDef {
  ...
  public PSRequestHandlerDef(
    ...
    if (handlerName == null) throw new IllegalArgumentException("handlerName may not be null");

    if (className == null) throw new IllegalArgumentException("className may not be null");

    if (requestRoots == null) throw new IllegalArgumentException("requestRoots may not be null");

    if (!requestRoots.hasNext())
      throw new IllegalArgumentException("requestRoots must contain at least one entry");
  ...
  public void addRequestMethods(String requestRoot, Iterator<String> methods) {
    ...
    if (methods == null) throw new IllegalArgumentException("methods may not be null");
