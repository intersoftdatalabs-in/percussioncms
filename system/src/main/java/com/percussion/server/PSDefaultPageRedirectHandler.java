...
public class PSDefaultPageRedirectHandler implements IPSRequestHandler {
  ...
  public PSDefaultPageRedirectHandler(String fullRequestRoot, String defaultPage) {
    if (null == fullRequestRoot
      ...
      throw new IllegalArgumentException("Cannot provide empty parameters to constructor");
  ...
  public void processRequest(PSRequest request) {
    try {
      ...
      PSConsole.printMsg(
          "Server", "Could not process default page redirect request", new String[] {e.toString()});
    }
  }
