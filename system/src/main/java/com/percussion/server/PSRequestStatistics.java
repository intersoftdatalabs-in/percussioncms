...
public class PSRequestStatistics {
  ...
  public Element toXml(Document doc) {
    ...
    PSXmlDocumentBuilder.addElement(doc, root, "RowsInserted", String.valueOf(getRowsInserted()));
    PSXmlDocumentBuilder.addElement(doc, root, "RowsUpdated", String.valueOf(getRowsUpdated()));
    PSXmlDocumentBuilder.addElement(doc, root, "RowsDeleted", String.valueOf(getRowsDeleted()));
    PSXmlDocumentBuilder.addElement(doc, root, "RowsSelected", String.valueOf(getRowsSelected()));
    PSXmlDocumentBuilder.addElement(doc, root, "RowsSkipped", String.valueOf(getRowsSkipped()));
    PSXmlDocumentBuilder.addElement(doc, root, "RowsFailed", String.valueOf(getRowsFailed()));
    return root;
  }
