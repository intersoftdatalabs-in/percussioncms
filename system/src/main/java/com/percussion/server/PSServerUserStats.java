...
/**
 * This class will be used to represent one user\session information on E2 server. All the current
 * users on E2 server will be collected in a collection component and shown in UI of Admin applet.
 *
...
public class PSServerUserStats extends Object {
   ...
   *
   * @return <code>true</code> if there is no request processing for this user else <code>false
   *     </code>
   */
  ...
  /**
   * If the user session is not busy, the idle time will be returned, else this method returns 0.
   */
