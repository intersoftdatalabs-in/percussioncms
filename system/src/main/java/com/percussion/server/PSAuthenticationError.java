...
public class PSAuthenticationError extends PSLogError {
  /**
   * Constructs an authentication error for the supplied error code and parameters.
   *
   * @param errorCode the error code is a reference to the error message.
   * @param errorParams the message parameters formatted into the message at runtime, may be <code>
  ...
  /**
   * Constructs an authentication error for the supplied error code and parameter.
   *
   * @param errorCode the error code is a reference to the error message.
   * @param singleArg the message parameter formatted into the message at runtime, not <code>null
   *     </code>.
   */
   ...
   *
   * @param loc the locale to use to build the error messages, may be <code>null</code>.
  ...
  /**
   * An array of error message arguments, initialized in ctor, never changed after that. May be
   * <code>null</code>.
   */
