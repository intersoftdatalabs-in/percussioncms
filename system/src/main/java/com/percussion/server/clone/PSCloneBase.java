...
public abstract class PSCloneBase extends PSDefaultExtension implements IPSResultDocumentProcessor {
  ...
  protected void cloneChildObjects(
    ...
    if (queryResources.length != updateResources.length)
      throw new IllegalArgumentException("The length of query and update resources is different.");
  ...
  protected void updateContent(
    ...
    if (updateResourceName == null || updateResourceName.trim().length() < 1)
      throw new IllegalArgumentException("updateResourceName must not be be null or empty");
