...
public class PSCloneWorkflowExit extends PSCloneBase {
  ...
  public Document processResultDocument(
    ...
    if (targetWorkflowId.length() < 0) {
      request.printTraceMessage(
          "Error: Missing workflowid html parameter, "
  ...
  private static final String[] ms_queryResources = {
    ...
    "sys_wfCloning/QueryNotifications",
    "sys_wfCloning/QueryTransitions",
    "sys_wfCloning/QueryStateRoles",
    "sys_wfCloning/QueryTransitionRoles",
  ...
  private static final String[] ms_updateResources = {
    ...
    "sys_wfCloning/UpdateTransitions",
    "sys_wfCloning/UpdateStateRoles",
