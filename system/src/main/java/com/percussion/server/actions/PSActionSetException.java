...
public class PSActionSetException extends PSException {
   ...
   */
  public PSActionSetException(IPSErrorCode code) {
    super(code);
  }
   ...
   */
  public PSActionSetException(IPSErrorCode code, Object singleArg) {
   ...
   */
  public PSActionSetException(IPSErrorCode code, Object[] arrayArgs) {
