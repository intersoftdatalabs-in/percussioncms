...
public class PSCustomControlManager extends PSBaseControlManager {
  ...
  public void init(File rxRoot) {
    if (rxRoot == null || !rxRoot.exists()) {
      throw new IllegalArgumentException("rxRoot may not be null and must " + "exist");
    }

    if (m_rxRoot != null) {
      throw new IllegalStateException("Custom control manager has already " + "been initialized");
    }
  ...
  public void writeImports() {
    if (m_rxRoot == null) {
      throw new IllegalStateException("Custom control manager has not been " + "initialized");
    }
  ...
  public String createImport(String path) {
    if (StringUtils.isBlank(path)) throw new IllegalArgumentException("path may not be blank");
