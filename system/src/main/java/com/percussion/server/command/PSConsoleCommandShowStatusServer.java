 ...
 * @since      1.0
 */
public class PSConsoleCommandShowStatusServer
   extends PSConsoleCommandShowStatusHandler
{
    ...
    *
    */
   public PSConsoleCommandShowStatusServer(String cmdArgs)
      ...
      throws PSConsoleCommandException
   {
      ...
      PSServerStatistics stats = PSServer.getStatistics();
      if (stats != null) {
    ...
    */
   final static String   ms_cmdName = "show status server";
}
