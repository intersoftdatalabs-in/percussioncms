...
public class PSRemoteConsole {
  ...
  public Document execute(String command)
      throws PSIllegalArgumentException, PSServerException, PSAuthorizationException,
          PSAuthenticationFailedException, java.io.IOException {
    ...
    Element root = PSXmlDocumentBuilder.createRoot(sendDoc, "PSXRemoteConsoleCommand");
