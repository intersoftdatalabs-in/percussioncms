...
public class PSServerLockResult {
  ...
  PSServerLockResult(PSServerLock lock, List<PSServerLock> conflicts) {
    ...
    if (conflicts == null) throw new IllegalArgumentException("conflicts may not be null");

    if (conflicts.isEmpty()) throw new IllegalArgumentException("conflicts may not be empty");
