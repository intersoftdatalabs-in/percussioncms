...
public class PSPersistentProperty {
  ...
  private void fromXML(Element elem) {
    ...
    setUserName(lpsxml.getElementData(PSPersistentPropertyMeta.USERNAME_ELEM));
    setName(lpsxml.getElementData(PSPersistentPropertyMeta.PROPERTYNAME_ELEM));
    setCategory(lpsxml.getElementData(PSPersistentPropertyMeta.CATEGORY_ELEM));
  ...
  synchronized Element toXML(Document doc) {
    ...
    PSXmlDocumentBuilder.addElement(doc, root, PSPersistentPropertyMeta.CATEGORY_ELEM, m_category);
    PSXmlDocumentBuilder.addElement(doc, root, CONTEXT_ELEM, m_context);
    PSXmlDocumentBuilder.addElement(
        doc, root, PSPersistentPropertyMeta.PROPERTYNAME_ELEM, m_propertyName);
    PSXmlDocumentBuilder.addElement(doc, root, PSPersistentPropertyMeta.USERNAME_ELEM, m_userName);
    PSXmlDocumentBuilder.addElement(doc, root, PROPERTYVALUE_ELEM, m_propertyValue);
    return root;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(m_context, that.m_context)
        ...
        && Objects.equals(m_propertyName, that.m_propertyName)
        && Objects.equals(m_category, that.m_category)
        && Objects.equals(m_propertyValue, that.m_propertyValue)
  ...
  public int hashCode() {
    return Objects.hash(
        m_context, m_userName, m_propertyName, m_category, m_propertyValue, m_action);
  }
