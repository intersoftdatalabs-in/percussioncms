...
public interface IPSContentDataHandler extends IPSPortActionHandler {
  ...
  PSServerItem updateItem(PSRequest request, Element item, PSLocator loc, long typeId)
      throws PSException;

  void processInsertItem(PSRequest request, String folderContenttype, Element toXml)
      throws PSException;
}
