    ...
    try {
      ...
      if (inputDoc == null) {
        ...
        if (inputDocParam != null && inputDocParam.trim().length() > 0) {
          inputDoc = PSXmlDocumentBuilder.createXmlDocument(new StringReader(inputDocParam), false);
        } else {
      ...
      String responseRoot = PSStringOperation.singleReplace(rootName, "Request", "Response");
      ...
      String name = "com.percussion.server.webservices.PS" + port + "Handler";
