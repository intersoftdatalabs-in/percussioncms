...
/**
 * Enumeration for the cross site link types that are processed by this processor. Each type is
 * identified by a unique ordinal value and name. These map closely to the terminology used in the
 * specification.
 */
public enum PSCrossSiteLinkTypeEnum {
  ...
  /** Name value for the cross site link type, initialized in the ctor, never modified. */
