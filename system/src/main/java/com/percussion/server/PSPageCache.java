...
public class PSPageCache extends Thread {
  ...
  public static PSPageCache getInstance() {
    if (ms_instance == null) ms_instance = new PSPageCache();
  ...
  public static synchronized void cleanCache() {
    ...
    while (pages.hasNext()) {
      ...
      if (timestamp.before(current)) pages.remove();
    }
  }
  ...
  public static Map<Integer, List<Object>> createFIFOCache() {
    ...
    LinkedHashMap<Integer, List<Object>> unSyncedHash =
        new LinkedHashMap<Integer, List<Object>>() {
