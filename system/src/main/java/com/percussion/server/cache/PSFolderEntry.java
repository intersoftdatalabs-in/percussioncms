...
public class PSFolderEntry extends PSItemEntry {
  ...
  PSFolderEntry(PSFolder folder) {
    super(
        ((PSLocator) folder.getLocator()).getId(),
        folder.getName(),
        folder.getCommunityId(),
        FOLDER_CONTENT_TYPE_ID,
  ...
  public String getGlobalTemplateProperty() {
    ...
    else return m_folder.getGlobalTemplateProperty();
  }
  ...
  public Element toXml(Document doc) {
    if (m_folderAcl == null) {
      ...
      if (m_folder != null) root.appendChild(m_folder.toXml(doc));
      return root;
    }
  }
  ...
  public void setName(String name) {
    ...
    if (m_folder != null) m_folder.setName(name);
  }
  ...
  void setPubFileNameProperty(String pubFileName) {
    ...
    if (m_pubFileNameProperty != null) m_pubFileNameProperty = m_pubFileNameProperty.trim();
  }
