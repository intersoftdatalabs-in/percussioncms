...
public class PSCacheProxy {
  ...
  public static void flushAssemblers(
    ...
    if (contentId != null) keyMap.put(PSAssemblerCacheHandler.KEY_ENUM[1], contentId.toString());
    if (revision != null) keyMap.put(PSAssemblerCacheHandler.KEY_ENUM[2], revision.toString());
    if (variantId != null) keyMap.put(PSAssemblerCacheHandler.KEY_ENUM[3], variantId.toString());
  ...
  public static void flushResources(String appName, String dataSetName) throws PSCacheException {
    PSCacheManager mgr = PSCacheManager.getInstance();
    IPSCacheHandler handler = mgr.getCacheHandler(PSResourceCacheHandler.HANDLER_TYPE);
