...
public class PSDataSource implements DataSource {
  ...
  private Connection createConnection(String user, String pwd) throws SQLException {
    ...
    Properties props = PSSqlHelper.makeConnectProperties(m_url, m_database, username, password);
  ...
  /** Database connection url. Initialized in constructor, never <code>null</code> after that. */
  private String m_url;

  /** Database name. Initialized in constructor, never <code>null</code> after that. */
  private String m_database;

  /** Database user name. Initialized in constructor, never <code>null</code> after that. */
  private String m_username;

  /** Database driver class. Initialized in constructor, never <code>null</code> after that. */
  ...
  /**
   * The currently loaded driver used for creating connections. Set in {@link
   * #createConnection(String, String)}.
   */
  private Driver m_driver;

  /** Database user password. Initialized in constructor, never <code>null</code> after that. */
