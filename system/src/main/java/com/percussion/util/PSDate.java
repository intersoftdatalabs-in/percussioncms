...
public class PSDate {
  ...
  public void setYearMonthDay(int year, int month, int day) {
    if ((month < 1) || (month > 12)) ruleViolation();
    if ((month == 2) && (isLeapYear(year))) {
      if ((day < 1) || (day > 29)) ruleViolation();
    } else {
      if ((day < 1) || (day > dayArray[month])) ruleViolation();
    }
  ...
  public void setTime(int hour, int minute, int second) {
    if ((hour < 0) || (hour >= 24)) ruleViolation();
    if ((minute < 0) || (minute >= 60)) ruleViolation();
    if ((second < 0) || (second >= 60)) ruleViolation();
  ...
  public void setDateOfMonth(int day) {
    if ((m_month == 2) && (isLeapYear(m_year))) {
      ...
      if ((day < 1) || (day > dayArray[m_month])) ruleViolation();
    }
