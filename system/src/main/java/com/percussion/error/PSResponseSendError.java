...
/**
 * The PSResponseSendError class is used to report errors encountered while attempting to respond to
 * a request. This usually occurs when an I/O error occurs sending the response.
 *
...
public class PSResponseSendError extends PSLogError {
   ...
   */
  public PSResponseSendError(int applId, String sessId, int errorCode, Object[] errorParams) {
    super(applId);
    m_sessId = sessId;
   ...
   */
  public PSResponseSendError(int applId, String sessId, int errorCode, Object singleArg) {
