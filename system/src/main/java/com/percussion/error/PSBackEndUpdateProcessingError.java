...
public class PSBackEndUpdateProcessingError extends PSBackEndError {
  ...
  public PSBackEndUpdateProcessingError(
    ...
    this(
        ...
        new Object[] {new Integer(errorCode), ((errorString == null) ? "" : errorString)},
        updateString,
        null); // xml tree
  }
  ...
  public PSBackEndUpdateProcessingError(
    ...
    this(applId, sessionId, errorCode, errorParams, source, null); // xml tree
  }
  ...
  public PSBackEndUpdateProcessingError(
    ...
    if (sourceSql == null) m_sourceSql = "";
    else m_sourceSql = sourceSql;
  ...
  protected PSLogSubMessage[] buildSubMessages(Locale loc) {
    ...
    int errorCount = 0;
    for (err = this; err != null; err = err.m_next) errorCount += 3;
