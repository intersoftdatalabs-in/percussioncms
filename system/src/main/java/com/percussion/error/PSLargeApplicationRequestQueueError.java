...
/**
 * The PSLargeApplicationRequestQueueError class is used to report large requests queues. This may
 * signify that the number of user threads permitted is insufficient to handle the load, or the
 * amount of time to process a request is taking too long.
 *
