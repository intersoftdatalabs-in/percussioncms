...
/**
 * This is the base class for all test results produced by different methods in the {@link IPSEffect
 * interface}. Implements common methods to pass informtion from the methods to relationship engine
 * after execution.
 */
public class PSResult {
  ...
  public void setError(PSException exception) {
    if (exception == null) throw new IllegalArgumentException("exception must not be null");
