...
public class PSErrorHandlerTest {
  ...
  public static void main(String[] args) {
    if (args.length != 3) {
      ...
      log.info("");
      log.info(
          "  eg: java com.percussion.error.PSErrorHandlerTest myname@percussion.com pan"
              + " rhythmyx@percussion.com");
      System.exit(1);
    }
    ...
    try {
      ...
      PSApplicationAuthorizationError appAuthErr =
          new PSApplicationAuthorizationError(11, ip, login, errCode, null);
