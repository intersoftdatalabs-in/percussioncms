...
/**
 * Exception to indicate something that is being processed by the server would violate some kind of
 * non-unique constraint.
 */
public class PSDeployNonUniqueException extends PSDeployException {
  /**
   * Constructs a PSDeployNonUniqueException with the specified error code and argument.
   *
   ...
   */
  // Removed duplicate constructor; see below for correct overloads.
  // ...existing code...
  // ...existing code...
  /**
   ...
   *     by the base class's {@link PSDeployException#toXml(Document) toXml} method documentation.
   *     May not be <code>null</code>.
   * @throws IllegalArgumentException if <code>source</code> is <code>null</code>.
   * @throws PSUnknownNodeTypeException if the XML element node does not represent a type supported
   *     by the class.
   */
  public PSDeployNonUniqueException(Element source) throws PSUnknownNodeTypeException {
    super(source);
  }

  /**
   * Sets the original exception class to this class so that when restored from XML as a <code>
   * PSDeployException</code>, it can be converted back to this type of exception. See {@link
   * PSDeployException#toXml(Document) super.toXml()} for more info.
   */
