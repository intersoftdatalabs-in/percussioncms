...
public class PSErrorHumanReadableNames {
  ...
  protected static void lazyInit() {
    ...
    synchronized (ms_syncObj) {
      ...
      // check for null
      if (ms_errorNames == null) ms_errorNames = new PSBijectionMap(20);
    }

    ms_errorNames.put(
        com.percussion.error.PSApplicationAuthorizationError.class, "Application authorization");
    ms_errorNames.put(com.percussion.error.PSApplicationDesignError.class, "Application design");
    ms_errorNames.put(
        com.percussion.error.PSBackEndAuthorizationError.class, "Back end authorization");
    ms_errorNames.put(com.percussion.error.PSBackEndQueryProcessingError.class, "Back end query");
    ms_errorNames.put(com.percussion.error.PSBackEndServerDownError.class, "Back end server down");
    ms_errorNames.put(
        com.percussion.error.PSBackEndUpdateProcessingError.class, "Back end update processing");
    ms_errorNames.put(com.percussion.error.PSDataConversionError.class, "Data conversion");
    ms_errorNames.put(com.percussion.error.PSFatalError.class, "Fatal");
    ms_errorNames.put(com.percussion.error.PSHtmlProcessingError.class, "HTML processing");
    ms_errorNames.put(
        com.percussion.error.PSLargeApplicationRequestQueueError.class,
        "Large application request queue");
    ms_errorNames.put(
        com.percussion.error.PSLargeBackEndRequestQueueError.class, "Large back end request queue");
    ms_errorNames.put(
        com.percussion.error.PSRequestHandlerNotFoundError.class, "Request handler not found");
    ms_errorNames.put(
        com.percussion.error.PSRequestPreProcessingError.class, "Request preprocessing");
    ms_errorNames.put(com.percussion.error.PSValidationError.class, "Validation");
    ms_errorNames.put(com.percussion.error.PSXmlProcessingError.class, "XML processing");
  }
