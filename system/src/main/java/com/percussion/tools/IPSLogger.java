...
public interface IPSLogger {
   ...
   * @throws IllegalArgumentException if the msg is <code>null</code> or <code>empty</code>.
   ...
   * debug mode. This method is normally used to log a extra information for debug purpose.
   *
   * @param msg - the message to be logged, must not be <code>null</code>.
   * @throws IllegalArgumentException if the msg is <code>null</code> or <code>empty</code>.
   * @deprecated use log4j methods.
  ...
  /**
   * If an <code>IOException</code> occurs while logging, the exception will be available through
   * this method.
   *
   * @return the exception message or <code>null</code> if no exception occurred.
   * @deprecated use log4j methods.
   */
