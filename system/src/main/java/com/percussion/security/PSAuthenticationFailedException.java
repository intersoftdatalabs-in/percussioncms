...
/**
 * PSAuthenticationFailedException is thrown to indicate that a user failed to authenticate through
 * the specified provider. This usually means that either the user id or the password is incorrect.
 *
