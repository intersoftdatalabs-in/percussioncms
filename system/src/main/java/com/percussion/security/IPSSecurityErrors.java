...
public interface IPSSecurityErrors {
  ...
  /**
   * initialization of the specified security provider failed due to an exception
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * authentication failed through a security provider for the specified reason
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * cataloging for the specified security provider has been disabled due to an initialization
   * exception
   *
   * <p>The arguments passed in for this message are:
   *
  ...
  /**
   * when security provider instance name is used as key to put objects into a hashmap, this integer
   * is a warning message code.
   */
  public static final int PROVIDER_INSTANCE_NAME_DUPLICATED = 9014;

  /** when calling a native method to process authentication, it failed to give a normal result. */
  public static final int NATIVE_AUTHENTICATION_FAILURE = 9015;

  /**
   * The server requires a larger key strength than the one associated with a request.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * The security subsystem has not been initialized, so no authorizations can be performed.
   *
   * <p>No arguments for this message.
   */
  ...
  /**
   * If multiple security providers are used during login, and none of them succeed, this error may
   * be returned.
   *
   * <p>The arguments passed in for this message are:
   *
  ...
  /**
   * When detailed error messages about failures is disabled, this message is returned.
   *
   * <p>No arguments for this message.
   */
  ...
  /**
   * If a security system can't access the data it needs to perform a requested action, (say meta
  ...
  /**
   * PSHostAddressFilterEntry constructor called with a filter string with no filter (asterisk)
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * PSOsProvider.impersonate was called to impersonate user id and password. Pass-in arguments are
   * not needed.
   */
  public static final int OS_IMPERSONATE_FAILURE = 9601;

  /**
   * PSOsProviderMeta.getObjects was called but the calling of native impersonate method failed.
   * Pass-in arguments are not needed.
   */
  public static final int OSMETA_GET_OBJECTS_FAILURE = 9602;

  /**
   * PSOsProviderMeta.getObjectTypes was called but the calling of native impersonate method failed.
   * Pass-in arguments are not needed.
   */
  public static final int OSMETA_GET_OBJECT_TYPES_FAILURE = 9603;

  /**
   * PSOsProviderMeta.getServers was called but the calling of native impersonate method failed.
   * Pass-in arguments are not needed.
   */
  public static final int OSMETA_GET_SERVERS_FAILURE = 9604;

  /**
   * PSOsProviderMeta.getAttributes was called but the calling of native impersonate method failed.
   * Pass-in arguments are not needed.
   */
  public static final int OSMETA_GET_ATTRIBUTES_FAILURE = 9605;

  /**
   * PSRoleProvider.createRoleEntry was called with a role name which was not previously defined
   * using PSRoleProvider.defineRoleEntry (for app ACL)
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * PSRoleProvider.createRoleEntry was called with a role name which was not previously defined
   * using PSRoleProvider.defineRoleEntry (for server ACL)
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * PSRoleProvider.defineRoleEntry was called with a role name which was already defined (for
   * private roles)
   *
   * <p>The arguments passed in for this message are:
   *
  ...
  /**
   * PSRoleManager/addApplicationRoles is called with a role name already defined, but overwrite is
   * not specified.
   */
  public static final int ROLE_OVERWRITE_REQD = 9707;

  /**
   * Could not obtain a handler for the application that is used to catalog role stuff. This could
   * be because the app isn't running or because it is missing a necessary resource.
   */
  ...
  /**
   * Multiple entries were returned when trying to look up a single user, therefore authentication
   * failed.
   *
   * <p>The arguments passed in for this message are:
   *
  ...
  /**
   * An error occurred trying to initialize the password filter instance.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * An error occurred trying to shut down the back end table resources.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * The back end table found multiple user entries with the same user id.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * If no email attribute name is specified, an unsupported exception will be thrown with this
   * error message if one makes a request for a users email address.
   */
  public static final int NO_EMAIL_ATTRIBUTE_NAME = 9853;

  /**
   * Unknown error occurred during a directory catalog request to the backend directory cataloger.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * The invocation target error while instantiating the requested catalog provider class.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
  ...
  /**
   * A required constructor was not found while instantiating the requested catalog provider class.
   *
   * <p>The arguments passed in for this message are:
   *
   * <TABLE BORDER="1"><CAPTION>Error Arguments</CAPTION>
