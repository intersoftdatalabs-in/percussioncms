...
/**
 * PSAuthorizationException is thrown to indicate that authorization has been denied to the
 * requested resource. This may occur when connecting to the server, or when attempting to access an
 * application.
 *
