...
public class PSOdbcProviderMetaData extends PSSecurityProviderMetaData {
  ...
  public java.util.Properties getConnectionProperties() {
    ...
    props.put(
        PSOdbcProvider.PROPS_SERVER_NAME,
        "The ODBC Data Source Name (DSN) to authenticate through.");

    props.put(
        PSOdbcProvider.PROPS_LOGIN_ID, "The user id to use when cataloging against this provider.");

    props.put(
        PSOdbcProvider.PROPS_LOGIN_PW,
  ...
  public java.sql.ResultSet getServers() throws java.sql.SQLException {
    com.percussion.data.jdbc.PSOdbcDriverMetaData psOdbc =
        new com.percussion.data.jdbc.PSOdbcDriverMetaData();
    ...
    try {
      ...
      Object[] args = {
        "A sql exception occurred", PSOdbcProvider.SP_NAME, m_instance, PSSqlException.toString(e)
      };
