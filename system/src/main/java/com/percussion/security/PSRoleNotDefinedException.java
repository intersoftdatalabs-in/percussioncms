...
/**
 * PSRoleNotDefinedException is thrown to indicate that a role reference was made to a role the role
 * security rovider does not know about.
 *
...
public class PSRoleNotDefinedException extends PSException {
  /**
   * Constructs a role not defined exception with the default message.
   *
  ...
  /**
   * Constructs a role not defined exception for non-application ACLs with the default message. If
   * an application ACL is throwing this exception, be sure to use the constructor which takes the
