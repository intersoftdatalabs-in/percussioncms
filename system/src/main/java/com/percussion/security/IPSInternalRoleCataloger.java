...
public interface IPSInternalRoleCataloger {
   ...
   * @param includeEmpty <code>true</code> to include subjects with an empty attribute list, <code>
   *     false</code> otherwise.
   * @return A valid set with 0 or more PSSubject objects. The caller takes ownership of the set and
