...
public class PSNavFolder {
   ...
   */
  public PSNavFolder(PSComponentSummary folder, PSComponentSummary navon) throws PSNavException {
    if (folder == null) {
  ...
  public boolean equals(Object o) {
    if (o instanceof PSNavFolder) {
      ...
      if (this.m_folderSummary.getCurrentLocator().getId()
          == other.m_folderSummary.getCurrentLocator().getId()) {
        return true;
      }
    }
    return false;
