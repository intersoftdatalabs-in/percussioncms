...
public interface IPSNavigationErrors {
  ...
  int NAVIGATION_SERVICE_FAILED_TO_MOVE_SECTION_BECAUSE_TARGET_ALREADY_HAS_ITEM =
      NAVIGATION_SERVICE_CATEGORY + 4;
  int NAVIGATION_SERVICE_NAVTREE_CANNOT_BE_ADDED_TO_FOLDER_WITH_NAVON =
      NAVIGATION_SERVICE_CATEGORY + 5;
  int NAVIGATION_SERVICE_NAVTREE_CANNOT_BE_ADDED_TO_FOLDER_WITH_NAVTREE =
      NAVIGATION_SERVICE_CATEGORY + 6;
