...
public class PSNavComponentSummary {
   ...
   */
  public PSNavComponentSummary(PSLocator loc) throws PSNavException {
    this(loc.getId());
  }
   ...
   * @throws PSNavException
   */
  public PSNavComponentSummary(int id) throws PSNavException {
    Connection conn = PSNavSQLUtils.connect();
    PreparedStatement stmt = null;
    ResultSet rs = null;

    try {
      stmt = PSPreparedStatement.getPreparedStatement(conn, getSqlStatement());
      stmt.setInt(1, id);
