...
public class PSGlobalTemplateCatalogerExit extends PSDefaultExtension
  ...
  public Document processResultDocument(
    ...
    while (names.hasNext()) {
      ...
      templateElem.setAttribute(ROOT_TEMPLATE_NAME_ATTR, name + ROOT_EXTENSION);
  ...
  private Iterator<String> getTemplateNames() throws PSExtensionProcessingException {
    final IPSAssemblyService assembly = PSAssemblyServiceLocator.getAssemblyService();
    try {
      final Set<String> templateNames = assembly.findAll57GlobalTemplates();
      final Set<IPSAssemblyTemplate> templates = assembly.findAllGlobalTemplates();
  ...
  private static final String GLOBAL_TEMPLATES_ELEM = "GlobalTemplates";
  private static final String TEMPLATE_ELEM = "Template";
  private static final String NAME_ATTR = "name";
  private static final String FILE_NAME_ATTR = "fileName";
  private static final String ROOT_TEMPLATE_NAME_ATTR = "rootTemplateName";
}
