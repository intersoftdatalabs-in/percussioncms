...
public class PSLocale implements IPSCatalogSummary {
  ...
  public PSLocale(String languageString, String displayName, String description, int status) {
    ...
    if (!validateStatus(status)) throw new IllegalArgumentException("invalid status");
  ...
  PSLocale(PSJdbcRowData rowData) throws PSDataExtractionException {
    ...
    m_languageString = getColumnValue(rowData, PSLocaleHandler.COL_LANGUAGE_STRING, true);
    m_displayName = getColumnValue(rowData, PSLocaleHandler.COL_DISPLAY_NAME, true);
  ...
  public Element toXml(Document doc) {
    ...
    if (m_description != null)
      PSXmlDocumentBuilder.addElement(doc, root, EL_DESCRIPTION, m_description);
  ...
  public void fromXml(Element source) throws PSUnknownNodeTypeException {
    ...
    if (version != -1) m_version = version;

    m_description = null;
    PSXmlTreeWalker tree = new PSXmlTreeWalker(source);
    Element descEl = tree.getNextElement(EL_DESCRIPTION, PSXmlTreeWalker.GET_NEXT_ALLOW_CHILDREN);
    if (descEl != null) {
  ...
  public boolean equals(Object o) {
    ...
    return m_localeId == psLocale.m_localeId
        && m_status == psLocale.m_status
        && Objects.equals(m_languageString, psLocale.m_languageString)
        && Objects.equals(m_displayName, psLocale.m_displayName)
        && Objects.equals(m_description, psLocale.m_description)
        && Objects.equals(m_version, psLocale.m_version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        m_languageString, m_displayName, m_description, m_localeId, m_status, m_version);
  }
