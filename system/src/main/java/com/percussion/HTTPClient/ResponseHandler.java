...
/**
 * This holds various information about an active response. Used by the StreamDemultiplexor and
 * RespInputStream.
 *
...
final class ResponseHandler {
  ...
  /**
   * signals that the demux has closed the response stream, and that therefore no more data can be
   * read
   */
  boolean eof = false;
  ...
  /**
   * return the compilation of the boundary string for this response. Set's up the InputStream
