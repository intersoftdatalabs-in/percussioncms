 ...
 *
 * @see com.percussion.HTTPClient.CookieModule#setCookiePolicyHandler(CookiePolicyHandler)
...
public interface CookiePolicyHandler {
   ...
   * This enables you to implement your own cookie acceptance policy.
   *
   ...
   * @return true if this cookie should be accepted, false if it is to be rejected.
   */
  boolean acceptCookie(Cookie cookie, RoRequest req, RoResponse resp);

  /**
   * This method is called for each cookie that is eligible for sending with a request (according to
   * the matching rules for the path, domain, protocol, etc). This enables you to control the
   * sending of cookies.
   *
   * @param cookie the cookie in question
