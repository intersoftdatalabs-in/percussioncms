...
public class AuthSchemeNotImplException extends ModuleException {
  ...
  /**
   * Constructs an AuthSchemeNotImplException with no detail message. A detail message is a String
  ...
  /**
   * Constructs an AuthSchemeNotImplException class with the specified detail message. A detail
