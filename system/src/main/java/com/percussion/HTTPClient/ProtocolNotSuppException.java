...
public class ProtocolNotSuppException extends IOException {
  ...
  /**
   * Constructs an ProtocolNotSuppException with no detail message. A detail message is a String
  ...
  /**
   * Constructs an ProtocolNotSuppException class with the specified detail message. A detail
