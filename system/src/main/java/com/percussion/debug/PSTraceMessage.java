...
public abstract class PSTraceMessage implements IPSTraceMessage {
  ...
  public void printTrace(PSTraceInfo traceInfo, Object source, PSTraceWriter target)
    ...
    // add the timestamp
    if (m_formatter == null) m_formatter = FastDateFormat.getInstance(TS_FORMAT);
    ...
    PSLineBreaker breaker =
        new PSLineBreaker(new String(header), traceInfo.getColumnWidth(), lineBreakMax);
