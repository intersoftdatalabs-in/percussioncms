...
public class PSTraceMessageFactory {
  ...
  public static IPSTraceMessage getTraceMessage(int typeFlag) {
    ...
    if (message == null) throw new IllegalArgumentException("Invalid trace flag");
    ...
    synchronized (m_optionLists) {
      ...
      if (optionList == null) {
        ...
        ResourceBundle bundle =
            ResourceBundle.getBundle("com.percussion.server.PSStringResources", locale);

        optionList.add(
            new PSTraceOption(
                BASIC_REQUEST_INFO_FLAG,
