...
public class PSCommonSearchUtils {
  ...
  public static String OP_EQUALS =
      PSI18NTranslationKeyValues.getInstance().getTranslationValue(EDITOR_I18N_PREFIX + "@Equals");
  public static String OP_GREATER_THAN =
      PSI18NTranslationKeyValues.getInstance()
          .getTranslationValue(EDITOR_I18N_PREFIX + "@Greater than");
  public static String OP_LESS_THAN =
      PSI18NTranslationKeyValues.getInstance()
          .getTranslationValue(EDITOR_I18N_PREFIX + "@Less than");
  public static String OP_ON =
      PSI18NTranslationKeyValues.getInstance().getTranslationValue(EDITOR_I18N_PREFIX + "@On");
  public static String OP_AFTER =
      PSI18NTranslationKeyValues.getInstance().getTranslationValue(EDITOR_I18N_PREFIX + "@After");
  public static String OP_BEFORE =
      PSI18NTranslationKeyValues.getInstance().getTranslationValue(EDITOR_I18N_PREFIX + "@Before");
  public static String OP_BETWEEN =
      PSI18NTranslationKeyValues.getInstance().getTranslationValue(EDITOR_I18N_PREFIX + "@Between");
  ...
  public static String OP_STARTS_WITH =
      PSI18NTranslationKeyValues.getInstance()
          .getTranslationValue(EDITOR_I18N_PREFIX + "@Starts with");
  ...
  public static String validateFTSSearchQuery(
    ...
    if (query.length() > PSSProperty.VALUE_LENGTH) {
      String key = SEARCH_SIMPLE_I18N_PREFIX + "@Search query too long";
      if (translator == null) {
