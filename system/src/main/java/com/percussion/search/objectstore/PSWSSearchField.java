...
public class PSWSSearchField {
  ...
  public Element toXml(Document doc) {
    ...
    root.setAttribute(ATTR_CONNECTOR, CONN_ATTR_VALUES[m_connector.getOrdinal()]);
  ...
  private void fromXml(Element src) throws PSUnknownNodeTypeException {
    ...
    m_operator =
        PSOperatorEnum.valueOf(
            PSXMLDomUtil.checkAttributeEnumerated(src, ATTR_OPERATOR, OP_ATTR_VALUES, false));
    m_connector =
        PSConnectorEnum.valueOf(
            PSXMLDomUtil.checkAttributeEnumerated(src, ATTR_CONNECTOR, CONN_ATTR_VALUES, false));
    m_externalOperator = PSXMLDomUtil.checkAttribute(src, ATTR_EXT_OPERATOR, false).trim();
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PSWSSearchField)) isEqual = false;
    else if (this != obj) {
      PSWSSearchField other = (PSWSSearchField) obj;
      if (!m_name.equals(other.m_name)) isEqual = false;
      else if (m_operator != other.m_operator) isEqual = false;
      else if (!m_externalOperator.equals(other.m_externalOperator)) isEqual = false;
      else if (!m_value.equals(other.m_value)) isEqual = false;
      else if (m_connector != other.m_connector) isEqual = false;
    }
  ...
  public enum PSOperatorEnum {
    ...
    public static PSOperatorEnum valueOf(int ordinal) {
      ...
      throw new IllegalArgumentException("No operator is defined for the supplied ordinal.");
    }
  ...
  public enum PSConnectorEnum {
    ...
    public static PSConnectorEnum valueOf(int ordinal) {
      ...
      throw new IllegalArgumentException("No connector is defined for the supplied ordinal.");
    }
