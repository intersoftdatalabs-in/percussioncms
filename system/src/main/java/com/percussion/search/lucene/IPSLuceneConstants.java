...
/** This file consists of constants that are used in lucene search engine implementation. */
public interface IPSLuceneConstants {
  ...
  public static final String MIME_TYPE_APPLICATION_BY_VNDMSPOWERPOINT =
  ...
  public static final String MIME_TYPE_APPLICATION_BY_OPENXML_MSWORD_DOC =
      "application/vnd.openxmlformats-officedocument.wordprocessingml.document";

  /** Mime type for word template (dotx) format */
  public static final String MIME_TYPE_APPLICATION_BY_OPENXML_MSWORD_TEMPLATE =
      "application/vnd.openxmlformats-officedocument.wordprocessingml.template";

  /** Mime type for powerpoint potx format */
  public static final String MIME_TYPE_APPLICATION_BY_OPENXML_MSPOWERPOINT_TEMPLATE =
      "application/vnd.openxmlformats-officedocument.presentationml.template";

  /** Mime type for the powerpoint pptx format */
  public static final String MIME_TYPE_APPLICATION_BY_OPENXML_MSPOWERPOINT_PRES =
      "application/vnd.openxmlformats-officedocument.presentationml.presentation";

  /** Mime type for the Excel xlsx format */
  public static final String MIME_TYPE_APPLICATION_BY_OPENXML_MSEXCEL_SHEET =
      "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";

  /** Mime type for the Excel xltx format */
  public static final String MIME_TYPE_APPLICATION_BY_OPENXML_MSEXCEL_TEMPLATE =
  ...
  /**
   * A property that must be supplied when the instance of this class is obtained. If exists must be
   * a valid directory. All path separators are normalized to forward slash before use.
   */
