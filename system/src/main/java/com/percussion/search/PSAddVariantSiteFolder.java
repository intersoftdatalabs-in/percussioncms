...
public class PSAddVariantSiteFolder extends PSDefaultExtension
   ...
   */
  public List<Object> processRows(
      @SuppressWarnings("unused") Object[] params, List<Object> rows, IPSRequestContext request)
  ...
  private List<Object> expandBySiteFolders(IPSRequestContext request, List<Object> rows)
    ...
    Map<String, String[]> cidFolderMap =
        getParentFolderPaths(request, contentIdSet.toArray(new String[0]));
  ...
  private Set<SiteFolder> getSiteFolderSetForPath(
    ...
    for (String key : siteMap.keySet()) {
      if (path.startsWith(key)) return siteMap.get(key);
    }
    return null;
  }
