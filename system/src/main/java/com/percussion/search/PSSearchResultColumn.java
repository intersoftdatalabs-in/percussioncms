...
public class PSSearchResultColumn {
  ...
  public void fromXml(Element sourceNode) throws PSUnknownNodeTypeException {
    ...
    m_displayValue = PSXMLDomUtil.checkAttribute(sourceNode, ATTR_DISPLAY_VALUE, false);
  }
  ...
  public boolean equals(Object obj) {
    ...
    return m_name.equals(s2.m_name)
        && m_value.equals(s2.m_value)
  ...
  public String getDisplayValue() {
    if (m_displayValue == null || m_displayValue.length() == 0) return m_value;
