...
public class PSEffectTestRunner {
  ...
  public static void run(
      ...
      throws PSNotFoundException, PSExtensionException, PSExtensionProcessingException,
          PSDataExtractionException, PSParameterMismatchException {
    if (execContext == null) throw new IllegalArgumentException("execContext must not be null");
