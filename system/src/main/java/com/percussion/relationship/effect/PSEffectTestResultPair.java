...
/**
 * This class represents a pair of effect, and it's test result. The effect processing can make use
 * of this class to gather all effects their test results. The analysis of test results is done
 * later before running the attempt() methods of the effects.
 *
...
public class PSEffectTestResultPair {
  ...
  /** Effect object, initialized in the ctor and never <code>null</code> after that. */
  private PSConditionalEffect m_effect = null;

  /** Result object, initialized in the ctor and never <code>null</code> after that. */
