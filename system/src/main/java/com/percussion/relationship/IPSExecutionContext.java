...
public interface IPSExecutionContext {
   ...
   */
  @Deprecated int RS_POST_CONSTRUCTION = RS_PRE_CONSTRUCTION;
   ...
   */
  @Deprecated int RS_POST_DESTRUCTION = RS_PRE_DESTRUCTION;
   ...
   */
  @Deprecated int RS_POST_UPDATE = RS_PRE_UPDATE;
