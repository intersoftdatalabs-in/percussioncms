...
/**
 * A self-describing content. This interface extends IPSMimeContentDescriptor, which means it has
 * all of the MIME typing, but with the added semantics of representing open (or openable)
 * resources.
 */
