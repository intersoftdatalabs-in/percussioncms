...
public class PSFUDContentTypeNode extends PSFUDAbstractNode {
  ...
  public Object[] getChildren() {
    ...
    NodeList nl = m_Element.getElementsByTagName(PSFUDApplication.ELEM_CONTENTITEM);
    if (null != nl) {
  ...
  public String toString() {
    String value =
        m_Element.getAttribute(PSFUDApplication.ATTRIB_NAME).trim()
            + " (ID:"
            + m_Element.getAttribute(PSFUDApplication.ATTRIB_CATEGORYID).trim()
            + ")";
