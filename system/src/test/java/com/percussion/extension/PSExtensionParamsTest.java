...
public class PSExtensionParamsTest {
  ...
  public void testReplacementValues() throws Exception {
    ...
    Date today = new Date();
    PSLiteral c = new PSDateLiteral(today, FastDateFormat.getInstance("yyyy/MM/dd HH:mm:ss.SSS"));
  ...
  /**
   * Test cases that the numeric param should be <code>null</code> and not <code>0</code>
   *
   * @throws Exception
   */
