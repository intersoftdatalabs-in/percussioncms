...
public class PSActionVisibilityCheckerTest {
  ...
  public void testBasics() {
    PSActionVisibilityChecker checker = new PSActionVisibilityChecker(-1, true, null);
    assertTrue(
        checker.isVisible(
            (PSActionVisibilityGlobalState) null,
            (Collection<PSActionVisibilityObjectState>) null));
  ...
  /** Tests all contexts that are exposed in {@link PSActionVisibilityGlobalState}. */
  @Test
  public void testGlobalStates() {
    genericCheckGlobalVisibility(PSActionVisibilityContext.VIS_CONTEXT_COMMUNITY);
    genericCheckGlobalVisibility(PSActionVisibilityContext.VIS_CONTEXT_CLIENT_CONTEXT);
    genericCheckGlobalVisibility(PSActionVisibilityContext.VIS_CONTEXT_LOCALES_TYPE);
    checkGlobalVisibilityRoles();
  }

  /** Tests all contexts that are exposed in {@link PSActionVisibilityObjectState}. */
  @Test
  public void testObjectStates() {
    // integer types
    genericCheckObjectVisibility(PSActionVisibilityContext.VIS_CONTEXT_ASSIGNMENT_TYPE);
    genericCheckObjectVisibility(PSActionVisibilityContext.VIS_CONTEXT_CONTENT_TYPE);
    genericCheckObjectVisibility(PSActionVisibilityContext.VIS_CONTEXT_OBJECT_TYPE);
    genericCheckObjectVisibility(PSActionVisibilityContext.VIS_CONTEXT_WORKFLOWS_TYPE);

    // string types
    genericCheckObjectVisibility(PSActionVisibilityContext.VIS_CONTEXT_PUBLISHABLE_TYPE);
  ...
  private void checkVisibilityFolderSecurity() {
    ...
    PSActionVisibilityContext ctx =
        new PSActionVisibilityContext(contextId, new String[] {"Read"}, null);
    vcs.add(ctx);
    PSActionVisibilityChecker checker = new PSActionVisibilityChecker(300, true, vcs);
    ...
    stateMap.put(contextId, new PSFolderPermissions(PSObjectPermissions.ACCESS_READ));
    os.reset(stateMap);
    assertFalse(checker.isVisible((PSActionVisibilityGlobalState) null, os));

    stateMap.put(
        contextId,
        new PSFolderPermissions(
            PSObjectPermissions.ACCESS_READ | PSObjectPermissions.ACCESS_WRITE));
    os.reset(stateMap);
  ...
  private void checkGlobalVisibilityRoles() {
    ...
    Map<String, Object> stateMap = new HashMap<String, Object>();
    stateMap.put(
        PSActionVisibilityContext.VIS_CONTEXT_ROLES_TYPE, Arrays.asList(new String[] {"r3", "r5"}));
    GenericGlobalState gs = new GenericGlobalState(stateMap);
    assertFalse(checker.isVisible(gs, (Collection) null));

    stateMap.put(
        PSActionVisibilityContext.VIS_CONTEXT_ROLES_TYPE, Arrays.asList(new String[] {"r3", "r6"}));
    gs.reset(stateMap);
    assertTrue(checker.isVisible(gs, (Collection) null));

    stateMap.put(
        PSActionVisibilityContext.VIS_CONTEXT_ROLES_TYPE, Arrays.asList(new String[] {"r7", "r8"}));
    gs.reset(stateMap);
    assertTrue(checker.isVisible(gs, (Collection) null));
  }
  ...
  private void genericCheckGlobalVisibility(String contextId) {
    PSActionVisibilityContexts vcs = new PSActionVisibilityContexts();
    PSActionVisibilityContext ctx =
        new PSActionVisibilityContext(contextId, new String[] {"100", "200"}, null);
    vcs.add(ctx);
    PSActionVisibilityChecker checker = new PSActionVisibilityChecker(300, true, vcs);
    Map<String, Object> stateMap = new HashMap<String, Object>();
  ...
  private void checkVisibilityCheckoutStatus() {
    ...
    PSActionVisibilityContexts vcs = new PSActionVisibilityContexts();
    PSActionVisibilityContext ctx =
        new PSActionVisibilityContext(contextId, new String[] {"myself", "checked Out"}, null);
    vcs.add(ctx);
    PSActionVisibilityChecker checker = new PSActionVisibilityChecker(300, true, vcs);
    Map<String, Object> stateMap = new HashMap<String, Object>();
  ...
  private class GenericObjectState extends PSActionVisibilityObjectState {
    /**
     * @param state Assumed not <code>null</code>. The keys are the context numbers, the values are
     *     what you want returned. Use <code>Integer</code> if the method returns an <code>int
     *     </code>. If no value is found, the default from the base class is used.
     */
    ...
    public int getAssignmentType() {
      Object o = m_state.get(PSActionVisibilityContext.VIS_CONTEXT_ASSIGNMENT_TYPE);
      return o == null ? super.getAssignmentType() : ((Integer) o).intValue();
    }

    @Override
    public String getCheckoutStatus() {
      Object o = m_state.get(PSActionVisibilityContext.VIS_CONTEXT_CHECKOUT_STATUS);
      return o == null ? super.getCheckoutStatus() : o.toString();
    }

    @Override
    public int getContentTypeUuid() {
      Object o = m_state.get(PSActionVisibilityContext.VIS_CONTEXT_CONTENT_TYPE);
      return o == null ? -1 : ((Integer) o).intValue();
    }

    @Override
    public PSObjectPermissions getFolderPermissions() {
      Object o = m_state.get(PSActionVisibilityContext.VIS_CONTEXT_FOLDER_SECURITY);
      return o == null ? super.getFolderPermissions() : (PSObjectPermissions) o;
    }

    @Override
    public int getObjectType() {
      Object o = m_state.get(PSActionVisibilityContext.VIS_CONTEXT_OBJECT_TYPE);
      return o == null ? super.getObjectType() : ((Integer) o).intValue();
    }

    @Override
    public String getPublishableType() {
      Object o = m_state.get(PSActionVisibilityContext.VIS_CONTEXT_PUBLISHABLE_TYPE);
      return o == null ? super.getPublishableType() : o.toString();
    }

    @Override
    public int getWorkflowAppUuid() {
      Object o = m_state.get(PSActionVisibilityContext.VIS_CONTEXT_WORKFLOWS_TYPE);
  ...
  private class GenericGlobalState extends PSActionVisibilityGlobalState {
    ...
    public String getClientContext() {
      Object o = m_state.get(PSActionVisibilityContext.VIS_CONTEXT_CLIENT_CONTEXT);
      return o == null ? super.getClientContext() : o.toString();
    }

    @Override
    public int getCommunityUuid() {
      Object o = m_state.get(PSActionVisibilityContext.VIS_CONTEXT_COMMUNITY);
      return o == null ? super.getCommunityUuid() : ((Integer) o).intValue();
    }

    @Override
    public String getLocale() {
      Object o = m_state.get(PSActionVisibilityContext.VIS_CONTEXT_LOCALES_TYPE);
      return o == null ? super.getLocale() : o.toString();
    }

    @Override
    public Collection<String> getRoles() {
      Object o = m_state.get(PSActionVisibilityContext.VIS_CONTEXT_ROLES_TYPE);
