...
public class PSDisplayChoicesTest {
  ...
  public void testXml() throws Exception {
    ...
    choices = new PSDisplayChoices(createEntries(3).iterator(), createFilter());
    assertEquals(choices, new PSDisplayChoices(choices.toXml(doc)));
  }
  ...
  private PSChoiceFilter createFilter() {
    ...
    fields.add(new DependentField("test", PSChoiceFilter.DependentField.TYPE_REQUIRED));
    PSUrlRequest lookup = new PSUrlRequest("test", null, new PSCollection(PSParam.class));
