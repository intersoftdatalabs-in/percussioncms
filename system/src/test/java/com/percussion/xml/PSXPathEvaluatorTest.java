...
public class PSXPathEvaluatorTest {
  ...
  /**
   * Builds an evaluator from an input stream. Obtains an iterator over nodes by evaluating an XPath
   * expresssion. Then constructs <code>PSXPathEvaluator</code> object for each node and evaluate
   * XPath expressions against each node.
   */
  @Test
  public void testNode() throws Exception {
    PSXPathEvaluator xp =
        new PSXPathEvaluator(
  ...
  /**
   * Builds an evaluator from an input stream and tests that XPaths are evaluated correctly. Also
   * makes sure that an exception is thrown when input is invalid.
   */
  @Test
  ...
  /**
   * Builds an evaluator from a document and tests that XPaths are evaluated correctly. Also makes
   * sure that an exception is thrown when input is invalid.
   */
  @Test
  ...
  /**
   * Applies several valid and invalid XPath expressions to make sure the appropriate results are
   * returned.
   */
