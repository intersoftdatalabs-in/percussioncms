...
/**
 * This bean takes a map of information to setup one or more internal configuration objects to allow
 * more server unit tests to become standalone.
 *
 * @author dougrand
 */
public class PSTestSetupBean {
  ...
  /**
   * Set the config, and as a side effect, setup various other things that the config specifies. The
   * current list is:
   *
   * <ul>
  ...
  public void setConfig(Map<String, String> config) {
    ...
    if (StringUtils.isNotBlank(extSourceLoc)) {
      ...
      initProps.setProperty(IPSExtensionHandler.INIT_PARAM_CONFIG_FILENAME, EXTENSIONS);
      try {
