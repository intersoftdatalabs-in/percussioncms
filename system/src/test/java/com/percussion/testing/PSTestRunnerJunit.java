...
/**
 * This class is intented to be used as a standalone program that will run a suite of junit tests,
 * print the results, and return <code>0</code> if there were no errors, and <code>1</code> if there
 * were errors.
 */
public class PSTestRunnerJunit {

  /**
   * Runs the specified test suite, returning <code>0</code> if no errors are encountered, and
   * <code>1</code> if there are errors. All errors are logged to the console.
   *
   * @param args The commandline arguments. A single argument is expected, the fully qualified class
   *     name of the suite to run. Must specify a class that implements a method matching the
   *     following interface:
   *     <p><code>
   * public static Test suite();
   * </code>
   *     <p>which returns the an object implementing the <code>Test</code> interface and defines the
   *     test or tests that will be run (typically it returns a <code>TestSuite</code> object).
   */
  public static void main(String[] args) {
    ...
    try {
      if (args.length != 1) {
        ...
        System.out.println("java com.percussion.testing.PSTestRunner <suite>");
        System.out.println("where <suite> is the name of the class containing the suite ");
  ...
  /**
   * Runs a single test, collects its results, and prints them to the console. Any console output by
   * the test is supressed.
   *
  ...
  public static int run(Test suite) {
    if (suite == null) throw new IllegalArgumentException("suite may not be null");
