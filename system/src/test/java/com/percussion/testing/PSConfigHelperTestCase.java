...
/**
 * The utility class to provide various properties for all the unit tests. It is essentially a
 * config props factory that uses a classloader to fetch a appropriate properties file based on the
 * given CONN_TYPE_XX. Prop. file names correspond to the CONN_TYPE_XX, ie:
 * conn_rxserver.properties.
 */
public class PSConfigHelperTestCase implements IPSUnitTestConfigHelper {
  ...
  /**
   * Loads properties from the classpath and overrides values from system properties. This is useful
   * when running tests from CI server's like Jenkins or from Eclipse launch configurations. Assumes
