...
public class PSJunitRequestHandlerPlatformTest {
  ...
  public void testPlatformExecutionTranslatesToXml() throws Exception {
    ...
    req.setParameter(
        PSJunitRequestHandler.HTML_PARAM_EXE, "com.percussion.testing.HandlerSampleJupiterTest");
    ...
    Document doc =
        PSXmlDocumentBuilder.createXmlDocument(new ByteArrayInputStream(out.toByteArray()), false);
  ...
  public void testAbortedExecutionTranslatesToXml() throws Exception {
    ...
    PSRequest req = new PSRequest(null, null, null, null);
    req.setParameter(
        PSJunitRequestHandler.HTML_PARAM_EXE, "com.percussion.testing.HandlerSampleAbortedTest");
    ...
    Document doc =
        PSXmlDocumentBuilder.createXmlDocument(
            new java.io.ByteArrayInputStream(out.toByteArray()), false);
    NodeList results = doc.getElementsByTagName("TestResult");
  ...
  public void testParameterizedDisplayNamePreservedInFailure() throws Exception {
    ...
    PSRequest req = new PSRequest(null, null, null, null);
    req.setParameter(
        PSJunitRequestHandler.HTML_PARAM_EXE,
        "com.percussion.testing.HandlerSampleParameterizedTest");
