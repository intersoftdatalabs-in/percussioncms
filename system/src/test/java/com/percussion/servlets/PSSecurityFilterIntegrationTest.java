...
public class PSSecurityFilterIntegrationTest {
  ...
  /** */
  private static final String TEST_FILE_DIR = "/com/percussion/servlets";

  /** */
  private static boolean[] ms_testSecure = new boolean[] {false, true, false};
  ...
  static {
    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            false, true, PSSecurityFilter.AuthType.BASIC, "/Design*"));
    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            false, true, PSSecurityFilter.AuthType.BASIC, "/rxwebdav*"));
    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            false, true, PSSecurityFilter.AuthType.ANONYMOUS, "/rxlogin.jsp"));
    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            false, true, PSSecurityFilter.AuthType.ANONYMOUS, "/rxlogout.jsp"));
    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            false, true, PSSecurityFilter.AuthType.ANONYMOUS, "/sys_deploymentHandler"));
    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            false, true, PSSecurityFilter.AuthType.ANONYMOUS, "/login"));
    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            false, true, PSSecurityFilter.AuthType.ANONYMOUS, "/logout"));
    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            false, true, PSSecurityFilter.AuthType.ANONYMOUS, "/locale.jsp"));

    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            false, false, PSSecurityFilter.AuthType.BASIC, "PROPFIND"));
    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            false, false, PSSecurityFilter.AuthType.ANONYMOUS, "PROPPATCH"));

    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            true, true, PSSecurityFilter.AuthType.BASIC, "/user/basic*"));
    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            true, true, PSSecurityFilter.AuthType.ANONYMOUS, "/user/anon*"));
    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            true, true, PSSecurityFilter.AuthType.ANONYMOUS, "/user/*anon.jsp"));
    ms_configuredRequests.add(
        new PSSecurityFilter.SecurityEntry(
            true, true, PSSecurityFilter.AuthType.BASIC, "/user/*basic.jsp"));
  }
