...
public class PSRuleListEvaluatorTest {
  ...
  @Test
  public void testAndEvaluation() throws PSNotFoundException, PSExtensionException {
    PSRuleListEvaluator evaluator = null;
    PSCollection rules = new PSCollection(PSRule.class);
    PSExecutionData data = new PSExecutionData(null, null, new PSRequest(null, null, null, null));
  ...
  @Test
  public void testOrEvaluation() throws PSNotFoundException, PSExtensionException {
    PSRuleListEvaluator evaluator = null;
    PSCollection rules = new PSCollection(PSRule.class);
    PSExecutionData data = new PSExecutionData(null, null, new PSRequest(null, null, null, null));
  ...
  @Test
  public void testMixedEvaluation() throws PSNotFoundException, PSExtensionException {
    PSRuleListEvaluator evaluator = null;
    PSCollection rules = new PSCollection(PSRule.class);
    PSExecutionData data = new PSExecutionData(null, null, new PSRequest(null, null, null, null));
   ...
   *
   * @param evaluationResult <code>true</code> will return a rule which evaluates to <code>true
   *     </code>, <code>false</code> will return a rule which evaluates to <code>false</code>.
   * @param operator the rule operator, assumed one of <code>PSRule.OPBOOL_AND</code> or <code>
   *     PSRule.OPBOOL_OR</code>, defaults to <code>PSRule.OPBOOL_AND</code> if -1 is supplied.
   * @return the rule that produces the requested evaluation result, never <code>null</code>.
   */
  private PSRule getConditionalRule(boolean evaluationResult, int operator) {
    ...
    if (evaluationResult)
      conditional = new PSConditional(literal_1, PSConditional.OPTYPE_EQUALS, literal_1);
    else conditional = new PSConditional(literal_1, PSConditional.OPTYPE_EQUALS, literal_2);
    ...
    if (operator > 0) rule.setOperator(operator);
