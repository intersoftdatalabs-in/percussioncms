...
/**
 * The PSConditionalEvaluatorTest class is for unit test of PSConditionalEvaluator class.
 *
 * @author Jian Huang
 * @version 1.0
 * @since 1.0
...
public class PSConditionalEvaluatorTest {
  ...
  public void testMakeComparable2Number() throws Exception {
    ...
    PSLiteralSet literalSet =
        new PSLiteralSet(com.percussion.design.objectstore.PSNumericLiteral.class);
    literalSet.add(num1);
    literalSet.add(num2);
    ...
    PSLiteralSet dateLiteralSet =
        new PSLiteralSet(com.percussion.design.objectstore.PSDateLiteral.class);
  ...
  public void testMakeComparable2Date() throws Exception {
    ...
    literalSet = new PSLiteralSet(com.percussion.design.objectstore.PSNumericLiteral.class);
    literalSet.add(num1);
    literalSet.add(num1);
  ...
  public void testMakeComparable2PSDateLiteral() throws Exception {
    ...
    literalSet = new PSLiteralSet(com.percussion.design.objectstore.PSTextLiteral.class);
    literalSet.add(text1);
    literalSet.add(text2);
  ...
  private void testLikeCase(Object left, Object right, boolean expectThrow, boolean expectResult) {
  ...
  private void testLessThan(Object left, Object right) {
    int intOp[] = {
      PSConditionalEvaluator.OPCODE_LESSTHAN, PSConditionalEvaluator.OPCODE_LESSTHANOREQUALS
    };
  ...
  private void testGreaterThan(Object left, Object right) {
    int intOp[] = {
      PSConditionalEvaluator.OPCODE_GREATERTHAN, PSConditionalEvaluator.OPCODE_GREATERTHANOREQUALS
    };
