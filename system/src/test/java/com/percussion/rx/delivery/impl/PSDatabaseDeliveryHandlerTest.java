...
public class PSDatabaseDeliveryHandlerTest {
  /** Original document */
  private static final String ms_pubinput =
      "<datapublisher>\n"
          + "    <tabledefset>\n"
          ...
          + "                        <column"
          + " name=\"DATA_1\">4444444444444444444444444444444444444444444444444444444444444444444444444444444444444</column>\n"
          + "                    </row>\n"
          + "                </childtable>\n"
          + "            </row>\n"
          + "        </table>\n"
  ...
  /** Test result data */
  private static final String ms_result =
  ...
  /**
   * Test the extraction of unpublishing information - really tests the sax copier.
   *
   * @throws SAXException
   ...
   */
  @Test
  public void testDBUnpublishInfo()
      throws ParserConfigurationException, SAXException, XMLStreamException, IOException {
    ...
    DefaultHandler dh = new PSDatabaseDeliveryHandler.UnpublishingContentHandler(formatter, null);
