...
public class PSTreeModelTest {
  ...
  public void testDummy() {
    // Added a dummy test all the tests in the file have been ignored, this test needs to be removed
    // after fixing other tests
  }
  ...
  public void ignoretestCreateTree() {
    ...
    PSCategoryNodeBase dtypes =
        new PSCategoryNodeBase("Delivery Types", "pub-design-delivery-types-view");
    root.addNode(dtypes);
    ...
    PSCategoryNodeBase contexts = new PSCategoryNodeBase("Contexts", "pub-design-contexts-view");
