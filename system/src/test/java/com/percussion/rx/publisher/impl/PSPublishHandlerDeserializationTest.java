...
/**
 * Unit tests for PSPublishHandler deserialization security validation (CWE-502).
 * Tests ensure that unsafe JMS ObjectMessage deserialization is properly validated
 * against whitelist of known message types.
 */
class PSPublishHandlerDeserializationTest {
    ...
    @Mock
    private PSCancelPublishingMessage cancelMessage;

    @Mock
    private PSJobControlMessage jobControlMessage;
    ...
    void setUp() {
        ...
        // Note: PSPublishHandler requires IPSDeliveryManager, IPSRxPublisherServiceInternal, and PSQueueErrorHandler
    ...
    /**
     * Tests that invalid message types are rejected (CWE-502).
     * Only whitelisted types (PSCancelPublishingMessage, PSJobControlMessage, IPSAssemblyItem)
     * should be processed.
     */
    @Test
