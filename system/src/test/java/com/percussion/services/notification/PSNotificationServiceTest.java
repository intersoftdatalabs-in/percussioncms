...
public class PSNotificationServiceTest {
  /** Test class for listener tracks how many times it's been called with a matching file. */
  ...
  public void testNotifications() {
    IPSNotificationService nsvc = PSNotificationServiceLocator.getNotificationService();
    ...
    try {
      ...
      PSNotificationEvent xyz_event = new PSNotificationEvent(EventType.FILE, new File("xyz"));
      PSNotificationEvent abc_event = new PSNotificationEvent(EventType.FILE, new File("abc"));
      ...
      PSNotificationEvent xyz_completion =
          new PSNotificationEvent(EventType.OBJECT_INVALIDATION, new File("xyz"));
  ...
  public void testTopicNotifications() throws InterruptedException {
    ...
    try {
      ...
      PSNotificationEvent evt =
          new PSNotificationEvent(EventType.OBJECT_INVALIDATION, new PSGuid());
  ...
  public void testHelpers() throws InterruptedException {
    ...
    try {
      ...
      PSNotificationHelper.notifyInvalidation(new PSGuid(PSTypeEnum.ACL, 123));
