...
/**
 * Unit tests for PSMessageQueueService deserialization security validation (CWE-502).
 * Tests ensure that unsafe JMS ObjectMessage deserialization is properly validated
 * and type-checked before use.
 */
...
class PSMessageQueueServiceDeserializationTest {
    ...
    @Mock
    private IPSMessageQueueListener<Serializable> listener;
