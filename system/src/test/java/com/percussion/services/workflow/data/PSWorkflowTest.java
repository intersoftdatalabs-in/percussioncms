...
public class PSWorkflowTest {
  ...
  public void testAll() throws Exception {
    ...
    assignedRole2.setGUID(
        new PSGuid(PSTypeEnum.WORKFLOW_ROLE, assignedRole.getGUID().getUUID() + 1));
    ...
    List<PSNotificationDef> notificationDefs = new ArrayList<PSNotificationDef>();
  ...
  private PSTransition createTransition(
      int uuId, List<PSWorkflowRole> roles, List<PSNotification> notifications) {
