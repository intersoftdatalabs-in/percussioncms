...
public class PSScheduleTest extends PSScheduleTestBase {
  public void testApply() {
    ...
    assertTrue(EqualsBuilder.reflectionEquals(createFullSchedule(), clone));
  }
   ...
   *
   * @param schedule the schedule to fill with the data. Assumed not null.
   */
  ...
  public void testSerializeEmpty() {
    final PSScheduledTask schedule = new PSScheduledTask();
    assertTrue(EqualsBuilder.reflectionEquals(schedule, SerializationUtils.clone(schedule)));
  }

  public void testSerializeFull() {
    assertTrue(
        EqualsBuilder.reflectionEquals(
            createFullSchedule(), SerializationUtils.clone(createFullSchedule())));
  }
