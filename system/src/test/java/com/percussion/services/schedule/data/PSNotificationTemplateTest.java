...
public class PSNotificationTemplateTest {
  ...
  public void testEqualsHashCode() {
    ...
    final PSNotificationTemplate t1 = createTemplate(id, LABEL1, SUBJECT1, TEMPLATE1);
    final PSNotificationTemplate t2 = createTemplate(id, LABEL1, SUBJECT1, TEMPLATE1);
    final PSNotificationTemplate t3 = createTemplate(id, LABEL2, SUBJECT2, TEMPLATE2);
   ...
   */
  private PSNotificationTemplate createTemplate(
      IPSGuid id, String label, String subject, String template) {
