...
public class PSJexlExtensionsTest {
  ...
  /**
   * Perform the test by running the template and comparing the actual and expected results
   *
   * @param ctx the context, never <code>null</code>
   * @param inputtemplate the input template, never <code>null</code> or empty
  ...
  public void testCombineMap() throws Exception {
    ...
    input.put("a", new String[] {"0", "1"});
    input.put("b", new String[] {"0", "1"});
    input.put("e", new String[] {"5"});
    ...
    vals = output.get("a");
    checkEquality(vals, new String[] {"0", "1"});
    vals = output.get("b");
    checkEquality(vals, new String[] {"1"});
    vals = output.get("c");
    checkEquality(vals, new String[] {"2", "3"});
    vals = output.get("d");
    checkEquality(vals, new String[] {"4"});
    vals = output.get("e");
    checkEquality(vals, new String[] {"5"});
  ...
  /**
   * Check objects for equality. If the objects are arrays, then they are checked element by element
   * for equality
   *
  ...
  public void testBodyPageBreakUtils() throws Exception {
    PSContentNode parent = new PSContentNode(null, "parent", null, null, null, null);
    PSPaginateUtils pager = new PSPaginateUtils();

    final String content =
        "<div class=\"rxbodyfield\">adipiscing elit. <![CDATA[ <hello>\n"
            + "&<?pageBreak?> ]]><?test abc?><!-- comment text --><em>Praesent ullamcorper.</em>"
            + " Pellentesque <h2><font>elementum<?pageBreak?>turpis id justo. <h1"
            + " attr=\"foo\"><font>D<em>u</em>is</font> adipiscing</h1>, orci non placerat"
            + " <em>congue,<?pageBreak?>malesuada est</em> et diam. Nunc sit amet lacus"
            + " sit</font></h2> amet lacus varius<em><?pageBreak ?>volutpat.</em> Sed molestie"
            + " pharetra sem. Sed dictum. Fusce <em>elementum.<?pageBreak  ?></em>Etiam non orci"
            + " non felis &lt;foo&gt; feugiat lobortis.<?pageBreak ?>abc <foo attrib1='x\"y\"'"
            + " attrib2=\"&amp;&lt;&apos;&quot;\"></foo>  <br></br> <br/> <br /><h1/> <h2/>"
            + " <textarea/>&apos;&amp;yyy&apos;</div>";
    ...
    String[] testResults = {
      "<div class=\"rxbodyfield\">adipiscing elit. <![CDATA[ <hello>\n"
          + "&<?pageBreak?> ]]><?test abc?><!-- comment text --><em>Praesent ullamcorper.</em>"
          + " Pellentesque <h2><font>elementum</font></h2></div>",
      "<div class=\"rxbodyfield\"><h2><font>turpis id justo. <h1"
          + " attr=\"foo\"><font>D<em>u</em>is</font> adipiscing</h1>, orci non placerat"
          + " <em>congue,</em></font></h2></div>",
      "<div class=\"rxbodyfield\"><h2><font><em>malesuada est</em> et diam. Nunc sit amet lacus"
          + " sit</font></h2> amet lacus varius<em></em></div>",
      "<div class=\"rxbodyfield\"><em>volutpat.</em> Sed molestie pharetra sem. Sed dictum. Fusce"
          + " <em>elementum.</em></div>",
      "<div class=\"rxbodyfield\">"
          + "<em></em>Etiam non orci non felis &lt;foo> feugiat lobortis.</div>",
      "<div class=\"rxbodyfield\">abc <foo attrib1=\"x&quot;y&quot;\" attrib2=\"&amp;&lt;'&quot;\""
          + " />  <br /> <br /> <br /><h1></h1> <h2></h2> <textarea></textarea>'&amp;yyy'</div>"
    };
  ...
  public void testCodecUtils() throws Exception {
    ...
    //      "4uPk5Q==");
    doTest(ctx, "$sys.codec.base64Decoder(\"" + input + "\")", "\u00E2\u00E3\u00E4\u00E5");
    doTest(ctx, "$sys.codec.decodeFromXml(\"&#160;\'&lt;&gt;&amp;\")", "\u00A0\'<>&");
    doTest(ctx, "$sys.codec.escapeForXml(\"\u00A0\'<>&\")", "&#160;&apos;&lt;&gt;&amp;");
  }

  /** */
  public static final String testHtmlDoc =
      "<html><head>" + "<title>Test title</title>" + "</head><body><p>test body</p></body></html>";
  ...
  public void testLinkUtils() throws Exception {
    ...
    doTest(ctx, "$sys.link.addParams($url,'p1','v1')", "http://www.google.com/foo/bar?p1=v1");
    doTest(
        ctx,
        "$sys.link.addParams($url2,'p2','v2')",
        "http://www.google.com/foo/bar?param1=value1&p2=v2");
    doTest(
        ctx,
        "$sys.link.addParams($url,'p1','v1','p2','v2')",
    ...
    doTest(
        ctx,
        "$sys.link.addParams($url,'p1','v1','p2','v2','p3','v3','p4','v4'," + "'p5','v5')",
        "http://www.google.com/foo/bar?p1=v1&p2=v2&p3=v3&p4=v4&p5=v5");
    // Try nesting
    doTest(
        ctx,
        "$sys.link.addParams(" + "$sys.link.addParams($url,'p1','v1','p2','v2'),'p3','v3'" + ")",
        "http://www.google.com/foo/bar?p1=v1&p2=v2&p3=v3");
  }
