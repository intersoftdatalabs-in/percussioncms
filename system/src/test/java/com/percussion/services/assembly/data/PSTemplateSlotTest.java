...
public class PSTemplateSlotTest {
  ...
  private void setupSlot(IPSTemplateSlot slot) {
    ...
    slotAssociations.add(
        new PSPair(new PSGuid(PSTypeEnum.NODEDEF, 1000), new PSGuid(PSTypeEnum.TEMPLATE, 1001)));
    slotAssociations.add(
        new PSPair(new PSGuid(PSTypeEnum.NODEDEF, 1002), new PSGuid(PSTypeEnum.TEMPLATE, 1003)));
  ...
  public void testCRUD() throws Exception {
    ...
    IPSTemplateSlot nonCachedSlot = assembly.loadSlotModifiable(slot.getGUID());
