...
public class PSPropertyTest {
  ...
  /** Useful static class for testing functionality of the property accessor class */
  ...
  public static class TestMultiMappingClass {
     ...
     */
    public TestMultiMappingClass(
        Collection<Long> ival, Collection<Double> dval, Collection<String> sval) {
      mi_lval = ival;
      mi_dval = dval;
      mi_sval = sval;
    }
  ...
  public void testMulti() throws Exception {
    ...
    TestMultiMappingClass tmm = new TestMultiMappingClass(longs, floats, strings);
