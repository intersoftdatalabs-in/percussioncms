...
/**
 * Unit tests for PSContentMgr SQL injection vulnerability fixes (CWE-89).
 * Tests ensure that parameterized queries are used for user-supplied input
 * and that column names are properly validated.
 */
...
class PSContentMgrSQLInjectionTest {
    ...
    @Mock
    private PSBackEndColumn backEndColumn;

    @Mock
    private PSBackEndTable backEndTable;

    @Mock
    private IPSBackEndMapping backEndMapping;
