...
public class PSSharedPropertyTest {
  ...
  public void testCRUD() throws Exception {
    ...
    // find all properties
    List<PSSharedProperty> properties = service.findSharedPropertiesByName(null);
    ...
    service.saveSharedProperty(property);
    PSSharedProperty property2 = service.loadSharedProperty(property.getGUID());
  ...
  /**
   * Create a new shared property for the supplied parameters and save it to the repository.
   *
   * @param name the property name, not <code>null</code> or empty.
   * @param value the property value, may be <code>null</code> or empty.
   * @param session the session used to create the property, not <code>null</code> or empty.
   * @param user the user used to create the property, not <code>null</code> or empty.
   * @return the new shared property, saved in the repository, never <code>null</code>.
   * @throws PSErrorsException if the property could not be created.
   */
  public static PSSharedProperty createProperty(
      String name, String value, String session, String user) throws PSErrorsException {
