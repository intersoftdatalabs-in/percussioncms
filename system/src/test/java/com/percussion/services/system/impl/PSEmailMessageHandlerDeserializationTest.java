...
/**
 * Unit tests for PSEmailMessageHandler deserialization security validation (CWE-502).
 * Tests ensure that unsafe JMS ObjectMessage deserialization is properly validated
 * with type checking before casting to IPSMailMessageContext.
 */
...
class PSEmailMessageHandlerDeserializationTest {
    ...
    @Mock
    private IPSMailMessageContext mailMessageContext;
