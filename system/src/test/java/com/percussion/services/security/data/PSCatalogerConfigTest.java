...
public class PSCatalogerConfigTest {
  ...
  public void testCtor() throws Exception {
    ...
    config = (PSCatalogerConfig) PSTestUtils.testCtor(PSCatalogerConfig.class, PARAMS, args, false);
  ...
  public void testAccessors() throws Exception {
    PSCatalogerConfig config =
        (PSCatalogerConfig) PSTestUtils.testCtor(PSCatalogerConfig.class, PARAMS, ARGS, false);
   ...
   * @param shouldThrow <code>true</code> if the setter should throw an excpetion, <code>false
   *     </code> if not.
   * @throws Exception If the test fails.
   */
  private void testSetter(PSCatalogerConfig config, int iProp, Object val, boolean shouldThrow)
      throws Exception {
    Object[] args = ARGS.clone();
    args[iProp] = val;
    PSTestUtils.testSetter(config, METHODS[iProp], args[iProp], PARAMS[iProp], shouldThrow);
  }
  ...
  public void testXml() throws Exception {
    ...
    PSCatalogerConfig config1 =
        (PSCatalogerConfig) PSTestUtils.testCtor(PSCatalogerConfig.class, PARAMS, ARGS, false);
    assertEquals(config1, new PSCatalogerConfig(config1.toXml(doc), config1.getConfigType()));
  ...
  private static final Class[] PARAMS =
      new Class[] {String.class, ConfigTypes.class, String.class, String.class, Map.class};
  ...
  static {
    ...
    ARGS = new Object[] {"name", ConfigTypes.SUBJECT, "com.test.PSCataloger", "desc", props};
  }

  /** Array of bean property names used to call accessors by reflection. */
  private static final String[] METHODS =
      new String[] {"Name", "ConfigType", "ClassName", "Description", "Properties"};
