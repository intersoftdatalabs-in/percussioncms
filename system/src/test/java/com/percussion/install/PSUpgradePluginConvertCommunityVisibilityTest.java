...
public class PSUpgradePluginConvertCommunityVisibilityTest {
  ...
  private static final int[] communities = {1001, 1003};
  ...
  public static void setUp() throws Exception {
    ...
    try {
      ...
      org.junit.jupiter.api.Assumptions.assumeTrue(
          false, "Application Context not initialized - skipping upgrade plugin test");
    }
  }
  ...
  public void testPlugin() throws Exception {
    ...
    SessionFactory factory = (SessionFactory) PSBaseServiceLocator.getBean("sys_sessionFactory");
    ...
    try {
      ...
      s.createQuery(
              "create table "
                  ...
                  + "primary key (variantid, communityid))")
          .executeUpdate();

      Query query =
          s.createQuery("insert into " + tablename + " (variantid, communityid) values (?, ?)");
      ...
      InputStream stream =
          new FileInputStream("UnitTestResources/com/percussion/rxupgrade/rxupgrade.xml");
      ...
      while (!found) {
        ...
        if (e == null) throw new Exception("Couldn't find expected entry.");
        else if (e.getAttribute("name").equals("ConvertCommunityVisibility")) found = true;
      }
      e = walker.getNextElement("data", PSXmlTreeWalker.GET_NEXT_ALLOW_CHILDREN);
      sws.stop();
