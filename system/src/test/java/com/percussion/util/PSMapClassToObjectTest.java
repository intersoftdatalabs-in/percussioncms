...
public class PSMapClassToObjectTest {
  ...
  /**
   * Make the mappings more and more specific and test at each stage to make sure that the most
   * specific mappings apply.
   */
  public void testObjectMapping() {
    ...
    String thirdString =
        "Whenever a separation is made between liberty and justice, neither, in my opinion, is"
            + " safe.";
    String fourthString = "Example is the school of mankind, and they will learn at no other.";
    String fifthString =
        "The first and simplest emotion which we discover in the human mind, is curiosity.";
    String sixthString = "What ever disunites man from God, also disunites man from man.";
