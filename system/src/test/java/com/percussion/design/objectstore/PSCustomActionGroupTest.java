...
public class PSCustomActionGroupTest {
  ...
  /**
   * Case tests object->xml->object serialization.The custom action grou is built as a Java object.
   * Converted to XML document using toXml() method. Then the object is restored from this xml
   * document and compared with original object using equals() method.
   *
  ...
  public void testXml() throws PSUnknownNodeTypeException {
    ...
    PSActionLink actionLink = new PSActionLink(new PSDisplayText("displayText"));
