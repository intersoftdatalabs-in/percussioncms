...
public class PSApplicationTest {
  ...
  public void testXml() throws Exception {
    ...
    app.setRevision("Application test program", "This is a dummy revision");
    app.setRevision("Application test program", "Yet another dummy revision");
    assertTrue(!app.equals(fromXmlApp));
    fromXmlApp.fromXml(app.toXml());
    assertEquals(app, fromXmlApp);
    ...
    Element propRoot = PSXmlDocumentBuilder.createRoot(propDoc, "AppTestRoot");
    ...
    PSXmlDocumentBuilder.addElement(propDoc, propRoot, "SimpleElement", "SimpleValue");
    app.setPropertyTree(propDoc);
    assertTrue(!app.equals(fromXmlApp));
    fromXmlApp.fromXml(app.toXml());
    assertEquals(app, fromXmlApp);
    ...
    PSXmlDocumentBuilder.addElement(
        propDoc,
        PSXmlDocumentBuilder.addEmptyElement(propDoc, propRoot, "Hierarchical"),
        "Value",
        "HierarchicalValue");
    app.setPropertyTree(propDoc);
    assertTrue(!app.equals(fromXmlApp));
