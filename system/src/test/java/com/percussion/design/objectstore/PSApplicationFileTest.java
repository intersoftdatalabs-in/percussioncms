...
public class PSApplicationFileTest {
   ...
   *   <LI>Create a Document object <CODE>doc</CODE> by calling PSApplicationFile.toXml().
   *   <LI>Create a new PSApplicationFile object by calling fromXml(doc)
   *   <LI>Compare the bytes from the new PSApplicationFile object with the original bytes to make
   *       sure they went through the encoding process OK.
   * </OL>
   *
   * @author chad loder
