...
public class PSContentEditorSharedDefTest {
  ...
  public void testXml() throws Exception {
    ...
    PSField field1 =
        new PSField(PSField.TYPE_SHARED, "category1", new PSBackEndColumn(table1, "CATEGORY"));
    PSField field2 =
        new PSField(PSField.TYPE_SHARED, "category2", new PSBackEndColumn(table1, "TITLE"));
