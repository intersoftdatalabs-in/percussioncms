...
public class PSLegacyServerConfigTest extends PSBaseXmlConfigTest {
  ...
  public void testConfig() throws Exception {
    ...
    File srcFile =
        PSTestResourceUtils.getFile(PSLegacyServerConfigTest.class, TEST_LEGACY_CONFIG_FILE, null);
    ...
    Document srcDoc = PSXmlDocumentBuilder.createXmlDocument(new FileInputStream(srcConfig), false);
    ...
    Document tmpDoc =
        PSXmlDocumentBuilder.createXmlDocument(new FileInputStream(tmpConfig1), false);
    ...
    tmpConfig.setSecurityProviderInstances(new PSCollection(PSSecurityProviderInstance.class));
    newConfig.setSecurityProviderInstances(new PSCollection(PSSecurityProviderInstance.class));
