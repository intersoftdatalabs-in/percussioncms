...
public class PSRelationshipTest {
  ...
  public void testConstructors() throws Exception {
    ...
    try {
      rs =
          new PSRelationship(
              1, owner, dependent, configs.getConfig(PSRelationshipConfig.TYPE_TRANSLATION));
    } catch (Exception e) {
      exception = e;
    }
    ...
    try {
      rs =
          new PSRelationship(
              1, null, dependent, configs.getConfig(PSRelationshipConfig.TYPE_TRANSLATION));
    } catch (Exception e) {
      exception = e;
    }
    ...
    try {
      rs =
          new PSRelationship(
              1, owner, null, configs.getConfig(PSRelationshipConfig.TYPE_TRANSLATION));
    } catch (Exception e) {
      exception = e;
    }
    assertTrue(exception instanceof IllegalArgumentException);
    ...
    PSRelationship test =
        new PSRelationship(
            1, owner, dependent, configs.getConfig(PSRelationshipConfig.TYPE_NEW_COPY));
    ...
    try {
      rs =
          new PSRelationship(
              testXml, null, null, configs.getConfig(PSRelationshipConfig.TYPE_NEW_COPY));
    } catch (Exception e) {
      exception = e;
    }
    assertTrue(exception == null);
    ...
    try {
      rs =
          new PSRelationship(
              null, null, null, configs.getConfig(PSRelationshipConfig.TYPE_NEW_COPY));
    } catch (Exception e) {
      exception = e;
    }
    assertTrue(exception instanceof PSUnknownNodeTypeException);
  ...
  public void testPublicAPI() throws Exception {
    ...
    PSRelationship rs =
        new PSRelationship(
            1, owner, dependent, configs.getConfig(PSRelationshipConfig.TYPE_ACTIVE_ASSEMBLY));
   ...
   *
   * @return the relationship configuration set, never <code>null</code> or empty.
   * @throws Exception for any error reading the relationship configuration set.
   */
  ...
  public void testToFromXml() throws Exception {
    ...
    PSRelationship rs_2 =
        new PSRelationship(
            rsEl, null, null, configs.getConfig(PSRelationshipConfig.TYPE_TRANSLATION));
    ...
    rs_2 =
        new PSRelationship(
            rsEl, null, null, configs.getConfig(PSRelationshipConfig.TYPE_ACTIVE_ASSEMBLY));
  ...
  public void testEqualsHashCode() {
    ...
    assertEqualsWithHash(relationship, new PSRelationship(1, owner, dependent, config));
    {
      final PSRelationshipConfig config2 =
          new PSRelationshipConfig("name2", PSRelationshipConfig.RS_TYPE_SYSTEM);
      assertFalse(relationship.equals(new PSRelationship(1, owner, dependent, config2)));
    }
  }

  /**
   * The relationship configuration set used for testing purposes. Initialized in the first call to
   * {@link getConfigs()}, never <code>null</code>, empty or changed after that.
   */
