...
// Test case
public class PSContentEditorTest {
  ...
  public void testXml() throws Exception {
    ...
    PSUrlRequest req1 =
        new PSUrlRequest("bannerincludeurl", "file:rx_resources/html/banner.html", parameters1);
    ...
    PSCommandHandlerStylesheets commandHandlerSS =
        new PSCommandHandlerStylesheets("New", new PSStylesheet(newReq));
    ...
    PSUrlRequest redirect =
        new PSUrlRequest("redirect", "file:rx_resources/html/redirect.html", parameters4);
