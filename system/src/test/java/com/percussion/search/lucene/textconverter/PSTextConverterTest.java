...
public class PSTextConverterTest {
  ...
  public void testWordConvertion() throws Exception {
    ...
    try {
      ...
      String text =
          new PSTextConverterMsWord()
              .getConvertedText(is, IPSLuceneConstants.MIME_TYPE_APPLICATION_BY_MSWORD);
      ...
      text =
          new PSTextConverterMsWord()
              .getConvertedText(is, IPSLuceneConstants.MIME_TYPE_APPLICATION_BY_OPENXML_MSWORD_DOC);
  ...
  public void testExcelConversion() throws Exception {
    ...
    try {
      ...
      String text =
          new PSTextConverterMsExcel()
              .getConvertedText(is, IPSLuceneConstants.MIME_TYPE_APPLICATION_BY_EXCEL);
      ...
      text =
          new PSTextConverterMsExcel()
              .getConvertedText(
                  is, IPSLuceneConstants.MIME_TYPE_APPLICATION_BY_OPENXML_MSEXCEL_SHEET);
  ...
  public void testPdfConvertion() throws Exception {
    ...
    try {
      is = loadFile("pdf.pdf");
      String text =
          new PSTextConverterPdf()
              .getConvertedText(is, IPSLuceneConstants.MIME_TYPE_APPLICATION_BY_PDF);
  ...
  public void testHtmlConversion() throws Exception {
    ...
    try {
      ...
      String text =
          new PSTextConverterHtml().getConvertedText(is, IPSLuceneConstants.MIME_TYPE_TEXT_BY_HTML);
  ...
  public void testTikaHtmlConversion() throws Exception {
    ...
    try {
      is = loadFile("html.html");
      String text =
          new PSTikaTextConvertor().getConvertedText(is, IPSLuceneConstants.MIME_TYPE_TEXT_BY_HTML);
      assertEquals(StringUtils.trim(text), "text from html");
    } finally {
      if (is != null) {
        is.close();
  ...
  public void testPowerPointConvertion() throws Exception {
    ...
    try {
      is = loadFile("ppt.ppt");
      String text =
          new PSTextConverterMsPowerPoint()
              .getConvertedText(is, IPSLuceneConstants.MIME_TYPE_APPLICATION_BY_MSPOWERPOINT);
      ...
      text =
          new PSTextConverterMsPowerPoint()
              .getConvertedText(
                  is, IPSLuceneConstants.MIME_TYPE_APPLICATION_BY_OPENXML_MSPOWERPOINT_PRES);
  ...
  public void testTikaRtfConversion() throws Exception {
    ...
    try {
      ...
      String text =
          new PSTikaTextConvertor()
              .getConvertedText(is, IPSLuceneConstants.MIME_TYPE_APPLICATION_BY_RTF);
      assertEquals(StringUtils.trim(text), "text from rtf");
    } finally {
      if (is != null) {
        is.close();
  ...
  public void testXmlConvertion() throws Exception {
    ...
    try {
      is = loadFile("xml.xml");
      String text =
          new PSTextConverterXml()
              .getConvertedText(is, IPSLuceneConstants.MIME_TYPE_APPLICATION_BY_XML);
  ...
  private static String dataDir = "UnitTestResources/com/percussion/" + "search/lucene/converters/";
}
