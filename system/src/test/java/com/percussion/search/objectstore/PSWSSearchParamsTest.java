...
public class PSWSSearchParamsTest {
  ...
  public void testEquals() throws Exception {
    ...
    // test title
    params1.setTitle("foo", PSWSSearchField.OP_ATTR_LIKE, PSWSSearchField.CONN_ATTR_AND);
    assertFalse(params1.equals(params2));
    params2.setTitle("bar", PSWSSearchField.OP_ATTR_LIKE, PSWSSearchField.CONN_ATTR_AND);
    assertFalse(params1.equals(params2));
    params2.setTitle("foo", PSWSSearchField.OP_ATTR_LIKE, PSWSSearchField.CONN_ATTR_AND);
    assertEquals(params1, params2);
    PSWSSearchField title = params2.getTitle();
    params1.setTitle(title.getValue(), title.getOperator(), title.getConnector());
    assertEquals(params1, params2);
    params1.setTitle(null, PSWSSearchField.OP_ATTR_LIKE, PSWSSearchField.CONN_ATTR_AND);
    assertFalse(params1.equals(params2));
    params2.setTitle("", PSWSSearchField.OP_ATTR_LIKE, PSWSSearchField.CONN_ATTR_AND);
    assertEquals(params1, params2);
    ...
    params2.setFolderPathFilter(
        params1.getFolderPathFilter().toUpperCase(), params1.isIncludeSubFolders());
    assertEquals(params1, params2);
    assertEquals(params1.hashCode(), params2.hashCode());
    ...
    fields.add(
        new PSWSSearchField(
            "foo", PSWSSearchField.OP_ATTR_LIKE, "bar", PSWSSearchField.CONN_ATTR_AND));
    ...
    fields.add(
        new PSWSSearchField(
            "sys_bar", PSWSSearchField.OP_ATTR_LESSTHAN, "2", PSWSSearchField.CONN_ATTR_OR));
    params1.setSearchFields(fields);
    assertFalse(params1.equals(params2));
  ...
  private PSWSSearchParams roundTrip(PSWSSearchParams params) throws Exception {
    return new PSWSSearchParams(params.toXml(PSXmlDocumentBuilder.createXmlDocument()));
  }
}
