...
/**
 * Unit tests for the full-text search engine. Tests very basic functionality, that the server will
 * start and stop and the standard objects (admin, query, and indexer) can all be obtained.
 *
 * @author paulhoward
 */
@Disabled("Temporarily disabled — failing in perc-system test run")
public class PSSearchEngineTest implements IPSServerBasedJunitTest {
   ...
   */
  @Test
  public void testShutdown() throws PSSearchException {
   ...
   */
  @Test
  public void testGetStatus() throws PSSearchException {
    PSSearchEngine eng = PSSearchEngine.getInstance();
   ...
   */
  @Test
  public void testGetters() throws PSSearchException, PSAdminLockedException {
    PSSearchEngine eng = PSSearchEngine.getInstance();
