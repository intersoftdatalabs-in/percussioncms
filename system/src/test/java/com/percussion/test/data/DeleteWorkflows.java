...
public class DeleteWorkflows {
   ...
   *
   * <p>param names are case-insensitive, [] params are optional, order doesn't matter for optional,
   * except they must appear after the ids, default values shown, [params] w/ no value are ignored
  ...
  public static void main(String[] args) throws Exception {
    final String usage =
        "Usage: DeleteWorkflows lowerId upperId [server=localhost] [port=9992] [uid=admin1]"
            + " [pw=demo]";
    if (args.length < 2) {
    ...
    Map<String, String> userParams = CreateWorkflows.extractArgs(optionalArgs, usage);
  ...
  private static void deleteWorkflow(PSRemoteRequester req, int id) throws Exception {
