...
public class PSLocaleTest {
  ...
  public void testCtors() throws Exception {
    assertTrue(checkMemberCtor("en-us", "english", null, PSLocale.STATUS_ACTIVE));
    assertTrue(checkMemberCtor("en-us", "english", "", PSLocale.STATUS_ACTIVE));
    assertTrue(checkMemberCtor("en-us", "english", "foo", PSLocale.STATUS_ACTIVE));
    assertTrue(!checkMemberCtor(null, "english", null, PSLocale.STATUS_ACTIVE));
    assertTrue(!checkMemberCtor("", "english", null, PSLocale.STATUS_ACTIVE));
    assertTrue(!checkMemberCtor("en-us", null, null, PSLocale.STATUS_ACTIVE));
    assertTrue(!checkMemberCtor("en-us", "", null, PSLocale.STATUS_ACTIVE));
    assertTrue(!checkMemberCtor("en-us", "english", null, -1));

    String[] colnames = {"LANGUAGESTRING", "DISPLAYNAME", "DESCRIPTION", "STATUS"};
    ...
    PSJdbcRowData badRow = new PSJdbcRowData(cols.iterator(), PSJdbcRowData.ACTION_INSERT);
  ...
  public void testEquals() throws Exception {
    PSLocale locale1 = new PSLocale("en-us", "english", null, PSLocale.STATUS_ACTIVE);
    PSLocale locale2 = new PSLocale("en-us", "english", "desc", PSLocale.STATUS_ACTIVE);
    PSLocale locale3 = new PSLocale("en-uk", "english", null, PSLocale.STATUS_ACTIVE);
    PSLocale locale4 = new PSLocale("en-us", "dude", null, PSLocale.STATUS_ACTIVE);
    PSLocale locale5 = new PSLocale("en-us", "english", null, PSLocale.STATUS_INACTIVE);
    PSLocale locale6 = new PSLocale("en-us", "english", "", PSLocale.STATUS_ACTIVE);
    PSLocale localeSame = new PSLocale("en-us", "english", null, PSLocale.STATUS_ACTIVE);
  ...
  public void testXml() throws Exception {
    Document doc;
    PSLocale locale1 = new PSLocale("en-us", "english", null, PSLocale.STATUS_ACTIVE);
    PSLocale locale2 = new PSLocale("en-us", "english", "desc", PSLocale.STATUS_INACTIVE);
  ...
  /**
   * Test the construction of a <code>PSLocale</code> from its member data. See the constructor of
   * this object for parameter information.
   *
   * @return <code>true</code> if the construction using the supplied params does not throw any
   *     exceptions, <code>false</code> otherwise.
   */
  private boolean checkMemberCtor(String langString, String dispName, String desc, int status) {
  ...
  /**
   * Test the construction of a <code>PSLocale</code> from a <code>PSJdbcRowData</code>. See the
   * constructor of this object for parameter information.
   *
   * @return <code>true</code> if the construction using the supplied params does not throw any
   *     exceptions, <code>false</code> otherwise.
   */
