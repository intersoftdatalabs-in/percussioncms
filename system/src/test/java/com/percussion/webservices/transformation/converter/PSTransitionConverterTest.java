  ...
  public void testConverter() throws Exception {
    ...
    com.percussion.webservices.system.PSTransition tgt =
        (com.percussion.webservices.system.PSTransition)
            converter.convert(com.percussion.webservices.system.PSTransition.class, src);
    ...
    assertEquals(
        src.getNotifications().size(),
        (tgt.getNotifications() == null ? 0 : tgt.getNotifications().getPSNotification().size()));
    assertEquals(
        PSStringUtils.toCamelCase(src.getRequiresComment().name()), tgt.getComment().toString());
