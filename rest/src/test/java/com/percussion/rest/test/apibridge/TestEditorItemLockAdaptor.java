...
/** Spring test stub so rest ApplicationContext can inject {@link IEditorItemLockAdaptor}. */
@Component
@Lazy
public class TestEditorItemLockAdaptor implements IEditorItemLockAdaptor {

  @Override
  public EditorItemLockInfo checkout(URI baseUri, String itemId) {
    return new EditorItemLockInfo("stub", "admin", "admin", "Assignee");
  }
