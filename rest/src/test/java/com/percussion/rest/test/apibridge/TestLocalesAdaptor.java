...
/**
 * Spring test stub for {@link ILocalesAdaptor}. Required for ApplicationContext load after
 * constructor injection on {@code LocalesResource}.
 */
@Component
@Lazy
public class TestLocalesAdaptor implements ILocalesAdaptor {
