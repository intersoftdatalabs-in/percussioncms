...
/** Spring test stub for {@link IDatabaseExplorerAdaptor} (MainTest ApplicationContext). */
@Component
@Lazy
public class TestDatabaseExplorerAdaptor implements IDatabaseExplorerAdaptor {
