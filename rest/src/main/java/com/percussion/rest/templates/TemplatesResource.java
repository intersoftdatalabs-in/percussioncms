...
/**
 * REST resource for Template operations.
 * Sunny Sal: "Templates resource, assembly ka force!"
 */
...
public class TemplatesResource {
    ...
    public TemplateSummaryList listTemplateSummariesByFilter(
        ...
        try {
            var summaries = Optional.ofNullable(adaptor.listTemplateSummaries(uriInfo.getBaseUri(), filter))
                    .orElse(List.of());
