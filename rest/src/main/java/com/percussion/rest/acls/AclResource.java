...
public class AclResource {
  ...
  public UserAccessLevel getUserAccessLevel(
      @Parameter(
              description =
                  "The guid of the object for which the current user's effective access level needs to be computed. Must not be null.",
              required = true)
          Guid objectGuid) {
    ...
    try {
      ...
      log.error(
          "An exception occurred getting User Access Level for Object: {}, Error: {}",
  ...
  public UserAccessLevel calculateUserAccessLevel(@PathParam("aclGuid") String aclGuid) {
    ...
    try {
      ...
      log.error(
          "An error occurred checking the access level for Acl: {}, Error: {}",
          aclGuid,
  ...
  public Acl createAcl(
    ...
    try {
      ...
      log.error(
          "An error occurred creating an Acl for Owner: {} and object: {}, Error: {}",
  ...
  public AclList loadAcls(GuidList aclGuids) {
    try {
      ...
      log.error(
          "An error occurred loading acls for guid list: {}, Error: {}",
          aclGuids.toString(),
          PSExceptionUtils.getMessageForLog(e));
      log.debug(PSExceptionUtils.getDebugMessageForLog(e));
      throw new WebApplicationException(e.getMessage(), Response.serverError().build());
  ...
  public Acl loadAcl(@PathParam(value = "guid") String guid) {
    ...
    try {
      ...
      log.error(
          "An error occurred loading acl for guid : {} {}",
          guid,
          PSExceptionUtils.getMessageForLog(e));
      log.debug(PSExceptionUtils.getDebugMessageForLog(e));
      throw new WebApplicationException(e.getMessage(), Response.serverError().build());
  ...
  public AclList loadAclsForObjects(GuidList objectGuids) {
    try {
      ...
      log.error(
          "An error occurred loading acl for guids : {} {}",
          objectGuids.toString(),
          PSExceptionUtils.getMessageForLog(e));
      log.debug(PSExceptionUtils.getDebugMessageForLog(e));
      throw new WebApplicationException(e.getMessage(), Response.serverError().build());
    }
  ...
  public Acl loadAclForObject(@PathParam(value = "objectGuid") String objectGuid) {
    try {
      ...
      log.error(
          "An error occurred loading acl for Object guid : {}, {}", objectGuid, e.getMessage());
      log.debug(PSExceptionUtils.getDebugMessageForLog(e));
      throw new WebApplicationException(e.getMessage(), Response.serverError().build());
    }
  }
  ...
  public Status deleteAcl(Guid aclGuid) {
    ...
    try {
      ...
      log.error(
          "An error occurred deleting acl:{}, Error: {}",
