...
public class DisplayFormatResource {
  ...
  @Autowired private IDisplayFormatAdaptor adaptor;
  ...
  @Operation(
      summary = "Get a Display Format by name",
      description = "Returns a Display Format that matches the name.",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(
      summary = "Get a Display Format by GUID",
