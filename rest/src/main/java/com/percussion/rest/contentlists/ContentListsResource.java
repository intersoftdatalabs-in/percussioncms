...
public class ContentListsResource {
  ...
  @Operation(
      summary = "Get a ContentList by id. Will return a ContentList if it exists.",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
            content = @Content(schema = @Schema(implementation = ContentList.class))),
        @ApiResponse(responseCode = "500", description = "Error")
      })
  public ContentList getContentListById(
      @PathParam("id")
          @Parameter(name = "id", description = "The id of the Content List to lookup.")
          long id) {
  ...
  @Operation(
      summary =
          "Get a list of available Content List Generators.  Will return a list of all Content List Generators registered on the system",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
  ...
  @Operation(
      summary =
          "Get a list of available Template Expanders.  Will return a list of all Content List Template Expanders registered on the system",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
  ...
  @Operation(
      summary =
          "Get a list of Content Lists defined for the specified Edition.  Will return a list of all Content Lists linked to the specified Edition",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
  ...
  public List<ContentList> getContentListsByEditionId(
      @PathParam(value = "id")
          @Parameter(
              name = "id",
              description = "The id of the Edition to retrieve content lists for.")
          long editionId) {
  ...
  public List<ContentList> getUnusedContentLists(
      @PathParam(value = "id") @Parameter(name = "id", description = "A valid Site ID")
          long siteId) {
  ...
  @Path("/")
  @Operation(
      summary = "Create or Update the specified ContentList.  Will return the updated ContentList",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
  ...
  public ContentList createOrUpdateContentList(
      @Parameter(allowEmptyValue = false, name = "body") ContentList cl) {
  ...
  public void deleteContentList(
      @PathParam(value = "id")
          @Parameter(
              name = "id",
              required = true,
              description = "The id of the ContentList to delete.  Must exist.")
          long id) {
