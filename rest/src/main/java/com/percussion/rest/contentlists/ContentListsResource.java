...
public class ContentListsResource {
  ...
  @Operation(
      summary =
          "Get a list of available Content List Generators.  Will return a list of all Content List"
              + " Generators registered on the system",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
  ...
  @Operation(
      summary =
          "Get a list of available Template Expanders.  Will return a list of all Content List"
              + " Template Expanders registered on the system",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
  ...
  @Operation(
      summary =
          "Get a list of Content Lists defined for the specified Edition.  Will return a list of"
              + " all Content Lists linked to the specified Edition",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
