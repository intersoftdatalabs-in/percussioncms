...
public interface IAssetAdaptor {
     ...
     */
    Collection<Asset> getSharedAssets(URI baseURI, String path, String type) throws BackendException, PSDataServiceException;
     ...
     */
    Asset uploadBinary(URI baseURI, String path, String assetType, InputStream inputStream, String uploadFilename, String fileMimeType, boolean forceCheckOut) throws BackendException;
     ...
     */
    Asset renameSharedAsset(URI baseURI, String site, String folder, String name, String newName) throws BackendException;
    ...
    List<String> previewAssetImport(URI baseUri, String osFolder, String assetFolder, boolean replace, boolean onlyIfDifferent, boolean autoApprove) throws BackendException;

    void assetImport(URI baseUri, String osFolder, String assetFolder, boolean replace, boolean onlyIfDifferent, boolean autoApprove);
}
