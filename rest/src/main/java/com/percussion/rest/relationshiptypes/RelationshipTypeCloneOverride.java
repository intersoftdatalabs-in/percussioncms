...
/**
 * Cloning field override on a relationship type ({@code PSCloneOverrideField}): content-editor
 * field name plus UDF replacement ({@code PSExtensionCall}).
 */
@XmlRootElement(name = "RelationshipTypeCloneOverride")
@JsonInclude(JsonInclude.Include.NON_NULL)
@Schema(description = "Relationship type cloning field override (field + UDF)")
public class RelationshipTypeCloneOverride {
  ...
  @Schema(
      description =
          "Fully qualified UDF extension ref (e.g. Java/global/percussion/generic/sys_Literal)")
  private String extensionRef;

  @Schema(description = "Literal UDF parameter values, in call order")
