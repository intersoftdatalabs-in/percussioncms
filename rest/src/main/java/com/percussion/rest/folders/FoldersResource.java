...
public class FoldersResource {
  ...
  @Operation(
      ...
      description =
          "Get folder with site name path and folder name."
  ...
  @Operation(
      ...
      description =
          "Create or update folder using site name, path, and folder name."
  ...
  @Operation(
      ...
      description =
          "Delete a folder item below the first level of the site."
  ...
  @Operation(
      ...
      description =
          "Delete a folder below the first level of the site."
              + "<br/> Simple send a DELETE request using the site name, path to the folder, and the folder name."
  ...
  @Operation(
      summary =
          "Moves the specified item in the MoveFolderItem request to the target path.  Path should include the full path to the item and folder, for example /Sites/MySite/MyFolder/MyPage",
      responses = {
  ...
  @Operation(
      summary =
          "Moves the specified Folder in the MoveFolderItem request to the target path.  Path should include the full path to the source Folder and Target folder, for example /Sites/MySite/MyFolder/MySubFolder",
      responses = {
        @ApiResponse(responseCode = "404", description = "Item not found"),
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      summary =
          "Copies the specified item in the CopyFolderItemRequest request to the target path.  Path should include the full path to the item and folder, for example /Sites/MySite/MyFolder/MyPage",
      responses = {
        @ApiResponse(responseCode = "404", description = "Item not found"),
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      summary =
          "Moves the specified Folder in the CopyFolderItem request to the target path.  Path should include the full path to the folder, for example /Sites/MySite/MyFolder",
      responses = {
        @ApiResponse(responseCode = "404", description = "Folder not found"),
        @ApiResponse(
            responseCode = "200",
