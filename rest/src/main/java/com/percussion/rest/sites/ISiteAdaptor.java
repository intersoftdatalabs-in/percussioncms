...
public interface ISiteAdaptor {
   ...
   * robots-txt} / {@code llms-txt} / {@code openapi-yaml}, required root path when virtual and
   ...
   * {@code robots-txt}, {@code llms-txt}, and {@code openapi-yaml} require a portable-safe local
   ...
   * fixture only — no live spec fetch). GET after PUT round-trips the stored {@code sourceKind}.
   *
   * @param nameOrId site name or GUID string, not blank
