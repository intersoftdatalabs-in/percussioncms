 ...
 * {@code http-json}, {@code object-storage}, {@code rss-atom}, and {@code icalendar} (not
 * git-only). Missing or failed builds return HTTP 200 with {@code available=false} and a
 * message — not 500.
 *
