  ...
  @Operation(
      ...
      description =
          "Persists virtual.* properties. Validation aligns with PSVirtualSiteHelper:"
              ...
              + " openapi-yaml, asyncapi-yaml), required non-blank rootPath for"
              + " sql-database, http-json, object-storage, rss-atom, icalendar, sitemap-xml, robots-txt, llms-txt, openapi-yaml, and asyncapi-yaml; for"
              ...
              + " icalendar, sitemap-xml, robots-txt, llms-txt, openapi-yaml, and asyncapi-yaml reject remoteUrl — no secrets on this envelope), safe"
