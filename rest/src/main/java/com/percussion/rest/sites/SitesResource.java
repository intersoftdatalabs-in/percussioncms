  ...
  @Operation(
      ...
      description =
          "Persists virtual.* properties. Validation aligns with PSVirtualSiteHelper:"
              ...
              + " object-storage, rss-atom, icalendar, sitemap-xml), required non-blank rootPath for"
              + " sql-database, http-json, object-storage, rss-atom, icalendar, and sitemap-xml; for"
              ...
              + " icalendar, and sitemap-xml reject remoteUrl — no secrets on this envelope), safe"
  ...
  @Operation(
      ...
      description =
          "Runs the Virtual Site static build for a site configured with"
              ...
              + " properties, and cloud rootPath are 400. A second sitemap-xml Build after an"
              + " in-process sitemap.xml / sitemap.file or referenced-page edit returns"
