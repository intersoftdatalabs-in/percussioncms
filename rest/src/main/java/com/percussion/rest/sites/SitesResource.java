  ...
  @Operation(
      ...
      description =
          "Persists virtual.* properties. Validation aligns with PSVirtualSiteHelper:"
              ...
              + " openapi-yaml, asyncapi-yaml, graphql-sdl), required non-blank rootPath for"
              + " sql-database, http-json, object-storage, rss-atom, icalendar, sitemap-xml, robots-txt, llms-txt, openapi-yaml, asyncapi-yaml, and graphql-sdl; for"
              ...
              + " icalendar, sitemap-xml, robots-txt, llms-txt, openapi-yaml, asyncapi-yaml, and graphql-sdl reject remoteUrl — no secrets on this envelope), safe"
              ...
              + " last-build HTML to IPSSite.root). GET after PUT"
  ...
  @Operation(
      ...
      description =
          "Runs the Virtual Site static build (always using the default output root; unlike POST"
              ...
              + " missing assemble is 400 and does not invent pages),"
