...
/**
 * Control property values and choice catalog for one system-definition field (CD-16 / CD-07 on
 * system def).
 *
 * <p>Jackson root wrap is {@code SystemDefControlProperties}. GET always returns {@code
 ...
 * clears).
 */
@XmlRootElement(name = "SystemDefControlProperties")
@JsonInclude(JsonInclude.Include.NON_NULL)
@Schema(description = "System-def field control property values and choice catalog (CD-16)")
public class SystemDefControlProperties {
  ...
  public SystemDefControlProperties() {}
