...
public class Examples {
  ...
  static {
    ...
    calendar.setCalendars(new ArrayList<>(Arrays.asList(new String[] {"Caldendar1", "Calendar2"})));
    ...
    seo.setCategories(Arrays.asList(new String[] {"Category1", "Category2"}));
    seo.setTags(Arrays.asList(new String[] {"Tag1", "Tag2"}));
