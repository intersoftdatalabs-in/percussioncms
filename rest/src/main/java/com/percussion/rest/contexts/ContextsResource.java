...
public class ContextsResource {
  ...
  @Autowired private IContextsAdaptor adaptor;

  @Autowired private ILocationSchemeAdaptor locationSchemeAdaptor;

  @jakarta.ws.rs.core.Context private UriInfo uriInfo;
  ...
  @Path("/{id}")
  @Operation(
      summary = "Delete the specified publishing Context",
      responses = {
        @ApiResponse(
            responseCode = "200",
  ...
  public Status deleteContext(
      @PathParam(value = "id")
          @Parameter(name = "id", description = "The id of the publishing Context to delete")
          String id) {
    try {
  ...
  @Path("/{id}")
  @Operation(
      summary = "Get a publishing Context by id",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
  ...
  public Context getContextById(
      @PathParam(value = "id")
          @Parameter(name = "id", description = "The guid id for the Publishing Context to return")
          String id) {
    try {
  ...
  @Operation(
      summary = "Get the available Publishing Contexts",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
            content =
                @Content(array = @ArraySchema(schema = @Schema(implementation = Context.class)))),
        @ApiResponse(responseCode = "500", description = "Error")
      })
  ...
  @Operation(
      summary =
          "Create or update the publishing Context. Returns the updated Context, id should not be"
              + " set for new Contexts",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
