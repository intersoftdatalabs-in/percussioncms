...
public class PagesResource {
  ...
  @Operation(
      ...
      description =
          "Get page with site name, path, and page name."
  ...
  @Operation(
      ...
      description =
          "Create or Update page using site name, path, and page name."
  ...
  @Operation(
      ...
      description =
          "Rename a page to a new a new name using site name, path, and page name."
  ...
  @Operation(
      summary =
          "Approves every Page on the system that are not in an Archive state and that live in the specified folder.",
      description =
          "Example /Passing the root folder will result in all Pages being approved.  Will override any checkout status and approve the Pages as the method caller.",
      responses = {
  ...
  @Operation(
      ...
      description =
          "Example /Passing the root folder will result in all Pages being Submitted.  Will override any checkout status and Submit the Pages as the method caller.",
      responses = {
        @ApiResponse(responseCode = "500", description = "An unexpected exception occurred."),
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Example /Passing the root folder will result in all Pages being Archived.  Will override any checkout status and Archives the Pages as the method caller.",
      responses = {
        @ApiResponse(responseCode = "500", description = "An unexpected exception occurred."),
        @ApiResponse(
            responseCode = "200",
