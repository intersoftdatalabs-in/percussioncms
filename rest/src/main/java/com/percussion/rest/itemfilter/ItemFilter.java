...
public class ItemFilter {
  ...
  /** Name of the filter rule, never <code>null</code> or empty after construction */
  ...
  /** The filter is an aggregation of rules to be applied to the items being filtered. */
  @Schema(name = "rules")
  private Set<ItemFilterRuleDefinition> rules;

  /** Item filters can be changed, this member points to the parent filter, if there is one */
  @Schema(
      name = "parentFilter",
