...
public class ActionMenu {
  ...
  @Schema(
      description =
          "Display label for this action. Can be used to set the label for\n"
  ...
  @Schema(
      description = "The menu type, never null or empty, must be\n" + "a valid menu type.",
      allowableValues =
          PSAction.TYPE_MENU
              + ","
  ...
  @Schema(
      description =
          "An array of the Properties defined for this menu.   <table>\n"
