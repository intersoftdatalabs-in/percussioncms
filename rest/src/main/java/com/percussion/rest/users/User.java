...
public class User {
  ...
  @Schema(
      name = "firstName",
      required = false,
      description = "The first name of the user - Read only for LDAP users")
  private String firstName;

  @Schema(
      name = "lastName",
      required = false,
      description = "The last name of the user - Read only for LDAP users")
  private String lastName;

  @Schema(
      name = "email",
      required = false,
      description = "The email address of the User - read only for LDAP users.")
  ...
  @Schema(
      name = "bookmarkedPages",
      required = false,
      description = "List of Pages bookmarked by this user.")
  private List<LinkRef> bookmarkedPages;

  @Schema(
      name = "recentPages",
      required = false,
      description = "List of Pages Recently edited by this user.")
  ...
  @Schema(
      name = "recentSiteFolders",
      required = false,
      description = "List of Recently used Site Folders this user.")
  private List<LinkRef> recentSiteFolders;

  @Schema(
      name = "recentTemplates",
      required = false,
      description = "List of Recently used templates by this user.")
  private List<LinkRef> recentTemplates;

  @Schema(
      name = "personalPage",
      required = false,
      description = "The qualifed folder path to this users Personal Page")
  private LinkRef personalPage;

  @Schema(
      name = "personAssets",
      required = false,
      description = "A list of PersonAssets that represent this user.")
  private List<LinkRef> personAssets;

  @Schema(
      name = "roles",
      required = false,
      description = "A list of the Role names that this user belongs to.")
  ...
  public List<LinkRef> getBookmarkedPages() {
    if (bookmarkedPages == null) bookmarkedPages = new ArrayList<>();
  ...
  public List<LinkRef> getRecentPages() {
    if (recentPages == null) recentPages = new ArrayList<>();
  ...
  public List<LinkRef> getRecentAssetTypes() {
    if (recentAssetTypes == null) recentAssetTypes = new ArrayList<>();
  ...
  public List<LinkRef> getRecentAssetFolders() {
    if (recentAssetFolders == null) recentAssetFolders = new ArrayList<>();
  ...
  public List<LinkRef> getRecentSiteFolders() {
    if (recentSiteFolders == null) recentSiteFolders = new ArrayList<>();
  ...
  public List<LinkRef> getRecentTemplates() {
    if (recentTemplates == null) recentTemplates = new ArrayList<>();
  ...
  public LinkRef getPersonalPage() {
    if (personalPage == null) personalPage = new LinkRef();
    return personalPage;
  }
