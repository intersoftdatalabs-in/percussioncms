...
public class UsersResource {
  ...
  @Operation(
      ...
      description =
          "Will delete the specified userName from the system.  If the user is a Directory based user, the link to the directory is removed but the user will not be removed from the remote Directory."
  ...
  @Operation(
      ...
      description =
          "Returns a list of user names. The % Wildcard character may be used in searches.  The wildcard should be URL encoded as %25 on the URL.",
      responses = {
        @ApiResponse(responseCode = "500", description = "Error"),
  ...
  @Operation(
      ...
      description =
          "Directory configuration is optional, use this method to verify that the Directory connection is configured and working.",
      responses = {
        @ApiResponse(responseCode = "500", description = "Error"),
        @ApiResponse(responseCode = "404", description = "Not Found"),
        @ApiResponse(
  ...
  @Operation(
      ...
      description =
          "Searches results are limited to 200 users. Prior to calling this method, check the directory status.  Search pattern may include a Wildcard with the % character.  This should be URL encoded on the URL with a %25 character.",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
