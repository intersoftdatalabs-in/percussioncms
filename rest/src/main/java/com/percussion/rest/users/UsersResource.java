...
/** REST resource for User operations. Sunny Sal: "User resource, authentication ka force!" */
...
public class UsersResource {
  ...
  @Operation(
      ...
      description =
          "Will delete the specified userName from the system. If the user is a Directory based"
              + " user, the link to the directory is removed but the user will not be removed from"
              + " the remote Directory.<br/> Send a DELETE request using the userName<br/> Example"
              + " URL: http://localhost:9992/Rhythmyx/rest/users/userNameToDelete .",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
  ...
  public Status deleteUser(
      @Parameter(description = "The userName of the user to delete.", name = "userName")
          @PathParam("userName")
          String userName) {
    int retCode = 404;
  ...
  public User updateUser(
      ...
      @Parameter(description = "The userName to be updated or created", name = "userName")
          @PathParam("userName")
          String userName) {
    try {
      userName = java.net.URLDecoder.decode(userName, "UTF-8");
  ...
  @Operation(
      ...
      description =
          "Returns a list of user names. The % Wildcard character may be used in searches. The"
              + " wildcard should be URL encoded as %25 on the URL.",
      responses = {
        @ApiResponse(responseCode = "500", description = "Error"),
  ...
  @Operation(
      summary =
          "Check the status of the Active Directory or LDAP connection for external directories.",
      description =
          "Directory configuration is optional, use this method to verify that the Directory"
  ...
  @Operation(
      ...
      description =
          "Search results are limited to 200 users. Prior to calling this method, check the"
              + " directory status. Search pattern may include a Wildcard with the % character."
              + " This should be URL encoded on the URL with a %25 character.",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "OK",
