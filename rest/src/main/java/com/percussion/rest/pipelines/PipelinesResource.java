 ...
 * {@code shutdownApplication}. Validation peers {@code PSValidatorAdapter#validateApplication}.
 */
...
@Tag(
    name = "Pipelines",
    description =
        "Data pipeline / XML application design catalog, Admin start/stop, validation, and thin IR"
            + " execute")
