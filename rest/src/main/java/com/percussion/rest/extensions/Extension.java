...
public class Extension {
  ...
  @Schema(
      ...
      description =
          "When true if an error occurs on processing the original request parameters will be"
              + " restored.")
  ...
  @Schema(
      ...
      description = "A list of URLs pointing to resource locations for the Extension")
