...
public class Extension {
  ...
  @Schema(
      name = "fqn",
      required = false,
      description = "The fully qualified name for the extension")
  private String fqn;
  ...
  @Schema(
      name = "restoreRequestParamsOnError",
      description =
          "When true if an error occurs on processing the original request parameters will be restored.")
  ...
  @Schema(
      ...
      description = "A list of urls pointing to resources supplied by the Extension")
  private List<String> suppliedResources;

  @Schema(
      name = "resourceLocations",
      description = "A list of urls pointing to resources locations the Extension")
  private List<String> resourceLocations;

  @Schema(
      name = "supportedInterfaces",
      description = "A list of Java interfaces supported by this Extension")
  private List<String> supportedInterfaces;

  @Schema(
      name = "runtimeParameters",
      description = "A list of ExtensionParameter objects required by the extension")
  private List<ExtensionParameter> runtimeParameters;

  @Schema(
      name = "initParameters",
      description =
          "A map of key value pairs indicating the initParameters used to initialize the Extension")
