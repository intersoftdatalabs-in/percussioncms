...
public class ContentTypesResource {
  ...
  /**
   * Maps workflow-association failures. Typed lock conflicts are 409; do not infer 409 from
   * generic IllegalStateException message substrings.
   */
  private static WebApplicationException mapWorkflowsFailure(RuntimeException e) {
