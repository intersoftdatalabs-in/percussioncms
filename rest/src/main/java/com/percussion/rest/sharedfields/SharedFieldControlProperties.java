...
/**
 * Control property values and choice catalog for one shared field (CD-15 / CD-07 on shared defs).
 *
 * <p>Jackson root wrap is {@code SharedFieldControlProperties}. GET always returns {@code
 ...
 * clears).
 */
@XmlRootElement(name = "SharedFieldControlProperties")
@JsonInclude(JsonInclude.Include.NON_NULL)
@Schema(description = "Shared field control property values and choice catalog (CD-15)")
public class SharedFieldControlProperties {
  ...
  public SharedFieldControlProperties() {}
