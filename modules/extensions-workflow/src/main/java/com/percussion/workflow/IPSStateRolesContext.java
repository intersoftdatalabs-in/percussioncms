...
public interface IPSStateRolesContext {
  ...
  /**
   * Gets map with role ID as key and value = assignment type, which can take values defined in
   * {@link PSWorkFlowUtils}
   *
  ...
  /**
   * Gets map with role ID as key and value <CODE>true</CODE> if notification for the role is on,
   * else <CODE>false</CODE>
   *
   * @return map from role ID to <CODE>true</CODE>/<CODE>false</CODE> for notification on/off.
   */
  public Map getIsNotificationOnMap();

  /**
   * Gets map of role IDs for nonadhoc roles with trimmed lower case role names as key
   *
  ...
  /**
   * Gets map of role IDs for adhoc normal roles with trimmed lower case role names as key
   *
  ...
  /**
   * Gets map of role IDs for all state roles with trimmed lower case role names as key
   *
