...
public class PSXMLNodeMissingException extends PSException {
   ...
   *     null</code>.
   */
  public PSXMLNodeMissingException(String language, int msgCode, Object singleArg) {
   ...
   *     <code>null</code>.
   */
  public PSXMLNodeMissingException(String language, int msgCode, Object[] arrayArgs) {
