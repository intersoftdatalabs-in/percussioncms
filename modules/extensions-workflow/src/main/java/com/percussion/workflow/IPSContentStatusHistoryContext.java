...
/**
 * An interface that defines methods for creating new content status history records and accessing
...
public interface IPSContentStatusHistoryContext {
   ...
   *
   * @return the revision for the content item. For checkout return the base revision, which is
   *     either 1, or the revision of the content item copied to create the revision checked out.
   *     Must be <CODE>> 0</CODE>.
   */
   ...
   *
   * @return the title of the content item May not be more than 40 characters Initial and final
   ...
   *
   * @return the SessionID for this content status history entry. May not be more than 40 characters
   *     Initial and final whitespace will be trimmed.
   */
  public String getSessionID();

  /**
   * Gets the name of the user that performed this transition or action including check in and check
   * out (actor name).
   *
   * @return the actor name for this content status history entry. Initial and final whitespace will
   *     be trimmed.
   */
   ...
   *
   * @return the transition ID if the content item has undergone a transition, else 0.
   */
   ...
   *
   * @return <CODE>true</CODE> if content is publishable else <CODE>false</CODE>
   */
   ...
   *
   * @return the ID of the current state at completion of transition or action.
   */
  public int getContentStateID();

  /**
   * Gets the name of the current state at completion of transition or action.
   *
   * @return the name of the current state at completion of transition or action. May not be more
   *     than 50 characters Initial and final whitespace will be trimmed.
   */
   ...
   *
   * @return for a transition, the transition label, "CheckIn" for a check in, "CheckOut for a check
   *     out May not be more than 50 characters Initial and final whitespace will be trimmed.
   */
  public String getTransitionLabel();

  /**
   * Gets the comma-separated list of assigned role names for the content item's current state.
   *
   * @return comma-separated list of assigned role names for the content item's current state May
   *     not be more than 255 characters. Initial and final whitespace will be trimmed.
   */
   ...
   *
   * @return name of the user that last modified this content item May not be more than 255
   *     characters. Initial and final whitespace will be trimmed.
   */
   ...
   *
   * @return the descriptive comment for this transition. May not be more than 255 characters.
   *     Initial and final whitespace will be trimmed.
   */
