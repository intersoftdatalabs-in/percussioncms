...
public class PSExecuteWorkflowActions implements IPSResultDocumentProcessor {
  ...
  public Document processResultDocument(
    ...
    List workflowActions =
        (List) requestContext.getPrivateObject(IPSWorkflowAction.WORKFLOW_ACTIONS_PRIVATE_OBJECT);
    ...
    PSWorkFlowContext wfContext =
        (PSWorkFlowContext)
            requestContext.getPrivateObject(IPSWorkFlowContext.WORKFLOW_CONTEXT_PRIVATE_OBJECT);
     ...
     * the same request.
     */
    requestContext.setPrivateObject(IPSWorkflowAction.WORKFLOW_ACTIONS_PRIVATE_OBJECT, null);
    ...
    PSWorkFlowUtils.printWorkflowMessage(
        requestContext, "PSExecute WorkflowActions: exit processResultDocument ");
    return resultDoc;
  }
