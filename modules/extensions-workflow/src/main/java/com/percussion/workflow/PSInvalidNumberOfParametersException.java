...
/**
 * PSAuthorizationException is thrown to indicate that
 * authorization failed.Reason for the failure is indicated in the
 * exception message.
 */
public class PSInvalidNumberOfParametersException extends PSException {
   ...
   */
  public PSInvalidNumberOfParametersException(String language, int msgCode) {
   ...
   */
  public PSInvalidNumberOfParametersException(String language, int msgCode, Object singleArg) {
  ...
  /**
   * Construct the exception using array of arguments.
   * @param sa can be <code>null</code>.
   */
  public PSInvalidNumberOfParametersException(String[] sa) {
    super();
    m_params = sa;
  }
