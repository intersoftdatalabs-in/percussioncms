...
public class PSContentStatusContextTest extends PSAbstractWorkflowTest {
  ...
  public void ExecuteTest(Connection connection) throws PSWorkflowTestException {
    ...
    try {
      ...
      PSContentStatusContext csc = new PSContentStatusContext(connection, m_nContentID);
      ...
      workingVarCal = PSWorkFlowUtils.incrementCalendar(workingVarCal, now, -60 * m_nSetBackHours);
      ...
      csc.setReminderDate(
          PSWorkFlowUtils.sqlDateFromCalendar(
              PSWorkFlowUtils.incrementCalendar(workingVarCal, startDate, m_nReminderOffset)));
  ...
  public int GetArgValues(int i) {
    ...
    if (m_sArgs[i].equals("-n") || m_sArgs[i].equals("-nextagingtransition")) {
    ...
    if (m_sArgs[i].equals("-t") || m_sArgs[i].equals("-tiprevision")) {
  ...
  public static void main(String[] args) {
    PSContentStatusContextTest wfTest = new PSContentStatusContextTest(args);
    wfTest.Test();
  }
