...
public class PSTransitionNotificationsContextTest extends PSAbstractWorkflowTest {
  ...
  private static final Logger log =
      LogManager.getLogger(PSTransitionNotificationsContextTest.class);
  ...
  public void ExecuteTest(Connection connection) throws PSWorkflowTestException {
    ...
    try {
      context = new PSTransitionNotificationsContext(m_nWorkflowID, m_nTransitionID, connection);
      log.info(
          "Notification count for TransitionID {}, workflowID {} is {}",
          m_nWorkflowID,
          m_nTransitionID,
          context.getCount() + "\n");
  ...
  public static void main(String[] args) {
    PSTransitionNotificationsContextTest wfTest = new PSTransitionNotificationsContextTest(args);
    wfTest.Test();
  }
