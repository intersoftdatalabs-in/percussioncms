...
public class PSJdbcTableDataCollection extends PSCollection {
  ...
  public final void fromXml(Element sourceNode) throws PSJdbcTableFactoryException {
    ...
    Element table = walker.getNextElement(PSJdbcTableData.NODE_NAME, firstFlags);
  ...
  public static void main(String[] args) {
    if (args.length != 1) {
      ...
      log.info("where <tables> is an xml file containing the expected xml.");
      System.exit(1);
    }
