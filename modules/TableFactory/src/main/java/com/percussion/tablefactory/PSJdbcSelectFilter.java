...
public class PSJdbcSelectFilter {
  ...
  public PSJdbcSelectFilter(String filterString) {
    if ((filterString == null) || (filterString.trim().length() < 1))
      throw new IllegalArgumentException("filterString may not be null or empty");
  ...
  public PSJdbcSelectFilter(String colName, int op, String colValue, int colDataType) {
    ...
    if (colValue == null) throw new IllegalArgumentException("colValue may not be null");

    if (!isValidOp(op)) throw new IllegalArgumentException("invalid conditional operator");
  ...
  public static void main(String[] args) {
    PSJdbcSelectFilter filter =
        new PSJdbcSelectFilter("Name", PSJdbcSelectFilter.NOT_LIKE, "a%", Types.VARCHAR);
    ...
    container1.doAND(
        new PSJdbcSelectFilter("ID", PSJdbcSelectFilter.GREATER_THAN, "10", Types.INTEGER));
    container1.doAND(new PSJdbcSelectFilter("Name", PSJdbcSelectFilter.LIKE, "a%", Types.VARCHAR));

    PSJdbcFilterContainer container2 = new PSJdbcFilterContainer();
    container2.doAND(
        new PSJdbcSelectFilter("AGE", PSJdbcSelectFilter.LESS_THAN, "30", Types.INTEGER));
    container2.doAND(
        new PSJdbcSelectFilter("Name", PSJdbcSelectFilter.IS_NOT_NULL, "", Types.VARCHAR));
