...
public class PSJdbcTableChangeEvent {
  ...
  public PSJdbcTableChangeEvent(
      String driver, String server, String database, String schema, String table, int action) {
    ...
    if (action != ACTION_SCHEMA_CHANGED) throw new IllegalArgumentException("invalid action type");
