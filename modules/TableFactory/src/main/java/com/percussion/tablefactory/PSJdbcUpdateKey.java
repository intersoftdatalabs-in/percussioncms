...
/**
 * This class is used to represent a update key in a table schema. Specifies columns to use as keys
 * when updating data instead of using the primary key columns.
 */
public class PSJdbcUpdateKey extends PSJdbcKey {
  /**
   * Basic constructor for this class.
   *
   * @param names An iterator over one or more column names as Strings to include in the update key.
   *     May not be <code>null</code>. May not contain <code>null</code>, empty or duplicate names.
   ...
   */
  public PSJdbcUpdateKey(Iterator<String> names) throws PSJdbcTableFactoryException {
   ...
   *     to the definition for the updatekey element in the tabledef.dtd. May not be <code>null
   *     </code>.
   ...
   */
  public PSJdbcUpdateKey(Element sourceNode) throws PSJdbcTableFactoryException {
   ...
   *     the definition for the updatekey element in the tabledef.dtd. May not be <code>null</code>.
   * @throws IllegalArgumentException if sourceNode is <code>null</code>.
   * @throws PSJdbcTableFactoryException if the Xml definition contains any empty or duplicate
   *     column names, or if there are any other errors.
   */
