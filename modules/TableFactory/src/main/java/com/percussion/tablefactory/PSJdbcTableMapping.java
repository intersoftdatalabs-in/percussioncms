...
public class PSJdbcTableMapping {
  ...
  public void addRowMapping(IPSJdbcRowMapping rowMapping) {
    if (rowMapping == null) throw new IllegalArgumentException("rowMapping may not be null");
  ...
  public void addRowMapping(Element sourceNode) throws PSJdbcTableFactoryException {
    ...
    while (rowMapEl != null) {
      PSJdbcRowMapping rowMapping = new PSJdbcRowMapping(m_dbmsDef, m_tableSchema);
