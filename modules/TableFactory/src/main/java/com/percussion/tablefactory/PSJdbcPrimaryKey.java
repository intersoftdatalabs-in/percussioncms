...
/**
 * This class is used to represent a primary key in a table schema, and the action to perform when
 * that table schema is used to create or modify a table.
 */
public class PSJdbcPrimaryKey extends PSJdbcKey {
  /**
   * Convenience method for calling {@link #PSJdbcPrimaryKey(String, Iterator, int)} with the pkName
   * parameter as <code>null</code>. See that method for parameter descriptions.
   */
  public PSJdbcPrimaryKey(Iterator<String> names, int action) throws PSJdbcTableFactoryException {
    this(null, names, action);
  }

  /**
   * Initializes a newly created <code>PSJdbcPrimaryKey</code> object, from the specified
   * parameters.
   *
   * @param pkName the name to use for this constraint's identifier, may be <code>null</code> or
   *     empty to let the backend assign a identifier.
   * @param names An iterator over one or more column names as Strings to include in the primary
   *     key. May not be <code>null</code>. May not contain <code>null</code>, empty or duplicate
   *     names.
   ...
   *     element or if action is not valid.
   ...
   */
  public PSJdbcPrimaryKey(Element sourceNode) throws PSJdbcTableFactoryException {
  ...
  /**
   * Compares this primary key to another object. See {@link PSJdbcTableComponent#compare(Object,
   * int)} for values returned by this method.
   *
