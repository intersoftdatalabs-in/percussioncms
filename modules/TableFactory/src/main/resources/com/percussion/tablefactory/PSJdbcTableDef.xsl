...
<!-- Transforms documents conforming to the sys_DatabasePublisher.dtd to
	a document conforming to the tabledef.dtd. -->
<xsl:stylesheet version="1.0"
	...
	<!-- Transform all elements 'rowdef' to 'row' and copy all attributes without
		changes. -->
