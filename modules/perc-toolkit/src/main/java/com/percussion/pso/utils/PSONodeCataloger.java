...
/**
 * Finds Property Definitions for a given Node Definition. This can be used to catalog node types
 * (or content types).
 *
 * <p>Note that the names of all Node Definitions and Property Definitions begin with "rx:". This is
 * how they are returned from the server.
 *
 * @author DavidBenua
 */
public class PSONodeCataloger {
   ...
   * @return the names of the content types. Never <code>null</code> but may be <code>empty</code>
