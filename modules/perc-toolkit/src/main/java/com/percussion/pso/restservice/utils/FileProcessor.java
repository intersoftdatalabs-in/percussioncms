...
public class FileProcessor {
  ...
  public static void process(PSCoreItem psItem) {
    ...
    while (iterator.hasNext()) {
      ...
      if (field.getItemFieldMeta().isBinary()) {
        ...
        String mimetype = determineMimeType(temp.getSourceContentType(), temp.getSourceFileName());
   ...
   */
  private static final Map<String, String> ms_wellKnownExts = new HashMap<String, String>(2);
