...
public class PSOBase64Codec extends PSJexlUtilBase implements IPSJexlExpression {
   ...
   * @return the byte array. Will be <code>null</code> if the stream is <code>null</code>.
   ...
   * @throws UnsupportedEncodingException if an error occurs. ASCII should always be supported, so
