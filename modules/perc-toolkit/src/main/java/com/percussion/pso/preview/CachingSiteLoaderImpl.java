 ...
 *
 * <p>Otherwise, the siteReloadDelay is the number of seconds to wait before reloading the sites.
 *
 * @author DavidBenua
 */
public class CachingSiteLoaderImpl implements InitializingBean, SiteLoader {
  ...
  /**
   * The site reload delay, in seconds. Set to 0, the sites will never be reloaded. Set < 0, the
   * sites will not be cached.
   */
  ...
  /**
   * Gets the site reload delay in seconds. If this value is 0, the sites will not be reloaded.
   *
