...
public interface SiteEditionLookUpService {
   ...
   * @throws SiteLookUpException when the site preview information cannot located or the
   ...
   *
   * @return the site names. Never <code>null</code> but may be <code>empty</code>.
   */
