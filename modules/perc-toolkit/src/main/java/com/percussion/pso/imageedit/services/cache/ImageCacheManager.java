...
public interface ImageCacheManager {
  ...
  /**
   * Removes an image from the cache. Images should be removed when the application has finished
   * with them. The cache configuration controls whether unused images get flushed over time.
   *
   * @param imageKey the image key.
   */
