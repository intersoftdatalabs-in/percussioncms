...
public interface ImageSizeDefinitionManager {
  /**
   * Get a specific image size by code. Will return <code>null</code> if the image size is not
   * defined.
   *
   * @param code the image size code.
   * @return the image size definition, or <code>null</code> if the requested size is not defined.
   */
   ...
   *
   * @return the list of defined image sizes. The order depends on the order of definitions in the
   *     beans XML.
   */
  ...
  /**
   * Gets the property name of the image size code in the sized image child node.
   *
  ...
  /**
   * Gets the image path to be used when there is no image.
   *
