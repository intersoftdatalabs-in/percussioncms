  ...
  */
  ...
  public final Document processResultDocument(
    ...
    if ((isRequestToBeProcessedForBuilding(request) && m_mode == Mode.BUILD)
      ...
      final PSExtensionHelper helper =
          new PSExtensionHelper(builder, this.getParameters(params), request);
  ...
  public final Object processUdf(Object[] params, IPSRequestContext request)
    ...
    PSExtensionHelper helper = new PSExtensionHelper(builder, getParameters(params), request);
    return helper.retrieveIds();
  }

  public abstract IPSRelationshipBuilder createRelationshipBuilder(
