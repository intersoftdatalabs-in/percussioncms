...
public class PSEffectLoggingEffect implements IPSEffect {
  ...
  public void test(
    ...
    switch (exCtx.getContextType()) {
      case IPSExecutionContext.RS_CHECKIN:
        context = "CHECKIN";
        break;
      case IPSExecutionContext.RS_CHECKOUT:
        context = "CHECKOUT";
        break;
      case IPSExecutionContext.RS_CONSTRUCTION:
        context = "CONSTRUCTION";
        break;
      case IPSExecutionContext.RS_DESTRUCTION:
        context = "DESTRUCTION";
        break;
      ...
      case IPSExecutionContext.RS_POST_WORKFLOW:
        context = "POST_WORKFLOW";
        break;
        // case IPSExecutionContext.RS_PRE_CHECKIN: context="PRE_CHECKIN"; break;
      case IPSExecutionContext.RS_PRE_CLONE:
        context = "PRE_CLONE";
        break;
      ...
      case IPSExecutionContext.RS_PRE_WORKFLOW:
        context = "PRE_WORKFLOW";
        break;
      case IPSExecutionContext.RS_UPDATE:
        context = "UPDATE";
        break;
      default:
        context = "UNKOWN";
