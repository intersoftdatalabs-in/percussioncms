...
public class PSOTransform extends PSJexlUtilBase implements IPSJexlExpression {
   ...
   */
  @IPSJexlMethod(
      description = "Transform a value with an XSLT transform",
      params = {
  ...
  /**
   * Transforms an XML string with XSLT. The source will be wrapped in a <code>
   * &lt;div class="rxbodyfield"&gt;</code>. The source may contain multiple elements, but otherwise
   * must be well formed.
   *
   * <p>The parameters may be referenced with <code>&lt;xsl:param...</code> as a direct child of the
   * <code>&lt;xsl:stylesheet></code> node.
   *
   * @param source the source string.
   * @param stylesheetName the name of the stylesheet, relative to the Percussion CMS root. This
   *     should be a file url. For example: <code>file:rx_resource/stylesheets/myStylesheet.xsl
   *     </code>
