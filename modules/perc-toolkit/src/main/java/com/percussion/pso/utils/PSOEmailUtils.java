  ...
  public static void sendEmail(
    ...
    try {
      ...
      message.addRecipients(
          Message.RecipientType.TO, splitEmailAddresses(to_line).toArray(new Address[0]));

      if (cc_line != null)
        message.addRecipients(
            Message.RecipientType.CC, splitEmailAddresses(cc_line).toArray(new Address[0]));

      if (bcc_line != null)
        message.addRecipients(
            Message.RecipientType.BCC, splitEmailAddresses(bcc_line).toArray(new Address[0]));
