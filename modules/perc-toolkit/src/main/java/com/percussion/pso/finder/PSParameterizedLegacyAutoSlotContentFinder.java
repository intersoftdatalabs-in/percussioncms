...
/**
 * This class is a rewrite of the out of the box Legacy "finder". That version did not accept
 * request parameters which meant it either needed to be used with static URL or invoked multiple
 * times for each set of possible parameters. To do the latter, you would have needed a slot
 * registration for each permutation.
 *
 * @author Erich Heard
 * @version 6.0
 */
public class PSParameterizedLegacyAutoSlotContentFinder extends PSBaseSlotContentFinder
  ...
  protected Set<SlotItem> getSlotItems(
      ...
      throws RepositoryException, PSFilterException {
