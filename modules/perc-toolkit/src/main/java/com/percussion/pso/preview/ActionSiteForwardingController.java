...
/**
 * Controller for miscellaneous actions such as Compare. These actions to not require a location,
 * just a site id.
 *
 * @author DavidBenua
 */
public class ActionSiteForwardingController extends AbstractMenuController implements Controller {
  ...
  protected ModelAndView handleRequestInternal(
    ...
    if (sites.size() == 1) {
      ...
      simpleMap.put(IPSHtmlParameters.SYS_SITEID, String.valueOf(site.getSiteId()));
      return redirectTo(baseUrl, simpleMap);
    }
