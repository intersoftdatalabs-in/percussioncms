...
public interface SiteFolderFinder {
   ...
   * pairs is restricted by the optional folder id and site id parameters. The return value is a
   * List of Maps. Each Map contains the <code>sys_siteid</code> and <code>sys_folderid</code> for
   * the selected folder. Other keys in the map are "sitename" and "fullpath".
   *
