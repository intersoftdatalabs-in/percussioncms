...
public class PSOThumbnailGeneratorTest {
  ...
  private class TestThumbnailGenerator extends PSOThumbnailGenerator {
    ...
    @Override
    public BufferedImage createBufferedImage(int width, int height, BufferedImage baseImage) {
    ...
    @Override
    public BufferedImage paintImage(BufferedImage inImage, int maxDim, int width, int height) {
      return super.paintImage(inImage, maxDim, width, height);
    }

    @Override
    public BufferedImage readImage(ImageInputStream iis, ImageReader reader) throws IOException {
      return super.readImage(iis, reader);
    }

    @Override
    public void writeImage(BufferedImage outImage, ImageWriter iw, OutputStream outstream)
        throws IOException {
