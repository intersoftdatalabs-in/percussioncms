...
public class ActionPreviewControllerTest {
    ...
    @InjectMocks
    private ActionPreviewController cut = new ActionPreviewController();
    ...
    public final void testHandleRequestInternalHttpServletRequestHttpServletResponse() {
        ...
        try {
            ...
            Mockito.when(asm.findTemplatesByContentType(Mockito.any(IPSGuid.class))).thenReturn(Collections.singletonList(template));
            ...
            Mockito.when(urlbuilder.buildUrl(Mockito.any(IPSAssemblyTemplate.class), Mockito.any(Map.class), Mockito.any(SiteFolderLocation.class), Mockito.any(Boolean.class))).thenReturn("http://localhost/foo/bar/baz");
