...
public class PSONodeCatalogerTest
{
   ...
   @Mock
   private IPSContentMgr cmgr;
   @Mock
   private IPSNodeDefinition t1;
   @Mock
   private IPSNodeDefinition t2;
   @Mock
   private IPSNodeDefinition nd1;
   @Mock
   private IPSNodeDefinition nd2;
   @Mock
   private NodeType t1NodeType;
   @Mock
   private NodeType t2NodeType;
   @Mock
   private PropertyDefinition p1;
   @Mock
   private PropertyDefinition p2;
   @Mock
   private PropertyDefinition p3;
   @Mock
   private NodeTypeIterator nodes;
   @Mock
   private IPSNodeDefinition nodeDef;
   @Mock
   private NodeType t1Type;
