...
public class ImageResizeManagerImplTest {
  ...
  public final void testGenerateImageSimple() {
    try {
      InputStream imgStream =
          getClass()
              .getClassLoader()
              .getResourceAsStream("test/percussion/pso/imageedit/services/impl/Sample.jpg");
  ...
  public final void testBigImageMemory() {
    ...
    Dimension imgSize = new Dimension(100, 100);
    try {
      InputStream bigImgStream =
          getClass()
              .getClassLoader()
              .getResourceAsStream("test/percussion/pso/imageedit/services/impl/DSC_1720.jpg");
  ...
  private class TestableImageResizeManager extends ImageResizeManagerImpl {
    ...
    @Override
    public BufferedImage scaleImage(BufferedImage inImage, Rectangle sourceBox, Dimension outSize) {
