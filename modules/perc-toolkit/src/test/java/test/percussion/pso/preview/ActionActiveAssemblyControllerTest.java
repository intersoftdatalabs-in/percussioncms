...
public class ActionActiveAssemblyControllerTest {
    private static final org.apache.logging.log4j.Logger log = LogManager.getLogger(ActionActiveAssemblyControllerTest.class);
    ...
    public void testFindVisibleTemplates() {
        ...
        try {
            Mockito.when(asm.findTemplatesByContentType(Mockito.any(IPSGuid.class))).thenReturn(templates);
            ...
            List<IPSAssemblyTemplate> results = cut.findVisibleTemplates("2", Collections.singleton(site));
    ...
    private static class TestableActiveAssemblyController extends ActionActiveAssemblyController {
        @Override
        public List<IPSAssemblyTemplate> findVisibleTemplates(String contentid, Set<IPSSite> sites) throws PSException, PSAssemblyException {
