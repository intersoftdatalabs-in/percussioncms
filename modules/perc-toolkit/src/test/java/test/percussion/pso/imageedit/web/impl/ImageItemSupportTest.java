...
public class ImageItemSupportTest {
    ...
    private class TestableImageItemSupport extends ImageItemSupport {
        @Override
        public PSItemChildEntry findChildEntry(List<PSItemChildEntry> entries, String code) throws Exception {
        ...
        @Override
        public void readBinaryMetaData(IPSItemAccessor item, ImageMetaData image, String fieldName) throws Exception {
            super.readBinaryMetaData(item, image, fieldName);
        }
        @Override
        public void readMetaData(IPSItemAccessor item, Object bean, Map<String, String> fieldMap) throws Exception {
            super.readMetaData(item, bean, fieldMap);
        }
        @Override
        public void writeBinaryMetaData(IPSItemAccessor item, ImageMetaData image, String fieldName) throws Exception {
            super.writeBinaryMetaData(item, image, fieldName);
        }
        @Override
        public void writeMetaData(IPSItemAccessor item, Object bean, Map<String, String> fieldMap) throws Exception {
