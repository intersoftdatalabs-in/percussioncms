...
public class DefaultPageTemplateBeanTest {
	...
	public void testFindTemplateSingle() {
		...
		List<IPSAssemblyTemplate> tlist = new ArrayList<IPSAssemblyTemplate>(){{add(t1);}};
		IPSGuid t1ID = new PSGuid(PSTypeEnum.TEMPLATE, 1L);
		IPSGuid ctypeId = new PSGuid(PSTypeEnum.NODEDEF, 42L);
		PSComponentSummary summ = new PSComponentSummary(){{setContentTypeId(42L);}};
	...
	public void testFindTemplateMulti() {
		...
		List<IPSAssemblyTemplate> tlist = new ArrayList<IPSAssemblyTemplate>(){{add(t3); add(t2); add(t1);}};
		IPSGuid t1ID = new PSGuid(PSTypeEnum.TEMPLATE, 1L);
		...
		IPSSite site = mock(IPSSite.class);
		IPSGuid contentId = mock(IPSGuid.class);
		Set<IPSAssemblyTemplate> siteTemplates = new HashSet<IPSAssemblyTemplate>(){{add(t3); add(t1);}};
