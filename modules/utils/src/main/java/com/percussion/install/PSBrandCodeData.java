...
public class PSBrandCodeData {
  ...
  public void setBrandCodeMapVersion(int version) {
    if (version < 1) throw new IllegalArgumentException("Illegal brand code version number");
  ...
  public void setCodeExpires(Date expire) {
    if (expire == null) throw new IllegalArgumentException("expire may not be null");
  ...
  public void setLicenseId(int licenseId) {
    if (licenseId < 0) throw new IllegalArgumentException("Illegal license id.");
  ...
  public boolean hasExpired() {
    ...
    if (expire.before(now)) return (true);
    return (false);
  }
