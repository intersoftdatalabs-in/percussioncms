...
public final class PSBrandCodeElementList {
  ...
  public PSBrandCodeElementList(
      ...
      String[] childElementReqAttrNames,
      String[] childElementOptionalAttrNames)
      throws CodeException {
    if ((childElementName == null) || (childElementName.trim().length() < 1))
      throw new IllegalArgumentException("childElementName may not be null or empty");
  ...
  public PSBrandCodeElement getBrandCodeElement(String attrName, String attrValue, boolean required)
    ...
    if ((ret == null) && (required)) {
      throw new CodeException(
          "No element found having attribute : " + attrName + " with value : " + attrValue);
    }
    return ret;
  }
  ...
  public final void fromXml(Element sourceNode) throws CodeException {
    ...
    for (int i = 0; i < nl.getLength(); i++) {
      ...
      m_elementList.add(
          new PSBrandCodeElement(el, m_childElementReqAttrNames, m_childElementOptionalAttrNames));
    }
  }
