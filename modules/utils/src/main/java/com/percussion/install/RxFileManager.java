...
public class RxFileManager {
  ...
  public static final String DTS_APP_CHECK_FILE7 =
      "Deployment"
          + File.separator
          + "Server"
          + File.separator
  ...
  public static void setSystemInstallationPropertiesFile(String arg) {
    if (arg == null || arg.trim().equals(""))
      throw new IllegalArgumentException(
          "Installation Properties File name must not be null or empty.");
  ...
  public static String getSystemInstallationPropertiesAbsolute(OSEnum os) {
    if (os == OSEnum.Windows)
      return getProgramDir()
          ...
          + "Percussion"
          + File.separator
          + systemInstallationPropertiesFile;
    else return getProgramDir() + File.separator + systemInstallationPropertiesFile;
  }
...
>>>>>>> development-8.1.x
  ...
  public static boolean isDTSDir(String dir) {
    ...
    if ((dir == null) || (dir.trim().length() < 1)) return false;
...
>>>>>>> development-8.1.x
  ...
  public static String getSystemInstallationFile() {
    return PSOsTool.isWindowsPlatform()
        ? getWindowsSystemInstallationFile()
        : getUnixSystemInstallationFile();
  }
  ...
  public static void setProgramDir(String programDir) {
    if ((programDir == null) || (programDir.trim().length() < 1))
      throw new IllegalArgumentException("programDir may not be null or empty");
  ...
  public static String getHomeDrive() {
    ...
    if (!strHomeDirName.endsWith(File.separator)) strHomeDirName += File.separator;
...
>>>>>>> development-8.1.x
  ...
  public static Properties getDTSSystemFileProperties(String dts_file, String cm1_file, OSEnum os)
    ...
    Properties props =
        RxFileManager.loadProperties(RxFileManager.getSystemInstallationPropertiesAbsolute(os));
  ...
  public static Properties loadProperties(String propFilePath) throws IOException {
    if ((propFilePath == null) || (propFilePath.trim().length() < 1))
      throw new IllegalArgumentException("propFilePath may not be null or empty");
  ...
  public static void setLongRootDir(String longRootDir) {
    if (longRootDir == null) throw new IllegalArgumentException("longRootDir may not be null");
