...
/**
 * PSDataExtractionException is thrown to indicate that the requested data extraction failed.
 *
...
public class PSDataExtractionException extends PSException {
   ...
   * @param singleArg the argument to use as the sole argument in the error message
   */
  public PSDataExtractionException(String language, int msgCode, Object singleArg) {
   ...
   * @param arrayArgs the array of arguments to use as the arguments in the error message
   */
  public PSDataExtractionException(String language, int msgCode, Object[] arrayArgs) {
