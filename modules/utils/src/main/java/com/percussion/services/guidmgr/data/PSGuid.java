...
public class PSGuid extends Number implements IPSGuid {
  ...
  public PSGuid(PSTypeEnum type, long value, boolean forceType) {
    ...
    if (getType() == 0) setType(type.getOrdinal());
      ...
      if (forceType) setType(type.getOrdinal());
  ...
  protected final void assemble(String guid, PSTypeEnum type, boolean forceType) {
    ...
    if (tokens.length > 3)
      throw new IllegalArgumentException("guid string must have no more than three components");
  ...
  public final void setHostId(long hostid) {
    ...
    if (getHostId() != 0) throw new IllegalStateException("The hostid must not already be set");
  ...
  public final void setType(short type) {
    ...
    if (getType() != 0) throw new IllegalStateException("The type must not already be set");
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof PSGuid)) return false;
