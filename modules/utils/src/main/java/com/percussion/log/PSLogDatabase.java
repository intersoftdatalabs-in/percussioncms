...
public class PSLogDatabase {
   ...
   */
  public static String getLogCatalog(String driver, Connection conn, String db)
      throws SQLException {
    if (driver == null || driver.length() == 0)
      throw new IllegalArgumentException("need a valid driver type");

    if (conn == null) throw new IllegalArgumentException("need a valid connection");

    if (db == null) throw new IllegalArgumentException("need a valid database name");
