...
public class PSTomcatConnector extends PSAbstractConnector implements XMLEnabled {
   ...
   protected static final String SSL_ENABLED_PROTOCOLS = "sslEnabledProtocols";
    ...
    static final Map<String , String> DEFAULT_HTTPS_ATTRIBUTES = new HashMap<String , String>() {{
       ...
       put(CIPHERS_ATTR, "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_AES_256_GCM_SHA384");
    }};
