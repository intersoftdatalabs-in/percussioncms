...
public class PSStringValue extends PSBaseValue<String> {
  ...
  public InputStream getStream() throws IllegalStateException, RepositoryException {
    if (m_value == null || m_value.trim().equals("")) return null;

    return PSValueConverter.convertToStream(m_value);
  }

  public long getLong() throws ValueFormatException, IllegalStateException, RepositoryException {
    if (m_value == null || m_value.trim().equals("")) return 0;
  ...
  public Calendar getDate()
      throws ValueFormatException, IllegalStateException, RepositoryException {
    if (m_value != null && m_value != "") return PSValueConverter.convertToCalendar(m_value);
    else return null;
  }

  public boolean getBoolean()
      throws ValueFormatException, IllegalStateException, RepositoryException {
    if (m_value != null && m_value != "") return Boolean.parseBoolean(m_value);
    else return false;
  }
