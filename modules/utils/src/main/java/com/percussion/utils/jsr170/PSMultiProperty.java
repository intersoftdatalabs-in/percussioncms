...
public final class PSMultiProperty extends PSPropertyWrapper implements IPSJcrCacheItem, IPSProperty {
  ...
  public PropertyDefinition getDefinition() throws RepositoryException {
    ...
    throw new PathNotFoundException("Can't find definition for property: " + m_name);
  }
  ...
  public Item getAncestor(int index)
  ...
  public String toString() {
    return new ToStringBuilder(this).append("name", m_name).append("value", m_value).toString();
  }
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder()
            .append(m_depth, b.m_depth)
            .append(m_name, b.m_name)
            .append(m_value, b.m_value)
            .isEquals()
        && (m_parent == b.m_parent);
  }
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(m_depth).append(m_name).append(m_value).toHashCode();
  }
