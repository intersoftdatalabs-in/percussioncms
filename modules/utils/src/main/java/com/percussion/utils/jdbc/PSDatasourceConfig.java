...
public final class PSDatasourceConfig implements IPSDatasourceConfig, IPSBeanConfig, Cloneable {
  ...
  public final void fromXml(Element source) throws PSInvalidXmlException {
    ...
    Element propEl = PSSpringBeanUtils.getNextPropertyElement(source, null, NAME_PROP);
    ...
    propEl = PSSpringBeanUtils.getNextPropertyElement(source, propEl, DS_NAME_PROP);
    m_dsName = PSSpringBeanUtils.getBeanPropertyValue(propEl, true);

    propEl = PSSpringBeanUtils.getNextPropertyElement(source, propEl, DB_PROP);
    m_database = PSSpringBeanUtils.getBeanPropertyValue(propEl, false);

    propEl = PSSpringBeanUtils.getNextPropertyElement(source, propEl, ORIGIN_PROP);
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(m_name, that.m_name)
        && Objects.equals(m_dsName, that.m_dsName)
