...
public class PSJdbcUtils {
  ...
  public static String getDatabaseFromUrl(String url) {
    ...
    if (s.length() > 2 && s.charAt(0) == '/' && s.charAt(1) == '/') s = s.substring(2);
  ...
  private static String getDbName(String partialUrl) {
    ...
    if (i != -1) return partialUrl.substring(0, i);
  ...
  static {
    ...
    ms_jdbcUrlToDriverMap.put("weblogic:mssqlserver4", "weblogic:mssqlserver4");
