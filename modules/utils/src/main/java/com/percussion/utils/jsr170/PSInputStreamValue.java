...
>>>>>>> development-8.1.x
  ...
  public String getString()
    ...
    if (m_strValue == null) {
      if (m_streamUsed) throw new IllegalStateException("May not read from stream twice");
  ...
  public InputStream getStream() throws IllegalStateException, RepositoryException {
    if (m_getUsed) throw new IllegalStateException("May not read from stream twice");
    m_streamUsed = true;
    return m_value;
  }
