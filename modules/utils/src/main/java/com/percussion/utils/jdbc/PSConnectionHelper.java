...
public class PSConnectionHelper {
   ...
   */
  public static synchronized PSConnectionHelper createInstance(IPSDatasourceManager dsMgr) {
    if (ms_instance != null) throw new IllegalStateException("Instance already initialized");

    if (dsMgr == null) throw new IllegalArgumentException("dsMgr may not be null");
