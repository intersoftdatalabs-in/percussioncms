...
public class PSStopwatch {
  ...
  public void start() {
    if (!isStopped()) {
      throw new IllegalStateException("Stopwatch must be stopped before started");
    }
    m_state = RUN_STATE;
  ...
  public void pause() {
    ...
    if (!isRunning()) {
      throw new IllegalStateException("Stopwatch must be running before pausing");
    }
  ...
  public void cont() {
    ...
    if (!isPaused()) {
      throw new IllegalStateException("Stopwatch must be paused before continuing");
    }
    m_state = RUN_STATE;
  ...
  public String toString() {
    ...
    return "<Stopwatch " + state + " elapsed " + ms_numberFormat.format(elapsed()) + " ms>";
  }
