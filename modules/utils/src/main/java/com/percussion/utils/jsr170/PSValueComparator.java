    ...
    try {
      switch (v1.getType()) {
        case PropertyType.BOOLEAN:
          if (v1.getBoolean() && !v2.getBoolean()) result = 1;
          else if (!v1.getBoolean() && v2.getBoolean()) result = -1;
          break;
        case PropertyType.LONG:
          if (v1.getLong() > v2.getLong()) result = 1;
          else if (v1.getLong() < v2.getLong()) result = -1;
          break;
        case PropertyType.DOUBLE:
          if (v1.getDouble() > v2.getDouble()) result = 1;
          else if (v1.getDouble() < v2.getDouble()) result = -1;
          break;
        case PropertyType.DATE:
          if (v1.getDate().getTimeInMillis() > v2.getDate().getTimeInMillis()) result = 1;
          else if (v1.getDate().getTimeInMillis() < v2.getDate().getTimeInMillis()) result = -1;
          break;
        default:
          if (m_collator == null) {
