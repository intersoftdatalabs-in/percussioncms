...
public class PSSpringBeanUtils {
  ...
  public static void addBeanProperty(Element root, String name, String value) {
    ...
    if (doc == null) throw new IllegalArgumentException("root must be associated with a document");
  ...
  public static void addBeanProperty(Element root, String name, Map<String, String> value) {
    ...
    Element propEl = createPropElement(doc, root, name);
    Element mapEl = PSXmlDocumentBuilder.addEmptyElement(doc, propEl, BEAN_PROP_VAL_MAP);

    for (Map.Entry<String, String> entry : value.entrySet()) {
      Element entryEl = PSXmlDocumentBuilder.addEmptyElement(doc, mapEl, BEAN_PROP_VAL_MAP_ENTRY);
      entryEl.setAttribute(BEAN_PROP_VAL_MAP_KEY_ATTR, entry.getKey());

      PSXmlDocumentBuilder.addElement(doc, entryEl, BEAN_PROP_VAL_MAP_VAL, entry.getValue());
    }
  }
  ...
  public static void addBeanProperty(
    ...
    Element propEl = createPropElement(doc, root, name);
    Element listEl = PSXmlDocumentBuilder.addEmptyElement(doc, propEl, BEAN_PROP_VAL_LIST);
  ...
  public static void addBeanRef(Element root, String name, String ref) {
    ...
    Element propEl = createPropElement(doc, root, name);
    Element refEl = PSXmlDocumentBuilder.addEmptyElement(doc, propEl, BEAN_REF);
  ...
  private static Element createPropElement(Document doc, Element root, String name) {
    Element propEl = PSXmlDocumentBuilder.addEmptyElement(doc, root, BEAN_PROPERTY);
  ...
  public static Map<String, String> getBeanPropertyValueMap(Element source)
    ...
    while (entryEl != null) {
      String key = PSXmlUtils.checkAttribute(entryEl, BEAN_PROP_VAL_MAP_KEY_ATTR, true);

      String value = PSXmlUtils.checkAttribute(entryEl, BEAN_PROP_VAL_ATTR, false);
      ...
      entryEl =
          tree.getNextElement(BEAN_PROP_VAL_MAP_ENTRY, PSXmlTreeWalker.GET_NEXT_ALLOW_SIBLINGS);
    }
  ...
  static {
    movedClasses.put(
        "com.percussion.services.datasource.PSDatasourceResolver",
        PSDatasourceResolver.class.getName());
    movedClasses.put(
        "com.percussion.services.datasource.PSDatasourceConfig",
        PSDatasourceConfig.class.getName());
  }
