...
/**
 * This is an independent exception for use within the beans portion of the system. There are no
 * dependencies on anything Rhythmyx.
 */
public class PSBeansException extends Exception {
  ...
  private String createMessage(int msgCode, Object[] arrayArgs, Locale loc) {
    ...
    if (errList != null) msg = errList.getString(String.valueOf(msgCode));
