...
/**
 * PSNotFoundException is thrown when a request is made for a named item which cannot be found. This
 * usually occurs when attempting to load an application and the application cannot be found.
 *
