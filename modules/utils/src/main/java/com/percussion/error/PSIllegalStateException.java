...
/**
 * The PSIllegalStateException class is thrown whenever a call to an object's method is made when it
 * is in an improper state. For instance, the output stream from a connection cannot be used once
