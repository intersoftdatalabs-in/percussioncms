...
public class PSException extends java.lang.Exception implements IPSException {
  ...
  public PSException(int msgCode, Object singleArg) {
    ...
    if (singleArg instanceof Throwable) {
      ...
      String arg = "[" + t.getClass().getName() + "]: " + t.getLocalizedMessage();
      if (null == m_args) m_args = new Object[1];
      m_args[0] = arg;
    }
  }
  ...
  public java.lang.String getLocalizedMessage() {
    if (m_overridingMessage != null) {
      return m_overridingMessage;
    } else if (m_lang == null) return getLocalizedMessage(Locale.getDefault());
    else return getLocalizedMessage(m_lang);
  }
