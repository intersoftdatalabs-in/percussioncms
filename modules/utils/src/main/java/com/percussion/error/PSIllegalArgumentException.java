...
/**
 * The PSIllegalArgumentException class is thrown whenever a bad argument is passed into a routine.
 * This may be due to a null which is not expected, an inappropriate value, etc.
 *
 * @author Tas Giakouminakis
 * @version 1.0
 * @since 1.0
 */
public class PSIllegalArgumentException extends PSException {
   ...
   */
  public PSIllegalArgumentException(int msgCode, Object singleArg) {
   ...
   */
  public PSIllegalArgumentException(int msgCode, Object[] arrayArgs) {
