...
public class PSPathUtil {
  ...
  /**
   * Determines if the path passed in resides under the //Sites folder hierarchy
   *
   ...
   * @return The normalized path, it may be <code>null</code> or empty if the given path is <code>
   *     null</code> or empty.
   */
