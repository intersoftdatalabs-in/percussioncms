...
public class PSStringComparator implements Comparator {
  ...
  public PSStringComparator(int type) {
    if (!validateType(type)) throw new IllegalArgumentException("type is not supported");
  ...
  public int compare(Object o1, Object o2) {
    ...
    switch (m_type) {
      ...
      default:
        ...
        throw new IllegalStateException("type value (" + m_type + ") is not supported");
    }
  ...
  private boolean validateType(int type) {
    ...
    if (type == SORT_CASE_INSENSITIVE_ASC) isValid = true;
