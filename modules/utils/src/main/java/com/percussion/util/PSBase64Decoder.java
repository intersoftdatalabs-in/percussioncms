...
public class PSBase64Decoder {
  ...
  public static String decode(String in, String encoding) throws PSRuntimeException {
    ...
    try {
      ...
      if (encoding != null && encoding.length() > 1) return new String(decoded, encoding);
  ...
  public static void decode(InputStream in, OutputStream out) throws IOException {
    if (in == null) throw new IllegalArgumentException("input stream may not be null");
  ...
  public static byte[] decode(byte[] in) {
    if (in == null) throw new IllegalArgumentException("array may not be null");
  ...
  public static void main(String[] args) {
    if (args.length != 1) {
      System.out.println("Usage: java com.percussion.util.PSBase64Decoder" + " text");
      System.exit(-1);
    }
