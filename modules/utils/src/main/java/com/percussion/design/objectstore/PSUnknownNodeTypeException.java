...
/**
 * PSUnknownNodeTypeException is thrown when fromXml is called in one of the IPSComponent
 * implementations and the implementation does not support the specified XML node type.
 *
