...
public class SecureStringUtilsTests {
  ...
  public void testHeaderValidation() {
    ...
    cleaned =
        SecureStringUtils.stripAllLineBreaks("This%20Is%20An%20ENCODED%0dSTRING%0aWITH_SOME%20");
  ...
  public void testCleanURLString() {
    ...
    t1 =
        SecureStringUtils.stripNonHttpProtocols(
            "file://C\\:/Windows/Users/Administrator/somefile.txt");
    assertEquals("", t1);
  ...
  public void testValidSQLObjectName() {
    ...
    assertNotEquals(
        "IN VALID;", SecureStringUtils.removeInvalidSQLObjectNameCharacters("IN VALID;"));

    assertEquals("VALID", SecureStringUtils.removeInvalidSQLObjectNameCharacters("VALID"));

    assertEquals("VAL_ID", SecureStringUtils.removeInvalidSQLObjectNameCharacters("VAL_ID"));

    assertEquals("VAL1_ID", SecureStringUtils.removeInvalidSQLObjectNameCharacters("VAL1_ID"));
  ...
  public void testValidCMSPath() {
    assertTrue(
        SecureStringUtils.isValidCMSPathString(
            "/Sites/HWMB/%22%3e%3cscript%3ealert%28595%29%3c%2fscript%3e"));
    assertTrue(SecureStringUtils.isValidCMSPathString("/Sites/www.mysite.com/mypage.html"));
    assertFalse(SecureStringUtils.isValidCMSPathString("/Sites/HWMB/<script>alert(595);</script>"));
  }
}
