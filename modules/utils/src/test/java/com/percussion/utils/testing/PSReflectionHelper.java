...
public class PSReflectionHelper {
   ...
   */
  public static boolean testClone(Object a, Object b, IPSReflectionFilter filter)
    ...
    while (iter.hasNext()) {
      ...
      if (result1 == null && result2 == null) {
        ...
        return false; // One null and not the other
      } else if (copyingNotRequired.contains(result1.getClass()) == false && result1 == result2) {
        return false;
      }
  ...
  public static void testEquals(Object a, Object b, IPSReflectionFilter filter) throws Exception {
    ...
    if (a.getClass().equals(b.getClass()) == false) {
      throw new Exception("The objects must be of the same class " + a.getClass());
    }
    ...
    while (fields.hasNext()) {
      ...
      try {
        ...
        System.err.println("Couldn't create new object for " + accessor.getSetMethod());
        e.printStackTrace(System.err);
        throw e;
      }
      Object args[] = new Object[] {newval};
      ...
      if (a.equals(b)) {
        throw new Exception("Values should not be equals after modifying field " + field);
      }
      // Assign to the first object, test for equals

      accessor.getSetMethod().invoke(a, args);
      if (!a.equals(b)) {
        throw new Exception("Updating first object should restore equals for field " + field);
      }

      // Check that hash matches
      if (a.hashCode() != b.hashCode()) {
        throw new Exception("Objects that are equal must have the same hash code " + a);
      }

      // Reset original values
      accessor.getSetMethod().invoke(a, new Object[] {oa});
      accessor.getSetMethod().invoke(b, new Object[] {ob});
    }
  }
  ...
  public static AccessorMap getAccessors(Class<?> clazz, IPSReflectionFilter filter)
    ...
    for (Method getter : getters) {
      ...
      if (!found) {
        ms_log.warn("No matching setter for field " + name + " in class " + clazz);
      }
    }
