...
public class TestAllHTML5Tags {
        ...
        new Scanner(
                Objects.requireNonNull(
                    TestPSHtmlCleanerProperties.class.getResourceAsStream(
                        "/com/percussion/html/alltags.html")),
                "UTF-8")
            .useDelimiter("\\A")
            .next();

    parsedDoc = PSHtmlUtils.createHTMLDocument(sourceDoc, StandardCharsets.UTF_8, true, null);
  ...
  public void testAudioTag() {
    ...
    Attributes.put(
        "src", "https://open.spotify.com/track/141GIDaZBy7Bn3I2NAFR31?si=71e860708f3c4b55");
  ...
  public void testImageTag() {
    ...
    Attributes.put(
        "longdesc",
        "https://www.google.com/imgres?imgurl=https%3A%2F%2Fcdn.britannica.com%2F92%2F100692-050-5B69B59B%2FMallard.jpg&imgrefurl=https%3A%2F%2Fwww.britannica.com%2Fanimal%2Fduck&tbnid=cv-8vEQ0udAypM&vet=12ahUKEwigtsHGxI_6AhWImmoFHZ_-CKQQMygAegUIARDjAQ..i&docid=IpKgqf0_gTf_MM&w=1600&h=1423&q=duck&ved=2ahUKEwigtsHGxI_6AhWImmoFHZ_-CKQQMygAegUIARDjAQ");
    Attributes.put("referrerpolicy", "no-referrer");
  ...
  public void testObjectTag() {
    ...
    Map<String, String> Attributes = new HashMap<String, String>();
    Attributes.put(
        "data", "https://open.spotify.com/track/141GIDaZBy7Bn3I2NAFR31?si=71e860708f3c4b55");
    Attributes.put("form", "1");
