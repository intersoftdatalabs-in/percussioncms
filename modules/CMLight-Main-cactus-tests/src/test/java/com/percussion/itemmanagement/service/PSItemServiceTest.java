...
public class PSItemServiceTest extends PSServletTestCase {
  ...
  public void testCopyFolder() throws Exception {
    ...
    try {
      ...
      // Copy folder
      var assetMap =
          itemService.copyFolder(folderPath, PSAssetPathItemService.ASSET_ROOT, "TestCopy");

      var copyFolders =
          contentWs.loadFolders(new String[] {PSAssetPathItemService.ASSET_ROOT + "/TestCopy"});
      ...
      copyFolders =
          contentWs.loadFolders(new String[] {PSAssetPathItemService.ASSET_ROOT + "/TestCopy2"});
      assertTrue(!copyFolders.isEmpty());
  ...
  private void myPagesDeleteUserTest() throws Exception {
    ...
    try {
      ...
      itemService.addUserItem(
          testuser, idMapper.getContentId(id1), PSUserItemTypeEnum.FAVORITE_PAGE);
      itemService.addUserItem(
          testuser, idMapper.getContentId(id2), PSUserItemTypeEnum.FAVORITE_PAGE);
      ...
      if (!isUserDeleted) userService.delete(testuser);
    }
  }
