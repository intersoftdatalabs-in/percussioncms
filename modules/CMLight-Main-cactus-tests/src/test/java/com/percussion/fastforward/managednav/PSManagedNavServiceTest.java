...
public class PSManagedNavServiceTest {
  ...
  public void setUp() throws Exception {
    ...
    secWs.login(request, response, "Admin", "demo", null, "Enterprise_Investments_Admin", null);
  ...
  private PSPair<List<Integer>, IPSGuid> createNavigationStructure() {
    ...
    pair.setSecond(
        new PSLegacyGuid(navService.findNavSummary(section211.getGuid()).getContentId()));
