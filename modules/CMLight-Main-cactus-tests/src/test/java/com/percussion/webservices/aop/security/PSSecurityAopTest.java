    ...
    /**
     * List of test ACLs, never {@code null} or empty during test execution.
     ...
     */
    private static IPSGuid ms_templateGuid = new PSGuid(PSTypeEnum.TEMPLATE, 123);
...
public class PSSecurityAopTest extends ServletTestCase {
     ...
     *
     * @return The list, not {@code null} or empty during test execution.
     */
    ...
    /**
     * Gets the design service manager for testing.
     *
    ...
    /**
     * Gets the public service manager for testing.
     *
     * @return The manager, never {@code null}.
     */
    ...
    /**
     * Creates and saves two test ACLs. The first is for a template with the following entries:
     * <ul>
