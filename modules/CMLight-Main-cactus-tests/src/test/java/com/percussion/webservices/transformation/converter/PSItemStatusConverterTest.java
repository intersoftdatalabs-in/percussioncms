...
public class PSItemStatusConverterTest extends PSConverterTestBase {
    ...
    public void testConversion() throws Exception {
        var is = createItemStatus(103, true, true, 7L, "Public", 6L, "Quick-Edit");
        roundTripConversionAssert(is);
    ...
    public void testListToArray() throws Exception {
        var srcList = new ArrayList<PSItemStatus>();
    ...
    private void roundTripConversionAssert(PSItemStatus source) throws PSTransformationException {
        var target = (PSItemStatus) roundTripConversion(PSItemStatus.class,
    ...
    private PSItemStatus createItemStatus(int id, boolean isChkout,
        ...
        return new PSItemStatus(id, isChkout, isTransition,
