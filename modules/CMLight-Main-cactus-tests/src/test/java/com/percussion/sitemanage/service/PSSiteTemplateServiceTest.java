...
/** Integration tests for site template service. // REFACTORED: CP-JAVA11 */
...
public class PSSiteTemplateServiceTest {
  ...
  public void testFindTemplatesBySiteAndType() throws Exception {
    ...
    assertEquals(
        1,
        siteTemplateService
            .findTypedTemplatesBySite(site1Id, PSTemplateTypeEnum.UNASSIGNED)
            .size());
  }
  ...
  public void testCopyTemplates() throws Exception {
    ...
    // add template to the new site with same name as original site template and one additional
    // template
