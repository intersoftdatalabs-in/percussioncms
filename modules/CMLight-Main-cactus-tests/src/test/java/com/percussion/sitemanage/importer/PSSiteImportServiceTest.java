...
class PSSiteImportServiceTest extends PSSiteImportTestBase {
  ...
  public void ignore_testImportPage() throws Exception {
    ...
    try {
      ...
      pageImportService.importCatalogedPage(
          (PSSite) fixture.site1, page1.getId(), USER_AGENT, context);
  ...
  private PSPage addCatalogedPage() throws Exception {
    ...
    if (catalogedPage != null) fixture.pageCatalogCleaner.add(catalogedPage.getId());
