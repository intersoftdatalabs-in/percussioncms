...
public class PSGenerateContentTypeList extends PSDefaultExtension
  ...
  public Document processResultDocument(
    ...
    try {
      ...
      for (long contentTypeId : contentTypeIds) {
        PSItemDefSummary itemDefSummary =
            PSItemDefManager.getInstance().getSummary(contentTypeId, securityToken);
      ...
      // alphabetically
      else structuredActions.sort(actionComparator);
  ...
  private PSMenuAction getAction(PSItemDefSummary itemDefSummary, IPSRequestContext request)
    ...
    try {
      ...
      log.error("Exception occurred : {}", PSExceptionUtils.getMessageForLog(e));
