...
public class PSCacheBySessionRule implements IPSUdfProcessor {
  ...
  public Object processUdf(Object[] params, IPSRequestContext request)
    ...
    if (request == null) throw new PSConversionException(0, "request may not be null");

    boolean result = false;
    String sysCommand = request.getParameter(IPSHtmlParameters.SYS_COMMAND);
    if (sysCommand != null && sysCommand.equals(PSAddAssemblerInfo.SYS_COMMAND_EDITRC)) {
      ...
      if (relatedItemId == null) result = true;
      else if (activeItemId != null && activeItemId.equals(relatedItemId)) result = true;
    }
