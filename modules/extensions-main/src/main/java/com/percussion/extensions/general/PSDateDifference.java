...
public class PSDateDifference extends PSDefaultExtension implements IPSUdfProcessor {
  ...
  public Object processUdf(Object[] params, IPSRequestContext request)
    ...
    if (size < 1) {
      ...
      Object[] args = {arg0, "PSDateDifference/processUdf"};
    ...
    if (params[0] == null || params[0].toString().length() < 1) {
      ...
      Object[] args = {msg, "PSDateDifference/processUdf"};
      throw new PSConversionException(0, args);
    }
  ...
  private Date parseDateParam(Object param) {
    ...
    if (param instanceof Date) {
      ...
      if (str != null && str.length() > 0) date = PSDataTypeConverter.parseStringToDate(str);
    }
    return date;
  }
}
