...
public class PSGetBase64Encoded extends PSSimpleJavaUdfExtension {
   ...
   * @return a base64 encoded string of the results making an internal request with the URL created
   *     from the provided parameters, never <code>null</code>, might be empty.
