...
/**
 * This workflow action touches all "active assembly parent" items of the current item. These items
 * are found by searching the related content table for parent items, and then searching for the
