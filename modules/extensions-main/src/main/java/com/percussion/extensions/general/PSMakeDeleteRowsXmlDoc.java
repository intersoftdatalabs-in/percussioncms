  ...
  public void preProcessRequest(Object[] params, IPSRequestContext request)
    ...
    if (params == null || params.length < 1) {
      throw new PSExtensionProcessingException(
          ...
          new Exception(
              "You must supply the name of the html parameter" + " that has the key values"));
    }
    ...
    try {
      ...
      Element root = PSXmlDocumentBuilder.createRoot(doc, "deleterows");
      ...
      if (obj instanceof Collection) {
        ...
        Object obj1 = (paramKeyName1 == null) ? null : htmlParams.get(paramKeyName1);
        Object obj2 = (paramKeyName2 == null) ? null : htmlParams.get(paramKeyName2);

        String val = (obj == null) ? "" : obj.toString().trim();
        String val1 = (obj1 == null) ? "" : obj1.toString().trim();
        String val2 = (obj2 == null) ? "" : obj2.toString().trim();

        if ((val.length() > 0) || (val1.length() > 0) || (val2.length() > 0)) {
          elem = PSXmlDocumentBuilder.addElement(doc, root, "row", null);
          elem.setAttribute("pkey", val);
