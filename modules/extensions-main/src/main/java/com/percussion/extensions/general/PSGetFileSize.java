...
public class PSGetFileSize extends PSSimpleJavaUdfExtension {
  /**
   * First this creates a URL from the supplied parameters and attaches the
   ...
   * @return the size of the file as String from the results making an
   *    internal request with the URL created from the provided parameters,
