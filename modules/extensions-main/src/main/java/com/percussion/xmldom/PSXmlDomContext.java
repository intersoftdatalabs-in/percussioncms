...
public class PSXmlDomContext {
  ...
  public void printTraceMessage(String msg) {
    ...
    if (m_req != null) m_req.printTraceMessage(msg);
  ...
  public void handleException(Exception e, boolean throwException)
    ...
    if (throwException) throw new PSExtensionProcessingException(m_function, e);
  }
   ...
   */
  public void handleException(Exception e) throws PSExtensionProcessingException {
