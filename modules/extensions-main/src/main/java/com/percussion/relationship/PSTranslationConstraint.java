...
public class PSTranslationConstraint extends PSDefaultExtension implements IPSRequestPreProcessor {
  ...
  public void preProcessRequest(Object[] params, IPSRequestContext request)
    ...
    try {
      ...
      if (e instanceof PSExtensionProcessingException) throw (PSExtensionProcessingException) e;

      throw new PSExtensionProcessingException(e.getErrorCode(), e.getErrorArguments());
    } catch (SQLException e) {
      throw new PSExtensionProcessingException(0, PSSqlException.getFormattedExceptionText(e));
    } catch (IOException e) {
