...
public interface IPSTypedPrincipal extends Principal {
  ...
  public enum PrincipalTypes {
     ...
     * first enum value with a matching ordinal is returned. Exception is thrown if ordinal value
     * not found in the enumeration.
     *
     * @param s ordinal value must be a valid ordianl number for this enumeration
     * @return an enumerated value if the ordinal does not match
     * @throws IllegalArgumentException if the ordinal does not have corresponding enumeration.
     */
