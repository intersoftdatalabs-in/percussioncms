 ...
 *
 * <p>For example, if legacy file name has a [ in it, we want to allow that for all but the create
 * operation. Search, Delete, and others should work.
 */
public enum PSOperationContext {
  ...
  AUTHENTICATION,
  /**
   * Use this as a general default when the operation is generic and the validation applies to any
   * operation.
   */
  ANY
}
