...
(function ($) {
  ...
  function updateArchiveList() {
    $(".perc-archive-list").each(function () {
      ...
      if ("" === currentArchiveList.attr("data-query")) {
        return;
      }
      ...
      $.PercArchiveListService.getArchiveEntries(
        queryString,
        function (status, archiveList) {
          if (status) {
            if (
              "undefined" !== typeof renderOption &&
              "" !== renderOption &&
              "perc-list-hierarchical" === renderOption
            ) {
              ...
              if (
                "undefined" !== typeof numberEntries &&
                "" !== numberEntries
              ) {
              ...
              for (var i = 0; i < itemToList; i++) {
                ...
                if (0 < row.yearCount) {
                  ...
                  if (
                    "undefined" === typeof pageResult ||
                    "" === pageResult ||
                    isEditMode === "true"
                  ) {
                    anchorYear = $("<a href='#'>").text(linkYearText);
                  } else {
                  ...
                  for (var j = 0; j < archiveList.years[i].months.length; j++) {
                    ...
                    dateParam1 =
                      row.year + "-" + stringMonthParam + "-01 00:00:00";
                    dateParam2 =
                      row.year +
                      "-" +
                      stringMonthParam +
              ...
              currentArchiveList
                .find(".perc-archive-list-container")
                .html("")
                .append(ul);
            } else {
              if (typeof archiveList !== "undefined") {
              ...
              if (
                typeof numberEntries !== "undefined" &&
                numberEntries !== ""
              ) {
              ...
              for (var i = 0; i < archiveList.years.length; i++) {
                ...
                for (var j = 0; j < archiveList.years[i].months.length; j++) {
                  ...
                  //Generate the link text
                  var linkText =
                    row2.month + " " + row.year + " (" + row2.count + ")";
