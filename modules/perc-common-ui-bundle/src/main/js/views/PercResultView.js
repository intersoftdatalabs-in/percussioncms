...
(function ($) {
  ...
  var methods = {
    init: function (options) {
      return $(this).each(function () {
        ...
        if (
          "undefined" !== typeof options.orderBy &&
          "undefined" !== typeof this.settings.query &&
          null !== this.settings.query
        ) {
        ...
        if (!(0 < parseInt(this.settings.maxResults, 10))) {
    ...
    load: function (startIndex, secondCallback) {
      ...
      return $.PercResultService.getPageEntries(
        this.settings.query,
  ...
  function createEntryHtml(settings, entry) {
    ...
    var timeZone = "";
    if (
      "undefined" !== typeof entry.properties["dcterms:created"] &&
      "" !== entry.properties["dcterms:created"]
    ) {
    ...
    if (
      "undefined" !== typeof entry.properties["dcterms:contentpostdatetz"] &&
      "" !== entry.properties["dcterms:contentpostdatetz"]
    ) {
    ...
    if (settings.summary) {
      var pageSummary =
        "undefined" === typeof entry.properties["dcterms:abstract"]
          ? ""
          : entry.properties["dcterms:abstract"];
      var summary = "";
