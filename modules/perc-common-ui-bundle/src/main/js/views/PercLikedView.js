...
(function ($) {
  ...
  function renderLikeWidget(likeWidgetState, likeTotalLikes) {
    if ("undefined" === typeof likeWidgetState || null === likeWidgetState) {
      return false;
    }
    if ("undefined" === typeof likeTotalLikes || null === likeTotalLikes) {
      return false;
    }
    ...
    if (likeWidgetState === LIKED) {
      likeWidget.removeClass(PERC_UNLIKED).addClass(PERC_LIKED);
      button
        .off("click")
      ...
      likeWidget.removeClass(PERC_LIKED).addClass(PERC_UNLIKED);
      button
        .off("click")
        .on("click", function (evt) {
          like(evt);
    ...
    if (
      0 !== likeTotalLikes &&
      "undefined" !== typeof likeTotalLikes &&
      null !== likeTotalLikes
    ) {
