...
(function ($) {
  ...
  function handleProtectContent(elem) {
    ...
    if ("undefined" !== typeof protectObj) {
      ...
      if (
        "undefined" !== typeof protectObj.protectedRegion &&
        "" !== protectObj.protectedRegion
      ) {
        if (!userloggedIn) {
          var message = protectObj.protectedRegionText;
          var linkHtml =
            '<div class="perc-protected-region-text"><a href="<hrefText>">' +
            message +
            "</a></div>";

          if (
            "undefined" !== typeof protectObj.siteLoginPage &&
