...
(function ($) {
  ...
  function updatePageList() {
    $(".perc-page-auto-list").each(function () {
      ...
      if ("" === currentAutoList.attr("data-query")) {
        return;
      }
      var locale = null;
      ...
      var hidePastResults =
        "true" === $(currentAutoList).attr("data-hide-past-results");
      if (hidePastResults) {
        var nowDate = new Date();
        var nowDateFormatted =
          nowDate.getFullYear() +
          "-" +
      ...
      function loadResults(target, startPage, callback, callbackOptions) {
        ...
        if (
          isNaN(target.settings.maxResults) ||
          1 > target.settings.maxResults
        ) {
        ...
        return $.PercPageListService.getPageEntries(
      ...
      function displayResults(target, pageEntries, options) {
        ...
        if ("undefined" !== typeof pageEntries && 0 < pageEntries.length) {
          ...
          var listRoot = currentAutoList
            .find(".perc-list-main")
            .not(".perc-page-auto-list-structure .perc-list-main")
            .empty();

          currentAutoList
            .find(".perc-list-main-wrapper .perc-list-main")
            .empty()
            .remove();
          ...
          for (var i = 0; i < pageEntries.length; i++) {
            ...
            if (summary) {
              newListElem
                .find("div.perc-page-auto-list-summary-container")
                .append(summary);
            }

            //Date & Calender Icon
            newListElem
              .find("div.perc-page-auto-list-calicon-month")
              .text(postMonth);
            newListElem
              .find("div.perc-page-auto-list-calicon-day")
              .text(postDay);
            newListElem
              .find("span.perc-page-auto-list-date")
