...
(function ($) {
  ...
  function updateBlogNav() {
    $(".perc-blog-navigation-container").each(function () {
      ...
      if ("" === currentBlogNavigation.attr("data-query")) {
        return;
      }
      ...
      if (!queryString.criteria.length) {
        $(".perc-blog")
          .find(".perc-blog-nav-left-wrapper , .perc-blog-nav-right-wrapper")
          .hide();
        return;
      }
      $.PercBlogPostService.getPostNavEntries(
        queryString,
        pagePath,
        function (status, navEntries) {
          if (status) {
            ...
            if (null !== navEntries.next) {
              ...
              $(".perc-blog")
                .find(".perc-blog-nav-right-wrapper")
                .html("&nbsp;");
            }
            ...
            if (null !== navEntries.previous) {
              ...
              $(".perc-blog")
                .find(".perc-blog-nav-left-wrapper")
                .html("&nbsp;");
            }
          } else {
            $(".perc-blog")
  ...
  function updateBlogLink() {
    $(".perc-blog-wrapper").each(function () {
      ...
      var blogIndexPage =
        folderPath.replace(siteName, "") + "/" + indexPageName;
  ...
  function trackBlogPost() {
    $(".perc-blog-wrapper").each(function () {
      ...
      if ("" === currentBlogElem.attr("data-query")) {
        return;
      }
