...
(function ($) {
  ...
  function resetPassword(email, newPassword, resetkey, callback) {
    var serviceUrl =
      "/perc-membership-services/membership/pwd/reset/" + resetkey;
  ...
  function resetPwRequest(email, pwResetPageUrl, callback) {
    ...
    pwResetPageUrl =
      window.location.protocol + "//" + window.location.host + pwResetPageUrl;
  ...
  function confirmRegistration(key, callback) {
    var serviceUrl =
      "/perc-membership-services/membership/registration/confirm/" + key;
