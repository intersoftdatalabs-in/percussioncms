...
<xsl:stylesheet version="1.1"
	...
	<psxctl:ControlMeta
		name="imageAutoListWidgetControl" dimension="single" choiceset="none">
		<psxctl:Description>The control for building the JCR query for the
			Image Auto List Widget:</psxctl:Description>
		<psxctl:ParamList>
		</psxctl:ParamList>
		...
		<psxctl:AssociatedFileList>
			...
			<psxctl:FileDescriptor
				name="jquery.imageAutoList.js" type="script"
				mimetype="text/javascript">
	...
	<xsl:template
		match="Control[@name='imageAutoListWidgetControl']" mode="psxcontrol">
		...
		<script>
			...
			*********************************************************************
			...
			'/rx_resources/widgets/imageAutoList/images/calendar.gif',
	...
	<xsl:template
		match="Control[@name='imageAutoListWidgetControl' and @isReadOnly='yes']"
