...
function buildQuery() {
  ...
  if (p_query_published_after != null && p_query_published_after != "") {
    p_query +=
      queryOp + "rx:sys_contentpostdate >='" + jxl_query_published_after + "'";
    queryOp = " and ";
  }

  if (p_query_published_before != null && p_query_published_before != "") {
    p_query +=
      queryOp + "rx:sys_contentpostdate <='" + jxl_query_published_before + "'";
    queryOp = " and ";
  }
  ...
  $.fn.queryListControl = function (settings) {
    ...
    function showPageTemplates() {
      ...
      if (typeof $('[name="query_template_list"]').val() != "undefined") {
        var pageTemplatesOptionsArray = $('[name="query_template_list"]')
          .val()
          .split(",");
      }
