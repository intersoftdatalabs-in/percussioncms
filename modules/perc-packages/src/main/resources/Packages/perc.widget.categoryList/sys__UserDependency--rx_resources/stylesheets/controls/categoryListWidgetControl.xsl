...
<xsl:stylesheet version="1.1"
	...
	<psxctl:ControlMeta name="categoryListWidgetControl"
		...
		<psxctl:AssociatedFileList>
			...
			<psxctl:FileDescriptor name="PSJSUtils.js"
	...
	<xsl:template
		match="Control[@name='categoryListWidgetControl']" mode="psxcontrol">

		<script>
			$(function () {
			$.categoryListWidget.psxControl(); //
			maintained in categoryListWidget.js
			});
		</script>
		<div id="perc-categorylist-wrapper"
			class="categorylist-with-border">
			...
			<div id="criteria_for_list">
				...
				<div>
					<span class="categorylistlabel">
						<label for='perc_categorylist_resultspage'
							style="font-weight:bold">Results page:</label>
					</span>
					<div style="margin-top: 5px;">
						<input type='text' name='display_category_page_result'
							id='display_category_page_result' />
	...
	<xsl:template
		match="Control[@name='categoryListWidgetControl' and @isReadOnly='yes']"
	...
	<![CDATA[
		...
		<div id="perc-categorylist-wrapper">
			...
			<div id="criteria_for_list">
				...
				<br />
				<div class="datadisplay" id="perc_display_category_page_result">
					<xsl:value-of
						select="//DisplayField/Control[@paramName='category_page_result']/Value" />
				</div>
				<br />
