...
(function ($) {
  ...
  $.PercFormFieldPref = {
    REQUIRED: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          "<input type='checkbox' id='perc-field-required'" +
          checked +
        ...
        if (typeof vals === "object" && vals["perc-field-required"]) {
          ...
          if (
            ...
            elemParent
              .parent()
              .parent()
              .find(".field-label-container")
              .prepend("<span class = 'perc-form-error-asterisk'>*</span>");
          } else {
            elemParent
              .find(".field-label-container")
              .prepend("<span class = 'perc-form-error-asterisk'>*</span>");
    ...
    MAX_CHAR: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        if (typeof vals == "object") {
          ...
          typeof defaults["perc-field-max-char-value"] != "undefined"
        ) {
      ...
      onApply: function (data, defaults) {
        var newData = {};
        var checked =
          $("#perc-field-max-char-enabled:checked").val() !== undefined;
        var max = parseInt($("#perc-field-max-char-value").val());
        if (!isNaN(max) && max > 0)
          newData = {
            "perc-field-max-char-enabled": checked,
            "perc-field-max-char-value": max,
          };
        else if (
          typeof defaults == "object" &&
          typeof defaults["perc-field-max-char-value"] != "undefined"
          ...
          newData = {
            "perc-field-max-char-value": defaults["perc-field-max-char-value"],
          };
        }
        return newData;
      },
      onRender: function (elem, vals, defaults) {
        ...
        if (
          ...
          vals["perc-field-max-char-value"] !==
            defaults["perc-field-max-char-value"]
        ) {
          max = vals["perc-field-max-char-value"];
        } else if (
          typeof defaults === "object" &&
      ...
      validate: function (defaults) {
        ...
        if (!max || max > 2048) {
          $(".perc_field_error[for='perc-field-max-char-value']")
            .css("display", "block")
            .closest(".perc-pref-entry")
            .css("height", "40");
          isValid = false;
        } else {
          $(".perc_field_error[for='perc-field-max-char-value']")
    ...
    WIDTH: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        if (
          ...
          typeof defaults == "object" &&
          typeof defaults["perc-field-width-value"] != "undefined"
        ) {
        ...
        var out =
          ...
          "<input type='text' class='perc-pref-text' value='" +
          width +
          "' id='perc-field-width-value'/>px" +
          "</div>";
        container.append(out);
        $.perc_filterField(
          container.find("#perc-field-width-value"),
          $.perc_textFilters.ONLY_DIGITS,
        );
      },
      onApply: function (data, defaults) {
        ...
        if (!isNaN(width) && width >= 0) {
          ...
          newData = {
            "perc-field-width-value": defaults["perc-field-width-value"],
          };
        }
        return newData;
      },
    ...
    HEIGHT: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        if (
          ...
          typeof defaults == "object" &&
          typeof defaults["perc-field-height-value"] != "undefined"
        ) {
        ...
        var out =
          ...
          "<input type='text' class='perc-pref-text' value='" +
          height +
          "' id='perc-field-height-value'/>px" +
          "</div>";
        container.append(out);
        $.perc_filterField(
          container.find("#perc-field-height-value"),
          $.perc_textFilters.ONLY_DIGITS,
        );
      },
      onApply: function (data, defaults) {
        ...
        if (!isNaN(height) && height >= 0) {
          ...
          newData = {
            "perc-field-height-value": defaults["perc-field-height-value"],
          };
        }
        return newData;
      },
      onRender: function (elem, vals, defaults) {
        ...
        if (
          typeof vals === "object" &&
          typeof vals["perc-field-height-value"] !== "undefined" &&
          vals["perc-field-height-value"] !==
            defaults["perc-field-height-value"]
        ) {
          height = vals["perc-field-height-value"];
        }
    ...
    CLASS: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        if (
          typeof vals == "object" &&
          typeof vals["perc-field-class-value"] != "undefined"
        ) {
          classValue = vals["perc-field-class-value"];
        } else if (
          typeof defaults == "object" &&
          typeof defaults["perc-field-class-value"] != "undefined"
        ) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          "Class <input type='text' class='perc-pref-text perc-pref-text-longer' value='" +
          classValue +
          '\' id=\'perc-field-class-value\' size="50" maxlength="255"/>' +
          "</div>";
        container.append(out);
      ...
      onApply: function (data, defaults) {
        ...
        if (classValue.length !== undefined) {
          ...
          newData = {
            "perc-field-class-value": defaults["perc-field-class-value"],
          };
        }
      ...
      onRender: function (elem, vals, defaults) {
        ...
        if (
          typeof vals === "object" &&
          typeof vals["perc-field-class-value"] !== "undefined" &&
          vals["perc-field-class-value"] !== defaults["perc-field-class-value"]
        ) {
          classValue = vals["perc-field-class-value"];
        }
    ...
    NAME: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        if (
          ...
          typeof defaults == "object" &&
          typeof defaults["perc-field-name-value"] != "undefined"
        ) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          "Name <input type='text' class='perc-pref-text perc-pref-text-longer' value='" +
          nameValue +
          '\' id=\'perc-field-name-value\' size="50" maxlength="255"/>' +
          "</div>";
        container.append(out);
        $.perc_filterFieldText(
      ...
      onApply: function (data, defaults) {
        ...
        if (nameValue.length !== undefined) {
          ...
          newData = {
            "perc-field-name-value": defaults["perc-field-name-value"],
          };
        }
      ...
      onRender: function (elem, vals, defaults) {
        ...
        if (
          typeof vals === "object" &&
          typeof vals["perc-field-name-value"] !== "undefined" &&
          vals["perc-field-name-value"] !== defaults["perc-field-name-value"] &&
          vals["perc-field-name-value"] !== ""
        ) {
          nameValue = vals["perc-field-name-value"];
        }
    ...
    TITLE: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        if (
          ...
          typeof defaults == "object" &&
          typeof defaults["perc-field-title-value"] != "undefined"
        ) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          "Title <input type='text' class='perc-pref-text perc-pref-text-longer' value='" +
          titleValue +
          '\' id=\'perc-field-title-value\' size="50" maxlength="255"/>' +
          "</div>";
        container.append(out);
        $.perc_filterFieldText(
      ...
      onApply: function (data, defaults) {
        ...
        if (titleValue.length !== undefined) {
          ...
          newData = {
            "perc-field-title-value": defaults["perc-field-title-value"],
          };
        }
    ...
    RECAPTCHA_SITEKEY: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        if (
          ...
          typeof defaults === "object" &&
          typeof defaults["perc-field-recaptcha-sitekey-value"] !== "undefined"
        ) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          "Site Key <input type='text' class='perc-pref-text perc-pref-text-longer' value='" +
          sitekeyValue +
          '\' id=\'perc-field-recaptcha-sitekey-value\' size="50" maxlength="255"/>' +
          "</div>";
        container.append(out);
      },
      ...
      onApply: function (data, defaults) {
        var newData = {};
        var sitekeyValue = $("#perc-field-recaptcha-sitekey-value")
          .val()
          .trim();
        ...
        if (sitekeyValue.length > 0) {
          ...
          newData = {
            "perc-field-recaptcha-sitekey-value":
              defaults["perc-field-recaptcha-sitekey-value"],
          };
        }
      ...
      onRender: function (elem, vals, defaults) {
        ...
        if (
          typeof vals === "object" &&
          typeof vals["perc-field-recaptcha-sitekey-value"] !== "undefined" &&
          vals["perc-field-recaptcha-sitekey-value"] !==
            defaults["perc-field-recaptcha-sitekey-value"]
        ) {
          sitekeyValue = vals["perc-field-recaptcha-sitekey-value"];
        }
        // If key was set, apply it to the current element
        if (sitekeyValue) elem.attr("data-sitekey", sitekeyValue);
      },
      validate: function () {
        return true;
      },
    ...
    RECAPTCHA_THEME: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        if (
          ...
          typeof defaults === "object" &&
          typeof defaults["perc-field-recaptcha-theme-value"] !== "undefined"
        ) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          "<label for='perc-field-recaptcha-theme-value' class='field-label'>Theme (dark/light)</label><input type='text' placeholder='light' class='perc-pref-text perc-pref-text-longer' value='" +
          value +
          '\' id=\'perc-field-recaptcha-theme-value\' size="50" maxlength="255"/>' +
          "</div>";
        container.append(out);
      },
      ...
      onApply: function (data, defaults) {
        ...
        if (value.length > 0) {
          ...
          newData = {
            "perc-field-recaptcha-theme-value":
              defaults["perc-field-recaptcha-theme-value"],
          };
        }
      ...
      onRender: function (elem, vals, defaults) {
        ...
        if (
          typeof vals === "object" &&
          typeof vals["perc-field-recaptcha-theme-value"] !== "undefined" &&
          vals["perc-field-recaptcha-theme-value"] !==
            defaults["perc-field-recaptcha-theme-value"]
        ) {
          value = vals["perc-field-recaptcha-theme-value"];
        }
        // If key was set, apply it to the current element
        if (value) elem.attr("data-theme", value);
      },
      validate: function () {
        return true;
      },
    ...
    RECAPTCHA_SIZE: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        if (
          ...
          typeof defaults === "object" &&
          typeof defaults["perc-field-recaptcha-size-value"] != "undefined"
        ) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          "<label for='perc-field-recaptcha-size-value'>Size (compact/normal)</label><input type='text' placeholder='normal' class='perc-pref-text perc-pref-text-longer' value='" +
          value +
          '\' id=\'perc-field-recaptcha-size-value\' size="50" maxlength="255"/>' +
          "</div>";
        container.append(out);
      },
      ...
      onApply: function (data, defaults) {
        ...
        if (value.length > 0) {
          ...
          newData = {
            "perc-field-recaptcha-size-value":
              defaults["perc-field-recaptcha-size-value"],
          };
        }
      ...
      onRender: function (elem, vals, defaults) {
        ...
        if (
          typeof vals === "object" &&
          typeof vals["perc-field-recaptcha-size-value"] !== "undefined" &&
          vals["perc-field-recaptcha-size-value"] !==
            defaults["perc-field-recaptcha-size-value"]
        ) {
          value = vals["perc-field-recaptcha-size-value"];
        }
        // If key was set, apply it to the current element
        if (value) elem.attr("data-size", value);
      },
      validate: function () {
        return true;
      },
    ...
    RECAPTCHA_TABINDEX: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          "<label for='perc-field-recaptcha-tabindex-value'>Tabindex</label><input type='text' class='perc-pref-text perc-pref-text-longer' value='" +
          value +
          '\' id=\'perc-field-recaptcha-tabindex-value\' size="50" maxlength="255"/>' +
          "</div>";
        container.append(out);
      },
      ...
      onApply: function (data, defaults) {
        ...
        if (value.length > 0) {
          ...
          newData = {
            "perc-field-recaptcha-tabindex-value":
              defaults["perc-field-recaptcha-tabindex-value"],
          };
        }
      ...
      onRender: function (elem, vals, defaults) {
        ...
        if (
          typeof vals === "object" &&
          typeof vals["perc-field-recaptcha-tabindex-value"] !== "undefined" &&
          vals["perc-field-recaptcha-tabindex-value"] !==
            defaults["perc-field-recaptcha-tabindex-value"]
        ) {
          value = vals["perc-field-recaptcha-tabindex-value"];
        }
        // If key was set, apply it to the current element
        if (value) elem.attr("data-tabindex", value);
      },
      validate: function () {
        return true;
      },
    ...
    RECAPTCHA_CALLBACK: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        if (
          ...
          typeof defaults === "object" &&
          typeof defaults["perc-field-recaptcha-callback-value"] != "undefined"
        ) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          "<label for='perc-field-recaptcha-callback-value'>Callback</label><input type='text' class='perc-pref-text perc-pref-text-longer' value='" +
          value +
          '\' id=\'perc-field-recaptcha-callback-value\' size="50" maxlength="255"/>' +
          "</div>";
        container.append(out);
      },
      ...
      onApply: function (data, defaults) {
        ...
        if (value.length > 0) {
          ...
          newData = {
            "perc-field-recaptcha-callback-value":
              defaults["perc-field-recaptcha-callback-value"],
          };
        }
      ...
      onRender: function (elem, vals, defaults) {
        ...
        if (
          typeof vals === "object" &&
          typeof vals["perc-field-recaptcha-callback-value"] !== "undefined" &&
          vals["perc-field-recaptcha-callback-value"] !==
            defaults["perc-field-recaptcha-callback-value"]
        ) {
          value = vals["perc-field-recaptcha-callback-value"];
        }
        // If key was set, apply it to the current element
        if (value) elem.attr("data-callback", value);
      },
      validate: function () {
        return true;
      },
    ...
    RECAPTCHA_EXPIREDCALLBACK: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        if (
          vals !== undefined &&
          typeof vals === "object" &&
          typeof vals["perc-field-recaptcha-expired-callback-value"] !==
            "undefined"
        ) {
          value = vals["perc-field-recaptcha-expired-callback-value"];
        } else if (
          typeof defaults === "object" &&
          typeof defaults["perc-field-recaptcha-expired-callback-value"] !==
            "undefined"
        ) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          "<label for='perc-field-recaptcha-expired-callback-value'>Expired Callback</label><input type='text' class='perc-pref-text perc-pref-text-longer' value='" +
          value +
          '\' id=\'perc-field-recaptcha-expired-callback-value\' size="50" maxlength="255"/>' +
          "</div>";
        container.append(out);
      },
      ...
      onApply: function (data, defaults) {
        var newData = {};
        var value = $("#perc-field-recaptcha-expired-callback-value")
          .val()
          .trim();
        ...
        if (value.length > 0) {
          ...
          newData = {
            "perc-field-recaptcha-expired-callback-value":
              defaults["perc-field-recaptcha-expired-callback-value"],
          };
        }
      ...
      onRender: function (elem, vals, defaults) {
        ...
        if (
          ...
          typeof vals["perc-field-recaptcha-expired-callback-value"] !==
            "undefined" &&
          vals["perc-field-recaptcha-expired-callback-value"] !==
            defaults["perc-field-recaptcha-expired-callback-value"]
        ) {
          value = vals["perc-field-recaptcha-expired-callback-value"];
        }
        // If key was set, apply it to the current element
        if (value) elem.attr("data-expired-callback", value);
      },
      validate: function () {
        return true;
      },
    ...
    RECAPTCHA_ERRORCALLBACK: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        if (
          vals !== undefined &&
          typeof vals === "object" &&
          typeof vals["perc-field-recaptcha-error-callback-value"] !==
            "undefined"
        ) {
          value = vals["perc-field-recaptcha-error-callback-value"];
        } else if (
          typeof defaults === "object" &&
          typeof defaults["perc-field-recaptcha-error-callback-value"] !==
            "undefined"
        ) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          "<label for='perc-field-recaptcha-error-callback-value'>Error Callback</label><input type='text' class='perc-pref-text perc-pref-text-longer' value='" +
          value +
          '\' id=\'perc-field-recaptcha-error-callback-value\' size="50" maxlength="255"/>' +
          "</div>";
        container.append(out);
      },
      ...
      onApply: function (data, defaults) {
        var newData = {};
        var value = $("#perc-field-recaptcha-error-callback-value")
          .val()
          .trim();
        ...
        if (value.length > 0) {
          ...
          newData = {
            "perc-field-recaptcha-error-callback-value":
              defaults["perc-field-recaptcha-error-callback-value"],
          };
        }
      ...
      onRender: function (elem, vals, defaults) {
        ...
        if (
          ...
          typeof vals["perc-field-recaptcha-error-callback-value"] !==
            "undefined" &&
          vals["perc-field-recaptcha-error-callback-value"] !==
            defaults["perc-field-recaptcha-error-callback-value"]
        ) {
          value = vals["perc-field-recaptcha-error-callback-value"];
        }
        // If key was set, apply it to the current element
        if (value) elem.attr("data-error-callback", value);
      },
      validate: function () {
        return true;
      },
    ...
    ID: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          "Id <input type='text' class='perc-pref-text perc-pref-text-longer' value='" +
          idValue +
          '\' id=\'perc-field-id-value\' size="50" maxlength="255"/>' +
          "</div>";
        container.append(out);
      ...
      onApply: function (data, defaults) {
        ...
        for (var i = 0; i < formControls.length; i++) {
          ...
          if (
            typeof controlPreferenceVals !== "undefined" &&
            typeof controlPreferenceVals.id !== "undefined" &&
            typeof controlPreferenceVals.id["perc-field-id-value"] !==
              "undefined" &&
            idValue.toLowerCase() ===
              controlPreferenceVals.id["perc-field-id-value"].toLowerCase()
          ) {
            isUniqueId = false;
            break;
          }
        ...
        if (!isUniqueId) {
          window.parent.jQuery.perc_utils.alert_dialog({
            title: "Error",
            content:
              "The Id supplied is already assignated to another form control.",
          });
          return null;
        } else {
          return newData;
  ...
  $.PercFormController = function () {
    ...
    function getFormData($formElem, $formMetaElem) {
      ...
      formData.config.description = $formMetaElem
        .find("textarea[name='perc-form-description']")
        .val();
      formData.config.processorType = $formMetaElem
        .find("input[name='perc-save-to']:checked")
        .val();
      formData.config.processorURL = $formMetaElem
        .find("input[name='perc-save-to-url']")
        .val();
      formData.config.successURL = $formMetaElem
        .find("#perc-formbuild-success-url")
        .val();
      formData.config.unencryptedSuccessURL = $formMetaElem
        .find("#perc-formbuild-success-url-paired-unencrypted")
        .val();
      formData.config.encryptedSuccessURL = $formMetaElem
        .find("#perc-formbuild-success-url-paired-encrypted")
        .val();
      formData.config.errorURL = $formMetaElem
        .find("#perc-formbuild-error-url")
        .val();
      formData.config.unencryptedErrorURL = $formMetaElem
        .find("#perc-formbuild-error-url-paired-unencrypted")
        .val();
      formData.config.encryptedErrorURL = $formMetaElem
        .find("#perc-formbuild-error-url-paired-encrypted")
        .val();
      formData.config.emailNotification = $formMetaElem
        .find("#perc-form-metadata-email-notification")
        .is(":checked");
      formData.config.emailFormNotification = $formMetaElem
        .find("#perc-form-metadata-email-form")
        .is(":checked");
      formData.config.mailTo = $formMetaElem
        .find("#perc-formbuild-mail-to")
        .val();
      formData.config.unencryptedMailTo = $formMetaElem
        .find("#perc-formbuild-mail-to-paired-unencrypted")
        .val();
      formData.config.encryptedMailTo = $formMetaElem
        .find("#perc-formbuild-mail-to-paired-encrypted")
        .val();
      formData.config.mailSubject = $formMetaElem
        .find("#perc-formbuild-mail-subject")
        .val();
      formData.config.unencryptedMailSubject = $formMetaElem
        .find("#perc-formbuild-mail-subject-paired-unencrypted")
        .val();
      formData.config.encryptedMailSubject = $formMetaElem
        .find("#perc-formbuild-mail-subject-paired-encrypted")
        .val();
      //Fill field Elements
    ...
    function getFormEditor(formData) {
      ...
      if (formData) {
        ...
        formEditorHtml
          .find("#" + $.PercFormConstants.FORM_TITLE_INPUT_ID)
          .val(formConfig.title);
        formEditorHtml
          .find("#" + $.PercFormConstants.FORM_NAME_INPUT_ID)
          .val(formConfig.name);
        $.each(formData.fields, function () {
          ...
          fieldEditorHtml
            .find("." + $.PercFormConstants.FIELD_CLASS)
            .data($.PercFormConstants.PREFERENCES_KEY, this.prefs);
    ...
    function getFormMetaDataEditor(formData) {
      var formEditorHtml = $(
        "<div class='" + $.PercFormConstants.FORM_METADATA_CLASS + "'></div>",
      );
      formEditorHtml.append(
      ...
      if (formData) {
        formEditorHtml
          .find("input[name='perc-save-to']")
          .on("change", function (event) {
            if ($(this).val() === "LocalServer") {
              if (this.checked) {
                formEditorHtml
                  .find("#perc-form-metadata-save-to-url-text")
                  .get(0)
        ...
        formEditorHtml
          .find("textarea[name='perc-form-description']")
          .val(formData.config.description);
        formEditorHtml
          .find("#perc-formbuild-success-url")
          .val(formData.config.unencryptedSuccessURL);
        formEditorHtml
          .find("#perc-formbuild-success-url-paired-unencrypted")
          .val(formData.config.unencryptedSuccessURL);
        formEditorHtml
          .find("#perc-formbuild-success-url-paired-encrypted")
          .val(formData.config.encryptedSuccessURL);
        formEditorHtml
          .find("#perc-formbuild-error-url")
          .val(formData.config.unencryptedErrorURL);
        formEditorHtml
          .find("#perc-formbuild-error-url-paired-unencrypted")
          .val(formData.config.unencryptedErrorURL);
        formEditorHtml
          .find("#perc-formbuild-error-url-paired-encrypted")
          .val(formData.config.encryptedErrorURL);
        formEditorHtml
          .find("#perc-form-metadata-email-notification")
          .prop("checked", formData.config.emailNotification);
        formEditorHtml
          .find("#perc-form-metadata-email-form")
          .prop("checked", formData.config.emailFormNotification);
        formEditorHtml
          .find("#perc-formbuild-mail-to")
          .val(formData.config.unencryptedMailTo);
        formEditorHtml
          .find("#perc-formbuild-mail-to-paired-unencrypted")
          .val(formData.config.unencryptedMailTo);
        formEditorHtml
          .find("#perc-formbuild-mail-to-paired-encrypted")
          .val(formData.config.encryptedMailTo);
        formEditorHtml
          .find("#perc-formbuild-mail-subject")
          .val(formData.config.unencryptedMailSubject);
        formEditorHtml
          .find("#perc-formbuild-mail-subject-paired-unencrypted")
          .val(formData.config.unencryptedMailSubject);
        formEditorHtml
          .find("#perc-formbuild-mail-subject-paired-encrypted")
          .val(formData.config.encryptedMailSubject);

        formEditorHtml
          .find("#perc-formbuild-mail-to")
          .prop("disabled", !formData.config.emailNotification);
        formEditorHtml
          .find("#perc-formbuild-mail-subject")
          .prop("disabled", !formData.config.emailNotification);
        ...
        if (formData.config.processorType === "ExternalServer") {
          formEditorHtml
            .find("input[name='perc-save-to'][value='LocalServer']")
            .prop("checked", false);
          formEditorHtml
            .find("input[name='perc-save-to'][value='ExternalServer']")
            .attr("checked", "checked")
            .trigger("click")
            .trigger("change");
          formEditorHtml
            .find("input[name='perc-save-to-url']")
            .val(formData.config.processorURL);
        } else {
          formEditorHtml
            .find("input[name='perc-save-to'][value='LocalServer']")
            .trigger("click")
      ...
      formEditorHtml
        ...
        .on("click", function () {
          ...
          formEditorHtml
            ...
            .prop("disabled", flag);
          formEditorHtml
            .find("input[name='perc-email-form']")
            .prop("checked", false);
        });
      ...
      formEditorHtml
        ...
        .on("click", function () {
          var flag = !formEditorHtml
            ...
            .is(":checked");
          formEditorHtml
            .find("input[name='perc-email-notification']")
            .prop("checked", false);
          formEditorHtml
            .find("#perc-formbuild-mail-to")
            .get(0)
    ...
    function getRenderedForm(formData) {
      ...
      if (formData.config.emailFormNotification) {
        formRenderedHtml.append(
          $("<input/>").attr("type", "hidden").attr("name", "emailForm"),
        );
      }
      ...
      $.each(formData.fields, function () {
        ...
        if (fieldName === "") fieldName = "_blank_";
    ...
    function updateEncryptedFields(fields, async) {
      ...
      if (encObjects.length === 0) return { call_made: false };

      var success = false;
      $.PercUtilService.encryptStrings(
        encStrings,
        function (status, result) {
          if (status === $.PercServiceUtils.STATUS_SUCCESS) {
            $(encObjects).each(function () {
              $("#" + this.fieldName + "-paired-unencrypted").val(
                this.fieldValue,
              );
              $("#" + this.fieldName + "-paired-encrypted").val(
  ...
  $.PercFieldControlInterface = {
     ...
     */
    getFieldEditor: function (fieldData, isExtended) {
      throw "Must be implemented by the concrete class";
    },
     ...
     */
    getFieldData: function ($fieldElem) {
      throw "Must be implemented by the concrete class";
    },
    ...
    toggleFieldEditor: function ($fieldElem) {
      ...
      if (typeof prefs == "object") {
        editor
          .find("." + $.PercFormConstants.FIELD_CLASS)
          .data($.PercFormConstants.PREFERENCES_KEY, prefs);
      }
      return editor;
    },
     ...
     */
    getRenderedField: function (fieldData) {
      throw "Must be implemented by the concrete class";
    },
  ...
  $.PercEntryFieldControl = function () {
    ...
    entryControlAPI.getFieldData = function ($fieldElem) {
      ...
      if ($fieldElem.hasClass($.PercFormConstants.FIELD_EDITOR_BASIC_CLASS)) {
        fieldData.label = $fieldElem
          .find("." + $.PercFormConstants.FIELD_EDITOR_LABEL_CLASS)
          .text();
        fieldData.defaultValue = $fieldElem
          .find("div[name='defaultValue']")
          .text();
        if (
    ...
    entryControlAPI.getFieldEditor = function (fieldData, isExtended) {
      ...
      if (fieldData && isExtended) {
        defValue =
          fieldData.defaultValue === "null" ? "" : fieldData.defaultValue;
          ...
          $("<div/>")
            ...
            .append(
              $("<div/>")
                ...
                .addClass($.PercFormConstants.FORM_LABEL_CLASS)
                .text(
                  this.label + " " + $.PercFormConstants.DEFAULT_LABEL_CONST,
                ),
            )
            .append(
              $("<div>").append(
    ...
    entryControlAPI.getRenderedField = function (fieldData) {
      ...
      if (fieldData.prefs && fieldData.prefs.name) {
        nameValue =
          fieldData.prefs.name["perc-field-name-value"] === ""
            ? fieldData.name
            : fieldData.prefs.name["perc-field-name-value"];
      }
    ...
    entryControlAPI.getAvailablePrefs = function () {
      return [
        ...
        {
          pref: $.PercFormFieldPref.MAX_CHAR,
          defaults: {
            "perc-validate-max-char": "yes",
            "perc-field-max-char-value": 2048,
          },
        },
        {
          pref: $.PercFormFieldPref.WIDTH,
          defaults: { "perc-field-width-value": 150 },
        },
      ];
    };
  ...
  $.PercHiddenFieldControl = function () {
    ...
    hiddenControlAPI.getFieldData = function ($fieldElem) {
      ...
      var fieldName = "";
      if ($fieldElem.hasClass($.PercFormConstants.FIELD_EDITOR_BASIC_CLASS)) {
        fieldName = $.perc_autoFillTextFilters.URL(
          $fieldElem
            .find("." + $.PercFormConstants.FIELD_EDITOR_NAME_CLASS)
            .text(),
        );
        ...
        fieldName = $.perc_autoFillTextFilters.URL(
          $fieldElem.find("input[name='fieldName']").val(),
        );
        fieldData.name = fieldName;
        fieldData.label = fieldName;
        fieldData.defaultValue = $fieldElem
    ...
    hiddenControlAPI.getFieldEditor = function (fieldData, isExtended) {
      ...
      if (fieldData && isExtended) {
        ...
        $.perc_filterFieldText(
          fieldEditorHtml.find("input[name='fieldName']"),
          $.perc_autoFillTextFilters.IDNAMECDATAALPHA,
        );
      } else if (fieldData) {
        defValue =
        ...
        $.perc_filterField(
          fieldEditorHtml.find("input[id='perc-form-label-field-name']"),
          $.perc_autoFillTextFilters.IDNAMECDATAALPHA,
        );
      }
      return fieldEditorHtml;
  ...
  $.PercHoneypotFieldControl = function () {
    ...
    honeypotControlAPI.getFieldData = function ($fieldElem) {
      ...
      if ($fieldElem.hasClass($.PercFormConstants.FIELD_EDITOR_BASIC_CLASS)) {
        ...
        fieldName = $.perc_autoFillTextFilters.URL(
          $fieldElem.find("div[name='fieldName']").text(),
        );
        fieldData.name = fieldName;
        fieldData.label = fieldName;
        fieldData.defaultValue = $fieldElem
      ...
      if (fieldData && isExtended) {
        ...
        fieldEditorHtml.append(
          $("<div/>")
            ...
            .append(
              $("<div/>").append(
                $("<div/>").attr("name", "fieldName").text(fieldData.name),
              ),
            )
            .append(
              $("<div/>").append(
        ...
        $.perc_filterFieldText(
          fieldEditorHtml.find("div[name='fieldName']"),
          $.perc_autoFillTextFilters.IDNAMECDATAALPHA,
        );
      } else if (fieldData) {
        defValue =
        ...
        $.perc_filterField(
          fieldEditorHtml.find("div[id='perc-form-label-field-name']"),
          $.perc_autoFillTextFilters.IDNAMECDATAALPHA,
        );
      }
  ...
  $.PercTextareaFieldControl = function () {
    ...
    textareaControlAPI.getFieldData = function ($fieldElem) {
      ...
      fieldData.defaultValue = $fieldElem
        .find("textarea[name='defaultValue']")
        .val();
      if (
        fieldData.defaultValue === "" ||
        fieldData.defaultValue === undefined ||
    ...
    textareaControlAPI.getAvailablePrefs = function () {
      return [
        ...
        {
          pref: $.PercFormFieldPref.MAX_CHAR,
          defaults: { "perc-field-max-char-value": 2048 },
        },
  ...
  $.PercTextFieldControl = function () {
    ...
    textControlAPI.getRenderedField = function (fieldData) {
      ...
      var renderedHtml = $("<div/>")
        .addClass($.PercFormConstants.FIELD_ROW_CLASS)
        .append(
          $("<span/>").html(fieldData.label).text(fieldData.defaultValue),
        );
  ...
  $.PercDataDropDownControl = function () {
      ...
      opts.each(function () {
        if ($(this).val().trim() !== "") {
          ...
          if (
            ...
            $(this).prev().is("input[type=radio]:checked")
          ) {
    ...
    DataDropDownControlAPI.getFieldEditor = function (fieldData, isExtended) {
      var fieldEditorHtml = "";
      var fieldEditorHtmlWrapper = $(
        "<div class = 'perc-form-field-wrapper'></div>",
      );
      if (fieldData && isExtended) {
        fieldEditorHtml = $(
          "<div type='" +
            $.PercFormConstants.FIELD_CONTROL_DATADROPDOWN +
            "' class=' form-widget-label " +
            $.PercFormConstants.FIELD_EDITOR_EXT_CLASS +
            " " +
            $.PercFormConstants.FIELD_CLASS +
            "'></div>",
        ).attr(
          "name",
          $.PercFormController().generateNameFromLabel(fieldData.label),
        );
        fieldEditorHtml.append(
          $("<div>").append(
            $(
              "<input size = '38' class = 'perc-form-datadisplay defaultFocus' type='text' maxlength='255' name='fieldLabel'/>",
            ).val(fieldData.label),
          ),
        );
        fieldEditorHtml.append(
          "<div class='form-widget-label' style='padding-right:10px;margin-bottom:-8px;' " +
            $.PercFormConstants.FIELD_EDITOR_LABEL_CLASS +
            " >Select a widget</div></br>",
        );
        s = $('<select class="dataDropDownSelect" />');
        var opt = "";
        $.getJSON(
          $.perc_paths.ASSET_TYPES + "?filterDisabledWidgets=yes",
          function (data) {
            ...
            for (let i = 0; i < len; i++) {
              opt = $(
                "<option value='" +
                  data.WidgetContentType[i].contentTypeName +
                  "'>" +
                  data.WidgetContentType[i].contentTypeName +
                  "</option>",
              );
        ...
        fieldEditorHtml = $(
          "<div type='" +
            $.PercFormConstants.FIELD_CONTROL_DATADROPDOWN +
            "' class='" +
            $.PercFormConstants.FIELD_EDITOR_BASIC_CLASS +
            " " +
            $.PercFormConstants.FIELD_CLASS +
            "'></div>",
        );
        ...
        var DataDropDown = $('<select style = "margin-top:5px"/>').attr(
          "disabled",
          "disabled",
        );
        ...
        fieldEditorHtml.append(
          $(
            "<div id = 'perc-form-label-field-name' class='" +
              $.PercFormConstants.FIELD_EDITOR_LABEL_CLASS +
              " form-widget-label' />",
    ...
    DataDropDownControlAPI.getRenderedField = function (fieldData) {
      ...
      var renderedHtml = $("<div/>")
        ...
        .append(
          $("<div/>")
            .addClass($.PercFormConstants.FIELD_LABEL_CONTAINER_CLASS)
            .append(
              $("<label/>").attr("for", "email-to").text(fieldData.label),
            ),
        )
        .append(
          $("<div/>").addClass($.PercFormConstants.FIELD_INPUT_CONTAINER_CLASS),
        );
      ...
      renderedHtml
        .find("." + $.PercFormConstants.FIELD_INPUT_CONTAINER_CLASS)
        .eq(0)
        .append(DataDropDownOptions);

      var prefs = this.getAvailablePrefs();
      for (var i = 0; i < prefs.length; i++) {
        prefs[i].pref.onRender(
          renderedHtml.find("select"),
          fieldData.prefs ? fieldData.prefs[prefs[i].pref.name] : undefined,
          prefs[i].defaults,
        );
      }
      ...
      $.PercFormFieldPref.REQUIRED.onRender(
        renderedHtml.find("select"),
        vals,
        null,
      );
      ...
      var checkOptionPresence = renderedHtml.find(
        "#" +
          "field-" +
          fieldData.name +
  ...
  $.PercDropDownControl = function () {
    ...
    dropDownControlAPI.getFieldEditor = function (fieldData, isExtended) {
      ...
      if (fieldData && isExtended) {
        fieldEditorHtml = $(
          "<div type='" +
            $.PercFormConstants.FIELD_CONTROL_DROPDOWN +
            "' class=' form-widget-label " +
            $.PercFormConstants.FIELD_EDITOR_EXT_CLASS +
            " " +
            $.PercFormConstants.FIELD_CLASS +
        ...
        fieldEditorHtml.append(
          "<div class='form-widget-label' style='color:#E6E6E9;float:left;margin-left:auto;margin-right:auto;padding-right:10px;' " +
            $.PercFormConstants.FIELD_EDITOR_LABEL_CLASS +
            " ></div>",
        );
        fieldEditorHtml.append(
          "<div class='form-widget-label' style='float:left;padding-right:10px;' " +
            $.PercFormConstants.FIELD_EDITOR_LABEL_CLASS +
            " >Enter your custom options</div></br>",
        );
        fieldEditorHtml.append("<br />");
        //Load variables to be used
        var newOption =
          "<div class='perc-div-rowOption'><input type='radio' name='defaultValue' value='' />" +
          "<input size='33' class='perc-form-datadisplay option-dd' type='text' name='defaultValue' maxlength='255' value='' />" +
          "</div>";
        var addControl =
          "<button type='button' class='control-img-button add-control' alt='Add field' title='Add field'></button>";
        var deleteControl =
          "<button type='button' class='control-img-button delete-control' alt='Delete field' title='Delete field'></button>";
        ...
        var delete_function = function (event) {
          ...
          if (target.parent().find(".add-control").is(".add-control")) {
            ...
            if (
              !target.parent().prev().is("div") &&
              target.parent().next().find(".add-control").is(".add-control")
            ) {
        ...
        var dropDown = $('<select style = "margin-top:5px"/>').attr(
          "disabled",
          "disabled",
        );
        $.each(fieldData.options, function (i, e) {
        ...
        fieldEditorHtml.append(
          "<div><select disabled='disabled' class = 'perc-form-datadisplay' name='defaultValue'> <option class='option-dd' value='Selection 1'>Selection 1</option> " +
    ...
    dropDownControlAPI.getRenderedField = function (fieldData) {
      ...
      for (var index in fieldData.options) {
        ...
        dropDownOptions.append(
          $("<option/>").val(option.value).text(option.label),
        );
      }
  ...
  $.PercCheckBoxControl = function () {
    ...
    checkboxControlAPI.getFieldData = function ($fieldElem) {
      ...
      opts.each(function (i) {
        if ($(this).val().trim() !== "") {
          ...
          if (
            $(this).is(":checked") ||
            $(this).prev().is("input[type=checkbox]:checked")
          ) {
    ...
    checkboxControlAPI.getFieldEditor = function (fieldData, isExtended) {
      ...
      if (fieldData && isExtended) {
        fieldEditorHtml = $(
          "<div type='" +
            $.PercFormConstants.FIELD_CONTROL_CHECKBOX +
            "' class=' form-widget-label " +
            $.PercFormConstants.FIELD_EDITOR_EXT_CLASS +
            " " +
            $.PercFormConstants.FIELD_CLASS +
        ...
        fieldEditorHtml.append(
          $("<div/>").append(
            $(
              "<input size = '38' class = 'defaultFocus perc-form-datadisplay' type='text' maxlength='255' name='fieldLabel' />",
            ).val(fieldData.label),
          ),
        );
        ...
        //Load variables to be used
        var newOption =
          "<div class='perc-div-rowOption'><input type='checkbox' name='defaultValue' value='' />" +
          "<input size='33' class='perc-form-datadisplay option-dd' type='text' name='defaultValue' maxlength='255' value='' />" +
          "</div>";
        var addControl =
          "<button type='button' class='control-img-button add-control' alt='Add field' title='Add field'></button>";
        ...
        $.each(fieldData.options, function (i, e) {
          ...
          var labelRadio = $("<div/>")
            .append($("<label/>").attr("for", e.value).text(e.value))
            .html(); // $('<div/>').append().html() hack to get source.
          newRow.append(check);
        ...
        fieldEditorHtml.append(
          "<div id = 'perc-form-label-field-name' class='" +
            $.PercFormConstants.FIELD_EDITOR_LABEL_CLASS +
            " form-widget-label'>Checkboxes field label</div>",
        );
        fieldEditorHtml.append(
          "<div><input disabled = 'disabled' size = '33' class = 'option-dd' type='checkbox' name='defaultValue' value='Item 1' id='option1'/> " +
            "<label for='option1'>Item 1</label></div>",
        );
        fieldEditorHtml.append(
          "<div><input disabled = 'disabled' size = '33' class = 'option-dd' type='checkbox' name='defaultValue' value='Item 2' id='option2'/> " +
            "<label for='option2'>Item 2</label></div>",
        );
        fieldEditorHtml.append(
          "<div><input disabled = 'disabled' size = '33' class = 'option-dd' type='checkbox' name='defaultValue' value='Item 3' id='option2'/> " +
    ...
    checkboxControlAPI.getRenderedField = function (fieldData) {
      ...
      var checkBoxesHtml = $("<div/>").addClass(
        $.PercFormConstants.FIELD_INPUT_CONTAINER_CLASS,
      );
      var thisRow = {};
      for (var index in fieldData.options) {
        // Array of Objects
        ...
        var labelForValue =
          ...
          fieldData.name +
          "-option-" +
          formControl.generateNameFromLabel(option.value);
        thisRow = $("<div/>")
          .append(
            $("<div/>").append(
              $("<input/>")
          ...
          .append(
            $("<div/>").append(
              $("<label/>").attr("for", labelForValue).text(option.value),
            ),
          );
        if (option.checked === "true" || option.checked === true) {
          // It can be provided as either a string or a bool :(
          // Fix Firefox Bug involving rendering html and defaultValue/value
          thisRow.find("input").prop("checked", true).get(0).defaultChecked =
            true;
        }
  ...
  $.PercRadioControl = function () {
    ...
    radioControlAPI.generateUID = function () {
      ...
      var nameElements = $(
        "#" +
          $.PercFormConstants.FORM_DND_FIELDS +
          "  input[name=" +
          uniqueName +
          "]",
      );
    ...
    radioControlAPI.getFieldEditor = function (fieldData, isExtended) {
      ...
      if (fieldData && isExtended) {
        fieldEditorHtml = $(
          "<div type='" +
            $.PercFormConstants.FIELD_CONTROL_RADIO +
            "' class='form-widget-label " +
            $.PercFormConstants.FIELD_EDITOR_EXT_CLASS +
            " " +
            $.PercFormConstants.FIELD_CLASS +
        ...
        //Load variables to be used
        var newOption =
          "<div class='perc-div-rowOption'><input type='radio' name='" +
          fieldData.defaultName +
          "' value='' />" +
          "<input size='34' class='perc-form-datadisplay option-dd' type='text' maxlength='255' value='' />" +
          "</div>";
        $(newOption)
          .find("input[type=text]")
          .attr("name", fieldData.defaultName);
        ...
        fieldEditorHtml.append(
          "<div id = 'perc-form-label-field-name' class='" +
            $.PercFormConstants.FIELD_EDITOR_LABEL_CLASS +
            " form-widget-label defaultFocus'>Radio button field label</div>",
        );
        fieldEditorHtml.append(
          "<div><input size = '34' disabled = 'disabled' class = 'option-dd' type='radio' name='" +
            inputName +
            "' value='Item 1' id='option1'/> " +
            "<label for='option1'>Item 1</label></div>",
        );
        fieldEditorHtml.append(
          "<div><input size = '34' disabled = 'disabled' class = 'option-dd' type='radio' name='" +
            inputName +
            "' value='Item 2' id='option2'/> " +
            "<label for='option2'>Item 2</label></div>",
        );
        fieldEditorHtml.append(
          "<div><input size = '34' disabled = 'disabled' class = 'option-dd' type='radio' name='" +
            inputName +
            "' value='Item 3' id='option3'/> " +
            "<label for='option3'>Item 3</label></div>",
        );
        fieldEditorHtml
          .find("input[type=radio]")
          .map(function (index, DOMElement) {
            $(DOMElement).attr("name", inputName);
          });
        fieldEditorHtmlWrapper.append(fieldEditorHtml);
      }
      return fieldEditorHtmlWrapper;
    ...
    radioControlAPI.getRenderedField = function (fieldData) {
      ...
      var radioButtonsHtml = $("<div/>").addClass(
        $.PercFormConstants.FIELD_INPUT_CONTAINER_CLASS,
      );
      var thisRow = {};
      for (var index in fieldData.options) {
      ...
      if (fieldData && isExtended) {
        ...
        fieldEditorHtml.append(
          $("<div/>")
            ...
            .append(
              $('<div class = "perc-form-datepicker" />').append(
                $("<input />")
                  .attr("type", "text")
                  .attr("readonly", "readonly")
                  .attr("name", "defaultValue")
   ...
   */
  $.PercFieldTypes = [];
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_ENTRY] =
    $.PercEntryFieldControl;
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_TEXT] =
    $.PercTextFieldControl;
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_RADIO] =
    $.PercRadioControl;
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_TEXTAREA] =
    $.PercTextareaFieldControl;
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_DROPDOWN] =
    $.PercDropDownControl;
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_DATADROPDOWN] =
    $.PercDataDropDownControl;
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_CHECKBOX] =
    $.PercCheckBoxControl;
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_DATE] = $.PercDateControl;
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_SUBMIT] =
    $.PercSubmitButtonControl;
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_HIDDEN] =
    $.PercHiddenFieldControl;
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_HONEYPOT] =
    $.PercHoneypotFieldControl;
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_RECAPTCHA] =
