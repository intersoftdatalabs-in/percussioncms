...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" />
	<!-- formWidgetControl -->
	<psxctl:ControlMeta name="formWidgetControl"
		...
		<psxctl:AssociatedFileList>
			...
			<psxctl:FileDescriptor
				name="perc-form-widget.css" type="css" mimetype="text/css">
	...
	<xsl:template match="Control[@name='formWidgetControl']"
		mode="psxcontrol">
		<!-- PercFormView.js file actually renders the form. -->
		<span class="perc-required-form-legend">
		...
		<div id="{@paramName}" class="PercFormWidget">
			<div id="perc-form-top-row">
				<div id="perc-control-menu-button">
					<img src="/rx_resources/widgets/form/images/control.png"
	...
	<xsl:template
		match="Control[@name='formWidgetControl' and @isReadOnly='yes']"
