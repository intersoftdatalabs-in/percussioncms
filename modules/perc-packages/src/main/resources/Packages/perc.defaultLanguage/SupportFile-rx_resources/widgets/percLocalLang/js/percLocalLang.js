    ...
    function renderEditor() {
      ...
      if (data != null) {
        ...
        for (var i = 0; i < data.config.length; i++) {
          ...
          $clone
            .find('.perc-page-select input[type="text"]')
            .attr("data-page-id", data.config[i].pageId);
          $clone.find(".perc-lang-list").val(data.config[i].lang);
          $clone.find(".perc-country-list").val(data.config[i].country);
          $clone
            .find('input[name="default-lang"]')
            .prop("checked", data.config[i].defLang);
          ...
          $clone
            ...
            .attr("id", newCloneId);
          $clone
            .find('.perc-page-select input[type="button"]')
            .attr("for", newCloneId);
      ...
      $(document).ready(function () {
        $(".perc-page-field-select-button").on("click", function () {
          ...
          var validator = function (pathItem) {
            return pathItem && pathItem.type == "percPage"
              ? null
