!(function (t) {
  function e(e, o, p) {
    ...
    ((d.id = p),
      ...
      (d.elements = {
        target: e.addClass(d.options.style.classes.target),
        tooltip: null,
        wrapper: null,
        content: null,
        contentWrapper: null,
      ...
      t.extend(d, d.options.api, {
        show: function (e) {
          ...
          if (
            ...
            "static" !== d.options.position.type &&
              d.updatePosition(e, d.options.show.effect.length > 0),
            "object" == typeof d.options.show.solo
              ? (o = t(d.options.show.solo))
              : !0 === d.options.show.solo &&
                (o = t("div.qtip").not(d.elements.tooltip)),
            o &&
              o.each(function () {
                !0 === t(this).qtip("api").status.rendered &&
                  t(this).qtip("api").hide();
              }),
            ...
            switch (d.options.show.effect.type.toLowerCase()) {
              case "fade":
                d.elements.tooltip.fadeIn(d.options.show.effect.length, i);
                break;
              case "slide":
                ...
                break;
              case "grow":
                d.elements.tooltip.show(d.options.show.effect.length, i);
                break;
              default:
                d.elements.tooltip.show(null, i);
            }
        ...
        hide: function (e) {
          ...
          if (
            ...
            d.elements.tooltip.stop(!0, !1),
            !1 === d.beforeHide.call(d, e))
          )
            return d;
          function o() {
            d.onHide.call(d, e);
          ...
          if (
            ...
            switch (d.options.hide.effect.type.toLowerCase()) {
              case "fade":
                d.elements.tooltip.fadeOut(d.options.hide.effect.length, o);
                break;
              case "slide":
                d.elements.tooltip.slideUp(d.options.hide.effect.length, o);
                break;
              case "grow":
                d.elements.tooltip.hide(d.options.hide.effect.length, o);
                break;
              default:
                d.elements.tooltip.hide(null, o);
            }
        ...
        updatePosition: function (e, o) {
          ...
          if (
            ...
            "mouse" !== d.options.position.target)
          ) {
            if (
              "area" == d.options.position.target.get(0).nodeName.toLowerCase()
            ) {
              for (
                l = d.options.position.target.attr("coords").split(","), i = 0;
                i < l.length;
                i++
              )
                l[i] = parseInt(l[i]);
              switch (
                ((p = d.options.position.target.parent("map").attr("name")),
                (a = t('img[usemap="#' + p + '"]:first').offset()),
                (n.position = {
                  left: Math.floor(a.left + l[0]),
                  top: Math.floor(a.top + l[1]),
                }),
                d.options.position.target.attr("shape").toLowerCase())
              ) {
                case "rect":
                  n.dimensions = {
                    width: Math.ceil(Math.abs(l[2] - l[0])),
                    height: Math.ceil(Math.abs(l[3] - l[1])),
                  };
                  break;
                case "circle":
                  n.dimensions = { width: l[2] + 1, height: l[2] + 1 };
                  break;
                case "poly":
                  for (
                    n.dimensions = { width: l[0], height: l[1] }, i = 0;
                    i < l.length;
                    i++
                  )
                    i % 2 == 0
                      ? (l[i] > n.dimensions.width &&
                          (n.dimensions.width = l[i]),
                        l[i] < l[0] &&
                          (n.position.left = Math.floor(a.left + l[i])))
                      : (l[i] > n.dimensions.height &&
              ...
              1 === d.options.position.target.add(document.body).length
                ...
                : (void 0 !== d.options.position.target.attr("qtip")
                    ? (n.position =
                        d.options.position.target.qtip("api").cache.position)
                    : (n.position = d.options.position.target.offset()),
                  (n.dimensions = {
          ...
          if (
            ...
            -1 !== r.corner.search(/((top|bottom)Middle)|center/) &&
              (h.left -= r.dimensions.width / 2),
            -1 !== r.corner.search(/((left|right)Middle)|center/) &&
              (h.top -= r.dimensions.height / 2),
            (c = t.browser.msie ? 1 : 0),
            t.browser.msie && 6 === parseInt(t.browser.version.charAt(0))
              ? 1
              : 0,
            d.options.style.border.radius > 0 &&
              (-1 !== r.corner.search(/Left/)
                ? (h.left -= d.options.style.border.radius)
                : -1 !== r.corner.search(/Right/) &&
                  (h.left += d.options.style.border.radius),
              -1 !== r.corner.search(/Top/)
                ? (h.top -= d.options.style.border.radius)
                : -1 !== r.corner.search(/Bottom/) &&
                  (h.top += d.options.style.border.radius)),
            c &&
              (-1 !== r.corner.search(/top/)
                ? (h.top -= c)
                : -1 !== r.corner.search(/bottom/) && (h.top += c),
              -1 !== r.corner.search(/left/)
                ? (h.left -= c)
                : -1 !== r.corner.search(/right/) && (h.left += c),
              -1 !== r.corner.search(/leftMiddle|rightMiddle/) && (h.top -= 1)),
            !0 === d.options.position.adjust.screen &&
              (h = function (e, o, i) {
                var n, r, l, p;
                ...
                ((n = t.extend({}, e)),
                  ...
                  (p = {
                    ...
                    right:
                      n.left + i.dimensions.width + 2 >=
                      t.fn.qtip.cache.screen.width +
                        t.fn.qtip.cache.screen.scroll.left,
                    top: n.top < t.fn.qtip.cache.screen.scroll.top,
                    bottom:
                      n.top + i.dimensions.height + 2 >=
                      t.fn.qtip.cache.screen.height +
                        t.fn.qtip.cache.screen.scroll.top,
                  }),
                  (r = {
                    left:
                      p.left &&
                      (-1 != i.corner.search(/right/i) ||
                        (-1 == i.corner.search(/right/i) && !p.right)),
                    right:
                      p.right &&
                      (-1 != i.corner.search(/left/i) ||
                        (-1 == i.corner.search(/left/i) && !p.left)),
                    top: p.top && -1 == i.corner.search(/top/i),
                    bottom: p.bottom && -1 == i.corner.search(/bottom/i),
                  }).left
                    ? ("mouse" !== this.options.position.target
                        ? (n.left = o.position.left + o.dimensions.width)
                        : (n.left = this.cache.mouse.x),
                      (l.x = "Left"))
                    : r.right &&
                      ("mouse" !== this.options.position.target
                ...
                r.top
                  ? ("mouse" !== this.options.position.target
                      ...
                      : (n.top = this.cache.mouse.y),
                    (l.y = "top"))
                  : r.bottom &&
                    ("mouse" !== this.options.position.target
                      ? (n.top = o.position.top - i.dimensions.height)
                      : (n.top = this.cache.mouse.y - i.dimensions.height),
                    (l.y = "bottom"));
                n.left < 0 && ((n.left = e.left), (l.x = !1));
                n.top < 0 && ((n.top = e.top), (l.y = !1));
                !1 !== this.options.style.tip.corner &&
                  ((n.corner = new String(i.corner)),
                  !1 !== l.x &&
                    (n.corner = n.corner.replace(/Left|Right|Middle/, l.x)),
                  !1 !== l.y &&
                    (n.corner = n.corner.replace(/top|bottom/, l.y)),
                  n.corner !== this.elements.tip.attr("rel") &&
                    s.call(this, n.corner));
                return n;
              }.call(d, h, n, r)),
            "mouse" === d.options.position.target &&
              !0 === d.options.position.adjust.mouse &&
              ((f =
                !0 === d.options.position.adjust.screen && d.elements.tip
                  ? d.elements.tip.attr("rel")
                  : d.options.position.corner.tooltip),
              (h.left += -1 !== f.search(/right/i) ? -6 : 6),
              (h.top += -1 !== f.search(/bottom/i) ? -6 : 6)),
            !d.elements.bgiframe &&
              t.browser.msie &&
            ...
            ((d.cache.position = h),
              !0 === o
                ...
                : d.elements.tooltip.css(h),
              d.onPositionUpdate.call(d, e),
              void 0 !== e &&
                e.type &&
                "mousemove" !== e.type &&
          ...
          return d.status.rendered
            ? e && "number" != typeof e
              ...
              : ((o = d.elements.contentWrapper
                  .siblings()
                  .add(d.elements.tip)
                  .add(d.elements.button)),
                e ||
                  ("number" == typeof d.options.style.width.value
                    ? (e = d.options.style.width.value)
                    : (d.elements.tooltip.css({ width: "auto" }),
                      o.hide(),
                      t.browser.msie &&
                        d.elements.wrapper
                          .add(d.elements.contentWrapper.children())
                          .css({ zoom: "normal" }),
                      (e = d.getDimensions().width + 1),
                      d.options.style.width.value ||
                        (e > d.options.style.width.max &&
                          (e = d.options.style.width.max),
                        e < d.options.style.width.min &&
                          (e = d.options.style.width.min)))),
                e % 2 != 0 && (e -= 1),
                d.elements.tooltip.width(e),
                o.show(),
                d.options.style.border.radius &&
                  d.elements.tooltip
                    .find(".qtip-betweenCorners")
                    .each(function (o) {
                      t(this).width(e - 2 * d.options.style.border.radius);
                    }),
                t.browser.msie &&
                  (d.elements.wrapper
                    .add(d.elements.contentWrapper.children())
                    .css({ zoom: "1" }),
                  d.elements.wrapper.width(e),
                  d.elements.bgiframe &&
                    d.elements.bgiframe
                      .width(e)
                      .height(d.getDimensions.height)),
                t.fn.qtip.log.error.call(
                  d,
                  1,
        ...
        updateStyle: function (e) {
          var o, s, r, p;
          return d.status.rendered
            ? "string" == typeof e && t.fn.qtip.styles[e]
              ? ((d.options.style = a.call(
                ...
                !1 !== d.options.content.title.text &&
                  d.elements.title.css(l(d.options.style.title, !0)),
                d.elements.contentWrapper.css({
                  borderColor: d.options.style.border.color,
                }),
                !1 !== d.options.style.tip.corner &&
                  (t("<canvas>").get(0).getContext
                    ? ((o = d.elements.tooltip.find(".qtip-tip canvas:first")),
                      o.get(0).getContext("2d").clearRect(0, 0, 300, 300),
                      (p = h(
                ...
                d.options.style.border.radius > 0 &&
                  ...
                  t("<canvas>").get(0).getContext
                    ? ((s = c(d.options.style.border.radius)),
                      d.elements.tooltip
                        ...
                        .each(function () {
                          (t(this)
                            ...
                            (r = t(this).parent("div[rel]:first").attr("rel")),
                            i.call(
                              d,
                              t(this),
                              s[r],
        ...
        updateContent: function (e, o) {
          ...
          return (
            ...
            e.jquery && e.length > 0
              ? e.clone(!0).appendTo(d.elements.content).show()
              : d.elements.content.html(e),
            (s = d.elements.content.find("img[complete=false]")).length > 0
              ? ((n = 0),
                s.each(function (e) {
        ...
        updateTitle: function (e) {
          ...
          return !1 === d.beforeTitleUpdate.call(d)
            ? d
            : (d.elements.button &&
                (d.elements.button = d.elements.button.clone(!0)),
              d.elements.title.html(e),
              d.elements.button && d.elements.title.prepend(d.elements.button),
        ...
        focus: function (e) {
          ...
          if (
            ...
            (i = 6e3 + t("div.qtip[qtip]").length - 1),
            ...
            (t("div.qtip[qtip]")
              ...
              .each(function () {
                !0 === t(this).qtip("api").status.rendered &&
                  ("number" == typeof (s = parseInt(t(this).css("z-index"))) &&
                    s > -1 &&
                    t(this).css({
                      zIndex: parseInt(t(this).css("z-index")) - 1,
                    }),
                  (t(this).qtip("api").status.focused = !1));
              }),
              d.elements.tooltip.css({ zIndex: i }),
              (d.status.focused = !0),
              d.onFocus.call(d, e),
              t.fn.qtip.log.error.call(
                d,
        ...
        destroy: function () {
          var e, o;
          if (!1 === d.beforeDestroy.call(d)) return d;
          if (
            (d.status.rendered
            ...
            "object" == typeof d.elements.target.data("qtip") &&
              "object" ==
                typeof (o = d.elements.target.data("qtip").interfaces) &&
              o.length > 0)
          )
            for (e = 0; e < o.length - 1; e++)
              o[e].id == d.id && o.splice(e, 1);
          return (
            delete t.fn.qtip.interfaces[d.id],
            "object" == typeof o && o.length > 0
              ? (d.elements.target.data("qtip").current = o.length - 1)
        ...
        getPosition: function () {
          var e, o;
          return d.status.rendered
            ? ((e = "none" === d.elements.tooltip.css("display")) &&
                d.elements.tooltip.css({ visiblity: "hidden" }).show(),
              (o = d.elements.tooltip.offset()),
              e && d.elements.tooltip.css({ visiblity: "visible" }).hide(),
              o)
            : t.fn.qtip.log.error.call(
                d,
                2,
        ...
        getDimensions: function () {
          var e, o;
          return d.status.rendered
            ? ((e = !d.elements.tooltip.is(":visible")) &&
                d.elements.tooltip.css({ visiblity: "hidden" }).show(),
              (o = {
                height: d.elements.tooltip.outerHeight(),
                width: d.elements.tooltip.outerWidth(),
              }),
              e && d.elements.tooltip.css({ visiblity: "visible" }).hide(),
              o)
            : t.fn.qtip.log.error.call(
  ...
  function o() {
    ...
    (this.beforeRender.call(this),
      ...
      (this.elements.tooltip =
        ...
        this.options.style.classes.content +
        '"></div></div></div></div>'),
      (this.elements.tooltip = t(this.elements.tooltip)),
      ...
      (this.elements.contentWrapper = this.elements.wrapper
        .children("div:first")
        .css({ background: this.options.style.background })),
      (this.elements.content = this.elements.contentWrapper
        .children("div:first")
        .css(l(this.options.style))),
      t.browser.msie &&
        this.elements.wrapper.add(this.elements.content).css({ zoom: 1 }),
      "unfocus" == this.options.hide.when.event &&
        this.elements.tooltip.attr("unfocus", !0),
      "number" == typeof this.options.style.width.value && this.updateWidth(),
      t("<canvas>").get(0).getContext || t.browser.msie
        ? (this.options.style.border.radius > 0
            ? function () {
                var e, o, s, n, r, l, p, a, h, d, f, u, m, g, w;
                for (o in ((e = this).elements.wrapper
                  .find(".qtip-borderBottom, .qtip-borderTop")
                  .remove(),
                (s = e.options.style.border.width),
                (n = e.options.style.border.radius),
                (r = e.options.style.border.color || e.options.style.tip.color),
                (l = c(n)),
                (p = {}),
                l))
                  ((p[o] =
            ...
            : this.elements.contentWrapper.css({
                border:
                  this.options.style.border.width +
                  "px solid " +
                  this.options.style.border.color,
              }),
          !1 !== this.options.style.tip.corner && s.call(this))
        : (this.elements.contentWrapper.css({
            border:
              this.options.style.border.width +
              "px solid " +
          ...
          (this.options.style.border.radius = 0),
          (this.options.style.tip.corner = !1),
          t.fn.qtip.log.error.call(
            this,
            2,
        ...
        function () {
          ...
          !1 !== e.options.content.title.button &&
            ...
            (e.elements.button = t(
              ...
              .prependTo(e.elements.title)
              .click(function (t) {
                e.status.disabled || e.hide(t);
              }));
        }.call(this),
      ...
      function () {
        ...
        if ("inactive" == e.options.hide.when.event) {
          ...
          !0 === e.options.hide.fixed &&
            e.elements.tooltip.on("mouseover.qtip", function () {
              !0 !== e.status.disabled && clearTimeout(e.timers.hide);
            });
        function r(o) {
          !0 !== e.status.disabled &&
        ...
        function l(o) {
          if (!0 !== e.status.disabled) {
            if (
              !0 === e.options.hide.fixed &&
              -1 !== e.options.hide.when.event.search(/mouse(out|leave)/i) &&
              t(o.relatedTarget).parents("div.qtip[qtip]").length > 0
            )
              return (
                o.stopPropagation(),
                o.preventDefault(),
        ...
        (1 ===
          e.options.show.when.target.add(e.options.hide.when.target).length &&
          e.options.show.when.event == e.options.hide.when.event &&
          "inactive" !== e.options.hide.when.event) ||
        "unfocus" == e.options.hide.when.event
          ? ((e.cache.toggle = 0),
            o.on(e.options.show.when.event + ".qtip", function (t) {
              0 == e.cache.toggle ? r(t) : l(t);
            }))
          : (o.on(e.options.show.when.event + ".qtip", r),
            "inactive" !== e.options.hide.when.event &&
              i.on(e.options.hide.when.event + ".qtip", l));
        -1 !== e.options.position.type.search(/(fixed|absolute)/) &&
          e.elements.tooltip.on("mouseover.qtip", e.focus);
      ...
      !1 !== this.options.content.url &&
        ((o = this.options.content.url),
        (n = this.options.content.data),
        (r = this.options.content.method || "get"),
        this.loadContent(o, n, r)),
  ...
  function s(e) {
    ...
    (null !== this.elements.tip && this.elements.tip.remove(),
      ...
      !1 !== this.options.style.tip.corner &&
        ...
        (this.elements.tip =
          '<div class="' +
          this.options.style.classes.tip +
          '" dir="ltr" rel="' +
          e +
        ...
        t("<canvas>").get(0).getContext
          ...
          : t.browser.msie &&
            ...
            (this.elements.tip +=
              ...
              (-1 !== e.search(/top/) ? "bottom" : "top") +
              '"></v:shape>'),
            (this.elements.tip +=
              '<v:image style="behavior:url(#default#VML);"></v:image>'),
            this.elements.contentWrapper.css("position", "relative")),
        this.elements.tooltip.prepend(this.elements.tip + "</div>"),
        (this.elements.tip = this.elements.tooltip
          .find("." + this.options.style.classes.tip)
          .eq(0)),
        t("<canvas>").get(0).getContext &&
          n.call(this, this.elements.tip.find("canvas:first"), i, o),
        -1 !== e.search(/top/) &&
          t.browser.msie &&
          6 === parseInt(t.browser.version.charAt(0)) &&
  ...
  function r(e) {
    ...
    !1 !== this.options.style.tip.corner &&
      this.elements.tip &&
      (e || (e = this.elements.tip.attr("rel")),
      (o = positionAdjust = t.browser.msie ? 1 : 0),
      this.elements.tip.css(e.match(/left|right|top|bottom/)[0], 0),
      -1 !== e.search(/top|bottom/)
        ? (t.browser.msie &&
            (6 === parseInt(t.browser.version.charAt(0))
              ? (positionAdjust = -1 !== e.search(/top/) ? -3 : 1)
              : (positionAdjust = -1 !== e.search(/top/) ? 1 : 2)),
          -1 !== e.search(/Middle/)
      ...
      (i = "padding-" + e.match(/left|right|top|bottom/)[0]),
      (s =
        this.options.style.tip.size[
          -1 !== i.search(/left|right/) ? "width" : "height"
        ]),
      this.elements.tooltip.css("padding", 0),
      this.elements.tooltip.css(i, s),
      t.browser.msie &&
        6 == parseInt(t.browser.version.charAt(0)) &&
        ((n = parseInt(this.elements.tip.css("margin-top")) || 0),
        (n += parseInt(this.elements.content.css("margin-top")) || 0),
        this.elements.tip.css({ marginTop: n })));
  }
  function l(e, o) {
    var i, s;
    for (s in (i = t.extend(!0, {}, e)))
      !0 === o && -1 !== s.search(/(tip|classes)/i)
        ? delete i[s]
        : o ||
          -1 === s.search(/(width|border|tip|title|classes|user)/i) ||
          delete i[s];
    return i;
  }
  function p(t) {
    return (
      "object" != typeof t.tip && (t.tip = { corner: t.tip }),
      "object" != typeof t.tip.size &&
        (t.tip.size = { width: t.tip.size, height: t.tip.size }),
      "object" != typeof t.border && (t.border = { width: t.border }),
      "object" != typeof t.width && (t.width = { value: t.width }),
      "string" == typeof t.width.max &&
        (t.width.max = parseInt(t.width.max.replace(/([0-9]+)/i, "$1"))),
      "string" == typeof t.width.min &&
        (t.width.min = parseInt(t.width.min.replace(/([0-9]+)/i, "$1"))),
      "number" == typeof t.tip.size.x &&
        ((t.tip.size.width = t.tip.size.x), delete t.tip.size.x),
      "number" == typeof t.tip.size.y &&
        ((t.tip.size.height = t.tip.size.y), delete t.tip.size.y),
      t
    );
  }
  function a() {
    ...
    return (
      ...
      !0 === s.tip.corner &&
        (s.tip.corner =
          "center" !== this.options.position.corner.tooltip &&
  ...
  function h(t, e, o) {
    ...
    return (
      (i.leftTop = i.bottomRight),
      (i.rightTop = i.bottomLeft),
      (i.leftBottom = i.topRight),
      (i.rightBottom = i.topLeft),
      i[t]
    );
  }
  function c(e) {
  ...
  ((t.fn.qtip = function (i, s) {
    ...
    if ("string" == typeof i) {
      ...
      (i || (i = {}),
        ...
        "object" != typeof i.content.title &&
          (i.content.title = { text: i.content.title }),
        "object" != typeof i.position && (i.position = { corner: i.position }),
        "object" != typeof i.position.corner &&
          (i.position.corner = {
            target: i.position.corner,
            tooltip: i.position.corner,
          }),
        "object" != typeof i.show && (i.show = { when: i.show }),
        "object" != typeof i.show.when &&
          (i.show.when = { event: i.show.when }),
        "object" != typeof i.show.effect &&
          (i.show.effect = { type: i.show.effect }),
        "object" != typeof i.hide && (i.hide = { when: i.hide }),
        "object" != typeof i.hide.when &&
          (i.hide.when = { event: i.hide.when }),
        "object" != typeof i.hide.effect &&
          (i.hide.effect = { type: i.hide.effect }),
        "object" != typeof i.style && (i.style = { name: i.style }),
        (i.style = p(i.style)),
      ...
      if ("string" == typeof i) {
        ...
        for (
          (f = t.extend(!0, {}, h)).hide.effect.length = h.hide.effect.length,
            f.show.effect.length = h.show.effect.length,
            !1 === f.position.container &&
              (f.position.container = t(document.body)),
            !1 === f.position.target && (f.position.target = t(this)),
            !1 === f.show.when.target && (f.show.when.target = t(this)),
            !1 === f.hide.when.target && (f.hide.when.target = t(this)),
            r = t.fn.qtip.interfaces.length,
            n = 0;
          n < r;
          n++
        )
          if (void 0 === t.fn.qtip.interfaces[n]) {
            r = n;
            break;
          }
        ((c = new e(t(this), f, r)),
          ...
          "object" == typeof t(this).data("qtip")
            ? (void 0 === t(this).attr("qtip") &&
                (t(this).data("qtip").current =
                  t(this).data("qtip").interfaces.length),
              t(this).data("qtip").interfaces.push(c))
            : t(this).data("qtip", { current: 0, interfaces: [c] }),
          !1 === f.content.prerender &&
          !1 !== f.show.when.event &&
          !0 !== f.show.ready
            ? f.show.when.target.on(
      ...
      ((t.fn.qtip.cache = {
          ...
          (clearTimeout(e),
            (e = setTimeout(function () {
              "scroll" === o.type
                ...
                : ((t.fn.qtip.cache.screen.width = t(window).width()),
                  (t.fn.qtip.cache.screen.height = t(window).height()));
              for (let i = 0; i < t.fn.qtip.interfaces.length; i++) {
                var e = t.fn.qtip.interfaces[i];
                !0 === e.status.rendered &&
                  ("static" !== e.options.position.type ||
                    (e.options.position.adjust.scroll && "scroll" === o.type) ||
                    (e.options.position.adjust.resize &&
                      "resize" === o.type)) &&
        ...
        t(document).on("mousedown.qtip", function (e) {
          0 === t(e.target).parents("div.qtip").length &&
            t(".qtip[unfocus]").each(function () {
              var o = t(this).qtip("api");
              t(this).is(":visible") &&
                !o.status.disabled &&
