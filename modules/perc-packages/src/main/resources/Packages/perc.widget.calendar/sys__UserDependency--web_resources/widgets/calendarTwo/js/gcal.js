  ...
  (o.sourceNormalizers.push(function (e) {
    ...
    o.sourceFetchers.push(function (n, l, t, d) {
      if (n.googleCalendarId)
        return (function (n, l, t, d, c) {
          var i,
            s,
            u =
              a +
              "/" +
              encodeURIComponent(n.googleCalendarId) +
              "/events?callback=?",
            g = n.googleCalendarApiKey || c.options.googleCalendarApiKey,
            p = n.success;
          function m(a, r) {
            var l = r || [{ message: a }];
            ...
            e.extend({}, n, {
              ...
              success: function (a) {
                var o,
                  ...
                  l = [];
                if (a.error)
                  m("Google Calendar API: " + a.error.message, a.error.errors);
                else if (
                  a.items &&
