...
(function ($) {
    ...
    $.extend(self, self.options.api, {
        ...
        if (typeof self.options.show.effect.type == "function") {
          ...
          switch (self.options.show.effect.type.toLowerCase()) {
            case "fade":
              ...
              break;
            case "slide":
              self.elements.tooltip.slideDown(
                self.options.show.effect.length,
                function () {
                  afterShow();
                  if (self.options.position.type !== "static")
      ...
      updatePosition: function (event, animate) {
        ...
        if (self.options.position.target !== "mouse") {
          ...
          if (
            self.options.position.target.get(0).nodeName.toLowerCase() == "area"
          ) {
          ...
          // Target is the document
            ...
            self.options.position.target.add(document.body).length === 1
          ) {
            target.position = {
          ...
          // Target is a regular HTML element, find position normally
            ...
            if (
              typeof self.options.position.target.attr("qtip") !== "undefined"
            )
              target.position =
        ...
        ie6Adjust =
          $.browser.msie && parseInt($.browser.version.charAt(0)) === 6 ? 1 : 0; // ...and even more so IE6!
        ...
        if (ieAdjust) {
          if (tooltip.corner.search(/top/) !== -1) newPosition.top -= ieAdjust;
          else if (tooltip.corner.search(/bottom/) !== -1)
        ...
        if (
          self.options.position.target === "mouse" &&
        ...
        if (
          ...
          $("select, object").each(function () {
            ...
            if (
              newPosition.top + tooltip.dimensions.height >= offset.top &&
        ...
        if (
          newPosition.left != curPosition.left ||
      ...
      updateWidth: function (newWidth) {
        ...
        hidden = self.elements.contentWrapper
          .siblings()
          .add(self.elements.tip)
          .add(self.elements.button);
          ...
          // No width is set, proceed with auto detection
            ...
            if ($.browser.msie)
              self.elements.wrapper
                .add(self.elements.contentWrapper.children())
                .css({ zoom: "normal" });
        ...
        if ($.browser.msie) {
          ...
          if (self.elements.bgiframe)
            self.elements.bgiframe
              .width(newWidth)
              .height(self.getDimensions.height);
        }
      ...
      updateStyle: function (name) {
        ...
        if (self.options.style.border.radius > 0) {
          self.elements.tooltip
            ...
            .css({ backgroundColor: self.options.style.border.color });
  ...
  function construct() {
    ...
    self.elements.contentWrapper = self.elements.wrapper
      .children("div:first")
      .css({ background: self.options.style.background });
    self.elements.content = self.elements.contentWrapper
      .children("div:first")
    ...
    if ($("<canvas>").get(0).getContext || $.browser.msie) {
      ...
      if (self.options.style.border.radius > 0) createBorder.call(self);
        ...
        self.elements.contentWrapper.css({
          border:
            self.options.style.border.width +
            "px solid " +
            self.options.style.border.color,
        });
    ...
    if (
      (typeof self.options.content.text == "string" &&
    ...
    // Use title string for content if present
      ...
      typeof self.elements.target.attr("title") == "string" &&
    ...
    // No title is present, use alt attribute instead
      ...
      typeof self.elements.target.attr("alt") == "string" &&
    ...
    for (i in coordinates) {
      ...
      // No canvas, but if it's IE use VML
        ...
        containers[i] +=
          ...
          "px; " +
          "margin-left:" +
          (i.search(/Right/) !== -1 ? coordinates[i][2] - 3.5 : -1) +
          "px; " +
  ...
  function createTip(corner) {
    ...
    self.elements.tip =
      '<div class="' +
      self.options.style.classes.tip +
      '" dir="ltr" rel="' +
      corner +
    ...
    self.elements.tip = self.elements.tooltip
      .find("." + self.options.style.classes.tip)
      .eq(0);
    if ($("<canvas>").get(0).getContext)
      drawTip.call(
        self,
  ...
  function positionTip(corner) {
    ...
    paddingSize =
      self.options.style.tip.size[
        paddingCorner.search(/left|right/) !== -1 ? "width" : "height"
      ];
  ...
  function createTitle() {
    ...
    if (
      self.options.content.title.button !== false &&
  ...
  function assignEvents() {
    ...
    if (
      (self.options.show.when.target.add(self.options.hide.when.target)
        .length === 1 &&
  ...
  function screenAdjust(position, target, tooltip) {
    ...
    overflow = {
      ...
      right:
        adjustedPosition.left + tooltip.dimensions.width + 2 >=
        $.fn.qtip.cache.screen.width + $.fn.qtip.cache.screen.scroll.left,
      top: adjustedPosition.top < $.fn.qtip.cache.screen.scroll.top,
      bottom:
        adjustedPosition.top + tooltip.dimensions.height + 2 >=
        $.fn.qtip.cache.screen.height + $.fn.qtip.cache.screen.scroll.top,
    };
    ...
    adjust = {
      left:
        overflow.left &&
        (tooltip.corner.search(/right/i) != -1 ||
          (tooltip.corner.search(/right/i) == -1 && !overflow.right)),
      right:
        overflow.right &&
        (tooltip.corner.search(/left/i) != -1 ||
  ...
  function jQueryStyle(style, sub) {
    ...
    for (i in styleObj) {
      if (sub === true && i.search(/(tip|classes)/i) !== -1) delete styleObj[i];
      else if (
        !sub &&
  ...
  function buildStyle() {
    ...
    if (finalStyle.tip.corner === true)
      finalStyle.tip.corner =
        self.options.position.corner.tooltip === "center"
          ? false
  ...
  function bgiframe() {
    ...
    self.elements.bgiframe = self.elements.wrapper
      .prepend(html)
