...
(function ($) {
  ...
  $.PercFormFieldPref = {
    REQUIRED: {
      ...
      addControl: function (container, vals, defaults) {
        var checked = "";
        if (
          (typeof vals === "object" && vals["perc-field-required"]) ||
          defaults["DISABLED"] === "TRUE" ||
          (vals === undefined && defaults["CHECKED"] === "TRUE")
        ) {
    ...
    NAME: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          I18N.message("perc.ui.widgets.commentsForm@Name") +
          " <input type='text' class='perc-pref-text perc-pref-text-longer' value='" +
          nameValue +
    ...
    TITLE: {
      ...
      addControl: function (container, vals, defaults) {
        ...
        var out =
          "<div class='perc-pref-entry'>" +
          I18N.message("perc.ui.widgets.commentsForm@Title") +
          " <input type='text' class='perc-pref-text perc-pref-text-longer' value='" +
          titleValue +
    ...
    titleControlAPI.getAvailablePrefs = function () {
      return [
        { pref: $.PercFormFieldPref.REQUIRED, defaults: { DISABLED: "FALSE" } },
        {
          ...
          defaults: { "perc-field-max-char-value": 255 },
        },
        {
  ...
  $.PercHoneypotFieldControl = function () {
    ...
    honeypotControlAPI.getAvailablePrefs = function () {
      return [{ pref: $.PercFormFieldPref.CLASS }];
    };
      ...
      return [
        {
          ...
          defaults: { DISABLED: "FALSE", CHECKED: "TRUE" },
        },
        {
          pref: $.PercFormFieldPref.MAX_CHAR,
          defaults: { "perc-field-max-char-value": 255 },
  ...
  $.PercTextareaFieldControl = function () {
    ...
    textareaControlAPI.getAvailablePrefs = function () {
      return [
        ...
        {
          pref: $.PercFormFieldPref.MAX_CHAR,
          defaults: { "perc-field-max-char-value": 4000 },
        },
  ...
  $.PercTextFieldControl = function () {
    ...
    textControlAPI.getRenderedField = function (fieldData) {
      var renderedHtml = $("<div/>")
        .addClass($.PercFormConstants.FIELD_ROW_CLASS)
        .append($("<span/>").html(fieldData.label));
      var prefs = this.getAvailablePrefs();
      for (var i = 0; i < prefs.length; i++) {
        prefs[i].pref.onRender(
  ...
  $.PercURLFieldControl = function () {
    ...
    urlControlAPI.getAvailablePrefs = function () {
      return [
        ...
        {
          pref: $.PercFormFieldPref.MAX_CHAR,
          defaults: { "perc-field-max-char-value": 2000 },
        },
        {
          pref: $.PercFormFieldPref.WIDTH,
          defaults: { "perc-field-width-value": 150 },
  ...
  $.PercSubmitButtonControl = function () {
    ...
    submitButtonControlAPI.getRenderedField = function (fieldData) {
      var renderedHtml = $("<div/>")
        .addClass($.PercFormConstants.FIELD_ROW_CLASS)
        .append($("<input/>").attr("type", "submit").val(fieldData.label));
   ...
   */
  $.PercFieldTypes = [];
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_TITLE] =
    $.PercTitleFieldControl;
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_USER] =
    $.PercUserFieldControl;
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_EMAIL] =
  ...
  $.PercFieldTypes[$.PercFormConstants.FIELD_CONTROL_URL] =
    $.PercURLFieldControl;
