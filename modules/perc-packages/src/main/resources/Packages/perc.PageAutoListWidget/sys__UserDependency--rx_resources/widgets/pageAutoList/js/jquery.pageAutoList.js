...
function buildQuery() {
  ...
  if (p_titlecontains != null && p_titlecontains != "") {
    p_query +=
      queryOp + "rx:resource_link_title like '%" + p_titlecontains + "%'";
    queryOp = " and ";
  }
...
(function ($) {
  ...
  $.fn.pageAutoListControl = function (settings) {
    ...
    function populateTemplateTypes(siteName, pageTemplatesOptionsArray) {
      ...
      $(".ui-perc-pageautolist-pagetypes")
        .empty()
    ...
    function populateCategories(siteName, pageCategoriesOptionsArray) {
      ...
      var treeSrcUrl =
        "../percPageSupport/getCategories.xml?sitename=" + siteName;
      var readonly = false;
    ...
    function showCategories() {
      ...
      if (typeof $('[name="page_category_list"]').val() != "undefined") {
        pageCategoriesOptionsArray = $('[name="page_category_list"]')
          .val()
          .split(",");
      }
    ...
    $('[name="perc-pageautolist-hide-past-results-date-type"]').on(
      "change",
      function () {
