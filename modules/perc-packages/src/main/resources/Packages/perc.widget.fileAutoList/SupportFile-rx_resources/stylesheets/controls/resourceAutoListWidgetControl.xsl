...
<xsl:stylesheet version="1.1"
	...
	<psxctl:ControlMeta
		name="resourceAutoListWidgetControl" dimension="single"
		choiceset="none">
		<psxctl:Description>The control for building the JCR query for the
			Resource Auto List Widget:</psxctl:Description>
		<psxctl:ParamList>
		</psxctl:ParamList>
		...
		<psxctl:AssociatedFileList>
			<psxctl:FileDescriptor
				name="jquery-ui-1.8.9.custom.css" type="css" mimetype="text/css">
			...
			<psxctl:FileDescriptor
				name="jquery.resourceAutoList.css" type="css" mimetype="text/css">
	...
	<xsl:template
		match="Control[@name='resourceAutoListWidgetControl']"
		mode="psxcontrol">
		<xsl:variable name="contentTypeName">
			<xsl:choose>
				<xsl:when test="ParamList/Param[@name='contentTypeName']">
					<xsl:value-of
						select="ParamList/Param[@name='contentTypeName']" />
				</xsl:when>
			</xsl:choose>
		</xsl:variable>
		<script>
			var percAssetContentTypeName = '
			...
			*********************************************************************
			...
			'/rx_resources/controls/percResourceAutoListControl/images/calendar.gif',
			buttonImageOnly: true, altFormat: 'yy-mm-dd'
			});
							...
							<td>
								<span class="autolistlabel">
									<label for="perc-folder-selector"
										style="font-weight:bold">Asset library location:</label>
								</span>
							</td>
						</tr>
						<tr>
	...
	<xsl:template
		match="Control[@name='resourceAutoListWidgetControl' and @isReadOnly='yes']"
			...
			<div id="criteria_for_list">
				...
				<input type="hidden" id="perc_asset_library_path">
					<xsl:attribute name="value"><xsl:value-of
						select="//DisplayField/Control[@paramName='asset_library_path']/Value" /></xsl:attribute>
				</input>
