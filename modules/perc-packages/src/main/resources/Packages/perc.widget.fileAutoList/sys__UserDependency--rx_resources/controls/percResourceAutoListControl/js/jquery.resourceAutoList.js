...
/**
 *    jquery.resourceAutoListControl.js
 *
 *    Java Script code for the control resourceAutoListWidgetControl used by the ResourceAutoListWidget
 *     This control used to build the JCR query for the Resource Auto List widget, based on
...
function buildQuery() {
  ...
  var p_query =
    "select rx:sys_contentid, rx:sys_folderid from rx:" +
    percAssetContentTypeName +
    " ";
 ...
 */
(function ($) {
  $.fn.resourceAutoListControl = function (settings) {
    var config = {};
