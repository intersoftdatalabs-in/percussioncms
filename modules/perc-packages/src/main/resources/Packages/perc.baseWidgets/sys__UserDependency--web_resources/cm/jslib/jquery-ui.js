(!(function (t) {
  "function" == typeof define && define.amd
    ? define("ui/version.js", ["jquery"], t)
    : t(jQuery);
})(function (t) {
  return ((t.ui = t.ui || {}), (t.ui.version = "@VERSION"));
}),
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/data", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/disable-selection", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
    return t.fn.extend({
      disableSelection:
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ? define("ui/vendor/jquery-color/jquery.color.js", ["jquery"], e)
      ...
      return (
        ...
        d(a, function (t, i) {
          ...
          if (r)
            return (
              (o = s[h](r)),
              (s[l[h].cache] = o[l[h].cache]),
              (n = s._rgba = o._rgba),
              !1
            );
        }),
        n.length
          ? ("0,0,0,0" === n.join() && t.extend(n, i.transparent), s)
          : i[e]
      );
    }
    function m(t, e, i) {
    ...
    ((c.style.cssText = "background-color:rgba(1,1,1,.5)"),
      ...
      (r.fn = t.extend(r.prototype, {
        parse: function (s, n, o, a) {
          ...
          var h = this,
            ...
            c = (this._rgba = []);
          return (
            n !== e && ((s = [s, n, o, a]), (u = "array")),
            "string" === u
              ? this.parse(g(s) || i._default)
              : "array" === u
                ? (d(l.rgba.props, function (t, e) {
                    c[e.idx] = f(s[e.idx], e);
                  }),
                  this)
                : "object" === u
      ...
      (l.hsla.from = function (t) {
        ...
        var e = t[0] / 360,
          ...
          a = 2 * s - o;
        return [
          Math.round(255 * m(a, o, e + 1 / 3)),
          Math.round(255 * m(a, o, e)),
          Math.round(255 * m(a, o, e - 1 / 3)),
          n,
        ];
      }),
      d(l, function (t, i) {
        var s = i.props,
          ...
          l = i.from;
        ((r.fn[t] = function (t) {
          if ((a && !this[n] && (this[n] = a(this._rgba)), t === e))
            return this[n].slice();
          var i,
            o = p(t),
            h = "array" === o || "object" === o ? t : arguments,
            u = this[n].slice();
          return (
            d(s, function (t, e) {
              var i = h["object" === o ? t : e.idx];
              (null == i && (i = u[e.idx]), (u[e.idx] = f(i, e)));
            }),
            l ? (((i = r(l(u)))[n] = u), i) : r(u)
          );
        }),
            ...
            r.fn[e] ||
              (r.fn[e] = function (s) {
                ...
                return (
                  (a = (n =
                    this[
                      (l = "alpha" === e ? (this._hsla ? "hsla" : "rgba") : t)
                    ]())[i.idx]),
                  "undefined" === h
                    ? a
                    : ("function" === h && (h = p((s = s.call(this, a)))),
                      null == s && i.empty
                        ? this
                        : ("string" === h &&
                            (r = o.exec(s)) &&
                            (s =
                              a + parseFloat(r[2]) * ("+" === r[1] ? 1 : -1)),
                          (n[i.idx] = s),
                          this[l](n)))
                );
              });
          ...
          ((t.cssHooks[i] = {
            set: function (e, s) {
              var n,
                o,
                a = "";
              if ("transparent" !== s && ("string" !== p(s) || (n = g(s)))) {
                if (((s = r(n || s)), !u.rgba && 1 !== s._rgba[3])) {
                  for (
      ...
      (t.cssHooks.borderColor = {
        expand: function (t) {
          var e = {};
          return (
            d(["Top", "Right", "Bottom", "Left"], function (i, s) {
              e["border" + s + "Color"] = t;
            }),
            e
          );
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define(
          "ui/effect",
          ["jquery", "./vendor/jquery-color/jquery.color", "./version"],
          t,
        )
      : t(jQuery);
  })(function (t) {
          ...
          function (e, i) {
            t.fx.step[i] = function (t) {
              (("none" !== t.end && !t.setAttr) ||
                (1 === t.pos && !t.setAttr)) &&
                (s.style(t.elem, i, t.end), (t.setAttr = !0));
            };
          },
        ),
          t.fn.addBack ||
                ...
                c = function (e) {
                  ...
                  (s.data(i, !0),
                    ...
                    o &&
                      ("show" === n || (n === o && "hide" === n)) &&
                      s.show(),
                    (o && "none" === n) || t.effects.saveStyle(s),
                    "function" == typeof e && e());
                };
              if (t.fx.off || !n)
                return h
    ...
    return t.effects.define("bounce", function (e, i) {
      ...
      for (
        ...
        (((s = {})[m] = (_ ? "-=" : "+=") + c),
          ...
          (c = l ? 2 * c : c / 2));
      (l &&
        (((s = { opacity: 0 })[m] = (_ ? "-=" : "+=") + c), a.animate(s, f, g)),
        a.queue(i),
  ...
  (function (t) {
    ...
    return t.effects.define("explode", "hide", function (e, i) {
      ...
      function _() {
        (m.push(this),
          m.length === h * u &&
            (c.css({ visibility: "visible" }), t(m).remove(), i()));
      }
      for (s = 0; s < h; s++)
        for (a = p.top + s * g, l = s - (h - 1) / 2, n = 0; n < u; n++)
          ((o = p.left + n * f),
            (r = n - (u - 1) / 2),
            c
              .clone()
  ...
  (function (t) {
    ...
    return t.effects.define("fold", "hide", function (e, i) {
      ...
      (l && (r = (parseInt(l[1], 10) / 100) * g[a ? 0 : 1]),
        ...
        (f.clip[h[1]] = 0),
        o &&
          (s.cssClip(f.clip), c && c.css(t.effects.clipToBox(f)), (f.clip = d)),
        s
          .queue(function (i) {
            (c &&
              c
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define(
          ...
          ["jquery", "../version", "../effect", "./effect-size"],
          t,
        )
      : t(jQuery);
  })(function (t) {
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define(
          ...
          ["jquery", "../version", "../effect", "./effect-scale"],
          t,
        )
      : t(jQuery);
  })(function (t) {
  ...
  (function (t) {
    ...
    return (
      !1 !== t.uiBackCompat &&
        (e = t.effects.define("transfer", function (e, i) {
          t(this).transfer(e, i);
        })),
      e
    );
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/focusable", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
    return (
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/form.js", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/form-reset-mixin", ["jquery", "./form", "./version"], t)
      : t(jQuery);
  })(function (t) {
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/jquery-patch.js", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
    if (
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/keycode", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
    return (t.ui.keyCode = {
      BACKSPACE: 8,
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/labels", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/plugin", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
    return (t.ui.plugin = {
      add: function (e, i, s) {
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/position", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
    return (
      (function () {
            ...
            return (
              ...
              this.each(function () {
                var n,
                  ...
                  d = c(this, "marginLeft"),
                  _ = c(this, "marginTop"),
                  v = r + d + c(this, "marginRight") + k.width,
                  b = h + _ + c(this, "marginBottom") + k.height,
                  D = t.extend({}, m),
                  I = u(C.my, a.outerWidth(), a.outerHeight());
                ("right" === e.my[0]
                  ? (D.left -= r)
                  ...
                  e.using &&
                    (o = function (t) {
                      ...
                      (p < r && s(n + o) < p && (c.horizontal = "center"),
                        f < h && s(l + u) < f && (c.vertical = "middle"),
                        i(s(n), s(o)) > i(s(l), s(u))
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/safe-active-element", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/safe-blur", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/scroll-parent", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/tabbable", ["jquery", "./version", "./focusable"], t)
      : t(jQuery);
  })(function (t) {
    return t.extend(t.expr.pseudos, {
      tabbable: function (e) {
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/unique-id", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
    return t.fn.extend({
      uniqueId:
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/widget", ["jquery", "./version"], t)
      : t(jQuery);
  })(function (t) {
    var e,
      i = 0,
  ...
  (function (t) {
    "function" == typeof define && define.amd
      ? define("ui/widgets/controlgroup.js", ["jquery", "../widget"], t)
      : t(jQuery);
  })(function (t) {
    ...
    return t.widget("ui.controlgroup", {
      ...
      _resolveClassesValues: function (i, s) {
        ...
        return (
          t.each(i, function (t) {
            var o = s.options.classes[t] || "";
            ((o = String.prototype.trim.call(o.replace(e, ""))),
              (n[t] = (o + " " + i[t]).replace(/\s+/g, " ")));
          }),
          n
        );
      },
                ...
                ? this.length || "instance" !== i
                  ? this.each(function () {
                      ...
                      return "instance" === i
                        ? ((o = r), !1)
                        : r
                          ? "function" != typeof r[i] || "_" === i.charAt(0)
                            ? t.error(
                                "no such method '" +
                                  i +
                                  "' for button widget instance",
                              )
                            : (e = r[i].apply(r, n)) !== r && void 0 !== e
                  ...
                  : (o = void 0)
                : (n.length && (i = t.widget.extend.apply(null, [i].concat(n))),
                  this.each(function () {
  ...
  (function (t) {
    ...
    return (
      t.extend(t.ui, { datepicker: { version: "@VERSION" } }),
      t.extend(i.prototype, {
        ...
        _updateDatepicker: function (i) {
          ...
          var s,
            ...
            a = o[1],
            r = i.dpDiv.find("." + this._dayOverClass + " a");
          ...
          for (
            e.drawMonth = tt,
              ...
              s = K
                ? this.formatDate(
                    s,
                    this._daylightSavingAdjust(new Date(et, tt - X, 1)),
              ...
              n = this._canAdjustMonth(e, -1, et, tt)
                ? t("<a>")
                    ...
                    .append(
                      t("<span>")
                        .addClass(
                          "ui-icon ui-icon-circle-triangle-" + (Y ? "e" : "w"),
                        )
                        .text(s),
                    )[0].outerHTML
                : V
              ...
              a = this._canAdjustMonth(e, 1, et, tt)
                ? t("<a>")
                    ...
                    .append(
                      t("<span>")
                        .addClass(
                          "ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e"),
                        )
                        .text(o),
                    )[0].outerHTML
                : V
              ...
              l = this._get(e, "gotoCurrent") && e.currentDay ? G : q,
              r = K ? this.formatDate(r, l, this._getFormatConfig(e)) : r,
              h = "",
              e.inline ||
                (h = t("<button>")
                  .attr({
            ...
            for (C = "", this.maxRows = 4, D = 0; D < U[1]; D++) {
              if (
                ((I = this._daylightSavingAdjust(
              ...
              for (
                P +=
                  ...
                  T +
                  "'>" +
                  (/all|left/.test(T) && 0 === x ? (Y ? a : n) : "") +
                  (/all|right/.test(T) && 0 === x ? (Y ? n : a) : "") +
              ...
              for (
                P += S + "</tr></thead><tbody>",
                  ...
                  O = (this._getFirstDayOfMonth(et, tt) - c + 7) % 7,
                  z = Math.ceil((O + H) / 7),
                  A = $ && this.maxRows > z ? this.maxRows : z,
                  this.maxRows = A,
                  N = this._daylightSavingAdjust(new Date(et, tt, 1 - O)),
                  E = 0;
                E < A;
                E++
              ) {
                for (
                  ...
                  ((j = _
                    ...
                    (W +=
                      "<td class='" +
                      ((k + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") +
                      ...
                      (F && !v
                        ...
                        : R
                          ...
                          : "<a class='ui-state-default" +
                            ...
                            "' href='#' aria-current='" +
                            (N.getTime() === G.getTime() ? "true" : "false") +
                            "'>" +
                            N.getDate() +
                            "</a>") +
                      "</td>"),
        ...
        _generateMonthYearHeader: function (t, e, i, s, n, o, a, r) {
          var l,
            ...
            k = "";
          if (o || !m)
            k += "<span class='ui-datepicker-month'>" + a[e] + "</span>";
          else {
            for (
              l = s && s.getFullYear() === i,
                h = n && n.getFullYear() === i,
                  ...
                  r &&
                    (this.options.greedy &&
                      ...
                      (o = this.element
                        ...
                        .filter(function () {
                          return (
                            t(this).droppable("instance").options.scope === n
                          );
                        })).length &&
            ...
            this.selectees.each(function () {
              ...
              i &&
                ...
                "touch" === n.tolerance
                  ...
                  : "fit" === n.tolerance &&
                    (h =
                      u.left > o && u.right < r && u.top > a && u.bottom < l),
                h
                  ? (i.selected &&
    ...
    return t.widget("ui.sortable", t.ui.mouse, {
      ...
      _refreshItems: function (e) {
        ...
        for (i = c.length - 1; i >= 0; i--)
          for (a = c[i][1], s = 0, h = (r = c[i][0]).length; s < h; s++)
