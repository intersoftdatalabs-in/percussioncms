 ...
 * committed install Widget XML (batch A ship-exit #2883) materialize {@code
...
public final class PSPackageBuilder {
  ...
  private void buildPackage(Path packageDir, String dirName) throws IOException {
    ...
    try {
      ...
      // Step 1a: Modern-only widget packages → install Widget XML (#2883 batch A ship-exit)
   ...
   * definition XML (batch A ship-exit #2883).
   */
