 ...
 * against a local AsyncAPI 2 YAML file (no live spec fetch URLs or credentials).
 * A single PUBLISH light/measured operation assembles {@code 8.2/onLightMeasured-1.html}
 * (sole HTML home fallback). Publish chrome stays a later slice.
 *
