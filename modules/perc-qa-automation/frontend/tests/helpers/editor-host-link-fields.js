...
/**
 * Helpers for EditorHost link field save (#4753).
 *
...
const TEST_IDS = Object.freeze({
  ...
  fieldPage: "editor-field-page",
  fieldErrorPage: "editor-field-error-page",
  clearPage: "editor-link-clear-page",
});
...
function isItemFieldsPutUrl(url) {
  const u = String(url || "");
  return u.includes("/services/itemmanagement/item/fields/") && !u.includes("?");
}
