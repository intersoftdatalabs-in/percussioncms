...
/**
 * Helpers for EditorHost HTML field save (#4680).
 *
...
const TEST_IDS = Object.freeze({
  ...
  fieldText: "editor-field-text",
  fieldErrorText: "editor-field-error-text",
});
...
function isItemFieldsPutUrl(url) {
  const u = String(url || "");
  return (
    u.includes("/services/itemmanagement/item/fields/") &&
    !u.includes("?")
  );
}
