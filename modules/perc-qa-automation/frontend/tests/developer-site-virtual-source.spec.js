 ...
 * (#2956 / #3020 / #3300 / #3687 / #3697 / #3707 / epic #2678).
 *
 ...
 * save chrome, Build + Preview chrome for git-filesystem and csv-filesystem (never
 * repository), and Publish chrome for git-filesystem only (CSV publish is a later
 * slice). Also intercepts build REST to prove link-problem detail lines render on
 * HTTP 200 and publish REST to prove dest path + files copied on HTTP 200. Live
 * H2 QA deploys a CSV tree into the cell, asserts POST /virtual/build, then
 * Preview assembled site (GET /virtual/preview status + home HTML).
 *
