 ...
 * (#2956 / #3020 / #3300 / #3687 / #3697 / #3699 / #3707 / #3735 / #3759 / #3778 / #3796 / #3808 / #3820 / #3856 / #3868 / #3869 / #3870 / #3879 / #3927 / #3928 / #3931 / #3989 / #4115 / #4164 / epic #2678).
 *
 ...
 * Build chrome is shown after save for sitemap-xml (Preview/Publish stay hidden). Also intercepts build REST
 ...
 * (Preview/Publish chrome stay hidden; remoteUrl/credentials stay 400).
 *
...
test.describe("Developer Site Virtual Site source panel (#2956 / #3020)", () => {
  ...
  test("Sites detail shows Virtual Site source panel with repository default", async ({
    ...
    if (await page.locator('[data-testid="developer-site-virtual-form"]').isVisible()) {
      ...
      // Switch to sitemap-xml reveals root path + Build (no Git remotes, no Preview/Publish)
  ...
  test("sitemap-xml save PUTs envelope and GET-roundtrip persists with Build chrome (#4164)", async ({
    page,
  }) => {
    const pageErrors = [];
    page.on("pageerror", (err) => pageErrors.push(String(err)));
