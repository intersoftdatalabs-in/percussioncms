...
public interface IPSUnitTestConfigHelper {
  ...
  /**
   * Conn type for Rx server. Properties are extracted from conn_rxserver.properties file. The
   * location of which is expected in this same package com.percussion.testing.
   */
  public static final int CONN_TYPE_RXSERVER = 0;

  /**
   * Conn type for tomcat server. Properties are extracted from conn_tomcat.properties file. The
   * location of which is expected in this same package com.percussion.testing.
   */
  public static final int CONN_TYPE_TOMCAT = CONN_TYPE_RXSERVER + 1;

  /**
   * Conn type for Rx SQL server. Extracts DB props from Rx standard conn_sql.properties file. The
   * location of which is expected in this same package com.percussion.testing.
   */
  public static final int CONN_TYPE_SQL = CONN_TYPE_TOMCAT + 1;

  /**
   * Conn type for Rx ORA server. Extracts DB props from Rx standard conn_ora.properties file. The
   * location of which is expected in this same package com.percussion.testing.
   */
