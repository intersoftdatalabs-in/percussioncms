...
public class PSTomcatUtilsTest extends PSBaseXmlConfigTest {
  ...
  public void testLoadHttpConnectors() throws Exception {
    ...
    // try round-trip
    List<IPSConnector> connectors = PSTomcatUtils.loadHttpConnectors(srcServerDoc);
  ...
  public void testSaveHttpConnectors() throws Exception {
    ...
    List<IPSConnector> connectors1 = PSTomcatUtils.loadHttpConnectors(srcServerDoc);
    ...
    PSTomcatUtils.saveHttpConnectors(tgtServerDoc, connectors1);
    List<IPSConnector> connectors2 = PSTomcatUtils.loadHttpConnectors(tgtServerDoc);
    ...
    connectors2 = PSTomcatUtils.loadHttpConnectors(tgtServerDoc);
