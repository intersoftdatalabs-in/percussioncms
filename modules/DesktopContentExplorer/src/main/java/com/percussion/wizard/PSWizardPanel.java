...
public abstract class PSWizardPanel extends JPanel implements IPSWizardPanel {
  ...
  /**
   * By default we do not validate, must be overridden to implemment validation.
   *
  ...
  /**
   * By default we do not skip any wizard page, must be overridden to change this behavior.
   *
  ...
  /**
   * No default summary is available, must be overridden to return a page specific summary.
   *
