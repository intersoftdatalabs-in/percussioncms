...
public class PSContentCopyOptionsPage extends PSWizardPanel {
  ...
  public String getSummary() {
    ...
    if (m_asNewCopy.isSelected()) summary = m_asNewCopy.getText();
  ...
  private JPanel createMainPanel() {
    ...
    m_asNewCopy =
        new JRadioButton(
            PSI18NTranslationKeyValues.getInstance()
                .getTranslationValue(getClass().getName() + "@Copy Content as new copy"));
   ...
   * Get the panel data.
   *
   * @return the panel data as <code>PSContentCopyOptionsPage.OutputData</code> object, never <code>
   *     null</code>.
   */
  ...
  public class OutputData {
     ...
     *
     * @param isAsLink <code>true</code> if content will be copied as link, <code>false</code>
     *     otherwise.
     * @param isAsNewCopy <code>true</code> if content will be copied as new copy, <code>false
     *     </code> otherwise.
     */
    private OutputData(boolean isAsLink, boolean isAsNewCopy) {
      if (isAsLink && !isAsNewCopy) m_copyOption = AS_LINK;
      else if (isAsNewCopy && !isAsLink) m_copyOption = AS_NEW_COPY;
     ...
     *
     * @return the selected content copy option, one of <code>AS_LINK</code> or <code>AS_NEW_COPY
     *     </code> values.
     */
  ...
  /**
   * The radio button used to select the option to copy content as link. Initialized in {@link
   * createMainPanel()}, never <code>null</code> or changed after that.
   */
  private JRadioButton m_asLink = null;

  /**
   * The radio button used to select the option to copy content as new copy. Initialized in {@link
   * createMainPanel()}, never <code>null</code> or changed after that.
   */
