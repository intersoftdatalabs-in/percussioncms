...
public final class PSColumnWidthsOption implements IPSClientObjects {
   ...
   *
   * @param itemPath a string representing the key for the map to save the column width list for,
   ...
   *
   * @param itemPath a string representing the key for the map to remove the column width list for,
   *     must not be <code>null</code> or empty.
   */
