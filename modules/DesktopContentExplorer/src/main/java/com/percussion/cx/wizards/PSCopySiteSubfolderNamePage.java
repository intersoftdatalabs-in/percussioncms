...
public class PSCopySiteSubfolderNamePage extends PSWizardPanel {
  ...
  public void validatePanel() throws PSWizardValidationError {
      ...
      errors.append(
          "\t"
              + PSI18NTranslationKeyValues.getInstance()
                  .getTranslationValue(getClass().getName() + "@Site Subfolder name is required."));
    }
    ...
    if (m_input.getFolderNames().contains(folderName)) {
      ...
      errors.append(
          "\t"
              + PSI18NTranslationKeyValues.getInstance()
                  .getTranslationValue(getClass().getName() + "@Site Subfolder name is invalid."));
    }
  ...
  public String getSummary() {
    return PSI18NTranslationKeyValues.getInstance()
   ...
   * Get the panel data.
   *
   * @return the panel data as <code>PSCopySiteSubfolderNamePage.OutputData</code> object, never
   *     <code>null</code>.
   */
   ...
   *
   * @param data the data as <code>PSCopySiteSubfolderNamePage.InputData</code> object, not <code>
   *     null</code>.
   */
