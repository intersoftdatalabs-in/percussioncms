...
/**
 * The manager that listens to selection changes in the applet view panel and updates the menu
 * source that need to be informed of selection changes. In general the menu source of global menu
 * bar need to be informed of selection changes in applet.
 */
public class PSMenuManager implements IPSSelectionListener {
  ...
  /**
   * The menu source object that needs to be informed of selection changes in applet view panel,
   * initialized in the constructor and never <code>null
   * </code> after that.
   */
