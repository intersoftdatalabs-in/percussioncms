  ...
  public class Subject {
    ...
    public boolean equals(Object obj) {
      if (!(obj instanceof Subject)) return false;
        ...
        if (!((Subject) obj).getName().equals(getName())) return false;

        if (((Subject) obj).getSecurityProviderTypeId() != getSecurityProviderTypeId())
          return false;

        if (!((Subject) obj).getSecurityProviderInstance().equals(getSecurityProviderInstance()))
          return false;
