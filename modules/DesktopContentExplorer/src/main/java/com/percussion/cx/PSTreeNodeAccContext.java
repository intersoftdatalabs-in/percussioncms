...
/**
 * Implementation of {@link AccessibleContext} for a tree node. A context provides information for a
 * screen reader to read a component.
 */
public class PSTreeNodeAccContext extends AccessibleContext implements AccessibleText {
  /**
   * Initialized in the ctor, never <code>null</code> afterward. This field holds a reference to the
   * tree being used for the context.
   */
  private PSNavigationTree m_tree = null;

  /**
   * The node that this is a context for. Initialized in ctor, never <code>null</code> afterward.
   */
