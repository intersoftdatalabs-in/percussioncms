...
public class PSMenuSource {
   ...
   *
   * @param selection the default (navigational) selection for the menu, may not be <code>null
   *     </code>
   */
  ...
  /**
   * Gets the current context selection source. See {@link #setContextSource(PSSelection)} for more
   * information.
   *
   * @return the selection, may be <code>null</code>
   */
  ...
  /**
   * Sets the context selection source of the menu. Generally this should be called whereever the
   * selection changes (either in navigational or main display panel).
   *
  ...
  public void setContextSource(PSSelection contextSource) {
    if (contextSource == null) throw new IllegalArgumentException("contextSource may not be null.");

    m_contextSrc = contextSource;
  }

  /**
   * The selection for the menu actions for which this object is set as source. In general this is
   * the selection in navigational panel. <code>null</code> until <code>setSource(PSSelection)
   * </code> is called.
   */
  private PSSelection m_source = null;

  /**
   * The selection for the context menu actions for which this object is set as source. In general
   * this is the recent selection of navigational panel or main display panel selections. <code>null
   * </code> until <code>
