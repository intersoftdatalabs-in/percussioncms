...
/**
 * Map which stores items using SoftReference. Items can be garbage collected and removed. It is not
 * a general purpose cache, as it doesn't implement some methods, and others not according to the
 * map definition, to improve speed.
 *
