...
/** The class to imitate the clip board for copy and paste and also to support drag and drop. */
public class PSClipBoard {
  /** The default constructor. */
  public PSClipBoard() {}

  /**
   * Sets the list of nodes that are to remember or cache in clip board. Overwrites any content
   * (nodes) before in the clip board. The drag clip board should be used with a 'Drop' or
   * 'Drop-Paste', 'Drop-Move' actions. This cache should be cleared once drop actions are completed
   * by calling {@link #clearDragClip}.
   *
   * @param type the type of clip board, must be one of the <code>TYPE_DRAG
   * </code> or <code>TYPE_COPY</code>
   * @param clip the clip that contains the current selection with parent of clipped nodes, may not
   *     be <code>null</code>
   ...
   *
   * @param type the type of clip, must be one of the <code>TYPE_DRAG</code> or <code>TYPE_COPY
   *     </code> values.
   * @return the clipped/cached nodes, may be <code>null</code> if the clip is not set or cleared,
   *     never empty.
   ...
   * @param type the type of clip, must be one of the <code>TYPE_DRAG</code> or <code>TYPE_COPY
   *     </code> values.
   * @return the clipped/cached selection, may be <code>null</code> if the clip is not set or
   *     cleared.
   * @throws IllegalArgumentException if type is invalid.
   */
   ...
   * @param type the type of clip, must be one of the <code>TYPE_DRAG</code> or <code>TYPE_COPY
   *     </code> values.
   * @return the clipped nodes parent, may be <code>null</code> if the clip is not set or cleared.
   * @throws IllegalArgumentException if type is invalid.
   */
