...
(function (mod) {
  ...
  var Vim = function () {
    function lookupKey(e) {
      ...
      if (
        (mac && e.metaKey) ||
        (!hasModifier && e.shiftKey && key.length < 2)
      ) {
    ...
    function handleKeyPress(cm, e) {
      ...
      if (e.ctrlKey || e.metaKey || e.altKey || (e.shiftKey && code < 32)) {
        return;
      }
    ...
    var commandDispatcher = {
      ...
      evalInput: function (cm, vim) {
        ...
        var origHead = copyCursor(
          vim.visualMode ? sel.head : cm.getCursor("head")
        );
        var origAnchor = copyCursor(
          vim.visualMode ? sel.anchor : cm.getCursor("anchor")
        );
    ...
    var motions = {
      ...
      moveByParagraph: function (cm, head, motionArgs) {
        ...
        for (var i = 0; i < repeat; i++) {
          if (
            (!motionArgs.forward && line === cm.firstLine()) ||
    ...
    function expandWordUnderCursor(cm, inclusive, _forward, bigWord, noSymbol) {
      ...
      if (inclusive) {
        ...
        if (whitespacesAfterWord > 0) {
          ...
          var whitespacesBeforeWord =
            textBeforeWordStart.match(/^\s*/)[0].length;
          wordStart -= whitespacesBeforeWord;
        }
      }

      return { start: Pos(cur.line, wordStart), end: Pos(cur.line, wordEnd) };
    }
    ...
    function handleExternalSelection(cm, vim) {
      ...
      if (
        vim.visualMode &&
        cursorEqual(head, anchor) &&
        lineLength(cm, head.line) > head.ch
      ) {
