...
testJumplist("jumplist_?", ["?", "<C-o>"], [2, 3], [2, 3], "dialog");
testJumplist(
  "jumplist_skip_delted_mark<c-o>",
  ["*", "n", "n", "k", "d", "k", "<C-o>", "<C-o>", "<C-o>"],
  [0, 2],
  [0, 2]
);
testJumplist(
  "jumplist_skip_delted_mark<c-i>",
...
testVim("dd", function (cm, vim, helpers) {
  cm.setCursor(0, 3);
  var expectedBuffer = cm.getRange({ line: 0, ch: 0 }, { line: 1, ch: 0 });
...
testVim("dd_prefix_repeat", function (cm, vim, helpers) {
  cm.setCursor(0, 3);
  var expectedBuffer = cm.getRange({ line: 0, ch: 0 }, { line: 2, ch: 0 });
...
testVim("dd_multiply_repeat", function (cm, vim, helpers) {
  cm.setCursor(0, 3);
  var expectedBuffer = cm.getRange({ line: 0, ch: 0 }, { line: 6, ch: 0 });
