  ...
  tinymce.create("tinymce.plugins.MoreLink", {
    init: function (ed, url) {
      var ml =
        '<img src="' +
        url +
        '/img/ReadMoreInsert-1.png" class="perc-blog-more-link mceItemNoResize" />';
      var cls = "perc-blog-more-link";
      var sep = '<span class="perc-blog-more-link"></span>';
      var mlRE = new RegExp(
      ...
      ed.onPostProcess.add(function (ed, o) {
        if (o.get)
          o.content = o.content.replace(/<img[^>]+>/g, function (im) {
            if (im.indexOf('class="perc-blog-more-link') !== -1) im = sep;
            return im;
          });
      });
    },
