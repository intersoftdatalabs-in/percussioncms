  ...
  tinymce.create("tinymce.plugins.GlobalVariables", {
    init: function (ed, url) {
      ...
      ed.addCommand("mceInsertGlobalVariables", function () {
        ...
        if (!mainEditor.jQuery || !mainEditor.jQuery.topFrameJQuery) return;
        var topFrJQ = mainEditor.jQuery.topFrameJQuery;
        var dialogHtml =
          '<div><div id="perc-global-variables-wrapper"><table id="perc-global-variables-table"><tbody><tr class="perc-row-0"><th align="left" class="perc-column-0 perc-global-variables-column-header">Variable name</th><th class="perc-column-1 perc-global-variables-column-header">Variable value</th></tr>';
            ...
            Save: {
              click: function () {
                ...
                var urlToServlet =
                  ...
                  "/Rhythmyx/textToImage?imageText=&lt; " +
                  varValue +
                  " &gt;";
                var gvhtml =
      ...
      // Register button
      ed.ui.registry.addButton("globalvariables", {
