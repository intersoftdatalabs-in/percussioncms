...
tinymce.PluginManager.add("percadvlink", function (editor) {
  ...
  function showDialog(linkList) {
    ...
    cm1LinkData.sys_dependentvariantid = anchorElm
      ? dom.getAttrib(anchorElm, "sys_dependentvariantid")
      : "";
    cm1LinkData.rxinlineslot = anchorElm
      ? dom.getAttrib(anchorElm, "rxinlineslot")
      : "";
    cm1LinkData.sys_dependentid = anchorElm
      ? dom.getAttrib(anchorElm, "sys_dependentid")
      : "";
    cm1LinkData.inlinetype = anchorElm
    ...
    win = editor.windowManager.open({
      ...
      onSubmit: function (e) {
        ...
        if (
          linkPath.match("^//Sites/") ||
          linkPath.match("^//Assets/") ||
          linkPath.match("^/Sites/") ||
          linkPath.match("^/Assets/") ||
          linkPath.match("^Sites/") ||
          linkPath.match("^Assets/")
    ...
    function updateLinkData(pathItem) {
      ...
      topFrJQ.PercPathService.getInlineRenderLink(
        ...
        function (status, retData) {
          ...
          cm1LinkData.sys_dependentvariantid =
            renderLink.sys_dependentvariantid;
