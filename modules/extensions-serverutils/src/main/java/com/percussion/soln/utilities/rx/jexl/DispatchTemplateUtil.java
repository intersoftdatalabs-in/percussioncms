...
public class DispatchTemplateUtil extends SolnJexlBase {
  ...
  @IPSJexlMethod(
      ...
      params = {
        ...
        @IPSJexlParam(
            name = "templateMap",
            description = "The template map of content type to template name."),
        @IPSJexlParam(
            name = "defaultTemplate",
            description = "the base url to append the parameters to")
      },
      returns = "String")
  public String pickTemplate(
      IPSAssemblyItem item, Map<String, Object> templateMap, String defaultTemplate)
      throws RepositoryException {
    if (item == null) throw new IllegalArgumentException("item cannot be null");
    return pickTemplateByType(
        ((IPSNodeDefinition) item.getNode().getDefinition()).getInternalName(),
        templateMap,
        defaultTemplate);
  }
  ...
  @IPSJexlMethod(
      ...
      returns = "String")
  public String pickTemplateByType(
      String contentType, Map<String, Object> templateMap, String defaultTemplate) {
  ...
  @IPSJexlMethod(
      ...
      params = {@IPSJexlParam(name = "parameters", description = "$sys.params")},
  ...
  @IPSJexlMethod(
      ...
      params = {
        ...
        @IPSJexlParam(
            ...
            description = "location returned on failing to find default template.")
      },
