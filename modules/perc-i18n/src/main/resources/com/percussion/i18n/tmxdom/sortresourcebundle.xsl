...
<!-- This style is used to sort the TMX resource document just before saving
	to the disk. Idea is to make it easier for sombody to locate a required translation
	key. -->
