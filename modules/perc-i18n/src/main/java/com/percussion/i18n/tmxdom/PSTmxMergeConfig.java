...
public class PSTmxMergeConfig implements IPSTmxMergeConfig {
  ...
  public void setConfigDoc(Document doc) {
    ...
    processConfigElement(tu, IPSTmxDtdConstants.ELEM_NOTE, MERGE_NODEID_TU_NOTE);

    // Process "tu/prop" element
    processConfigElement(tu, IPSTmxDtdConstants.ELEM_PROP, MERGE_NODEID_TU_PROPERTY);

    // Process "tuv" element
    Element tuv = processConfigElement(tu, IPSTmxDtdConstants.ELEM_TUV, MERGE_NODEID_TUV);

    // Process "tuv/note" element
    processConfigElement(tuv, IPSTmxDtdConstants.ELEM_NOTE, MERGE_NODEID_TUV_NOTE);

    // Process "tu/prop" element
    processConfigElement(tuv, IPSTmxDtdConstants.ELEM_PROP, MERGE_NODEID_TUV_PROPERTY);

    // Process "tu/seg" element
    processConfigElement(tuv, IPSTmxDtdConstants.ELEM_SEG, MERGE_NODEID_SEGMENT);
  }
