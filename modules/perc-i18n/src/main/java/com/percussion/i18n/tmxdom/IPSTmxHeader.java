...
/**
 * This interface defines methods specific to TMX document's header. TMX DTD defines a set of
 * required and optional attributes for the header. This interface currently makes use of only the
 * required attributes. A header element can contain &lt;note&gt; and &lt;prop&gt; child elements.
 * We use &lt;prop&gt; elements to specify the list supported languages by the TMX resource bundle
 * as follows: &lt;header&gt; &lt;prop type="supportedlanguage"&gt;en-us&lt;/prop&gt; &lt;prop
 * type="supportedlanguage"&gt;fr-ca&lt;/prop&gt; ... &lt;/header&gt;
 *
 * @see IPSTmxDtdConstants
 */
public interface IPSTmxHeader extends IPSTmxNode {
  /**
   * Method to get an array of supported or defined langauges in the TMX document.
   *
   * @return array of language strings of suported languages. May be <code>null</code>.
   * @see IPSTmxDtdConstants
   */
   ...
   * @param value should not be <code>null</code>, if <code>null</code>, <code>empty</code> is
   *     assumed.
   * @see #PROPNAMEMAP
   */
  ...
  /**
   * Method to add a new language to the TMX document. Adding a language to header does not add the
   * stubs for the translation variants automatically.
   *
