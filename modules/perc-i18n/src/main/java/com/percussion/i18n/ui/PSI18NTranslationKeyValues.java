...
public class PSI18NTranslationKeyValues {
  ...
  public void load(IPSRemoteRequester requester)
    ...
    if (requester == null) throw new IllegalArgumentException("requester must not be null");
    ...
    if (doc != null) fromXml(doc.getDocumentElement());
  }
  ...
  public static PSI18NTranslationKeyValues getInstance() {
    if (ms_theInstance == null) ms_theInstance = new PSI18NTranslationKeyValues();
