...
public class PSUpdateItemAction extends PSAAActionBase {
  ...
  public PSActionResponse execute(Map<String, Object> params) throws PSAAClientActionException {
    try {
      ...
      ireq.performUpdate();
      String validateError = ureq.getParameter(IPSHtmlParameters.SYS_VALIDATION_ERROR);
      if (!StringUtils.isBlank(validateError)) {
        ...
        String cachedUrl = ureq.getParameter(IPSHtmlParameters.SYS_CE_CACHED_PAGEURL);
