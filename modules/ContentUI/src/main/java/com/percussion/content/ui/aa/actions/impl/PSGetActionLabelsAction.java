...
public class PSGetActionLabelsAction extends PSAAActionBase {
  ...
  public PSActionResponse execute(Map<String, Object> params) throws PSAAClientActionException {
    try {
      ...
      List<IPSCatalogSummary> actionSums = uiMgr.findActions(null, null, null);
      Map<String, IPSCatalogSummary> namesToSums = new HashMap<String, IPSCatalogSummary>();
      for (IPSCatalogSummary sum : actionSums) namesToSums.put(sum.getName().toLowerCase(), sum);
