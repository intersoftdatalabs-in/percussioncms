...
public class PSActionResponse {
  ...
  /**
   * Returns the response mime type string for the specified response type integer. If the response
   * type integer passed in is invalid then the response type of string will be returned.
   *
  ...
  /** The response data string. May be <code>null</code> or empty. Initialized in the ctor */
  private String m_responseData;

  /**
   * The response type that will be returned to the caller. USe the RESPONSE_TYPE_XXX constants.
   * Defaults to the RESPONSE_TYPE_PLAIN type.
   */
  private int m_responseType = RESPONSE_TYPE_PLAIN;

  /** Response type constant that represents the &quot;text/html&quot; mime type. */
  public static final int RESPONSE_TYPE_HTML = 0;

  /** Response type constant that represents the &quot;text/plain&quot; mime type. */
  public static final int RESPONSE_TYPE_PLAIN = 1;

  /** Response type constant that represents the &quot;text/xml&quot; mime type. */
  public static final int RESPONSE_TYPE_XML = 2;

  /** Response type constant that represents the &quot;text/json&quot; mime type. */
  public static final int RESPONSE_TYPE_JSON = 3;

  /** Response string array. */
  private static String[] ms_responseStrings =
      new String[] {"text/html", "text/plain", "text/xml", "text/json"};
}
