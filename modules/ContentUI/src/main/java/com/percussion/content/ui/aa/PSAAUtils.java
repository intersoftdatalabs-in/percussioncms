...
public final class PSAAUtils
{
   ...
   public static String getSlotObjectId(IPSAssemblyItem item, String slotname)
         throws PSAssemblyException, PSMissingBeanConfigurationException, IllegalArgumentException, JSONException
   {
      if (item == null) {
         ...
         throws PSAssemblyException, PSMissingBeanConfigurationException, IllegalArgumentException, JSONException
   {
      ...
      logger.debug("Creating snippet object ID for item: {} and slot: {} with sort rank: {}",
                   item, slotname, sortrank);
