...
public class PSResolveSiteFoldersAction extends PSAAActionBase {
  ...
  public PSActionResponse execute(Map<String, Object> params) throws PSAAClientActionException {
    ...
    try {
      if (folderGuid != null)
        result.put(IPSHtmlParameters.SYS_FOLDERID, Integer.toString(folderGuid.getUUID()));
      if (siteGuid != null)
        result.put(IPSHtmlParameters.SYS_SITEID, Integer.toString(siteGuid.getUUID()));
