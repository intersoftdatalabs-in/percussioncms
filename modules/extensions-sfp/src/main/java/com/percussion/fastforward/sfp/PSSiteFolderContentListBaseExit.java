...
public abstract class PSSiteFolderContentListBaseExit implements IPSResultDocumentProcessor {
  ...
  public Document processResultDocument(
    ...
    String filenameContext =
        PSUtils.getParameter(params, 0, request.getParameter(IPSHtmlParameters.SYS_CONTEXT, "0"));

    String deliveryType = PSUtils.getParameter(params, 1, "ftp");

    boolean isIncremental;
    String incremental = PSUtils.getParameter(params, 2, "n");
    if (incremental.startsWith("y")) isIncremental = true;
    else isIncremental = false;

    String publishableContentValidValues = PSUtils.getParameter(params, 3, "y");
    ...
    try {
      ...
      throw new PSExtensionProcessingException("PSSiteFolderContentListExit", e);
    }
