...
public class PSCopyValueToRequest extends PSDefaultExtension implements IPSUdfProcessor {
   ...
   * member of the array. Both are converted to strings before putting into the request.
   *
   * @param params - Object[] parameters to the UDF, must have have two non <code>null</code> and
   *     non-empty members.
  ...
  public Object processUdf(Object[] params, IPSRequestContext request)
    ...
    if (params.length < 2) throw new PSConversionException(0, "Atleast 2 parameters required");
