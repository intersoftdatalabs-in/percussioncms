  ...
  public Object processUdf(Object[] params, IPSRequestContext request)
    ...
    if (StringUtils.isNumeric(contentId)) {
      ...
      if (StringUtils.isBlank(slotname))
        throw new PSConversionException(0, "must provide non-blank slotname parameter value");

      try {
        PSChildRelationshipParser parser =
            new PSChildRelationshipParser(PSRelationshipProcessor.getInstance());
