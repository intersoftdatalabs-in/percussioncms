<xsl:stylesheet version="2.0"
	...
	<xsl:template
		match="bean[@id='sys_publishMessageHandlerContainerQ']" />
	...
	<xsl:template
		match="bean[@id='sys_amazons3DeliveryHandler']" />
	...
	<xsl:template
		match="bean[@id='sys_databaseDeliveryHandler']" />
	...
	<xsl:template
		match="bean[@id='sys_deliveryHandlerRunner']" />
	<xsl:template
		match="bean[@id='sys_metadataDeliveryHandler']" />
