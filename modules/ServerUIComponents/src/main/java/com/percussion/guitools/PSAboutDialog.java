...
public class PSAboutDialog extends JDialog implements Serializable {
  ...
  public PSAboutDialog(Frame parent, String title, String clientVersion) {
    ...
    if (clientVersion == null || clientVersion.trim().length() == 0)
      throw new IllegalArgumentException("clientVersion may not be null or empty");
  ...
  private void initDialog(String title, String[] versions, String copyRight3Party) {
    ...
    String imagePath;
    if (copyRight3Party == null) imagePath = (versions.length == 1) ? SHORT_IMAGE : MID_IMAGE;
    else imagePath = LONG_IMAGE;
    ...
    Font urlFont =
        new Font(defaultFont.getFontName(), defaultFont.getStyle(), defaultFont.getSize() + 4);
  ...
  public static final String SHORT_IMAGE = "images/about_rx_short.gif";
  public static final String RX_COPY_RIGHT =
      "Copyright \u00a9 " + "1999-" + YearMonth.now().getYear() + " by Percussion Software, Inc.";
}
