...
public class PSPagingControlEvent extends AWTEvent {
   ...
   * @param currentPage the current page indicated by the paging control or -1 if no page selected.
   */
  ...
  /**
   * The value of the current page as indicted by the paging control.
   *
