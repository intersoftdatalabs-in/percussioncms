...
/**
 * Initially, this will be a simple class that allows any object in the mainframe to display a
 * message. Once the text is set, it will remain until it is cleared or a different string is set.
 * It provides a very simple mechanism to give short messages to the end user.
 *
 * <p>The status bar is composed of a panel with a label.
 *
...
public class StatusBar extends JPanel {
   ...
   *
   * @param strMsg the default message to display when there is no message set, may be <code>null
   *     </code>
