...
public class Node implements Comparable<Node> {
  ...
  public Collection<Related_node> getRelatedNodesForNodeId() {
    return (this.relatedNodesForNodeId == null
        ? null
  ...
  public Collection<Node_editor> getNodeEditors() {
    return (this.nodeEditors == null ? null : new HashSet<Node_editor>(this.nodeEditors));
  }
  ...
  public String toString() {
    return "ID: "
        + getId()
        + "\nSearch: "
        + (this.getSearch() != null ? this.getSearch() : IRRELEVANT)
        + "\nParent: "
        + (parent != null ? parent.getId() : IRRELEVANT)
        + "\nDefault Community: "
        + this.getDefault_community_id()
        + "\nNot Leaf: "
        + this.getNot_leaf()
        + "\nCreated By: "
        + this.getCreated_by_id()
        + "\nCreated At: "
        + (this.getCreated_at() != null ? this.getCreated_at().toString() : IRRELEVANT)
        + "\nModified By: "
        + this.getModified_by_id()
        + "\nModified At: "
        + (this.getModified_at() != null ? this.getModified_at().toString() : IRRELEVANT);
  }
