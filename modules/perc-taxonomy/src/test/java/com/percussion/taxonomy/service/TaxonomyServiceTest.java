...
public class TaxonomyServiceTest extends ServletTestCase {
  ...
  private void initServices() {
    ...
    if (nodeStatusService == null) {
      nodeStatusService =
          (Node_statusServiceInf) PSBaseServiceLocator.getBean("Node_statusService");
    }

    if (attributeLangSevice == null) {
      attributeLangSevice =
          (Attribute_langServiceInf) PSBaseServiceLocator.getBean("Attribute_langService");
    }
  ...
  public void testGetNodesInDeletionOrder_oneRoot() {
    ...
    assertTrue(
        ordered.get(5).getId() == 11
            || ordered.get(6).getId() == 11
            || ordered.get(7).getId() == 11);
    assertTrue(
        ordered.get(5).getId() == 12
            || ordered.get(6).getId() == 12
            || ordered.get(7).getId() == 12);
    assertTrue(
        ordered.get(5).getId() == 13
            || ordered.get(6).getId() == 13
            || ordered.get(7).getId() == 13);
  ...
  public void testGetNodesInDeletionOrder_twoRoots() {
    ...
    assertTrue(
        ordered.get(2).getId() == 21
            || ordered.get(3).getId() == 21
            || ordered.get(4).getId() == 21);
    assertTrue(
        ordered.get(2).getId() == 11
            || ordered.get(3).getId() == 11
            || ordered.get(4).getId() == 11);
    assertTrue(
        ordered.get(2).getId() == 12
            || ordered.get(3).getId() == 12
            || ordered.get(4).getId() == 12);
  ...
  public void testGetNodesInDeletionOrder_threeRoots() {
    ...
    assertTrue(
        ordered.get(2).getId() == 1111
            || ordered.get(3).getId() == 1111
            || ordered.get(4).getId() == 1111
            || ordered.get(5).getId() == 1111);
    assertTrue(
        ordered.get(2).getId() == 3111
            || ordered.get(3).getId() == 3111
            || ordered.get(4).getId() == 3111
            || ordered.get(5).getId() == 3111);
    assertTrue(
        ordered.get(2).getId() == 3112
            || ordered.get(3).getId() == 3112
            || ordered.get(4).getId() == 3112
            || ordered.get(5).getId() == 3112);
    assertTrue(
        ordered.get(2).getId() == 3113
            || ordered.get(3).getId() == 3113
            || ordered.get(4).getId() == 3113
            || ordered.get(5).getId() == 3113);

    // third level: nodes n111, n211, n212, 311
    assertTrue(
        ordered.get(6).getId() == 111
            || ordered.get(7).getId() == 111
            || ordered.get(8).getId() == 111
            || ordered.get(9).getId() == 111);
    assertTrue(
        ordered.get(6).getId() == 211
            || ordered.get(7).getId() == 211
            || ordered.get(8).getId() == 211
            || ordered.get(9).getId() == 211);
    assertTrue(
        ordered.get(6).getId() == 212
            || ordered.get(7).getId() == 212
            || ordered.get(8).getId() == 212
            || ordered.get(9).getId() == 212);
    assertTrue(
        ordered.get(6).getId() == 311
            || ordered.get(7).getId() == 311
            || ordered.get(8).getId() == 311
            || ordered.get(9).getId() == 311);

    // fourth level: nodes n11, n21, n31
    assertTrue(
        ordered.get(10).getId() == 11
            || ordered.get(11).getId() == 11
            || ordered.get(12).getId() == 11);
    assertTrue(
        ordered.get(10).getId() == 21
            || ordered.get(11).getId() == 21
            || ordered.get(12).getId() == 21);
    assertTrue(
        ordered.get(10).getId() == 31
            || ordered.get(11).getId() == 31
            || ordered.get(12).getId() == 31);

    // fifth level: nodes n1, n2, n3
    assertTrue(
        ordered.get(13).getId() == 1
            || ordered.get(14).getId() == 1
            || ordered.get(15).getId() == 1);
    assertTrue(
        ordered.get(13).getId() == 2
            || ordered.get(14).getId() == 2
            || ordered.get(15).getId() == 2);
    assertTrue(
        ordered.get(13).getId() == 3
            || ordered.get(14).getId() == 3
            || ordered.get(15).getId() == 3);
  }
