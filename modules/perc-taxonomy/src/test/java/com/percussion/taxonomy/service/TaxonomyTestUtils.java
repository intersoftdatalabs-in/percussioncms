...
public class TaxonomyTestUtils {
  ...
  public static Set<Attribute_lang> createAttributeLangSet(
      int ordinal, Attribute attribute, Language language) {
  ...
  public static Set<Value> createValueSetForNode(
      Attribute attribute, Node node, String createdBy, Language language) {
    Value value1 = new Value();
    value1.setAttribute(attribute);
    value1.setName(
        "value 1 for attribute " + attribute.getAttribute_langs().iterator().next().getName());
