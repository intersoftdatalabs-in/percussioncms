...
public class PSNavFolderSelector extends PSDefaultExtension
   ...
   */
  private String setSiteFolderByPath(String path, IPSRequestContext req) throws PSNavException {
    try {
      ...
      if (summary != null) {
        String folderId = summary.getCurrentLocator().getPart(PSLocator.KEY_ID);
