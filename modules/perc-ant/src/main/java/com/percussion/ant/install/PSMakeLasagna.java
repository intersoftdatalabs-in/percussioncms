...
public class PSMakeLasagna extends Task {
  ...
  public void execute() throws BuildException {
    ...
    try {
      String propFilePath = m_root + File.separator + "rxconfig/Installer/rxrepository.properties";
      ...
      out =
          new FileOutputStream(
              m_root + File.separator + "rxconfig/Installer/rxrepository.properties");
