...
public class PSExecSQLRemoveDupes extends PSExecSQLStmt {
      ...
      try (Connection conn = InstallUtil.createConnection(driver, server, database, uid, pw)) {
        ...
        String sqlSelect =
            String.format(
                ...
                columns, finalTableName, columns);
        ...
        try (Statement stmt = conn.createStatement();
          ...
          String sqlInsert =
              String.format(
                  "INSERT INTO %s (%s) VALUES (%s)", finalTableName, columnNames, bindVariables);
   ...
   *
   * @return the column names, never <code>null</code>, may be empty
   */
   ...
   *
   * @param columns the column names, may be <code>null</code>
   */
