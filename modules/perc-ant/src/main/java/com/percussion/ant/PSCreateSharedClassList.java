...
public class PSCreateSharedClassList extends Task {
  /** Creates a new shared class list task. */
  public PSCreateSharedClassList() {}
  ...
  public void execute() throws BuildException {
    ...
    if (!m_dir.isDirectory()) throw new BuildException("dir must be a valid directory.");
    if (m_type == null || !(m_type.equals("include") || m_type.equals("exclude")))
  ...
  private void getAllPackageNmkPaths(File dir) {
    if (dir == null || !dir.isDirectory())
      throw new IllegalArgumentException("dir cannot be null and must be a directory.");
  ...
  /** The name of the package.nmk file. */
  public static final String PACKAGE_NMK = "package.nmk";

  /** The macro name for the package. */
  public static final String PACKAGE_MACRO = "PACKAGE";

  /** The macro name for shared classes. */
  public static final String SHARED_CLASSES_MACRO = "SHARED_CLASSES";

  /** The top-level comment inserted into the generated shared classes XML file. */
  public static final String TOP_COMMENT =
