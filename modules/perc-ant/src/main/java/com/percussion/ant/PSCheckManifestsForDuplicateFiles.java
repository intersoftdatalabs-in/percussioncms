...
public class PSCheckManifestsForDuplicateFiles extends Task {
  ...
  private Set<String> extractLibs(File file) {
    ...
    if (!libDelimiterFound) {
      throw new BuildException("Can't find library specifications in manifest " + file);
    }
    return libs;
  }
  ...
  public static class Exclude {
    ...
    public void setName(String name) {
      if (StringUtils.isBlank(name)) {
        throw new IllegalArgumentException("Excluded file name should not be null");
      }
      mi_name = name.trim();
    }
