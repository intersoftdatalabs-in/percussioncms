...
| P-Adv (US7) | Advanced CE tools (clipboard, dependencies, wizards) | PR #1401 | Kilo (implementer); QA/UAT pending 8.2 candidate build | 2026-07-19 | PR merged; SC-011 capability-matrix evidence in `contracts/capability-matrix.md` (5 Implemented + 1 Partial + 2 Pending for client-side dimensions 1/6/7); Vitest + 7 Playwright tests; UAT acceptance pending 8.2 GA candidate build |
