...
| Search in content browser | Dialogs            | `enableSearch` prop mounts shared `SearchPanel`                        | P-Search | US5              | **Present** (#2793) — `ContentBrowser` mounts Explorer `SearchPanel` (catalog + free-text + saved execute; no new REST). Asset picker host opts in; Open/Reveal wired for select dialogs.                                                                                                                                                                                                                                                              | Vitest ContentBrowser host wiring; Playwright host-asset-picker soft-skip when fixture lag                                                                 |
...
| Search in content browser | **Present** (#2793) | `ContentBrowser.enableSearch` mounts shared `SearchPanel`; asset picker host opts in |
...
- P-ACL: 4/4 **Done**.
- P-Search: 2/2 **Done**; client-browser integration **Present** (#2793 SearchPanel host); saved-searches catalog+execute on Explorer Present (residual polish may remain under #2400).
