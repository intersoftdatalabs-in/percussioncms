...
- [x] T060 [US3] **`js/xss` (23 alerts, high)**: fix `WebUI/src/main/webapp/cm/pages/cui/components/twitter-bootstrap-3.0.0/js/tests/vendor/qunit.js` and other flagged files — if removed under US2, mark obsolete
