...
|                                     File                                     |                                                                                          Description                                                                                           |
|------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [workbench-rest-and-qa-modes.md](./workbench-rest-and-qa-modes.md)           | **Direction of record:** clean REST for Workbench replacement (SOAP as reference); **dev mode** vs **QA mode**; optional H2 QA GHA workflow (#1930)                                            |
| [playwright-failure-artifacts.md](./playwright-failure-artifacts.md)         | **Night-issue runbook:** where Playwright failure outputs land under `perc-qa-automation/frontend`, cross-platform collect notes, and `gh`/gist attach conventions for PR/issue comments       |
