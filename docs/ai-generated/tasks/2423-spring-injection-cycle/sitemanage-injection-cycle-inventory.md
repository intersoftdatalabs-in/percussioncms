...
5. Hub hardening: `PSTemplateService` class `@Lazy` + reverse-edge tests landed (#2477, 2026-08-08); `PSPageService` reverse-edge tests landed (#2514, 2026-08-08). Residual: `itemWorkflow` reverse-edge tests (#2478).
