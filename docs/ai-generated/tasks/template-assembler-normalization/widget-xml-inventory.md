...
| **Product packages still ship Widget XML** | **Partial** | Batch A (#2883) **stopped committing** install Widget XML (8 files); package-build materializes install XML from modern. Batches B/C + perc.Test still dual-ship committed XML (**40** remain). |
...
| Metric | Value |
|--------|-------|
| Widget definition files (committed product source) | **40** (was **48** before batch A ship-exit #2883; −8 base/core) |
