...
create, save, and delete a **group**, add or delete nested fields, and save
control properties and choices. The content-editor **system definition** (global system fields) is a
