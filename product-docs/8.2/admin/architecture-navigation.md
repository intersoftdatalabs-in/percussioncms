...
A site can exist without a NavTree item at the site root (for example a
Rhythmyx folder that was never given managed navigation, or a site whose
folder root is missing). Opening **Navigation** for that site does
