...
and GET-roundtrip the kind (local fixture `rootPath` only); Build/Preview/Publish stay later slices. REST **Build** (`POST …/virtual/build`) writes HTML from that local
