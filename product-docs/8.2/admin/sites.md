...
preview is not git-only. Developer Sites **Preview assembled site** appears for SQL
as well as Git and CSV. In-product REST Build records the last output path
(including a custom
