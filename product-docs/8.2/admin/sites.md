...
5. Choose **Save Virtual Site source**. For Git the SPA sends the Jackson/JAXB
   ...
   **Object storage**, **RSS / Atom**, and **iCalendar**. **Sitemap XML** save/GET-roundtrip
   is available; Build/Preview/Publish chrome stay hidden. Traditional **Repository** hides that chrome.
...
`rootPath` only); **Build Virtual Site**, **Preview assembled site**, and **Publish Virtual Site**
stay later. After root, remote, or
