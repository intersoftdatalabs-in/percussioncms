...
5. Choose **Save Virtual Site source**. For Git the SPA sends the Jackson/JAXB
   ...
   **Object storage**, and **RSS / Atom**. Traditional **Repository** hides that chrome.
...
`rootPath` are **400**). REST Build/Preview/Publish and Developer Sites chrome stay later
slices. After root, remote, or
