...
`csv-filesystem`, `sql-database`, `http-json`, `object-storage`, `rss-atom`, and `icalendar`. `POST …/virtual/publish`
...
`csv-filesystem`, `sql-database`, `http-json`, or `object-storage`. Unknown kinds return **400**.
