...
Operators using **Developer → CE Controls** create, save, and delete chrome: [Developer CE Controls](id:admin-developer-ce-controls).
...
System definition fields, Content Types, Action Menus, and CE Controls) uses an **in-app
