...
| Update | `PUT /services/sites/{nameOrId}` | Admin. Updates description and `baseUrl` (body `name` must match the path). Renames stay outside this surface. Same action as **Developer → Sites** detail Save. |
