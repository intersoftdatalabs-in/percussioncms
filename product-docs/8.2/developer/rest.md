...
are unchanged. After POST the editor notice confirms the save. The catalog GET
row may lag until Hibernate `RXMENUACTION` persist (issue 4119 / 4140).
