...
| Update | `PUT /services/sites/{nameOrId}` | Admin. Updates description and `baseUrl` (body `name` must match the path). A mismatched body name is **400** — use Rename, not this PUT. Same action as **Developer → Sites** detail Save. |
