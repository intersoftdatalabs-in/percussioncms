...
The Developer SPA **Content types** detail chrome exposes an **Include system
or shared field** picker for this surface after a held lock — see
[Developer Content Types](id:admin-developer-content-types).
