...
and **Preview assembled site**. REST **Publish** stays a later slice.
...
**Build** and **Preview** run against that local fixture. REST **Publish** stays a later
slice. Operators can also assemble offline with the CLI.
...
envelope. **Build Virtual Site** and **Preview assembled site** run after save.
**Publish Virtual Site** stays a later slice.
...
last-build HTML for **Preview assembled site**. **Publish Virtual Site** stays a later
slice.
...
**400**. Developer Sites **Preview assembled site** uses that last-build Preview after
**Build Virtual Site**. Missing build stays unavailable (`available=false` HTTP **200**;
no fake preview). **Publish Virtual Site** stays a later slice.
...
object-storage, rss-atom, icalendar, sitemap-xml, robots-txt, llms-txt, and openapi-yaml after save (Publish copies last-build HTML after a successful Build for Git/CSV/SQL/HTTP JSON/object-storage/rss-atom/icalendar/sitemap-xml/robots-txt/llms-txt; openapi-yaml Publish stays a later slice).
