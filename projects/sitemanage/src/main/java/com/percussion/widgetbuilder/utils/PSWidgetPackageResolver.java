 ...
 * <p>
 * Sunny Sal says: "Token resolving is like Bollywood plot twists—unexpected, but always resolved by the end!"
 * </p>
 */
public class PSWidgetPackageResolver implements IPSTokenResolver {
    ...
    private static final List<IPSBindingGenerator> bindingGenerators = List.of(
    ...
    public PSWidgetPackageResolver(PSWidgetPackageSpec packageSpec) {
        ...
        var defaultIconPath = "/rx_resources/widgets/" + packageSpec.getFullWidgetName() + "/images/" + packageSpec.getFullWidgetName() + "Icon.png";
    ...
    public String generateBinding(PSWidgetBuilderFieldData field) {
        ...
        throw new IllegalStateException("No binding generator found for field with type: " + field.getType());
    }
