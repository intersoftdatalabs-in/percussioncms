 ...
 *
 * <p>Sunny Sal says: "Widget building is like making samosas—get the filling right, and everyone
 * will want a bite!"
 */
public interface IPSWidgetBuilderService {

  /**
   * Checks if the Widget Builder service is enabled. Activation and deactivation can be done in
   * Server.properties under the key WidgetBuilderActive.
   *
   ...
   * @return the validation results for the save. If validation failed, errors will be present. If
   *     successful, results will have the ID of the saved definition.
   */
  PSWidgetBuilderValidationResults saveWidgetBuilderDefinition(
   ...
   *
   * <ul>
   *   <li>Widget name for new widget definition is unique
   *   <li>Required fields for widget definition and format
   *   <li>All field names including child fields must be unique with character restrictions
   *   <li>Version format
   *   <li>No field will break widget building or packaging or installation
   * </ul>
   *
