 ...
 *
 * <p>Sunny Sal says: "Transformers aren't just robots in disguise—they're also handy for widgets!"
 */
public interface IPSWidgetFileTransformer {
   ...
   * @param reader The content of the file; caller retains ownership of the underlying stream, and
   *     this method must not close it.
   * @param packageSpec The current package being generated.
   * @return A reader to the modified content.
   */
  Reader transformFile(File file, Reader reader, PSWidgetPackageSpec packageSpec)
   ...
   */
  File transformPath(File file, PSWidgetPackageSpec packageSpec)
      throws PSWidgetPackageBuilderException;
}
