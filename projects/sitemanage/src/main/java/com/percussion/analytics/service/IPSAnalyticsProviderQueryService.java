...
/**
 * Service that queries against an analytics service provider generally returning the results in an
 * <code>IPSAnalyticsQueryResultSet</code>.
 *
 * @author erikserating
 */
public interface IPSAnalyticsProviderQueryService {
   ...
   * @param range the date range, cannot be <code>null</code>. The start and end date values in the
   *     date range are inclusive. Granularity is ignored.
   ...
   *
   * @param sitename the unique sitename to filter the results by. Cannot be <code>null</code>.
   * @param pathPrefix the path prefix used to filter the results. May be <code>null</code> in which
   *     case no filtering will be done by path prefix.
   * @param range the date range, cannot be <code>null</code>. The start and end date values in the
   *     date range are inclusive. Granularity is ignored.
   * @return the list of results, never <code>null</code> may be empty.
   *     <pre>
