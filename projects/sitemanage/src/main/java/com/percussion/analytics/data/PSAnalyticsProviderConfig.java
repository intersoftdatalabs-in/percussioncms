...
public class PSAnalyticsProviderConfig {
   ...
   * @param extraParamsMap The extra params used by the analytics provider to further define access
   *     to the account. May be <code>null</code> or empty.
   */
  ...
  /** Analytics provider account user id. Never <code>null</code> or empty. */
  ...
  /**
   * Analytics provider account password, may be encrypted, if so then <code>isEncrypted</code> will
   * return <code>true</code>. Never <code>null</code> or empty.
   */
  ...
  /**
   * The extra params used by the analytics provider to further define access to the account. May be
