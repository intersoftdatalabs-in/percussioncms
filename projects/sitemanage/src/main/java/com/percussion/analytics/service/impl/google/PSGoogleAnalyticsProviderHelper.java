...
public class PSGoogleAnalyticsProviderHelper {
    ...
    public Analytics getAnalyticsService(String email, String key)
        ...
        try {
            ...
            var credential = new GoogleCredential.Builder()
                    ...
                    .build();
            service = new Analytics.Builder(httpTransport, JSON_FACTORY, credential)
     ...
     */
    public static final Map<String, PSAnalyticsProviderException.CAUSETYPE> CAUSE_MAPPINGS = new HashMap<>();
    ...
    static PrivateKey privateKeyFromPkcs8(String privateKeyPkcs8)
        ...
        try (Reader reader = new StringReader(privateKeyPkcs8)) {
            ...
            try {
                ...
                throw new PSAnalyticsProviderException(exception.getMessage(), CAUSETYPE.AUTHENTICATION_ERROR);
            }
        }
    }
