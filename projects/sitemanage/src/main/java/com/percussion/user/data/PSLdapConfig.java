...
public class PSLdapConfig extends PSAbstractDataObject {
  ...
  /**
   * A single directory service. If <code>null</code> then directory service is disabled.
   *
  ...
  public static class PSLdapServer extends PSAbstractDataObject {
    ...
    @NotNull private String objectAttributeName;
    ...
    @NotNull private CatalogType catalogType;
