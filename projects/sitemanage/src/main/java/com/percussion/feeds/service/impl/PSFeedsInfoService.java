...
public class PSFeedsInfoService implements IPSFeedsInfoService {
   ...
   *
   * @return list of content type names of content types that use the feeds shared fields group.
   ...
   * @return collection of feed info objects for each feed enabled content item found. Never <code>
