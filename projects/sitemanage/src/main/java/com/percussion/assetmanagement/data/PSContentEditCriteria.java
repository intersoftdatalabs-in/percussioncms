...
/**
 * Class to provide the content creating/editing criteria part of the page or template. When content
 * is created part of a page or template it becomes local to the page or template and is treated as
 ...
 * auto-generated for the local content and for the shared content it is provided by the user.
 *
 * @author bjoginipally
 * @author adamgent
 */
...
public class PSContentEditCriteria extends PSAssetEditor {
   ...
   * editors producesResource attribute.
   *
  ...
  /**
   * Preferred editor height, this value needs to be set to the widget definitions preferred height
   * value.
   *
  ...
  /**
   * Preferred editor width, this value needs to be set to the widget definitions preferred width
   * value.
   *
   * @return never <code>null</code>.
   */
