...
public class PSAssetDropCriteria {
   ...
   *
   * @param existingAsset <code>true</code> to indicate this widget has a linked asset, otherwise
   *     <code>false</code>.
   */
   ...
   *
   * @param assetShared <code>true</code> to indicate the linked asset is shared, <code>false</code>
   *     if local.
   */
   ...
   *
   * @return the relationship ID, should be >= 0 for valid ID. It is <code>-1</code> if the property
   *     is unknown.
   */
