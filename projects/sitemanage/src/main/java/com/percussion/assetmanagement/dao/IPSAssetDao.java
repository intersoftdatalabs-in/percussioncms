...
public interface IPSAssetDao extends IPSGenericDao<PSAsset, String> {
  ...
  /**
   * Gets the asset from its identifier, similar with {@link #find(String)}, except caller can
   * specify the returned asset includes all fields or only the summary properties of the object.
   *
   ...
   * @return collection of assets, never <code>null</code>, may be empty.
   */
  public Collection<PSAsset> findAllAssetsUsingEncryption()
