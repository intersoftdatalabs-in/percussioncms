...
public class PSExtractedAssetRequest extends PSAbstractAssetRequest {
   ...
   *
   * @return <code>true</code> if the outer html should be included in the extracted content, <code>
  ...
  /**
   * @param includeOuterHtml <code>true</code> if the selector element should be included in the
   *     extracted content, <code>false</code> otherwise.
   */
