...
/**
 * Contains data for requesting a URL, which can be used for creating a related asset or editing an
 * existing asset.
 *
 * <p>Type can be either {@link #PAGE_PARENT} or {@link #TEMPLATE_PARENT}.
 *
...
public class PSAssetEditUrlRequest {
  ...
  /** The page parent type. TODO: Switch this to an enum (Adam Gent) */
   ...
   * Gets the asset ID.
   *
   * @return the asset ID. It may be {@code null} if requesting the URL for creating an asset;
   *     otherwise requesting the URL for editing.
   */
