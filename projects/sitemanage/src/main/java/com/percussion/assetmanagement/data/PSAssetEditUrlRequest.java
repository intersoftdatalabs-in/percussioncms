...
/**
 * It contains data for requesting a URL, which can be used for creating a related asset or editing
 * an existing asset.
 *
 * @author YuBingChen
 */
...
public class PSAssetEditUrlRequest {
   ...
   * Gets the asset ID.
   *
   * @return the asset ID. It may be <code>null</code> if requesting the URL for creating an asset;
  ...
  /** The asset ID. It may be <code>null</code> if requesting an URL for creating the asset. */
