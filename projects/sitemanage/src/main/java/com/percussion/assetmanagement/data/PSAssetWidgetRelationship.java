...
public class PSAssetWidgetRelationship extends PSAbstractDataObject {
  ...
  /**
   * When associated an asset to a widget the client can request that the asset be put in a asset
   * library folder.
   *
   ...
   *
   * @param rid the new relationship ID. It should be greater than <code>0</code> for an valid
   *     relationship.
   */
