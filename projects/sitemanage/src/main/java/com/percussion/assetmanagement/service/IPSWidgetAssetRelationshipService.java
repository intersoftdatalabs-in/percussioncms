 ...
 * <p>
 * Widget items are always associated to a single page or template; thus, a widget cannot exist without a page/template.
 * Consequently, widget IDs are not unique across pages/templates; the page/template ID must be provided whenever the widget ID is used.
 * <p>
 * However, a widget may have 0..n relationships with an asset, and this service manages those relationships.
 * <p>
 * Creating widget items is not done in this service and is part of page and template management.
 */
public interface IPSWidgetAssetRelationshipService {
     ...
     */
    void cleanupOrphanedPageAssets(PSPage page, PSPage previousPage, PSTemplate template, PSTemplate previousTemplate)
            throws PSWidgetAssetRelationshipServiceException;
     ...
     */
    void updateSharedRelationshipDependent(String ownerId, String depId, String newDepId) throws PSValidationException;
     ...
     * @throws PSCmsException
     */
    void updateSharedRelationshipDependent(String ownerId, String depId, String newDepId, boolean checkInOut)
