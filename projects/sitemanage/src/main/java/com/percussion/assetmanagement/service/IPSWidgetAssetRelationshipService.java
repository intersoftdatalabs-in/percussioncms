 ...
 *
 * <p>{@link PSWidgetItem Widget items} are always associated to a single page or template thus a
 * widget cannot exist with out a page/template. Consequently widget id's are not unique across
 * pages/templates the page/templates id must be provided whenever the widget id used.
 *
 * <p>However a widget may have 0..n relationships with an asset and this service manages those
 * relationships.
 *
 * <p><em>Creating {@link PSWidgetItem widget items} is not done in this service and is part of page
 * and template management.</em>
 *
 * @author adamgent
