 ...
 * <strong>Does not actually move the asset.</strong>
...
public class PSAssetNewFolderPathResolver {
    ...
    public PSResolvedFolderPath resolveFolderPath(IPSItemSummary owner, IPSItemSummary asset)
            throws IPSDataService.DataServiceLoadException, PSValidationException, IPSDataService.DataServiceNotFoundException {
     ...
     * {@link #isAlreadyInFolder()} {@code true} means it's already in the folder.
     */
