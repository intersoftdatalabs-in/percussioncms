...
/**
 * Resolves what the folder path should be for an asset that is to be associated to an owner.
 * <strong>It does not actually put the asset into the folder</strong>. That is done elsewhere.
 *
 * @author adamgent
 */
public class PSAssetNewFolderPathResolver {
   ...
   * <code>true</code> means its already in the folder.
   *
   * @author adamgent
   */
