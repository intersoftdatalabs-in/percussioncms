...
public class PSFormDataJoiner {
   ...
   *
   * @param columnsHeader The header with all the fields of every form, except the 'form name' and
   *     'create date'. Not {@code null}.
   ...
   *
   * @param csvRow Map generated with SuperCSV. Represents a row, with the header columns as keys.
   *     Not {@code null}.
   ...
   *
   * @param data Array with forms data in CSV format. Each element has a header and 0 or more rows
   *     of a single form.
