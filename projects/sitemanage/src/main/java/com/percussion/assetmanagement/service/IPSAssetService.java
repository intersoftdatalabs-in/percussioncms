...
public interface IPSAssetService extends IPSDataService<PSAsset, PSAssetSummary, String> {
    ...
    String updateAssetWidgetRelationship(PSAssetWidgetRelationship rel)
            throws PSAssetServiceException, IPSWidgetAssetRelationshipService.PSWidgetAssetRelationshipServiceException, PSValidationException;
    ...
    void clearAssetWidgetRelationship(PSAssetWidgetRelationship rel)
            throws PSAssetServiceException, PSValidationException, IPSWidgetAssetRelationshipService.PSWidgetAssetRelationshipServiceException;

    PSValidationErrors validateAssetWidgetRelationship(PSAssetWidgetRelationship awr) throws PSValidationException;
     ...
     */
    List<PSAssetDropCriteria> getWidgetAssetCriteria(String id, Boolean isPage) throws PSDataServiceException;
     ...
     */
    List<PSWidgetContentType> getAssetTypes(String filterDisabledWidgets) throws PSDataServiceException;
     ...
     */
    void addAssetToFolder(PSAssetFolderRelationship assetFolderRelationship) throws PSDataServiceException;
     ...
     * @param assetFolderRelationship never <code>null</code>.
     */
    void removeAssetFromFolder(PSAssetFolderRelationship assetFolderRelationship) throws PSDataServiceException;
     ...
     */
    PSAsset createAsset(PSAbstractAssetRequest request) throws PSAssetServiceException, PSValidationException;
    ...
    Collection<PSAsset> findLocalByType(String type)
            throws PSAssetServiceException, PSValidationException, IPSItemWorkflowService.PSItemWorkflowServiceException, IPSGenericDao.LoadException;
     ...
     */
    PSAsset updateAsset(String id, PSAbstractAssetRequest ar, boolean forceCheckOut) throws PSAssetServiceException;
     ...
     */
    String shareLocalContent(String name, String path, PSAssetWidgetRelationship awRel) throws PSAssetServiceException;
     ...
     * @throws PSAssetServiceException if an error occurs creating the asset.
     */
    PSAsset createAssetFromSourceAsset(String srcAssetId, String targetAssetType) throws PSAssetServiceException;
     ...
     */
    List<PSAsset> updateInspectedElements(PSInspectedElementsData inspectedElementsData) throws PSDataServiceException;
