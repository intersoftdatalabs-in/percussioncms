...
public interface IPSAssetService extends IPSDataService<PSAsset, PSAssetSummary, String> {
  ...
  public static final String CREATE_ASSET_ERROR_MESSAGE =
      "Unable to convert HTML asset to Rich Text asset";
   ...
   */
  public String createAssetWidgetRelationship(PSAssetWidgetRelationship rel)
   ...
   * @throws PSAssetServiceException if the relationship cannot be created.
   */
  public String updateAssetWidgetRelationship(PSAssetWidgetRelationship rel)
   ...
   * @throws PSAssetServiceException
   */
  public PSNoContent promoteAssetWidget(PSAssetWidgetRelationship rel)
   ...
   */
  public void clearAssetWidgetRelationship(PSAssetWidgetRelationship rel)
  ...
  public Collection<PSAsset> findLocalByType(String type)
      throws PSAssetServiceException, PSValidationException,
          IPSItemWorkflowService.PSItemWorkflowServiceException, IPSGenericDao.LoadException;
   ...
   */
  public PSAsset updateAsset(String id, PSAbstractAssetRequest ar, boolean forceCheckOut)
      throws PSAssetServiceException;
   ...
   * @throws PSAssetServiceException
   */
  public List<PSAsset> updateInspectedElements(PSInspectedElementsData inspectedElementsData)
      throws PSDataServiceException;
