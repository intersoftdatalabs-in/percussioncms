...
public class PSSiteImproveSiteConfigurations {
     ...
     */
    public PSSiteImproveSiteConfigurations(String siteName, Boolean doProduction, Boolean doStaging,
                                           Boolean doAssetsScanExclude, Boolean doPreview, Boolean isSiteImproveEnabled) {
    ...
    public String toString() {
        return "PSSiteImproveSiteConfigurations{" +
                ...
                ", doStaging=" + doStaging +
                ", doAssetsScanExclude=" + doAssetsScanExclude +
                ", doPreview=" + doPreview +
    ...
    @Override
    public int hashCode() {
        return Objects.hash(siteName, doProduction, doStaging, doAssetsScanExclude, doPreview, isSiteImproveEnabled);
    }
}
