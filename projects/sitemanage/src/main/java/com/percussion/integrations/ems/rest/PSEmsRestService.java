...
/**
 * * Functions as a proxy on the CMS side for calling the remote DTS EMS Api client. Used from
 * within content editors and content type fields.
 *
 * @author natechadwick
 */
@Path("/ems")
...
public class PSEmsRestService {
  ...
  public Response getBuildings() {
    ...
    try {
      ...
      if (server == null) {
        String msg =
            "Unable to locate delivery server for perc-integration service.  Verify the service is registered in the delivery-servers.xml and try again";
        log.error(msg);
      ...
      if (code == 200) {
        ...
        throw new Exception(
            "Invalid response code:" + code + " was received when listing buildings.");
      }
  ...
  public Response getEventTypes() {
    ...
    try {
      ...
      if (code == 200) {
        ...
        throw new Exception(
            "Invalid response code:" + code + " was received when listing eventtypes.");
      }
    ...
    try {
      ...
      StringRequestEntity entity =
          new StringRequestEntity(
              mapper.writeValueAsString(query), MediaType.APPLICATION_JSON, "UTF-8");
      ...
      if (code == 200) {
        ...
        throw new Exception(
            "Invalid response code:" + code + " was received when listing bookings.");
      }
    } catch (Exception e) {
      log.error("Error pulling Groups from DTS. Error: {}", PSExceptionUtils.getMessageForLog(e));
      return Response.serverError().entity(e.getMessage()).build();
  ...
  public Response getMCGroupings() {
    ...
    try {
      ...
      if (code == 200) {
        ...
        throw new Exception(
            "Invalid response code:" + code + " was received when listing MC groupings.");
      }
    } catch (Exception e) {
      log.error("Error pulling Groups from DTS. Error: {}", PSExceptionUtils.getMessageForLog(e));
      return Response.serverError().entity(e.getMessage()).build();
  ...
  public Response getMCLocations() {
    ...
    try {
      ...
      if (code == 200) {
        ...
        throw new Exception(
            "Invalid response code:" + code + " was received when listing MC locations.");
      }
    } catch (Exception e) {
      log.error(
  ...
  public Response getMCEventTypes() {
    ...
    try {
      ...
      if (code == 200) {
        ...
        throw new Exception(
            "Invalid response code:" + code + " was received when listing MC eventtypes.");
      }
    } catch (Exception e) {
      log.error(
          "Error pulling Event Types from DTS. Error: {}", PSExceptionUtils.getMessageForLog(e));
  ...
  public Response getMCCalendars() {
    ...
    try {
      ...
      if (code == 200) {
        ...
        throw new Exception(
            "Invalid response code:" + code + " was received when listing MC Calendars.");
      }
    } catch (Exception e) {
      log.error(
  ...
  public Response getMCEvents(PSEventQuery query) {
    ...
    try {
      ...
      if (code == 200) {
        ...
        throw new Exception(
            "Invalid response code:" + code + " was received when listing MC Events.");
      }
    } catch (Exception e) {
      log.error(
  ...
  public Response getMCFutureEvents(PSFeaturedEventsQuery query) {
    ...
    try {
      ...
      if (code == 200) {
        ...
        throw new Exception(
            "Invalid response code:" + code + " was received when listing MC Featured Events.");
      }
    } catch (Exception e) {
      log.error(
