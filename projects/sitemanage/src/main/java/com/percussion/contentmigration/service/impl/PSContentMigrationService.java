...
public class PSContentMigrationService implements IPSContentMigrationService {
  ...
  public void migrateSameTemplateChanges(String templateId, List<String> pageIds)
    ...
    for (var pageId : pageIds) {
      ...
      if (!applicableWidgets.isEmpty()) {
        ...
        log.debug(
            "Could not find any applicable widgets, skipping migration process for page {}",
            pageId);
  ...
  private void findMatchingContent(
      ...
      List<ApplicableWidget> applicableWidgets)
  ...
  private org.jsoup.nodes.Document getReferenceDocument(String templateId, String refPageId)
      throws PSContentMigrationException {
    org.jsoup.nodes.Document refDoc;
    try {
  ...
  private ApplicableWidget createApplicableWidget(
      PSAssetDropCriteria adc, org.jsoup.nodes.Document refDoc, boolean isPageWidget) {
  ...
  private void findMatchingContent(
      org.jsoup.nodes.Document refDoc,
      org.jsoup.nodes.Document targetPageDoc,
      List<ApplicableWidget> applicableWidgets) {
