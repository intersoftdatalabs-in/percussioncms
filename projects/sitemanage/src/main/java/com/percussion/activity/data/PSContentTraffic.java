...
public class PSContentTraffic {
  ...
  /**
   * @return visits total by date interval. Value in array index matches up date in the date array
   *     at the same index.
   */
  ...
  /**
   * @return newPages total by date interval. Value in array index matches up date in the date array
   *     at the same index.
   */
  ...
  /**
   * @return pageUpdates total by date interval. Value in array index matches up date in the date
  ...
  /**
   * @return takeDowns total by date interval. Value in array index matches up date in the date
   *     array at the same index.
   */
  ...
  /**
   * @return livePages total by date interval. Value in array index matches up date in the date
   *     array at the same index.
   */
  ...
  /**
   * @return dates by date interval. Dates in array matches up with values in all other list in this
   *     object.
   */
  ...
  /**
   * @return updateTotals sum of newPages, pageUpdates and takeDowns at the same index point in
   *     array.
   */
  ...
  /**
   * Sets map of visits to a site based on google analytics. Value in array index matches up date in
   * the date array at the same index.
   *
   * @param visits
   */
  ...
  /**
   * Sets map of new pages to a site. Value in array index matches up date in the date array at the
   * same index.
   *
   * @param newPages
   */
  ...
  /**
   * Sets map of updated pages to a site. Value in array index matches up date in the date array at
   * the same index.
   *
   * @param pageUpdates
   */
  ...
  /**
   * Sets map of unpublished pages to a site. Value in array index matches up date in the date array
   * at the same index.
   *
   * @param takeDowns
   */
  ...
  /**
   * Sets map of published pages to a site. Value in array index matches up date in the date array
   * at the same index.
   *
   * @param livePages
   */
  ...
  /**
   * Set dates for traffic content based on granularity. Index of list needs to match up with values
   * set on all other list in this object.
   *
   * @param dates
   */
