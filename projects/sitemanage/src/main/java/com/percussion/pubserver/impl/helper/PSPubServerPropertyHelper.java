 ...
 *
 * <p>These methods were originally private helpers in {@link
 * com.percussion.pubserver.impl.PSPubServerService} but have been moved out to keep the service
 * class focused and much smaller.
 */
public final class PSPubServerPropertyHelper {
  ...
  public static void updateProperty(
      List<PSPublishServerProperty> properties, String key, String value) {
    properties.stream()
