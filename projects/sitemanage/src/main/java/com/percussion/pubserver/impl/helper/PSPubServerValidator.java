...
/**
 * Simple validation routines formerly in {@link com.percussion.pubserver.impl.PSPubServerService}.
 */
public final class PSPubServerValidator {
   ...
   * @throws IPSPubServerService.PSPubServerServiceException if the name is blank after trimming
   */
