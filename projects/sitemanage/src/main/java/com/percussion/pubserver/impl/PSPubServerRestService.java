...
public class PSPubServerRestService {
   ...
   *
   * @param siteId the id of the site of which it is going to retrieve the information from. Cannot
   ...
   * @param pubServerInfo the <code>PSPublishServer</code> object containing the * server
   *     information to add to that server. Must not be empty or * <code>null</code>
   ...
   *
   * @return a <code>String</code> of the JSON object from a <code>Map<String, Boolean></code>
   *     (DriverName,available).
   */
  @GET
