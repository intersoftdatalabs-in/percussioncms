...
/**
 * This class contains the structure of the object returned by the Rest method located in sitemanage
 * project. The object is composed of a workflow name and a list of {@link PSUiWorkflowStep}.
 *
...
public class PSUiWorkflow extends PSAbstractDataObject {
  ...
  /**
   * @param defaultWorkflow the value for defaultWorkflow that indicates whether it is default
   *     workflow or not
   */
   ...
   *
   * @param stagingRoleNames if <code>null</code> will be set to empty string.
   */
