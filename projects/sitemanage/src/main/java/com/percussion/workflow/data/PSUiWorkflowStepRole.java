...
/**
 * This class contains the structure of the step role information. The object is composed of a role
 * name, a role id and a list of {@link PSUiWorkflowStepRoleTransition}.
 *
...
public class PSUiWorkflowStepRole extends PSAbstractDataObject {
  ...
  /**
   * @param enableNotification the for enableNotification that indicates whether it is enabled or
   *     not
   */
