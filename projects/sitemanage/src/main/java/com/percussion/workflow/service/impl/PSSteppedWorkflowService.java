...
public class PSSteppedWorkflowService
  ...
  public PSUiWorkflow updateWorkflow(String workflowName, PSUiWorkflow uiWorkflow)
      throws PSWorkflowEditorServiceException, PSNotFoundException, IPSGenericDao.LoadException,
  ...
  private static String STATE_NOT_FOUND =
      "The step ''{0}'' has been removed and no longer exists in the workflow. Please refresh and try again.";
}
