...
public class PSSteppedWorkflowMetadata implements IPSSteppedWorkflowMetadata {
  ...
  static final Set<String> excludedWorkflows =
      Set.of("LocalContent", "Standard Workflow", "Simple Workflow");

  // Steps names to exclude from the list to show
  static final Set<String> excludedStates = Set.of("Pending", "Live", "Quick Edit");
  ...
  static final List<String> defaultTransitions =
      List.of(
  ...
  static final List<String> orderedTransitions =
      List.of(
          TRANSITION_NAME_SUBMIT,
  ...
  static final List<String> systemStatesList =
      List.of(
