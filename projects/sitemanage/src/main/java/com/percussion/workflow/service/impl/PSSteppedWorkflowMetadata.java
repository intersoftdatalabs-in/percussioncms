...
public class PSSteppedWorkflowMetadata implements IPSSteppedWorkflowMetadata {
  ...
  static String[] excludedWorkflowsArray = {"LocalContent", "Standard Workflow", "Simple Workflow"};
  static final Set<String> excludedWorkflows = new HashSet<>(Arrays.asList(excludedWorkflowsArray));

  // Steps names to exclude from the list to show
  static String[] excludedStatesArray = {"Pending", "Live", "Quick Edit"};
  static final Set<String> excludedStates = new HashSet<>(Arrays.asList(excludedStatesArray));
  ...
  static String[] defaultTransitionsValues = {
    TRANSITION_NAME_SUBMIT,
    TRANSITION_NAME_REJECT,
    TRANSITION_NAME_APPROVE,
    TRANSITION_NAME_PUBLISH,
    TRANSITION_NAME_ARCHIVE
  };
  static List<String> defaultTransitions = new ArrayList<>(Arrays.asList(defaultTransitionsValues));

  // Ordered list of transitions names
  static String[] orderedTransitionsValues = {
    TRANSITION_NAME_SUBMIT,
    TRANSITION_NAME_RESUBMIT,
    TRANSITION_NAME_REJECT,
    TRANSITION_NAME_APPROVE,
    TRANSITION_NAME_PUBLISH,
    TRANSITION_NAME_ARCHIVE
  ...
  static List<String> orderedTransitions = new ArrayList<>(Arrays.asList(orderedTransitionsValues));
