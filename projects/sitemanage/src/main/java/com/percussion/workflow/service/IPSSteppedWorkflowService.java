...
public interface IPSSteppedWorkflowService {
  ...
  /**
   * Load the workflow information based on the workflow name as the parameter, and builds a <code>
   * PSUiWorkflow</code> object with it.
   *
   * @param workflowName the name of the workflow of which it is going to retrieve the information
   *     from. Cannot be empty or <code>null</code>
   ...
   *
   * @return a <code>PSEnumVals</code> containing the list of workflow names, never empty or <code>
   *     null</code>
   * @throws PSWorkflowEditorServiceException, if the supplied object is invalid.
   */
   ...
   *
   * @return a <code>PSEnumVals</code> containing the workflow name, never empty or <code>null
   *     </code>
   */
   ...
   * @param uiWorkflow the <code>PSUiWorkflow</code> object containing the workflow information to
   *     create that workflow. Must not be emtpy or <code>null</code>
   * @return a <code>PSUiWorkflow</code> object maybe empty never <code>null</code>
   * @throws PSWorkflowEditorServiceException, if the supplied object is invalid.
   */
   ...
   * @param uiWorkflow the <code>PSUiWorkflow</code> object containing the workflow information to
   *     update that workflow (previous and actual workflow name). Must not be emtpy or <code>null
   *     </code>
   ...
   *
   * @param workflowName the name of the workflow to be deleted. Cannot be empty or <code>null
   *     </code>
   * @throws PSWorkflowEditorServiceException, if the supplied workflow name is not found or
   *     contains associated items.
   */
   ...
   * @param stepName the name of the step to be created. Must be identical to the attribute <code>
   *     stepName</code> within the <code>uiWorkflow</code> param
   * @param uiWorkflow the <code>PSUiWorkflow</code> object containing the state to add to that
   *     workflow. Must not be empty or <code>null</code>
   * @return a <code>PSUiWorkflow</code> object never empty or <code>null</code>
   * @throws PSWorkflowEditorServiceException, if the supplied object is invalid.
   */
  public PSUiWorkflow createStep(String workflowName, String stepName, PSUiWorkflow uiWorkflow)
      throws PSWorkflowEditorServiceException;
   ...
   *
   * @param uiWorkflow the <code>PSUiWorkflow</code> object containing the state to add to that
   *     workflow. Must not be <code>null</code>
   * @param workflowName the name of the workflow
   * @param stepName the name of the step to be updated. Must be identical to the attribute <code>
   *     previousStepName</code> within the <code>uiWorkflow</code> param
   * @param uiWorkflow the <code>PSUiWorkflow</code> object containing the state to update that step
   *     (previous and actual step name). Must not be empty or <code>null</code>
  ...
  /**
   * Deletes the given step from the given workflow, re-points the submit transition of the previous
   * step to next step and reject transitions of next step to the previous step.
   *
   * @param workflowName the name of the workflow
   * @param stepName the name of the step to be deleted
   * @return PSUiWorkflow The updated workflow, never empty or <code>null</code>.
   * @throws PSWorkflowEditorServiceException if the supplied workflow or step are not found in the
   *     system or the supplied step name is a reserved step name or if items exist in that
   *     workflow.
   */
