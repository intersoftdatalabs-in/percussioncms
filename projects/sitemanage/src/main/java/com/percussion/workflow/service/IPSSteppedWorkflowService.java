...
public interface IPSSteppedWorkflowService {
   ...
   * @throws PSWorkflowEditorServiceException if the supplied object is invalid
   */
  PSUiWorkflow createWorkflow(String workflowName, PSUiWorkflow uiWorkflow)
   ...
   *
   * @param workflowName the workflow name; cannot be empty or {@code null}
   * @throws PSWorkflowEditorServiceException if the workflow is not found or contains associated
   *     items
   */
   ...
   * @param uiWorkflow the workflow object containing the state to add; must not be empty or {@code
   *     null}
   * @return a {@code PSUiWorkflow} object, never {@code null}
   * @throws PSWorkflowEditorServiceException if the supplied object is invalid
   */
  PSUiWorkflow createStep(String workflowName, String stepName, PSUiWorkflow uiWorkflow)
      throws PSWorkflowEditorServiceException;
   ...
   * @param uiWorkflow the workflow object containing the state to update; must not be empty or
   *     {@code null}
   * @return the updated workflow, never {@code null}
   * @throws PSWorkflowEditorServiceException if the supplied object is invalid
   */
  PSUiWorkflow updateStep(String workflowName, String stepName, PSUiWorkflow uiWorkflow)
      throws PSWorkflowEditorServiceException;
   ...
   */
  PSUiWorkflow deleteStep(String workflowName, String stepName)
      throws PSWorkflowEditorServiceException;
