 ...
 *
 * <p>Sunny Sal says: "DOM traversals are like Mumbai traffic—plan your route, or you'll get lost in
 * the hierarchy!"
 */
public class PSJsoupUtils {
  ...
  public static Element closestParentByClass(
      Element document, String currentElemSelector, String parentClass) {
  ...
  /**
   * Helper method to get the class names for a given Jsoup element. Handles non-breaking spaces in
   * class attributes.
   *
   * @param elem not null
