...
public class PSUtilityRestService {
  /**
   * The value of this key represents the string to be encrypted/decrypted in {@link
   * #encryptString(PSMapWrapper)}.
   */
  public static final String STRING_KEY = "string";

  /**
   * The value of this key represents the encryption/decryption key to be used in {@link
   * #encryptString(PSMapWrapper)}, {@link #decryptString(PSMapWrapper)}.
   */
   ...
   *
   * @return A wrapped map containing one key/value pair where the key is {@link #STRING_KEY} and
   *     the value is the encrypted string which is never <code>null</code>, may be empty. Never
   *     <code>null</code>.
   */
  @POST
  @Path("/encryptstring")
   ...
   *
   * @return A wrapped map containing one key/value pair where the key is {@link #STRING_KEY} and
   *     the value is the decrypted string which is never <code>null</code>, may be empty. Never
   *     <code>null</code>.
   */
  @POST
  @Path("/decryptstring")
  ...
  /**
   * Encrypts the supplied list of strings using {@link IPSUtilityService#encryptString(String,
   * String)} method. Uses the default key for encrypting the strings.
   *
   * @return A wrapped map containing one key/value pair where the key is the supplied string and
   *     the value is the encrypted string which is never <code>null</code>, may be empty. Never
   *     <code>null</code>.
   */
  @POST
  ...
  /**
   * Encrypts the supplied list of strings using {@link IPSUtilityService#decryptString(String,
   * String)} method. Uses the default key for decrypting the strings.
   *
   * @return A wrapped map containing one key/value pair where the key is supplied string and the
   *     value is the decrypted string which is never <code>null</code>, may be empty. Never <code>
   *     null</code>.
   */
  @POST
  @Path("/decryptstrings")
   ...
   * @return A wrapped map containing one key/value pair where the key is {@link #STRING_KEY} and
   *     the value is the encrypted/decrypted string which is never <code>null</code>, may be empty.
