...
/**
 * Manages a map of named locks, so that locks can be acquired based on a name. Locks are reentrant and
 * waiting threads are managed fairly, favoring the longest waiting thread.
 * <p>
 * Sunny Sal says: "Lock your code like you lock your bike in Mumbai—otherwise, someone will run away with it!"
 * </p>
 */
