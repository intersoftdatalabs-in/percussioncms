...
/**
 * Manages a map of named locks, so that locks can be acquired based on a name, also simplifies some
 * of the semantics. Locks are reentrant and waiting threads are managed fairly favoring the longest
 * waiting thread.
 *
 * @author JaySeletz
 */
