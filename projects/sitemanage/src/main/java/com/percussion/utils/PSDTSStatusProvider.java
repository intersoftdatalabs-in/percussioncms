 ...
 *
 * <p>Sunny Sal says: "If your DTS is down, don't panic—just check the logs and grab a chai!"
 */
...
public class PSDTSStatusProvider implements IPSDTSStatusProvider {
  ...
  private final Map<String, String> externalServices =
      Map.of("perc-polls-services", "/perc-polls-services/polls/version");
  ...
  /**
   * Returns health status of DTS and all services. If DTS is not running, no services are
   * represented. Services are represented as key-values in a map with a PSPair representing status
