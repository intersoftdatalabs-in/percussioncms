...
public class PSMaintenanceManagerRestService {
   ...
   *
   * @param clearErrors If <code>true</code>, will clear any errors. Note that you must have Admin
   *     access to the server to perform this. If not, returns Forbidden (403)
