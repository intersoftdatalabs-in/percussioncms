...
public class PSSiteQueue {
   ...
   * current thread. It do nothing if the request info has already configure.
   */
   ...
   * done.
   *
   * @param checkImporting <code>true</code> to check if a page is importing, <code>false</code> to
   *     only consider if there are cataloged pages waiting for import.
   */
