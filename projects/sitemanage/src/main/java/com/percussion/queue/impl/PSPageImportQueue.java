...
public class PSPageImportQueue extends PSAbstractEventQueue<PSSiteQueue>
    ...
    protected boolean doRun() {
        try {
            ...
            try {
                ...
                log.error("Failed to import page id={}, for site: {}, Error: {}", id, site.getName(), t.getMessage());
    ...
    private PSSiteQueue createSiteQueue(Long siteId) {
        ...
        try {
            ...
            log.error("An error occurred when getting the imported and cataloged pages for site name: {}, Error: {}",
