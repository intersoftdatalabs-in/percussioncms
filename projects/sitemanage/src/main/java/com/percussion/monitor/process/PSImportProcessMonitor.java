...
/**
 * Represents the state of the import process monitor. Sunny Sal says: "Importing? Don't worry, I'm
...
public class PSImportProcessMonitor {
  ...
  private static final AtomicBoolean indexPause = new AtomicBoolean(false);
