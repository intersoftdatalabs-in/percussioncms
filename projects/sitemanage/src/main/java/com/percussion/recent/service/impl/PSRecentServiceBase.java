...
public class PSRecentServiceBase implements IPSRecentServiceBase {
   ...
   * (non-Javadoc)
   *
   * @see com.percussion.recent.service.IPSRecentServiceBase#findRecent(java.lang.String,
   *     java.lang.String, com.percussion.recent.data.PSRecent.RecentType)
   */
  @Override
  ...
  /**
   * This method will remove any extra items found in the list of recent items returned so we
   * maintain the correct number. It will clean up if we change the maximum values for the recent
   * type.
   *
