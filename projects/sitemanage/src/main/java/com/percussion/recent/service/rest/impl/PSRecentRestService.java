...
/**
 * REST endpoint for managing recent items, templates, folders, and asset types.
 * Provides methods to add, find, and delete recent user actions.
 */
@Path("/recent")
...
public class PSRecentRestService implements IPSRecentRestService {
    ...
    private final IPSRecentService recentService;
    ...
    public List<PSTemplateSummary> findRecentTemplate(@PathParam("siteName") String siteName) {
    ...
    @POST
    @Path("/item")
    public void addRecentItem(@FormParam("value") String value) {
        recentService.addRecentItem(value);
    }

    @POST
    @Path("/template/{siteName}")
    public void addRecentTemplate(@PathParam("siteName") String siteName, @FormParam("value") String value) {
        recentService.addRecentTemplate(siteName, value);
    }

    @POST
    @Path("/site-folder")
    public void addRecentSiteFolder(@FormParam("value") String value) {
        recentService.addRecentSiteFolder(value);
    }

    @POST
    @Path("/asset-folder")
    public void addRecentAssetFolder(@FormParam("value") String value) {
        recentService.addRecentAssetFolder(value);
    }

    @POST
    @Path("/item-by-user/{userName}")
    public void addRecentItemByUser(@PathParam("userName") String userName, @FormParam("value") String value) {
        recentService.addRecentItemByUser(userName, value);
    }

    @POST
    @Path("/template-by-user/{userName}/{siteName}")
    public void addRecentTemplateByUser(@PathParam("userName") String userName, @PathParam("siteName") String siteName, @FormParam("value") String value) {
        recentService.addRecentTemplateByUser(userName, siteName, value);
    }

    @POST
    @Path("/site-folder-by-user/{userName}")
    public void addRecentSiteFolderByUser(@PathParam("userName") String userName, @FormParam("value") String value) {
        recentService.addRecentSiteFolderByUser(userName, value);
    }

    @POST
    @Path("/asset-folder-by-user/{userName}")
    public void addRecentAssetFolderByUser(@PathParam("userName") String userName, @FormParam("value") String value) {
    ...
    public void deleteUserRecent(@PathParam("user") String user) {
        recentService.deleteUserRecent(user);
    }
    ...
    @POST
    @Path("/asset-type")
    public void addRecentAssetType(@FormParam("value") String value) {
