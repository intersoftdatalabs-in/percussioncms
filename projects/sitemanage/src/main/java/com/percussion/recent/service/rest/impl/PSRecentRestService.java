...
/**
 * REST endpoint for managing recent items, templates, folders, and asset types. Provides methods to
 * add, find, and delete recent user actions.
 */
@Path("/recent")
...
public class PSRecentRestService implements IPSRecentRestService {
  ...
  public void addRecentTemplate(
      @PathParam("siteName") String siteName, @FormParam("value") String value) {
  ...
  public void addRecentItemByUser(
      @PathParam("userName") String userName, @FormParam("value") String value) {
    recentService.addRecentItemByUser(userName, value);
  }

  @POST
  @Path("/template-by-user/{userName}/{siteName}")
  public void addRecentTemplateByUser(
  ...
  public void addRecentSiteFolderByUser(
      @PathParam("userName") String userName, @FormParam("value") String value) {
  ...
  public void addRecentAssetFolderByUser(
      @PathParam("userName") String userName, @FormParam("value") String value) {
