...
/** Holds current options for path retrieval. Thread-local options for path loading behavior. */
public class PSPathOptions {
   ...
   *
   * @return {@code true} to check them, {@code false} to skip checking. Defaults to {@code false}
   *     if not set.
   */
