...
public class PSFolderPermission extends PSAbstractDataObject {
  ...
  public boolean equals(Object o) {
    ...
    return getAccessLevel() == that.getAccessLevel()
        && Objects.equals(getAdminPrincipals(), that.getAdminPrincipals())
        && Objects.equals(getWritePrincipals(), that.getWritePrincipals())
        && Objects.equals(getReadPrincipals(), that.getReadPrincipals())
        && Objects.equals(getViewPrincipals(), that.getViewPrincipals());
  }
  ...
  public enum Access {
    ...
    /**
     * This is more restrictive than ADMIN, but less restrictive than READ. It also have READ
     * permission.
     */
    WRITE,
  ...
  /**
   * Gets the access level that is applied to unspecified principals. It returns {@link
   * Access#ADMIN} if it has not been set by {@link #setAccessLevel(Access)}.
   *
   ...
   *
   * @return the list of principals, may be <code>null</code> or empty if the list of principals
   *     that have ADMIN access is unknown.
   */
   ...
   *
   * @param principals the new list of principals, it may be <code>null</code> or empty.
   */
   ...
   *
   * @return the list of principals, it may be <code>null</code> or empty if the list of subjects is
   *     unknown.
   */
