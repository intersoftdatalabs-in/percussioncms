...
/**
 * This class is posted to the rest service as part of a request to find the properties of a set of
 * items by path, workflow, and workflow state.
 *
...
public class PSItemByWfStateRequest {
  ...
  /**
   * @return the workflow state for which the items will be requested. May be <code>null</code> or
   *     empty to indicate properties for items in all states should be returned.
   */
  ...
  /**
   * @param state the workflow state of the requested items. May be <code>null</code> or empty to
   *     indicate properties for items in all states should be returned.
   */
