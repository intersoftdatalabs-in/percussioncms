...
public class PSFolderProperties extends PSAbstractDataObject {
  ...
  /**
   * The list of allowed sites used by the publishing service to check if the assets must be
   * published.
   *
   * <p>If this list is null, then the assets are published to all sites by default.
   */
