...
/**
 * This class is posted to the rest service as part of a request to delete a folder. It contains the
 * relative path of the folder which should be deleted as well as a flag which indicates if in use
 * assets/resources should be skipped during deletion.
 *
...
public class PSDeleteFolderCriteria {
   ...
   *
   * @return <code>true</code> if the item is to be purged. <code>false</code> if it should be
   *     recycled.
   */
  ...
  @NotBlank private SkipItemsType skipItems;

  /** @See {@link #getShouldPurge()}. */
  @NotBlank @NotNull private boolean shouldPurge;
