...
public interface IPSCategoryService {
  ...
  /**
   * Method to get the information whether the category tab in the 'Administration' ui is being used
   * by an admin.
   *
  ...
  /**
   * Method to create a file indicating that an admin is using the category tab in the
   * 'Administration' ui.
   *
   * @param sitename - name of the site.
