...
/**
 * Represents an Object coming from the client. It has two fields, one is the workflow name, and the
 * other is a list of paths. This object is used to assign the given workflow to all of the folders
 * that are listed.
 *
...
public class PSWorkflowAssignment {
  ...
  /**
   * A list of folder ids for which the assigned workflow should be applied to all content in the
   * folder. May be empty.
   */
