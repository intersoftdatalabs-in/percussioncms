...
/**
 * Object that will be serialized for the workflow tab. Used to list the sites and asset folders
 * assigned to a given workflow.
 *
...
public class PSFolderItem extends PSAbstractDataObject {
  ...
  /**
   * <code>true</code> if all of the subfolders are assignated to the same workflow as this one.
  ...
  /** @param allChildrenAssociatedWithWorkflow the allChildrenAssociatedWithWorkflow to set */
