...
public class JacksonContextResolver implements ContextResolver<ObjectMapper> {
  ...
  static {
    mapper
        ...
        .configure(
            DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE, Boolean.TRUE)
        .configure(SerializationFeature.WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED, Boolean.FALSE)
