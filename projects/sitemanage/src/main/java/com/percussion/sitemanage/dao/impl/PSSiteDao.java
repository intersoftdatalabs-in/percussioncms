...
public class PSSiteDao implements IPSiteDao {
   ...
   * @param origSite The site from which this site is being created or <code>null</code> to indicate
   *     that this site is not being created from an existing site.
  ...
  /**
   * Used for sorting of {@link PSSiteSummary} objects. Sorts alphabetically by name
   * (case-insensitive).
   *
