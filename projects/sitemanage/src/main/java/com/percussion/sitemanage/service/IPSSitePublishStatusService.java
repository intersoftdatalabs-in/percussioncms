...
public interface IPSSitePublishStatusService {
   ...
   * @return the job status for each completed job. Never <code>null</code> but may be <code>empty
   *     </code>.
   * @throws PSDataServiceException
   */
   ...
   * @return the list of item status records. Never <code>null</code> but may be <code>empty</code>
   * @throws PSDataServiceException
   */
