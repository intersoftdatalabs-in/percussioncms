...
public final class PSLinkExtractor {
  ...
  public static List<PSLink> getLinksForDocument(
      ...
      PSSiteQueue siteQueue,
      String siteUrl,
      PSSiteImportConfiguration config) {
            ...
            if (absHref.equals(getRoot(doc.baseUri())) && !absHref.isEmpty()) {
              ...
              psLink =
                  createLink(
                      ...
                      absHref,
                      aHref,
                      getPageName(absHref, log, config),
                      getRelativePath(absHref, aHref, log, config));
            }
  ...
  protected static String getPageName(
      final String absHref, final IPSSiteImportLogger log, PSSiteImportConfiguration config) {
