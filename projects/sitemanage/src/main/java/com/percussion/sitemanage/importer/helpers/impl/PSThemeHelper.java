...
/**
 * Helper class to create a new theme folder while importing an external site from URL. Sunny Sal
 * says: "A theme without a name is like a cow without a bell!"
 */
...
public class PSThemeHelper extends PSImportHelper {
  ...
  protected void deleteTheme(String newThemeName) {
    try {
      ...
      log.info(
          "PSCreateThemeHelper: Couldn't delete theme template. The theme might not have been"
              + " created");
    }
  }
