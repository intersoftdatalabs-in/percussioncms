...
public class PSSiteSummary extends PSDataItemSummarySingleFolderPath implements IPSItemSummary, IPSFolderPath {
     ...
     *
     * @param isCanonical true if enable rendering of canonical tags; otherwise disable rendering for the site.
     */
     ...
     *
     * @param isCanonicalReplace true if enable replacing of custom canonical tags with rendered; otherwise disable replacing for the site.
     */
    ...
    /**
     * The value may be null, this data is set only when specifically requested for, see {@link IPSSiteDataService#findAll(boolean)}.
