...
public class PSSiteSummary extends PSDataItemSummarySingleFolderPath
   ...
   *
   * @param isCanonical <code>true</code> if enable rendering of canonical tags; otherwise disable
   ...
   *
   * @param isCanonicalReplace <code>true</code> if enable replacing of custom canonical tags with
  ...
  /**
   * The value may be <code>null</code>, this data is set only when specifically requested for, see
   * {@link IPSSiteDataService#findAll(boolean)}. Also see {@link
