...
public class PSSiteSummary extends PSDataItemSummarySingleFolderPath
    implements IPSItemSummary, IPSFolderPath {
  ...
  /**
   * The legacy id for the site. This is used by the allowed sites properties for assets root level
   * folders dialog.
   */
  private Long siteId;
  ...
  public Boolean getOverrideSystemJQuery() {
  ...
  public Boolean getOverrideSystemFoundation() {
  ...
  public Boolean getOverrideSystemJQueryUI() {
  ...
  /**
   * TODO: Check why getId is returning the name property of the class. Need to investigate the
   * consequence of doing this change.
   */
  @Override
  public String getId() {
    return getName();
   ...
   *
   * @return true if the site is (marked) to render canonical tags.
   */
   ...
   *
   * @param isCanonical true if enable rendering of canonical tags; otherwise disable rendering for
   *     the site.
   */
  ...
  /**
   * @param defaultDocument site's default document (like "index.html") used when rendering
   *     canonical tags.
   */
  ...
  /**
   * @param canonicalDist URLs' destination ("sections" or "pages") used when rendering canonical
   *     tags.
   */
  ...
  /**
   * Determines if custom (existing) canonical tags should be replaced with rendered ones or not
   * during the publishing.
   *
   * @return true if the site is (marked) to replace custom canonical tags.
   */
   ...
   *
   * @param isCanonicalReplace true if enable replacing of custom canonical tags with rendered;
   *     otherwise disable replacing for the site.
   */
  ...
  /**
   * The value may be null, this data is set only when specifically requested for, see {@link
   * IPSSiteDataService#findAll(boolean)}. Also see {@link
   * IPSPubServerService#getS3PubInfo(com.percussion.utils.guid.IPSGuid)} for more information.
   *
   * @return Publishing info may be null.
   */
  public Optional<PSPubInfo> getPubInfo() {
    return Optional.ofNullable(pubInfo);
  }
