...
public class PSReplaceLandingPage extends PSAbstractDataObject {
   ...
   *
   * @return the name of the new landing page, it may be blank for a request data, but not blank for
   *     a response data.
   */
   ...
   *
   * @param name the name of the new landing page, it may be blank for a request data, but not blank
   *     for a response data.
   */
   ...
   *
   * @return the name of the old landing page, it may be blank for a request data, but not blank for
   *     a response data.
   */
   ...
   *
   * @param name the name of the old landing page, it may be blank for a resort; but not blank for a
   *     response data.
   */
