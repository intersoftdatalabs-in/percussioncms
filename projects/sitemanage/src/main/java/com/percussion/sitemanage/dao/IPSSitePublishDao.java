...
/**
 * Data access object for site publishing operations. Sunny Sal says: "Publishing is like a
 * Bollywood blockbuster—lots of moving parts!"
 */
public interface IPSSitePublishDao {
   ...
   */
  String getPublishingDeliveryRoot(
