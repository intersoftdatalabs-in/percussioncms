...
/**
 * This class contains information for creating a site section. A section contains a folder, landing
 * page and a navon item.
 *
 * @author YuBingChen
 */
...
public class PSCreateSiteSection extends PSAbstractDataObject {
   ...
   *
   * @param name the new landing page name of the section, should not be blank for a valid request.
   * @see #getPageName()
   */
   ...
   *
   * @param title the new landing page title, should not be blank for a valid request.
   * @see #getPageTitle()
   */
   ...
   *
   * @param urlIdentifier the new URL identifier, should not be blank for a valid request.
   */
  ...
  /**
   * Gets the ID of the template used to create the landing page of the site section.
   *
  ...
  /**
   * Sets the ID of the template used to create the landing page of the site section.
   *
  ...
  /**
   * Gets the folder path that will contain the section. This folder is also the parent folder of
   * the section.
   *
  ...
  /**
   * @param sectionType to set, if <code>null</code> initialized to {@link
   *     PSSectionTypeEnum#section}
   */
  public void setSectionType(PSSectionTypeEnum sectionType) {
    if (sectionType == null) sectionType = PSSectionTypeEnum.section;
  ...
  /**
   * @param target The target window type to set, if <code>null</code> initialized to {@link
   *     PSSectionTargetEnum#_self}
   */
  public void setTarget(PSSectionTargetEnum target) {
    if (target == null) target = PSSectionTargetEnum._self;
    this.target = target;
  }
  ...
  /**
   * The name of the section, see {@link #getPageName()} for detail. If null will get default from
   * site
   */
  ...
  /**
   * The URL identifier of the landing page, should not be blank for a valid section request. See
   * {@link #getPageUrlIdentifier()} for detail.
   */
  @NotBlank @NotNull private String pageUrlIdentifier;

  /**
   * The navon title of the section, should not be blank for a valid section request. See {@link
   * #getPageLinkTitle()} for detail.
   */
  @NotBlank @NotNull private String pageLinkTitle;

  /**
   * The ID of the template used to create the landing page, it should not be blank for a valid
   * request.
   */
  @NotBlank @NotNull private String templateId;

  /**
   * The parent folder path of the section, should not be blank for a valid section request. See
   * {@link #getFolderPath()} for detail.
   */
