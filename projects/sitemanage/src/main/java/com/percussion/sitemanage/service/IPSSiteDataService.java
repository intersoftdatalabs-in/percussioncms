...
public interface IPSSiteDataService extends IPSDataService<PSSite, PSSiteSummary, String> {
  /**
   * The publishing type. Used to indicate which mechanism to be used to publish to the live site.
   */
  ...
  public Long createSiteFromUrlAsync(
      @Context HttpServletRequest request, PSSiteImportConfiguration config)
