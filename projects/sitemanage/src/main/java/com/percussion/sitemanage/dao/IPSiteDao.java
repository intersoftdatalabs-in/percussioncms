...
public interface IPSiteDao extends IPSGenericDao<PSSite, String> {
   ...
   * @return <code>true</code> if a pubserver was modified as a result of the change, <code>false
   *     </code> if not.
   */
  ...
  /**
   * Adds the publish-now infrastructure (edition, content list) for the specified site. It is
   * assumed that support for publish now does not exist for the site.
   *
   * @param site the existing site, not <code>null</code>.
   */
  ...
  /**
   * Adds the unpublish-now infrastructure (edition, content list) for the specified site. It is
   * assumed that support for un-publish now does not exist for the site.
   *
   * @param site the existing site, not <code>null</code>.
   */
  ...
  /**
   * Creates a site with content copied from an existing site. The result will be a new site visible
   * in the Finder which includes a copy of all content from the original site. Templates are not
   ...
   * @return summary of the parent site, may be <code>null</code> if there are no sites or the path
   *     does not exist under a site.
   */
