...
/**
 * Utility class for identifying and handling managed tags in HTML documents.
 * Managed tags include certain meta and script tags that are handled by the CMS.
 */
public class PSManagedTagsUtils {
    ...
    private static final List<String> META_NAMES_TO_EXCLUDE = asList("generator", "robots", DESCRIPTION_META_NAME);
    private static final List<String> META_PROPERTIES_TO_EXCLUDE = asList(
    ...
    /**
     * Checks if the given tag is managed by the CMS.
     * Managed tags include certain meta and property tags.
     *
