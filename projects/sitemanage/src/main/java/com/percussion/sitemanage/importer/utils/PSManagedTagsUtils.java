...
public class PSManagedTagsUtils {
  ...
  private static final List<String> HTTP_EQUIV_TO_EXCLUDE = asList(new String[] {"content-type"});

  private static final String DESCRIPTION_META_NAME = "description";

  private static final List<String> META_NAMES_TO_EXCLUDE =
      asList(new String[] {"generator", "robots", DESCRIPTION_META_NAME});
  ...
  /**
   * Verifies if the given tag is a managed reference to a jquery or javascript file.
   *
   * @param tag {@link Element} to verify. Must not be <code>null</code>.
   * @return <code>true</code> if the given tag references a managed js file. <code>false</code>
   *     otherwise.
   */
   ...
   *
   * @param metaTag {@link Element} with the given tag to inspect, must not be <code>null</code>.
  ...
  /**
   * Removes the given tag from the dom and then adds a comment with the text that the tag had. For
   * example, for this tag <code>&lt;meta name="robots" content="noindex" /&gt;</code> it will add
   * <code>&lt;!--&lt;meta name="robots" content="noindex" /&gt;--&gt;</code>
   *
   * @param docHead {@link Element} with the DOM to modify. Must not <code>null</code>.
   * @param tag {@link Element} with the tag to comment. Must not <code>null</code>.
   */
   ...
   * </pre>
   *
   * @param tagText {@link String} with the text of the tag to comment, must not be <code>null
  ...
  /**
   * Verifies if the given filename matches with the regular expressions that represent the managed
   * js references.
   *
   * @param filename {@link String}, may be <code>null</code> or empty, in which case it will return
   *     <code>false</code>.
   * @return <code>true</code> if the source references a managed js file. <code>false</code>
   *     otherwise.
   */
  ...
  /**
   * Verifies if the given filename matches with the filenames that represent the managed js
   * references.
   *
   * @param filename {@link String}, may be <code>null</code> or empty, in which case it will return
   *     <code>false</code>.
  ...
  /**
   * Gets the filename from a source reference. For example, if the source is this: <code>
   * http://ajax.aspnetcdn.com/ajax/jQuery/jquery-1.7.1.min.js?b=111</code> this method will return
   * <code>jquery-1.7.1.min.js</code>
   *
   * @param srcAttr {@link String} with the source reference, assumed not <code>null</code>.
