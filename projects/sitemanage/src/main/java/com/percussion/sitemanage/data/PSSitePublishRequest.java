...
public class PSSitePublishRequest {
  ...
  @NotBlank @NotNull String siteName;

  /** See {@link #getType()}. */
  @NotBlank @NotNull PubType type;
  ...
  /** @param type the type of publishing to be performed, may not be <code>null</code>. */
  public void setType(PubType type) {
    this.type = type;
  }

  /**
   * @return the id's of the items to be published during demand publishing, {@link
   *     PubType#PUBLISH_NOW}. May be <code>null</code>.
   */
  ...
  /**
   * @param items the id's of the items to be published during demand publishing, {@link
   *     PubType#PUBLISH_NOW}. May be <code>null</code>.
   */
