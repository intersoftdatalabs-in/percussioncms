...
public class PSAssetCreator {
    ...
    ) throws IOException, PSExtractHTMLException, IPSItemWorkflowService.PSItemWorkflowServiceException,
     ...
     * @throws IOException
     */
    public PSAsset createAssetIfNeeded(
            InputStream fileInput,
    ...
    /**
     * Helper method to guess the string asset type based on the MIME type of the file.
