...
public class PSAssetCreator {
  ...
  private static Map<String, AssetType> ms_assetTypeMap = new HashMap<>();
   ...
   * Create the asset.
   *
   * @param folderpath the path of the target folder, assumed not <code>null</code>.
   * @param type the asset type, assumed not <code>null</code>.
   * @param fileInput the file input, assumed not <code>null</code>. The input stream of this item
   *     will be closed by this method.
   * @param fileName the name of the file, assumed not <code>null</code>.
   * @param selector the css selector used for content extraction, assumed not <code>null</code>.
   * @param includeOuterHtml <code>true</code> to include the selector element with the extracted
   *     content, <code>false</code> otherwise.
   * @param approveOnUpload <code>true</code> to include control for the Approve assets checked,
  ...
  public PSAsset createAsset(
      ...
      throws IOException, PSExtractHTMLException,
          ...
          IPSAssetService.PSAssetServiceException, PSValidationException {
    try {
  ...
  public PSAsset createAssetIfNeeded(InputStream fileInput, String destinationPath)
      throws PSExtractHTMLException, IOException, IPSAssetService.PSAssetServiceException,
          PSValidationException, IPSItemWorkflowService.PSItemWorkflowServiceException {
   ...
   *     <p>return {@link AssetType} the asset type
   */
   ...
   * @return <code>true</code> if the resource is an Asset. <code>false</code> if not.
   */
   ...
   *
   * @param filename the filename including extension. Assumed not <code>null</code> or empty.
   * @return the appropriate MIME type or the default of "application/octet-stream", never <code>
   *     null</code>.
   */
   ...
   *
   * @param fileName the filename including extension. Assumed not <code>null</code> or empty.
   * @return the appropriate string asset type. By default is <b>file</b>, never <code>null</code>.
   */
