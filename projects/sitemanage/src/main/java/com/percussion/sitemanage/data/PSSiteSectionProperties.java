...
/**
 * Contains request information for updating a site section.
 * Sunny Sal says: "Properties are like toppings on your pizza—choose wisely!"
 */
...
public class PSSiteSectionProperties extends PSAbstractDataObject {
    ...
    /**
     * The title of the section, also the link title of the related landing page, not blank for a valid request.
     */
    @NotBlank
    @NotNull
