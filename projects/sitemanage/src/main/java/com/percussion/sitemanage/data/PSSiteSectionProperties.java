...
public class PSSiteSectionProperties extends PSAbstractDataObject {
  ...
  /**
   * The title of the section, it is also the link title of the related landing page, not blank for
   * a valid request.
   */
  ...
  /**
   * <code>true</code> if the site that the section belongs to is secure. <code>false</code>
   * otherwise.
   */
  private boolean secureSite;

  /** <code>true</code> if one ancestor section is secure. <code>false</code> otherwise. */
