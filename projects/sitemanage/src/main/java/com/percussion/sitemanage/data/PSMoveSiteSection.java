...
public class PSMoveSiteSection extends PSAbstractDataObject {
  ...
  /**
   * Gets the target index, which is <code>0</code> based location under the target navigation node.
   *
   * @return the target location. It may be <code>-1</code> if append to the child nodes of the
   *     target node.
   */
  ...
  /**
   * The to be moved location under the target navigation node. It is <code>0</code> based. Append
   * the source node if it is <code>-1</code>.
   */
