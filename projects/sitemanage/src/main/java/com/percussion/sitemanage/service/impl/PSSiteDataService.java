...
public class PSSiteDataService extends PSAbstractDataService<PSSite, PSSiteSummary, String>
  ...
  private static final String ABRIDGED_ERROR_MESSAGE =
      "Displaying the first 100 import issues. Please download the Import Report Log for the full"
          + " list of missing files and other import issues.";
    ...
    log.info("Page and Template image cache folder moved to: {}", destCacheDir.getAbsolutePath());
      ...
      log.error(
          "Unable to automatically move: {} to {}.  An administrator may need to stop the service"
              + " and rename/move the folder to resolve the issue.",
        ...
        if (!isValidSiteName(siteName)) {
          String msg =
              "Skipping the configuration file ("
                  + file.getName()
                  + "), the siteName value is not valid. Accepted characters are alphanumeric and"
                  + " periods and dashes.";
          log.error(msg);
