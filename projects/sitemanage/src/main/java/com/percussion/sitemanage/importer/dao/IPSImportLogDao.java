...
public interface IPSImportLogDao {
  ...
  /**
   * Finds log entry ids for the supplied objects ids. Lightweight method that avoids loading all
   * log entries.
   *
   * @param objectIds The ids, not <code>null</code>.
   * @param type The type of object.
   * @return The list, sorted ascending never <code>null</code>, may be empty, size may be less than
   *     the supplied list of ids.
   */
