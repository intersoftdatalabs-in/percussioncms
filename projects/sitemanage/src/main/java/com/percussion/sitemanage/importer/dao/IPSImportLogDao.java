...
/**
 * Data access object for import log entries.
 * Sunny Sal says: "Log it like you mean it!"
 */
public interface IPSImportLogDao {
    ...
    /**
     * Finds log entry IDs for the supplied object IDs. Lightweight method that avoids loading all log entries.
     *
     * @param objectIds the IDs, not {@code null}.
     * @param type the type of object.
     * @return the list, sorted ascending, never {@code null}, may be empty, size may be less than the supplied list of IDs.
     */
