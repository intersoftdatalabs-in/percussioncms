...
/**
 * This class contains information for updating the section links. The old section ident. is
 * replaced with the new section in the supplied par
 *
 * @author BJoginipally
 */
...
public class PSUpdateSectionLink {
  ...
  /**
   * @param oldSectionId the string format of the guid of the old section, should not be blank for a
   *     valid request.
   */
  ...
  /**
   * @param newSectionId the string format of the guid of the new section, should not be blank for a
   *     valid request.
   */
  ...
  /**
   * @param parentSectionId the string format of the guid of the parent section, should not be blank
   *     for a valid request.
   */
