...
public class PSSiteImportCtx {
  ...
  public IPSSiteImportLogger getLogger() {
    if (logger == null) throw new IllegalStateException("logger has not been set");
  ...
  /**
   * Set the id of the template if one was created during the import process, must be called in
   * order for an import log to be saved.
   *
