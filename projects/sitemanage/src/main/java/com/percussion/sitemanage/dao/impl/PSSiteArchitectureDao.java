...
public class PSSiteArchitectureDao implements IPSSiteArchitectureDao {
  ...
  /**
   * Creates the object {@link PSSiteArchitecture} for the given site. Returns the structure
   * expanded upto the first level.
   *
   * @param name The name of the site for which the site architecture needs to be created.
