...
public abstract class PSAbstractRegion extends PSRegionNode {
  ...
  /**
   * Start xhtml tag of region. maybe <code>null</code>.
   *
   * @see #getStartTag()
   */
  ...
  /**
   * The start tag of the region. This should include the entire opening tag. This is all the
   * content from '<code>&lt;</code>' to '<code>&gt;</code>' inclusive.
   *
   * <p>Usually this is a div like:
   *
   * <pre>
  ...
  /**
   * The user defined CSS class selector for the region. The selector may or may not be in the
   * {@link #getStartTag() start tags} class attribute but in general <strong>it should be</strong>.
   *
  ...
  /**
   * The user defined attributes for the region.
   *
   * @return maybe empty or <code>null</code>.
   */
