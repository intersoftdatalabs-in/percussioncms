...
public class PSMetadataDocTypeUtils {
    ...
    /**
     * Converts the doc type value stored in the DB and generates a PSMetadataDocType object for the client.
     * PERC_XHTML -> xhtml, PERC_HTML5 -> html5, any other value is treated as custom.
     *
    ...
    /**
     * Provides the doc type to store in the DB. Used when a new template is added.
     * For new templates, the default doc type is HTML5.
     */
    ...
    /**
     * Provides the default doc type to set when a new template is created.
     * For new templates, the default doc type is HTML5.
     */
