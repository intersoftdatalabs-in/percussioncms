...
public interface IPSRenderLinkService {
  ...
  public PSRenderLink renderLinkThemeRegionCSS(
      ...
      throws IPSDataService.PSThemeNotFoundException, PSValidationException,
  ...
  /**
   * All Javascript links from the resource definitions that match the the supplied widget
   * definitions in order based on the resources dependency, all Javascript links percSystem
   * resource definition file is always added.
   *
   * @param context never <code>null</code>.
   * @param widgetDefIds set of widget definitions whose JavaScript resource definitions needs to be
   *     returned.
  ...
  /**
   * All CSS links from the resource definitions that match the the supplied widget definitions in
   * order based on the resources dependency, all CSS links percSystem resource definition file is
   * always added.
   *
   * @param context never <code>null</code>.
   * @param widgetDefIds set of widget definitions whose css resource definitions needs to be
   *     returned.
   ...
   * @param renderType this is the rendered type, "html", "xml" or "database". It is default to
   *     "html".
   ...
   * are <code>null</code> an {@link IllegalArgumentException} will be thrown.
   *
