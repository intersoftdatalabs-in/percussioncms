...
public class PSWidgetContentFinderUtils {
   ...
   * @return the list of relationships, sorted by "sort-rank" property, never {@code null}, but may
   *     be empty.
   */
   ...
   * @param relationshipName the name of the returned relationship. It may be {@code null} if the
   *     dependent can be either shared & local assets.
   * @return the list of relationships, sorted by "sort-rank" property, never {@code null}, but may
   *     be empty.
   */
   ...
   *     relationships/assets). Not {@code null}.
   ...
   * behave the same as the comparator defined in {@link PSRelationshipWidgetContentFinder}.
   */
