...
/**
 * Visitor pattern for region nodes.
 * Used to avoid casting and decouple visit order from the visitor.
 * The order of the visit is defined by different iterators.
 * @author adamgent
 */
