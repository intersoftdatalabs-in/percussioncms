...
public class PSTemplateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (isMultipart) {
            try {
                ...
                throw new ServletException("The file you attempted to import is not a CM1 template XML file. Choose a valid CM1 template XML file for upload", e);
            }
        }
    }
    ...
    private PSTemplate importTemplate(String siteId, FileItem item)
        ...
        try (var fileInput = item.getInputStream();
            ...
            var msg = "The file you attempted to import is not a Page template XML file. Choose a valid CM1 template XML file for upload";
