...
public class PSMetadataTagsHelper {
  ...
  /**
   * This method is responsible for return the JSONObject with the list properties with tags and
   * their occurrences. First iterate by page and later by PropertyPage.
   *
