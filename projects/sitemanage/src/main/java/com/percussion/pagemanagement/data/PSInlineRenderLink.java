 ...
 *
 * <p>There are many legacy properties that are needed for the inline link parser that will be
 * removed someday.
 *
 * @author adamgent
 */
...
public class PSInlineRenderLink extends PSRenderLink {
  ...
  /**
   * Legacy - Set Legacy sys_dependentvariantid User by link parser until parser is updated.
   *
  ...
  /**
   * Legacy - Set Legacy rxinlineslot Used by link parser until parser is updated.
   *
   * @param rxinlineslot
   */
  @Deprecated
  ...
  /**
   * Legacy - Set Legacy sys_dependentid Used by link parser until parser is updated.
   *
  ...
  /**
   * Legacy - Set Legacy inlinetype Used by link parser until parser is updated.
   *
   * @param inlinetype
   */
  @Deprecated
  ...
  /**
   * Set thumbnail url if image has a thumbnail. Empty if there isn't a thumbnail. Never <code>null
   * </code>
   *
   * @param thumbUrl
   */
  ...
  /**
   * Legacy - Sets sys_dependentvariantid Used by link parser until parser is updated.
   *
