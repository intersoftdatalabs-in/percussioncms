...
public class PSWidgetAssemblyContext extends PSAbstractAssemblyContext {
   ...
   *
   * @return a list of items. It cannot be <code>null</code>, but may be empty.
   */
  ...
  /**
   * Sets the 1st element of the widget content list, which is returned from {@link
   * #getWidgetContents()}.
   *
   * @param item the 1st element of the widget content list. It may be <code>null</code>, in this
   *     case do nothing.
   */
  ...
  /**
   * A convenience method, it simply return the 1st element of the widget content list, {@link
   * #getWidgetContents()}.
   *
   * @return the 1st element of the widget content list. It may be <code>null</code> if the widget
   *     content list is <code>null</code> or empty.
   */
