...
/**
 * This is the rendering result of a something in a region which can be one of two things:
 *
 * <p>{@link PSRegionResultType#WIDGET} or {@link PSRegionResultType#SUBREGION}.
 *
 * <p><em>Note: The rendering results of an entire region are a list of these objects.</em>
 *
 * @author adamgent
 */
public class PSRegionResult {
  ...
  /**
   * If this part of the region failed to render because an exception was thrown the exception can
   * be retrieved here.
   *
  ...
  /**
   * Dictates whether or not this region result is a widget rendering or a subregion.
   *
   * @author adamgent
   */
