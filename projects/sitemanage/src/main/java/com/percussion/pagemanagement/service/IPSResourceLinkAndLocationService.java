...
public interface IPSResourceLinkAndLocationService {
   ...
   * resource definition id should be fully qualified if its not <code>null</code>. If the resource
   ...
   * @param resourceDefinitionId The unique id for a resource definition. If <code>null</code> the
   *     resource definition with {@link PSAssetResource#isPrimary()} set to <code>true</code> for
   *     the items type ({@link IPSLinkableItem#getType()}) will be used.
