...
public class PSPageDao extends PSAbstractContentItemDao<PSPage> implements IPSPageDao {
  ...
  private void handleThumbnail(String id) {
    PSNotificationEvent notifyEvent = new PSNotificationEvent(EventType.PAGE_LOAD, id);
  ...
  public PSPage findPageByPath(String fullFolderPath) throws PSPageException {
    try {
      PSContentItem contentItem = getContentItemDao().findItemByPath(fullFolderPath);
      if (contentItem == null) {
        return null;
      }
  ...
  public PSPage findPage(String name, String folderPath) throws PSDataServiceException {
    PSContentItem contentItem = getContentItemDao().findItemByPath(name, folderPath);
  ...
  public void delete(String id, boolean force) throws PSDataServiceException {
    ...
    super.delete(id);
    PSNotificationEvent notifyEvent = new PSNotificationEvent(EventType.PAGE_DELETE, id);
    IPSNotificationService srv = PSNotificationServiceLocator.getNotificationService();
    srv.notifyEvent(notifyEvent);
  }
  ...
  protected void convertToObject(PSContentItem contentItem, PSPage page) {
    ...
    String templateContentMigrationVersion = (String) f.get("template_content_migration_version");
    String migrationEmptyWidgetFlag = (String) f.get("migrationemptywidgets");
