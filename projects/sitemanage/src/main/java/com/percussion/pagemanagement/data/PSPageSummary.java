...
public class PSPageSummary extends PSDataItemSummarySingleFolderPath {
    ...
    /**
     * Gets the meta tag noindex of the Page. If set to "true" noindex meta tag will be added to
     * page.
     *
     * @return the noindex
     */
    ...
    /**
     * Sets the meta tag noindex of the Page. If set to "true" noindex meta tag will be added to
     * page.
     *
