...
public class PSPageSummary extends PSDataItemSummarySingleFolderPath {
  ...
  /**
   * Checks the meta tag noindex of the Page. If set to "true" noindex meta tag will be added to
   * page.
   *
   * @return the noindex
   */
   ...
   *
   * @param linkTitle the link title for the page, never <code>null</code> or empty.
   */
   ...
   *
   * @param version the version to set, not <code>null</code>, non-numeric values are ignored.
   */
  ...
  /**
   * Flag to indicate whether content migration failed to migrate content into all the widgets are
   * not.
   *
  ...
  /**
   * @param migrationEmptyWidgetFlag Flag to indicate whether content migration failed to migrate
   *     content into all the widgets are not.
   */
