...
public class PSRegionTree extends PSRegionWidgetAssociations {
     ...
     * If the region tree is not empty, then the first element of the returned list
     * is the most outer region and there is only one outer region for a valid region tree.
     *
     * @return the list of descendant regions. It may be empty if there are no child regions, never {@code null}.
     * @throws IllegalStateException if there is more than one direct child region node under the root node.
     */
