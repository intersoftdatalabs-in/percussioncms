...
/**
 * This class is posted to the rest service as part of a request to find non-seo pages by path,
 * workflow, and workflow state. A keyword may also be specified to further refine the seo
 * validations.
 *
...
public class PSNonSEOPagesRequest extends PSItemByWfStateRequest {
  ...
  /**
   * @return the keyword which will be searched for as part of the request. May consist of one word
   *     or a set of words. May be <code>null</code> or empty.
   */
