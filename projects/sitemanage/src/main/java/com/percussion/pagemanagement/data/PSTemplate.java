...
public class PSTemplate extends PSTemplateSummary implements IPSHtmlMetadata {
  ...
  /**
   * The CSS styles that may override the ones defined in else where, such as in theme, it may be
   * <code>null</code> or empty.
   */
  private String cssOverride;

  /** The name of the theme that is used by the template. It may be <code>null</code> or empty. */
  private String theme;

  /** Contains the region tree for the template. Widgets are associated in the region tree. */
  @AssertValid private PSRegionTree regionTree;
  ...
  /** The server version for the exported template <code>null</code> or empty. */
  private String serverVersion;

  /**
   * The doc type that was entered manually by user. May be <code>null</code> or empty. Eg:
   * <!DOCTYPE html>
   */
  private PSMetadataDocType docType;

  /** The type of template. Eg: NORMAL or UNASSIGNED. It may be <code>null</code> or empty. */
  private String type;

  /**
   * Gets the region tree for the template. Widgets are associated in the region tree.
   *
   ...
   *
   * @param bodyMarkup the new body mark-up content, may be <code>null</code> or empty.
   */
  ...
  /**
   * Gets the HTML header property. It is used for the head section of an HTML page.
   *
   ...
   *
   * @param cssRegion the new CSS styles for regions defined in the template, may be <code>null
   *     </code> or empty.
   */
  ...
  /**
   * Gets the CSS override property, which contains the CSS styles that may override the ones
   * defined else where, such as in the theme.
   *
  ...
  public void setTheme(String theme) {
    if (theme != null && theme.length() > MAX_THEME) theme = theme.substring(0, MAX_THEME);
   ...
   * @return <code>true</code> if the template has an instance of the widget, <code>false</code>
   *     otherwise.
   */
  ...
  /**
   * Gets the type of the template. Possible values are NORMAL or UNASSIGNED.
   *
  ...
  /**
   * Sets the type of the template. Possible values are NORMAL or UNASSIGNED.
   *
   * @param type - the type of template
   */
  @Override
  public void setType(String type) {
    if (type != null && type.length() > MAX_TYPE) type = type.substring(0, MAX_TYPE);

    this.type = type;
  }

  /** Public enum for the templates type. Possible values are NORMAL and UNASSIGNED */
