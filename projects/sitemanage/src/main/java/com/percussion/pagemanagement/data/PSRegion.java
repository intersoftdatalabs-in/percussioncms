...
public class PSRegion extends PSAbstractRegion {
  ...
  /**
   * Gets all regions, which includes the region itself and all descendant regions. The first
   * element is the region itself, followed by its direct child regions, and so forth.
   *
