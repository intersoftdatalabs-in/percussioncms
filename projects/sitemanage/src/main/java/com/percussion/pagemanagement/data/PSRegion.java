...
public class PSRegion extends PSAbstractRegion {
  ...
  /**
   * Gets all regions, which includes the region of itself and all descendant regions. The 1st
   * element is the region itself, followed by its direct child region, and so forth.
   *
