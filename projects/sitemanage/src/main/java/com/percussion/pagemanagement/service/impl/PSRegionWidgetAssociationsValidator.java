...
/**
 * Validates Region Widget Associations. Ensures there are no duplicate regionIds and validates
 * widget items.
 *
 * @param <BEAN> Page or Template
 * @author adamgent
 */
public abstract class PSRegionWidgetAssociationsValidator<BEAN>
    extends PSAbstractBeanValidator<BEAN> {
  ...
  public abstract PSRegionWidgetAssociations getWidgetAssociations(
      BEAN wa, PSBeanValidationException e);

  protected void doWidgetAssociations(
      PSRegionWidgetAssociations associations, PSBeanValidationException e) {
