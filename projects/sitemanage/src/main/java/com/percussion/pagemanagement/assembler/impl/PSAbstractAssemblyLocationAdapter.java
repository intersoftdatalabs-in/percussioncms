...
/**
 * An adapter for legacy location scheme generators. The location scheme parameters are wrapped in a
 * more friendly object: {@link PSAssemblyLocationRequest}.
 *
 * @author adamgent
 */
public abstract class PSAbstractAssemblyLocationAdapter implements IPSAssemblyLocation {
  ...
  /**
   * Wraps all the parameters passed into a location scheme generator. Most of the ids have been
   * converted to GUIDs.
   *
   * @author adamgent
   */
  public static class PSAssemblyLocationRequest {
    ...
    @NotNull private IPSGuid itemId;
    @NotNull private IPSGuid templateId;
    @NotNull private IPSGuid siteId;
    private IPSGuid folderId;
    @NotNull private Number context;
