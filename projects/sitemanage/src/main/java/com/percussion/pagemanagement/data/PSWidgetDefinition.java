...
public class PSWidgetDefinition extends PSAbstractPersistantObject {
   ...
   *
   * <p>This nested type used to be generated from PSWidgetDefinition.xsd in
   * earlier branches; it was accidentally removed during refactoring and
   * caused numerous "cannot find symbol Resource" compile errors.
   */
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "")
