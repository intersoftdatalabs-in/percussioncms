...
public interface IPSWidgetService
   ...
   */
  PSSpringValidationException validateWidgetItem(PSWidgetItem widgetItem)
   ...
   *
   * @param type The type of the widgets, widget types are set to one of the PSWidgetTypeEnum.
   * @param filterDisabledWidgets If equals (case-insensitive) "yes", then disabled widgets are
   *     filtered from the returned list.
   * @return List of widget summaries, never {@code null}, may be empty.
   * @throws PSDataServiceException If a data service error occurs.
   */
  List<PSWidgetSummary> findByType(String type, String filterDisabledWidgets)
   ...
   *     widget is not found, no result for that widget is included.
   */
