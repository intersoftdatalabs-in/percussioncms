 ...
 * <p>
 * Its responsibilities are to create resource instances and manage executing them
...
public class PSResourceInstanceHelper {
    ...
    private List<PSResourceLinkAndLocation> executeResourceLinkScript(PSResourceInstance resourceInstance, String script)
        ...
        try {
            ...
            if (rvalue instanceof List) {
                ...
                if (log.isDebugEnabled()) {
                    log.debug("Script did not return an object of type : {}", PSResourceLinkAndLocation.class.getSimpleName());
                }
            }
    ...
    public PSResourceInstance createResourceInstance(
            ...
            throws IPSAssetService.PSAssetServiceException, DataServiceNotFoundException, PSValidationException {
