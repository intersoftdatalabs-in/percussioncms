...
/**
 * Loads and manages {@link PSResourceDefinitionGroup}s and {@link PSResourceDefinition}s. This
 * service does <em>NOT</em> convert the resources to preview/publish links.
 *
 * @author adamgent
 */
public interface IPSResourceDefinitionService
   ...
   * PSResourceDefinitionGroup} that contains them and their own id with {@link
