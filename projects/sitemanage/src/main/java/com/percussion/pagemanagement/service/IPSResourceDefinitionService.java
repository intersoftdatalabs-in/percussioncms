...
/**
 * Loads and {@link PSResourceDefinitionGroup}s and {@link PSResourceDefinition}. This service does
 * <em>NOT</em> convert the resources to preview/publish links.
 *
 * @author adamgent
 */
public interface IPSResourceDefinitionService
    extends IPSCatalogService<PSResourceDefinitionGroup, String> {

  /**
   * {@link PSResourceDefinition} have a global unique identifier based on the {@link
   * PSResourceDefinitionGroup} that contains them and there own id with {@link
   * #NAMESPACE_SEPARATOR} between them.
   */
   ...
   */
  PSResourceDefinitionGroup find(String id)
      throws DataServiceLoadException, PSResourceDefinitionGroupNotFoundException;

  /**
   * Finds a resource based on the uniqueId. For unique id see {@link #createUniqueId(String,
   * String)}.
   *
   ...
   * @author adamgent
   */
  public static class PSResourceDefinitionGroupNotFoundException
      extends DataServiceNotFoundException {
