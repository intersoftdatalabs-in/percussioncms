...
/**
 * Data access object for PSPage entities. Provides methods for finding, saving, and deleting pages
 * and their summaries.
 */
public interface IPSPageDao extends IPSGenericDao<PSPage, String> {
   ...
   *
   * @param path the internal folder path. If blank, result is same as {@link
   ...
   * @param force {@code true} to delete even if being edited by another user, {@code false}
   *     otherwise.
   */
