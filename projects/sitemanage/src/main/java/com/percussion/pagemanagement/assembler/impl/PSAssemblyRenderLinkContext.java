...
public class PSAssemblyRenderLinkContext extends PSRenderLinkContext {
  ...
  /**
   * This is the assembly context which is normally <code>sys_context</code> or <code>
   * sys_assembly_context</code>. parameter in the assembly url.
   *
  ...
  /**
   * This is the delivery context which is the context used to generate file locations in in the
