...
public class PSTemplateSummary extends PSAbstractPersistantObject {
  ...
  /**
   * The ID of the Template, initialized by constructor, never <code>null</code> or modified after
   * that.
   */
  @NotEmpty private String id;

  /**
   * The name of the Template, initialized by constructor, never <code>null</code>, empty or
   * modified after that.
   */
  @NotNull @NotEmpty private String name;

  /** The label of the Template, initialized by constructor, may be <code>null</code> or empty. */
  private String label;

  /**
   * The description of the Template, initialized by constructor, may be <code>null</code> or empty.
   */
  private String description;

  /**
   * The path of thumb sized image of the Template, initialized by constructor, never <code>null
   * </code> or empty after that. Refer to {@link #getImageThumbPath()} for more details.
   */
  private String imageThumbPath;

  /** Indicates if the Template is ready only, see {@link #isReadOnly()} for more details. */
  private boolean isReadOnly;

  /**
   * The name of the source template, which was used to create this template. It may be <code>null
   * </code> or empty if it has not been properly set.
   */
  private String sourceTemplateName;

  /**
   * The type of template. Eg: NORMAL or UNASSIGNED It may be <code>null</code> if it has not been
   * properly set.
   */
  private String type;
  ...
  public void setLabel(String label) {
    if (label != null && label.length() > MAX_LABEL) label = label.substring(0, MAX_LABEL);
   ...
   *
   * @param srcTemplate the new source template name, never <code>null</code> or empty.
   */
  ...
  public void setType(String type) {
    if (type.length() > MAX_TYPE) type = type.substring(0, MAX_TYPE);
