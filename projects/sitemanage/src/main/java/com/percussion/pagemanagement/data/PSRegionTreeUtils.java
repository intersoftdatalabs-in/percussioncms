...
public class PSRegionTreeUtils {
   ...
   * href="http://en.wikipedia.org/wiki/Tree_traversal">http://en.wikipedia.org/wiki/Tree_traversal</a>
   *
   * @param rootNode
   * @param visitor
   */
   ...
   * that does not contain another regions.
   *
  ...
  /**
   * Gets the leaf regions of the template and returns those that don't have widgets in it.
   *
   * @param regionTree
   * @return {@link Set}<{@link PSRegion}> never <code>null</code>.
   */
   ...
   * @return <code>true</code> if the region is leaf, <code>false</code> otherwise.
   */
