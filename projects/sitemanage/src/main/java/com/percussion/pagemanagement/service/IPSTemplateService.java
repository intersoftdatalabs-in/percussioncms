...
public interface IPSTemplateService extends IPSDataService<PSTemplate, PSTemplateSummary, String> {
     ...
     * @throws PSTemplateException If a template error occurs.
     */
    List<PSTemplateSummary> findAll(String siteName) throws IPSGenericDao.LoadException, PSTemplateException;
     ...
     * @throws PSTemplateException If a template error occurs.
     */
    List<PSTemplateSummary> loadUserTemplateSummaries(List<String> ids, String siteName) throws PSTemplateException;
     ...
     */
    @Deprecated
    PSTemplateSummary findUserTemplateByName_UsedByUnitTestOnly(String name) throws PSDataServiceException;
     ...
     */
    IPSGuid findUserTemplateIdByName(String templateName, String siteName) throws PSValidationException, DataServiceLoadException;
     ...
     * @throws PSTemplateException If a template error occurs.
     */
    PSTemplate exportTemplate(String id, String name) throws PSValidationException, PSTemplateException;
     ...
     */
    PSTemplate importTemplate(PSTemplate template, String siteId) throws PSDataServiceException, IPSPathService.PSPathNotFoundServiceException;
