...
public interface IPSTemplateService extends IPSDataService<PSTemplate, PSTemplateSummary, String> {
  ...
  public PSTemplateSummary createNewTemplate(
      String plainBaseTemplateName, String templateName, String id)
   ...
   *
   * @param type The type of the base templates, may be null or empty. @see IPSTemplateDao for
   *     details
   * @return a list of requested Templates. It can never be <code>null</code>, but may be empty. The
   *     order of the list is undetermined.
   */
   ...
   * @param srcId the ID of the source template, may not be <code>null</code> or empty.
   ...
   * @param siteId the ID of the site, it may be <code>null</code> assumed the template has already
   *     attached to a site.
   ...
   * @throws com.percussion.share.service.IPSDataService.DataServiceSaveException if there is any
   *     unexpected error.
   */
   ...
   *     content migration has been executed between the page and template, which requires the page
   *     to be validated to exist and to be checked out.
   * @return the saved template, never <code>null</code>.
   * @throws PSBeanValidationException if there is any invalid properties in the template.
   * @throws com.percussion.share.service.IPSDataService.DataServiceSaveException if there is any
   *     unexpected error.
   */
  public PSTemplate save(PSTemplate template, String siteId, String pageId)
  ...
  /**
   * This method is a wrapper to expose as a service the following method: {@link
   * com.percussion.pagemanagement.dao.IPSTemplateDao#getTemplateThumbPath(PSTemplateSummary,
   * String)}
   *
   * <p>For additional information please refer to it.
   */
  public String getTemplateThumbPath(PSTemplateSummary summary, String siteName);

  /**
   * Returns PSTemplateMetadata object with the following Data set: additional_head_content
   * code_insert_before_body_close code_insert_after_body_start
   *
  ...
  /**
   * Saves/Replaces The following metadata field of a template additional_head_content
   * code_insert_before_body_close code_insert_after_body_start
   *
   ...
   *
   * @param id the ID of the specified template, never blank.
   * @param force <code>true</code> to delete the template even if it is in use, <code>false</code>
   *     otherwise.
   */
   ...
   * @return <code>true</code> if the template is being used by one or more pages, <code>false
   *     </code> otherwise.
   */
