...
public interface IPSPageService extends IPSDataService<PSPage, PSPage, String> {
    ...
    /**
     * Deletes the specified page. All local content of the page will also be deleted.
     * The page will not be deleted if it is being edited by another user.
     *
     * @param id The ID of the page, never <code>null</code> or empty.
     */
     ...
     *
     * @param pageId The ID of the page to update, must specify an existing page, and the page must be checked out to the current user.
     * @throws PSDataServiceException If a data service error occurs.
     */
     ...
     *
     * @param pageId The ID of the page to get the flag, must specify an existing page, and the page must be checked out to the current user.
     ...
     * @throws PSDataServiceException If a data service error occurs.
     */
    List<PSPageReportLine> findAllPages(String siteName) throws PSReportFailedToRunException, PSDataServiceException;
     ...
     * @throws PSPageException If an error occurs.
     */
    PSUnassignedResults getUnassignedPagesBySite(String siteName, Integer startIndex, Integer maxResults) throws PSPageException;
