...
public interface IPSTemplateDao extends IPSGenericDao<PSTemplate, String> {
   ...
   */
  IPSAssemblyTemplate loadBaseTemplateById(IPSGuid id)
   ...
   * @return the template, never {@code null}.
   */
  PSAssemblyTemplate loadBaseTemplateByName(String name)
      throws IPSTemplateService.PSTemplateException;
   ...
   *
   * @return all template summaries, never {@code null}, may be empty, sorted alphabetically by
   *     name.
   */
  List<PSTemplateSummary> findAllSummaries()
   ...
   * @return template summaries, never {@code null}, may be empty, sorted alphabetically by name.
   */
  List<PSTemplateSummary> findAllSummaries(String siteName)
      throws com.percussion.share.dao.IPSGenericDao.LoadException,
          IPSTemplateService.PSTemplateException;
   ...
   */
  PSTemplate generateTemplateToExport(String id, String name)
      throws IPSTemplateService.PSTemplateException;
   ...
   * @return the loaded template.
   */
  PSTemplate generateTemplateFromSource(PSTemplate template, String siteId)
   ...
   */
  List<PSTemplate> findUserTemplatesByType(PSTemplateTypeEnum type)
      throws IPSTemplateService.PSTemplateException;
   ...
   */
  List<PSTemplateSummary> findAllUserTemplateSummariesByType(PSTemplateTypeEnum type)
      throws IPSTemplateService.PSTemplateException;
