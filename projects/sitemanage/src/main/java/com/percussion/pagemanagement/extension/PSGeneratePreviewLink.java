...
public class PSGeneratePreviewLink extends com.percussion.extension.PSSimpleJavaUdfExtension {
   ...
   *
   * @param params the parameters for this extension, never <code>null</code>. It contains the
   *     content ID (1st element) and revision (2nd element) of the page or asset in question.
