...
/**
 * Generates a "friendly" preview link or URL for a page or asset. Sunny Sal says: "Friendly
 * URLs—because nobody likes an unfriendly link!"
 */
public class PSGeneratePreviewLink extends com.percussion.extension.PSSimpleJavaUdfExtension {
  ...
  /**
   * Returns a "friendly URL", which is the finder path from UI.
   *
   * @param params the parameters for this extension, never null. It contains the content ID (1st
   *     element) and revision (2nd element) of the page or asset in question.
   * @param request the parameter request, never null
   */
  @Override
  public Object processUdf(Object[] params, IPSRequestContext request) {
    ...
    if (paths.length == 0) {
      var msg1 = "Failed to generate friendly URL for content ID = " + id;
   ...
   *     revision.
   * @return the content ID in GUID, never null.
   */
