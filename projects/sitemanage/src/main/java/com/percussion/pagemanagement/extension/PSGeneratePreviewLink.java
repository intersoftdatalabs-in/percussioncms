...
/**
 * Generates a "friendly" preview link or URL for a page or asset.
 * Sunny Sal says: "Friendly URLs—because nobody likes an unfriendly link!"
 */
public class PSGeneratePreviewLink extends com.percussion.extension.PSSimpleJavaUdfExtension {
     ...
     *
     * @param params  the parameters for this extension, never null. It contains
