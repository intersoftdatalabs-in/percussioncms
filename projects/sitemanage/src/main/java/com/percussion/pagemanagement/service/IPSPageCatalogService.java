...
public interface IPSPageCatalogService {
  ...
  /**
   * Catalogs a page, creating a "page stub" as a placeholder. The specified page cannot be
   * cataloged and returns <code>null</code> in the following scenarios:
   *
   * <ul>
   *   <li>The maximum number of cataloged pages has been reached.
   *   <li>The page already exists for that name and folder path.
   *   <li>The page already exists under the (imported) normal location of the site.
   *   <li>There is already a page with the specified folder path.
   * </ul>
   *
   * @param siteName The name of the site for which the page is cataloged, not <code>null</code> or
   *     empty.
   ...
   * @param folderPath The folder path relative from the root of the site, including the leading
   *     "/". Not <code>null</code> or empty.
   * @param linkText The link text of the page.
   * @return The saved page stub, or <code>null</code> if one of the scenarios described above is
   *     met.
   * @throws Exception if there are any unexpected errors.
   */
  PSPage addCatalogPage(
  ...
  /**
   * Moves the cataloged page from the "page stub" location to the local location. If the local
   ...
   * @return <code>true</code> if the page already exists under the given site, <code>false</code>
   *     otherwise.
   */
