...
public class PSResourceDefinitionService implements IPSResourceDefinitionService {
  ...
  @Autowired
  public PSResourceDefinitionService(
      IPSResourceDefinitionGroupDao dao, IPSThemeService themeService) {
    super();
    this.dao = dao;
  ...
  /** {@inheritDoc} */
  @Override
  public PSResourceDefinitionGroup find(String id)
  ...
  public PSResourceDefinition findResource(String uniqueId) throws PSDataServiceException {
    ...
    if (rd == null)
      throw new PSResourceDefinitionNotFoundException(
          "No resource found for uniqueId: " + uniqueId);
    return rd;
  }

  public PSResourceDefinitionGroup save(PSResourceDefinitionGroup object)
      throws PSDataServiceException {
    return dao.save(object);
  }

  /** {@inheritDoc} */
  public PSAssetResource findDefaultAssetResourceForType(String contentType)
      throws PSDataServiceException {
    PSAssetResource resource = dao.findAssetResourceForType(contentType);
    if (resource == null)
      throw new PSResourceDefinitionNotFoundException(
          "Not primary asset for content type: " + contentType);
    return resource;
  }
  ...
  /**
   * Checks to see if this resource is a theme resource. If it is a resource definition is returned.
   *
