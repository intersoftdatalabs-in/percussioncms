...
public class PSResourceDefinitionUtils {
    /**
     * Sorts a list of resources by its dependencies such that if resource 'b' is
     * depends on resource 'a', resource 'b' will be somewhere after resource 'a' in
     * the returned list. <strong>Note: If a resource depends on another resource it
     * is not guarenteed to be directly after the resource it depends on.</strong>
     *
    ...
    /**
     * Thrown when there is a cyle. Example would be 'a' depends on 'b' which depends
