...
public class PSMergedRegionTree extends PSAbstractMergedRegionTree {
   ...
   * {@inheritDoc}
   *
   * <p>This implementation chooses the page if and only if the templates region is has no widgets
   * or subregions.
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * <p><strong>This implementation will expand if the region has children regardless if its a page
   * or template.</strong>
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * <p>Will prefer the templates widgets over the pages widgets if there is a conflict.
   */
  @Override
