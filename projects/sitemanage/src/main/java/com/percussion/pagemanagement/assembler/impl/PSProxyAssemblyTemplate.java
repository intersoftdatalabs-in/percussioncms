...
/**
 * A decorator around the real assembly template to enhance performance with cloning and memory foot
 * print. The template,bindings, and assembler properties are not wrapped.
 *
 * @author adamgent
 */
