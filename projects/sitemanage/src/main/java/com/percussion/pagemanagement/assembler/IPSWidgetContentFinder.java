...
/**
 * Widget finders calculate what assets are related to a particular page or template via a widget.
 ...
 *
 * <p>Widget finders are reusable across pages or templates, they are referenced by the widget
 * preferences.
 */
