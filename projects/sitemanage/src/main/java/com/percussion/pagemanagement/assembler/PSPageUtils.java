...
/**
 * Utility class to provide various JEXL methods for the templates used by page or widget.
 *
 * <p>NOTE: That if you add JEXL methods to this class they will only be registered if you update
 * the
 * /CMLite-Main/Packages/perc.Baseline/Extension-Java/global/percussion/system/pageutils.extension
...
public class PSPageUtils extends PSJexlUtilBase {
  ...
  @IPSJexlMethod(
      description =
          "parseHtmlFragment can be used to parse a fragment of HTML and return an Element that can"
              + " be manipulated",
      params = {@IPSJexlParam(name = "htmlFragment", description = "An HTML fragment to parse.")},
      returns = "An org.jsoup.nodes.Element instance representing the HTML fragment.")
  ...
  @IPSJexlMethod(
      description = "Returns the Major.Minor version string for the product.",
      params = {},
      returns = "String")
  ...
  @IPSJexlMethod(
      description = "Returns the detailed version string for the product.",
      params = {},
      returns = "String")
  ...
  @IPSJexlMethod(
      description =
          "Validates that the path / url passed in resolves to a resource that has a 20X http"
              + " status code.",
      params = {
        @IPSJexlParam(description = "Link (relative or absolute to be checked.", name = "link"),
        @IPSJexlParam(description = "Publishing context name", name = "context"),
        @IPSJexlParam(
            description =
                "Set to true to not cache this link. false to use caching.  By default all links"
  ...
  @IPSJexlMethod(
      ...
      params = {
        @IPSJexlParam(
            name = "linkContext",
            description = "The link context. Use $perc.linkContext"),
        @IPSJexlParam(name = "linkableItem", description = "An asset or page.")
      },
      returns = "PSRenderLink")
  ...
  @IPSJexlMethod(
      description = "Renders a list of javascript links",
      params = {
        @IPSJexlParam(
            name = "linkContext",
            description = "The link context. Use $perc.linkContext"),
  ...
  @IPSJexlMethod(
      description = "Renders a list of css links",
      params = {
        @IPSJexlParam(
            name = "linkContext",
            description = "The link context. Use $perc.linkContext"),
  ...
  @IPSJexlMethod(
      description = "Renders a relative path to the login page",
      params = {
        @IPSJexlParam(
            name = "sitename",
            description = "The name of the site to load the login page property")
      },
      returns = "String")
  ...
  @IPSJexlMethod(
      description = "Renders a relative path to the registration page",
      params = {
        @IPSJexlParam(
            name = "sitename",
            description = "The name of the site to load the registration page property")
      },
      returns = "String")
  ...
  @IPSJexlMethod(
      description = "Renders a relative path to the registration confirmation page",
      params = {
        @IPSJexlParam(
            name = "sitename",
            description =
                "The name of the site to load the registration confirmation page property")
      },
      returns = "String")
  public String getSiteRegistrationConfirmationPage(String sitename) {
    try {
      ...
      log.error(
          LOG_ERROR_DEFAULT,
          "getSiteRegistrationConfirmationPage",
  ...
  @IPSJexlMethod(
      description = "Renders a relative path to the reset page",
      params = {
        @IPSJexlParam(
            name = "sitename",
            description = "The name of the site to load the reset page property")
      },
      returns = "String")
  ...
  @IPSJexlMethod(
      description = "Renders a relative path to the reset request password page",
      params = {
        @IPSJexlParam(
            name = "sitename",
            description = "The name of the site to load the reset request password page property")
      },
      returns = "String")
  ...
  @IPSJexlMethod(
      description =
          "Create a clone of the current assemblyItem if an id is passed the clone will be modified"
              + " to that id.",
      params = {
  ...
  @IPSJexlMethod(
      description = "Tries to generate an IPSGuid object from different object types",
      params = {@IPSJexlParam(name = "id", description = "The id to convert to a guid")},
      returns = "IPSGuid")
  public IPSGuid parseGuid(Object idObj) {
    ...
    if (idObj instanceof IPSGuid) {
      ...
      throw new RuntimeException(
          "Cannot parse guid or content id object "
              + idObj.toString()
              + " of type "
              + idObj.getClass().toString());
    }
    return guid;
  }

  @IPSJexlMethod(
      description = "Returns region information about a page.",
      params = {
        @IPSJexlParam(name = "item", description = "the parent (page/template) assembly item")
      },
      returns = "PSAbstractMergedRegionTree")
  ...
  @IPSJexlMethod(
      description =
          "Find a list of WidgetInstances for an assemblyItem, will filter by regionName and/or"
              + " widgetName if not null ",
      params = {
        @IPSJexlParam(name = "item", description = "the parent (page/template) assembly item"),
        @IPSJexlParam(name = "regionName", description = "The name of the region to filter by"),
        @IPSJexlParam(name = "widgetName", description = "The name of the widget to filter by")
      },
      returns = "List<PSWidgetInstance>")
  public List<PSWidgetInstance> findWidgetInstances(
      IPSAssemblyItem assemblyItem, String regionName, String widgetName) {
  ...
  @IPSJexlMethod(
      ...
      params = {
        @IPSJexlParam(
            name = "regionTree",
            description = "the PSAbstractMergedRegionTree to find from"),
        @IPSJexlParam(name = "regionName", description = "The name of the region to filter by"),
        @IPSJexlParam(name = "widgetName", description = "The name of the widget to filter by")
      },
      returns = "List<PSWidgetInstance>")
  public List<PSWidgetInstance> findWidgetInstances(
      PSAbstractMergedRegionTree regionTree, String regionName, String widgetName) {
  ...
  /**
   * Helper method to get set of widget definitions for the supplied assembly item.
   *
   * @param item if <code>null</code> returns empty set.
   * @return Set of widget definition ids, never <code>null</code>, may be empty.
   */
  private Set<String> getWidgetDefIds(IPSAssemblyItem item)
      throws PSDataServiceException, RepositoryException {
    ...
    widgetList.stream().map(PSWidgetItem::getDefinitionId).forEach(widgetDefIds::add);
    return widgetDefIds;
  }

  @IPSJexlMethod(
      description = "Strip javascript",
      params = {
        @IPSJexlParam(name = "source", description = "The source that may contain javascript")
      },
      returns = "The text without javascript")
  ...
  @IPSJexlMethod(
      ...
      returns = "The text without canonical link")
  ...
  @IPSJexlMethod(
      ...
      returns = "true if the source contains canonical link, false otherwise")
  public boolean checkLinkCanonical(String source) {
    return PSHtmlUtils.checkLinkCanonicalElement(source);
  }

  @IPSJexlMethod(
      description = "Renders a Link of a landing page for the given navigation node.",
      params = {
        @IPSJexlParam(
            name = "linkContext",
            description = "The link context. Use $perc.linkContext"),
        @IPSJexlParam(name = "navNode", description = "A navigation node.")
      },
      returns = "PSRenderLink")
  ...
  @IPSJexlMethod(
      description = "Renders a Link to an item",
      params = {
        @IPSJexlParam(
            name = "linkContext",
            description = "The link context. Use $perc.linkContext"),
        ...
        @IPSJexlParam(
            ...
            description = "the fully qualified resourceDefinitionId")
      },
      returns = "PSRenderLink")
  public PSRenderLink itemLink(
      PSRenderLinkContext linkContext, IPSLinkableItem linkableItem, String resourceDefinitionId) {
    try {
  ...
  @IPSJexlMethod(
      description = "Renders a Link to a folder",
      params = {
        @IPSJexlParam(
            name = "linkContext",
            description = "The link context. Use $perc.linkContext"),
  ...
  @IPSJexlMethod(
      description = "Renders a Link to a file",
      params = {
        @IPSJexlParam(
            name = "linkContext",
            description = "The link context. Use $perc.linkContext"),
  ...
  @IPSJexlMethod(
      description = "Renders a Link to a theme CSS file",
      params = {
        @IPSJexlParam(
            name = "linkContext",
            description = "The link context. Use $perc.linkContext"),
  ...
  @IPSJexlMethod(
      description = "Renders a Link to the region's CSS file of a theme",
      params = {
        @IPSJexlParam(
            name = "linkContext",
            description = "The link context. Use $perc.linkContext"),
        ...
        @IPSJexlParam(name = "editType", description = "edit type")
      },
      returns = "PSRenderLink")
  public PSRenderLink themeRegionCssLink(
      PSRenderLinkContext linkContext, String theme, Boolean isEdit, EditType editType) {
    try {
      theme = isNotBlank(theme) ? theme : "percussion";
      return renderLinkService.renderLinkThemeRegionCSS(linkContext, theme, isEdit, editType);
    } catch (IPSDataService.PSThemeNotFoundException
        | PSValidationException
        | IPSResourceDefinitionService.PSResourceDefinitionInvalidIdException e) {
  ...
  /**
   * Gets the contents (or items) of a widget that are relate to the specified page and/or template.
   *
   * <p>Note, if the specified item is a page , then the returned items are relate to the page's
   * template if there is any; otherwise return the items that are relate to the page itself.
   *
   * @param item the page or template item, never <code>null</code>.
   * @param widget the ID of the widget, never blank.
   * @param finderName the name of the widget content finder. It defaults to {@link
   *     #DEFAULT_WIDGET_CONTENT_FINDER}. if the finder name is not specified.
   * @param params extra parameters for the finder, may be <code>null</code> or empty.
   * @return a list of asset items.
   */
  @IPSJexlMethod(
      description =
          "Gets the items of a widget that are relate to the specified page and/or template.  If"
              + " not found it will look for same widget on landing page and then ancestor landing"
              + " pages",
      params = {
        @IPSJexlParam(name = "item", description = "the parent (page/template) assembly item"),
        ...
        @IPSJexlParam(
            name = "finder",
            description = "the fully qualified name of the content finder"),
        @IPSJexlParam(name = "params", description = "extra parameters to the process"),
        @IPSJexlParam(name = "regionName", description = "Optional regionName to find widget")
      },
      returns = "list of assembly items")
  public List<PSRenderAsset> firstAncestorWidgetContents(
    ...
    if (CollectionUtils.isEmpty(widgetContents)) {
      ...
      for (int i = ancestors.size() - 1; i >= 0; i--) {
        ...
        landingAssemblyItem.setParameterValue(
            IPSHtmlParameters.SYS_CONTENTID, String.valueOf(guid.getUUID()));
        ...
        List<PSWidgetInstance> newWidgetInstances =
            findWidgetInstances(landingAssemblyItem, regionName, widgetName);
        if (!CollectionUtils.isEmpty(newWidgetInstances)) {
          PSWidgetInstance newWidgetInstance = newWidgetInstances.get(0);
          List<PSRenderAsset> testWidget =
              widgetContents(landingAssemblyItem, newWidgetInstance, null, null, false);
  ...
  @IPSJexlMethod(
      ...
      returns = "list of assembly items")
  public List<PSRenderAsset> widgetContents(
      IPSAssemblyItem item, Object widget, String finderName, Map<String, Object> params) {
    return widgetContents(item, widget, finderName, params, false);
  }

  @IPSJexlMethod(
      description = "Returns if item is in recycler.",
      params = {@IPSJexlParam(name = "itemId", description = "itemId")},
      returns = "boolean")
  ...
  /**
   * If the user entered format is within the SimpleDateFormat pattern string then returns the date
   * string according to it Ex: if the format is "a" then it is a valid one and return string would
   * be AM/PM.. If other than the SimpleDateFormat supported pattern string then it returns the
  ...
  @IPSJexlMethod(
      description =
          "Verify if the entered date format is correct or not for the SimpleDateFormat. If not"
              + " system returns the default error format",
      params = {
        @IPSJexlParam(name = "format", description = "Date Format entered by user"),
        @IPSJexlParam(name = "defaultFormat", description = "System Default format")
      },
      returns = "dateformat")
  ...
  @IPSJexlMethod(
      description = "Parse the metadata string into key/value pairs",
  ...
  /**
   * Method to update the managed links during the assembly. This is a thin wrapper, calls
   * IPSManagedLinkService for actual work.
   *
   * @param linkContext The render link context assumed not <code>null</code>.
   * @param source The source String in which the links needs to be updated, may be <code>null
   *     </code> or empty. If blank returns blank.
   * @return String updated source html.
   */
  @IPSJexlMethod(
      description = "Updates the managed links in the given source",
      params = {
        @IPSJexlParam(
            name = "linkContext",
            description = "The link context. Use $perc.linkContext"),
        @IPSJexlParam(
            name = "source",
            description = "The source html in which the managed links needs to be updated."),
        @IPSJexlParam(name = "parentId", description = "The parentId for the item under management")
      },
      returns = "managed links updated source")
  public String updateManagedLinks(
      PSRenderLinkContext linkContext, String source, String parentId) {
    if (StringUtils.isBlank(source)) {
      return source;
    }
    return managedLinkService.renderLinks(
        linkContext, source, Boolean.FALSE, Integer.parseInt(parentId));
  }

  /**
   * Method to update the managed links in a JSON payload during assembly. This is a thin wrapper,
   * calls IPSManagedLinkService for actual work.
   *
   * @param linkContext The render link context assumed not <code>null</code>.
   * @param source The source String in which the links needs to be updated, may be <code>null
   *     </code> or empty. If blank returns blank.
  ...
  @IPSJexlMethod(
      ...
      params = {
        ...
        @IPSJexlParam(
            name = "source",
            description = "The source JSON in which the managed links needs to be updated.")
      },
      returns = "managed links updated source")
  ...
  @IPSJexlMethod(
      ...
      params = {
        ...
        @IPSJexlParam(
            name = "serverId",
            description = "The serverId to determine whether it is a staging publishing or not."),
        @IPSJexlParam(name = "parentId", description = "The parentId for the item under management")
      },
      returns = "managed links updated source")
  public String updateManagedLinks(
      PSRenderLinkContext linkContext, String source, Long serverId, String parentId) {
    if (StringUtils.isBlank(source)) {
      return source;
    }
    return managedLinkService.renderLinks(
        linkContext, source, isStagingServer(serverId), Integer.parseInt(parentId));
  }

  /**
   * Checks whether pub server corresponding to the server id is a staging server or not. If server
   * id is <code>null</code> or not valid then returns <code>false</code>
   *
   * @param serverId
   * @return <code>true</code> if server id is not null and a pub server exists corresponding to the
   *     server id and it is a staging pub server.
   */
  private Boolean isStagingServer(Long serverId) {
    ...
    if (serverId != null) {
      try {
        ...
        log.warn(
            "Error finding the server corresponding to the supplied server id ("
                + serverId
  ...
  /**
   * Method to render the managed item path during the assembly. This is a thin wrapper, calls
   * IPSManagedLinkService for actual work.
   *
   * @param linkContext The render link context assumed not <code>null</code>.
   * @param linkId The id of the link to render, if <code>null</code> or empty returns "#".
   * @return The rendered path
   */
  @IPSJexlMethod(
      description = "Renders the item path for the given link id",
      params = {
        @IPSJexlParam(
            name = "linkContext",
            description = "The link context. Use $perc.linkContext"),
      ...
      returns = "the rendered path, or \"#\" if not rendered")
  ...
  @IPSJexlMethod(
      ...
      params = {
        ...
        @IPSJexlParam(
            name = "linkId",
            description = "The id of the link that needs to be updated."),
        @IPSJexlParam(
            name = "serverId",
            description = "The serverId to determine whether it is a staging publishing or not.")
      },
      returns = "the rendered path, or \"#\" if not rendered")
  public String renderManagedItemPath(
      PSRenderLinkContext linkContext, String linkId, Long serverId) {
   ...
   * Gets the contents (or items) of a widget that are relate to the specified page and/or template.
   *
   * <p>Note, if the specified item is a page and <code>processPageAssetOnly</code> is <code>false
   * </code>, then the returned items are relate to the page's template if there is any.
   *
   * @param item the page or template item, never <code>null</code>.
   ...
   *     #DEFAULT_WIDGET_CONTENT_FINDER}. if the finder name is not specified.
   * @param params extra parameters for the finder, may be <code>null</code> or empty.
   * @param processPageAssetOnly if <code>true</code>, then return items that are relate to the
   *     specified page item only; otherwise return empty list if the specified item is not a page.
   * @return a list of asset items described above, never <code>null</code>, but be empty.
   */
  @IPSJexlMethod(
      description =
          "Gets the items of a widget that are relate to the specified page and/or template.",
      params = {
        ...
        @IPSJexlParam(name = "params", description = "extra parameters to the process"),
        @IPSJexlParam(
            name = "processPageAssetOnly",
            description = "if true, then lookup lookup items relate to page only")
      },
      returns = "list of assembly items")
  public List<PSRenderAsset> widgetContents(
      IPSAssemblyItem item,
      ...
      String finderName,
      Map<String, Object> params,
      boolean processPageAssetOnly) {
    notNull(item, "assemblyItem");
    PSWidgetInstance widget = getWidgetInstance(widgetParam);
    if (log.isDebugEnabled()) {
      log.debug(
          format(
              "Calling widget finder with widgetId:{0}, finderName:{1} and params:{2}",
              widget.getItem().getId(), finderName, params));
    }
    ...
    try {
      if (isBlank(finderName)) {
        ...
        if (log.isDebugEnabled()) {
          log.debug(
              "No finder defined for widget id \""
                  + widget.getItem().getId()
                  + "\", defaulting to \""
      ...
      widgetAssets = null;
      if (!page) {
        if (!processPageAssetOnly) widgetAssets = toAssets(finder.find(item, widget, params));
        else widgetAssets = new ArrayList<>();
      } else {
      ...
      String errMsg =
          "Failed to find content for widget id="
              + widget.getItem().getId()
              + " while assemble item id="
              + item.getId().toString();
      log.error(errMsg, ae);
   ...
   * @param defaultTooltip the default tool-tip, this is used if not in edit mode or there is no
   *     widget name and/or description.
   * @return the tool-tip, never <code>null</code> or empty.
   */
  @IPSJexlMethod(
      description = "Gets the tooltip of the specified widget.",
      params = {
        ...
        @IPSJexlParam(name = "defaultTooltip", description = "the default tooltip")
      },
      returns = "tooltip")
  public String getWidgetTooltip(
      PSAbstractAssemblyContext context, PSWidgetInstance widgetInstance, String defaultTooltip) {
   ...
   * category, the second is a {@code PSPair<Integer, Integer>} which count the occurrence of the
   * category of the current node and his children and the third is a list of PSCategoryTree.
   */
  @IPSJexlMethod(
      description = "Gets the processed list of categories.",
      params = {
        @IPSJexlParam(name = "categories", description = "String of comma separated categories")
      },
      returns = "List of PSCategoryTree.")
  public List<PSCategoryTree> getProcessedCategories(List<PSRenderAsset> assemblyPages) {
    ...
    try {
      ...
      if (assemblyPages == null) return categoryTree.getChildren();
  ...
  private String getCategoryByIdPath(String path) {
    if (path.contains("/")) path = StringUtils.substringAfterLast(path, "/");
    return getCategoryMap().get(path);
  }

  @IPSJexlMethod(
      description = "Returns the category label path for the given category id path",
      params = {
        @IPSJexlParam(
            name = "catPath",
            description = "The category id path, if not found returns the idpath")
      },
      returns = "String")
  ...
  /**
   * Helper method to create category map. Loads the category tree xml file and creates a map of id
   * and label paths.
   *
  ...
  private Map<String, String> getCategoryMap() {
    ...
    try {
      ...
      if (StringUtils.isBlank(id)) id = label;
      label = "/" + label;
      catMap.put(id, label);
      List<Element> children = rootNode.getChildren();
      if (!children.isEmpty()) {
        Element topLevelElement = children.get(0);
        if (topLevelElement.getName() != null
            && topLevelElement.getName().equalsIgnoreCase("topLevelNodes")) {
   ...
   *
   * @param map assumed not <code>null</code>, the map gets updated in recursive calls.
  ...
  private void createCategoryMap(Map<String, String> map, Element node, String label) {
    ...
    if (StringUtils.isBlank(curId)) curId = curLabel;
  ...
  public void alphaOrderTag(Value[] arrayElements) {
    ...
    for (int pass = 1; pass < n; pass++) {
      for (int i = 0; i < n - pass; i++) {
        try {
          if (arrayElements[i].getString().compareToIgnoreCase(arrayElements[i + 1].getString())
              > 0) {
  ...
  /**
   * A utility method that gets the labels for list of categories and then sorts, by the category
   * without the whole path, alphabetically case insensitive. For example if the values are [/A/B/C,
   * /A/B] it compares C and B.
   *
  ...
  public void alphaOrderCategory(Value[] arrayElements) {
    ...
    for (int i = 0; i < n; i++) {
      try {
        arrayElements[i] =
            PSValueFactory.createValue((Object) getCategoryLabel(arrayElements[i].getString()));
      } catch (Exception e) {
        ...
        try {
          if (arrayElements[i]
                  ...
                  .compareToIgnoreCase(
                      arrayElements[i + 1]
                          .getString()
                          .substring(arrayElements[i + 1].getString().lastIndexOf('/') + 1))
              > 0) {
            Value temp = arrayElements[i];
            arrayElements[i] = arrayElements[i + 1];
            arrayElements[i + 1] = temp;
  ...
  /**
   * A utility method that collects the years and months from the supplied list of assembled pages
   * and returns a structure of unique months categorized by year and the number of blogs of each
   * year/month. Return a list of PSBlogYear objects. Each PSBlogYear is formed with an string
   * element the string year, the count for the year and the list of months with the number of
   * blogs.
   */
  @IPSJexlMethod(
      description = "Gets the processed list of blogs per month organized by year.",
      params = {@IPSJexlParam(name = "assemblyPages", description = "assembly pages")},
      returns = "List of PSBlogArchive.")
  ...
  /**
   * A utility method that collects the pages collected from the system, that match with the
   * calendar name passed as parameter. Return a JSONArray object that have a list of fields, with
   * the values read from the list of pages found, such as title, start date, end date and summary.
   *
  ...
  public List<Map<String, Object>> getPagesForCalendar(String calendarName)
    ...
    try {
      ...
      for (Integer id : ids) {
        ...
        String title =
            StringUtils.isNotBlank((String) fields.get("resource_link_title"))
                ? (String) fields.get("resource_link_title")
                : "";
        String summary =
            StringUtils.isNotBlank((String) fields.get("page_summary"))
                ? (String) fields.get("page_summary")
                : "";
        ...
        pageCalItem.put(
            "start", (startDate == null) ? StringUtils.EMPTY : outputFormat.format(startDate));
        if (endDate != null) {
  ...
  // ====================================================
  /**
   * A utility method that collects the tags from the supplied list of assembled pages and returns a
   * list of unique tags and the number of occurrence of each tag. The returned object is a list of
   * PSPair objects, the first object is the String tag and the second object is Integer count. The
   * returned list is sorted by the supplied sortOption, either alpha and count, defaults to alpha
   * and any value other than count is treated as alpha.
   *
   * @throws RepositoryException
   * @throws IllegalStateException
   * @throws PathNotFoundException
   ...
   */
  @IPSJexlMethod(
      description = "Gets the processed list of tags.",
      params = {
        @IPSJexlParam(name = "tags", description = "String of comma separated tags"),
        @IPSJexlParam(
            name = "sortOption",
            description =
                "either alpha and count, defaults to alpha and any value other "
                    + "than count is treated as alpha")
      },
      returns = "List of PSPair of String and Integers.")
  public List<PSPair<String, Integer>> getProcessedTags(
      List<PSRenderAsset> assemblyPages, String sortOption) throws RepositoryException {
    if (assemblyPages == null) {
   ...
   *
   * @param templateIds comma separated template ids, and id is expected in guid format never <code>
   *     null</code>, but be empty.
   * @return a list template names, never <code>null</code>, but be empty.
   */
  @IPSJexlMethod(
      description = "gets list of template names",
      params = {
        @IPSJexlParam(name = "templateIds", description = "String of comma separated template ids")
      },
   ...
   * @return the workflow. It may be <code>null</code> if the workflow does not exist.
   */
  @IPSJexlMethod(
      description = "find a workflow from ID",
      params = {@IPSJexlParam(name = "workflowId", description = "the ID of the workflow")},
      returns = "the workflow. It may be null if not exist.")
   ...
   */
  @IPSJexlMethod(
      description = "Gets the blog post template id for the specified blog.",
      params = {@IPSJexlParam(name = "path", description = "the folder path of the blog")},
      returns = "id of the blog post template")
   ...
   * @return The item content id, or an empty string if the supplied linkId is not valid
   */
  @IPSJexlMethod(
      description = "Gets the dependent content id of the specified link.",
      params = {@IPSJexlParam(name = "linkId", description = "the id of the link")},
      returns =
  ...
  @IPSJexlMethod(
      description = "Find an item and return specified field values.",
      params = {
        ...
        @IPSJexlParam(name = "contentId", description = "The content id of the item to find")
      },
      returns =
          "A map of the specified field names and their values as strings, values are escaped for"
              + " html")
  public Map<String, String> findItemFieldValues(String type, String fields, String contentId) {
    ...
    PSJcrNodeFinder nodeFinder =
        new PSJcrNodeFinder(contentMgr, type, IPSHtmlParameters.SYS_CONTENTID);
  ...
  @IPSJexlMethod(
      description =
          "Get a list of child categories from a root path, or top level categories if not"
              + " specified",
      params = {
        @IPSJexlParam(
            name = "siteName",
            description = "Tne sitename of all sites if null or empty"),
        @IPSJexlParam(
            name = "rootPath",
            description =
                "The root path, can find by title or guid,  if relative path first match will be"
                    + " returned")
      },
      returns = "A list of PSCategoryNode objects")
  ...
  @IPSJexlMethod(
      description =
          "Get item's category json string value and prepare the information in a map and return.",
      params = {
        @IPSJexlParam(
            name = "fieldValue",
            description = "the category drop down value that is to be displayed"),
        @IPSJexlParam(name = "fieldName", description = "the name of the category drop down field"),
        @IPSJexlParam(name = "siteName", description = "the name of the site")
      },
      returns =
          "A map of the category drop down values, where is key is the drop down fieldname appended"
              + " with a count and value is a list of PSCategoryNode. This list has PSCategoryNode"
              + " that belong to the specific dropdown. The selected categories are marked as"
              + " selected true in their object.")
  public Map<String, List<PSCategoryNode>> getCategoryDropDownValues(
      String fieldValue, String fieldName, String siteName) {
    try {
      notEmpty(fieldValue);
      notEmpty(fieldName);
  ...
  @IPSJexlMethod(
      description = "Find a category node by the category path",
      params = {@IPSJexlParam(name = "categoryPath", description = "the category path")},
  ...
  /**
   * The pages and widgets are assembled as a chain of assembly items. When a sub item is assembled
   * a clone of the assembly item is created and the original item is made available from
   * getCloneParentItem() if this value returns null then we are at the top most original assembly
   * items This means the item that is being directly assembled, e.g. the page. By getting hold of
   * this object the widgets can modify the bindings of the page. This can be used to modify the
   * metadata map that is extracted when delivering the page. No assumption can be made about the
   * order that the widgets are rendered in and the widgets may be assembled concurrently.
   *
   * @param asmItem
  ...
  @IPSJexlMethod(
      ...
      params = {
        @IPSJexlParam(
            name = "asmItem",
            description = "The current assemblyItem usually $sys.assemblyItem")
      },
      returns = "The top level IPSAssemblyItem")
  ...
  /**
   * We check for the $sys.metadata binding on the parent assembly item. e.g. page if we find it we
   * return the object that individual widgets can add to. If we do not find it we add it.
   *
   * @param param
  ...
  @IPSJexlMethod(
      ...
      returns =
          "A Map.  The key is a String of the metada key.  The value is an Object but should only"
              + " be populated with a String or List of Strings ")
  ...
  private PSCategoryNode getParentNode(
      List<PSCategoryNode> nodes, String selectedId, PSCategoryNode pNode) {
  ...
  private PSWidgetInstance getWidgetInstance(Object widget) {
    ...
    if (!(widget instanceof PSWidgetInstance)) {
      throw new IllegalArgumentException(
          "Must pass widget instance, e.g. $perc.widget, but cannot be  $perc.widget.item or"
              + " $perc.widget.item.id");
    }
   ...
   *
   * @param finder the fully qualified extension name of the finder in question. It is default to
  ...
  /**
   * Gets html content from a field and escapes the fields contents to html if needed.
   *
   * <p>If the field is an html field then the contents will not be escaped. If the field is not
   ...
   * Gets html content from a field and escapes the fields contents to html if needed.
   *
   * <p>If the field is an html field then the contents will not be escaped.
   *
   * @param item either a map, assembly item or a jcr node.
   * @param fields a list of comma separated fields tried in order.
   * @param defaultValue if there are no fields matching then this parameter will be returned. If
   *     this field is <code>null</code> and no property is found an exception will be thrown.
   * @return never <code>null</code>.
   */
  ...
  /**
   * Gets the path of the specified item. This is the finder path, including the item name.
   *
   * @param id of the item, never <code>null</code> or empty.
   * @return the path, may be empty if the item does not have a path (this will be true for local
   *     content).
   */
  ...
  /**
   * Find or edit html source doc as a string and do something with it. Test Method.
   *
  ...
  public String processForm(IPSAssemblyItem item, Object widget, String src) {
    ...
    List<net.htmlparser.jericho.Element> hiddenContentType =
        processSRC.getAllElements(HTMLElementName.INPUT);
  ...
  private String createDDDropdown(IPSAssemblyItem item, Object widget, String query) {
    ...
    StringBuilder dddString =
        new StringBuilder("<select name=\"perc_EmailFormTo\" id=\"email-to\" />");
    Map<String, Object> params = new HashMap<>();
    params.put(
        "query",
        "select rx:personFirstName, rx:personLastName, rx:personEmail, jcr:path from rx:"
            + query
            + " where jcr:path like '//Folders/$System$/Assets/%'");
    ...
    if (results.size() > 0) {
      ...
      for (PSRenderAsset element : results) {
        try {
          ...
          log.error(
              "Error retrieving name property as string {}", PSExceptionUtils.getMessageForLog(e));
        } catch (PathNotFoundException e) {
          log.error(
              "Error finding path  to retrieve name property as string {}",
              PSExceptionUtils.getMessageForLog(e));
        } catch (RepositoryException e) {
  ...
  private void handleNoFieldFound(Object item, String fields) throws RepositoryException {
    ...
    throw new RepositoryException(
        format(
            "For item type: {0} failed to find a property and no default value provided for fields:"
                + " {1}",
  ...
  private Property getProperty(Node node, List<String> fields) throws RepositoryException {
    notNull(fields);
  ...
  public static final String DEFAULT_WIDGET_CONTENT_FINDER =
      "Java/global/percussion/widgetcontentfinder/perc_DefaultWidgetContentFinder";

  @Autowired private IPSRecycleService recycleService;

  @Autowired private IPSRelationshipService relationshipService;

  /**
   * The site manager service. It is assumed to be auto wired by {@link
   * PSSpringWebApplicationContextUtils}
   */
  @Autowired private IPSSiteManager siteMgr;

  /**
   * The page service. It is assumed to be auto wired by {@link PSSpringWebApplicationContextUtils}
   */
  @Autowired private IPSPageService pageService;

  /**
   * The page dao service. It is assumed to be auto wired by {@link
   * PSSpringWebApplicationContextUtils}
   */
  @Autowired private IPSPageDao pageDao;

  /**
   * The template service. It is assumed to be auto wired by {@link
   * PSSpringWebApplicationContextUtils}
   */
  @Autowired private IPSTemplateService templateService;

  /**
   * The content service. It is assumed to be auto wired by {@link
   * PSSpringWebApplicationContextUtils}.
   */
  @Autowired private IPSContentWs contentWs;

  /**
   * The GUID manager. It is assumed to be auto wired by {@link PSSpringWebApplicationContextUtils}.
   */
  @Autowired private IPSGuidManager guidManager;

  /** The widget service, assumed to auto wired by {@link PSSpringWebApplicationContextUtils} */
  @Autowired private IPSWidgetService widgetService;

  @Autowired private IPSIdMapper idMapper;

  @Autowired private IPSRenderLinkService renderLinkService;

  @Autowired private PSAssemblyItemBridge assemblyItemBridge;

  @Autowired private IPSContentItemDao contentItemDao;

  @Autowired private IPSManagedLinkService managedLinkService;

  @Autowired private IPSManagedLinkDao managedLinkDao;

  @Autowired private IPSContentMgr contentMgr;

  private IPSFileSystemService fileSystemService;

  @Autowired private IPSPageCategoryService pageCategoryService;

  @Autowired private IPSPubServerService pubServerService;

  /** Analytics provider service auto wired by {@link PSSpringWebApplicationContextUtils} */
  @Autowired private IPSAnalyticsProviderService analyticsProviderService;

  /**
   * The delivery info service to get location of delivery server. auto wired by {@link
   * PSSpringWebApplicationContextUtils}
   */
  @Autowired private IPSDeliveryInfoService deliveryInfoService;
  ...
  /**
   * Gets the page service, which is auto "wired" by {@link PSSpringWebApplicationContextUtils}
   *
  ...
  /**
   * Sets the page service, which is auto "wired" by {@link PSSpringWebApplicationContextUtils}
   *
  ...
  /**
   * Gets the page dao, which is auto "wired" by {@link PSSpringWebApplicationContextUtils}
   *
   * @return the page service, never <code>null</code>.
   */
  ...
  /**
   * Sets the page dao, which is auto "wired" by {@link PSSpringWebApplicationContextUtils}
   *
  ...
  /**
   * Sets the site manager service, which is auto "wired" by {@link
   * PSSpringWebApplicationContextUtils}
   *
  ...
  /**
   * Gets the template service, which is auto "wired" by {@link PSSpringWebApplicationContextUtils}
   *
  ...
  /**
   * Sets the template service, which is auto "wired" by {@link PSSpringWebApplicationContextUtils}
   *
  ...
  /**
   * Gets the content service, which is auto "wired" by {@link PSSpringWebApplicationContextUtils}.
   *
  ...
  /**
   * Sets the content service, which is auto "wired" by {@link PSSpringWebApplicationContextUtils}.
   *
  ...
  /**
   * Gets the GUID manager, which is auto "wired" by {@link PSSpringWebApplicationContextUtils}.
   *
  ...
  /**
   * Sets the GUID manager, which is auto "wired" by {@link PSSpringWebApplicationContextUtils}.
   *
  ...
  /**
   * Gets the widget service, which is auto "wired" by {@link PSSpringWebApplicationContextUtils}
   *
  ...
  /**
   * Sets the widget service, which is auto "wired" by {@link PSSpringWebApplicationContextUtils}
   *
  ...
  /**
   * Gets the 'web property ID' for the specified site. This will only exist if Google Analytics was
   * set-up and a profile assigned to the site. So the presence of the web property indicates that
   * the site has analytics enabled.
   *
   * @param sitename may be <code>null</code> or empty in which case no web property will be
   *     returned.
   * @return the web property ID. It may be empty if it is not configured for the site.
   */
   ...
   * @return the API key. It may be empty if the site name is blank or the google API key is not
   *     configure for the site.
   */
  ...
  /**
   * @return the url of the delivery server as defined in <code>config/delivery-servers.xml</code>.
   *     Never <code>null</code> , may be empty if no entry was found.
   */
  ...
  public String getDeliveryServer(Long serverId) {
    ...
    if (serverId != null
        && pubServer != null
        && pubServer.getServerType().equals(PSPubServer.STAGING)) {
  ...
  public IPSFileSystemService getFileSystemService() {
    if (fileSystemService == null) {
      fileSystemService =
          (IPSFileSystemService) getWebApplicationContext().getBean("webResourcesService");
    }
