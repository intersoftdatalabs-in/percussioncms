...
public class PSPageUtils extends PSJexlUtilBase {
  ...
  @IPSJexlMethod(
      description =
          "parseHtmlFragment can be used to parse a fragment of HTML and return an Element that can be manipulated",
  ...
  @IPSJexlMethod(
      description =
          "Validates that the path / url passed in resolves to a resource that has a 20X http status code.",
      params = {
        ...
        @IPSJexlParam(
            description =
                "Set to true to not cache this link. false to use caching.  By default all links are cached for 30 minutes.",
            name = "dontCache")
      },
      returns = "boolean")
  ...
  @IPSJexlMethod(
      description =
          "Verify if the entered date format is correct or not for the SimpleDateFormat. If not system returns the default error format",
      params = {
  ...
  /**
   * Helper method that takes a list of non unique strings and returns a list of unique strings
   * along with the number of occurrence of each string as PSPair objects with the first object as
   * String and second one as Integer. The returned list is sorted based on the sortOption
   * parameter. For example, if the incoming list is [foo, bar, foo, cat, bar, dog, bar] and
   * sortOption is alpha. Then the returned list will be like [bar(3),cat(1),dog(1),foo(2)]. If the
   * sortOption is count then the returned list will be like [bar(3),foo(2),cat(1),dog(1)].
   *
  ...
  @IPSJexlMethod(
      ...
      returns =
          "A map of the specified field names and their values as strings, values are escaped for html")
  ...
  @IPSJexlMethod(
      description =
          "Get a list of child categories from a root path, or top level categories if not specified",
      params = {
        @IPSJexlParam(
            name = "siteName",
        ...
        @IPSJexlParam(
            name = "rootPath",
            description =
                "The root path, can find by title or guid,  if relative path first match will be returned")
      },
  ...
  @IPSJexlMethod(
      ...
      returns =
          "A map of the category drop down values, where is key is the drop down fieldname appended with a count and value is a list of PSCategoryNode. "
