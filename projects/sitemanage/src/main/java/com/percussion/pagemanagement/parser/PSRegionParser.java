...
/**
 * Walks the HTML tree, pulling out regions and code, transforming them into our Abstract Syntax
 * Tree: {@link PSParsedRegionTree}.
 *
 * <p>A region is an HTML element that uses the {@link #REGION_CLASS}. Everything else is
 * HTML/velocity code. Implementation is a simple stack-based FSM parser.
 *
