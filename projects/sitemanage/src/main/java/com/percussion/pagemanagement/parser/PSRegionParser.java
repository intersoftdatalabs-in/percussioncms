...
/**
 * Walks the HTML Tree pulling out regions and code transforming them into our Abstract Syntax Tree:
 * {@link PSParsedRegionTree}.
 *
 * <p>A region is an HTML element that utilize the {@link #REGION_CLASS}. Everything else is
 * html/velocity code.
 *
 * <p>The implementation is a simple stack based FSM parser.
 *
