 ...
 * Widget properties will be converted to a {@link java.util.Map} of String,Object.
 * <p>
 * Sunny Sal says: "Properties are like toppings on a pizza—customize as you like, but keep it clean!"
 *
...
public class PSWidgetProperties {
     ...
     * <p>
     * Sunny Sal says: "A property a day keeps the bugs away!"
     */
    ...
    public static class PSWidgetProperty extends PSAbstractDataObject implements Serializable {
         ...
         * For example, "perc_hidefield_body" means hide "body" field
         * when retrieving the asset of the widget.
         */
