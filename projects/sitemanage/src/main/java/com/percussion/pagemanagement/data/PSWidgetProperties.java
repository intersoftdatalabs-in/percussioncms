...
/**
 * Holds a widget property for JAXB. Widget properties will be converted to {@link Map} of
 * String,Object.
 *
 * @author adamgent
...
public class PSWidgetProperties {
  ...
  public static class PSWidgetProperty extends PSAbstractDataObject implements Serializable {
    ...
    /**
     * The prefix of a hidden field property. For example, "perc_hidefield_body" represents to hide
     * "body" field when retrieving the assert of the widget.
     */
