...
public interface IPSCommentsService {
   ...
   *
   * @return a list of summary of pages, sorted by name (ascendant order) (per-server), never <code>
  ...
  /**
   * Provides a summary of the comment information for the given page. The count information is
   * combined from all delivery servers.
   *
   ...
   *
   * @param commentModeration An object that contains information about comments and the site which
   *     they belong to. Must not be <code>null</code>.
   */
  public void moderate(String site, PSCommentModeration commentModeration);

  /**
   * * When set the specified license # will be passed in as an override to any underlying calls.
   * Intended for Unit Testers.
   *
   * @param licenseId
   */
