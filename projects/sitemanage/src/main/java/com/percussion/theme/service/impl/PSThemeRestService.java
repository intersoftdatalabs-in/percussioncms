...
public class PSThemeRestService {
  ...
  @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
  public PSThemeSummary create(
      @PathParam("newTheme") String newTheme, @PathParam("existingTheme") String existingTheme) {
    try {
  ...
  @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
  public PSThemeSummary createFromDefault(@PathParam("newTheme") String newTheme)
  ...
  @DELETE
  @Path("/delete/{theme}")
  public void delete(@PathParam("theme") String theme)
      throws DataServiceNotFoundException, DataServiceDeleteException {
  ...
  public PSRegionCSS getRegionCSS(
      ...
      @PathParam("outerregion") String outerregion,
  ...
  @Consumes({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
  public void mergeRegionCSS(
      @PathParam("theme") String theme,
      @PathParam("templateId") String templateId,
      PSRegionCssList deletedRegions) {
    try {
  ...
  public void prepareForEditRegionCSS(
      @PathParam("theme") String theme, @PathParam("templatename") String templatename) {
    try {
  ...
  public void clearCacheRegionCSS(
      @PathParam("theme") String theme, @PathParam("templatename") String templatename) {
