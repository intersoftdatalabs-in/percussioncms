...
public class PSThemeSummary {
   ...
   *
   * @return URL of the thumbnail image of the theme. It should not be blank if it is properly
   *     created; otherwise it may be blank.
   */
   ...
   *
   * @param name the new name of the Theme, it should not be blank if this is not called by
   *     serializer of JAXB.
   */
   ...
   *
   * @param thumbUrl the new URL of the thumbnail image of the Theme, it should not be blank if this
   *     is not called by serializer of JAXB.
   */
  ...
  /**
   * Gets the CSS file path that is relative to the root of all themes parent folder.
   *
  ...
  /**
   * The region CSS file path, which contains all region-specific CSS styles or rules. This path is
   * relative to all themes parent folder, not the fully qualified path.
   *
  ...
  /** The URL of the thumbnail image of the Theme. See {@link #getThumbUrl()} for detail. */
