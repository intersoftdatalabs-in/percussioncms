...
public class PSThemeSummary {
   ...
   *
   * @return URL of the thumb image of the theme. It should not be blank if it is properly created;
   ...
   *
   * @param thumbUrl the new URL of the thumb image of the Theme, it should not be blank if this is
  ...
  /** The URL of the thumb image of the Theme. See {@link #getThumbUrl()} for detail. */
