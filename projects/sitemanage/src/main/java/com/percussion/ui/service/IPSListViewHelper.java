...
/**
 * Responsible for retrieving and filling display properties for {@link PSPathItem}
 * objects to be shown in the List View. Each {@link IPSPathService} should have
 * an {@link IPSListViewHelper} implementation associated.
 *
 * <p>
...
public interface IPSListViewHelper {
     ...
     *
     * @param criteria Contains the necessary information to fill the {@link PSPathItem} objects
     *                 with display properties. Cannot be {@code null}, nor can its {@link PSPathItem}
     *                 object list field. If the {@link PSSimpleDisplayFormat} format is {@code null},
