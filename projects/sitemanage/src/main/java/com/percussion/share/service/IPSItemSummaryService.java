...
/**
 * An extremely low level wrapper to CM System for relatively fast item retrieval.
 *
 * <p>Be aware: Although this is public API it should probably not be used externally and maybe
...
public interface IPSItemSummaryService<S extends IPSItemSummary>
   ...
   * NOTICE that the return value maybe <code>null</code>. </strong> Higher level layers and API
   * should deal with the null return value.
   *
