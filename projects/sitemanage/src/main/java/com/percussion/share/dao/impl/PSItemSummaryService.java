...
public class PSItemSummaryService implements IPSItemSummaryFactoryService, IPSDataItemSummaryService {
    ...
    private <F extends IPSItemSummary> List<F> convert(
            ...
            int landingPageId,
            String relationshipTypeName) throws PSErrorException, PSInvalidContentTypeException, DataServiceLoadException {
    ...
    private String getNavFolderType(PSItemSummary item, String relationshipTypeName) {
        ...
        if (childNavId != null) {
            var map = navService.getNavonProperties(childNavId, Collections.singletonList(IPSManagedNavService.NAVON_FIELD_TYPE));
    ...
    protected <F extends IPSItemSummary> void convert(
            ...
            String relationshipTypeName) throws PSErrorException, PSInvalidContentTypeException {
        ...
        var parentPaths = asList(contentWs.findFolderPaths(itemSummary.getGUID(), relationshipTypeName));
    ...
    public <F extends IPSItemSummary> F find(
        ...
        try {
            ...
            var item = sums.get(0);
            var landingPageId = isLandingPage(item, relationshipTypeName)
