 ...
 * parameter objects like {@link IPSRequestContext} into a {@link Map}. Once you convert parameters
 * to a Map you can take advantage of <a
 * href="http://commons.apache.org/collections/api/org/apache/commons/collections/MapUtils.html">
 * Apache Commons MapUtils</a> Or Apache Commons BeanUtils.
 *
 * @author adamgent
 */
public class PSLegacyExtensionUtils {
  /**
   * Adds the parameters specified by the extension def and contained in the parameters array to the
   * given map.
   *
