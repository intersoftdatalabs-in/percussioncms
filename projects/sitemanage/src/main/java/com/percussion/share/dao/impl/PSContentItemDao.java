...
/**
 * Manage R/W of the content item through a {@link PSJcrNodeMap}. Write operations are done using
  ...
  public PSContentItem save(PSContentItem contentItem)
    ...
    try {
      ...
      if (contentItem.getId() == null) {
        ...
        List<PSCoreItem> items = contentWs.loadItems(asList(guid), true, false, false, true);
        notEmpty(items);
