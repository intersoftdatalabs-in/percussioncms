...
public interface IPSDataService<FULL, SUMMARY, PK extends Serializable>
    extends IPSCatalogService<SUMMARY, PK>, IPSReadOnlyDataService<FULL, PK> {
   ...
   */
  void delete(PK id)
      throws PSDataServiceException, IPSGadgetService.PSGadgetNotFoundException,
  ...
  /** DataServiceSaveException is thrown when a site cannot be saved successfully. */
  ...
  /** DataServiceDeleteException is thrown when a site cannot be deleted successfully. */
  ...
  /** DataServiceLoadException is thrown when a site cannot be loaded successfully. */
  ...
  /** DataServiceLoadException is thrown when a site cannot be loaded successfully. */
  public static class DataServiceNotFoundException extends PSDataServiceException
