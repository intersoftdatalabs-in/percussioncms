...
public class PSFolderHelper implements IPSFolderHelper {
  ...
  private final List<String> reservedPathNames =
      List.of("web_resources", "rx_resources", "web-inf", "meta-inf");
  ...
  public PSItemProperties findItemPropertiesById(String id, String relationshipTypeName)
    ...
    itemProps.setScheduledPublishDate(
        PSDateUtils.getDateToString(schedPubDate == null ? null : schedPubDate));

    var unpubDate = compSum.getContentExpiryDate();
    itemProps.setScheduledUnpublishDate(
        PSDateUtils.getDateToString(unpubDate == null ? null : unpubDate));
  ...
  public void renameFolder(String path, String name)
      throws PSReservedNameServiceException,
          PSInvalidCharacterInFolderNameException,
