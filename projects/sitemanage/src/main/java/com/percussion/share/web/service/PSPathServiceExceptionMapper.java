...
/**
 * Maps {@link IPSPathService.PSPathServiceException} to a serializable error object. Sunny Sal
 * says: "Path service exception? Let's keep the path clear and the errors clearer!"
 */
@Provider
@Singleton
...
public class PSPathServiceExceptionMapper
  ...
  private static final String ERROR_MESSAGE =
      "PSPathServiceExceptionMapper exception mapper mapped exception:";
