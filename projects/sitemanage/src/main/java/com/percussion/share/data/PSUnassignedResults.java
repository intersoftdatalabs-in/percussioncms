...
public class PSUnassignedResults extends PSAbstractDataObject {
  ...
  public static class UnassignedItemList extends PSAbstractDataObject {
     ...
     *
     * @return {@link List}<{@link UnassignedItem}> not <code>null</code> after constructor.
     */
     ...
     * @param childrenInPage {@link List}<{@link UnassignedItem}> assumed not <code>null</code>.
     */
  ...
  /**
   * Class that represents the status of the import proces, for unassigned pages.
   *
   * @author Santiago M. Murchio
   */
  public static class ImportStatus extends PSAbstractDataObject {
     ...
     * @param catalogedPageCount {@link Integer} assumed not <code>null</code>.
     */
     ...
     * @param importedPageCount {@link Integer} assumed not <code>null</code>.
     */
  ...
  public static class UnassignedItem extends PSAbstractDataObject {
     ...
     *
     * @return {@link ItemStatus} should not be <code>null</code> after constructor.
     */
    ...
    /**
     * @see #getStatus()
     * @param status {@link ItemStatus} assumed not <code>null</code>.
     */
