...
/**
 * Startup process that will auto-import customer trusted certificates into the central cacerts
 * keystore when the server starts.<br>
 * <br>
 *
...
public class PSImportCustCertificates implements IPSStartupProcess {
  ...
  public void doStartupWork(Properties startupProps) throws Exception {
    ...
    try (InputStream localCertIn = new FileInputStream(file)) {
      ...
      log.error(
          "Error while importing customer trusted certificates into the central cacerts keystore.",
          e);
    }
  ...
  private static void appendCertKey(File file, KeyStore keystore) throws Exception {
    ...
    try (FileInputStream fis = new FileInputStream(fname)) {
      ...
      log.error(
          "Error while importing customer trusted certificate File Name : " + file.getName(), e);
    }
  }
