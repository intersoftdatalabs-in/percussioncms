...
public interface IPSContentItemDao
  ...
  /**
   * Gets the content item from its identifier, similar with {@link #find(String)}, except caller
   * can specify the returned object includes all fields or only the summary properties of the
   * object.
   *
   ...
   * @return a list of item IDs with the specified Content Type name, not <code>null</code>, but may
   *     empty.
   */
