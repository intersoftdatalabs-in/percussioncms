...
/**
 * Used to handle translation of id's between {@link IPSGuid} and their respective string
 * representations.
 */
public interface IPSIdMapper {
   ...
   * @return the string representation of the locator's id, never <code>null</code>.
   */
