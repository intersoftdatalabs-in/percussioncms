...
/**
 * Handles translation of IDs between {@link IPSGuid} and their
...
public interface IPSIdMapper {
    ...
    /**
     * Generates a new, unique id which can be used for local content items.
     * The id is generated from next number table's "PSX_LOCAL_CONTENT" value.
     *
