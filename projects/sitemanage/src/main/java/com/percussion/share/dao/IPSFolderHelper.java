...
public interface IPSFolderHelper {
   ...
   */
  PSPathItem findItemById(String id)
      throws IPSDataService.DataServiceLoadException, PSValidationException, PSNotFoundException;

  PSPathItem findItemById(String id, String relationshipTypeName)
      throws IPSDataService.DataServiceLoadException, PSValidationException, PSNotFoundException;
   ...
   */
  PSPathItem setFolderAccessLevel(PSPathItem item)
   ...
   * @return never <code>null</code>.
   */
  PathTarget pathTarget(String path, boolean shouldRecycle)
