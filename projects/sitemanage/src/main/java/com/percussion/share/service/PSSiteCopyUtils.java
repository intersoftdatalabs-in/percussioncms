...
public class PSSiteCopyUtils {
  ...
  // Following constants are used to give error messages if any action is performed on a site while
  // it is in the
   ...
   * @param methodName name of the method from where this method gets called not <code>null</code>
   *     or <code>empty</code>
   * @param errorMessage error message based on what kind of action is being done on a site while
   *     getting copied not <code>null</code> or <code>empty</code>
   */
   ...
   * @param methodName name of the method from where it is getting called. not <code>null</code> or
   *     <code>empty</code>
  ...
  /**
   * Checks to see if there is any site is under copy process and if so, if the passed in site name
   * is same as either the site getting copied or the site going to be created from the copy then
   * throws related message.
   *
