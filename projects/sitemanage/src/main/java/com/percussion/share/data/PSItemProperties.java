...
public class PSItemProperties extends PSAbstractPersistantObject {
  ...
  /**
   * Gets the name of the item. It is the name of the item for an asset, but it is the link text for
   * a page.
   *
  ...
  /**
   * Sets the item name, which is the name of the item for an asset, but the link text for a page.
   *
   ...
   *
   * @param stateName the new state name. It may be blank if the item is not workflowable.
   */
   ...
   *
   * @param workflowName the new workflow name. It may be blank if the item is not workflowable.
   */
   ...
   *
   * <p>Note, this is the last user who modified the item, checked in/out the item; but not the user
   * who (workflow) transitioned the item.
   *
   * @return the user name, not blank for a valid item. It may be {@link #SYSTEM_USER} if the item
   *     was modified by the system.
   */
   ...
   *
   * <p>Note, this is the last date/time the item has been modified, checked in/out; but not the
   * date/time the item was (workflow) transitioned.
   *
   ...
   *
   * @return last published date. It may be blank if the item has not been published.
   */
   ...
   *
   * @param date the new last published date, may be blank if the item has not been published.
   */
   ...
   *
   * @return the content type for an asset; template name for a page, not blank for a valid asset or
   *     page.
   */
   ...
   *
   * @param type the new type. It is the content type for an asset; or template name for a page, not
  ...
  /** A user name of the system, which is used when an item is modified by the system. */
