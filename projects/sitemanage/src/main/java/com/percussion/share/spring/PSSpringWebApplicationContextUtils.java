...
public class PSSpringWebApplicationContextUtils {
  ...
  /**
   * This will autowire objects using the objects getters and setters. It will not work if your
   * object uses constructor based wiring.
   *
  ...
  private static void logAutoWire(Object bean) {
    if (log.isDebugEnabled()) log.debug("Autowiring bean: " + bean);
  }
