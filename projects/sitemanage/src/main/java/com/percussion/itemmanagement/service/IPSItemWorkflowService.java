...
public interface IPSItemWorkflowService {
   ...
   * @return a no-content response as a workaround for an issue in jQuery/ajax, which always
   *     expecting something in the response; otherwise it flags JavaScript error for the
  ...
  /**
   * calls {@link #transitionWithComments(String, String, String)} with <code>null</code> for
   * comment.
   */
   ...
   *
   * @param id the ID of the item, not blank.
   * @return <code>true</code> if the item can be modified by the current user, <code>false</code>
   *     otherwise.
   */
   ...
   *
   * @param id the ID of the asset, never blank.
   * @param folderPath the asset's folder path, never blank. Must represent a valid site folder
   *     path.
   * @return set of page id's. Never <code>null</code>, may be empty.
   */
   ...
   * @return <code>true</code> if the supplied item is still checked out to the current user,
   *     otherwise <code>false</code>.
   */
  boolean isCheckedOutToCurrentUser(String id);

  /**
   * Checks whether the item with the supplied id is checked out to the someone else user or not.
   *
   * @param id the ID of the item, never blank.
   * @return <code>true</code> if the supplied item is still checked out to someone else user,
   *     otherwise <code>false</code>.
   */
   ...
   * @return <code>true</code> if the item can be transitioned using the trigger, <code>false</code>
   *     otherwise.
   */
   ...
   * staging permission then returns <code>true</code> otherwise returns <code>false</code>.
   *
   * @param id of the item, never blank.
   ...
   * permission then returns <code>true</code> otherwise returns <code>false</code>.
   *
   * @param id of the item, never blank.
   * @return <code>true</code> if available otherwise <code>false</code>.
   */
