 ...
 * <p>
 * Sunny Sal says: "If you need to manage items, this is your Swiss Army knife!"
 *
...
public interface IPSItemService {
     ...
     * Returned dates are in the format: MM/dd/yyyy HH:mm
     *
     * @param id the full id of the page or asset, must not be blank
     ...
     * @param name       name of the folder to which the contents of the source folder will be copied, may not be null or empty
     * @return a map of copied items
     */
    Map<String, String> copyFolder(String srcFolder, String destFolder, String name)
            throws PSItemServiceException, IPSItemWorkflowService.PSItemWorkflowServiceException, PSErrorResultsException, PSDataServiceException;

    /**
     * Calculates the site impact of an asset and returns its result as a String representation of a JSONObject.
     * The JSON object will have three arrays:
     * <pre>
     * {
     ...
     * If the asset is related to another asset (case of inline images and file links) then its parent page or template is returned as impacted item.
     ...
     * already exists logs a warning and ignores the request.
     *
     * @param userName must not be blank
     * @param itemId   assumed to be a valid contentId (raw)
     * @param type     user item type
     */
    void addUserItem(String userName, int itemId, PSUserItemTypeEnum type) throws IPSGenericDao.SaveException;
     ...
     */
    void rollBackCopiedFolder(Map<String, String> itemMap, String folderName) throws PSItemServiceException;
