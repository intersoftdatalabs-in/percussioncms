...
/**
 * The class contains the results of transitioning an item. This includes the item ID along with a
 * list of shared assets which failed to transition.
 *
...
public class PSItemTransitionResults extends PSAbstractDataObject {
   ...
   *
   * @param assets the new list of assets, may be <code>null</code> or empty, <code>null</code>
   *     value is the same as empty list.
   */
  ...
  /**
   * A list of all shared assets which could not be transitioned. Never <code>null</code>, may be
   * empty.
   */
