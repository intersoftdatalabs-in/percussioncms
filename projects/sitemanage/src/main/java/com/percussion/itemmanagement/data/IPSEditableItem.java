...
public interface IPSEditableItem {
  /**
   * This is the id used for open and preview actions on the item. In some cases (form assets), this
  ...
  /**
   * This is the item type used for open and preview actions on the item. It is used to determine
