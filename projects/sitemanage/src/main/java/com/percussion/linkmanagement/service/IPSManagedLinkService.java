...
public interface IPSManagedLinkService {
  ...
  public static final String SERVER_PROPERTY_AUTO_MANAGE_LOCAL_PATHS =
      IPSConstants.SERVER_PROP_MANAGELINKS;
  ...
  /**
   * Attemps to cleanup any managed links referencing content ids that no longer exists. Fixes
   ...
   * context.
   *
   * @param linkContext The link context to use, may be <code>null</code> to use edit path for the
   *     link.
   ...
   * copy a site.
   *
   * @param assetIds the IDs of the assets that may have managed links, not <code>null</code> or
   *     empty.
  ...
  /**
   * A convenient method that checks a server property called {@link
   * #SERVER_PROPERTY_AUTO_MANAGE_LOCAL_PATHS} is available with a value of <code>true</code>
   *
   ...
   * the supplied context. If the link id of the element is not found, or doen't resolve to a
   ...
   * supplied context. If the link id of the element is not found, or doen't resolve to a dependent
