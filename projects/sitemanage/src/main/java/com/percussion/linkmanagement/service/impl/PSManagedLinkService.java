...
public class PSManagedLinkService implements IPSManagedLinkService {
  ...
  public String renderLinksInJSON(
    ...
    try {
      ...
      log.error(
          "An error occurred while trying to manage links in a JSONPayload field. Payload was: {} Error was: {}",
          jsonPayload,
  ...
  private void updateCopyAssetLink(
    ...
    if (guid == null) {
      log.warn(
          "Found a page from original site ( {}{} ), but cannot find the copied page ( {} ). Skip updating managed link: {}",
          origSiteRoot,
          relativePath,
          path,
          link);
