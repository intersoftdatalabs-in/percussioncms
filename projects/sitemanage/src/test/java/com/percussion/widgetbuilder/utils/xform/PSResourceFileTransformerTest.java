...
public class PSResourceFileTransformerTest {
   ...
   * com.percussion.widgetbuilder.utils.xform.PSResourceFileTransformer#transformFile(java.io.File,
   * java.io.Reader, com.percussion.widgetbuilder.utils.PSWidgetPackageSpec)}.
   */
  @Test
  public void testTransformFile() throws Exception {
    ...
    Reader reader =
        new InputStreamReader(this.getClass().getResourceAsStream("transformResources.xml"));
    File file = new File("sys__UserDependency--rxconfig_Resources_preMyWidget/preMyWidget.xml");

    String expected =
        IOUtils.toString(this.getClass().getResourceAsStream("expectedResources.xml"));
    expected =
        PSSerializerUtils.marshal(
            PSSerializerUtils.unmarshal(expected, PSResourceDefinitionGroup.class));
  ...
  /**
   * Test method for {@link
   * com.percussion.widgetbuilder.utils.xform.PSResourceFileTransformer#handleFile(java.io.File)}.
   */
  @Test
  public void testHandleFile() {
    ...
    assertFalse(
        xform.handleFile(
            new File("sys__UserDependency--rxconfig_Widgets_mywidget/testWidget.xml")));
    assertTrue(
        xform.handleFile(
            new File("sys__UserDependency--rxconfig_Resources_mywidget/testWidget.xml")));
  }

  /**
   * Test method for {@link
   * com.percussion.widgetbuilder.utils.xform.PSResourceFileTransformer#transformPath(java.io.File,
   * com.percussion.widgetbuilder.utils.PSWidgetPackageSpec)}.
   */
  @Test
