...
public class PSWidgetBuilderValidationTest {
  ...
  public void testGeneral() {
    ...
    List<PSWidgetBuilderValidationResult> results =
        PSWidgetBuilderGeneralValidator.validate(data, current);
    ...
    // copy
    PSWidgetBuilderDefinitionData data2 =
        new PSWidgetBuilderDefinitionData(PSWidgetBuilderDefinitionData.createDaoObject(data));
  ...
  private void testGeneralValue(
    ...
    List<PSWidgetBuilderValidationResult> results =
        PSWidgetBuilderGeneralValidator.validate(data, current);
    if (isValid) assertTrue(results.isEmpty());
    else {
  ...
  private boolean hasError(
      ValidationCategory category, String name, List<PSWidgetBuilderValidationResult> results) {
