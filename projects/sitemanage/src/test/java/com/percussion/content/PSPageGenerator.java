...
public class PSPageGenerator extends PSItemGenerator<PSPageRestClient> {
   ...
   *
   * @param def Not null. If link title is not specified, it defaults to name. If browser title is
   *     not specified, it defaults to link title.
   * @param path Must start with a '/' and is relative to /Sites. Trailing slash is optional.
