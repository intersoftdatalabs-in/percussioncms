 ...
 * @author rafaelsalis
 */
public class PSSteppedWorkflowRestServiceTest
    extends PSRestTestCase<PSSteppedWorkflowRestServiceClient> {
  ...
  private static final String WORKFLOW_HAS_ITEMS =
      "Cannot delete: ''{0}'' because this workflow has items assigned to it.";
  private static final String WORKFLOW_IS_DEFAULT_WORKFLOW =
      "The workflow ''{0}'' cannot be deleted because is the default workflow.";
   ...
   */
  private void testCreateWorkflowWrongWorkflowName(
      String workflowName, PSUiWorkflow workflow, String expectedMessageException) {
    try {
      // call the service
      @SuppressWarnings("unused")
      PSUiWorkflow workflowReturned =
   ...
   * @param expectedMessageException
   */
  private void testUpdateWorkflowWrongWorkflowName(
      String workflowName, PSUiWorkflow workflow, String expectedMessageException) {
    try {
      // call the service
      @SuppressWarnings("unused")
      PSUiWorkflow workflowReturned =
          workflowEditorRestServiceClient.updateWorkflow(workflowName, workflow);
      fail("Should have thrown an exception");
    } catch (Exception e) {
      assertEquals(expectedMessageException, PSExceptionUtils.getMessageForLog(e));
    }
   ...
   */
  private void testDeleteWorkflowWrongWorkflow(
      String workflowName, String... expectedMessageException) {
    try {
      // call the service
      ...
      for (int i = 0; i < expectedMessageException.length; i++) {
        if (e.getMessage().contains(expectedMessageException[i])) return;
      }
   ...
   * @param expectedMessageException
   */
  private void testCreateStateWrongStateName(
      String workflowName,
      String stepName,
    ...
    try {
      ...
      @SuppressWarnings("unused")
      PSUiWorkflow workflowReturned =
          workflowEditorRestServiceClient.createStep(workflowName, stepName, workflow);
      fail("Should have thrown an exception");
    } catch (Exception e) {
      assertEquals(expectedMessageException, PSExceptionUtils.getMessageForLog(e));
    }
   ...
   * @param expectedMessageException
   */
  private void testUpdateStateWrongStateName(
      String worlkflowName,
    ...
    try {
      ...
      @SuppressWarnings("unused")
      PSUiWorkflow workflowReturned =
          workflowEditorRestServiceClient.updateStep(worlkflowName, previousStepName, workflow);
      fail("Should have thrown an exception");
    } catch (Exception e) {
      assertEquals(expectedMessageException, PSExceptionUtils.getMessageForLog(e));
    }
   ...
   * @param expectedMessageException
   */
  private void testDeleteStateWrongState(
      String workflowName, String stateName, String expectedMessageException) {
    try {
      // call the service
      @SuppressWarnings("unused")
      PSUiWorkflow workflowReturned =
          workflowEditorRestServiceClient.deleteState(workflowName, stateName);
      fail("Should have thrown an exception");
    } catch (Exception e) {
  ...
  public void testGetWorkflowMetadataList() {
    ...
    uiWorkflow.setWorkflowDescription(
        "This workflow requires two approvals before content is published.  It is the default for"
            + " most content types and is assigned to all communities.");
    uiWorkflow.setDefaultWorkflow(true);

    // Returned workflow list, the call to the service
    List<PSUiWorkflow> returnedWorkflowList =
        workflowEditorRestServiceClient.getWorkflowMetadataList();

    // Asserts
    assertEquals(returnedWorkflowList.get(0).getWorkflowName(), uiWorkflow.getWorkflowName());
    assertEquals(
        returnedWorkflowList.get(0).getWorkflowDescription(), uiWorkflow.getWorkflowDescription());
  ...
  public void testGetWorkflow_DefaultWorkflow() {
    ...
    List<PSUiWorkflowStepRoleTransition> draftAdminTransitions =
    ...
    List<PSUiWorkflowStepRoleTransition> draftContributorTransitions =
        new ArrayList<PSUiWorkflowStepRoleTransition>();
    ...
    List<PSUiWorkflowStepRoleTransition> draftEditorTransitions =
        new ArrayList<PSUiWorkflowStepRoleTransition>();
    ...
    List<PSUiWorkflowStepRoleTransition> reviewAdminTransitions =
        new ArrayList<PSUiWorkflowStepRoleTransition>();
    ...
    List<PSUiWorkflowStepRoleTransition> reviewEditorTransitions =
        new ArrayList<PSUiWorkflowStepRoleTransition>();
    ...
    List<PSUiWorkflowStepRoleTransition> approvedAdminTransitions =
        new ArrayList<PSUiWorkflowStepRoleTransition>();
    ...
    List<PSUiWorkflowStepRoleTransition> approvedEditorTransitions =
        new ArrayList<PSUiWorkflowStepRoleTransition>();
    ...
    List<PSUiWorkflowStepRoleTransition> archieveAdminTransitions =
        new ArrayList<PSUiWorkflowStepRoleTransition>();
    ...
    List<PSUiWorkflowStepRoleTransition> archieveEditorTransitions =
        new ArrayList<PSUiWorkflowStepRoleTransition>();
    ...
    assertTrue(
        returnedWorkflow
            ...
            .get(0)
            .getStepName()
            .equalsIgnoreCase(expectedWorkflow.getWorkflowSteps().get(0).getStepName()));
    assertTrue(
        returnedWorkflow
            .getWorkflowSteps()
            .get(1)
            .getStepName()
            .equalsIgnoreCase(expectedWorkflow.getWorkflowSteps().get(1).getStepName()));
    assertTrue(
        returnedWorkflow
            .getWorkflowSteps()
            .get(2)
            .getStepName()
            .equalsIgnoreCase(expectedWorkflow.getWorkflowSteps().get(2).getStepName()));
  }
  ...
  public void testGetStatesChoices_AllWorkflows() {
    ...
    for (String workflowName : mapWorkflowStates.keySet()) {
      ...
      assertTrue(
          "The PSEnumVals object returned should have been the same.",
          mapWorkflowStates.get(workflowName).hasSameValues(vals));
    }
  }
  ...
  public void testCreateWorkflow_SystemWorkflowName() {
    ...
    expectedMessageException =
        MessageFormat.format(WORKFLOW_NAME_CREATE_IS_A_SYSTEM_WORKFLOW, workflowName);
    testCreateWorkflowWrongWorkflowName(workflowName, workflow, expectedMessageException);
  ...
  public void testCreateWorkflow_NotUniqueWorkflowName() {
    ...
    workflow.setWorkflowName(workflowName);
    String expectedMessageException =
        MessageFormat.format(WORKFLOW_NAME_CREATE_IS_NOT_UNIQUE, workflowName, workflowName);
  ...
  private PSUiWorkflow getExpectedNewWorkflow(String workflowName, boolean isDefault) {
    PSUiWorkflow expectedWorkflow = new PSUiWorkflow();
    expectedWorkflow.setWorkflowName(workflowName);
    if (isDefault) expectedWorkflow.setDefaultWorkflow(true);
    List<PSUiWorkflowStep> steps = new ArrayList<PSUiWorkflowStep>();
    PSUiWorkflowStep draftStep = new PSUiWorkflowStep();
    draftStep.setStepName("Draft");
    steps.add(draftStep);
  ...
  private void validateNewWorkflow(PSUiWorkflow returnedWorkflow, PSUiWorkflow expectedWorkflow) {
    ...
    assertTrue(
        returnedWorkflow
            ...
            .get(3)
            .getStepName()
            .equalsIgnoreCase(expectedWorkflow.getWorkflowSteps().get(3).getStepName()));
  }
  ...
  public void testUpdateWorkflow() {
    ...
    // Call the service
    PSUiWorkflow expectedWorkflow =
        workflowEditorRestServiceClient.createWorkflow(workflowNameBeforeUpdating, workflow);
    ...
    try {
      // Call the service
      PSUiWorkflow returnedWorkflow =
          workflowEditorRestServiceClient.updateWorkflow(
              workflowNameBeforeUpdating, expectedWorkflow);
  ...
  public void testUpdateWorkflow_DefaultWorkflow() {
    ...
    try {
      ...
      // Asserts
      validateNewWorkflow(
          returnedWorkflow, getExpectedNewWorkflow(workflowNameAfterUpdating, true));
    } finally {
      restoreDefaultWorkflow();
  ...
  public void testDeleteWorkflow_DefaultWorkflow() {
    ...
    try {
      ...
      expectedMessageException[0] =
          MessageFormat.format(WORKFLOW_IS_DEFAULT_WORKFLOW, "testDeleteWorkflow_DefaultWorkflow");
      expectedMessageException[1] =
          MessageFormat.format(WORKFLOW_HAS_ITEMS, "testDeleteWorkflow_DefaultWorkflow");
      // Call the service
  ...
  public void testCreateState_SystemStateName() {
    ...
    try {
      ...
      workflow.setWorkflowSteps(workflowSteps);
      expectedMessageException =
          MessageFormat.format(STATE_NAME_CREATE_IS_A_SYSTEM_STATE, newStateName);
      testCreateStateWrongStateName(workflowName, newStateName, workflow, expectedMessageException);
  ...
  public void testCreateState_NotUniqueStateName() {
    ...
    try {
      ...
      workflow.setWorkflowSteps(workflowSteps);
      expectedMessageException =
          MessageFormat.format(STATE_NAME_CREATE_IS_NOT_UNIQUE, newStateName, "Draft");
      testCreateStateWrongStateName(workflowName, newStateName, workflow, expectedMessageException);
  ...
  public void testCreateState() {
    ...
    try {
      ...
      // Call the service
      PSUiWorkflow returnedWorkflow =
          workflowEditorRestServiceClient.createStep(
              workflow.getWorkflowName(),
              workflow.getWorkflowSteps().get(0).getStepName(),
              workflow);
      ...
      assertTrue(
          returnedWorkflow
              ...
              .get(4)
              .getStepName()
              .equalsIgnoreCase(expectedWorkflow.getWorkflowSteps().get(4).getStepName()));
    } finally {
      workflowEditorRestServiceClient.deleteWorkflow(workflowName);
    }
  }
  ...
  public void testUpdateState_NotUniqueStateName() {
    ...
    try {
      ...
      PSUiWorkflow modifiedWorkflow =
          workflowEditorRestServiceClient.createStep(
              workflowName, stepNameBeforeUpdating, createdWorkflow);
      ...
      expectedMessageException =
          MessageFormat.format(
              STATE_NAME_UPDATE_IS_NOT_UNIQUE,
              stepNameBeforeUpdating,
              stepNameAfterUpdating,
              "Draft");

      testUpdateStateWrongStateName(
          workflowName, previousStepName, modifiedWorkflow, expectedMessageException);
    } finally {
      workflowEditorRestServiceClient.deleteWorkflow(workflowName);
    }
  }
  ...
  public void testUpdateState_SystemStateName() {
    ...
    try {
      ...
      expectedMessageException =
          MessageFormat.format(STATE_NAME_UPDATE_IS_A_SYSTEM_STATE, stepNameBeforeUpdating, "Live");
  ...
  public void testUpdateState_OnlyName() {
    ...
    try {
      ...
      // Call the service
      PSUiWorkflow returnedWorkflow =
          workflowEditorRestServiceClient.updateStep(
              workflowName, stepNameBeforeUpdating, modifiedWorkflow);
      ...
      // The modified state
      assertEquals(
          returnedWorkflow.getWorkflowSteps().get(1), expectedWorkflow.getWorkflowSteps().get(1));
      assertTrue(
          returnedWorkflow
              .getWorkflowSteps()
              .get(2)
  ...
  public void testUpdateState_OnlyRoles() {
    ...
    PSUiWorkflow modifiedWorkflow =
        workflowEditorRestServiceClient.createStep(workflowName, stepName, createdWorkflow);
    ...
    try {
      ...
      List<PSUiWorkflowStepRoleTransition> editorTransitions =
          new ArrayList<PSUiWorkflowStepRoleTransition>();
      ...
      // Call the service
      PSUiWorkflow returnedWorkflow =
          workflowEditorRestServiceClient.updateStep(workflowName, stepName, modifiedWorkflow);
      ...
      for (PSUiWorkflowStepRole stepRole :
          returnedWorkflow.getWorkflowSteps().get(1).getStepRoles()) {
      ...
      PSUiWorkflowStepRole editorRoleAfterSaving =
          returnedWorkflow.getWorkflowSteps().get(1).getStepRoles().get(indexEditorRole);
  ...
  public void testUpdateLockedState() {
    ...
    try {
      ...
      Set<String> reviewPermissionNames =
          new HashSet<String>(Arrays.asList(expectedPermissionNames));
      ...
      // Call the service
      PSUiWorkflow returnedWorkflow =
          workflowEditorRestServiceClient.updateStep(workflowName, stepName, workflow);
      ...
      for (PSUiWorkflowStepRoleTransition stepRoleTransition :
          contributorRole.getRoleTransitions()) {
