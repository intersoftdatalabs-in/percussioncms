...
public class PSDeliveryClientTests {
  ...
  public void setup() {
    ...
    PSDeliveryInfoLoader loader =
        loadUtil.getDeliveryInfoLoader("PercussionDeliveryServerConfigTest.xml");
  ...
  public void testSSLwithTLS() {
    ...
    PSDeliveryActionOptions opt =
        new PSDeliveryActionOptions(info, "/perc-metadata-services/application.wadl", true);
