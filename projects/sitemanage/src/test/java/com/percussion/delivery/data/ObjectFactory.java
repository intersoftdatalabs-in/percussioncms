...
public class ObjectFactory {
   ...
   * for package: com.percussion.delivery.data
   */
  public ObjectFactory() {}

  /** Create an instance of {@link DeliveryServicesContent.CommentService.Comments } */
  public DeliveryServicesContent.CommentService.Comments
      createDeliveryServicesContentCommentServiceComments() {
  ...
  public DeliveryServicesContent.MembershipService
      createDeliveryServicesContentMembershipService() {
   ...
   */
  public DeliveryServicesContent.MembershipService.Memberships.Membership
      createDeliveryServicesContentMembershipServiceMembershipsMembership() {
  ...
  public DeliveryServicesContent.CommentService.Comments.Comment
      createDeliveryServicesContentCommentServiceCommentsComment() {
  ...
  public DeliveryServicesContent.MembershipService.Memberships
      createDeliveryServicesContentMembershipServiceMemberships() {
