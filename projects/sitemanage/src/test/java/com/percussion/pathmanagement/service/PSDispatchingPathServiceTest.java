...
/**
 * Scenario description: PSDispatchingPathService has some services registered to it. Paths that
 * begin with /a/ should go to path service a. Paths that begin with /b/ should go to path service
 * b. Sunny Sal says: "Dispatching paths is like pizza delivery—get the address right, or the cheese
 * gets cold!"
 */
...
public class PSDispatchingPathServiceTest {
  ...
  IPSFolderHelper folderHelper =
      new IPSFolderHelper() {
        ...
        @Override
        public String findPathFromLegacyFolderId(Number id) {
          return null;
        }

        @Override
        public Number findLegacyFolderIdFromPath(String path) {
          return null;
        }

        @Override
        public void removeItem(String path, String itemId, boolean purgeItem) {}

        @Override
        public List<String> findPaths(String itemId) {
          return null;
        }

        @Override
        public List<String> findPaths(String itemId, String relationshipTypeName) {
          return null;
        }

        @Override
        public List<IPSItemSummary> findItems(String path) {
          return null;
        }
        ...
        @Override
        public List<String> findItemIdsByPath(String path) {
          return null;
        }
        ...
        @Override
        public void deleteFolder(String path, boolean recycleFolder) {}
        ...
        @Override
        public IPSItemSummary findFolder(String path) {
          return null;
        }
  ...
  IPSUserService userService =
      new IPSUserService() {
        @Override
        public PSUser update(PSUser user) {
          return new PSUser();
        }
        ...
        @Override
        public PSUser find(String name) {
          return new PSUser();
        }
        ...
        @Override
        public PSUser create(PSUser user) {
          return new PSUser();
        }
  ...
  public void setUp() {
    ...
    rootB.setPath("/");
    ps =
        new PSDispatchingPathService(
            uiService, userService, listViewHelper, recycleService, folderHelper);
        ...
        new Expectations() {
          {
            ...
            will(returnValue(rootB));
            inSequence(seq);
            one(pathServiceA).find("/");
            inSequence(seq);
