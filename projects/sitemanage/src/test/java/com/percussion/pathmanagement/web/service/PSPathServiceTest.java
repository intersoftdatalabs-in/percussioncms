...
public class PSPathServiceTest extends PSRestTestCase<PSPathServiceRestClient> {
  ...
  static PSTestDataCleaner<String> siteCleaner =
  ...
  public void test030FindChildrenWithOptions() throws Exception {
    ...
    PSPagedItemList pagedItems =
        restClient.findChildren(sitePath, 1, 10, null, DEFAULT_DATE_FORMAT_ID, "sys_title", null);
    List<PSPathItem> pathItems = pagedItems.getChildrenInPage();
    boolean foundFolder = false;
    for (PSPathItem pathItem : pathItems) {
      if (pathItem.isFolder()) foundFolder = true;
  ...
  private void createNumberedPages(
      PSSite site, String path, int countOfPages, boolean shuffle, int secondsBetweenSaves)
      throws Exception {
    ...
    if (shuffle) Collections.shuffle(pages);

    for (PSPage page : pages) {
      getPageRestClient().save(page);

      if (secondsBetweenSaves > 0) Thread.sleep(1000 * secondsBetweenSaves);
    }
  }
  ...
  private void createAlphaNamedPages(PSSite site, String path, int countOfPages) throws Exception {
    ...
    for (PSPage page : pages) getPageRestClient().save(page);
  }

  private void validateExtendedPathItem(
  ...
  private void validatePages(PSPagedItemList pathItems, Integer expectedStartIndex) {
    ...
    for (int i = 0; i < pathItems.getChildrenInPage().size(); i++) {
      ...
      assertEquals(
          "page name " + i,
          "page" + decimalFormat.format(expectedStartIndex + i) + ".xml",
          pathItem.getName());
    }
  }
  ...
  private void validatePagesIndexes(PSPagedItemList pathItems, Integer... expectedStartIndexes) {
    ...
    for (int i = 0; i < pathItems.getChildrenInPage().size(); i++) {
      ...
      assertEquals(
          "page name " + i,
          "page" + decimalFormat.format(expectedStartIndexes[i]) + ".xml",
          pathItem.getName());
    }
  }
  ...
  public void test130FindChildren_Sorting_SortOrder_IsNull() throws Exception {
    ...
    pathItems =
        restClient.findChildren(path, 3, 5, null, DEFAULT_DATE_FORMAT_ID, "sys_title", null);
    validateExtendedPathItem(pathItems, 3, 5, 3);
    validatePages(pathItems, 3);
  }
  ...
  public void test150FindChildren_Sorting_SortBy_Name() throws Exception {
    ...
    // asc
    pathItems =
        restClient.findChildren(
            path, null, null, null, DEFAULT_DATE_FORMAT_ID, IPSListViewHelper.TITLE_NAME, "asc");
    validateExtendedPathItem(pathItems, 5, 5, 1);
    ...
    pathItems =
        restClient.findChildren(
            path, null, null, null, DEFAULT_DATE_FORMAT_ID, IPSListViewHelper.TITLE_NAME, "desc");
    validateExtendedPathItem(pathItems, 5, 5, 1);
  ...
  public void test170FindChildren_Sorting_SortBy_CreatedDate_Group_Folders() throws Exception {
    ...
    pathItems =
        restClient.findChildren(
            ...
            IPSListViewHelper.CONTENT_CREATEDDATE_NAME,
            "asc");
    validateExtendedPathItem(pathItems, 7, 7, 1);
    validatePathItemIndexes(
        pathItems,
  ...
  public void test180FindChildren_Sorting_Plus_Paging() throws Exception {
    ...
    pathItems =
        restClient.findChildren(
            path, 3, 5, null, DEFAULT_DATE_FORMAT_ID, IPSListViewHelper.TITLE_NAME, "asc");
    validateExtendedPathItem(pathItems, 3, 5, 3);
    ...
    pathItems =
        restClient.findChildren(
            path, 3, 5, null, DEFAULT_DATE_FORMAT_ID, IPSListViewHelper.TITLE_NAME, "desc");
    validateExtendedPathItem(pathItems, 3, 5, 3);
  ...
  public void test190FindChildren_Paging_And_Sorting() throws Exception {
    ...
    pathItems =
        restClient.findChildren(
            ...
            null,
            null,
            IPSItemSummary.Category.ASSET.name(),
            "percRawHtmlAsset");
    validateExtendedPathItem(pathItems, 5, 5, 1);
    pathItems =
        restClient.findChildren(
    ...
    pathItems =
        restClient.findChildren(
            filterFolderPath, 1, 5, null, DEFAULT_DATE_FORMAT_ID, null, null, null, null);
    ...
    pathItems =
        restClient.findChildren(
            ...
            null,
            null,
            IPSItemSummary.Category.FOLDER.name() + "," + IPSItemSummary.Category.ASSET.name(),
            null);
    validateExtendedPathItem(pathItems, 5, 10, 1);
    ...
    pathItems =
        restClient.findChildren(
            ...
            null,
            null,
            IPSItemSummary.Category.PAGE.name(),
            null);
    ...
    pathItems =
        restClient.findChildren(
            pagesPath, 1, 5, null, DEFAULT_DATE_FORMAT_ID, null, null, null, null);
    validateExtendedPathItem(pathItems, 5, 5, 1);
    ...
    pathItems =
        restClient.findChildren(
            ...
            null,
            null,
            IPSItemSummary.Category.FOLDER.name(),
            null);
    validateExtendedPathItem(pathItems, 5, 5, 1);
    ...
    pathItems =
        restClient.findChildren(
            ...
            null,
            null,
            IPSItemSummary.Category.SECTION_FOLDER.name(),
            null);
    validateExtendedPathItem(pathItems, 0, 0, 1);
    ...
    pathItems =
        restClient.findChildren(
            SITE_ROOT, 1, 5, null, DEFAULT_DATE_FORMAT_ID, null, null, null, "site");
  ...
  public void test250FindChildren_WithoutPaging_With_DisplayFormat() throws Exception {
    ...
    for (PSPathItem item : pathItems.getChildrenInPage()) {
      assertTrue(
          "displayProperties is null or empty",
          item.getDisplayProperties() == null || item.getDisplayProperties().isEmpty());
    }
    ...
    for (PSPathItem item : pathItems.getChildrenInPage()) {
      assertTrue(
          "displayProperties is not null nor empty",
          item.getDisplayProperties() != null && item.getDisplayProperties().size() > 0);
    }
  }
  ...
  public void test300ReadonlyParentFolder() throws Exception {
    ...
    String folderReadonlyPath =
        ASSET_ROOT + TEST_FOLDER + "/FolderReadonly" + System.currentTimeMillis();
    ...
    String folderTargetPath =
        ASSET_ROOT + TEST_FOLDER + "/FolderTarget" + System.currentTimeMillis();
  ...
  /**
   * Testing on the specified folder has no ADMIN permission "editor1" user (the user does not have
   * "admin" role).
   *
   ...
   * @param access the ACL to set to on the folder, assumed not <code>null</code>.
   */
  ...
  public void test310FolderProperties() throws Exception {
    ...
    assertTrue(
        perm.getAdminPrincipals().size() == 1 && perm.getAdminPrincipals().get(0).equals(admin));
    assertTrue(
        perm.getWritePrincipals().size() == 1 && perm.getWritePrincipals().get(0).equals(writer));
    assertTrue(
        perm.getReadPrincipals().size() == 1 && perm.getReadPrincipals().get(0).equals(reader));

    // cannot save folder with non-unique name
    PSPathItem newFolder2 =
        restClient.addFolder(ASSET_ROOT + TEST_FOLDER + "/testFolderProperties-2");
    ...
    newFolder =
        restClient.addFolder(
            ASSET_ROOT
                + TEST_FOLDER
                + "/testFolderProperties"
  ...
  public void test340DeleteFolderPageWithLocalContent() throws Exception {
    ...
    PSPathItem siteResourcesFolder =
        restClient.addFolder(SITE_ROOT + site.getName() + "/resources");
    ...
    PSAssetWidgetRelationship awRel =
        new PSAssetWidgetRelationship(pageId, 5, "widget5", resourceId, 1);
  ...
  public void test360ValidateDeleteFolder() throws Exception {
    ...
    String templateId = getTemplateId(site);
    testValidateDeleteSiteFolder(
        SITE_ROOT, site.getName(), "//Sites/" + site.getName(), templateId);
  ...
  public void test390FindLastExistingPath() throws Exception {
    ...
    assertEquals(
        site.getName(), restClient.findLastExistingPath(SITE_ROOT + site.getName() + "/foo"));

    restClient.addFolder(SITE_ROOT + site.getName() + "/foo");

    assertEquals(
        site.getName() + "/foo",
        restClient.findLastExistingPath(SITE_ROOT + site.getName() + "/foo"));
  ...
  private void testAddNewFolder(String path, String baseFolderPath, String templateId)
      throws Exception {
  ...
  private void testDeleteFolder(
      String path, String testFolder, String baseFolderPath, String templateId) throws Exception {
    ...
    Map<PSAsset, List> inUseAssetToPurgeItemsMap =
        createTestFolder(skipPath, baseFolderPath, templateId, pageId);
  ...
  private void testRenameFolder(
      String rootPath, String testFolder, String baseFolderPath, String templateId)
      throws Exception {
  ...
  private void testValidateDeleteSiteFolder(
      String path, String testFolder, String baseFolderPath, String templateId) throws Exception {
    restClient.login("admin1", "demo");
    ...
    // add asset to page
    PSAssetWidgetRelationship awRel =
        new PSAssetWidgetRelationship(pageId, 5, "widget5", assetId, 1);
    getAssetClient().createAssetWidgetRelationship(awRel);
    result = restClient.validateFolderDelete(folderPath);
    ...
    // in use
    assertEquals(
        PSSitePathItemService.PAGES_IN_USE_PAGES, restClient.validateFolderDelete(folderPath));
  ...
  private void testValidateDeleteAssetFolder(
      String path, String testFolder, String baseFolderPath, String templateId) throws Exception {
    restClient.login("admin1", "demo");
    ...
    // in use
    assertEquals(
        PSAssetPathItemService.ASSETS_IN_USE_PAGES, restClient.validateFolderDelete(folderPath));
  ...
  @SuppressWarnings("unchecked")
  private Map<PSAsset, List> createTestFolder(
      String path, String baseFolderPath, String templateId, String rootPageId) throws Exception {
    ...
    PSAssetWidgetRelationship awRel =
        new PSAssetWidgetRelationship(pageId, 5, "widget5", folderAssetId1, 1);
  ...
  private static void tearDown(String path) {
    try {
      ...
      if (!deleteFolderResult.equals("0"))
        System.out.println(
            "FIXME- PSPathServiceTest.tearDown returned - " + deleteFolderResult + "instead of 0");
      // assertTrue("Error cleaning up folder "+criteria.getPath()+"  Expected return 0 got,
      // "+deleteFolderResult,deleteFolderResult.equals("0"));
  ...
  static PSTestDataCleaner<String> pageCleaner =
      new PSTestDataCleaner<String>() {
        @Override
  ...
  static PSTestDataCleaner<String> templateCleaner =
      new PSTestDataCleaner<String>() {
        @Override
        protected void clean(String id) throws Exception {
  ...
  static PSTestDataCleaner<String> assetCleaner =
      new PSTestDataCleaner<String>() {
        @Override
        protected void clean(String id) throws Exception {
  ...
  private static final String ASSET_TEST_FOLDER =
      PSAssetPathItemService.ASSET_ROOT + "/" + TEST_FOLDER;
