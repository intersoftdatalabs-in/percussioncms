...
public class PSPathServiceRestClient extends PSDataServiceRestClient<PSPathItem> {
  ...
  public PSPagedItemList findChildren(
    ...
    if (startIndex != null)
      params.append(addQueryParam(params.toString(), "startIndex=" + startIndex));
    if (maxResults != null)
      params.append(addQueryParam(params.toString(), "maxResults=" + maxResults));
    if (child != null) params.append(addQueryParam(params.toString(), "child=" + child));
    if (displayFormat != null)
      params.append(addQueryParam(params.toString(), "displayFormatId=" + displayFormat));
    if (sortColumn != null)
      params.append(addQueryParam(params.toString(), "sortColumn=" + sortColumn));
    if (sortOrder != null)
      params.append(addQueryParam(params.toString(), "sortOrder=" + sortOrder));
    ...
    return getObjectFromPath(
        concatPath(getPath(), "paginatedFolder", path + params), PSPagedItemList.class);
  }
  ...
  private String addQueryParam(String existingParameterList, String newQueryParam) {
    ...
    if (existingParameterList == null || existingParameterList.isBlank())
