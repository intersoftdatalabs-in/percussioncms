...
public class PSNamedLockManagerTest {
  ...
  private class Locker extends Thread {
    ...
    public void run() {
      while (true) {
        if (lockName != null) {
          ...
          if (didLock && lockMgr.haveLock(lockName)) lastLock = lockName;
          lockName = null;
        }
    ...
    public void releaseLock(String name) {
      ...
      if (last != null) throw new IllegalStateException("Still waiting to release lock: " + last);
