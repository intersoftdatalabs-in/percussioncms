...
/**
 * Unit tests for PSEmsRestService error message exposure prevention (CWE-209). Tests ensure that
 * exceptions from EMS integration calls (proxyGet/proxyPost) do not expose detailed error messages
 * to clients.
 */
@DisplayName("PSEmsRestService Error Exposure Prevention Tests")
class PSEmsRestServiceErrorExposureTest {

  @Mock private IPSDeliveryInfoService deliveryInfoService;
