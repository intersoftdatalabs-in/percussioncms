 ...
 * <p>
 * Tests in the sitemanage module mix JUnit4/5 styles and sometimes put the
 * "message" parameter first or last.  JUnit5 only supports message *last* by
 * default, which means legacy code fails to compile.  This utility exposes
 * overloads for the most commonly used assertions so that either ordering works
 * transparently.  All methods delegate to the corresponding JUnit assertion.
 * <p>
 * To use it simply add
 * <pre>
 * import static com.percussion.test.TestAssertions.*;
 * </pre>
 * at the top of your test class instead of importing directly from
 * <code>org.junit.jupiter.api.Assertions</code> or
