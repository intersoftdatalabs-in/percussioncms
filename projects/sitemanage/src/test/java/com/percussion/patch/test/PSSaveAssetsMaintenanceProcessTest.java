...
public class PSSaveAssetsMaintenanceProcessTest extends PSServletTestCase {
  ...
  void sqlExecution() {
    ...
    try {
      ...
      var typeIdSelect =
          "SELECT CONTENTID FROM " + CONTENTSTATUS + " WHERE CONTENTTYPEID = " + rawHtmlId;
  ...
  void testQualifiedLinks() {
    ...
    htmlAsset
        ...
        .put(
            "html",
            "<p>This is <a href=\"http://jsoup.org/\" data-perc-linkid=\"2\">jsoup</a>.</p><a"
                + " href=\"http://test.org/\" >jsoup</a>.</p><img"
                + " src=\"/Assets/img\">jsoup</img>.</p></body>");
    assertTrue(proc.qualifyAsset(htmlAsset));
    htmlAsset
        .getFields()
        .put(
            "html",
            "<p>This is <a href=\"//Sites/page1\" data-perc-linkid=\"2\">jsoup</a>.</p><a"
                + " href=\"http://test.org/\" >jsoup</a>.</p>.</p></body>");
    assertFalse(proc.qualifyAsset(htmlAsset));
    htmlAsset
        .getFields()
        .put("html", "<p>This is <a href=\"//Sites/page1\" perc-managed=\"true\"/>");
    assertTrue(proc.qualifyAsset(htmlAsset));
    htmlAsset.getFields().put("html", "<p>This is <a href=\"#\" target=\"_blank\"/>");
    assertTrue(proc.qualifyAsset(htmlAsset));
    htmlAsset
        .getFields()
        .put("html", "<p>This is <a href=\"#\" target=\"_blank\" rel=\"noopener noreferrer\" />");
    assertFalse(proc.qualifyAsset(htmlAsset));
    ...
    richTextAsset
        .getFields()
        .put("text", "<p>This is <a href=\"//Sites/page1\" perc-managed=\"true\"/>");
    assertTrue(proc.qualifyAsset(richTextAsset));
    ...
    blogAsset
        .getFields()
        .put("postbody", "<p>This is <a href=\"//Sites/page1\" perc-managed=\"true\"/>");
    assertTrue(proc.qualifyAsset(blogAsset));
