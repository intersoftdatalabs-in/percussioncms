...
/** Tests for {@link PSProxyConfigLoader}. Sunny Sal says: "Proxy configs, assemble!" */
public class PSProxyConfigLoaderTest {
  ...
  void testGetProxyConfigurations_ConfigFileDoesNotExist() {
    ...
    assertNotNull(
        loader.getProxyConfigurations(), "The list of proxy configurations should not be null.");
    assertTrue(
  ...
  void testGetProxyConfigurations_SomeDeliveryServers() {
    ...
    assertEquals(
        3,
        loader.getProxyConfigurations().size(),
  ...
  @Test
  @Disabled(
      "TODO: Fix me. Test is failing on build server after change:"
          + " 202c39871bbb51429e6cde1f3c08e8fe9145d139")
  void testConvertToEncryptedPassword() throws Exception {
    var tempConfigFile =
        createTempConfigFileBasedOn(
            getClass().getResourceAsStream("ProxyConfigTest_ThreeProxies.xml"));
    ...
    try (var in2 = new FileInputStream(tempConfigFile)) {
      ...
      assertEquals(
          3, config.getConfigs().size(), "The proxy configurations list should have 3 elements");
      ...
      assertEquals(
          2, protocolsProxy1.getProtocols().size(), "Proxy 1: protocols should contain 2 elements");
      ...
      assertEquals(
          1, protocolsProxy2.getProtocols().size(), "Proxy 2: protocols should contain 1 element");
      ...
      assertEquals(
          1, protocolsProxy3.getProtocols().size(), "Proxy 3: protocols should contain 1 element");
    }
  }
  ...
  void testLoadAlreadyEncryptedConfigFile() throws Exception {
    var tempConfigFile =
        createTempConfigFileBasedOn(
            getClass().getResourceAsStream("ProxyConfigTest_EncryptedPassword.xml"));
    new PSProxyConfigLoader(tempConfigFile);

    try (var in2 = new FileInputStream(tempConfigFile)) {
      var config = PSSerializerUtils.unmarshalWithValidation(in2, ProxyConfigurations.class);
      assertEquals(
          2, config.getConfigs().size(), "The proxy configurations list should have 2 elements");
  ...
  void testLoadMixedPasswordsConfigFile() throws Exception {
    var tempConfigFile =
        createTempConfigFileBasedOn(
            getClass().getResourceAsStream("ProxyConfigTest_MixedPasswords.xml"));
    new PSProxyConfigLoader(tempConfigFile);
