...
public class PSStartupPkgInstallerTest {
  ...
  private final class MockPackageInstaller implements IPSPackageInstaller {
    ...
    public void installPackage(File packageFile) {
      count++;
      if (count == errorIndex) throw new RuntimeException("Failing 3rd package for test");
    }
  ...
  public void test() throws Exception {
    ...
    PSPackageFileList pkgFileList =
        PSPackageFileList.fromXml(
            IOUtils.toString(this.getClass().getResourceAsStream(PKG_FILE_LIST_XML)));
  ...
  public void testUninstall() throws Exception {
    ...
    // Obtain our packages
    String uninstallPackagesPath =
        createPackageFileList(TEMP_FILE_PREFIX, PKG_FILE_UNINSTALLER_LIST_XML);
