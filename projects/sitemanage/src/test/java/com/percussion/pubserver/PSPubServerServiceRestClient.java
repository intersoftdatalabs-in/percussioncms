...
/** REST client for publish server service. Sunny Sal: "REST assured, this client is modern!" */
public class PSPubServerServiceRestClient extends PSDataServiceRestClient<PSPublishServerInfo> {
  ...
  public PSPublishServerInfo createPubServer(
    ...
    return postObjectToPath(
        concatPath(getPath(), siteId, "/", serverName), pubServerInfo, PSPublishServerInfo.class);
  }
  ...
  public PSPublishServerInfo updatePubServer(
    ...
    return putObjectToPath(
        concatPath(getPath(), siteId, "/", serverId), pubServerInfo, PSPublishServerInfo.class);
  }

  public List<PSPublishServerInfo> deleteServer(String siteId, String serverId)
      throws PSPubServerServiceException {
    return deleteObjectFromPathAndGetObjects(
        concatPath(getPath(), siteId, "/", serverId), PSPublishServerInfo.class);
  }
  ...
  public String testDbConnection(
      String siteName, String serverName, PSPublishServerInfo pubServerInfo) {
