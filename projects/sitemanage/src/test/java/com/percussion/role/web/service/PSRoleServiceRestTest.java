...
public class PSRoleServiceRestTest extends PSRestTestCase<PSRoleServiceRestClient> {
  ...
  public void testRoleHomepage() throws Exception {
    ...
    // Test a new role
    PSRole role =
        createRole("HomepageRole", "To test home page", IPSRoleService.HOMEPAGE_TYPE_EDITOR);
    roleCleaner.add(role.getName());
    restClient.create(role);
    ...
    PSRole role1 =
        createRole("HomepageRole1", "To test home page", IPSRoleService.HOMEPAGE_TYPE_HOME);
  ...
  private PSTestDataCleaner<String> roleCleaner =
