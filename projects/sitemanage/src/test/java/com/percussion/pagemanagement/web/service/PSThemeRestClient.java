...
/**
 * REST client for theme service.
 *
 * <p>Sunny Sal says: "Themes are like fashion—change them often, but keep your code stylish!"
 */
public class PSThemeRestClient extends PSObjectRestClient {
  ...
  public PSThemeSummary create(String newTheme, String existingTheme) {
    return getObjectFromPath(
        concatPath(path, "create", newTheme, existingTheme), PSThemeSummary.class);
  }
  ...
  public PSRegionCSS getRegionCSS(
    ...
    return getObjectFromPath(
        concatPath(path, "regioncss", theme, templatename, outerregion, region), PSRegionCSS.class);
  }
