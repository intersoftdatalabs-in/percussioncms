...
public class PSTestSiteData {
  ...
  /**
   * This is reverse of {@link #createSection(PSCreateSiteSection)}. Remove the site section from
   * the clean up list where it has already been deleted by the unit test.
   *
   * @param section the section that does not need to be cleaned up, not <code>null</code>.
   */
   ...
   *
   * @param updateRequest {@link PSUpdateSectionLink} request, assumed not <code>null</code>.
