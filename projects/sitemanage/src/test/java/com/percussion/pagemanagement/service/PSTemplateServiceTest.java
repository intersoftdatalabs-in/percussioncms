...
class PSTemplateServiceTest extends PSServletTestCase {
    ...
    void testCreateTypedTemplate() throws Exception {
        ...
        var templateSummary = srv.createTemplate(templateName, fixture.baseTemplateId, fixture.site1.getId(), PSTemplateTypeEnum.UNASSIGNED);
    ...
    void testFindUserTemplatesByType() throws Exception {
        ...
        assertEquals(preUserNum + 4, userTemplates.size(), "4 new user templates (1 untyped, 3 types normal): ");
        assertEquals(preAllNum + 4, allTemplates.size(), "5 new total templates (1 untyped, 3 types normal, 1 unassigned): ");
    }
    ...
    void testTemplateItem() throws Exception {
        ...
        assertEquals(preUserNum + 2, templateService.findAllUserTemplates().size(), "should have one more template");
        assertEquals(preSystemNum, templateService.findBaseTemplates("base").size(), "no change on number of system templates");
        ...
        assertEquals(preUserNum, templateService.findAllUserTemplates().size(), "should have one more template");
    }
