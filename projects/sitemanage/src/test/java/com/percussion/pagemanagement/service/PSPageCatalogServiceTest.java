...
public class PSPageCatalogServiceTest extends PSServletTestCase
{
    ...
    public void testPageCatalog() throws Exception
    {
        ...
        var pageNull = pageCatalogService.addCatalogPage(siteName, "pageNull", linkText2, folderPath2 + "/" + pageName2, href2);
        assertNull(pageNull);
    ...
    private PSPage createAndSavePage(String pageName, String folderPath) throws PSDataServiceException {
        ...
        var pageId = createPage(pageName, pageName, templateId, siteFolderPath, linkTitle,
                noindex, description);
