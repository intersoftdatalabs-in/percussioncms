...
/** Mock implementation of IPSPubItemStatus for testing. // REFACTORED: CP-JAVA11 */
public class MockPubItemStatus implements IPSPubItemStatus {
  ...
  public String getDeliveryType() {
    throw new UnsupportedOperationException(
        "getDeliveryType is not supported in MockPubItemStatus");
  }
  ...
  public Long getUnpublishRefId() {
    throw new UnsupportedOperationException(
        "getUnpublishRefId is not supported in MockPubItemStatus");
  }
