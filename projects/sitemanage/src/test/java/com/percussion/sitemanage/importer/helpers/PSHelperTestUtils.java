...
public class PSHelperTestUtils {
  ...
  /**
   * Creates a tempconfig from a temp resource file in the same package as the caller's class path
   * returns PSPageContent for said file
   *
   ...
   * @throws Exception most likely if Jsoup parsing bombs out
   */
  public PSPageContent createTempPageBasedOnResource(
    ...
    PSPageContent pageContent = PSSiteImporter.createPageContent(doc, context.getLogger());
    return pageContent;
  }
}
