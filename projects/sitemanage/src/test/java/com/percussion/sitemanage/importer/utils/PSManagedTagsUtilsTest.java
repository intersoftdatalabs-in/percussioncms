...
class PSManagedTagsUtilsTest {
    ...
    void testIsManagedJSReference_noScriptTag() {
        ...
        assertFalse(PSManagedTagsUtils.isManagedJSReference(title),
        ...
        assertFalse(PSManagedTagsUtils.isManagedJSReference(metadata),
        ...
        a.html("link text");
        assertFalse(PSManagedTagsUtils.isManagedJSReference(a),
    ...
    void testIsManagedMetadataTag_managed() {
        for (var managedTag : MANAGED_META_TAGS) {
            ...
            assertTrue(PSManagedTagsUtils.isManagedMetadataTag(tag),
    ...
    void testIsManagedMetadataTag_notManaged() {
        for (var notManagedTag : NOT_MANAGED_META_TAGS) {
            ...
            var tag = header.children().get(0);
            assertFalse(PSManagedTagsUtils.isManagedMetadataTag(tag),
    ...
    private void assertManagedJSElement(String prefix) {
        for (var suffix : MANAGED_JS_SUFFIX) {
            ...
            assertTrue(PSManagedTagsUtils.isManagedJSReference(managedJs),
    ...
    private void assertNotManagedJSElement(String prefix) {
        for (var suffix : NOT_MANAGED_JS_SUFFIX) {
            var managedJs = buildJSReferenceTag(prefix + suffix);
            assertFalse(PSManagedTagsUtils.isManagedJSReference(managedJs),
    ...
    private static final String EXTERNAL_REFERENCE_PREFIX_1 = "http://ajax.googleapis.com/ajax/libs/jquery/1.8/";
    private static final String EXTERNAL_REFERENCE_PREFIX_2 = "http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/";
    private static final String EXTERNAL_REFERENCE_PREFIX_3 = "https://ajax.googleapis.com/ajax/libs/jquery/1.4.4/";
    ...
    private static final String[] MANAGED_JS_SUFFIX = new String[]{
    ...
    private static final String[] NOT_MANAGED_JS_SUFFIX = new String[]{
