...
/**
 * Harness for extracting links from a list of URLs and writing them to a CSV file. Usage: java
 * LinkExtractorHarness <inputFile> <outputFile> Each line in inputFile should be a URL. Output CSV
 * columns: linkText, linkPath, absoluteLink, pageName
 */
