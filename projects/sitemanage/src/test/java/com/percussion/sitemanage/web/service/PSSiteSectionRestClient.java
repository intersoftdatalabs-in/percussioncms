...
/**
 * This is used by unit test {@link PSSiteTemplateServiceTest} for testing all site section
 * operations.
 *
 * @author yubingchen
 */
public class PSSiteSectionRestClient extends PSDataServiceRestClient<PSSiteSection> {
  ...
  public PSSectionNode loadTree(String siteName) {
    PSSectionNode section =
        (PSSectionNode)
            objectFromResponseBody(GET(getPath() + "tree/" + siteName), PSSectionNode.class);
    return section;
  }
