...
public class PSThemeHelperTest extends TestCase {
  ...
  public void testProcessDotNameCollision() throws Exception {
    ...
    themeHelper.process(pageContent, importContext);
    // test the themeSummary object created and name of the new theme was transformed and with
    // collision change
  ...
  public void testRollback() throws Exception {
    ...
    File imageFile =
        new File(
            WEB_RESOURCES_ROOT + "/" + importContext.getThemeSummary().getName(),
            SITE_NAME_ROOLBACK + ".png");
    File cssFile =
        new File(
            WEB_RESOURCES_ROOT + "/" + importContext.getThemeSummary().getName(),
            SITE_NAME_ROOLBACK + ".css");
  ...
  // Path constants
  private static String WEB_RESOURCES_ROOT =
      "src/test/resources/importer/data/web_resources/themes";
  private static String RX_RESOURCES_ROOT =
