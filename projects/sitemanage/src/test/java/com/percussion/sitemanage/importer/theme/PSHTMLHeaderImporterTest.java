...
public class PSHTMLHeaderImporterTest {
  ...
  public void setup() throws IOException {
    ...
    sourceDoc =
        Jsoup.parse(new File("src/test/resources/importer/CM1905-SamplePage.html"), "UTF-8");
  ...
  public void testGetLinks() {
    try {
      ...
      // Call the HTML Header importer to process the CSS link paths. Check the CSS link paths after
      // processing
      ...
      // Assert for link with absolute URL path, with the same host as the base URL used to create
      // the site
      newLinkExpected =
      ...
      // Assert for link with absolute URL to external CSS file, with different host as the base URL
  ...
  public void testGetScripts() {
    ...
    // Call the HTML Header importer to process the script paths and check if the paths were updated
    // as expected
    ...
    // Absolute URL with the same host as the base URL used to create the site should be changed as
    // expected
    assertEquals(
  ...
  public void testProcessInlineImages() {
    ...
    // assertTrue(StringUtils.contains(docHeader.toString(), "@import
    // '/web_resources/themes/www.percussion.com/import/www.percussion.com/styles1.css';"));
    // assertTrue(StringUtils.contains(docHeader.toString(), "@import
    // '/web_resources/themes/www.percussion.com/import/www.percussion.com/styles2.css';"));
