...
public class PSURLConverterTest {
  ...
  public void testUrlConverter_RelativeCurrentPath() {
    ...
    urlConverter =
        new PSURLConverter(
            BASE_URL + "/folder1/folder2/", SITE_NAME, ABSOLUTE_THEME_PATH, THEME_URL, logger);
    link = "images/ExampleImage.png";
    remoteUrl = urlConverter.getFullUrl(link);
    assertEquals(remoteUrl, BASE_URL + "/folder1/folder2/" + "images/ExampleImage.png");
    assertEquals(
        urlConverter.convertToThemeLink(remoteUrl),
        THEME_URL + "/import/" + SITE_NAME + "/folder1/folder2/images/ExampleImage.png");
    assertEquals(
        (ABSOLUTE_THEME_PATH + "/import/" + SITE_NAME + "/folder1/folder2/images/ExampleImage.png")
  ...
  public void testUrlConverter_RelativeHost() {
    ...
    assertEquals(
        urlConverter.convertToThemeLink(remoteUrl),
        THEME_URL + "/import/" + SITE_NAME + "/backgroundImages/ExampleBackGround1.png");
    assertEquals(
        urlConverter.getFileSystemPath(remoteUrl),
        (ABSOLUTE_THEME_PATH + "/import/" + SITE_NAME + "/backgroundImages/ExampleBackGround1.png")
            .replace("/", File.separator));
  }
  ...
  public void testUrlConverter_RelativeUsingDots() {
    ...
    assertEquals(
        urlConverter.convertToThemeLink(remoteUrl),
        THEME_URL + "/import/" + SITE_NAME + "/folder1/textures/texture1.jpg");
    assertEquals(
        (ABSOLUTE_THEME_PATH + "/import/" + SITE_NAME + "/folder1/textures/texture1.jpg")
            .replace("/", File.separator),
        urlConverter.getFileSystemPath(remoteUrl));
  }
  ...
  public void testUrlConverter_AbsoluteUrlWithSameHost() {
    ...
    assertEquals(
        urlConverter.convertToThemeLink(remoteUrl),
        THEME_URL + "/import/" + SITE_NAME + "/images/srpr/logo3w.png");
    assertEquals(
        (ABSOLUTE_THEME_PATH + "/import/" + SITE_NAME + "/images/srpr/logo3w.png")
            .replace("/", File.separator),
        urlConverter.getFileSystemPath(remoteUrl));
  }
  ...
  public void testGetFileSystemPathForCss_cssEndedFile() {
    ...
    PSURLConverter urlConverter =
        new PSURLConverter(BASE_URL, SITE_NAME, ABSOLUTE_THEME_PATH, THEME_URL, logger);
    assertEquals(
        (ABSOLUTE_THEME_PATH + "/import/" + SITE_NAME + "/folder1/textures/texture1.css")
            .replace("/", File.separator),
  ...
  public void testGetFileSystemPathForCss_otherSuffix() {
    ...
    assertEquals(
        urlConverter.getFileSystemPathForCss(remoteUrl),
        (ABSOLUTE_THEME_PATH + "/import/" + SITE_NAME + "/folder1/textures/texture1.cfm.css")
            .replace("/", File.separator));
  }
  ...
  public void testConvertToThemeLinkForCss_cssEndedFile() {
    ...
    PSURLConverter urlConverter =
        new PSURLConverter(BASE_URL, SITE_NAME, ABSOLUTE_THEME_PATH, THEME_URL, logger);
    assertEquals(
        urlConverter.convertToThemeLinkForCss(remoteUrl),
        THEME_URL + "/import/" + SITE_NAME + "/folder1/textures/texture1.css");
  }
  ...
  public void testConvertToThemeLinkForCss_otherSuffix() {
    ...
    assertEquals(
        urlConverter.convertToThemeLinkForCss(remoteUrl),
        THEME_URL + "/import/" + SITE_NAME + "/folder1/textures/texture1.cfm.css");
  }
  ...
  public void testGetFileSystemPathForImg_cssEndedFile() throws Exception {
    ...
    PSURLConverter urlConverter =
        new PSURLConverter(BASE_URL, SITE_NAME, ABSOLUTE_THEME_PATH, THEME_URL, logger);
    assertEquals(
        urlConverter.getCmsFolderPathForImageAsset(remoteUrl, THEME_NAME),
  ...
  public void testConvertCssResourceWithParamenters() {
    ...
    String remoteUrl1 =
        BASE_URL + "/min/?f=/includes/templates/freetemplate2/css/stylesheet1.css&1327766570";
    String remoteUrl2 = BASE_URL + "/?css=_stylesheets/print.v.1317061408";

    assertEquals(
        (ABSOLUTE_THEME_PATH + "/import/" + SITE_NAME + "/generic_1.css")
            .replace("/", File.separator),
        urlConverter.getFileSystemPathForCss(remoteUrl1));
    assertEquals(
        (ABSOLUTE_THEME_PATH + "/import/" + SITE_NAME + "/generic_2.css")
            .replace("/", File.separator),
  ...
  public void testConvertResourceWithInvalidCharacters() {
    ...
    PSURLConverter urlConverter =
        new PSURLConverter(BASE_URL, SITE_NAME, ABSOLUTE_THEME_PATH, THEME_URL, logger);
    assertEquals(
        (ABSOLUTE_THEME_PATH + "/import/" + SITE_NAME + "/media-/js/site-min.js".toLowerCase())
            .replace("/", File.separator),
