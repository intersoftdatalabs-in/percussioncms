...
public class PSPublishStagingTest extends TestCase {
  ...
  public class TestablePSPublishStagingService extends PSPublishStagingService {
  ...
  public void testStagingActive() {
    TestablePSPublishStagingService stgService =
        new TestablePSPublishStagingService(new MockMetadataService());
