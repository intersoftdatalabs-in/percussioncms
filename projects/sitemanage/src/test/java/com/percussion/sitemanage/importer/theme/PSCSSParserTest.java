...
class PSCSSParserTest {
  ...
  private static final String SAMPLE_UNCOMPRESSED_FILE_BACKUP =
      "src/test/resources/importer/sample_backup.css";
  private static final String SAMPLE_COMPRESSED_FILE_BACKUP =
  ...
  private void assertImages(Map<String, String> imagesToDownload) {
    assertEquals(
        ...
        imagesToDownload.get("http://generic:8080/images/corner.modulo.png"));
    assertEquals(
        absoluteThemePath + "/import/generic/images/boton.gif",
        imagesToDownload.get("http://generic:8080/images/boton.gif"));
    assertEquals(
        absoluteThemePath + "/import/generic/images/fondo_1.png",
        imagesToDownload.get("http://generic:8080/images/fondo_1.png"));
    assertEquals(
        absoluteThemePath + "/import/generic/images/back.modulo.png",
        imagesToDownload.get("http://generic:9980/images/back.modulo.png"));
    assertEquals(
        absoluteThemePath + "/import/generic/images/buttonCancel.png",
        imagesToDownload.get("http://generic:8080/images/buttonCancel.png"));
    assertEquals(
        absoluteThemePath + "/import/generic/images/buttonOk.png",
        imagesToDownload.get("http://generic:8080/images/buttonOk.png"));
