...
public class PSCSSParserTest {
  ...
  private static String SAMPLE_UNCOMPRESSED_FILE_BACKUP =
      "src/test/resources/importer/sample_backup.css";

  private static String SAMPLE_COMPRESSED_FILE_BACKUP =
      "src/test/resources/importer/sample-min_backup.css";
  ...
  /**
   * Inner class which implements {@link IPSFileDownloader} and redefines the methods to download
   * files. Redefined methods are used to copy local files to a temp directory instead of
   * downloading them from a url.
   *
   * @author Ignacio Erro
   */
  ...
  public void testParseImports() {
    ...
    assertTrue(
        cssImportA.contains(
            "@import \"/web_resources/themes/ownTheme/import/generic/importB.css\";"));
    assertTrue(
        cssImportA.contains(
            "url(/web_resources/themes/ownTheme/import/generic/images/buttonOk.png)"));

    assertTrue(
        cssImportB.contains(
            "@import \"/web_resources/themes/ownTheme/import/generic/importC.cfm.css\";"));
    assertTrue(
        cssImportB.contains(
            "@import \"/web_resources/themes/ownTheme/import/generic/importA.css\";"));
    assertTrue(cssImportB.contains("url(http://www.percussion.com/images/images/buttonOk.png);"));

    assertTrue(
        cssImportC.contains(
            "url(/web_resources/themes/ownTheme/import/generic/images/buttonCancel.png)"));
  }
  ...
  private void assertKnownChanges(String sampleFilePath, String modifiedFilePath) {
    ...
    modifiedFile =
        modifiedFile.replace(
            "/web_resources/themes/ownTheme/import/generic/importA.css", "importA.css");
    modifiedFile =
        modifiedFile.replace(
            "url(/web_resources/themes/ownTheme/import/generic/images/fondo_1.png)",
            "url(\"../images/fondo_1.png\")");
    modifiedFile =
        modifiedFile.replace(
            "url(/web_resources/themes/ownTheme/import/generic/images/corner.modulo.png)",
            "url(\"/images/corner.modulo.png\")");
    modifiedFile =
        modifiedFile.replace(
            "url(/web_resources/themes/ownTheme/import/generic/images/boton.gif)",
            "url(\"images/boton.gif\")");
    modifiedFile =
        modifiedFile.replace(
  ...
  private void assertUrls(String cssFile) {
    assertTrue(
        cssFile.contains("url(/web_resources/themes/ownTheme/import/generic/images/fondo_1.png)"));
    assertTrue(
        cssFile.contains(
            "url(/web_resources/themes/ownTheme/import/generic/images/corner.modulo.png)"));
    assertTrue(
        cssFile.contains("url(/web_resources/themes/ownTheme/import/generic/images/boton.gif)"));
  ...
  private void assertImages(Map<String, String> imagesToDownload) {
    assertTrue(
        imagesToDownload
            .get("http://generic:8080/images/corner.modulo.png")
            .equals(absoluteThemePath + "/import/generic/images/corner.modulo.png"));
    assertTrue(
        imagesToDownload
            .get("http://generic:8080/images/boton.gif")
            .equals(absoluteThemePath + "/import/generic/images/boton.gif"));
    assertTrue(
        imagesToDownload
            .get("http://generic:8080/images/fondo_1.png")
            .equals(absoluteThemePath + "/import/generic/images/fondo_1.png"));
    assertTrue(
        imagesToDownload
            .get("http://generic:9980/images/back.modulo.png")
            .equals(absoluteThemePath + "/import/generic/images/back.modulo.png"));
    assertTrue(
        imagesToDownload
            .get("http://generic:8080/images/buttonCancel.png")
            .equals(absoluteThemePath + "/import/generic/images/buttonCancel.png"));
    assertTrue(
        imagesToDownload
            .get("http://generic:8080/images/buttonOk.png")
            .equals(absoluteThemePath + "/import/generic/images/buttonOk.png"));
