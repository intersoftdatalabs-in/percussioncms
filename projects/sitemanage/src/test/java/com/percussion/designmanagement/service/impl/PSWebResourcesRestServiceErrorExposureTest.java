...
/**
 * Unit tests for PSWebResourcesRestService error message exposure prevention (CWE-209). Tests
 * ensure that detailed exception messages are not exposed to clients while maintaining detailed
