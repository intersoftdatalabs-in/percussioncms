...
public class PSFolderHelperTest {
  ...
  void setUp() throws Exception {
    ...
    securityWs.login(
        request, response, "admin1", "demo", null, "Enterprise_Investments_Admin", null);
  }
  ...
  void testFindFolderChildren() throws Exception {
    ...
    for (var itemSummary : allItems) {
      if (itemSummary.isFolder()) folderCount++;
    }
  ...
  void testUniqueNameInFolder() throws Exception {
    try {
      ...
      var name =
          folderHelper.getUniqueNameInFolder("//Sites", "UniqueNameInFolderTest", "copy", 1, true);
      ...
      var name4 =
          folderHelper.getUniqueNameInFolder("//Sites", "UniqueNameInFolderTest", "copy", 1, false);
      assertEquals("UniqueNameInFolderTest-copy-1", name4);

      var name5 =
          folderHelper.getUniqueNameInFolder(
              "//Sites", "UniqueNameInFolderTest", "copy", 10, false);
    ...
    try {
      ...
      var name5 =
          folderHelper.getUniqueFolderName(
              "//Sites", folderName + SecureStringUtils.INVALID_ITEM_NAME_CHARACTERS);
      assertEquals(name2, name5);

      var name6 =
          folderHelper.getUniqueFolderName(
              "//Sites", "Invalid" + SecureStringUtils.INVALID_ITEM_NAME_CHARACTERS + "FolderName");
