...
public class PSJcrNodeMapTest {
        ...
        new Expectations() {
          {
            ...
            one(pi).nextProperty();
            will(returnValue(expectProperty("a", "A")));
            inSequence(sequence);
            ...
            one(pi).nextProperty();
            will(returnValue(expectProperty("b", "B")));
            inSequence(sequence);
  ...
  public Property expectProperty(final String name, final String value, final int type)
      throws Exception {
    notNull(name);
    final Property property =
        context.mock(Property.class, Property.class.getSimpleName() + " " + name);
