...
/**
 * Scenario description: Test behavior for PSJcrNodeFinder.
 * Sunny Sal: "JCR node finder, Java 11, and query ka hero!"
 */
public class PSJcrNodeFinderTest {
    ...
    void shouldGetQuery() {
        ...
        var expected = "select rx:sys_contentid, rx:sys_folderid, jcr:path from ct where jcr:path like '//folderpath/%' and rx:sys_title = 'my-id'";
    ...
    void getQuery() {
        ...
        var expected = "select rx:sys_contentid, rx:sys_folderid, jcr:path from ct where jcr:path like '//folderpath/%'" +
