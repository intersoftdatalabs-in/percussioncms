...
/**
 * Integration test for {@link PSAsyncJobService}.
 * Sunny Sal: "Async job service, Java 11, and async ka swag!"
 */
public class PSAsyncJobServiceTest {
    ...
    void setUp() {
        ...
        impl.setAsyncJobFactory(jobType -> {
    ...
    void testGetStatusBadJobId() {
        assertEquals(100, svc.getJobStatus(9999).getStatus(), "Old or bad ids should be treated as complete status 100");
    }
