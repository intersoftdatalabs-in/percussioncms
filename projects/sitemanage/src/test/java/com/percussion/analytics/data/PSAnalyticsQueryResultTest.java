...
class PSAnalyticsQueryResultTest {
  ...
  void testPutMethods() {
    ...
    var ex1 =
        assertThrows(
            PSAnalyticsQueryResultException.class, () -> r.put("INVALID_CLASS", new HashMap<>()));
    assertEquals("Class type is not supported.", ex1.getMessage());

    var ex2 = assertThrows(IllegalArgumentException.class, () -> r.put(KEY_INT, null));
    assertEquals("Value cannot be null.", ex2.getMessage());

    var ex3 = assertThrows(IllegalArgumentException.class, () -> r.put(null, new HashMap<>()));
    assertEquals("key cannot be null or empty.", ex3.getMessage());

    var ex4 = assertThrows(IllegalArgumentException.class, () -> r.putAll(null));
  ...
  void testHasValue() {
    ...
    var ex = assertThrows(IllegalArgumentException.class, () -> result.hasValue(null));
    assertEquals("key cannot be null or empty.", ex.getMessage());
  }

  @Test
  void testGetDataType() {
    var ex = assertThrows(IllegalArgumentException.class, () -> result.getDataType(null));
    assertEquals("key cannot be null or empty.", ex.getMessage());
  }
  ...
  void testGetDate() {
    ...
    var ex1 = assertThrows(PSAnalyticsQueryResultException.class, () -> result.getDate(KEY_INT));
    assertEquals("Type cannot be converted to a Date", ex1.getMessage());

    var ex2 = assertThrows(PSAnalyticsQueryResultException.class, () -> result.getDate(KEY_LONG));
    assertEquals("Type cannot be converted to a Date", ex2.getMessage());

    var ex3 = assertThrows(PSAnalyticsQueryResultException.class, () -> result.getDate(KEY_FLOAT));
    assertEquals("Type cannot be converted to a Date", ex3.getMessage());

    var ex4 = assertThrows(PSAnalyticsQueryResultException.class, () -> result.getDate(KEY_STRING));
  ...
  void testGetInt() {
    ...
    var ex1 = assertThrows(PSAnalyticsQueryResultException.class, () -> result.getInt(KEY_STRING));
    assertEquals("Type cannot be converted to a Integer", ex1.getMessage());

    var ex2 = assertThrows(PSAnalyticsQueryResultException.class, () -> result.getInt(KEY_DATE));
  ...
  void testGetString() {
    ...
    var ex = assertThrows(IllegalArgumentException.class, () -> result.getString(null));
    assertEquals("key cannot be null or empty.", ex.getMessage());
  }
  ...
  void testGetFloat() {
    ...
    var ex1 =
        assertThrows(PSAnalyticsQueryResultException.class, () -> result.getFloat(KEY_STRING));
    assertEquals("Type cannot be converted to a Float", ex1.getMessage());

    var ex2 = assertThrows(PSAnalyticsQueryResultException.class, () -> result.getFloat(KEY_DATE));
  ...
  void testGetLong() {
    ...
    var ex = assertThrows(IllegalArgumentException.class, () -> result.getLong(null));
    assertEquals("key cannot be null or empty.", ex.getMessage());

    var ex2 = assertThrows(PSAnalyticsQueryResultException.class, () -> result.getLong(KEY_STRING));
