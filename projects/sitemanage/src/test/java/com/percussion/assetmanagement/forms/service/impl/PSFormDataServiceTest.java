...
/**
 * JLS: Disabled test as it is unreliable, and since there is a similar test in the Delivery tier
 * project, this test is mostly redundant, and there are no other sitemanage unit tests for rest
 * services that pass through to the DTS.
 */
