...
public class PSFormDataJoinerTest {
  ...
  // form1
  private static final String FORM1_COLUMNS = "Form name,Create date,field1,field2";

  private static final String FORM1_DATA = "testform1,12/22/2010 14:28:00,value1,value2";

  // form1 with different columns than form1
  private static final String FORM1_2_COLUMNS = "Form name,Create date,field3,field4";
  ...
  private static final String FORM1_3_COLUMNS = "Form name,Create date,field2,field3";
  ...
  private static final String FORM2_COLUMNS = FORM1_COLUMNS;
  ...
  public void testJoinFormData_EmptyData() throws Exception {
    assertEquals(
        "joined data should be empty", "", this.formDataJoiner.joinFormData(new String[] {""}));
  }

  @Test
  public void testJoinFormData_EmptyData2() throws Exception {
    assertEquals(
        "joined data should be empty", "", this.formDataJoiner.joinFormData(new String[0]));
  }

  @Test
  public void testJoinFormData_EmptyData3() throws Exception {
    assertEquals(
        "joined data should be empty", "", this.formDataJoiner.joinFormData((String[]) null));
  }
  ...
  public void testJoinFormData_MultipleData_FormsWithSameColumns() throws Exception {
    assertEquals(
        "returned csv file",
        join(FORM1_COLUMNS, FORM1_DATA, FORM2_DATA),
        this.formDataJoiner.joinFormData(
            new String[] {join(FORM1_COLUMNS, FORM1_DATA), join(FORM2_COLUMNS, FORM2_DATA)}));
  }
  ...
  @Test
  public void testJoinFormData_MultipleData_FormsWithDifferentColumns_AllColumnsAreUnique()
      throws Exception {
    assertEquals(
        "returned csv file",
        // join form1's columns with form3's ones
        join(
            "Form name,Create date,field1,field2,field3,field4",
            "testform1,12/22/2010 14:28:00,value1,value2,,",
            "testform1,12/18/2010 20:28:00,,,value33,value44",
            "testform1,12/19/2010 22:27:00,,,value331,value441"),
        this.formDataJoiner.joinFormData(
            new String[] {join(FORM1_COLUMNS, FORM1_DATA), join(FORM1_2_COLUMNS, FORM1_2_DATA)}));
  }
  ...
  public void testJoinFormData_MultipleData_InversedSubmissionOrder() throws Exception {
    assertEquals(
        ...
        join(
            ...
            "testform1,12/22/2010 14:28:00,value1,value2,,"),
        this.formDataJoiner.joinFormData(
            new String[] {join(FORM1_2_COLUMNS, FORM1_2_DATA), join(FORM1_COLUMNS, FORM1_DATA)}));
  }

  @Test
  public void testJoinFormData_MultipleData_FormsWithDifferentColumns_SomeColumnsShared()
      throws Exception {
    assertEquals(
        "returned csv file",
        // join form1's columns with form3's ones
        join(
            "Form name,Create date,field1,field2,field3",
            "testform1,12/22/2010 14:28:00,value1,value2,",
            "testform1,12/18/2010 20:28:00,,value22,value33",
            "testform1,12/19/2010 22:27:00,,value221,value331"),
        this.formDataJoiner.joinFormData(
            new String[] {join(FORM1_COLUMNS, FORM1_DATA), join(FORM1_3_COLUMNS, FORM1_3_DATA)}));
  }
