...
class PSFormDataJoinerTest {
  ...
  void testJoinFormData_EmptyData() {
    assertEquals(
        "", this.formDataJoiner.joinFormData(new String[] {""}), "joined data should be empty");
  }

  @Test
  void testJoinFormData_EmptyData2() {
    assertEquals(
        "", this.formDataJoiner.joinFormData(new String[0]), "joined data should be empty");
  }

  @Test
  void testJoinFormData_EmptyData3() {
    assertEquals(
        "", this.formDataJoiner.joinFormData((String[]) null), "joined data should be empty");
  }
  ...
  @Test
  void testJoinFormData_MultipleData_FormsWithDifferentColumns_AllColumnsAreUnique()
      throws Exception {
    assertEquals(
        "returned csv file",
  ...
  @Test
  void testJoinFormData_MultipleData_FormsWithDifferentColumns_SomeColumnsShared()
      throws Exception {
    assertEquals(
        "returned csv file",
        // join form1's columns with form3's ones
