...
public class PSClassNameMatchingMigrationRuleTest {
  ...
  private static final PSClassNameMatchingMigrationRule RULE =
      new PSClassNameMatchingMigrationRule();
  ...
  void testSingleNoParentMatch() {
    ...
    var expected =
        loadResourceAsDocument(SINGLE_PARENT_CONTENT_TO_MATCH)
            .getElementById(SINGLE_PARENT_CONTENT_TO_MATCH_ID)
            .html();
    assertNull(match);
  }
  ...
  void testMutliParentMatch() {
    ...
    var expected =
        loadResourceAsDocument(MULTI_PARENT_CONTENT_TO_MATCH)
            .getElementById(MULTI_PARENT_CONTENT_TO_MATCH_ID)
            .html();
    assertNotNull(match);
